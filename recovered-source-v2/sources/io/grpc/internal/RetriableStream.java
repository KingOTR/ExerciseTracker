...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0054, code lost:
        ...
        r8 = io.grpc.internal.RetriableStream.CANCELLED_BECAUSE_COMMITTED;
     */
    ...
    */
    ...
    private final class Sublistener implements ClientStreamListener {
        ...
        private HedgingPlan makeHedgingDecision(Status status, Metadata metadata) {
            Integer pushbackMills = getPushbackMills(metadata);
            boolean contains = RetriableStream.this.hedgingPolicy.nonFatalStatusCodes.contains(status.getCode());
            boolean z = (RetriableStream.this.throttle == null || (!contains && (pushbackMills == null || pushbackMills.intValue() >= 0))) ? false : !RetriableStream.this.throttle.onQualifiedFailureThenCheckIsAboveThreshold();
            if (contains && !z && !status.isOk() && pushbackMills != null && pushbackMills.intValue() > 0) {
                pushbackMills = 0;
            }
            return new HedgingPlan(contains && !z, pushbackMills);
        }
