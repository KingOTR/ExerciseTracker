...
public final class ServiceConfigUtil {
    ...
    static List<Map<String, ?>> getNameListFromMethodConfig(Map<String, ?> map) {
        return JsonUtil.getListOfObjects(map, HintConstants.AUTOFILL_HINT_NAME);
    }
    ...
    public static final class PolicySelection {
        ...
        public PolicySelection(LoadBalancerProvider loadBalancerProvider, @Nullable Object obj) {
            this.provider = (LoadBalancerProvider) Preconditions.checkNotNull(loadBalancerProvider, DatabaseFileArchive.COLUMN_PROVIDER);
            this.config = obj;
        }
        ...
        public String toString() {
            return MoreObjects.toStringHelper(this).add(DatabaseFileArchive.COLUMN_PROVIDER, this.provider).add("config", this.config).toString();
        }
    }
}
