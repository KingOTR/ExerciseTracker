...
public final class Metadata {
    ...
    public <T> void put(Key<T> key, T t) {
        Preconditions.checkNotNull(key, DatabaseFileArchive.COLUMN_KEY);
    ...
    public void merge(Metadata metadata, Set<Key<?>> set) {
        Preconditions.checkNotNull(metadata, Vo2MaxRecord.MeasurementMethod.OTHER);
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.size; i++) {
            ...
            sb.append(str).append(Tag.KEY_VALUE_SEPARATOR);
    ...
    public static abstract class Key<T> {
        ...
        private static String validateName(String str, boolean z) {
            Preconditions.checkNotNull(str, HintConstants.AUTOFILL_HINT_NAME);
        ...
        private Key(String str, boolean z, Object obj) {
            String str2 = (String) Preconditions.checkNotNull(str, HintConstants.AUTOFILL_HINT_NAME);
