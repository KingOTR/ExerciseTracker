...
public final class AdvancedTlsX509KeyManager extends X509ExtendedKeyManager {
    ...
    public void updateIdentityCredentials(PrivateKey privateKey, X509Certificate[] x509CertificateArr) {
        this.keyInfo = new KeyInfo((PrivateKey) Preconditions.checkNotNull(privateKey, DatabaseFileArchive.COLUMN_KEY), (X509Certificate[]) Preconditions.checkNotNull(x509CertificateArr, "certs"));
    }
    ...
    */
    public UpdateResult readAndUpdate(File file, File file2, long j, long j2) throws IOException, GeneralSecurityException {
        ...
        if (lastModified != j && lastModified2 != j2) {
            try {
                PrivateKey privateKey = CertificateUtils.getPrivateKey(new FileInputStream(file));
