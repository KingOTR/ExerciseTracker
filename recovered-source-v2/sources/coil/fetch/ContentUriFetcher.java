...
public final class ContentUriFetcher implements Fetcher {
    ...
    public final boolean isMusicThumbnailUri$coil_base_release(Uri data) {
        ...
        int size;
        return Intrinsics.areEqual(data.getAuthority(), SVGParser.XML_STYLESHEET_ATTR_MEDIA) && (size = (pathSegments = data.getPathSegments()).size()) >= 3 && Intrinsics.areEqual(pathSegments.get(size + (-3)), "audio") && Intrinsics.areEqual(pathSegments.get(size + (-2)), "albums");
    }
