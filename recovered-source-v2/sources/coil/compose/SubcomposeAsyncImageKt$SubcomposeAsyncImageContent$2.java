...
final class SubcomposeAsyncImageKt$SubcomposeAsyncImageContent$2 implements MeasurePolicy {
    ...
    public final MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6258getMinWidthimpl(j), Constraints.m6257getMinHeightimpl(j), null, new Function1() { // from class: coil.compose.SubcomposeAsyncImageKt$SubcomposeAsyncImageContent$2$$ExternalSyntheticLambda0
