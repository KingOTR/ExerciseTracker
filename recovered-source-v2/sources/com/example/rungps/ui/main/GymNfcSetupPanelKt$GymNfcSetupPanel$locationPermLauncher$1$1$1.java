...
@DebugMetadata(c = "com.example.rungps.ui.main.GymNfcSetupPanelKt$GymNfcSetupPanel$locationPermLauncher$1$1$1", f = "GymNfcSetupPanel.kt", i = {}, l = {104, 109}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class GymNfcSetupPanelKt$GymNfcSetupPanel$locationPermLauncher$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GymNfcSetupPanelKt$GymNfcSetupPanel$locationPermLauncher$1$1$1(this.$ctx, this.$newLocationName$delegate, this.$locations$delegate, this.$cards$delegate, this.$checkIns$delegate, this.$defaultRadiusM$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GymNfcSetupPanelKt$GymNfcSetupPanel$locationPermLauncher$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new GymNfcSetupPanelKt$GymNfcSetupPanel$locationPermLauncher$1$1$1$pair$1(this.$ctx, null), this);
    ...
    /* compiled from: GymNfcSetupPanel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = 48)
    @DebugMetadata(c = "com.example.rungps.ui.main.GymNfcSetupPanelKt$GymNfcSetupPanel$locationPermLauncher$1$1$1$1", f = "GymNfcSetupPanel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.example.rungps.ui.main.GymNfcSetupPanelKt$GymNfcSetupPanel$locationPermLauncher$1$1$1$1, reason: invalid class name */
