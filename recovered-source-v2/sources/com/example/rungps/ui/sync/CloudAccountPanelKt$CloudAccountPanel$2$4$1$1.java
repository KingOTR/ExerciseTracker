...
@DebugMetadata(c = "com.example.rungps.ui.sync.CloudAccountPanelKt$CloudAccountPanel$2$4$1$1", f = "CloudAccountPanel.kt", i = {}, l = {ExerciseSessionRecord.EXERCISE_TYPE_WEIGHTLIFTING, ExerciseSessionRecord.EXERCISE_TYPE_WHEELCHAIR, ExerciseSessionRecord.EXERCISE_TYPE_YOGA, 88}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class CloudAccountPanelKt$CloudAccountPanel$2$4$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CloudAccountPanelKt$CloudAccountPanel$2$4$1$1(Repository repository, MutableState<String> mutableState, MutableState<String> mutableState2, CoroutineScope coroutineScope, SnackbarHostState snackbarHostState, Continuation<? super CloudAccountPanelKt$CloudAccountPanel$2$4$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CloudAccountPanelKt$CloudAccountPanel$2$4$1$1(this.$repo, this.$cloudEmail$delegate, this.$cloudPassword$delegate, this.$scope, this.$snackbar, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CloudAccountPanelKt$CloudAccountPanel$2$4$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Task<AuthResult> signInWithEmailAndPassword = firebaseAuth.signInWithEmailAndPassword(obj2, CloudAccountPanel$lambda$7);
            Intrinsics.checkNotNullExpressionValue(signInWithEmailAndPassword, "signInWithEmailAndPassword(...)");
            this.label = 1;
            if (TasksKt.await(signInWithEmailAndPassword, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    /* compiled from: CloudAccountPanel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = 48)
    @DebugMetadata(c = "com.example.rungps.ui.sync.CloudAccountPanelKt$CloudAccountPanel$2$4$1$1$1", f = "CloudAccountPanel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.example.rungps.ui.sync.CloudAccountPanelKt$CloudAccountPanel$2$4$1$1$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            CloudAccountPanelKt.toastSyncResult(this.$scope, this.$snackbar, "Signed in", this.$r);
            return Unit.INSTANCE;
        }
    }
    ...
    /* compiled from: CloudAccountPanel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = 48)
    @DebugMetadata(c = "com.example.rungps.ui.sync.CloudAccountPanelKt$CloudAccountPanel$2$4$1$1$2", f = "CloudAccountPanel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.example.rungps.ui.sync.CloudAccountPanelKt$CloudAccountPanel$2$4$1$1$2, reason: invalid class name */
