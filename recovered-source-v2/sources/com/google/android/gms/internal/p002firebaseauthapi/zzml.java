        ...
        while (true) {
            ...
            if (i3 < bArr3.length) {
                if (MessageDigest.isEqual(bArr3[i3], copyOf)) {
                    throw new InvalidKeyException("Banned public key: " + zzyt.zza(bArr3[i3]));
                }
                i3++;
            } else {
                ...
                zzmr.zza(jArr22, zza2, jArr);
                zzmr.zzd(jArr23, zza2, jArr);
