...
public final class zzane {
    ...
    private static zzami zzb(zzami zzamiVar) {
        ...
        if (!zza(zzb) || zza2 < 0 || zza2 >= 1000000000) {
            throw new IllegalArgumentException(String.format("Timestamp is not valid. See proto definition for valid values. Seconds (%s) must be in range [-62,135,596,800, +253,402,300,799]. Nanos (%s) must be in range [0, +999,999,999].", Long.valueOf(zzb), Integer.valueOf(zza2)));
        }
        return zzamiVar;
    }
    ...
    public static zzami zza(String str) throws ParseException {
        ...
        try {
            ...
            if (i <= -1000000000 || i >= 1000000000) {
                time = zzbe.zza(time, i / Http2Connection.DEGRADED_PONG_TIMEOUT_NS);
