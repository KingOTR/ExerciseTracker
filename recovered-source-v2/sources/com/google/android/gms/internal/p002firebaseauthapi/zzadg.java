...
public final class zzadg {
    ...
    */
        ...
        if (statusCode != 17021) {
            if (statusCode != 17051) {
                ...
                switch (statusCode) {
                    ...
                    case 17200:
                        return new zzad(zza(statusCode), zza2);
                                            ...
                                            default:
                                                switch (statusCode) {
                                                    ...
                                                    default:
                                                        switch (statusCode) {
                                                            case 17056:
                                                                return new zzae(zza(statusCode), zza2);
                                                            default:
                                                                switch (statusCode) {
                                                                    case 17061:
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzzl zzzlVar, FirebaseUser firebaseUser) {
        zzy.zza(firebaseAuth);
        zzy.zza(zzzlVar);
        Pair<String, String> pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzaj.zza(zzzlVar, firebaseAuth, firebaseUser));
    }
