...
interface zzanf {
    ...
    void zza(int i, zzaip zzaipVar) throws IOException;

    <K, V> void zza(int i, zzakx<K, V> zzakxVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzalv zzalvVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzaip> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzalv zzalvVar) throws IOException;
    ...
    void zzb(int i, Object obj, zzalv zzalvVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzalv zzalvVar) throws IOException;
