...
public final class zzmk {
    ...
    private static zzmn zza(zzmn zzmnVar, zzmn zzmnVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger mod = zzmnVar.zzd.multiply(zzmnVar.zzd).mod(bigInteger2);
        BigInteger mod2 = zzmnVar2.zzd.multiply(zzmnVar2.zzd).mod(bigInteger2);
        BigInteger mod3 = zzmnVar.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmnVar2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzmnVar.zzc.multiply(zzmnVar2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzmnVar2.zzc.multiply(zzmnVar.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            return !mod5.equals(mod6) ? zzmn.zza : zza(zzmnVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger add = zzmnVar.zzd.add(zzmnVar2.zzd);
        return new zzmn(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }
    ...
    private static zzmn zza(zzmn zzmnVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger mod = zzmnVar.zzb.multiply(zzmnVar.zzb).mod(bigInteger2);
        BigInteger mod2 = zzmnVar.zzc.multiply(zzmnVar.zzc).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmnVar.zzd.multiply(zzmnVar.zzd).mod(bigInteger2);
        BigInteger add = zzmnVar.zzb.add(mod2);
        ...
        BigInteger add3 = zzmnVar.zzc.add(zzmnVar.zzd);
        return new zzmn(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }
    ...
    private static zzmn zza(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger mod = new BigInteger(1, zzpe.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new zzmn(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        zzmn zza3 = zza(ECPoint.POINT_INFINITY, zza2);
        zzmn zza4 = zza(generator, zza2);
