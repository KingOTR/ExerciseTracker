...
public abstract class zzajg extends zzaim {
        ...
        final void zzb(int i) {
            if (zzajg.zzb) {
                ...
                while ((i & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) != 0) {
                    ...
                    int i2 = this.zzc;
                    this.zzc = i2 + 1;
                    zzamp.zza(bArr, i2, (byte) (i | 128));
                    i >>>= 7;
                }
                byte[] bArr2 = this.zza;
                int i3 = this.zzc;
                this.zzc = i3 + 1;
                zzamp.zza(bArr2, i3, (byte) i);
    ...
    abstract void zzc(int i, zzalc zzalcVar, zzalv zzalvVar) throws IOException;
    ...
    @Deprecated
    static int zza(int i, zzalc zzalcVar, zzalv zzalvVar) {
    ...
    static int zzb(int i, zzalc zzalcVar, zzalv zzalvVar) {
