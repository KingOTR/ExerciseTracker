...
public interface RecaptchaClient {
    ...
    Object mo7684execute0E7RQCE(RecaptchaAction recaptchaAction, long j, Continuation<? super Result<String>> continuation);

    /* renamed from: execute-gIAlu-s, reason: not valid java name */
    Object mo7685executegIAlus(RecaptchaAction recaptchaAction, Continuation<? super Result<String>> continuation);
}
