...
public abstract class zzjb {
    ...
    static zzjb zzH(byte[] bArr, int i, int i2, boolean z) {
    ...
    public abstract int zze(int i) throws zzlc;
    ...
    public abstract zziv zzw() throws IOException;

    public abstract String zzx() throws IOException;

    public abstract String zzy() throws IOException;

    public abstract void zzz(int i) throws zzlc;
}
