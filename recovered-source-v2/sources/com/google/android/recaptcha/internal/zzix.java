...
final class zzix extends zzjb {
    ...
    /* synthetic */ zzix(byte[] bArr, int i, int i2, boolean z, zziw zziwVar) {
        super(null);
    ...
    public final zziv zzw() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzh;
            if (zzj <= i - i2) {
                zziv zzk = zziv.zzk(this.zze, i2, zzj);
                this.zzh += zzj;
                return zzk;
            }
        }
        ...
        if (zzj > 0) {
            ...
            if (zzj <= i3 - i4) {
                int i5 = zzj + i4;
                this.zzh = i5;
                return new zziu(Arrays.copyOfRange(this.zze, i4, i5));
            }
        }
        if (zzj <= 0) {
            throw zzlc.zzf();
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzh;
            if (zzj <= i - i2) {
                String str = new String(this.zze, i2, zzj, zzla.zza);
                this.zzh += zzj;
                return str;
            }
        }
    ...
    public final String zzy() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzh;
            if (zzj <= i - i2) {
                String zzd = zznl.zzd(this.zze, i2, zzj);
                this.zzh += zzj;
                return zzd;
            }
        }
