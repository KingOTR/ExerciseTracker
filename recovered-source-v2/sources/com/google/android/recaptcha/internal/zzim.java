...
final class zzim extends zzii implements RandomAccess, zzkz, zzmf {
    ...
    public final /* bridge */ /* synthetic */ zzkz zzd(int i) {
        if (i >= this.zzb) {
            return new zzim(Arrays.copyOf(this.zza, i), this.zzb, true);
        }
    ...
    private zzim(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zza = zArr;
        this.zzb = i;
    }
