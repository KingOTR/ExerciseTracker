...
interface zzmj {
    ...
    @Deprecated
    void zzC(List list, zzmk zzmkVar, zzkd zzkdVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzmk zzmkVar, zzkd zzkdVar) throws IOException;
    ...
    zziv zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzmk zzmkVar, zzkd zzkdVar) throws IOException;

    void zzu(Object obj, zzmk zzmkVar, zzkd zzkdVar) throws IOException;
