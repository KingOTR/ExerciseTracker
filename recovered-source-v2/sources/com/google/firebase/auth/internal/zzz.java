...
public final class zzz extends AbstractSafeParcelable implements UserInfo {
    ...
    public zzz(zzagr zzagrVar) {
        ...
        this.zza = zzagrVar.zzd();
        this.zzb = Preconditions.checkNotEmpty(zzagrVar.zzf());
        this.zzc = zzagrVar.zzb();
        Uri zza = zzagrVar.zza();
        if (zza != null) {
            this.zzd = zza.toString();
            this.zze = zza;
        }
        this.zzf = zzagrVar.zzc();
        this.zzg = zzagrVar.zze();
        this.zzh = false;
        this.zzi = zzagrVar.zzg();
    }

    public zzz(zzage zzageVar, String str) {
        Preconditions.checkNotNull(zzageVar);
        Preconditions.checkNotEmpty(str);
        this.zza = Preconditions.checkNotEmpty(zzageVar.zzi());
        this.zzb = str;
        this.zzf = zzageVar.zzh();
        this.zzc = zzageVar.zzg();
        Uri zzc = zzageVar.zzc();
        if (zzc != null) {
            this.zzd = zzc.toString();
            this.zze = zzc;
        }
        this.zzh = zzageVar.zzm();
        this.zzi = null;
        this.zzg = zzageVar.zzj();
    }
