...
public final class zzav {
    ...
    private static AuthCredential zza(Intent intent) {
        ...
        return com.google.firebase.auth.zze.zza(((zzahr) SafeParcelableSerializer.deserializeFromIntentExtra(intent, "com.google.firebase.auth.internal.VERIFY_ASSERTION_REQUEST", zzahr.CREATOR)).zzc(true));
    }
    ...
    static /* synthetic */ void zza(zzav zzavVar, Intent intent, TaskCompletionSource taskCompletionSource, Context context) {
    ...
    public final boolean zza(Activity activity, TaskCompletionSource<AuthResult> taskCompletionSource, FirebaseAuth firebaseAuth, FirebaseUser firebaseUser) {
        ...
        zza(activity, new zzbe(this, activity, taskCompletionSource, firebaseAuth, firebaseUser));
        this.zzb = true;
        return true;
    }
    ...
    public final boolean zza(Activity activity, TaskCompletionSource<String> taskCompletionSource) {
        ...
        zza(activity, new zzbd(this, activity, taskCompletionSource));
        this.zzb = true;
        return true;
    }
}
