...
public final class SetMutation extends Mutation {
    ...
    public void applyToRemoteDocument(MutableDocument mutableDocument, MutationResult mutationResult) {
        ...
        ObjectValue m7849clone = this.value.m7849clone();
        m7849clone.setAll(serverTransformResults(mutableDocument, mutationResult.getTransformResults()));
        mutableDocument.convertToFoundDocument(mutationResult.getVersion(), m7849clone).setHasCommittedMutations();
    }
    ...
    public FieldMask applyToLocalView(MutableDocument mutableDocument, FieldMask fieldMask, Timestamp timestamp) {
        ...
        ObjectValue m7849clone = this.value.m7849clone();
        m7849clone.setAll(localTransformResults);
        mutableDocument.convertToFoundDocument(mutableDocument.getVersion(), m7849clone).setHasLocalMutations();
        return null;
    }
