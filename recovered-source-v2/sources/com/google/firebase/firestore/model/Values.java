...
public class Values {
    ...
    static {
        ...
        MIN_VECTOR_VALUE = Value.newBuilder().setMapValue(MapValue.newBuilder().putFields(TYPE_KEY, build3).putFields(VECTOR_MAP_VECTORS_KEY, Value.newBuilder().setArrayValue(ArrayValue.newBuilder()).build())).build();
    ...
    private static int compareVectors(MapValue mapValue, MapValue mapValue2) {
        ...
        ArrayValue arrayValue = fieldsMap.get(VECTOR_MAP_VECTORS_KEY).getArrayValue();
        ArrayValue arrayValue2 = fieldsMap2.get(VECTOR_MAP_VECTORS_KEY).getArrayValue();
