...
public class AsyncQueue {
    ...
    class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            newThread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda1
                ...
                public final void uncaughtException(Thread thread, Throwable th) {
                    AsyncQueue.SynchronizedShutdownAwareExecutor.this.m7875x23fada6e(thread, th);
                }
            });
        ...
        /* synthetic */ void m7875x23fada6e(Thread thread, Throwable th) {
            AsyncQueue.this.panic(th);
        }
        ...
        public synchronized Task<Void> executeAndInitiateShutdown(final Runnable runnable) {
            ...
            Task<Void> executeAndReportResult = executeAndReportResult(new Callable() { // from class: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda0
