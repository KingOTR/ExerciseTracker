...
public class WriteBatch {
        ...
        if (!this.mutations.isEmpty()) {
            return (Task) this.firestore.callClient(new com.google.firebase.firestore.util.Function() { // from class: com.google.firebase.firestore.WriteBatch$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    return WriteBatch.this.m7753lambda$commit$0$comgooglefirebasefirestoreWriteBatch((FirestoreClient) obj);
                }
            });
        }
    ...
    /* synthetic */ Task m7753lambda$commit$0$comgooglefirebasefirestoreWriteBatch(FirestoreClient firestoreClient) {
