...
public class BundleSerializer {
    ...
    public NamedQuery decodeNamedQuery(JSONObject jSONObject) throws JSONException {
        return new NamedQuery(jSONObject.getString(HintConstants.AUTOFILL_HINT_NAME), decodeBundledQuery(jSONObject.getJSONObject("bundledQuery")), decodeSnapshotVersion(jSONObject.get("readTime")));
    }
    ...
    public BundledDocumentMetadata decodeBundledDocumentMetadata(JSONObject jSONObject) throws JSONException {
        DocumentKey fromPath = DocumentKey.fromPath(decodeName(jSONObject.getString(HintConstants.AUTOFILL_HINT_NAME)));
    ...
    private int decodeLimit(JSONObject jSONObject) {
        ...
        if (optJSONObject != null) {
            return optJSONObject.optInt(Values.VECTOR_MAP_VECTORS_KEY, -1);
        }
    ...
    private void decodeUnaryFilter(List<Filter> list, JSONObject jSONObject) throws JSONException {
        ...
        String string;
        decodeFieldReference = decodeFieldReference(jSONObject.getJSONObject("field"));
