...
public class AggregateQuery {
    ...
    public Task<AggregateQuerySnapshot> get(AggregateSource aggregateSource) {
        ...
        ((Task) this.query.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.AggregateQuery$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return AggregateQuery.this.m7735lambda$get$0$comgooglefirebasefirestoreAggregateQuery((FirestoreClient) obj);
            }
            ...
            public final Object then(Task task) {
                return AggregateQuery.this.m7736lambda$get$1$comgooglefirebasefirestoreAggregateQuery(taskCompletionSource, task);
            }
        });
    ...
    /* synthetic */ Task m7735lambda$get$0$comgooglefirebasefirestoreAggregateQuery(FirestoreClient firestoreClient) {
    ...
    /* synthetic */ Object m7736lambda$get$1$comgooglefirebasefirestoreAggregateQuery(TaskCompletionSource taskCompletionSource, Task task) throws Exception {
