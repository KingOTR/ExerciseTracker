...
final class SQLiteTargetCache implements TargetCache {
    ...
    public void forEachTarget(final Consumer<TargetData> consumer) {
        this.db.query("SELECT target_proto FROM targets").forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteTargetCache$$ExternalSyntheticLambda1
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                SQLiteTargetCache.this.m7845x1515438a(consumer, (Cursor) obj);
            }
        });
    }

    /* renamed from: lambda$forEachTarget$1$com-google-firebase-firestore-local-SQLiteTargetCache, reason: not valid java name */
    /* synthetic */ void m7845x1515438a(Consumer consumer, Cursor cursor) {
    ...
    int removeQueries(long j, final SparseArray<?> sparseArray) {
        ...
        this.db.query("SELECT target_id FROM targets WHERE last_listen_sequence_number <= ?").binding(Long.valueOf(j)).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteTargetCache$$ExternalSyntheticLambda0
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                SQLiteTargetCache.this.m7847x1041d572(sparseArray, iArr, (Cursor) obj);
            }
        });
        writeMetadata();
        return iArr[0];
    ...
    /* synthetic */ void m7847x1041d572(SparseArray sparseArray, int[] iArr, Cursor cursor) {
    ...
    public TargetData getTargetData(final Target target) {
        ...
        this.db.query("SELECT target_proto FROM targets WHERE canonical_id = ?").binding(canonicalId).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteTargetCache$$ExternalSyntheticLambda4
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                SQLiteTargetCache.this.m7846x4f05f442(target, targetDataHolder, (Cursor) obj);
            }
        });
    ...
    /* synthetic */ void m7846x4f05f442(Target target, TargetDataHolder targetDataHolder, Cursor cursor) {
