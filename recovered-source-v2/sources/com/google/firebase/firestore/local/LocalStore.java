...
public final class LocalStore implements BundleCallback {
    ...
    public LocalDocumentsResult writeLocally(final List<Mutation> list) {
        ...
        return (LocalDocumentsResult) this.persistence.runTransaction("Locally write mutations", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda12
            ...
            public final Object get() {
                return LocalStore.this.m7807x4f0ff958(hashSet, list, now);
            }
        });
    }

    /* renamed from: lambda$writeLocally$2$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ LocalDocumentsResult m7807x4f0ff958(Set set, List list, Timestamp timestamp) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> acknowledgeBatch(final MutationBatchResult mutationBatchResult) {
        return (ImmutableSortedMap) this.persistence.runTransaction("Acknowledge batch", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda5
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m7789xd0c8f3b2(mutationBatchResult);
            }
        });
    }

    /* renamed from: lambda$acknowledgeBatch$3$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ ImmutableSortedMap m7789xd0c8f3b2(MutationBatchResult mutationBatchResult) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> applyRemoteEvent(final RemoteEvent remoteEvent) {
        ...
        return (ImmutableSortedMap) this.persistence.runTransaction("Apply remote event", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda14
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m7792xfb616aa7(remoteEvent, snapshotVersion);
            }
        });
    }

    /* renamed from: lambda$applyRemoteEvent$6$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ ImmutableSortedMap m7792xfb616aa7(RemoteEvent remoteEvent, SnapshotVersion snapshotVersion) {
    ...
    public TargetData allocateTarget(final Target target) {
        ...
        if (targetData != null) {
            ...
            this.persistence.runTransaction("Allocate target", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    LocalStore.this.m7790x5de91a9d(allocateQueryHolder, target);
                }
            });
    ...
    /* synthetic */ void m7790x5de91a9d(AllocateQueryHolder allocateQueryHolder, Target target) {
    ...
    public boolean hasNewerBundle(final BundleMetadata bundleMetadata) {
        return ((Boolean) this.persistence.runTransaction("Has newer bundle", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda17
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m7798x622d6455(bundleMetadata);
            }
        })).booleanValue();
    }

    /* renamed from: lambda$hasNewerBundle$9$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ Boolean m7798x622d6455(BundleMetadata bundleMetadata) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> applyBundledDocuments(final ImmutableSortedMap<DocumentKey, MutableDocument> immutableSortedMap, String str) {
        ...
        return (ImmutableSortedMap) this.persistence.runTransaction("Apply bundle documents", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda15
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m7791xda7cc59f(immutableSortedMap, allocateTarget);
            }
        });
    }

    /* renamed from: lambda$applyBundledDocuments$11$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ ImmutableSortedMap m7791xda7cc59f(ImmutableSortedMap immutableSortedMap, TargetData targetData) {
        ImmutableSortedSet<DocumentKey> emptyKeySet = DocumentKey.emptyKeySet();
        HashMap hashMap = new HashMap();
    ...
    public void saveNamedQuery(final NamedQuery namedQuery, final ImmutableSortedSet<DocumentKey> immutableSortedSet) {
        ...
        this.persistence.runTransaction("Saved named query", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m7803x3730c4c0(namedQuery, allocateTarget, targetId, immutableSortedSet);
            }
        });
    }

    /* renamed from: lambda$saveNamedQuery$12$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ void m7803x3730c4c0(NamedQuery namedQuery, TargetData targetData, int i, ImmutableSortedSet immutableSortedSet) {
    ...
    public LruGarbageCollector.Results collectGarbage(final LruGarbageCollector lruGarbageCollector) {
        return (LruGarbageCollector.Results) this.persistence.runTransaction("Collect garbage", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda13
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m7793x577feb79(lruGarbageCollector);
            }
        });
    }

    /* renamed from: lambda$collectGarbage$18$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ LruGarbageCollector.Results m7793x577feb79(LruGarbageCollector lruGarbageCollector) {
