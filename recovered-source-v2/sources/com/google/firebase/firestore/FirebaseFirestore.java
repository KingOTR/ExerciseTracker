...
public class FirebaseFirestore {
    ...
    private <ResultT> Task<ResultT> runTransaction(final TransactionOptions transactionOptions, final Transaction.Function<ResultT> function, final Executor executor) {
        ...
        final Function function2 = new Function() { // from class: com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda13
            @Override // com.google.firebase.firestore.util.Function
            public final Object apply(Object obj) {
                return FirebaseFirestore.this.m7743x9099e0de(executor, function, (com.google.firebase.firestore.core.Transaction) obj);
            }
        };
    ...
    /* synthetic */ Task m7743x9099e0de(Executor executor, final Transaction.Function function, final com.google.firebase.firestore.core.Transaction transaction) {
        return Tasks.call(executor, new Callable() { // from class: com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda4
            ...
            public final Object call() {
                return FirebaseFirestore.this.m7742x911046dd(function, transaction);
            }
        });
    }

    /* renamed from: lambda$runTransaction$1$com-google-firebase-firestore-FirebaseFirestore, reason: not valid java name */
    /* synthetic */ Object m7742x911046dd(Transaction.Function function, com.google.firebase.firestore.core.Transaction transaction) throws Exception {
    ...
    public Task<Void> clearPersistence(Executor executor) {
        ...
        executor.execute(new Runnable() { // from class: com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda3
            ...
            public final void run() {
                FirebaseFirestore.this.m7740x40c7eca0(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m7740x40c7eca0(TaskCompletionSource taskCompletionSource) {
        try {
