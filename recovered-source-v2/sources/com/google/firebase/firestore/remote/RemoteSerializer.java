    ...
    */
    ...
    public WatchChange decodeWatchChange(ListenResponse listenResponse) {
        ...
        if (i == 2) {
            ...
            DocumentKey decodeKey = decodeKey(documentChange2.getDocument().getName());
            SnapshotVersion decodeVersion = decodeVersion(documentChange2.getDocument().getUpdateTime());
            ...
            documentChange = new WatchChange.DocumentChange(Collections.emptyList(), documentRemove.getRemovedTargetIdsList(), decodeKey(documentRemove.getDocument()), null);
        }
