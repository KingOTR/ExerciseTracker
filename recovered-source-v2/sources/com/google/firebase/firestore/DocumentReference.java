...
public class DocumentReference {
    ...
    public Task<DocumentSnapshot> get(Source source) {
        if (source == Source.CACHE) {
            return ((Task) this.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.DocumentReference$$ExternalSyntheticLambda3
                @Override // com.google.firebase.firestore.util.Function
                public final Object apply(Object obj) {
                    return DocumentReference.this.m7738lambda$get$3$comgooglefirebasefirestoreDocumentReference((FirestoreClient) obj);
                }
                ...
                public final Object then(Task task) {
                    return DocumentReference.this.m7739lambda$get$4$comgooglefirebasefirestoreDocumentReference(task);
                }
            });
        }
    ...
    /* synthetic */ Task m7738lambda$get$3$comgooglefirebasefirestoreDocumentReference(FirestoreClient firestoreClient) {
    ...
    /* synthetic */ DocumentSnapshot m7739lambda$get$4$comgooglefirebasefirestoreDocumentReference(Task task) throws Exception {
    ...
    private ListenerRegistration addSnapshotListenerInternal(Executor executor, final EventManager.ListenOptions listenOptions, final Activity activity, final EventListener<DocumentSnapshot> eventListener) {
        final AsyncEventListener asyncEventListener = new AsyncEventListener(executor, new EventListener() { // from class: com.google.firebase.firestore.DocumentReference$$ExternalSyntheticLambda5
            @Override // com.google.firebase.firestore.EventListener
            public final void onEvent(Object obj, FirebaseFirestoreException firebaseFirestoreException) {
                DocumentReference.this.m7737xb3ec08f7(eventListener, (ViewSnapshot) obj, firebaseFirestoreException);
            }
        });
    ...
    /* synthetic */ void m7737xb3ec08f7(EventListener eventListener, ViewSnapshot viewSnapshot, FirebaseFirestoreException firebaseFirestoreException) {
        if (firebaseFirestoreException != null) {
