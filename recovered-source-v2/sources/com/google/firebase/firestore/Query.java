...
public class Query {
        ...
        if (source == Source.CACHE) {
            return ((Task) this.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.Query$$ExternalSyntheticLambda3
                ...
                public final Object apply(Object obj) {
                    return Query.this.m7750lambda$get$0$comgooglefirebasefirestoreQuery((FirestoreClient) obj);
                }
                ...
                public final Object then(Task task) {
                    return Query.this.m7751lambda$get$1$comgooglefirebasefirestoreQuery(task);
                }
            });
        }
    ...
    /* synthetic */ Task m7750lambda$get$0$comgooglefirebasefirestoreQuery(FirestoreClient firestoreClient) {
    ...
    /* synthetic */ QuerySnapshot m7751lambda$get$1$comgooglefirebasefirestoreQuery(Task task) throws Exception {
    ...
    private ListenerRegistration addSnapshotListenerInternal(Executor executor, final EventManager.ListenOptions listenOptions, final Activity activity, final EventListener<QuerySnapshot> eventListener) {
        ...
        final AsyncEventListener asyncEventListener = new AsyncEventListener(executor, new EventListener() { // from class: com.google.firebase.firestore.Query$$ExternalSyntheticLambda0
            @Override // com.google.firebase.firestore.EventListener
            public final void onEvent(Object obj, FirebaseFirestoreException firebaseFirestoreException) {
                Query.this.m7748xc56a5d4c(eventListener, (ViewSnapshot) obj, firebaseFirestoreException);
            }
        });
        return (ListenerRegistration) this.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.Query$$ExternalSyntheticLambda1
            @Override // com.google.firebase.firestore.util.Function
            public final Object apply(Object obj) {
                return Query.this.m7749xecba044e(listenOptions, asyncEventListener, activity, (FirestoreClient) obj);
            }
        });
    }

    /* renamed from: lambda$addSnapshotListenerInternal$3$com-google-firebase-firestore-Query, reason: not valid java name */
    /* synthetic */ void m7748xc56a5d4c(EventListener eventListener, ViewSnapshot viewSnapshot, FirebaseFirestoreException firebaseFirestoreException) {
        if (firebaseFirestoreException != null) {
    ...
    /* synthetic */ ListenerRegistration m7749xecba044e(EventManager.ListenOptions listenOptions, final AsyncEventListener asyncEventListener, Activity activity, final FirestoreClient firestoreClient) {
