...
public final class JsonKeysetWriter implements KeysetWriter {
    ...
    private JsonObject toJson(Keyset keyset) {
        ...
        jsonObject.add(DatabaseFileArchive.COLUMN_KEY, jsonArray);
        return jsonObject;
    }
    ...
    private JsonObject toJson(KeyData keyData) {
        ...
        jsonObject.addProperty(Values.VECTOR_MAP_VECTORS_KEY, Base64.encode(keyData.getValue().toByteArray()));
