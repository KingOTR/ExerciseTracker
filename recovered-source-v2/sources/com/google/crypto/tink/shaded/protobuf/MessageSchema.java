    ...
    */
    static <T> MessageSchema<T> newSchemaForRawMessageInfo(RawMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        while (i28 < length) {
                        ...
                        if ((charAt24 & 2048) != 0) {
                            ...
                            if ((charAt24 & 4096) == 4096 || i68 > 17) {
                                ...
                                if (charAt26 >= 55296) {
                                    ...
                                    while (true) {
                                        i19 = i82 + 1;
                                        charAt14 = stringInfo.charAt(i82);
                                        if (charAt14 < 55296) {
                                            break;
                                        }
            ...
            iArr2[i59] = charAt23;
            int i87 = i59 + 2;
            iArr2[i86] = ((charAt24 & 256) != 0 ? REQUIRED_MASK : 0) | ((charAt24 & 512) != 0 ? ENFORCE_UTF8_MASK : 0) | (i68 << 20) | objectFieldOffset;
            i59 += 3;
        ...
        return new MessageSchema<>(iArr2, objArr, charAt, charAt2, messageInfo.getDefaultInstance(), z2, false, iArr, charAt5, i55, newInstanceSchema, listFieldSchema, unknownFieldSchema, extensionSchema, mapFieldSchema);
    }
    ...
    */
    private int parseProto3Message(T message, byte[] data, int position, int limit, ArrayDecoders.Registers registers) throws IOException {
        ...
        while (i14 < i12) {
            ...
            byte b2 = bArr[i14];
            if (b2 < 0) {
                i = ArrayDecoders.decodeVarint32(b2, bArr, i19, registers2);
                b = registers2.int1;
            } else {
                b = b2;
                i = i19;
                ...
                if (type <= 17) {
                    ...
                    switch (type) {
                        case 0:
                            ...
                            if (i21 != 1) {
                                ...
                                UnsafeUtil.putDouble(t, offset, ArrayDecoders.decodeDouble(bArr, i10));
                                i14 = i10 + 8;
                                i17 = i11 | i25;
                                i16 = i9;
                                i15 = i3;
                        ...
                        case 1:
                            ...
                            if (i21 != 5) {
                                ...
                                UnsafeUtil.putFloat(t, offset, ArrayDecoders.decodeFloat(bArr, i10));
                                i14 = i10 + 4;
                                i17 = i11 | i25;
                                i16 = i9;
                                i15 = i3;
                        ...
                        case 3:
                            ...
                            if (i21 != 0) {
                                ...
                                int decodeVarint64 = ArrayDecoders.decodeVarint64(bArr, i10, registers2);
                                unsafe2.putLong(message, offset, registers2.long1);
                                i17 = i11 | i25;
                                i16 = i9;
                                i14 = decodeVarint64;
                        ...
                        case 11:
                            ...
                            if (i21 != 0) {
                                ...
                                i14 = ArrayDecoders.decodeVarint32(bArr, i10, registers2);
                        ...
                        case 7:
                            ...
                            if (i21 != 0) {
                                ...
                                int decodeVarint642 = ArrayDecoders.decodeVarint64(bArr, i, registers2);
                                if (registers2.long1 == 0) {
                                    z = false;
                                }
                                UnsafeUtil.putBoolean(t, offset, z);
                                i17 = i11 | i25;
                                i14 = decodeVarint642;
                                i16 = i9;
                                i15 = i3;
                        ...
                        case 8:
                            ...
                            if (i21 != 2) {
                                ...
                                if ((ENFORCE_UTF8_MASK & i23) == 0) {
                                    i14 = ArrayDecoders.decodeString(bArr, i, registers2);
                                } else {
                                    i14 = ArrayDecoders.decodeStringRequireUtf8(bArr, i, registers2);
                                }
                        ...
                        case 9:
                            ...
                            if (i21 != 2) {
                                ...
                                Object mutableMessageFieldForMerge = messageSchema.mutableMessageFieldForMerge(t, i9);
                                i14 = ArrayDecoders.mergeMessageField(mutableMessageFieldForMerge, messageSchema.getMessageFieldSchema(i9), data, i, limit, registers);
                                messageSchema.storeMessageField(t, i9, mutableMessageFieldForMerge);
                                i17 |= i25;
                                i16 = i9;
                                i15 = i3;
                                i13 = -1;
                        ...
                        case 10:
                            ...
                            if (i21 != 2) {
                                ...
                                decodeBytes = ArrayDecoders.decodeBytes(bArr, i, registers2);
                                unsafe2.putObject(t, offset, registers2.object1);
                                i17 |= i25;
                                i14 = decodeBytes;
                                i16 = i9;
                        ...
                        case 12:
                            ...
                            if (i21 != 0) {
                                ...
                                decodeBytes = ArrayDecoders.decodeVarint32(bArr, i, registers2);
                                unsafe2.putInt(t, offset, registers2.int1);
                                i17 |= i25;
                                i14 = decodeBytes;
                                i16 = i9;
                        ...
                        case 15:
                            ...
                            if (i21 != 0) {
                                ...
                                i14 = ArrayDecoders.decodeVarint32(bArr, i, registers2);
                        ...
                        case 16:
                            if (i21 != 0) {
                                ...
                                registers2 = registers;
                                int decodeVarint643 = ArrayDecoders.decodeVarint64(bArr, i, registers2);
                                i3 = i20;
                                unsafe2.putLong(message, offset, CodedInputStream.decodeZigZag64(registers2.long1));
                                i17 |= i25;
                                i16 = i22;
                    ...
                    if (type != 27) {
                        if (type <= 49) {
                            ...
                            unsafe = unsafe2;
                            i7 = i18;
                            i14 = parseRepeatedField(message, data, i29, limit, b, i3, i21, i22, i23, type, offset, registers);
                        } else {
                            i6 = i28;
                            i7 = i18;
                            i5 = i22;
                            ...
                            i4 = -1;
                            if (type != 50) {
                                i14 = parseOneofField(message, data, i8, limit, b, i3, i21, i23, type, offset, i5, registers);
                            } else if (i21 == 2) {
                                i14 = parseMapField(message, data, i8, limit, i5, offset, registers);
                            }
                        }
                        i13 = i4;
                        unsafe2 = unsafe;
                        ...
                        i14 = ArrayDecoders.decodeMessageList(messageSchema.getMessageFieldSchema(i22), b, data, i29, limit, protobufList, registers);
                        i16 = i22;
                        i17 = i28;
                        i15 = i3;
                        i13 = -1;
            ...
            i14 = ArrayDecoders.decodeUnknownField(b, data, i2, limit, getMutableUnknownFields(message), registers);
            messageSchema = this;
            t = message;
            bArr = data;
            i12 = limit;
        ...
        if (i18 != 1048575) {
            unsafe3.putInt(message, i18, i30);
        }
        if (i14 == limit) {
            return i14;
        }
