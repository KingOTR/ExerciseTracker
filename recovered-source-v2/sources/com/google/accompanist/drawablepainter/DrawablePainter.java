...
public final class DrawablePainter extends Painter implements RememberObserver {
    ...
    public DrawablePainter(Drawable drawable) {
        ...
        this.drawableIntrinsicSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3659boximpl(intrinsicSize), null, 2, null);
            ...
            public final AnonymousClass1 invoke() {
                ...
                return new Drawable.Callback() { // from class: com.google.accompanist.drawablepainter.DrawablePainter$callback$2.1
                    ...
                    public void invalidateDrawable(Drawable d) {
                        ...
                        drawablePainter3.m7680setDrawableIntrinsicSizeuvyYCjk(intrinsicSize2);
                    }
    ...
    private final long m7679getDrawableIntrinsicSizeNHjbRc() {
        return ((Size) this.drawableIntrinsicSize.getValue()).getPackedValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setDrawableIntrinsicSize-uvyYCjk, reason: not valid java name */
    public final void m7680setDrawableIntrinsicSizeuvyYCjk(long j) {
        this.drawableIntrinsicSize.setValue(Size.m3659boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m7679getDrawableIntrinsicSizeNHjbRc();
    }
    ...
    protected void onDraw(DrawScope drawScope) {
        ...
        this.drawable.setBounds(0, 0, MathKt.roundToInt(Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc())), MathKt.roundToInt(Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc())));
        try {
            canvas.save();
