...
class SqlTimestampTypeAdapter extends TypeAdapter<Timestamp> {
    ...
    public Timestamp mo7884read(JsonReader jsonReader) throws IOException {
        Date mo7884read = this.dateTypeAdapter.mo7884read(jsonReader);
        if (mo7884read != null) {
            return new Timestamp(mo7884read.getTime());
        }
        return null;
    }
