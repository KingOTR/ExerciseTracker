...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        /* renamed from: read */
        public Map<K, V> mo7884read(JsonReader jsonReader) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K mo7884read = this.keyTypeAdapter.mo7884read(jsonReader);
                    if (construct.put(mo7884read, this.valueTypeAdapter.mo7884read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo7884read);
                    }
                    jsonReader.endArray();
                }
                jsonReader.endArray();
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo7884read2 = this.keyTypeAdapter.mo7884read(jsonReader);
                    if (construct.put(mo7884read2, this.valueTypeAdapter.mo7884read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo7884read2);
                    }
                }
