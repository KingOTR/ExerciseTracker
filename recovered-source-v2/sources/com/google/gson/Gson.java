...
public final class Gson {
    ...
    private static TypeAdapter<AtomicLong> atomicLongAdapter(final TypeAdapter<Number> typeAdapter) {
        return new TypeAdapter<AtomicLong>() { // from class: com.google.gson.Gson.4
            ...
            public AtomicLong mo7884read(JsonReader jsonReader) throws IOException {
                return new AtomicLong(((Number) TypeAdapter.this.mo7884read(jsonReader)).longValue());
            }
        }.nullSafe();
    }
    ...
    private static TypeAdapter<AtomicLongArray> atomicLongArrayAdapter(final TypeAdapter<Number> typeAdapter) {
        return new TypeAdapter<AtomicLongArray>() { // from class: com.google.gson.Gson.5
            ...
            @Override // com.google.gson.TypeAdapter
            /* renamed from: read, reason: avoid collision after fix types in other method */
            public AtomicLongArray mo7884read(JsonReader jsonReader) throws IOException {
                ArrayList arrayList = new ArrayList();
                jsonReader.beginArray();
                while (jsonReader.hasNext()) {
                    arrayList.add(Long.valueOf(((Number) TypeAdapter.this.mo7884read(jsonReader)).longValue()));
                }
                jsonReader.endArray();
    ...
    */
                    ...
                    try {
                        try {
                            ...
                            try {
                                ...
                                T mo7884read = adapter.mo7884read(jsonReader);
                                Class wrap = Primitives.wrap(typeToken.getRawType());
                                if (mo7884read != null && !wrap.isInstance(mo7884read)) {
                                    throw new ClassCastException("Type adapter '" + adapter + "' returned wrong type; requested " + typeToken.getRawType() + " but got instance of " + mo7884read.getClass() + "\nVerify that the adapter was registered for the correct type.");
                                }
                                return mo7884read;
    ...
    static class FutureTypeAdapter<T> extends SerializationDelegatingTypeAdapter<T> {
        ...
        public T mo7884read(JsonReader jsonReader) throws IOException {
            return delegate().mo7884read(jsonReader);
        }
