...
public final class i1 extends SuspendLambda implements Function2 {
    ...
    public i1(AsyncSingleFuture asyncSingleFuture, ExecutorService executorService, CancellableContinuation cancellableContinuation, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new i1(this.a, this.b, this.c, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.a.setCallback(this.b, new p1(new g1(this.c)), new p1(new h1(this.c)));
