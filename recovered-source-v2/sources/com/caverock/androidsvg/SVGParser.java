...
class SVGParser {
    ...
    private static class FontSizeKeywords {
        ...
        static {
            ...
            hashMap.put(CervicalMucusRecord.Sensation.MEDIUM, new SVG.Length(12.0f, SVG.Unit.pt));
    ...
    private static class FontWeightKeywords {
        ...
        static {
            ...
            hashMap.put(TrackingService.BATTERY_NORMAL, valueOf);
            ...
            hashMap.put("500", Integer.valueOf(LogSeverity.ERROR_VALUE));
            hashMap.put("600", 600);
    ...
    public Map<String, String> parseProcessingInstructionAttributes(TextScanner textScanner) {
        ...
        String nextToken = textScanner.nextToken(Tag.KEY_VALUE_SEPARATOR);
        while (nextToken != null) {
            textScanner.consume(Tag.KEY_VALUE_SEPARATOR);
            hashMap.put(nextToken, textScanner.nextQuotedString());
            textScanner.skipWhitespace();
            nextToken = textScanner.nextToken(Tag.KEY_VALUE_SEPARATOR);
        }
        return hashMap;
    }
    ...
    */
        ...
        try {
            switch (AnonymousClass1.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(str).ordinal()]) {
                ...
                case ExerciseSessionRecord.EXERCISE_TYPE_SWIMMING_OPEN_WATER /* 73 */:
                    if (str2.indexOf(124) >= 0 || !VALID_DISPLAY_VALUES.contains(AmbientSessionTagger.CHIP_SEP + str2 + '|')) {
                        return;
                    }
                ...
                case ExerciseSessionRecord.EXERCISE_TYPE_SWIMMING_POOL /* 74 */:
                    if (str2.indexOf(124) >= 0 || !VALID_VISIBILITY_VALUES.contains(AmbientSessionTagger.CHIP_SEP + str2 + '|')) {
                        return;
                    }
                    style.visibility = Boolean.valueOf(str2.equals(Property.VISIBLE));
    ...
    private static void parseFont(SVG.Style style, String str) {
        String nextToken;
        if ("|caption|icon|menu|message-box|small-caption|status-bar|".contains(AmbientSessionTagger.CHIP_SEP + str + '|')) {
            TextScanner textScanner = new TextScanner(str);
            Integer num = null;
            ...
            while (true) {
                ...
                if (nextToken != null) {
                    ...
                    if (!nextToken.equals(TrackingService.BATTERY_NORMAL) && (num != null || (num = FontWeightKeywords.get(nextToken)) == null)) {
            ...
            style.fontWeight = Integer.valueOf(num == null ? LogSeverity.WARNING_VALUE : num.intValue());
            if (fontStyle == null) {
        ...
        while (true) {
            ...
            switch (i2) {
                ...
                case 118:
                    ...
                    break;
                case SleepScience.CYCLE_TYPICAL_MIN /* 90 */:
                case 122:
