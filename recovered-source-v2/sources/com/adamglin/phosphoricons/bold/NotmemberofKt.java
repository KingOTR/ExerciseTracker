...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NotMemberOf", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getNotMemberOf", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_notMemberOf", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NotmemberofKt {
    private static ImageVector _notMemberOf;

    public static final ImageVector getNotMemberOf(BoldGroup boldGroup) {
        ...
        pathBuilder.lineTo(133.31f, 140.0f);
        pathBuilder.horizontalLineTo(200.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.horizontalLineTo(155.13f);
        pathBuilder.lineToRelative(61.75f, -67.93f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 216.07f, 31.12f);
        pathBuilder.close();
        pathBuilder.moveTo(74.13f, 169.42f);
        pathBuilder.arcToRelative(67.75f, 67.75f, 0.0f, false, true, -13.0f, -29.42f);
        pathBuilder.horizontalLineToRelative(39.79f);
        pathBuilder.close();
        pathBuilder.moveTo(61.08f, 116.0f);
        pathBuilder.arcTo(68.1f, 68.1f, 0.0f, false, true, 128.0f, 60.0f);
