...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListMagnifyingGlass", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getListMagnifyingGlass", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listMagnifyingGlass", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListmagnifyingglassKt {
    private static ImageVector _listMagnifyingGlass;

    public static final ImageVector getListMagnifyingGlass(BoldGroup boldGroup) {
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(240.49f, 200.49f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, 0.0f);
        pathBuilder.lineToRelative(-18.08f, -18.08f);
        pathBuilder.arcToRelative(44.0f, 44.0f, 0.0f, true, true, 17.0f, -17.0f);
        pathBuilder.lineToRelative(18.08f, 18.07f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 240.49f, 200.49f);
        pathBuilder.close();
        pathBuilder.moveTo(184.0f, 164.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, true, false, -20.0f, -20.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 184.0f, 164.0f);
        pathBuilder.close();
