...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MicrosoftWordLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getMicrosoftWordLogo", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_microsoftWordLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MicrosoftwordlogoKt {
    private static ImageVector _microsoftWordLogo;

    public static final ImageVector getMicrosoftWordLogo(BoldGroup boldGroup) {
        ...
        pathBuilder.verticalLineToRelative(40.0f);
        pathBuilder.close();
        pathBuilder.moveTo(64.36f, 154.91f);
        pathBuilder.lineToRelative(-12.0f, -48.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 23.28f, -5.82f);
        pathBuilder.lineToRelative(4.13f, 16.53f);
        pathBuilder.lineToRelative(1.5f, -3.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 21.46f, 0.0f);
        pathBuilder.lineToRelative(1.5f, 3.0f);
        pathBuilder.lineToRelative(4.13f, -16.53f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 23.28f, 5.82f);
        pathBuilder.lineToRelative(-12.0f, 48.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -10.33f, 9.0f);
        pathBuilder.arcTo(11.62f, 11.62f, 0.0f, false, true, 108.0f, 164.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -10.73f, -6.63f);
        pathBuilder.lineTo(92.0f, 146.83f);
        pathBuilder.lineToRelative(-5.27f, 10.54f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -22.37f, -2.46f);
        pathBuilder.close();
