...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Baby", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getBaby", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_baby", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BabyKt {
    private static ImageVector _baby;

    public static final ImageVector getBaby(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 92.0f, 144.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(149.6f, 161.85f);
        ...
        pathBuilder.arcToRelative(84.08f, 84.08f, 0.0f, false, false, -82.0f, -83.95f);
        pathBuilder.curveToRelative(-9.46f, 14.2f, -10.0f, 27.28f, -10.0f, 28.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 136.0f, 72.0f);
        ...
        pathBuilder.curveToRelative(0.0f, -0.63f, 0.1f, -10.48f, 5.0f, -23.52f);
        pathBuilder.arcTo(84.0f, 84.0f, 0.0f, true, false, 212.0f, 128.0f);
        pathBuilder.close();
