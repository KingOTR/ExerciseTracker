...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CaretDoubleDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getCaretDoubleDown", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_caretDoubleDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CaretdoubledownKt {
    private static ImageVector _caretDoubleDown;

    public static final ImageVector getCaretDoubleDown(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(216.49f, 127.51f);
        ...
        pathBuilder.lineTo(128.0f, 199.0f);
        pathBuilder.lineToRelative(71.51f, -71.52f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 216.49f, 127.51f);
        pathBuilder.close();
        pathBuilder.moveTo(119.49f, 144.51f);
        ...
        pathBuilder.lineTo(128.0f, 119.0f);
        pathBuilder.lineTo(56.49f, 47.51f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -17.0f, 17.0f);
        pathBuilder.close();
