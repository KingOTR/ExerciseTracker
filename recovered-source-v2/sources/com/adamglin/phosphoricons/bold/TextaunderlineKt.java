...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TextAUnderline", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getTextAUnderline", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_textAUnderline", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TextaunderlineKt {
    private static ImageVector _textAUnderline;

    public static final ImageVector getTextAUnderline(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(58.89f, 178.86f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 16.0f, -5.75f);
        pathBuilder.lineTo(90.44f, 140.0f);
        ...
        pathBuilder.lineToRelative(-64.0f, 136.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 58.89f, 178.86f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 60.18f);
        pathBuilder.lineTo(154.27f, 116.0f);
        pathBuilder.horizontalLineTo(101.73f);
        pathBuilder.close();
