...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Bank", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getBank", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bank", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BankKt {
    private static ImageVector _bank;

    public static final ImageVector getBank(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(24.0f, 108.0f);
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 6.29f, -22.22f);
        pathBuilder.lineToRelative(-104.0f, -64.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -12.58f, 0.0f);
        pathBuilder.lineToRelative(-104.0f, 64.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 24.0f, 108.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(140.0f, 108.0f);
        pathBuilder.verticalLineToRelative(48.0f);
        pathBuilder.lineTo(116.0f, 156.0f);
        pathBuilder.lineTo(116.0f, 108.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(189.6f, 84.0f);
        pathBuilder.lineTo(66.4f, 84.0f);
        pathBuilder.close();
