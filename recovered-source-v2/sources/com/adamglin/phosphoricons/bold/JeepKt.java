...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Jeep", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getJeep", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_jeep", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class JeepKt {
    private static ImageVector _jeep;

    public static final ImageVector getJeep(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(240.0f, 84.0f);
        pathBuilder.horizontalLineToRelative(-6.3f);
        pathBuilder.lineToRelative(-8.61f, -40.19f);
        pathBuilder.arcTo(20.11f, 20.11f, 0.0f, false, false, 205.53f, 28.0f);
        pathBuilder.lineTo(50.47f, 28.0f);
        pathBuilder.arcTo(20.11f, 20.11f, 0.0f, false, false, 30.91f, 43.81f);
        pathBuilder.lineTo(22.3f, 84.0f);
        ...
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, -20.0f);
        pathBuilder.lineTo(236.0f, 108.0f);
        pathBuilder.horizontalLineToRelative(4.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(53.7f, 52.0f);
        pathBuilder.lineTo(202.3f, 52.0f);
        pathBuilder.lineToRelative(6.86f, 32.0f);
        pathBuilder.lineTo(46.84f, 84.0f);
        pathBuilder.close();
