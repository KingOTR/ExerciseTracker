...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"LinkSimple", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getLinkSimple", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_linkSimple", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LinksimpleKt {
    private static ImageVector _linkSimple;

    public static final ImageVector getLinkSimple(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(87.5f, 151.52f);
        pathBuilder.lineToRelative(64.0f, -64.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, 17.0f);
        pathBuilder.lineToRelative(-64.0f, 64.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, -17.0f);
        pathBuilder.close();
        pathBuilder.moveTo(218.5f, 37.52f);
        pathBuilder.arcToRelative(60.08f, 60.08f, 0.0f, false, false, -84.87f, 0.0f);
        pathBuilder.lineTo(103.51f, 67.61f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 17.0f, 17.0f);
        pathBuilder.lineToRelative(30.07f, -30.06f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, false, true, 50.93f, 50.92f);
        pathBuilder.lineTo(171.4f, 135.52f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, false, 17.0f, 17.0f);
        pathBuilder.lineToRelative(30.08f, -30.06f);
        pathBuilder.arcTo(60.09f, 60.09f, 0.0f, false, false, 218.45f, 37.55f);
        pathBuilder.close();
        pathBuilder.moveTo(135.52f, 171.4f);
