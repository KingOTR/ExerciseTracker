...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SelectionAll", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getSelectionAll", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_selectionAll", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SelectionallKt {
    private static ImageVector _selectionAll;

    public static final ImageVector getSelectionAll(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(100.0f, 40.0f);
        ...
        pathBuilder.lineTo(112.0f, 52.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 100.0f, 40.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(228.0f, 184.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 216.0f, 172.0f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 156.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 12.0f, -12.0f);
        pathBuilder.lineTo(52.0f, 112.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -24.0f, 0.0f);
        pathBuilder.verticalLineToRelative(32.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 40.0f, 156.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 40.0f, 84.0f);
        pathBuilder.close();
