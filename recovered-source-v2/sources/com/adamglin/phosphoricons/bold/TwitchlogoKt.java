...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TwitchLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getTwitchLogo", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_twitchLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TwitchlogoKt {
    private static ImageVector _twitchLogo;

    public static final ImageVector getTwitchLogo(BoldGroup boldGroup) {
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 19.68f, 9.22f);
        pathBuilder.lineTo(124.34f, 212.0f);
        pathBuilder.lineTo(165.1f, 212.0f);
        pathBuilder.arcToRelative(20.06f, 20.06f, 0.0f, false, false, 12.81f, -4.64f);
        pathBuilder.lineToRelative(42.89f, -35.74f);
        pathBuilder.arcToRelative(19.93f, 19.93f, 0.0f, false, false, 7.2f, -15.37f);
        pathBuilder.lineTo(228.0f, 48.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 208.0f, 28.0f);
        pathBuilder.close();
        pathBuilder.moveTo(204.0f, 154.38f);
        pathBuilder.lineTo(163.66f, 188.0f);
        pathBuilder.lineTo(120.0f, 188.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -7.68f, 2.78f);
        pathBuilder.lineTo(84.0f, 214.38f);
        pathBuilder.lineTo(84.0f, 200.0f);
