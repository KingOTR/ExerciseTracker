...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Cigarette", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getCigarette", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cigarette", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CigaretteKt {
    private static ImageVector _cigarette;

    public static final ImageVector getCigarette(BoldGroup boldGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(153.67f, 55.89f);
        pathBuilder.curveToRelative(7.53f, -12.71f, 7.12f, -19.63f, 5.07f, -21.1f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 168.67f, 13.0f);
        pathBuilder.arcToRelative(25.9f, 25.9f, 0.0f, false, true, 13.8f, 15.79f);
        pathBuilder.curveToRelative(3.6f, 10.92f, 0.86f, 24.17f, -8.14f, 39.38f);
        pathBuilder.curveToRelative(-7.53f, 12.7f, -7.12f, 19.63f, -5.07f, 21.1f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -9.93f, 21.84f);
        pathBuilder.arcToRelative(26.0f, 26.0f, 0.0f, false, true, -13.8f, -15.79f);
        pathBuilder.curveTo(141.93f, 84.34f, 144.67f, 71.09f, 153.67f, 55.89f);
        pathBuilder.close();
