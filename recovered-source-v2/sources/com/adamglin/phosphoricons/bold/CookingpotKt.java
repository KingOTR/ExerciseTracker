...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CookingPot", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getCookingPot", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cookingPot", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CookingpotKt {
    private static ImageVector _cookingPot;

    public static final ImageVector getCookingPot(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(253.76f, 93.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 237.0f, 90.24f);
        pathBuilder.lineToRelative(-9.0f, 6.44f);
        ...
        pathBuilder.lineTo(28.0f, 96.68f);
        pathBuilder.lineToRelative(-9.0f, -6.44f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, true, false, 5.0f, 109.76f);
        pathBuilder.lineToRelative(23.0f, 16.42f);
        ...
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, false, false, 36.0f, -36.0f);
        pathBuilder.lineTo(228.0f, 126.18f);
        pathBuilder.lineToRelative(23.0f, -16.42f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 253.76f, 93.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(76.0f, 16.0f);
