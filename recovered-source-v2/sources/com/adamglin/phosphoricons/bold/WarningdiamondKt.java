...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"WarningDiamond", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getWarningDiamond", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_warningDiamond", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class WarningdiamondKt {
    private static ImageVector _warningDiamond;

    public static final ImageVector getWarningDiamond(BoldGroup boldGroup) {
        ...
        pathBuilder.arcToRelative(19.86f, 19.86f, 0.0f, false, true, -5.84f, 14.11f);
        pathBuilder.lineToRelative(-96.0f, 96.06f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, -28.21f, 0.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.lineToRelative(-96.0f, -96.06f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 0.0f, -28.22f);
        pathBuilder.lineToRelative(96.05f, -96.06f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 28.21f, 0.0f);
        pathBuilder.lineToRelative(96.06f, 96.06f);
        pathBuilder.arcTo(19.86f, 19.86f, 0.0f, false, true, 244.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(218.32f, 128.0f);
        pathBuilder.lineTo(128.0f, 37.67f);
        pathBuilder.lineTo(37.68f, 128.0f);
        pathBuilder.lineTo(128.0f, 218.33f);
        pathBuilder.close();
