...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NumberSquareThree", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getNumberSquareThree", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_numberSquareThree", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NumbersquarethreeKt {
    private static ImageVector _numberSquareThree;

    public static final ImageVector getNumberSquareThree(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, true, true, 95.43f, 176.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 17.14f, -16.79f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, true, false, 124.0f, 132.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -9.83f, -18.88f);
        pathBuilder.lineTo(129.0f, 92.0f);
        pathBuilder.lineTo(104.0f, 92.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 92.0f, 80.0f);
        pathBuilder.close();
