...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Briefcase", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getBriefcase", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_briefcase", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BriefcaseKt {
    private static ImageVector _briefcase;

    public static final ImageVector getBriefcase(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 100.0f, 100.0f);
        pathBuilder.close();
        pathBuilder.moveTo(236.0f, 68.0f);
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 40.0f, 48.0f);
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 236.0f, 68.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.0f, 4.0f);
        pathBuilder.close();
        pathBuilder.moveTo(44.0f, 72.0f);
        pathBuilder.verticalLineToRelative(35.23f);
        pathBuilder.arcTo(180.06f, 180.06f, 0.0f, false, false, 128.0f, 128.0f);
        pathBuilder.arcToRelative(180.0f, 180.0f, 0.0f, false, false, 84.0f, -20.78f);
        pathBuilder.verticalLineTo(72.0f);
        pathBuilder.close();
        pathBuilder.moveTo(212.0f, 192.0f);
        pathBuilder.verticalLineTo(133.94f);
        pathBuilder.arcTo(204.27f, 204.27f, 0.0f, false, true, 128.0f, 152.0f);
        pathBuilder.arcToRelative(204.21f, 204.21f, 0.0f, false, true, -84.0f, -18.06f);
