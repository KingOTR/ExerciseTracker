...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsInCardinal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getArrowsInCardinal", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsInCardinal", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsincardinalKt {
    private static ImageVector _arrowsInCardinal;

    public static final ImageVector getArrowsInCardinal(BoldGroup boldGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(136.51f, 151.49f);
        ...
        pathBuilder.lineTo(116.0f, 189.0f);
        pathBuilder.verticalLineToRelative(43.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f);
        pathBuilder.lineTo(140.0f, 189.0f);
        pathBuilder.lineToRelative(11.51f, 11.52f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 17.0f, -17.0f);
        pathBuilder.close();
        pathBuilder.moveTo(232.0f, 116.0f);
        pathBuilder.lineTo(189.0f, 116.0f);
        ...
        pathBuilder.lineToRelative(32.0f, 32.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 17.0f, -17.0f);
        pathBuilder.lineTo(189.0f, 140.0f);
        pathBuilder.horizontalLineToRelative(43.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(104.49f, 119.51f);
        pathBuilder.lineTo(72.49f, 87.51f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -17.0f, 17.0f);
        pathBuilder.lineTo(67.0f, 116.0f);
        pathBuilder.lineTo(24.0f, 116.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f);
        pathBuilder.lineTo(67.0f, 140.0f);
        pathBuilder.lineTo(55.51f, 151.51f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 17.0f, 17.0f);
        pathBuilder.lineToRelative(32.0f, -32.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 104.49f, 119.51f);
        pathBuilder.close();
