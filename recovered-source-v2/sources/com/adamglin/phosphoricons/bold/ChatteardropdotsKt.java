...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ChatTeardropDots", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getChatTeardropDots", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_chatTeardropDots", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ChatteardropdotsKt {
    private static ImageVector _chatTeardropDots;

    public static final ImageVector getChatTeardropDots(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(132.0f, 20.0f);
        pathBuilder.arcTo(104.11f, 104.11f, 0.0f, false, false, 28.0f, 124.0f);
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 124.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(172.0f, 128.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 172.0f, 128.0f);
        pathBuilder.close();
