...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SealQuestion", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getSealQuestion", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sealQuestion", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealquestionKt {
    private static ImageVector _sealQuestion;

    public static final ImageVector getSealQuestion(BoldGroup boldGroup) {
        ...
        pathBuilder.curveToRelative(0.0f, 18.37f, -13.69f, 33.88f, -32.27f, 38.56f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 116.0f, 144.0f);
        ...
        pathBuilder.verticalLineToRelative(-4.0f);
        pathBuilder.curveToRelative(0.0f, -22.06f, 19.74f, -40.0f, 44.0f, -40.0f);
        pathBuilder.reflectiveCurveTo(172.0f, 85.94f, 172.0f, 108.0f);
        pathBuilder.close();
