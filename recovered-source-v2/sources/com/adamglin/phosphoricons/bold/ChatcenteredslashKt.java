...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ChatCenteredSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getChatCenteredSlash", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_chatCenteredSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ChatcenteredslashKt {
    private static ImageVector _chatCenteredSlash;

    public static final ImageVector getChatCenteredSlash(BoldGroup boldGroup) {
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -20.29f, 4.38f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 20.0f, 56.0f);
        pathBuilder.verticalLineTo(184.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, 20.0f);
        pathBuilder.horizontalLineTo(98.11f);
        pathBuilder.lineToRelative(12.52f, 21.92f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, false, 34.73f, 0.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(150.93f, 180.0f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 105.07f, 180.0f);
        pathBuilder.horizontalLineTo(44.0f);
        pathBuilder.verticalLineTo(60.0f);
        pathBuilder.horizontalLineToRelative(6.0f);
        pathBuilder.lineToRelative(109.1f, 120.0f);
        pathBuilder.close();
        pathBuilder.moveTo(236.0f, 56.0f);
        pathBuilder.verticalLineTo(174.14f);
