...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Bus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getBus", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BusKt {
    private static ImageVector _bus;

    public static final ImageVector getBus(BoldGroup boldGroup) {
        ...
        pathBuilder.lineTo(84.0f, 228.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, -20.0f);
        ...
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 184.0f, 28.0f);
        pathBuilder.close();
        pathBuilder.moveTo(60.0f, 168.0f);
        pathBuilder.lineTo(60.0f, 112.0f);
        ...
        pathBuilder.lineTo(60.0f, 88.0f);
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 108.0f, 140.0f);
        pathBuilder.close();
        pathBuilder.moveTo(180.0f, 140.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 180.0f, 140.0f);
        pathBuilder.close();
        pathBuilder.moveTo(256.0f, 80.0f);
