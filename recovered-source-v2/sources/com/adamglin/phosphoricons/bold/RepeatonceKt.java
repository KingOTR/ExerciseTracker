...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"RepeatOnce", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getRepeatOnce", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_repeatOnce", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RepeatonceKt {
    private static ImageVector _repeatOnce;

    public static final ImageVector getRepeatOnce(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(76.08f, 76.08f, 0.0f, false, true, 96.0f, 52.0f);
        ...
        pathBuilder.lineTo(195.0f, 76.0f);
        ...
        pathBuilder.lineTo(61.0f, 180.0f);
        pathBuilder.lineToRelative(3.52f, -3.51f);
        ...
        pathBuilder.lineToRelative(24.0f, 24.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, false, 17.0f, -17.0f);
        pathBuilder.lineTo(61.0f, 204.0f);
        pathBuilder.horizontalLineToRelative(99.0f);
        pathBuilder.arcToRelative(76.08f, 76.08f, 0.0f, false, false, 76.0f, -76.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 224.0f, 116.0f);
        pathBuilder.close();
        pathBuilder.moveTo(136.0f, 164.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 12.0f, -12.0f);
        pathBuilder.lineTo(148.0f, 104.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -17.36f, -10.74f);
        pathBuilder.lineToRelative(-16.0f, 8.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 9.36f, 22.0f);
        pathBuilder.lineTo(124.0f, 152.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 136.0f, 164.0f);
        pathBuilder.close();
