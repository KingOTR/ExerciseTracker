...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ScanSmiley", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getScanSmiley", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_scanSmiley", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ScansmileyKt {
    private static ImageVector _scanSmiley;

    public static final ImageVector getScanSmiley(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 216.0f, 176.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 12.0f, 12.0f);
        pathBuilder.lineTo(68.0f, 228.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 80.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 52.0f, 68.0f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 40.0f, 80.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 104.0f, 104.0f);
        pathBuilder.close();
        pathBuilder.moveTo(152.0f, 104.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, true, false, 16.0f, 16.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 152.0f, 104.0f);
        pathBuilder.close();
