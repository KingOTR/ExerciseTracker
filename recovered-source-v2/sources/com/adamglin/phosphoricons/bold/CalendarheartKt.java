...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CalendarHeart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getCalendarHeart", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendarHeart", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarheartKt {
    private static ImageVector _calendarHeart;

    public static final ImageVector getCalendarHeart(BoldGroup boldGroup) {
        ...
        pathBuilder.arcToRelative(35.86f, 35.86f, 0.0f, false, false, -24.0f, 9.19f);
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 68.0f, 120.0f);
        pathBuilder.curveToRelative(0.0f, 17.0f, 9.53f, 33.56f, 28.32f, 49.22f);
        pathBuilder.arcToRelative(151.47f, 151.47f, 0.0f, false, false, 26.31f, 17.51f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 10.74f, 0.0f);
        pathBuilder.arcToRelative(151.47f, 151.47f, 0.0f, false, false, 26.31f, -17.51f);
        pathBuilder.curveTo(178.47f, 153.56f, 188.0f, 137.0f, 188.0f, 120.0f);
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 152.0f, 84.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 162.29f);
        pathBuilder.curveToRelative(-13.15f, -7.86f, -36.0f, -25.06f, -36.0f, -42.29f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f);
        pathBuilder.curveTo(164.0f, 137.23f, 141.14f, 154.44f, 128.0f, 162.29f);
        pathBuilder.close();
