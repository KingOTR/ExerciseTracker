...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BoxArrowDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getBoxArrowDown", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_boxArrowDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BoxarrowdownKt {
    private static ImageVector _boxArrowDown;

    public static final ImageVector getBoxArrowDown(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(226.73f, 66.63f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 226.73f, 66.63f);
        pathBuilder.close();
        pathBuilder.moveTo(192.58f, 52.0f);
        pathBuilder.lineToRelative(6.0f, 12.0f);
        pathBuilder.lineTo(57.42f, 64.0f);
        pathBuilder.lineToRelative(6.0f, -12.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(168.49f, 139.51f);
        ...
        pathBuilder.lineTo(116.0f, 151.0f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 168.49f, 139.51f);
        pathBuilder.close();
