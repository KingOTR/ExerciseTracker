...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Virus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getVirus", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_virus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class VirusKt {
    private static ImageVector _virus;

    public static final ImageVector getVirus(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 168.0f, 108.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(227.28f, 140.0f);
        pathBuilder.arcToRelative(99.62f, 99.62f, 0.0f, false, true, -20.62f, 49.69f);
        pathBuilder.lineToRelative(9.83f, 9.82f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, 17.0f);
        pathBuilder.lineToRelative(-9.82f, -9.83f);
        pathBuilder.arcTo(99.62f, 99.62f, 0.0f, false, true, 140.0f, 227.28f);
        pathBuilder.lineTo(140.0f, 240.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f);
        pathBuilder.lineTo(116.0f, 227.28f);
        pathBuilder.arcToRelative(99.62f, 99.62f, 0.0f, false, true, -49.69f, -20.62f);
        pathBuilder.lineToRelative(-9.82f, 9.83f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, -17.0f);
        pathBuilder.lineToRelative(9.83f, -9.82f);
        pathBuilder.arcTo(99.62f, 99.62f, 0.0f, false, true, 28.72f, 140.0f);
        pathBuilder.lineTo(16.0f, 140.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, -24.0f);
        pathBuilder.lineTo(28.72f, 116.0f);
        pathBuilder.arcTo(99.62f, 99.62f, 0.0f, false, true, 49.34f, 66.31f);
        pathBuilder.lineToRelative(-9.83f, -9.82f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, -17.0f);
        pathBuilder.lineToRelative(9.82f, 9.83f);
        pathBuilder.arcTo(99.62f, 99.62f, 0.0f, false, true, 116.0f, 28.72f);
        pathBuilder.lineTo(116.0f, 16.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f);
        pathBuilder.lineTo(140.0f, 28.72f);
        pathBuilder.arcToRelative(99.62f, 99.62f, 0.0f, false, true, 49.69f, 20.62f);
        pathBuilder.lineToRelative(9.82f, -9.83f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, 17.0f);
        pathBuilder.lineToRelative(-9.83f, 9.82f);
        pathBuilder.arcTo(99.62f, 99.62f, 0.0f, false, true, 227.28f, 116.0f);
        ...
        pathBuilder.arcTo(76.08f, 76.08f, 0.0f, false, false, 204.0f, 128.0f);
        pathBuilder.close();
