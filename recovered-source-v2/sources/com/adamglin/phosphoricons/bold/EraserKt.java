...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Eraser", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getEraser", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_eraser", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class EraserKt {
    private static ImageVector _eraser;

    public static final ImageVector getEraser(BoldGroup boldGroup) {
        ...
        pathBuilder.horizontalLineTo(141.0f);
        pathBuilder.lineToRelative(86.84f, -86.84f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, false, 0.0f, -39.6f);
        pathBuilder.lineTo(186.43f, 36.19f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, false, -39.6f, 0.0f);
        pathBuilder.lineTo(28.19f, 154.82f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, false, 0.0f, 39.6f);
        pathBuilder.lineToRelative(30.06f, 30.07f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 66.74f, 228.0f);
        pathBuilder.horizontalLineTo(216.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(163.8f, 53.16f);
        ...
        pathBuilder.lineTo(160.0f, 151.0f);
        pathBuilder.lineToRelative(-47.0f, -47.0f);
        pathBuilder.close();
        pathBuilder.moveTo(71.71f, 204.0f);
        pathBuilder.lineTo(45.16f, 177.45f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -5.65f);
        pathBuilder.lineTo(96.0f, 121.0f);
        pathBuilder.lineToRelative(47.0f, 47.0f);
