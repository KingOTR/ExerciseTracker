...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MagnetStraight", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getMagnetStraight", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_magnetStraight", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MagnetstraightKt {
    private static ImageVector _magnetStraight;

    public static final ImageVector getMagnetStraight(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 96.0f, 36.0f);
        pathBuilder.lineTo(56.0f, 36.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 36.0f, 56.0f);
        pathBuilder.verticalLineToRelative(88.0f);
        pathBuilder.arcToRelative(92.0f, 92.0f, 0.0f, false, false, 92.0f, 92.0f);
        pathBuilder.horizontalLineToRelative(0.71f);
        pathBuilder.curveToRelative(50.34f, -0.38f, 91.3f, -42.1f, 91.3f, -93.0f);
        pathBuilder.lineTo(220.01f, 56.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(128.52f, 212.0f);
        ...
        pathBuilder.curveTo(196.0f, 180.77f, 165.73f, 211.72f, 128.52f, 212.0f);
        pathBuilder.close();
