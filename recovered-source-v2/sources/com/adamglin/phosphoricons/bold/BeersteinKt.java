...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BeerStein", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getBeerStein", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_beerStein", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BeersteinKt {
    private static ImageVector _beerStein;

    public static final ImageVector getBeerStein(BoldGroup boldGroup) {
        ...
        pathBuilder.curveTo(137.77f, 17.78f, 121.18f, 12.0f, 104.0f, 12.0f);
        pathBuilder.curveTo(66.5f, 12.0f, 36.0f, 38.92f, 36.0f, 72.0f);
        ...
        pathBuilder.lineTo(244.0f, 112.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 216.0f, 84.0f);
        pathBuilder.close();
        pathBuilder.moveTo(104.0f, 36.0f);
        pathBuilder.curveToRelative(12.85f, 0.0f, 25.0f, 4.62f, 33.44f, 12.67f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 8.3f, 3.33f);
        pathBuilder.lineTo(160.0f, 52.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 19.6f, 16.0f);
        pathBuilder.lineTo(60.28f, 68.0f);
        pathBuilder.curveTo(62.72f, 50.0f, 81.39f, 36.0f, 104.0f, 36.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(156.0f, 120.0f);
        pathBuilder.verticalLineToRelative(56.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f);
