...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsDownUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getArrowsDownUp", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsDownUp", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsdownupKt {
    private static ImageVector _arrowsDownUp;

    public static final ImageVector getArrowsDownUp(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(120.49f, 167.51f);
        ...
        pathBuilder.lineTo(68.0f, 179.0f);
        pathBuilder.lineTo(68.0f, 48.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f);
        pathBuilder.lineTo(92.0f, 179.0f);
        pathBuilder.lineToRelative(11.51f, -11.52f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 120.49f, 167.51f);
        pathBuilder.close();
        pathBuilder.moveTo(216.49f, 71.51f);
        pathBuilder.lineTo(184.49f, 39.51f);
        ...
        pathBuilder.lineTo(164.0f, 77.0f);
        pathBuilder.lineTo(164.0f, 208.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f);
        pathBuilder.lineTo(188.0f, 77.0f);
        pathBuilder.lineToRelative(11.51f, 11.52f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 17.0f, -17.0f);
        pathBuilder.close();
