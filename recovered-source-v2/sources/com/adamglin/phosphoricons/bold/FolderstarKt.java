...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FolderStar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getFolderStar", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_folderStar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FolderstarKt {
    private static ImageVector _folderStar;

    public static final ImageVector getFolderStar(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(112.56f, 196.0f);
        ...
        pathBuilder.horizontalLineTo(133.39f);
        ...
        pathBuilder.horizontalLineTo(90.61f);
        pathBuilder.lineToRelative(10.67f, 12.0f);
        pathBuilder.horizontalLineTo(44.0f);
        pathBuilder.close();
        pathBuilder.moveTo(243.44f, 158.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -10.52f, -8.34f);
        pathBuilder.lineToRelative(-27.42f, -2.12f);
        pathBuilder.lineTo(195.0f, 123.25f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -22.0f, 0.0f);
        pathBuilder.lineTo(162.5f, 147.53f);
        pathBuilder.lineToRelative(-27.42f, 2.12f);
        ...
        pathBuilder.lineTo(184.0f, 212.46f);
        pathBuilder.lineToRelative(23.58f, 13.88f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 17.73f, -13.22f);
        pathBuilder.lineToRelative(-6.25f, -25.26f);
        pathBuilder.lineToRelative(20.58f, -17.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 243.44f, 158.0f);
        pathBuilder.close();
        pathBuilder.moveTo(198.0f, 174.16f);
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 10.1f, -7.21f);
