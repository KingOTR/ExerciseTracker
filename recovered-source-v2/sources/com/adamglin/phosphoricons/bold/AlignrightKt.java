...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"AlignRight", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getAlignRight", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_alignRight", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class AlignrightKt {
    private static ImageVector _alignRight;

    public static final ImageVector getAlignRight(BoldGroup boldGroup) {
        ...
        pathBuilder.lineTo(228.0f, 216.0f);
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 80.0f, 44.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(188.0f, 156.0f);
        pathBuilder.verticalLineToRelative(36.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, -20.0f, 20.0f);
        pathBuilder.lineTo(40.0f, 212.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, -20.0f, -20.0f);
        pathBuilder.lineTo(20.0f, 156.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 20.0f, -20.0f);
        pathBuilder.lineTo(168.0f, 136.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 188.0f, 156.0f);
        pathBuilder.close();
