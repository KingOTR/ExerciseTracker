...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CursorClick", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getCursorClick", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cursorClick", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CursorclickKt {
    private static ImageVector _cursorClick;

    public static final ImageVector getCursorClick(BoldGroup boldGroup) {
        ...
        pathBuilder.lineToRelative(-46.82f, -46.82f);
        pathBuilder.lineToRelative(37.92f, -13.51f);
        ...
        pathBuilder.arcToRelative(20.47f, 20.47f, 0.0f, false, false, -3.73f, 0.35f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 112.35f, 162.0f);
        pathBuilder.curveToRelative(-0.11f, 0.25f, -0.2f, 0.5f, -0.3f, 0.76f);
        pathBuilder.lineTo(100.4f, 195.5f);
        pathBuilder.lineTo(54.29f, 54.29f);
        pathBuilder.lineTo(195.5f, 100.4f);
        pathBuilder.lineToRelative(-32.71f, 11.65f);
        pathBuilder.curveToRelative(-0.25f, 0.09f, -0.51f, 0.19f, -0.76f, 0.3f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, false, -6.16f, 32.48f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.lineToRelative(48.48f, 48.48f);
        pathBuilder.close();
        pathBuilder.moveTo(84.0f, 16.0f);
        pathBuilder.lineTo(84.0f, 12.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f);
        pathBuilder.verticalLineToRelative(4.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(12.0f, 108.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, -24.0f);
        pathBuilder.horizontalLineToRelative(4.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, 24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(120.62f, 24.21f);
        pathBuilder.lineToRelative(4.0f, -12.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 22.77f, 7.58f);
        pathBuilder.lineToRelative(-4.0f, 12.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -22.77f, -7.58f);
        pathBuilder.close();
        pathBuilder.moveTo(39.39f, 128.21f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -7.59f, 15.17f);
        pathBuilder.lineToRelative(-12.0f, 4.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, -7.59f, -22.76f);
        pathBuilder.lineToRelative(12.0f, -4.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 39.39f, 128.21f);
        pathBuilder.close();
