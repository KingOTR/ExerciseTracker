...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BellSimpleRinging", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getBellSimpleRinging", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bellSimpleRinging", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BellsimpleringingKt {
    private static ImageVector _bellSimpleRinging;

    public static final ImageVector getBellSimpleRinging(BoldGroup boldGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(230.94f, 58.48f);
        pathBuilder.arcTo(115.25f, 115.25f, 0.0f, false, false, 190.4f, 13.86f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, false, -12.8f, 20.29f);
        pathBuilder.arcToRelative(90.1f, 90.1f, 0.0f, false, true, 32.0f, 35.38f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 220.3f, 76.0f);
        pathBuilder.arcToRelative(11.86f, 11.86f, 0.0f, false, false, 5.51f, -1.35f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 230.94f, 58.48f);
        pathBuilder.close();
