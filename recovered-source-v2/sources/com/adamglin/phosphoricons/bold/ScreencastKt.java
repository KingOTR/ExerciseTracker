...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Screencast", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getScreencast", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_screencast", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ScreencastKt {
    private static ImageVector _screencast;

    public static final ImageVector getScreencast(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 44.0f, 40.0f);
        pathBuilder.lineTo(212.0f, 40.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 232.0f, 60.0f);
        pathBuilder.close();
        pathBuilder.moveTo(36.0f, 176.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.0f, 4.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 36.0f, 176.0f);
        pathBuilder.close();
        pathBuilder.moveTo(36.0f, 136.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f);
        pathBuilder.arcToRelative(44.05f, 44.05f, 0.0f, false, true, 44.0f, 44.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f);
        pathBuilder.arcTo(68.07f, 68.07f, 0.0f, false, false, 36.0f, 136.0f);
        pathBuilder.close();
        pathBuilder.moveTo(36.0f, 96.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f);
        pathBuilder.arcToRelative(84.09f, 84.09f, 0.0f, false, true, 84.0f, 84.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f);
        pathBuilder.arcTo(108.12f, 108.12f, 0.0f, false, false, 36.0f, 96.0f);
        pathBuilder.close();
