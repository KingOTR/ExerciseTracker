...
/* compiled from: Sealpercent.kt */
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SealPercent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getSealPercent", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sealPercent", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealpercentKt {
    private static ImageVector _sealPercent;

    public static final ImageVector getSealPercent(BoldGroup boldGroup) {
        Intrinsics.checkNotNullParameter(boldGroup, "<this>");
        ImageVector imageVector = _sealPercent;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        float f = (float) 24.0d;
        ImageVector.Builder builder = new ImageVector.Builder("SealPercent", Dp.m6303constructorimpl(f), Dp.m6303constructorimpl(f), 256.0f, 256.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(-4.64f, -0.07f, -9.9f, -0.15f, -12.47f, -1.21f);
        ...
        pathBuilder.curveToRelative(-2.82f, 6.8f, -2.93f, 14.17f, -3.0f, 21.29f);
        ...
        pathBuilder.curveToRelative(-7.0f, 2.92f, -12.73f, 8.38f, -17.76f, 13.2f);
        ...
        pathBuilder.curveToRelative(-5.0f, -4.82f, -10.72f, -10.28f, -17.76f, -13.2f);
        pathBuilder.curveToRelative(-6.8f, -2.81f, -14.17f, -2.92f, -21.29f, -3.0f);
        ...
        pathBuilder.curveToRelative(-2.91f, -7.0f, -8.37f, -12.74f, -13.19f, -17.76f);
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 80.0f, 96.0f);
        pathBuilder.close();
        pathBuilder.moveTo(176.0f, 160.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 176.0f, 160.0f);
        pathBuilder.close();
        pathBuilder.moveTo(176.49f, 79.51f);
        ...
        pathBuilder.lineToRelative(80.0f, -80.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 176.49f, 79.51f);
        pathBuilder.close();
