...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CurrencyJpy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getCurrencyJpy", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_currencyJpy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CurrencyjpyKt {
    private static ImageVector _currencyJpy;

    public static final ImageVector getCurrencyJpy(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(209.29f, 55.6f);
        pathBuilder.lineToRelative(-56.0f, 68.4f);
        ...
        pathBuilder.horizontalLineTo(80.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, -24.0f);
        pathBuilder.horizontalLineToRelative(22.68f);
        pathBuilder.lineToRelative(-56.0f, -68.4f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, true, true, 65.29f, 40.4f);
        pathBuilder.lineTo(128.0f, 117.05f);
        pathBuilder.lineTo(190.71f, 40.4f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 18.58f, 15.2f);
        pathBuilder.close();
