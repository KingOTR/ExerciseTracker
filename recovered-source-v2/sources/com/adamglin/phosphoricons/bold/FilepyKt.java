...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FilePy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getFilePy", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_filePy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilepyKt {
    private static ImageVector _filePy;

    public static final ImageVector getFilePy(BoldGroup boldGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(144.0f, 187.44f);
        pathBuilder.lineTo(144.0f, 208.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f);
        pathBuilder.lineTo(120.0f, 187.44f);
        pathBuilder.lineToRelative(-18.18f, -29.08f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 20.36f, -12.72f);
        pathBuilder.lineTo(132.0f, 161.36f);
        pathBuilder.lineToRelative(9.82f, -15.72f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 20.36f, 12.72f);
        pathBuilder.close();
