...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ShieldStar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getShieldStar", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_shieldStar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ShieldstarKt {
    private static ImageVector _shieldStar;

    public static final ImageVector getShieldStar(BoldGroup boldGroup) {
        ...
        pathBuilder.moveTo(76.86f, 115.54f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 15.6f, -6.68f);
        pathBuilder.lineTo(116.0f, 118.28f);
        pathBuilder.lineTo(116.0f, 96.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f);
        pathBuilder.verticalLineToRelative(22.28f);
        pathBuilder.lineToRelative(23.54f, -9.42f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 8.92f, 22.28f);
        pathBuilder.lineTo(147.0f, 141.33f);
        pathBuilder.lineTo(161.6f, 160.8f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, -19.2f, 14.4f);
        pathBuilder.lineTo(128.0f, 156.0f);
        pathBuilder.lineToRelative(-14.4f, 19.2f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, -19.2f, -14.4f);
        pathBuilder.lineTo(109.0f, 141.33f);
        pathBuilder.lineTo(83.54f, 131.14f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 76.86f, 115.54f);
        pathBuilder.close();
