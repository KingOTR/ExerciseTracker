...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SubtitlesSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getSubtitlesSlash", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_subtitlesSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SubtitlesslashKt {
    private static ImageVector _subtitlesSlash;

    public static final ImageVector getSubtitlesSlash(BoldGroup boldGroup) {
        ...
        pathBuilder.lineTo(12.0f, 64.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 32.0f, 44.0f);
        pathBuilder.horizontalLineToRelative(4.68f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 20.2f, -12.07f);
        pathBuilder.close();
        pathBuilder.moveTo(166.33f, 188.0f);
        pathBuilder.lineToRelative(-10.91f, -12.0f);
        pathBuilder.lineTo(60.0f, 176.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, -24.0f);
        pathBuilder.horizontalLineToRelative(73.6f);
        pathBuilder.lineToRelative(-10.91f, -12.0f);
        pathBuilder.lineTo(116.0f, 140.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -10.1f, -18.47f);
        pathBuilder.lineTo(57.24f, 68.0f);
        pathBuilder.lineTo(36.0f, 68.0f);
        pathBuilder.lineTo(36.0f, 188.0f);
        pathBuilder.close();
        pathBuilder.moveTo(224.0f, 44.0f);
        pathBuilder.lineTo(116.6f, 44.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f);
        pathBuilder.lineTo(220.0f, 68.0f);
        pathBuilder.lineTo(220.0f, 182.94f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f);
        pathBuilder.lineTo(244.0f, 64.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 224.0f, 44.0f);
        pathBuilder.close();
        pathBuilder.moveTo(196.0f, 140.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.lineTo(182.06f, 116.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f);
        pathBuilder.close();
