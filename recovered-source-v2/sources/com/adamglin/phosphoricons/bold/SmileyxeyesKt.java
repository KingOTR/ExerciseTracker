...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SmileyXEyes", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getSmileyXEyes", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_smileyXEyes", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SmileyxeyesKt {
    private static ImageVector _smileyXEyes;

    public static final ImageVector getSmileyXEyes(BoldGroup boldGroup) {
        ...
        pathBuilder.lineTo(162.0f, 131.0f);
        pathBuilder.lineToRelative(-5.51f, 5.52f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, -17.0f);
        pathBuilder.lineTo(145.0f, 114.0f);
        pathBuilder.lineToRelative(-5.52f, -5.51f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, -17.0f);
        pathBuilder.lineTo(162.0f, 97.0f);
        pathBuilder.lineToRelative(5.51f, -5.52f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, 17.0f);
        pathBuilder.lineTo(179.0f, 114.0f);
        pathBuilder.close();
        pathBuilder.moveTo(116.49f, 136.51f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, 0.0f);
        pathBuilder.lineTo(94.0f, 131.0f);
        pathBuilder.lineToRelative(-5.51f, 5.52f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, -17.0f);
        pathBuilder.lineTo(77.0f, 114.0f);
        pathBuilder.lineToRelative(-5.52f, -5.51f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, -17.0f);
        pathBuilder.lineTo(94.0f, 97.0f);
        pathBuilder.lineToRelative(5.51f, -5.52f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, 17.0f);
        pathBuilder.lineTo(111.0f, 114.0f);
        pathBuilder.lineToRelative(5.52f, 5.51f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 116.49f, 136.49f);
        pathBuilder.close();
