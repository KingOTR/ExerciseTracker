...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CameraPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getCameraPlus", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cameraPlus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CameraplusKt {
    private static ImageVector _cameraPlus;

    public static final ImageVector getCameraPlus(BoldGroup boldGroup) {
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 48.0f, 52.0f);
        pathBuilder.lineTo(73.58f, 52.0f);
        pathBuilder.lineTo(83.64f, 36.91f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 100.28f, 28.0f);
        pathBuilder.horizontalLineToRelative(55.44f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 16.64f, 8.91f);
        ...
        pathBuilder.lineTo(153.58f, 52.0f);
        pathBuilder.lineTo(102.42f, 52.0f);
        pathBuilder.lineTo(90.0f, 70.66f);
