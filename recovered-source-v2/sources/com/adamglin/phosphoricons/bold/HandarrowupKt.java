...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandArrowUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getHandArrowUp", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handArrowUp", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandarrowupKt {
    private static ImageVector _handArrowUp;

    public static final ImageVector getHandArrowUp(BoldGroup boldGroup) {
        ...
        pathBuilder.arcToRelative(35.74f, 35.74f, 0.0f, false, false, -25.45f, 10.54f);
        ...
        pathBuilder.arcToRelative(4.6f, 4.6f, 0.0f, false, true, 5.81f, 4.44f);
        pathBuilder.arcTo(4.58f, 4.58f, 0.0f, false, true, 217.68f, 164.61f);
        pathBuilder.close();
        pathBuilder.moveTo(151.51f, 64.48f);
        ...
        pathBuilder.lineTo(204.0f, 53.0f);
        pathBuilder.verticalLineToRelative(51.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f);
        pathBuilder.lineTo(180.0f, 53.0f);
        pathBuilder.lineTo(168.49f, 64.48f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 151.51f, 64.48f);
        pathBuilder.close();
