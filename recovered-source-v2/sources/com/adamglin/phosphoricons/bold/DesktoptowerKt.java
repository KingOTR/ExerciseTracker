...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"DesktopTower", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getDesktopTower", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_desktopTower", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class DesktoptowerKt {
    private static ImageVector _desktopTower;

    public static final ImageVector getDesktopTower(BoldGroup boldGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(180.0f, 124.0f);
        pathBuilder.horizontalLineToRelative(24.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -24.0f);
        pathBuilder.lineTo(180.0f, 100.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(252.0f, 48.0f);
        pathBuilder.lineTo(252.0f, 208.0f);
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 4.0f, 164.0f);
        pathBuilder.lineTo(4.0f, 96.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 32.0f, 68.0f);
        pathBuilder.lineTo(132.0f, 68.0f);
        pathBuilder.lineTo(132.0f, 48.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 20.0f, -20.0f);
        pathBuilder.horizontalLineToRelative(80.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 252.0f, 48.0f);
        pathBuilder.close();
        pathBuilder.moveTo(132.0f, 168.0f);
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 192.0f, 160.0f);
        pathBuilder.close();
