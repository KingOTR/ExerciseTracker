...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ChatCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/BoldGroup;", "getChatCircle", "(Lcom/adamglin/phosphoricons/BoldGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_chatCircle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ChatcircleKt {
    private static ImageVector _chatCircle;

    public static final ImageVector getChatCircle(BoldGroup boldGroup) {
        ...
        pathBuilder.arcToRelative(84.0f, 84.0f, 0.0f, false, true, -42.06f, -11.27f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -6.0f, -1.62f);
        pathBuilder.arcToRelative(12.1f, 12.1f, 0.0f, false, false, -3.8f, 0.62f);
        pathBuilder.lineToRelative(-29.79f, 9.93f);
        pathBuilder.lineToRelative(9.93f, -29.79f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -1.0f, -9.81f);
        pathBuilder.arcTo(84.0f, 84.0f, 0.0f, true, true, 128.0f, 212.0f);
        pathBuilder.close();
