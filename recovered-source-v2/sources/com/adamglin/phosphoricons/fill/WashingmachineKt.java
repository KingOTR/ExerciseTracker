...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"WashingMachine", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getWashingMachine", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_washingMachine", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class WashingmachineKt {
    private static ImageVector _washingMachine;

    public static final ImageVector getWashingMachine(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 188.0f, 80.0f);
        pathBuilder.close();
        pathBuilder.moveTo(133.66f, 109.66f);
        pathBuilder.lineTo(101.66f, 141.66f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f);
        pathBuilder.lineToRelative(48.0f, -48.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 165.66f, 106.34f);
        pathBuilder.close();
