...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileCSharp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getFileCSharp", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileCSharp", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilecsharpKt {
    private static ImageVector _fileCSharp;

    public static final ImageVector getFileCSharp(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(8.25f, 8.25f, 0.0f, false, true, 0.74f, 11.09f);
        ...
        pathBuilder.lineTo(136.0f, 199.98f);
        pathBuilder.verticalLineToRelative(7.73f);
        pathBuilder.arcToRelative(8.17f, 8.17f, 0.0f, false, true, -7.47f, 8.25f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.53f, -8.0f);
        pathBuilder.verticalLineToRelative(-8.0f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.53f);
        pathBuilder.horizontalLineToRelative(8.0f);
        pathBuilder.lineTo(120.02f, 168.0f);
        pathBuilder.horizontalLineToRelative(-7.73f);
        pathBuilder.arcToRelative(8.17f, 8.17f, 0.0f, false, true, -8.25f, -7.47f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.53f);
        pathBuilder.horizontalLineToRelative(8.0f);
