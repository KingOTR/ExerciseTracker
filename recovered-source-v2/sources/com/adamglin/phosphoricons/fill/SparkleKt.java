...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Sparkle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getSparkle", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sparkle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SparkleKt {
    private static ImageVector _sparkle;

    public static final ImageVector getSparkle(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(15.78f, 15.78f, 0.0f, false, true, -10.42f, 14.94f);
        pathBuilder.lineTo(146.0f, 178.0f);
        pathBuilder.lineToRelative(-19.0f, 51.62f);
        pathBuilder.arcToRelative(15.92f, 15.92f, 0.0f, false, true, -29.88f, 0.0f);
        pathBuilder.lineTo(78.0f, 178.0f);
        pathBuilder.lineToRelative(-51.62f, -19.0f);
        pathBuilder.arcToRelative(15.92f, 15.92f, 0.0f, false, true, 0.0f, -29.88f);
        pathBuilder.lineTo(78.0f, 110.0f);
        pathBuilder.lineToRelative(19.0f, -51.62f);
        pathBuilder.arcToRelative(15.92f, 15.92f, 0.0f, false, true, 29.88f, 0.0f);
        pathBuilder.lineTo(146.0f, 110.0f);
        pathBuilder.lineToRelative(51.62f, 19.0f);
        pathBuilder.arcTo(15.78f, 15.78f, 0.0f, false, true, 208.0f, 144.0f);
        pathBuilder.close();
