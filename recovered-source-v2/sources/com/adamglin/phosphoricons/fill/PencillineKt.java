...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PencilLine", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getPencilLine", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pencilLine", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PencillineKt {
    private static ImageVector _pencilLine;

    public static final ImageVector getPencilLine(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(79.32f, 188.0f);
        pathBuilder.lineToRelative(90.34f, -90.34f);
        pathBuilder.lineToRelative(16.69f, 16.68f);
        pathBuilder.lineTo(96.0f, 204.69f);
        pathBuilder.close();
        pathBuilder.moveTo(158.32f, 86.34f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.lineTo(68.0f, 176.69f);
        pathBuilder.lineTo(51.31f, 160.0f);
        pathBuilder.lineToRelative(90.35f, -90.34f);
        pathBuilder.close();
