...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Waves", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getWaves", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_waves", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class WavesKt {
    private static ImageVector _waves;

    public static final ImageVector getWaves(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(197.2f, 176.87f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(197.2f, 132.87f);
        pathBuilder.curveToRelative(-13.07f, 11.18f, -24.9f, 15.1f, -35.64f, 15.1f);
        pathBuilder.curveToRelative(-14.26f, 0.0f, -26.62f, -6.92f, -37.47f, -13.0f);
        pathBuilder.curveToRelative(-18.41f, -10.31f, -32.95f, -18.45f, -54.89f, 0.31f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -10.4f, -12.16f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 10.4f, 12.16f);
        pathBuilder.close();
        pathBuilder.moveTo(197.2f, 88.87f);
        pathBuilder.curveToRelative(-13.07f, 11.18f, -24.9f, 15.1f, -35.64f, 15.1f);
        pathBuilder.curveToRelative(-14.26f, 0.0f, -26.62f, -6.92f, -37.47f, -13.0f);
        pathBuilder.curveToRelative(-18.41f, -10.31f, -32.95f, -18.45f, -54.89f, 0.31f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 58.8f, 79.13f);
        pathBuilder.curveToRelative(30.42f, -26.0f, 54.09f, -12.76f, 73.11f, -2.11f);
        pathBuilder.curveToRelative(18.41f, 10.31f, 33.0f, 18.45f, 54.89f, -0.31f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 10.4f, 12.16f);
        pathBuilder.close();
