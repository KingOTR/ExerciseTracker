...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BaseballCap", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getBaseballCap", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_baseballCap", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BaseballcapKt {
    private static ImageVector _baseballCap;

    public static final ImageVector getBaseballCap(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(88.15f, 88.15f, 0.0f, false, true, 109.81f, 41.9f);
        ...
        pathBuilder.arcToRelative(7.77f, 7.77f, 0.0f, false, true, -4.34f, 7.1f);
        ...
        pathBuilder.arcToRelative(150.62f, 150.62f, 0.0f, false, true, 49.93f, -23.28f);
        pathBuilder.arcToRelative(7.06f, 7.06f, 0.0f, false, false, 1.0f, -0.26f);
        pathBuilder.arcToRelative(154.06f, 154.06f, 0.0f, false, true, 74.17f, 0.0f);
        pathBuilder.arcToRelative(8.64f, 8.64f, 0.0f, false, false, 1.0f, 0.27f);
        pathBuilder.arcTo(150.49f, 150.49f, 0.0f, false, true, 216.0f, 156.07f);
        pathBuilder.close();
        pathBuilder.moveTo(216.0f, 136.87f);
        ...
        pathBuilder.arcTo(88.15f, 88.15f, 0.0f, false, true, 216.0f, 128.0f);
        pathBuilder.close();
