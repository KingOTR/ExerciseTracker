...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Percent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getPercent", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_percent", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PercentKt {
    private static ImageVector _percent;

    public static final ImageVector getPercent(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, true, false, 80.0f, 84.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 92.0f, 96.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, true, false, 92.0f, 56.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 64.0f, 84.0f);
        pathBuilder.close();
        pathBuilder.moveTo(192.0f, 172.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, false, -28.0f, 28.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 192.0f, 172.0f);
        pathBuilder.close();
