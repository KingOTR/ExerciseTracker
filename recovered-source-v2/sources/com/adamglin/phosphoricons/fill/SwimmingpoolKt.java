...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SwimmingPool", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getSwimmingPool", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_swimmingPool", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SwimmingpoolKt {
    private static ImageVector _swimmingPool;

    public static final ImageVector getSwimmingPool(FillGroup fillGroup) {
        ...
        pathBuilder.curveToRelative(-14.42f, 0.0f, -22.19f, 5.18f, -28.44f, 9.34f);
        pathBuilder.curveTo(190.0f, 213.06f, 185.58f, 216.0f, 176.0f, 216.0f);
        pathBuilder.reflectiveCurveToRelative(-14.0f, -2.94f, -19.57f, -6.66f);
        pathBuilder.curveToRelative(-6.24f, -4.16f, -14.0f, -9.34f, -28.44f, -9.34f);
        pathBuilder.reflectiveCurveToRelative(-22.19f, 5.18f, -28.43f, 9.34f);
        pathBuilder.curveTo(94.0f, 213.06f, 89.57f, 216.0f, 80.0f, 216.0f);
        pathBuilder.reflectiveCurveToRelative(-14.0f, -2.94f, -19.56f, -6.66f);
        pathBuilder.curveTo(54.19f, 205.18f, 46.42f, 200.0f, 32.0f, 200.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f);
        pathBuilder.curveToRelative(9.58f, 0.0f, 14.0f, 2.94f, 19.56f, 6.66f);
        pathBuilder.curveToRelative(6.25f, 4.16f, 14.0f, 9.34f, 28.44f, 9.34f);
        pathBuilder.reflectiveCurveToRelative(22.19f, -5.18f, 28.43f, -9.34f);
        pathBuilder.curveToRelative(5.58f, -3.72f, 10.0f, -6.66f, 19.56f, -6.66f);
        pathBuilder.reflectiveCurveToRelative(14.0f, 2.94f, 19.57f, 6.66f);
        pathBuilder.curveToRelative(6.24f, 4.16f, 14.0f, 9.34f, 28.44f, 9.34f);
        pathBuilder.reflectiveCurveToRelative(22.19f, -5.18f, 28.44f, -9.34f);
        pathBuilder.curveToRelative(5.57f, -3.72f, 10.0f, -6.66f, 19.56f, -6.66f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(80.0f, 141.39f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder.lineTo(176.0f, 143.29f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 96.0f, 104.0f);
        pathBuilder.close();
