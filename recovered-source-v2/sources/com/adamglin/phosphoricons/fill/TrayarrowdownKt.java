...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TrayArrowDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getTrayArrowDown", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_trayArrowDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TrayarrowdownKt {
    private static ImageVector _trayArrowDown;

    public static final ImageVector getTrayArrowDown(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(90.34f, 114.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 0.0f);
        pathBuilder.lineTo(120.0f, 132.69f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 0.0f);
        pathBuilder.lineToRelative(-32.0f, -32.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 90.34f, 114.34f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 208.0f);
        pathBuilder.horizontalLineTo(48.0f);
        pathBuilder.verticalLineTo(168.0f);
        pathBuilder.horizontalLineTo(76.69f);
        pathBuilder.lineTo(96.0f, 187.32f);
        pathBuilder.arcTo(15.89f, 15.89f, 0.0f, false, false, 107.31f, 192.0f);
