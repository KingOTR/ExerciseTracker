...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserCircleCheck", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getUserCircleCheck", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userCircleCheck", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsercirclecheckKt {
    private static ImageVector _userCircleCheck;

    public static final ImageVector getUserCircleCheck(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(59.8f, 59.8f, 0.0f, false, false, 78.26f, 0.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.84f, -0.32f);
        ...
        pathBuilder.arcTo(44.0f, 44.0f, 0.0f, false, false, 84.0f, 120.0f);
        pathBuilder.close();
        pathBuilder.moveTo(237.66f, 34.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, 0.0f);
        pathBuilder.lineTo(200.0f, 60.69f);
        pathBuilder.lineTo(189.66f, 50.34f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 237.66f, 34.34f);
        pathBuilder.close();
