...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MicrosoftOutlookLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getMicrosoftOutlookLogo", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_microsoftOutlookLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MicrosoftoutlooklogoKt {
    private static ImageVector _microsoftOutlookLogo;

    public static final ImageVector getMicrosoftOutlookLogo(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 232.0f, 112.0f);
        pathBuilder.close();
        pathBuilder.moveTo(112.0f, 64.0f);
        pathBuilder.horizontalLineToRelative(24.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 16.0f, 16.0f);
        pathBuilder.verticalLineToRelative(74.13f);
        ...
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, false, 88.0f, 160.0f);
        pathBuilder.close();
        pathBuilder.moveTo(199.26f, 208.0f);
        pathBuilder.lineTo(152.0f, 173.87f);
        pathBuilder.lineTo(152.0f, 176.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -16.0f, 16.0f);
        pathBuilder.lineTo(88.0f, 192.0f);
        pathBuilder.verticalLineToRelative(16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(216.0f, 127.65f);
        pathBuilder.lineTo(165.66f, 164.0f);
        pathBuilder.lineTo(216.0f, 200.35f);
        pathBuilder.close();
