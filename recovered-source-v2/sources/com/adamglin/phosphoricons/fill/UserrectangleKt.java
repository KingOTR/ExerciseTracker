...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserRectangle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getUserRectangle", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userRectangle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UserrectangleKt {
    private static ImageVector _userRectangle;

    public static final ImageVector getUserRectangle(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(54.68f, 200.0f);
        pathBuilder.arcToRelative(80.0f, 80.0f, 0.0f, false, true, 29.41f, -34.84f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.83f, 0.31f);
        pathBuilder.arcToRelative(59.82f, 59.82f, 0.0f, false, false, 78.16f, 0.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.83f, -0.31f);
        pathBuilder.arcTo(80.0f, 80.0f, 0.0f, false, true, 201.32f, 200.0f);
