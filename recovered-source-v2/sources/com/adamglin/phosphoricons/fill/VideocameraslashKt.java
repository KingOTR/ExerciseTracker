...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"VideoCameraSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getVideoCameraSlash", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_videoCameraSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class VideocameraslashKt {
    private static ImageVector _videoCameraSlash;

    public static final ImageVector getVideoCameraSlash(FillGroup fillGroup) {
        ...
        pathBuilder.moveTo(256.0f, 80.23f);
        pathBuilder.verticalLineToRelative(95.45f);
        pathBuilder.arcToRelative(8.33f, 8.33f, 0.0f, false, true, -3.86f, 7.17f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.58f, -0.19f);
        pathBuilder.lineToRelative(-33.78f, -22.52f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -1.78f, -3.33f);
        pathBuilder.verticalLineTo(99.19f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 1.78f, -3.32f);
        pathBuilder.lineToRelative(33.78f, -22.53f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 9.73f, 0.66f);
        pathBuilder.arcTo(8.23f, 8.23f, 0.0f, false, true, 256.0f, 80.23f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(185.0f, 155.07f);
