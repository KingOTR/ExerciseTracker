...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Towel", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getTowel", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_towel", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TowelKt {
    private static ImageVector _towel;

    public static final ImageVector getTowel(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.55f, -8.0f);
        pathBuilder.arcTo(8.19f, 8.19f, 0.0f, false, false, 192.0f, 48.28f);
        pathBuilder.verticalLineTo(180.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, 4.0f);
        pathBuilder.horizontalLineTo(52.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, -4.0f);
        pathBuilder.verticalLineTo(48.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 72.0f, 24.0f);
        pathBuilder.horizontalLineTo(200.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 224.0f, 48.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 188.0f, 200.0f);
        pathBuilder.close();
