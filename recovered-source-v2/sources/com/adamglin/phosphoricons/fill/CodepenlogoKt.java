...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CodepenLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getCodepenLogo", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_codepenLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CodepenlogoKt {
    private static ImageVector _codepenLogo;

    public static final ImageVector getCodepenLogo(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 4.21f, 7.0f);
        pathBuilder.lineTo(114.1f, 217.6f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.9f, -3.52f);
        pathBuilder.verticalLineToRelative(-57.3f);
        pathBuilder.lineTo(66.55f, 128.0f);
        pathBuilder.lineTo(32.0f, 146.61f);
        pathBuilder.lineTo(32.0f, 109.39f);
        pathBuilder.lineTo(66.55f, 128.0f);
        pathBuilder.lineToRelative(16.88f, -9.09f);
        pathBuilder.lineTo(40.87f, 96.0f);
        pathBuilder.lineTo(120.0f, 53.39f);
        pathBuilder.lineTo(120.0f, 99.22f);
        pathBuilder.lineTo(83.43f, 118.91f);
        pathBuilder.lineToRelative(44.57f, 24.0f);
        pathBuilder.lineToRelative(44.57f, -24.0f);
        pathBuilder.lineTo(189.45f, 128.0f);
        pathBuilder.lineTo(224.0f, 109.39f);
        pathBuilder.verticalLineToRelative(37.22f);
        pathBuilder.lineTo(189.45f, 128.0f);
        pathBuilder.lineTo(136.0f, 156.78f);
        pathBuilder.verticalLineToRelative(57.3f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.9f, 3.52f);
        pathBuilder.lineTo(235.79f, 167.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 4.21f, -7.0f);
        pathBuilder.lineTo(240.0f, 96.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 235.79f, 89.0f);
        pathBuilder.close();
        pathBuilder.moveTo(172.57f, 119.0f);
