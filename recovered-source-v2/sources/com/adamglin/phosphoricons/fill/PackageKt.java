...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Package", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getPackage", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_package", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PackageKt {
    private static ImageVector _package;

    public static final ImageVector getPackage(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(178.57f, 92.29f);
        pathBuilder.lineToRelative(-80.35f, -44.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 120.0f);
        pathBuilder.lineTo(47.65f, 76.0f);
        pathBuilder.lineTo(81.56f, 57.43f);
        pathBuilder.lineToRelative(80.35f, 44.0f);
        pathBuilder.close();
        pathBuilder.moveTo(216.0f, 175.85f);
        ...
        pathBuilder.lineTo(184.0f, 107.56f);
        pathBuilder.lineToRelative(32.0f, -17.51f);
