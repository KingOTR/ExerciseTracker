...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Usb", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getUsb", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_usb", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsbKt {
    private static ImageVector _usb;

    public static final ImageVector getUsb(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 196.0f, 160.0f);
        ...
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, true, 0.0f, 16.0f);
        pathBuilder.horizontalLineTo(72.0f);
        pathBuilder.verticalLineToRelative(48.0f);
        pathBuilder.horizontalLineTo(196.0f);
        pathBuilder.verticalLineTo(96.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 6.22f, -3.33f);
        pathBuilder.lineToRelative(48.0f, 32.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 252.0f, 128.0f);
        pathBuilder.close();
