...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Playlist", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getPlaylist", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_playlist", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PlaylistKt {
    private static ImageVector _playlist;

    public static final ImageVector getPlaylist(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(207.59f, 130.53f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -10.12f, 5.06f);
        pathBuilder.lineTo(184.0f, 131.1f);
        pathBuilder.lineTo(184.0f, 176.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, true, true, -16.0f, -22.62f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 207.59f, 130.53f);
        pathBuilder.close();
