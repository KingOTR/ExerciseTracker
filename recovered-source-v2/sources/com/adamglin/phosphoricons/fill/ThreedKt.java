...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ThreeD", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getThreeD", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_threeD", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ThreedKt {
    private static ImageVector _threeD;

    public static final ImageVector getThreeD(FillGroup fillGroup) {
        ...
        pathBuilder.horizontalLineToRelative(8.0f);
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, true, 184.0f, 128.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, false, false, -18.31f, -28.92f);
        pathBuilder.lineTo(110.4f, 92.8f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 104.0f, 80.0f);
        pathBuilder.lineTo(64.0f, 80.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f);
        pathBuilder.lineTo(88.0f, 96.0f);
        pathBuilder.lineTo(73.6f, 115.2f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 80.0f, 128.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, true, true, -10.66f, 27.93f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -10.68f, 11.92f);
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, false, 112.0f, 144.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(48.05f, 48.05f, 0.0f, false, false, 200.0f, 128.0f);
        pathBuilder.close();
