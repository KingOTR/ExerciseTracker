...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserCircleMinus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getUserCircleMinus", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userCircleMinus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsercircleminusKt {
    private static ImageVector _userCircleMinus;

    public static final ImageVector getUserCircleMinus(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(215.87f, 88.46f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 211.0f, 98.67f);
        pathBuilder.arcToRelative(88.0f, 88.0f, 0.0f, false, true, -17.23f, 87.74f);
        ...
        pathBuilder.arcToRelative(103.9f, 103.9f, 0.0f, true, false, 80.76f, 67.89f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 215.87f, 88.46f);
        pathBuilder.close();
