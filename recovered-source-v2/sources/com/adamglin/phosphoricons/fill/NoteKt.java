...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Note", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getNote", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_note", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NoteKt {
    private static ImageVector _note;

    public static final ImageVector getNote(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(156.69f, 224.0f);
        pathBuilder.arcTo(15.92f, 15.92f, 0.0f, false, false, 168.0f, 219.31f);
        pathBuilder.lineTo(219.31f, 168.0f);
        pathBuilder.arcTo(15.92f, 15.92f, 0.0f, false, false, 224.0f, 156.69f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(160.0f, 204.69f);
        pathBuilder.lineTo(160.0f, 160.0f);
        pathBuilder.horizontalLineToRelative(44.7f);
        pathBuilder.close();
