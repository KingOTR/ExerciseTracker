...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Target", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getTarget", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_target", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TargetKt {
    private static ImageVector _target;

    public static final ImageVector getTarget(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(167.6f, 99.71f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.lineToRelative(-37.71f, 37.71f);
        pathBuilder.lineToRelative(-23.95f, 23.95f);
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, false, 62.0f, -35.67f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 16.0f, -0.9f);
        pathBuilder.arcToRelative(56.0f, 56.0f, 0.0f, false, true, -95.5f, 42.79f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.arcToRelative(56.0f, 56.0f, 0.0f, false, true, 73.13f, -84.43f);
