...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"LinkSimple", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getLinkSimple", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_linkSimple", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LinksimpleKt {
    private static ImageVector _linkSimple;

    public static final ImageVector getLinkSimple(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(144.56f, 173.66f);
        pathBuilder.lineToRelative(-21.45f, 21.45f);
        pathBuilder.arcToRelative(44.0f, 44.0f, 0.0f, false, true, -62.22f, -62.22f);
        pathBuilder.lineToRelative(21.45f, -21.46f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 11.31f);
        pathBuilder.lineTo(72.2f, 144.2f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(109.66f, 157.66f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f);
        pathBuilder.lineToRelative(48.0f, -48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 11.32f);
        pathBuilder.close();
        pathBuilder.moveTo(195.11f, 123.11f);
        pathBuilder.lineTo(173.66f, 144.56f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.31f);
        pathBuilder.lineTo(183.8f, 111.8f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, false, -39.6f, -39.6f);
        pathBuilder.lineTo(122.74f, 93.66f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.31f, -11.32f);
