...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListStar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getListStar", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listStar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListstarKt {
    private static ImageVector _listStar;

    public static final ImageVector getListStar(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(198.55f, 143.29f);
        pathBuilder.lineTo(180.69f, 158.0f);
        pathBuilder.lineToRelative(5.44f, 22.0f);
        ...
        pathBuilder.lineTo(160.0f, 172.54f);
        pathBuilder.lineToRelative(-20.22f, 11.91f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.91f, -4.41f);
        pathBuilder.lineToRelative(5.44f, -22.0f);
        pathBuilder.lineToRelative(-17.86f, -14.75f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 2.24f, -7.07f);
        pathBuilder.lineToRelative(23.58f, -1.82f);
        pathBuilder.lineToRelative(9.06f, -21.0f);
