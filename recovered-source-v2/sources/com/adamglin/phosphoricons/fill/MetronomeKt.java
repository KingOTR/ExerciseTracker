...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Metronome", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getMetronome", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_metronome", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MetronomeKt {
    private static ImageVector _metronome;

    public static final ImageVector getMetronome(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(106.91f, 32.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(71.27f, 160.0f);
        pathBuilder.lineTo(106.91f, 48.0f);
        pathBuilder.horizontalLineToRelative(42.17f);
        pathBuilder.lineToRelative(20.0f, 62.9f);
        pathBuilder.lineTo(124.46f, 160.0f);
        pathBuilder.close();
        pathBuilder.moveTo(146.08f, 160.0f);
        pathBuilder.lineTo(174.7f, 128.52f);
        pathBuilder.lineTo(184.7f, 160.0f);
        pathBuilder.close();
