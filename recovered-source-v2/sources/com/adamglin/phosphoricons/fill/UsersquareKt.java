...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserSquare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getUserSquare", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userSquare", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsersquareKt {
    private static ImageVector _userSquare;

    public static final ImageVector getUserSquare(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(44.0f, 44.0f, 0.0f, false, true, 172.0f, 120.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(80.58f, 80.58f, 0.0f, false, true, 26.07f, -38.25f);
        pathBuilder.quadToRelative(3.08f, -2.48f, 6.36f, -4.62f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.81f, 0.33f);
        pathBuilder.arcToRelative(59.82f, 59.82f, 0.0f, false, false, 78.18f, 0.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.81f, -0.33f);
        pathBuilder.quadToRelative(3.28f, 2.15f, 6.36f, 4.62f);
        pathBuilder.arcTo(80.58f, 80.58f, 0.0f, false, true, 204.33f, 208.0f);
