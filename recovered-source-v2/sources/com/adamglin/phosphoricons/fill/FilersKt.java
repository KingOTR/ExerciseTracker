...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileRs", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getFileRs", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileRs", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilersKt {
    private static ImageVector _fileRs;

    public static final ImageVector getFileRs(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(63.42f, 144.0f);
        ...
        pathBuilder.arcToRelative(28.48f, 28.48f, 0.0f, false, false, 5.73f, -0.59f);
        pathBuilder.lineTo(77.09f, 212.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.81f, 2.3f);
        pathBuilder.arcToRelative(8.14f, 8.14f, 0.0f, false, false, 1.91f, -10.54f);
        pathBuilder.lineToRelative(-7.0f, -12.0f);
        pathBuilder.arcTo(27.92f, 27.92f, 0.0f, false, false, 92.0f, 171.36f);
        pathBuilder.curveTo(91.65f, 156.05f, 78.74f, 144.0f, 63.42f, 144.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(155.81f, 196.31f);
        pathBuilder.arcToRelative(20.82f, 20.82f, 0.0f, false, true, -9.19f, 15.23f);
        pathBuilder.curveTo(141.43f, 215.0f, 135.0f, 216.0f, 129.13f, 216.0f);
        pathBuilder.arcTo(61.14f, 61.14f, 0.0f, false, true, 114.0f, 214.0f);
        ...
        pathBuilder.curveTo(141.49f, 174.17f, 158.05f, 179.0f, 155.81f, 196.31f);
        pathBuilder.close();
