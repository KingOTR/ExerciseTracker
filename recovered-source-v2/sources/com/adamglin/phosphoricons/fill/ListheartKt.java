...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListHeart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getListHeart", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listHeart", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListheartKt {
    private static ImageVector _listHeart;

    public static final ImageVector getListHeart(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(161.79f, 185.58f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.58f, 0.0f);
        pathBuilder.curveTo(156.65f, 184.8f, 120.0f, 166.17f, 120.0f, 140.0f);
        pathBuilder.arcToRelative(22.0f, 22.0f, 0.0f, false, true, 40.0f, -12.64f);
        pathBuilder.arcTo(22.0f, 22.0f, 0.0f, false, true, 200.0f, 140.0f);
        pathBuilder.curveTo(200.0f, 166.17f, 163.35f, 184.8f, 161.79f, 185.58f);
        pathBuilder.close();
