...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TextHThree", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getTextHThree", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_textHThree", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TexththreeKt {
    private static ImageVector _textHThree;

    public static final ImageVector getTextHThree(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, false, true, -21.34f, -8.15f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 10.68f, -11.92f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, true, false, 168.0f, 136.0f);
        ...
        pathBuilder.horizontalLineToRelative(40.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 6.4f, 12.8f);
        pathBuilder.lineToRelative(-16.71f, 22.28f);
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, true, 168.0f, 184.0f);
        pathBuilder.close();
