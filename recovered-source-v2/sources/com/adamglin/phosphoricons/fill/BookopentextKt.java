...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BookOpenText", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getBookOpenText", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bookOpenText", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BookopentextKt {
    private static ImageVector _bookOpenText;

    public static final ImageVector getBookOpenText(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, false, 88.0f, 48.0f);
        pathBuilder.lineTo(24.0f, 48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, 8.0f);
        pathBuilder.lineTo(16.0f, 200.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.0f, 8.0f);
        pathBuilder.lineTo(96.0f, 208.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, true, 24.0f, 23.94f);
        pathBuilder.arcToRelative(7.9f, 7.9f, 0.0f, false, false, 5.12f, 7.55f);
        ...
        pathBuilder.lineTo(168.27f, 168.0f);
        ...
        pathBuilder.lineTo(168.27f, 104.0f);
        pathBuilder.arcTo(8.17f, 8.17f, 0.0f, false, true, 160.0f, 96.53f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 168.0f, 88.0f);
        pathBuilder.horizontalLineToRelative(39.73f);
        pathBuilder.arcTo(8.17f, 8.17f, 0.0f, false, true, 216.0f, 95.47f);
