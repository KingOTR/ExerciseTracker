...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SteeringWheel", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getSteeringWheel", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_steeringWheel", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SteeringwheelKt {
    private static ImageVector _steeringWheel;

    public static final ImageVector getSteeringWheel(FillGroup fillGroup) {
        ...
        pathBuilder.lineToRelative(17.0f, 45.58f);
        pathBuilder.arcTo(88.35f, 88.35f, 0.0f, false, true, 49.63f, 168.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 156.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, true, true, 16.0f, -16.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 128.0f, 156.0f);
        pathBuilder.close();
        pathBuilder.moveTo(148.46f, 213.59f);
        pathBuilder.lineTo(165.55f, 168.0f);
        pathBuilder.horizontalLineToRelative(40.82f);
        pathBuilder.arcTo(88.34f, 88.34f, 0.0f, false, true, 148.46f, 213.59f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 96.0f);
        pathBuilder.arcToRelative(136.38f, 136.38f, 0.0f, false, false, -88.0f, 32.33f);
        ...
        pathBuilder.arcTo(136.38f, 136.38f, 0.0f, false, false, 128.0f, 96.0f);
        pathBuilder.close();
