...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"VideoConference", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getVideoConference", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_videoConference", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class VideoconferenceKt {
    private static ImageVector _videoConference;

    public static final ImageVector getVideoConference(FillGroup fillGroup) {
        ...
        pathBuilder.moveTo(204.0f, 88.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, -12.0f, -12.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 204.0f, 88.0f);
        pathBuilder.close();
        pathBuilder.moveTo(192.0f, 156.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, false, 12.0f, 12.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 192.0f, 156.0f);
        pathBuilder.close();
        pathBuilder.moveTo(96.0f, 104.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, true, false, 16.0f, 16.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 96.0f, 104.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(135.75f, 166.0f);
        ...
        pathBuilder.arcTo(39.84f, 39.84f, 0.0f, false, false, 56.25f, 166.0f);
