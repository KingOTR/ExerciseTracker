...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Prescription", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getPrescription", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_prescription", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PrescriptionKt {
    private static ImageVector _prescription;

    public static final ImageVector getPrescription(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(189.66f, 186.34f);
        pathBuilder.lineTo(175.31f, 172.0f);
        pathBuilder.lineToRelative(14.35f, -14.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, -11.32f);
        pathBuilder.lineTo(164.0f, 160.69f);
        pathBuilder.lineToRelative(-26.0f, -26.0f);
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, false, false, 128.0f, 56.0f);
        ...
        pathBuilder.lineToRelative(-14.35f, 14.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, 11.32f);
        pathBuilder.lineTo(164.0f, 183.31f);
