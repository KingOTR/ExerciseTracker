...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CurrencyJpy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getCurrencyJpy", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_currencyJpy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CurrencyjpyKt {
    private static ImageVector _currencyJpy;

    public static final ImageVector getCurrencyJpy(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(182.4f, 76.8f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
        pathBuilder.horizontalLineToRelative(16.0f);
        pathBuilder.lineTo(73.6f, 76.8f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 12.8f, -9.6f);
        pathBuilder.lineTo(128.0f, 122.67f);
        pathBuilder.lineTo(169.6f, 67.2f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 12.8f, 9.6f);
        pathBuilder.close();
