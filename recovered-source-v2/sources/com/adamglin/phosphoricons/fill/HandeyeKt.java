...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandEye", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getHandEye", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handEye", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandeyeKt {
    private static ImageVector _handEye;

    public static final ImageVector getHandEye(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 32.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(179.58f, 178.21f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, 3.58f);
        pathBuilder.curveToRelative(0.7f, 1.4f, 17.5f, 34.21f, 51.58f, 34.21f);
        pathBuilder.reflectiveCurveToRelative(50.88f, -32.81f, 51.58f, -34.21f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 179.58f, 178.21f);
        pathBuilder.close();
