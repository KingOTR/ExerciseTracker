...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HardHat", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getHardHat", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_hardHat", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HardhatKt {
    private static ImageVector _hardHat;

    public static final ImageVector getHardHat(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder.verticalLineToRelative(-8.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 224.0f, 168.0f);
        pathBuilder.close();
        pathBuilder.moveTo(224.0f, 148.0f);
        pathBuilder.lineTo(224.0f, 136.0f);
        pathBuilder.arcToRelative(96.44f, 96.44f, 0.0f, false, false, -50.11f, -84.31f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 168.0f, 55.22f);
        ...
        pathBuilder.lineTo(88.0f, 55.22f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -5.89f, -3.53f);
        pathBuilder.arcTo(96.44f, 96.44f, 0.0f, false, false, 32.0f, 136.0f);
        pathBuilder.verticalLineToRelative(12.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 36.0f, 152.0f);
        pathBuilder.close();
