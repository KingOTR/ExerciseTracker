...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PuzzlePiece", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getPuzzlePiece", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_puzzlePiece", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PuzzlepieceKt {
    private static ImageVector _puzzlePiece;

    public static final ImageVector getPuzzlePiece(FillGroup fillGroup) {
        ...
        pathBuilder.moveTo(165.78f, 224.0f);
        pathBuilder.horizontalLineTo(208.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder.verticalLineTo(170.35f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 212.94f, 163.0f);
        pathBuilder.arcToRelative(23.37f, 23.37f, 0.0f, false, true, -8.94f, 1.77f);
        pathBuilder.curveToRelative(-13.23f, 0.0f, -24.0f, -11.1f, -24.0f, -24.73f);
        pathBuilder.reflectiveCurveToRelative(10.77f, -24.73f, 24.0f, -24.73f);
        pathBuilder.arcToRelative(23.37f, 23.37f, 0.0f, false, true, 8.94f, 1.77f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 224.0f, 109.65f);
        ...
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, 16.0f);
        pathBuilder.horizontalLineToRelative(42.22f);
