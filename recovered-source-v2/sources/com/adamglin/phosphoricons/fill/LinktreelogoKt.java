...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"LinktreeLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getLinktreeLogo", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_linktreeLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LinktreelogoKt {
    private static ImageVector _linktreeLogo;

    public static final ImageVector getLinktreeLogo(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(147.31f, 120.0f);
        ...
        pathBuilder.lineTo(93.66f, 157.66f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f);
        pathBuilder.lineTo(108.69f, 120.0f);
        pathBuilder.lineTo(72.0f, 120.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
        pathBuilder.horizontalLineToRelative(36.69f);
        pathBuilder.lineTo(82.34f, 77.66f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 93.66f, 66.34f);
        pathBuilder.lineTo(120.0f, 92.69f);
        pathBuilder.lineTo(120.0f, 56.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder.lineTo(136.0f, 92.69f);
        pathBuilder.lineToRelative(26.34f, -26.35f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 11.32f);
        pathBuilder.lineTo(147.31f, 104.0f);
