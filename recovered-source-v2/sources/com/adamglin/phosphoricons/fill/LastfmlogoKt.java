...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"LastfmLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getLastfmLogo", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_lastfmLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LastfmlogoKt {
    private static ImageVector _lastfmLogo;

    public static final ImageVector getLastfmLogo(FillGroup fillGroup) {
        ...
        pathBuilder.horizontalLineTo(172.61f);
        pathBuilder.arcToRelative(40.09f, 40.09f, 0.0f, false, true, -36.42f, -23.45f);
        pathBuilder.lineToRelative(-23.0f, -50.48f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 91.39f, 96.0f);
        pathBuilder.horizontalLineTo(80.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, false, -24.0f, 24.0f);
        pathBuilder.verticalLineToRelative(24.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, false, 24.0f, 24.0f);
        pathBuilder.horizontalLineToRelative(8.0f);
        pathBuilder.arcToRelative(23.92f, 23.92f, 0.0f, false, false, 18.74f, -9.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 12.48f, 10.0f);
        pathBuilder.arcTo(39.83f, 39.83f, 0.0f, false, true, 88.0f, 184.0f);
        pathBuilder.horizontalLineTo(80.0f);
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, true, -40.0f, -40.0f);
        pathBuilder.verticalLineTo(120.0f);
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, false, true, 80.0f, 80.0f);
        pathBuilder.horizontalLineTo(91.39f);
        pathBuilder.arcToRelative(40.09f, 40.09f, 0.0f, false, true, 36.42f, 23.45f);
        pathBuilder.lineToRelative(22.95f, 50.48f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 172.61f, 168.0f);
