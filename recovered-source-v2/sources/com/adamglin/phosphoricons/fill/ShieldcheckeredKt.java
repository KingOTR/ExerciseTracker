...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ShieldCheckered", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getShieldCheckered", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_shieldCheckered", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ShieldcheckeredKt {
    private static ImageVector _shieldCheckered;

    public static final ImageVector getShieldCheckered(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 223.62f);
        pathBuilder.arcToRelative(128.25f, 128.25f, 0.0f, false, true, -38.92f, -21.81f);
        pathBuilder.curveTo(65.83f, 182.79f, 52.37f, 158.0f, 48.9f, 128.0f);
        pathBuilder.horizontalLineTo(128.0f);
        pathBuilder.verticalLineTo(56.0f);
        pathBuilder.horizontalLineToRelative(80.0f);
        pathBuilder.verticalLineToRelative(56.0f);
        pathBuilder.arcToRelative(141.24f, 141.24f, 0.0f, false, true, -0.9f, 16.0f);
        pathBuilder.horizontalLineTo(128.0f);
