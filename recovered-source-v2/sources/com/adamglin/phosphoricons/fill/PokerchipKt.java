...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PokerChip", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getPokerChip", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pokerChip", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PokerchipKt {
    private static ImageVector _pokerChip;

    public static final ImageVector getPokerChip(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(60.4f, 71.72f);
        pathBuilder.lineTo(77.47f, 88.79f);
        pathBuilder.arcToRelative(63.66f, 63.66f, 0.0f, false, false, -13.0f, 31.21f);
        pathBuilder.lineTo(40.37f, 120.0f);
        pathBuilder.arcTo(87.6f, 87.6f, 0.0f, false, true, 60.4f, 71.72f);
        pathBuilder.close();
        pathBuilder.moveTo(40.37f, 136.0f);
        pathBuilder.lineTo(64.52f, 136.0f);
        pathBuilder.arcToRelative(63.66f, 63.66f, 0.0f, false, false, 13.0f, 31.21f);
        pathBuilder.lineTo(60.4f, 184.28f);
        pathBuilder.arcTo(87.6f, 87.6f, 0.0f, false, true, 40.37f, 136.0f);
        pathBuilder.close();
        pathBuilder.moveTo(120.0f, 215.63f);
        ...
        pathBuilder.arcTo(87.6f, 87.6f, 0.0f, false, true, 215.63f, 120.0f);
        pathBuilder.close();
        pathBuilder.moveTo(136.0f, 40.37f);
        pathBuilder.arcToRelative(87.6f, 87.6f, 0.0f, false, true, 48.28f, 20.0f);
        pathBuilder.lineTo(167.21f, 77.47f);
        pathBuilder.arcToRelative(63.66f, 63.66f, 0.0f, false, false, -31.21f, -13.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(17.07f, 17.07f);
        pathBuilder.arcTo(87.6f, 87.6f, 0.0f, false, true, 136.0f, 215.63f);
        pathBuilder.close();
        pathBuilder.moveTo(195.6f, 184.28f);
        pathBuilder.lineTo(178.53f, 167.21f);
        pathBuilder.arcTo(63.66f, 63.66f, 0.0f, false, false, 191.48f, 136.0f);
        pathBuilder.horizontalLineToRelative(24.15f);
        pathBuilder.arcTo(87.6f, 87.6f, 0.0f, false, true, 195.6f, 184.28f);
        pathBuilder.close();
