...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Ruler", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getRuler", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_ruler", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RulerKt {
    private static ImageVector _ruler;

    public static final ImageVector getRuler(FillGroup fillGroup) {
        ...
        pathBuilder.moveTo(235.32f, 96.0f);
        pathBuilder.lineTo(96.0f, 235.31f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -22.63f, 0.0f);
        pathBuilder.lineTo(20.68f, 182.63f);
        ...
        pathBuilder.arcToRelative(8.18f, 8.18f, 0.0f, false, false, -0.6f, -11.09f);
        pathBuilder.lineTo(66.82f, 119.51f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.71f, -0.43f);
        pathBuilder.arcToRelative(8.18f, 8.18f, 0.0f, false, false, -0.6f, -11.09f);
        pathBuilder.lineTo(98.83f, 87.51f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -5.65f);
        pathBuilder.lineToRelative(15.0f, -15.0f);
        ...
        pathBuilder.lineTo(130.83f, 55.51f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -5.65f);
        pathBuilder.lineTo(160.0f, 20.69f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 22.63f, 0.0f);
        pathBuilder.lineToRelative(52.69f, 52.68f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 235.32f, 96.0f);
        pathBuilder.close();
