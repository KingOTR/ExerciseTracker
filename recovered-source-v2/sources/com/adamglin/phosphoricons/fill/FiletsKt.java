...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileTs", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getFileTs", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileTs", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FiletsKt {
    private static ImageVector _fileTs;

    public static final ImageVector getFileTs(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(164.0f, 120.0f);
        ...
        pathBuilder.arcTo(61.14f, 61.14f, 0.0f, false, true, 106.0f, 214.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 4.3f, -15.41f);
        pathBuilder.curveToRelative(4.38f, 1.2f, 15.0f, 2.7f, 19.55f, -0.36f);
        ...
        pathBuilder.arcToRelative(20.56f, 20.56f, 0.0f, false, true, 9.0f, -14.95f);
        pathBuilder.curveToRelative(11.84f, -8.0f, 30.71f, -3.31f, 32.83f, -2.76f);
        ...
        pathBuilder.curveToRelative(-0.12f, 0.9f, -0.14f, 1.09f, 1.11f, 1.9f);
        pathBuilder.curveToRelative(2.31f, 1.49f, 6.45f, 2.68f, 10.45f, 3.84f);
        pathBuilder.curveTo(133.49f, 174.17f, 150.05f, 179.0f, 147.81f, 196.31f);
        pathBuilder.close();
        pathBuilder.moveTo(88.0f, 152.53f);
        pathBuilder.arcTo(8.17f, 8.17f, 0.0f, false, true, 79.73f, 160.0f);
        pathBuilder.lineTo(68.0f, 160.0f);
        pathBuilder.verticalLineToRelative(47.73f);
        pathBuilder.arcTo(8.17f, 8.17f, 0.0f, false, true, 60.53f, 216.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 52.0f, 208.0f);
        pathBuilder.lineTo(52.0f, 160.0f);
        pathBuilder.lineTo(40.27f, 160.0f);
        pathBuilder.arcTo(8.17f, 8.17f, 0.0f, false, true, 32.0f, 152.53f);
