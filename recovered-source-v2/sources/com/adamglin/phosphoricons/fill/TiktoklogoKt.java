...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TiktokLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getTiktokLogo", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_tiktokLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TiktoklogoKt {
    private static ImageVector _tiktokLogo;

    public static final ImageVector getTiktokLogo(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(103.25f, 103.25f, 0.0f, false, true, -48.0f, -11.71f);
        pathBuilder.verticalLineTo(156.0f);
        pathBuilder.arcToRelative(76.0f, 76.0f, 0.0f, false, true, -152.0f, 0.0f);
        pathBuilder.curveToRelative(0.0f, -36.9f, 26.91f, -69.52f, 62.6f, -75.88f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 96.0f, 88.0f);
        pathBuilder.verticalLineToRelative(42.69f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -4.57f, 7.23f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, true, false, 120.0f, 156.0f);
