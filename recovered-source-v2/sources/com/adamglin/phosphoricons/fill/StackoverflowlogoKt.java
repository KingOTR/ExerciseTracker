...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"StackOverflowLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getStackOverflowLogo", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_stackOverflowLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class StackoverflowlogoKt {
    private static ImageVector _stackOverflowLogo;

    public static final ImageVector getStackOverflowLogo(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(134.86f, 46.86f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 0.0f);
        pathBuilder.lineToRelative(45.25f, 45.26f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.31f, 11.31f);
        pathBuilder.lineTo(134.86f, 58.18f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 134.86f, 46.86f);
        pathBuilder.close();
        pathBuilder.moveTo(100.18f, 98.77f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 10.45f, -4.33f);
        pathBuilder.lineToRelative(59.13f, 24.49f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -3.06f, 15.4f);
        pathBuilder.arcToRelative(7.89f, 7.89f, 0.0f, false, true, -3.06f, -0.62f);
        pathBuilder.lineToRelative(-59.13f, -24.49f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 100.18f, 98.77f);
        pathBuilder.close();
