...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileAudio", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getFileAudio", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileAudio", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FileaudioKt {
    private static ImageVector _fileAudio;

    public static final ImageVector getFileAudio(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(40.55f, 40.55f, 0.0f, false, true, -20.0f, 34.91f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 124.0f, 201.09f);
        pathBuilder.arcToRelative(24.49f, 24.49f, 0.0f, false, false, 0.0f, -42.18f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 132.0f, 145.09f);
        pathBuilder.arcTo(40.55f, 40.55f, 0.0f, false, true, 152.0f, 180.0f);
        pathBuilder.close();
        pathBuilder.moveTo(99.06f, 128.61f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.72f, 1.73f);
        pathBuilder.lineTo(68.69f, 152.0f);
        pathBuilder.lineTo(48.0f, 152.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, 8.0f);
        pathBuilder.verticalLineToRelative(40.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.0f, 8.0f);
        pathBuilder.lineTo(68.69f, 208.0f);
        pathBuilder.lineToRelative(21.65f, 21.66f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 104.0f, 224.0f);
        pathBuilder.lineTo(104.0f, 136.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 99.06f, 128.61f);
        pathBuilder.close();
