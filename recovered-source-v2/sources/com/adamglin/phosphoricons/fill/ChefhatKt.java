...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ChefHat", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getChefHat", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_chefHat", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ChefhatKt {
    private static ImageVector _chefHat;

    public static final ImageVector getChefHat(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(152.24f, 142.06f);
        pathBuilder.lineTo(160.24f, 110.06f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 15.52f, 3.88f);
        pathBuilder.lineToRelative(-8.0f, 32.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 160.0f, 152.0f);
        pathBuilder.arcToRelative(8.13f, 8.13f, 0.0f, false, true, -1.95f, -0.24f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 152.24f, 142.06f);
        pathBuilder.close();
        pathBuilder.moveTo(120.0f, 112.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder.verticalLineToRelative(32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(86.06f, 104.24f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 9.7f, 5.82f);
        pathBuilder.lineToRelative(8.0f, 32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.82f, 9.7f);
        pathBuilder.arcToRelative(8.13f, 8.13f, 0.0f, false, true, -2.0f, 0.24f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.75f, -6.06f);
        pathBuilder.lineToRelative(-8.0f, -32.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 86.06f, 104.24f);
        pathBuilder.close();
