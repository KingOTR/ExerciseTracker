...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Books", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getBooks", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_books", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BooksKt {
    private static ImageVector _books;

    public static final ImageVector getBooks(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(146.0f, 97.53f);
        pathBuilder.lineTo(142.65f, 81.63f);
        pathBuilder.lineTo(189.47f, 71.57f);
        pathBuilder.lineTo(192.81f, 87.47f);
        pathBuilder.close();
        pathBuilder.moveTo(216.0f, 197.94f);
        pathBuilder.lineTo(169.2f, 207.94f);
        pathBuilder.lineTo(165.87f, 192.07f);
