...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TrademarkRegistered", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getTrademarkRegistered", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_trademarkRegistered", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TrademarkregisteredKt {
    private static ImageVector _trademarkRegistered;

    public static final ImageVector getTrademarkRegistered(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 152.0f, 112.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(72.08f, 72.08f, 0.0f, false, true, 200.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(166.66f, 163.56f);
        pathBuilder.lineTo(151.09f, 140.21f);
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, false, 136.0f, 80.0f);
        ...
        pathBuilder.horizontalLineToRelative(22.39f);
        pathBuilder.lineToRelative(19.0f, 28.44f);
