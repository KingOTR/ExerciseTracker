...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListNumbers", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getListNumbers", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listNumbers", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListnumbersKt {
    private static ImageVector _listNumbers;

    public static final ImageVector getListNumbers(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(56.84f, 75.58f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 3.58f, -10.74f);
        pathBuilder.lineToRelative(16.0f, -8.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 88.0f, 64.0f);
        pathBuilder.verticalLineToRelative(48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder.lineTo(72.0f, 76.94f);
        pathBuilder.lineToRelative(-4.42f, 2.22f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 56.84f, 75.58f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(21.67f, -28.89f);
        pathBuilder.arcTo(3.92f, 3.92f, 0.0f, false, false, 84.0f, 152.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -7.77f, -1.33f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -15.09f, -5.34f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, true, true, 35.0f, 18.53f);
