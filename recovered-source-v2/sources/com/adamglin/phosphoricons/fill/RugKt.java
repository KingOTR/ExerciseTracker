...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Rug", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getRug", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_rug", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RugKt {
    private static ImageVector _rug;

    public static final ImageVector getRug(FillGroup fillGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(155.43f, 130.06f);
        pathBuilder.lineToRelative(-24.0f, 40.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -6.86f, 0.0f);
        pathBuilder.lineToRelative(-24.0f, -40.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -4.12f);
        pathBuilder.lineToRelative(24.0f, -40.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 6.86f, 0.0f);
        pathBuilder.lineToRelative(24.0f, 40.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 155.43f, 130.06f);
        pathBuilder.close();
