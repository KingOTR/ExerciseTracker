...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BehanceLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getBehanceLogo", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_behanceLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BehancelogoKt {
    private static ImageVector _behanceLogo;

    public static final ImageVector getBehanceLogo(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, false, -22.62f, 16.0f);
        pathBuilder.horizontalLineToRelative(45.24f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 176.0f, 120.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 32.0f, 40.0f);
        pathBuilder.lineTo(224.0f, 40.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 240.0f, 56.0f);
        pathBuilder.close();
        pathBuilder.moveTo(144.0f, 88.0f);
        ...
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, false, false, -14.13f, -26.53f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 92.0f, 80.0f);
        ...
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, true, false, -13.54f, 30.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -10.59f, -12.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, true, -38.49f, -10.0f);
        pathBuilder.lineTo(208.0f, 152.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 216.0f, 144.0f);
        pathBuilder.close();
