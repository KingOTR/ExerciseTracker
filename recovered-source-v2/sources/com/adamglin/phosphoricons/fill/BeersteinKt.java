...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BeerStein", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getBeerStein", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_beerStein", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BeersteinKt {
    private static ImageVector _beerStein;

    public static final ImageVector getBeerStein(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(148.82f, 32.0f);
        pathBuilder.curveToRelative(-11.91f, -10.2f, -28.0f, -16.0f, -44.82f, -16.0f);
        pathBuilder.curveTo(68.71f, 16.0f, 40.0f, 41.12f, 40.0f, 72.0f);
        ...
        pathBuilder.lineTo(240.0f, 112.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 216.0f, 88.0f);
        pathBuilder.close();
        ...
        pathBuilder.curveToRelative(4.46f, -18.24f, 23.85f, -32.0f, 47.0f, -32.0f);
        pathBuilder.curveToRelative(13.87f, 0.0f, 27.06f, 5.0f, 36.21f, 13.78f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 145.74f, 48.0f);
