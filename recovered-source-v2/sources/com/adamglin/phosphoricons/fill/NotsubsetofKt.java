...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NotSubsetOf", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getNotSubsetOf", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_notSubsetOf", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NotsubsetofKt {
    private static ImageVector _notSubsetOf;

    public static final ImageVector getNotSubsetOf(FillGroup fillGroup) {
        ...
        pathBuilder.lineTo(90.83f, 158.33f);
        pathBuilder.arcTo(48.0f, 48.0f, 0.0f, false, true, 128.0f, 80.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(173.37f, 64.0f);
        pathBuilder.lineTo(128.0f, 64.0f);
        pathBuilder.arcTo(64.0f, 64.0f, 0.0f, false, false, 80.19f, 170.49f);
        pathBuilder.lineTo(66.0f, 186.73f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 12.0f, 10.54f);
        pathBuilder.lineTo(92.22f, 181.0f);
        pathBuilder.arcTo(63.62f, 63.62f, 0.0f, false, false, 128.0f, 192.0f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.lineTo(128.0f, 176.0f);
        pathBuilder.arcToRelative(47.63f, 47.63f, 0.0f, false, true, -25.13f, -7.13f);
