...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getUserCircle", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userCircle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsercircleKt {
    private static ImageVector _userCircle;

    public static final ImageVector getUserCircle(FillGroup fillGroup) {
        ...
        pathBuilder.arcTo(44.05f, 44.05f, 0.0f, false, true, 172.0f, 120.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(88.09f, 88.09f, 0.0f, false, false, -91.47f, -87.93f);
        pathBuilder.curveTo(77.43f, 41.89f, 39.87f, 81.12f, 40.0f, 128.25f);
        pathBuilder.arcToRelative(87.65f, 87.65f, 0.0f, false, false, 22.24f, 58.16f);
        ...
        pathBuilder.arcToRelative(59.83f, 59.83f, 0.0f, false, false, 78.28f, 0.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.83f, -0.32f);
        pathBuilder.arcToRelative(79.71f, 79.71f, 0.0f, false, true, 21.79f, 21.31f);
