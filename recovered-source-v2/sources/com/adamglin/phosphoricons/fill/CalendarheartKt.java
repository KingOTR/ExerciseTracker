...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CalendarHeart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/FillGroup;", "getCalendarHeart", "(Lcom/adamglin/phosphoricons/FillGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendarHeart", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarheartKt {
    private static ImageVector _calendarHeart;

    public static final ImageVector getCalendarHeart(FillGroup fillGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(154.56f, 167.07f);
        ...
        pathBuilder.arcToRelative(143.52f, 143.52f, 0.0f, false, true, -24.77f, -16.51f);
        pathBuilder.curveTo(84.56f, 153.0f, 76.0f, 138.51f, 76.0f, 124.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, true, 52.0f, -14.41f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 180.0f, 124.0f);
        pathBuilder.curveTo(180.0f, 138.51f, 171.44f, 153.0f, 154.56f, 167.07f);
        pathBuilder.close();
