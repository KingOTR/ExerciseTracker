...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HourglassHigh", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getHourglassHigh", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_hourglassHigh", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HourglasshighKt {
    private static ImageVector _hourglassHigh;

    public static final ImageVector getHourglassHigh(LightGroup lightGroup) {
        ...
        pathBuilder.arcTo(14.0f, 14.0f, 0.0f, false, false, 184.0f, 26.0f);
        pathBuilder.close();
        pathBuilder.moveTo(72.0f, 38.0f);
        pathBuilder.lineTo(184.0f, 38.0f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, 2.0f);
        pathBuilder.lineTo(186.0f, 58.0f);
        pathBuilder.lineTo(70.0f, 58.0f);
        pathBuilder.lineTo(70.0f, 40.0f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, true, 72.0f, 38.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(185.21f, 77.24f);
        ...
        pathBuilder.lineTo(186.0f, 70.0f);
        pathBuilder.verticalLineToRelative(5.64f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, true, 185.21f, 77.24f);
        pathBuilder.close();
