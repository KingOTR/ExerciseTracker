...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Tag", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getTag", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_tag", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TagKt {
    private static ImageVector _tag;

    public static final ImageVector getTag(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(241.91f, 137.42f);
        pathBuilder.lineTo(142.59f, 38.1f);
        ...
        pathBuilder.arcTo(14.0f, 14.0f, 0.0f, false, false, 241.91f, 137.42f);
        pathBuilder.close();
        pathBuilder.moveTo(233.42f, 148.73f);
        pathBuilder.lineTo(148.73f, 233.42f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.83f, 0.0f);
        pathBuilder.lineTo(46.59f, 134.1f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -0.59f, -1.41f);
        pathBuilder.lineTo(46.0f, 46.0f);
        pathBuilder.horizontalLineToRelative(86.69f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.41f, 0.59f);
        pathBuilder.lineToRelative(99.32f, 99.31f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, true, 233.42f, 148.73f);
        pathBuilder.close();
        pathBuilder.moveTo(94.0f, 84.0f);
        pathBuilder.arcTo(10.0f, 10.0f, 0.0f, true, true, 84.0f, 74.0f);
        pathBuilder.arcTo(10.0f, 10.0f, 0.0f, false, true, 94.0f, 84.0f);
        pathBuilder.close();
