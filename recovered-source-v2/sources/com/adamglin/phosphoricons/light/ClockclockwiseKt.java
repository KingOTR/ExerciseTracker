...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ClockClockwise", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getClockClockwise", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_clockClockwise", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ClockclockwiseKt {
    private static ImageVector _clockClockwise;

    public static final ImageVector getClockClockwise(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(218.0f, 87.36f);
        pathBuilder.curveToRelative(-7.48f, -8.83f, -14.94f, -17.13f, -23.53f, -25.83f);
        pathBuilder.arcToRelative(94.0f, 94.0f, 0.0f, true, false, -1.95f, 134.83f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -8.24f, -8.72f);
        pathBuilder.arcTo(82.0f, 82.0f, 0.0f, true, true, 186.0f, 70.0f);
        pathBuilder.curveToRelative(9.24f, 9.36f, 17.18f, 18.3f, 25.31f, 28.0f);
