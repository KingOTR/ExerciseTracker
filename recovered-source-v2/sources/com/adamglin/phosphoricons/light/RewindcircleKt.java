...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"RewindCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getRewindCircle", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_rewindCircle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RewindcircleKt {
    private static ImageVector _rewindCircle;

    public static final ImageVector getRewindCircle(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(174.68f, 86.63f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -6.28f, 0.57f);
        pathBuilder.lineTo(122.0f, 122.0f);
        pathBuilder.lineTo(122.0f, 92.0f);
        ...
        pathBuilder.lineToRelative(48.0f, 36.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 122.0f, 164.0f);
        pathBuilder.lineTo(122.0f, 134.0f);
        pathBuilder.lineToRelative(46.4f, 34.8f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 178.0f, 164.0f);
        pathBuilder.lineTo(178.0f, 92.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 174.68f, 86.63f);
        pathBuilder.close();
        pathBuilder.moveTo(110.0f, 152.0f);
        pathBuilder.lineTo(78.0f, 128.0f);
        pathBuilder.lineToRelative(32.0f, -24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(166.0f, 152.0f);
        pathBuilder.lineTo(134.0f, 128.0f);
        pathBuilder.lineTo(166.0f, 104.0f);
        pathBuilder.close();
