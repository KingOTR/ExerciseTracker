...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PersonSimpleCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getPersonSimpleCircle", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_personSimpleCircle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PersonsimplecircleKt {
    private static ImageVector _personSimpleCircle;

    public static final ImageVector getPersonSimpleCircle(LightGroup lightGroup) {
        ...
        pathBuilder.verticalLineToRelative(16.18f);
        pathBuilder.lineToRelative(31.0f, 46.49f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, -10.0f, 6.66f);
        pathBuilder.lineToRelative(-27.0f, -40.51f);
        pathBuilder.lineToRelative(-27.0f, 40.51f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, -10.0f, -6.66f);
        pathBuilder.lineToRelative(31.0f, -46.49f);
        pathBuilder.lineTo(122.0f, 118.0f);
