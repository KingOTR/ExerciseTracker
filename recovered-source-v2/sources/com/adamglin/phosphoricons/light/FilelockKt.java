...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileLock", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFileLock", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileLock", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilelockKt {
    private static ImageVector _fileLock;

    public static final ImageVector getFileLock(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(120.0f, 178.0f);
        pathBuilder.lineTo(110.0f, 178.0f);
        pathBuilder.verticalLineToRelative(-6.0f);
        pathBuilder.arcToRelative(26.0f, 26.0f, 0.0f, false, false, -52.0f, 0.0f);
        pathBuilder.verticalLineToRelative(6.0f);
        pathBuilder.lineTo(48.0f, 178.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -6.0f, 6.0f);
        pathBuilder.verticalLineToRelative(40.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.0f, 6.0f);
        pathBuilder.horizontalLineToRelative(72.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.0f, -6.0f);
        pathBuilder.lineTo(126.0f, 184.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 120.0f, 178.0f);
        pathBuilder.close();
        pathBuilder.moveTo(70.0f, 172.0f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, true, 28.0f, 0.0f);
        pathBuilder.verticalLineToRelative(6.0f);
        pathBuilder.lineTo(70.0f, 178.0f);
        pathBuilder.close();
        pathBuilder.moveTo(114.0f, 218.0f);
