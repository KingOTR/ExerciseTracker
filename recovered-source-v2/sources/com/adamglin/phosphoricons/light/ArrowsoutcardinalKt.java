...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsOutCardinal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getArrowsOutCardinal", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsOutCardinal", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsoutcardinalKt {
    private static ImageVector _arrowsOutCardinal;

    public static final ImageVector getArrowsOutCardinal(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(91.76f, 60.24f);
        ...
        pathBuilder.lineTo(122.0f, 38.49f);
        pathBuilder.lineTo(100.24f, 60.24f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 91.76f, 60.24f);
        pathBuilder.close();
        pathBuilder.moveTo(155.76f, 195.76f);
        pathBuilder.lineTo(134.0f, 217.51f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(38.49f, 134.0f);
