...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Command", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getCommand", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_command", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CommandKt {
    private static ImageVector _command;

    public static final ImageVector getCommand(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(158.0f, 146.0f);
        pathBuilder.lineTo(158.0f, 110.0f);
        pathBuilder.horizontalLineToRelative(22.0f);
        pathBuilder.arcToRelative(34.0f, 34.0f, 0.0f, true, false, -34.0f, -34.0f);
        pathBuilder.lineTo(146.0f, 98.0f);
        pathBuilder.lineTo(110.0f, 98.0f);
        pathBuilder.lineTo(110.0f, 76.0f);
        pathBuilder.arcToRelative(34.0f, 34.0f, 0.0f, true, false, -34.0f, 34.0f);
        pathBuilder.lineTo(98.0f, 110.0f);
        pathBuilder.verticalLineToRelative(36.0f);
        pathBuilder.lineTo(76.0f, 146.0f);
        pathBuilder.arcToRelative(34.0f, 34.0f, 0.0f, true, false, 34.0f, 34.0f);
        ...
        pathBuilder.arcToRelative(34.0f, 34.0f, 0.0f, true, false, 34.0f, -34.0f);
        pathBuilder.close();
        pathBuilder.moveTo(158.0f, 76.0f);
        pathBuilder.arcToRelative(22.0f, 22.0f, 0.0f, true, true, 22.0f, 22.0f);
        pathBuilder.lineTo(158.0f, 98.0f);
        pathBuilder.close();
        pathBuilder.moveTo(54.0f, 76.0f);
        pathBuilder.arcToRelative(22.0f, 22.0f, 0.0f, false, true, 44.0f, 0.0f);
        pathBuilder.lineTo(98.0f, 98.0f);
        pathBuilder.lineTo(76.0f, 98.0f);
        pathBuilder.arcTo(22.0f, 22.0f, 0.0f, false, true, 54.0f, 76.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(158.0f, 158.0f);
        pathBuilder.horizontalLineToRelative(22.0f);
