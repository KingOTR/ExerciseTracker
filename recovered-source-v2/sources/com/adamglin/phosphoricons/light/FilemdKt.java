...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileMd", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFileMd", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileMd", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilemdKt {
    private static ImageVector _fileMd;

    public static final ImageVector getFileMd(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(202.0f, 224.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 12.0f, 0.0f);
        ...
        pathBuilder.lineTo(90.0f, 171.0f);
        pathBuilder.lineTo(72.92f, 195.44f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -9.84f, 0.0f);
        pathBuilder.lineTo(46.0f, 171.0f);
        pathBuilder.verticalLineToRelative(37.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f);
        pathBuilder.lineTo(34.0f, 152.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 10.92f, -3.44f);
        pathBuilder.lineToRelative(23.08f, 33.0f);
        pathBuilder.lineToRelative(23.08f, -33.0f);
