...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"EnvelopeOpen", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getEnvelopeOpen", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_envelopeOpen", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class EnvelopeopenKt {
    private static ImageVector _envelopeOpen;

    public static final ImageVector getEnvelopeOpen(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(100.18f, 152.0f);
        pathBuilder.lineTo(38.0f, 195.9f);
        pathBuilder.lineTo(38.0f, 107.65f);
        pathBuilder.close();
        pathBuilder.moveTo(112.45f, 158.0f);
        pathBuilder.horizontalLineToRelative(31.1f);
        pathBuilder.lineToRelative(62.29f, 44.0f);
        pathBuilder.lineTo(50.16f, 202.0f);
        pathBuilder.close();
        pathBuilder.moveTo(155.82f, 152.0f);
        pathBuilder.lineTo(218.0f, 107.65f);
        pathBuilder.lineTo(218.0f, 195.9f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 39.21f);
        pathBuilder.lineToRelative(85.43f, 57.0f);
        pathBuilder.lineTo(143.53f, 146.0f);
        pathBuilder.lineTo(112.47f, 146.0f);
