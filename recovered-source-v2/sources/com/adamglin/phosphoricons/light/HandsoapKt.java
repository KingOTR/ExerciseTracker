...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandSoap", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getHandSoap", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handSoap", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandsoapKt {
    private static ImageVector _handSoap;

    public static final ImageVector getHandSoap(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(182.0f, 98.48f);
        ...
        pathBuilder.lineTo(104.0f, 58.0f);
        pathBuilder.arcTo(30.0f, 30.0f, 0.0f, false, false, 74.0f, 88.0f);
        pathBuilder.lineTo(74.0f, 98.48f);
        pathBuilder.arcTo(38.05f, 38.05f, 0.0f, false, false, 42.0f, 136.0f);
        pathBuilder.verticalLineToRelative(80.0f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.0f, 14.0f);
        pathBuilder.lineTo(200.0f, 230.0f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.0f, -14.0f);
        pathBuilder.lineTo(214.0f, 136.0f);
        pathBuilder.arcTo(38.05f, 38.05f, 0.0f, false, false, 182.0f, 98.48f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(86.0f, 98.0f);
        pathBuilder.lineTo(86.0f, 88.0f);
        pathBuilder.arcTo(18.0f, 18.0f, 0.0f, false, true, 104.0f, 70.0f);
        pathBuilder.close();
