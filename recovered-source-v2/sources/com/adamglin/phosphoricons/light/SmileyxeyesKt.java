...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SmileyXEyes", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getSmileyXEyes", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_smileyXEyes", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SmileyxeyesKt {
    private static ImageVector _smileyXEyes;

    public static final ImageVector getSmileyXEyes(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(188.24f, 100.24f);
        pathBuilder.lineTo(176.49f, 112.0f);
        pathBuilder.lineToRelative(11.75f, 11.76f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, -8.48f, 8.48f);
        pathBuilder.lineTo(168.0f, 120.49f);
        pathBuilder.lineToRelative(-11.76f, 11.75f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -8.48f, -8.48f);
        pathBuilder.lineTo(159.51f, 112.0f);
        pathBuilder.lineToRelative(-11.75f, -11.76f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 8.48f, -8.48f);
        pathBuilder.lineTo(168.0f, 103.51f);
        pathBuilder.lineToRelative(11.76f, -11.75f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 8.48f, 8.48f);
        pathBuilder.close();
        pathBuilder.moveTo(108.24f, 100.24f);
        pathBuilder.lineTo(96.49f, 112.0f);
        pathBuilder.lineToRelative(11.75f, 11.76f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, -8.48f, 8.48f);
        pathBuilder.lineTo(88.0f, 120.49f);
        pathBuilder.lineTo(76.24f, 132.24f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -8.48f, -8.48f);
        pathBuilder.lineTo(79.51f, 112.0f);
        pathBuilder.lineTo(67.76f, 100.24f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 8.48f, -8.48f);
        pathBuilder.lineTo(88.0f, 103.51f);
