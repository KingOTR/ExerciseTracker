...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"IdentificationBadge", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getIdentificationBadge", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_identificationBadge", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class IdentificationbadgeKt {
    private static ImageVector _identificationBadge;

    public static final ImageVector getIdentificationBadge(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(151.11f, 166.13f);
        pathBuilder.arcToRelative(38.0f, 38.0f, 0.0f, true, false, -46.22f, 0.0f);
        pathBuilder.arcTo(65.75f, 65.75f, 0.0f, false, false, 75.2f, 188.4f);
        ...
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 9.6f, -7.2f);
        pathBuilder.arcTo(65.75f, 65.75f, 0.0f, false, false, 151.11f, 166.13f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 110.0f);
        pathBuilder.arcToRelative(26.0f, 26.0f, 0.0f, true, true, -26.0f, 26.0f);
        pathBuilder.arcTo(26.0f, 26.0f, 0.0f, false, true, 128.0f, 110.0f);
        pathBuilder.close();
