...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Pencil", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getPencil", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pencil", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PencilKt {
    private static ImageVector _pencil;

    public static final ImageVector getPencil(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(225.9f, 74.78f);
        pathBuilder.lineTo(181.21f, 30.09f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, -19.8f, 0.0f);
        pathBuilder.lineTo(38.1f, 153.41f);
        ...
        pathBuilder.lineTo(225.9f, 94.58f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 0.0f, -19.8f);
        pathBuilder.close();
        pathBuilder.moveTo(48.49f, 160.0f);
        pathBuilder.lineTo(136.0f, 72.48f);
        pathBuilder.lineTo(155.51f, 92.0f);
        pathBuilder.lineTo(68.0f, 179.51f);
        pathBuilder.close();
        pathBuilder.moveTo(46.0f, 208.0f);
        pathBuilder.lineTo(46.0f, 174.48f);
        pathBuilder.lineTo(81.51f, 210.0f);
        ...
        pathBuilder.lineTo(164.0f, 100.48f);
        pathBuilder.lineTo(183.51f, 120.0f);
        pathBuilder.close();
        pathBuilder.moveTo(217.41f, 86.1f);
        pathBuilder.lineTo(192.0f, 111.51f);
        pathBuilder.lineTo(144.49f, 64.0f);
        pathBuilder.lineTo(169.9f, 38.58f);
