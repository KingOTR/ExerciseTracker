...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HourglassMedium", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getHourglassMedium", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_hourglassMedium", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HourglassmediumKt {
    private static ImageVector _hourglassMedium;

    public static final ImageVector getHourglassMedium(LightGroup lightGroup) {
        ...
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, 2.0f);
        pathBuilder.lineTo(186.0f, 75.64f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -0.79f, 1.6f);
        pathBuilder.lineTo(178.9f, 82.0f);
        pathBuilder.lineTo(76.67f, 82.0f);
        pathBuilder.lineTo(70.8f, 77.6f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, true, 70.0f, 76.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 120.49f);
        pathBuilder.lineTo(92.67f, 94.0f);
        pathBuilder.lineTo(163.0f, 94.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(134.0f, 140.06f);
        pathBuilder.lineToRelative(51.21f, 38.7f);
