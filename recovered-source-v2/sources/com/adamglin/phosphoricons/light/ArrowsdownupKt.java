...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsDownUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getArrowsDownUp", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsDownUp", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsdownupKt {
    private static ImageVector _arrowsDownUp;

    public static final ImageVector getArrowsDownUp(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(116.24f, 171.76f);
        ...
        pathBuilder.lineTo(74.0f, 193.51f);
        pathBuilder.lineTo(74.0f, 48.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 12.0f, 0.0f);
        pathBuilder.lineTo(86.0f, 193.51f);
        pathBuilder.lineToRelative(21.76f, -21.75f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 116.24f, 171.76f);
        pathBuilder.close();
        pathBuilder.moveTo(212.24f, 75.76f);
        pathBuilder.lineTo(180.24f, 43.76f);
        ...
        pathBuilder.lineTo(170.0f, 62.49f);
        pathBuilder.lineTo(170.0f, 208.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 12.0f, 0.0f);
        pathBuilder.lineTo(182.0f, 62.49f);
        pathBuilder.lineToRelative(21.76f, 21.75f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 8.48f, -8.48f);
        pathBuilder.close();
