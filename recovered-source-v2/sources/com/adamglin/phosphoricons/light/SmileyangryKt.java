...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SmileyAngry", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getSmileyAngry", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_smileyAngry", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SmileyangryKt {
    private static ImageVector _smileyAngry;

    public static final ImageVector getSmileyAngry(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(92.0f, 150.0f);
        pathBuilder.arcToRelative(10.0f, 10.0f, 0.0f, true, true, 10.0f, -10.0f);
        pathBuilder.arcTo(10.0f, 10.0f, 0.0f, false, true, 92.0f, 150.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(172.67f, 83.0f);
        pathBuilder.lineTo(128.0f, 112.79f);
        pathBuilder.lineTo(83.33f, 83.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -6.66f, 10.0f);
        pathBuilder.lineToRelative(48.0f, 32.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.66f, 0.0f);
        pathBuilder.lineToRelative(48.0f, -32.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, false, -6.66f, -10.0f);
        pathBuilder.close();
        pathBuilder.moveTo(155.32f, 179.0f);
        ...
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.64f, 10.0f);
        pathBuilder.curveToRelative(6.67f, -4.43f, 12.19f, -7.0f, 20.68f, -7.0f);
        pathBuilder.reflectiveCurveToRelative(14.0f, 2.57f, 20.68f, 7.0f);
        pathBuilder.arcToRelative(5.94f, 5.94f, 0.0f, false, false, 3.31f, 1.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 3.33f, -11.0f);
        pathBuilder.close();
