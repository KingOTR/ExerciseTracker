...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FilePy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFilePy", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_filePy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilepyKt {
    private static ImageVector _filePy;

    public static final ImageVector getFilePy(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(64.0f, 198.0f);
        pathBuilder.arcToRelative(26.0f, 26.0f, 0.0f, false, false, 0.0f, -52.0f);
        pathBuilder.close();
        pathBuilder.moveTo(64.0f, 186.0f);
        pathBuilder.lineTo(54.0f, 186.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(153.09f, 155.18f);
        pathBuilder.lineTo(134.0f, 185.72f);
        pathBuilder.lineTo(134.0f, 208.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f);
        pathBuilder.lineTo(122.0f, 185.72f);
        pathBuilder.lineToRelative(-19.09f, -30.54f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 10.18f, -6.36f);
        pathBuilder.lineTo(128.0f, 172.68f);
        pathBuilder.lineToRelative(14.91f, -23.86f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 10.18f, 6.36f);
        pathBuilder.close();
