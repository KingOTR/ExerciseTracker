...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Warehouse", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getWarehouse", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_warehouse", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class WarehouseKt {
    private static ImageVector _warehouse;

    public static final ImageVector getWarehouse(LightGroup lightGroup) {
        ...
        pathBuilder.verticalLineTo(56.28f);
        pathBuilder.lineToRelative(11.26f, -2.41f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, false, -2.52f, -11.74f);
        pathBuilder.lineToRelative(-224.0f, 48.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 2.52f, 11.74f);
        pathBuilder.lineTo(26.0f, 100.0f);
        ...
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, -12.0f);
        pathBuilder.close();
        pathBuilder.moveTo(38.0f, 97.42f);
        pathBuilder.lineTo(218.0f, 58.85f);
