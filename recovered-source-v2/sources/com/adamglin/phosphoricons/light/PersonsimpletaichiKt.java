...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PersonSimpleTaiChi", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getPersonSimpleTaiChi", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_personSimpleTaiChi", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PersonsimpletaichiKt {
    private static ImageVector _personSimpleTaiChi;

    public static final ImageVector getPersonSimpleTaiChi(LightGroup lightGroup) {
        ...
        pathBuilder.lineToRelative(52.36f, 22.45f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 190.0f, 168.0f);
        pathBuilder.verticalLineToRelative(48.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f);
        pathBuilder.lineTo(178.0f, 172.0f);
        pathBuilder.lineTo(129.16f, 151.0f);
        pathBuilder.lineTo(52.0f, 220.46f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -8.0f, -8.92f);
        pathBuilder.lineToRelative(78.0f, -70.21f);
        pathBuilder.lineTo(122.0f, 110.0f);
        pathBuilder.lineTo(40.0f, 110.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 0.0f, -12.0f);
        pathBuilder.lineTo(216.0f, 98.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 222.0f, 104.0f);
        pathBuilder.close();
