...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Globe", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getGlobe", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_globe", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GlobeKt {
    private static ImageVector _globe;

    public static final ImageVector getGlobe(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(209.57f, 90.0f);
        pathBuilder.lineTo(169.19f, 90.0f);
        ...
        pathBuilder.arcToRelative(89.7f, 89.7f, 0.0f, false, true, -3.83f, 26.0f);
        pathBuilder.lineTo(171.81f, 154.0f);
        ...
        pathBuilder.arcTo(124.24f, 124.24f, 0.0f, false, true, 99.35f, 166.0f);
        pathBuilder.horizontalLineToRelative(57.3f);
        pathBuilder.arcToRelative(124.24f, 124.24f, 0.0f, false, true, -13.46f, 30.38f);
        pathBuilder.arcTo(110.0f, 110.0f, 0.0f, false, true, 128.0f, 215.83f);
        pathBuilder.close();
        pathBuilder.moveTo(96.45f, 154.0f);
        ...
        pathBuilder.arcTo(89.7f, 89.7f, 0.0f, false, true, 38.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 40.17f);
        pathBuilder.arcToRelative(110.0f, 110.0f, 0.0f, false, true, 15.19f, 19.45f);
        pathBuilder.arcTo(124.24f, 124.24f, 0.0f, false, true, 156.65f, 90.0f);
        pathBuilder.lineTo(99.35f, 90.0f);
        pathBuilder.arcToRelative(124.24f, 124.24f, 0.0f, false, true, 13.46f, -30.38f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(143.43f, 216.67f);
        pathBuilder.arcTo(132.58f, 132.58f, 0.0f, false, false, 169.19f, 166.0f);
        pathBuilder.horizontalLineToRelative(40.38f);
        pathBuilder.arcTo(90.29f, 90.29f, 0.0f, false, true, 143.46f, 216.67f);
        pathBuilder.close();
