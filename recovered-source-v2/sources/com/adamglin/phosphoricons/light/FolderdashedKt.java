...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FolderDashed", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFolderDashed", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_folderDashed", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FolderdashedKt {
    private static ImageVector _folderDashed;

    public static final ImageVector getFolderDashed(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(200.0f, 202.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, 12.0f);
        ...
        pathBuilder.lineTo(168.0f, 74.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, 12.0f);
        ...
        pathBuilder.lineTo(92.69f, 42.0f);
        pathBuilder.arcToRelative(13.94f, 13.94f, 0.0f, false, true, 9.9f, 4.1f);
        pathBuilder.lineToRelative(29.65f, 29.66f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 128.0f, 86.0f);
        pathBuilder.lineTo(32.0f, 86.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 26.0f, 80.0f);
        pathBuilder.close();
        pathBuilder.moveTo(38.0f, 74.0f);
        pathBuilder.horizontalLineToRelative(75.51f);
        pathBuilder.lineTo(94.1f, 54.59f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, false, 92.69f, 54.0f);
        pathBuilder.lineTo(40.0f, 54.0f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, false, -2.0f, 2.0f);
        pathBuilder.close();
        pathBuilder.moveTo(32.0f, 158.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.0f, -6.0f);
        pathBuilder.lineTo(38.0f, 120.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -12.0f, 0.0f);
        pathBuilder.verticalLineToRelative(32.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 32.0f, 158.0f);
        pathBuilder.close();
