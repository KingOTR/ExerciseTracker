...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Pen", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getPen", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pen", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PenKt {
    private static ImageVector _pen;

    public static final ImageVector getPen(LightGroup lightGroup) {
        ...
        pathBuilder.lineToRelative(86.16f, -86.16f);
        pathBuilder.lineToRelative(4.61f, 18.42f);
        pathBuilder.lineToRelative(-37.6f, 37.6f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, false, 8.49f, 8.48f);
        pathBuilder.lineToRelative(40.0f, -40.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 1.58f, -5.7f);
        pathBuilder.lineToRelative(-7.18f, -28.7f);
        pathBuilder.lineToRelative(27.26f, -27.25f);
        pathBuilder.arcTo(14.0f, 14.0f, 0.0f, false, false, 225.91f, 74.79f);
        pathBuilder.close();
        pathBuilder.moveTo(46.0f, 208.0f);
        pathBuilder.lineTo(46.0f, 174.49f);
        ...
        pathBuilder.lineTo(136.0f, 72.49f);
        ...
        pathBuilder.lineTo(169.9f, 38.59f);
