...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandCoins", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getHandCoins", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handCoins", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandcoinsKt {
    private static ImageVector _handCoins;

    public static final ImageVector getHandCoins(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(164.0f, 94.0f);
        pathBuilder.arcToRelative(34.54f, 34.54f, 0.0f, false, false, 7.28f, -0.78f);
        pathBuilder.arcToRelative(34.0f, 34.0f, 0.0f, true, false, 25.46f, -42.43f);
        pathBuilder.arcTo(34.0f, 34.0f, 0.0f, true, false, 164.0f, 94.0f);
        pathBuilder.close();
        pathBuilder.moveTo(226.0f, 84.0f);
        pathBuilder.arcToRelative(22.0f, 22.0f, 0.0f, true, true, -22.0f, -22.0f);
        pathBuilder.arcTo(22.0f, 22.0f, 0.0f, false, true, 226.0f, 84.0f);
        pathBuilder.close();
        pathBuilder.moveTo(164.0f, 38.0f);
        pathBuilder.arcToRelative(21.94f, 21.94f, 0.0f, false, true, 21.51f, 17.49f);
        pathBuilder.arcToRelative(34.0f, 34.0f, 0.0f, false, false, -15.38f, 25.65f);
        pathBuilder.arcTo(22.0f, 22.0f, 0.0f, true, true, 164.0f, 38.0f);
        pathBuilder.close();
