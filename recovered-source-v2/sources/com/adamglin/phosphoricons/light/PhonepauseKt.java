...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PhonePause", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getPhonePause", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_phonePause", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PhonepauseKt {
    private static ImageVector _phonePause;

    public static final ImageVector getPhonePause(LightGroup lightGroup) {
        ...
        pathBuilder.curveToRelative(0.15f, -0.18f, 0.29f, -0.38f, 0.42f, -0.57f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 1.12f, -13.28f);
        ...
        pathBuilder.arcTo(42.24f, 42.24f, 0.0f, false, true, 74.67f, 46.0f);
        ...
        pathBuilder.lineTo(194.0f, 48.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 12.0f, 0.0f);
        pathBuilder.verticalLineToRelative(56.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(154.0f, 104.0f);
