...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Calendar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getCalendar", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarKt {
    private static ImageVector _calendar;

    public static final ImageVector getCalendar(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(46.0f, 82.0f);
        ...
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.0f, -2.0f);
        pathBuilder.lineTo(46.0f, 94.0f);
        pathBuilder.lineTo(210.0f, 94.0f);
        pathBuilder.lineTo(210.0f, 208.0f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, true, 208.0f, 210.0f);
        pathBuilder.close();
        pathBuilder.moveTo(110.0f, 120.0f);
        pathBuilder.verticalLineToRelative(64.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f);
        pathBuilder.lineTo(98.0f, 129.71f);
        pathBuilder.lineToRelative(-7.32f, 3.66f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, -5.36f, -10.74f);
        pathBuilder.lineToRelative(16.0f, -8.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 110.0f, 120.0f);
        pathBuilder.close();
        pathBuilder.moveTo(169.57f, 149.25f);
        pathBuilder.lineTo(148.0f, 178.0f);
        pathBuilder.horizontalLineToRelative(20.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 0.0f, 12.0f);
        pathBuilder.lineTo(136.0f, 190.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -4.8f, -9.6f);
        pathBuilder.lineTo(160.0f, 142.0f);
        pathBuilder.arcToRelative(10.0f, 10.0f, 0.0f, true, false, -16.65f, -11.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, true, true, 133.0f, 125.0f);
        pathBuilder.arcToRelative(22.0f, 22.0f, 0.0f, true, true, 36.62f, 24.26f);
        pathBuilder.close();
