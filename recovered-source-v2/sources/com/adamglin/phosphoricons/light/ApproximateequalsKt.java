...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ApproximateEquals", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getApproximateEquals", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_approximateEquals", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ApproximateequalsKt {
    private static ImageVector _approximateEquals;

    public static final ImageVector getApproximateEquals(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(220.62f, 154.57f);
        ...
        pathBuilder.curveToRelative(-18.19f, 0.0f, -34.13f, -8.66f, -48.94f, -16.71f);
        pathBuilder.curveToRelative(-26.0f, -14.12f, -48.44f, -26.31f, -81.31f, 1.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, true, true, 36.17f, 157.0f);
        pathBuilder.curveToRelative(39.13f, -32.46f, 68.65f, -16.42f, 94.69f, -2.27f);
        pathBuilder.reflectiveCurveToRelative(48.44f, 26.31f, 81.31f, -1.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 220.62f, 154.57f);
        pathBuilder.close();
        pathBuilder.moveTo(43.83f, 102.22f);
        ...
        pathBuilder.curveToRelative(-32.87f, 27.27f, -55.32f, 15.08f, -81.31f, 1.0f);
        pathBuilder.reflectiveCurveTo(75.3f, 60.52f, 36.17f, 93.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 7.66f, 9.24f);
        pathBuilder.close();
