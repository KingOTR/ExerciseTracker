...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileImage", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFileImage", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileImage", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FileimageKt {
    private static ImageVector _fileImage;

    public static final ImageVector getFileImage(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(109.0f, 148.67f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -10.0f, 0.0f);
        pathBuilder.lineTo(76.46f, 182.5f);
        pathBuilder.lineTo(65.05f, 164.76f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -10.1f, 0.0f);
        pathBuilder.lineToRelative(-36.0f, 56.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 24.0f, 230.0f);
        pathBuilder.horizontalLineTo(152.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 5.0f, -9.33f);
        pathBuilder.close();
        pathBuilder.moveTo(35.0f, 218.0f);
        pathBuilder.lineToRelative(25.0f, -38.9f);
        pathBuilder.lineToRelative(11.32f, 17.6f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 10.0f, 0.08f);
        pathBuilder.lineToRelative(22.64f, -34.0f);
        pathBuilder.lineTo(140.79f, 218.0f);
        pathBuilder.close();
