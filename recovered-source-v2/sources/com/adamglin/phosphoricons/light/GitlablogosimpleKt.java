...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"GitlabLogoSimple", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getGitlabLogoSimple", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_gitlabLogoSimple", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GitlablogosimpleKt {
    private static ImageVector _gitlabLogoSimple;

    public static final ImageVector getGitlabLogoSimple(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(200.06f, 166.61f);
        pathBuilder.lineTo(128.0f, 217.53f);
        pathBuilder.lineTo(55.94f, 166.62f);
        pathBuilder.arcToRelative(43.12f, 43.12f, 0.0f, false, true, -16.54f, -46.0f);
        pathBuilder.lineTo(57.65f, 50.82f);
        ...
        pathBuilder.lineToRelative(18.25f, 69.82f);
        pathBuilder.arcTo(43.12f, 43.12f, 0.0f, false, true, 200.06f, 166.62f);
        pathBuilder.close();
