...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Nut", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getNut", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_nut", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NutKt {
    private static ImageVector _nut;

    public static final ImageVector getNut(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(134.72f, 19.73f);
        ...
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -1.0f, -1.75f);
        pathBuilder.lineTo(38.0f, 80.18f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.0f, -1.75f);
        pathBuilder.lineToRelative(88.0f, -48.18f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.92f, 0.0f);
        pathBuilder.lineToRelative(88.0f, 48.18f);
