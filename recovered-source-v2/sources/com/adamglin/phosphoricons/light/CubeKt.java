...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Cube", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getCube", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cube", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CubeKt {
    private static ImageVector _cube;

    public static final ImageVector getCube(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(222.72f, 67.9f);
        ...
        pathBuilder.arcTo(14.0f, 14.0f, 0.0f, false, false, 222.72f, 67.9f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(43.49f, 76.0f);
        pathBuilder.close();
        pathBuilder.moveTo(39.0f, 177.57f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -1.0f, -1.75f);
        pathBuilder.lineTo(38.0f, 86.66f);
        pathBuilder.lineToRelative(84.0f, 46.0f);
        pathBuilder.lineTo(122.0f, 223.0f);
        pathBuilder.close();
        pathBuilder.moveTo(216.92f, 177.57f);
        pathBuilder.lineTo(134.0f, 223.0f);
        pathBuilder.lineTo(134.0f, 132.64f);
        pathBuilder.lineToRelative(84.0f, -46.0f);
        pathBuilder.verticalLineToRelative(89.16f);
