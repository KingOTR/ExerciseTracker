...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FunnelX", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFunnelX", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_funnelX", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FunnelxKt {
    private static ImageVector _funnelX;

    public static final ImageVector getFunnelX(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(228.79f, 50.34f);
        pathBuilder.arcTo(13.83f, 13.83f, 0.0f, false, false, 216.0f, 42.0f);
        ...
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 21.76f, 11.64f);
        ...
        pathBuilder.lineToRelative(68.34f, -73.0f);
        pathBuilder.arcTo(13.83f, 13.83f, 0.0f, false, false, 228.79f, 50.34f);
        pathBuilder.close();
        pathBuilder.moveTo(217.53f, 57.28f);
        pathBuilder.lineTo(147.63f, 131.9f);
        ...
        pathBuilder.arcToRelative(1.89f, 1.89f, 0.0f, false, true, -0.33f, -2.13f);
        pathBuilder.arcTo(1.91f, 1.91f, 0.0f, false, true, 40.0f, 54.0f);
        pathBuilder.lineTo(216.0f, 54.0f);
        pathBuilder.arcToRelative(1.9f, 1.9f, 0.0f, false, true, 1.82f, 1.19f);
        pathBuilder.arcTo(1.87f, 1.87f, 0.0f, false, true, 217.53f, 57.28f);
        pathBuilder.close();
        pathBuilder.moveTo(244.24f, 211.77f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, -8.48f, 8.48f);
        pathBuilder.lineTo(216.0f, 200.49f);
        pathBuilder.lineToRelative(-19.75f, 19.76f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -8.49f, -8.48f);
        pathBuilder.lineTo(207.52f, 192.0f);
        pathBuilder.lineToRelative(-19.76f, -19.76f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 8.49f, -8.49f);
        pathBuilder.lineTo(216.0f, 183.52f);
        pathBuilder.lineToRelative(19.76f, -19.76f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 8.48f, 8.49f);
        pathBuilder.lineTo(224.49f, 192.0f);
        pathBuilder.close();
