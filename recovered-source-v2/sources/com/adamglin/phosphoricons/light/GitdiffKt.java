...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"GitDiff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getGitDiff", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_gitDiff", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GitdiffKt {
    private static ImageVector _gitDiff;

    public static final ImageVector getGitDiff(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(112.0f, 154.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -6.0f, 6.0f);
        pathBuilder.verticalLineToRelative(33.52f);
        pathBuilder.lineTo(64.93f, 152.44f);
        pathBuilder.arcTo(9.93f, 9.93f, 0.0f, false, true, 62.0f, 145.37f);
        ...
        pathBuilder.lineTo(97.52f, 202.0f);
        pathBuilder.lineTo(64.0f, 202.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, 12.0f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.0f, -6.0f);
        pathBuilder.lineTo(118.0f, 160.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 112.0f, 154.0f);
        pathBuilder.close();
        pathBuilder.moveTo(38.0f, 64.0f);
        pathBuilder.arcTo(18.0f, 18.0f, 0.0f, true, true, 56.0f, 82.0f);
        pathBuilder.arcTo(18.0f, 18.0f, 0.0f, false, true, 38.0f, 64.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(9.93f, 9.93f, 0.0f, false, true, 2.93f, 7.07f);
        pathBuilder.verticalLineToRelative(52.0f);
        pathBuilder.arcToRelative(30.0f, 30.0f, 0.0f, true, false, 12.0f, 0.0f);
        pathBuilder.close();
