...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MessengerLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getMessengerLogo", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_messengerLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MessengerlogoKt {
    private static ImageVector _messengerLogo;

    public static final ImageVector getMessengerLogo(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(180.24f, 107.76f);
        ...
        pathBuilder.lineTo(112.0f, 120.49f);
        pathBuilder.lineTo(84.24f, 148.24f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -8.48f, -8.48f);
        pathBuilder.lineToRelative(32.0f, -32.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 8.48f, 0.0f);
        pathBuilder.lineTo(144.0f, 135.51f);
        pathBuilder.lineToRelative(27.76f, -27.75f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 180.24f, 107.76f);
        pathBuilder.close();
