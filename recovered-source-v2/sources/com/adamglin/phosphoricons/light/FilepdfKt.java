...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FilePdf", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFilePdf", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_filePdf", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilepdfKt {
    private static ImageVector _filePdf;

    public static final ImageVector getFilePdf(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(178.0f, 152.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 6.0f, -6.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(162.0f, 180.0f);
        pathBuilder.arcToRelative(34.0f, 34.0f, 0.0f, false, true, -34.0f, 34.0f);
        pathBuilder.lineTo(112.0f, 214.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -6.0f, -6.0f);
        pathBuilder.lineTo(106.0f, 152.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 6.0f, -6.0f);
        pathBuilder.horizontalLineToRelative(16.0f);
        pathBuilder.arcTo(34.0f, 34.0f, 0.0f, false, true, 162.0f, 180.0f);
        pathBuilder.close();
        pathBuilder.moveTo(150.0f, 180.0f);
        pathBuilder.arcToRelative(22.0f, 22.0f, 0.0f, false, false, -22.0f, -22.0f);
        pathBuilder.lineTo(118.0f, 158.0f);
        pathBuilder.verticalLineToRelative(44.0f);
        pathBuilder.horizontalLineToRelative(10.0f);
        pathBuilder.arcTo(22.0f, 22.0f, 0.0f, false, false, 150.0f, 180.0f);
        pathBuilder.close();
