...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileArrowDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFileArrowDown", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileArrowDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilearrowdownKt {
    private static ImageVector _fileArrowDown;

    public static final ImageVector getFileArrowDown(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(156.24f, 155.76f);
        ...
        pathBuilder.lineTo(122.0f, 169.51f);
        pathBuilder.lineTo(122.0f, 120.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 12.0f, 0.0f);
        pathBuilder.verticalLineToRelative(49.51f);
        pathBuilder.lineToRelative(13.76f, -13.75f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 156.24f, 155.76f);
        pathBuilder.close();
