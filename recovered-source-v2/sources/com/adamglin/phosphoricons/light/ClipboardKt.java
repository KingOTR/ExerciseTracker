...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Clipboard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getClipboard", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_clipboard", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ClipboardKt {
    private static ImageVector _clipboard;

    public static final ImageVector getClipboard(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(162.83f, 34.0f);
        pathBuilder.arcToRelative(45.91f, 45.91f, 0.0f, false, false, -69.66f, 0.0f);
        ...
        pathBuilder.lineTo(94.0f, 66.0f);
        pathBuilder.lineTo(94.0f, 64.0f);
        pathBuilder.arcTo(34.0f, 34.0f, 0.0f, false, true, 128.0f, 30.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, -2.0f);
        pathBuilder.lineTo(85.67f, 46.0f);
        pathBuilder.arcTo(45.77f, 45.77f, 0.0f, false, false, 82.0f, 64.0f);
        pathBuilder.verticalLineToRelative(8.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.0f, 6.0f);
        pathBuilder.horizontalLineToRelative(80.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 6.0f, -6.0f);
        pathBuilder.lineTo(174.0f, 64.0f);
        pathBuilder.arcToRelative(45.77f, 45.77f, 0.0f, false, false, -3.67f, -18.0f);
