...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserRectangle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getUserRectangle", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userRectangle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UserrectangleKt {
    private static ImageVector _userRectangle;

    public static final ImageVector getUserRectangle(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(69.21f, 202.0f);
        pathBuilder.arcToRelative(66.0f, 66.0f, 0.0f, false, true, 117.58f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(218.0f, 200.0f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.0f, 2.0f);
        pathBuilder.horizontalLineTo(200.0f);
        pathBuilder.arcToRelative(78.18f, 78.18f, 0.0f, false, false, -46.55f, -43.71f);
        pathBuilder.arcToRelative(46.0f, 46.0f, 0.0f, true, false, -50.9f, 0.0f);
        pathBuilder.arcTo(78.18f, 78.18f, 0.0f, false, false, 56.0f, 202.0f);
        pathBuilder.horizontalLineTo(40.0f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.0f, -2.0f);
        pathBuilder.verticalLineTo(56.0f);
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, -2.0f);
