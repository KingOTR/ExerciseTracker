...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandSwipeLeft", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getHandSwipeLeft", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handSwipeLeft", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandswipeleftKt {
    private static ImageVector _handSwipeLeft;

    public static final ImageVector getHandSwipeLeft(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(202.0f, 140.0f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, -28.0f, 0.0f);
        pathBuilder.verticalLineToRelative(4.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f);
        pathBuilder.lineTo(162.0f, 124.0f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, -28.0f, 0.0f);
        pathBuilder.verticalLineToRelative(12.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f);
        pathBuilder.lineTo(122.0f, 68.0f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, -28.0f, 0.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(248.0f, 50.0f);
        pathBuilder.lineTo(190.48f, 50.0f);
        pathBuilder.lineToRelative(21.76f, -21.76f);
        ...
        pathBuilder.lineToRelative(32.0f, 32.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 8.49f, -8.48f);
        pathBuilder.lineTo(190.48f, 62.0f);
        pathBuilder.lineTo(248.0f, 62.0f);
