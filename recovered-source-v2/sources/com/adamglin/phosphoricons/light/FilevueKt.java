...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileVue", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getFileVue", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileVue", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilevueKt {
    private static ImageVector _fileVue;

    public static final ImageVector getFileVue(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(85.65f, 154.0f);
        ...
        pathBuilder.lineTo(60.0f, 190.16f);
        pathBuilder.lineTo(74.35f, 150.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 11.3f, 4.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 158.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, -12.0f);
        pathBuilder.lineTo(176.0f, 146.0f);
        ...
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, -12.0f);
        pathBuilder.lineTo(182.0f, 174.0f);
        pathBuilder.lineTo(182.0f, 158.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(193.52f, 82.0f);
