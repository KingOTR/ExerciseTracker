...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListMagnifyingGlass", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getListMagnifyingGlass", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listMagnifyingGlass", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListmagnifyingglassKt {
    private static ImageVector _listMagnifyingGlass;

    public static final ImageVector getListMagnifyingGlass(LightGroup lightGroup) {
        ...
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, -12.0f);
        pathBuilder.close();
        pathBuilder.moveTo(236.24f, 196.24f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -8.48f, 0.0f);
        pathBuilder.lineToRelative(-21.49f, -21.48f);
        pathBuilder.arcToRelative(38.06f, 38.06f, 0.0f, true, true, 8.49f, -8.49f);
        pathBuilder.lineToRelative(21.48f, 21.49f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 236.24f, 196.24f);
        pathBuilder.close();
        pathBuilder.moveTo(184.0f, 170.0f);
        pathBuilder.arcToRelative(26.0f, 26.0f, 0.0f, true, false, -26.0f, -26.0f);
        pathBuilder.arcTo(26.0f, 26.0f, 0.0f, false, false, 184.0f, 170.0f);
        pathBuilder.close();
