...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserCirclePlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getUserCirclePlus", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userCirclePlus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsercircleplusKt {
    private static ImageVector _userCirclePlus;

    public static final ImageVector getUserCirclePlus(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(194.0f, 32.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 12.0f, 0.0f);
        pathBuilder.lineTo(206.0f, 50.0f);
        pathBuilder.horizontalLineToRelative(18.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(228.59f, 111.0f);
        ...
        pathBuilder.arcToRelative(77.53f, 77.53f, 0.0f, false, true, 40.0f, 31.38f);
        pathBuilder.arcTo(89.65f, 89.65f, 0.0f, false, false, 218.0f, 128.0f);
        pathBuilder.arcToRelative(91.76f, 91.76f, 0.0f, false, false, -1.24f, -15.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, 11.83f, -2.0f);
        pathBuilder.close();
