...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MaskHappy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getMaskHappy", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_maskHappy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MaskhappyKt {
    private static ImageVector _maskHappy;

    public static final ImageVector getMaskHappy(LightGroup lightGroup) {
        ...
        pathBuilder.moveTo(188.47f, 124.0f);
        ...
        pathBuilder.reflectiveCurveTo(183.12f, 118.0f, 188.47f, 124.0f);
        pathBuilder.close();
        pathBuilder.moveTo(107.53f, 132.0f);
        ...
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, false, 8.94f, 8.0f);
        pathBuilder.curveToRelative(3.06f, -3.42f, 9.74f, -6.0f, 15.53f, -6.0f);
        pathBuilder.reflectiveCurveTo(104.47f, 128.58f, 107.53f, 132.0f);
        pathBuilder.close();
        pathBuilder.moveTo(166.26f, 163.43f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -8.46f, 0.67f);
        pathBuilder.arcToRelative(38.89f, 38.89f, 0.0f, false, true, -59.6f, 0.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, false, -9.13f, 7.79f);
        pathBuilder.arcToRelative(50.9f, 50.9f, 0.0f, false, false, 77.86f, 0.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 166.26f, 163.43f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, false, -0.87f, -1.66f);
        pathBuilder.arcToRelative(1.93f, 1.93f, 0.0f, false, false, -1.85f, -0.21f);
