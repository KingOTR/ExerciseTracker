...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TextSubscript", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getTextSubscript", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_textSubscript", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TextsubscriptKt {
    private static ImageVector _textSubscript;

    public static final ImageVector getTextSubscript(LightGroup lightGroup) {
        ...
        pathBuilder.arcTo(18.0f, 18.0f, 0.0f, true, false, 199.0f, 130.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, true, -11.31f, -4.0f);
        pathBuilder.arcTo(30.0f, 30.0f, 0.0f, true, true, 240.0f, 154.06f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(147.93f, 51.47f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, -8.46f, 0.6f);
        pathBuilder.lineTo(92.0f, 106.84f);
        pathBuilder.lineTo(44.53f, 52.07f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, false, -9.06f, 7.86f);
        pathBuilder.lineTo(84.06f, 116.0f);
        pathBuilder.lineTo(35.47f, 172.07f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, true, false, 9.06f, 7.86f);
        pathBuilder.lineTo(92.0f, 125.16f);
        pathBuilder.lineToRelative(47.47f, 54.77f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 9.06f, -7.86f);
        pathBuilder.lineTo(99.94f, 116.0f);
        pathBuilder.lineToRelative(48.59f, -56.07f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, false, 147.93f, 51.47f);
        pathBuilder.close();
