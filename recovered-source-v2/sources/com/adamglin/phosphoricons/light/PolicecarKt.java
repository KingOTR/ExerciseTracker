...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PoliceCar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getPoliceCar", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_policeCar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PolicecarKt {
    private static ImageVector _policeCar;

    public static final ImageVector getPoliceCar(LightGroup lightGroup) {
        ...
        pathBuilder.lineTo(68.64f, 50.05f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, -12.15f, 7.0f);
        pathBuilder.lineToRelative(-28.0f, 49.0f);
        pathBuilder.lineTo(16.0f, 106.05f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, 12.0f);
        pathBuilder.lineTo(26.0f, 118.05f);
        pathBuilder.verticalLineToRelative(82.0f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.0f, 14.0f);
        pathBuilder.lineTo(64.0f, 214.05f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.0f, -14.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(98.0f, 24.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 6.0f, -6.0f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 0.0f, 12.0f);
        pathBuilder.lineTo(104.0f, 30.0f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 98.0f, 24.0f);
        pathBuilder.close();
