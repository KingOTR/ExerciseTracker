...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Screencast", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getScreencast", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_screencast", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ScreencastKt {
    private static ImageVector _screencast;

    public static final ImageVector getScreencast(LightGroup lightGroup) {
        ...
        pathBuilder.arcTo(22.0f, 22.0f, 0.0f, false, false, 32.0f, 186.0f);
        pathBuilder.close();
        pathBuilder.moveTo(32.0f, 154.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, 12.0f);
        pathBuilder.arcToRelative(42.0f, 42.0f, 0.0f, false, true, 42.0f, 42.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 12.0f, 0.0f);
        pathBuilder.arcTo(54.06f, 54.06f, 0.0f, false, false, 32.0f, 154.0f);
        pathBuilder.close();
        pathBuilder.moveTo(32.0f, 122.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, 12.0f);
        pathBuilder.arcToRelative(74.09f, 74.09f, 0.0f, false, true, 74.0f, 74.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 12.0f, 0.0f);
        pathBuilder.arcTo(86.1f, 86.1f, 0.0f, false, false, 32.0f, 122.0f);
        pathBuilder.close();
