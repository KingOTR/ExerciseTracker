...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"AddressBookTabs", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getAddressBookTabs", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_addressBookTabs", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class AddressbooktabsKt {
    private static ImageVector _addressBookTabs;

    public static final ImageVector getAddressBookTabs(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(190.0f, 102.0f);
        pathBuilder.horizontalLineToRelative(20.0f);
        pathBuilder.verticalLineToRelative(52.0f);
        pathBuilder.lineTo(190.0f, 154.0f);
        pathBuilder.close();
        pathBuilder.moveTo(210.0f, 48.0f);
        pathBuilder.lineTo(210.0f, 90.0f);
        pathBuilder.lineTo(190.0f, 90.0f);
        ...
        pathBuilder.lineTo(190.0f, 166.0f);
        pathBuilder.horizontalLineToRelative(20.0f);
        pathBuilder.verticalLineToRelative(42.0f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, true, 208.0f, 210.0f);
        pathBuilder.close();
        pathBuilder.moveTo(149.81f, 166.51f);
        pathBuilder.arcTo(38.0f, 38.0f, 0.0f, false, false, 131.23f, 143.0f);
        pathBuilder.arcToRelative(30.0f, 30.0f, 0.0f, true, false, -38.45f, 0.0f);
        pathBuilder.arcTo(38.0f, 38.0f, 0.0f, false, false, 74.19f, 166.5f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, false, 11.62f, 3.0f);
        pathBuilder.curveTo(88.67f, 158.38f, 99.93f, 150.0f, 112.0f, 150.0f);
        ...
        pathBuilder.arcTo(18.0f, 18.0f, 0.0f, false, true, 94.0f, 120.0f);
        pathBuilder.close();
