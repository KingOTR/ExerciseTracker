...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HourglassSimpleLow", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getHourglassSimpleLow", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_hourglassSimpleLow", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HourglasssimplelowKt {
    private static ImageVector _hourglassSimpleLow;

    public static final ImageVector getHourglassSimpleLow(LightGroup lightGroup) {
        ...
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, 9.9f, -23.9f);
        pathBuilder.close();
        pathBuilder.moveTo(54.56f, 49.38f);
        pathBuilder.arcTo(2.0f, 2.0f, 0.0f, false, true, 56.0f, 46.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 136.31f);
        pathBuilder.lineTo(163.19f, 170.0f);
        pathBuilder.lineTo(92.81f, 170.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(2.0f, 2.0f, 0.0f, false, true, -1.45f, -3.38f);
        pathBuilder.lineTo(80.28f, 182.0f);
        pathBuilder.horizontalLineToRelative(95.44f);
        pathBuilder.lineToRelative(25.72f, 24.62f);
