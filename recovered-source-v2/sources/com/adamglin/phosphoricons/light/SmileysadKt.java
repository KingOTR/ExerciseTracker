...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SmileySad", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getSmileySad", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_smileySad", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SmileysadKt {
    private static ImageVector _smileySad;

    public static final ImageVector getSmileySad(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(173.19f, 173.0f);
        ...
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, -5.2f, 3.0f);
        pathBuilder.arcToRelative(5.9f, 5.9f, 0.0f, false, true, -3.0f, -0.81f);
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 82.81f, 173.0f);
        pathBuilder.curveToRelative(9.92f, -17.16f, 26.39f, -27.0f, 45.19f, -27.0f);
        pathBuilder.reflectiveCurveTo(163.27f, 155.84f, 173.19f, 173.0f);
        pathBuilder.close();
