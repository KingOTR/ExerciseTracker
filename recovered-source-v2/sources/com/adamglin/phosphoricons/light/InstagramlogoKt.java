...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"InstagramLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getInstagramLogo", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_instagramLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class InstagramlogoKt {
    private static ImageVector _instagramLogo;

    public static final ImageVector getInstagramLogo(LightGroup lightGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(176.0f, 26.0f);
        pathBuilder.lineTo(80.0f, 26.0f);
        pathBuilder.arcTo(54.06f, 54.06f, 0.0f, false, false, 26.0f, 80.0f);
        ...
        pathBuilder.arcTo(54.06f, 54.06f, 0.0f, false, false, 176.0f, 26.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(42.0f, 42.0f, 0.0f, false, true, 80.0f, 38.0f);
        pathBuilder.horizontalLineToRelative(96.0f);
        pathBuilder.arcToRelative(42.0f, 42.0f, 0.0f, false, true, 42.0f, 42.0f);
        pathBuilder.close();
        pathBuilder.moveTo(190.0f, 76.0f);
        pathBuilder.arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f);
        pathBuilder.arcTo(10.0f, 10.0f, 0.0f, false, true, 190.0f, 76.0f);
        pathBuilder.close();
