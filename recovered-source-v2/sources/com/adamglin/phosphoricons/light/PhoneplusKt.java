...
/* compiled from: Phoneplus.kt */
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PhonePlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/LightGroup;", "getPhonePlus", "(Lcom/adamglin/phosphoricons/LightGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_phonePlus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PhoneplusKt {
    private static ImageVector _phonePlus;

    public static final ImageVector getPhonePlus(LightGroup lightGroup) {
        Intrinsics.checkNotNullParameter(lightGroup, "<this>");
        ImageVector imageVector = _phonePlus;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        float f = (float) 24.0d;
        ImageVector.Builder builder = new ImageVector.Builder("PhonePlus", Dp.m6303constructorimpl(f), Dp.m6303constructorimpl(f), 256.0f, 256.0f, 0L, 0, false, 224, null);
        SolidColor solidColor = new SolidColor(ColorKt.Color(4278190080L), null);
        int m4196getButtKaPHkGw = StrokeCap.INSTANCE.m4196getButtKaPHkGw();
        int m4207getMiterLxFBmk8 = StrokeJoin.INSTANCE.m4207getMiterLxFBmk8();
        int m4126getNonZeroRgk1Os = PathFillType.INSTANCE.m4126getNonZeroRgk1Os();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(213.59f, 168.3f);
        ...
        pathBuilder.arcToRelative(1.89f, 1.89f, 0.0f, false, true, 0.0f, -1.67f);
        pathBuilder.lineToRelative(21.07f, -25.06f);
        ...
        pathBuilder.lineTo(87.73f, 42.49f);
        pathBuilder.arcToRelative(14.0f, 14.0f, 0.0f, false, false, -14.56f, -8.38f);
        pathBuilder.arcTo(54.25f, 54.25f, 0.0f, false, false, 26.0f, 88.0f);
        ...
        pathBuilder.arcTo(14.0f, 14.0f, 0.0f, false, false, 213.59f, 168.3f);
        pathBuilder.close();
        pathBuilder.moveTo(168.0f, 218.0f);
        pathBuilder.curveTo(96.32f, 218.0f, 38.0f, 159.68f, 38.0f, 88.0f);
        pathBuilder.arcTo(42.23f, 42.23f, 0.0f, false, true, 74.67f, 46.0f);
        ...
        pathBuilder.lineTo(76.73f, 121.15f);
        ...
        pathBuilder.arcTo(42.24f, 42.24f, 0.0f, false, true, 168.0f, 218.0f);
        pathBuilder.close();
        pathBuilder.moveTo(138.0f, 80.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 6.0f, -6.0f);
        pathBuilder.horizontalLineToRelative(26.0f);
        pathBuilder.verticalLineTo(48.0f);
        pathBuilder.arcToRelative(6.0f, 6.0f, 0.0f, false, true, 12.0f, 0.0f);
        pathBuilder.verticalLineTo(74.0f);
        pathBuilder.horizontalLineToRelative(26.0f);
        ...
        pathBuilder.arcTo(6.0f, 6.0f, 0.0f, false, true, 138.0f, 80.0f);
        pathBuilder.close();
