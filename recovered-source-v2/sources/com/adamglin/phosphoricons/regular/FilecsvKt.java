...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileCsv", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getFileCsv", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileCsv", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilecsvKt {
    private static ImageVector _fileCsv;

    public static final ImageVector getFileCsv(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 85.78f, 206.4f);
        ...
        pathBuilder.arcToRelative(4.57f, 4.57f, 0.0f, false, true, 2.0f, -3.67f);
        pathBuilder.curveToRelative(4.6f, -3.12f, 15.34f, -1.73f, 19.82f, -0.56f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 142.0f, 145.86f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 109.94f, 214.0f);
        ...
        pathBuilder.curveTo(154.0f, 179.0f, 137.49f, 174.17f, 127.6f, 171.31f);
        pathBuilder.close();
        pathBuilder.moveTo(210.69f, 144.47f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -15.07f, 5.38f);
        pathBuilder.lineToRelative(20.0f, 56.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 15.07f, 0.0f);
        pathBuilder.lineToRelative(20.0f, -56.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 210.69f, 144.47f);
        pathBuilder.close();
