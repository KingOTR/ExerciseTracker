...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"GlobeHemisphereWest", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getGlobeHemisphereWest", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_globeHemisphereWest", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GlobehemispherewestKt {
    private static ImageVector _globeHemisphereWest;

    public static final ImageVector getGlobeHemisphereWest(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(143.31f, 41.34f);
        pathBuilder.lineTo(152.0f, 56.9f);
        pathBuilder.lineTo(125.09f, 81.24f);
        pathBuilder.lineTo(112.85f, 88.0f);
        pathBuilder.lineTo(96.14f, 88.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -13.88f, 8.0f);
        pathBuilder.lineToRelative(-8.73f, 15.23f);
        pathBuilder.lineTo(63.38f, 84.19f);
        pathBuilder.lineTo(74.32f, 58.32f);
        pathBuilder.arcToRelative(87.87f, 87.87f, 0.0f, false, true, 69.0f, -17.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(142.58f, 214.78f);
        pathBuilder.lineTo(143.71f, 208.97f);
        pathBuilder.arcToRelative(16.09f, 16.09f, 0.0f, false, false, -4.0f, -13.9f);
        pathBuilder.arcToRelative(1.85f, 1.85f, 0.0f, false, true, -0.14f, -0.14f);
        pathBuilder.lineTo(120.0f, 174.74f);
        pathBuilder.lineTo(133.7f, 144.0f);
        pathBuilder.lineToRelative(22.82f, 3.08f);
        pathBuilder.lineToRelative(45.72f, 28.12f);
        pathBuilder.arcTo(88.18f, 88.18f, 0.0f, false, true, 142.58f, 214.78f);
        pathBuilder.close();
