...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MouseLeftClick", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMouseLeftClick", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mouseLeftClick", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MouseleftclickKt {
    private static ImageVector _mouseLeftClick;

    public static final ImageVector getMouseLeftClick(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(115.31f, 104.0f);
        pathBuilder.lineTo(69.31f, 58.0f);
        pathBuilder.arcTo(48.49f, 48.49f, 0.0f, false, true, 80.51f, 43.82f);
        pathBuilder.lineTo(120.0f, 83.31f);
        pathBuilder.lineTo(120.0f, 104.0f);
        pathBuilder.close();
        pathBuilder.moveTo(64.0f, 80.0f);
        pathBuilder.curveToRelative(0.0f, -1.51f, 0.08f, -3.0f, 0.22f, -4.47f);
        pathBuilder.lineTo(92.69f, 104.0f);
        pathBuilder.lineTo(64.0f, 104.0f);
        pathBuilder.close();
        pathBuilder.moveTo(120.0f, 32.0f);
        pathBuilder.lineTo(120.0f, 60.69f);
        pathBuilder.lineTo(94.59f, 35.28f);
        pathBuilder.arcTo(47.73f, 47.73f, 0.0f, false, true, 112.0f, 32.0f);
        pathBuilder.close();
