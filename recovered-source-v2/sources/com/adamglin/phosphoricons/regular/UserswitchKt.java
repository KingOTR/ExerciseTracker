...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserSwitch", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getUserSwitch", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userSwitch", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UserswitchKt {
    private static ImageVector _userSwitch;

    public static final ImageVector getUserSwitch(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(253.66f, 133.66f);
        ...
        pathBuilder.lineTo(216.0f, 132.69f);
        pathBuilder.lineTo(216.0f, 128.0f);
        pathBuilder.arcTo(88.0f, 88.0f, 0.0f, false, false, 56.49f, 76.67f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -13.0f, -9.34f);
        pathBuilder.arcTo(104.0f, 104.0f, 0.0f, false, true, 232.0f, 128.0f);
        pathBuilder.verticalLineToRelative(4.69f);
        pathBuilder.lineToRelative(10.34f, -10.35f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 11.32f);
        pathBuilder.close();
        pathBuilder.moveTo(212.48f, 188.66f);
        pathBuilder.arcTo(104.0f, 104.0f, 0.0f, false, true, 24.0f, 128.0f);
        pathBuilder.verticalLineToRelative(-4.69f);
        pathBuilder.lineTo(13.66f, 133.66f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 2.34f, 122.34f);
        pathBuilder.lineToRelative(24.0f, -24.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 0.0f);
        pathBuilder.lineToRelative(24.0f, 24.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 11.32f);
        pathBuilder.lineTo(40.0f, 123.31f);
        ...
        pathBuilder.arcToRelative(79.59f, 79.59f, 0.0f, false, true, 36.08f, 28.78f);
        pathBuilder.arcToRelative(89.68f, 89.68f, 0.0f, false, false, 5.71f, -7.11f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 13.0f, 9.34f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(88.2f, 88.2f, 0.0f, false, false, 53.92f, -18.49f);
