...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserSquare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getUserSquare", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userSquare", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsersquareKt {
    private static ImageVector _userSquare;

    public static final ImageVector getUserSquare(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(68.67f, 208.0f);
        pathBuilder.arcTo(64.36f, 64.36f, 0.0f, false, true, 87.8f, 182.2f);
        pathBuilder.arcToRelative(64.0f, 64.0f, 0.0f, false, true, 80.4f, 0.0f);
        pathBuilder.arcTo(64.36f, 64.36f, 0.0f, false, true, 187.33f, 208.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 208.0f);
        pathBuilder.horizontalLineToRelative(-3.67f);
        pathBuilder.arcToRelative(79.9f, 79.9f, 0.0f, false, false, -46.68f, -50.29f);
        pathBuilder.arcToRelative(48.0f, 48.0f, 0.0f, true, false, -59.3f, 0.0f);
        pathBuilder.arcTo(79.9f, 79.9f, 0.0f, false, false, 51.67f, 208.0f);
        pathBuilder.horizontalLineTo(48.0f);
        pathBuilder.verticalLineTo(48.0f);
        pathBuilder.horizontalLineTo(208.0f);
        pathBuilder.verticalLineTo(208.0f);
