...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PushPinSimpleSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPushPinSimpleSlash", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pushPinSimpleSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PushpinsimpleslashKt {
    private static ImageVector _pushPinSimpleSlash;

    public static final ImageVector getPushPinSimpleSlash(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(83.25f, 40.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder.horizontalLineTo(192.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder.horizontalLineToRelative(-6.46f);
        pathBuilder.lineToRelative(18.75f, 106.3f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.48f, 9.26f);
        pathBuilder.arcToRelative(7.52f, 7.52f, 0.0f, false, true, -1.4f, 0.13f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.87f, -6.61f);
        pathBuilder.lineTo(169.29f, 48.0f);
        pathBuilder.horizontalLineToRelative(-78.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 83.25f, 40.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
        pathBuilder.horizontalLineToRelative(9.29f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(153.55f, 168.0f);
        pathBuilder.lineTo(79.84f, 86.92f);
        pathBuilder.lineTo(65.54f, 168.0f);
        pathBuilder.close();
