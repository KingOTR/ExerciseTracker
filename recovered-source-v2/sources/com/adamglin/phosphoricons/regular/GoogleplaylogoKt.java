...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"GooglePlayLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getGooglePlayLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_googlePlayLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GoogleplaylogoKt {
    private static ImageVector _googlePlayLogo;

    public static final ImageVector getGooglePlayLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(239.82f, 114.19f);
        ...
        pathBuilder.lineTo(48.0f, 224.13f);
        pathBuilder.arcToRelative(15.68f, 15.68f, 0.0f, false, false, 7.92f, 13.67f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.12f, 0.0f);
        pathBuilder.lineToRelative(167.78f, -96.0f);
        pathBuilder.arcToRelative(15.75f, 15.75f, 0.0f, false, false, 0.0f, -27.62f);
        pathBuilder.close();
        pathBuilder.moveTo(64.0f, 212.67f);
        pathBuilder.lineTo(64.0f, 43.33f);
        pathBuilder.lineTo(148.69f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(160.0f, 139.31f);
        pathBuilder.lineTo(178.92f, 158.23f);
        pathBuilder.lineTo(90.42f, 208.89f);
        pathBuilder.close();
