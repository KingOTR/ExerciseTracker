...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MagicWand", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMagicWand", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_magicWand", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MagicwandKt {
    private static ImageVector _magicWand;

    public static final ImageVector getMagicWand(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(219.31f, 80.0f);
        pathBuilder.lineTo(80.0f, 219.31f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -22.62f, 0.0f);
        pathBuilder.lineTo(36.68f, 198.63f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 0.0f, -22.63f);
        pathBuilder.lineTo(176.0f, 36.69f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 22.63f, 0.0f);
        pathBuilder.lineToRelative(20.68f, 20.68f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 219.31f, 80.0f);
        pathBuilder.close();
        pathBuilder.moveTo(164.68f, 112.0f);
        pathBuilder.lineTo(144.0f, 91.31f);
        pathBuilder.lineToRelative(-96.0f, 96.0f);
        pathBuilder.lineTo(68.68f, 208.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 68.69f);
        pathBuilder.lineTo(187.31f, 48.0f);
        pathBuilder.lineToRelative(-32.0f, 32.0f);
        pathBuilder.lineTo(176.0f, 100.69f);
        pathBuilder.close();
