...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Balloon", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getBalloon", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_balloon", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BalloonKt {
    private static ImageVector _balloon;

    public static final ImageVector getBalloon(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(139.87f, 224.0f);
        pathBuilder.lineTo(116.13f, 224.0f);
        pathBuilder.lineToRelative(6.94f, -16.19f);
        pathBuilder.curveToRelative(1.64f, 0.12f, 3.28f, 0.19f, 4.93f, 0.19f);
        pathBuilder.reflectiveCurveToRelative(3.29f, -0.07f, 4.93f, -0.19f);
        pathBuilder.close();
        pathBuilder.moveTo(178.27f, 163.63f);
        pathBuilder.curveTo(163.94f, 181.93f, 146.09f, 192.0f, 128.0f, 192.0f);
        pathBuilder.reflectiveCurveToRelative(-35.94f, -10.07f, -50.27f, -28.37f);
        pathBuilder.curveTo(64.12f, 146.27f, 56.0f, 124.0f, 56.0f, 104.0f);
        pathBuilder.arcToRelative(72.0f, 72.0f, 0.0f, false, true, 144.0f, 0.0f);
        pathBuilder.curveTo(200.0f, 124.0f, 191.88f, 146.27f, 178.27f, 163.63f);
        pathBuilder.close();
        pathBuilder.moveTo(177.27f, 103.89f);
