...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandsPraying", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getHandsPraying", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handsPraying", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandsprayingKt {
    private static ImageVector _handsPraying;

    public static final ImageVector getHandsPraying(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(64.68f, 224.0f);
        pathBuilder.lineTo(32.0f, 191.32f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(143.0f, 175.75f);
        pathBuilder.arcToRelative(23.85f, 23.85f, 0.0f, false, true, -7.0f, -17.0f);
        ...
        pathBuilder.lineToRelative(-33.4f, 32.0f);
        pathBuilder.close();
        pathBuilder.moveTo(191.32f, 224.0f);
        pathBuilder.lineToRelative(-12.56f, -12.57f);
        pathBuilder.lineToRelative(33.39f, -32.0f);
        pathBuilder.lineTo(224.0f, 191.32f);
        pathBuilder.close();
