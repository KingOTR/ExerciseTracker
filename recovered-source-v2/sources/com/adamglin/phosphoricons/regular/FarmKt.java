...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Farm", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getFarm", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_farm", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FarmKt {
    private static ImageVector _farm;

    public static final ImageVector getFarm(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
        pathBuilder.arcToRelative(266.33f, 266.33f, 0.0f, false, true, 48.0f, 4.37f);
        ...
        pathBuilder.verticalLineToRelative(32.49f);
        pathBuilder.curveToRelative(5.31f, -0.31f, 10.64f, -0.49f, 16.0f, -0.49f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        ...
        pathBuilder.verticalLineToRelative(21.94f);
        pathBuilder.quadToRelative(11.88f, -2.56f, 24.0f, -4.0f);
        pathBuilder.lineTo(200.0f, 84.0f);
        pathBuilder.lineTo(144.0f, 42.0f);
        pathBuilder.lineTo(88.0f, 84.0f);
        pathBuilder.verticalLineToRelative(35.81f);
        pathBuilder.quadToRelative(12.19f, 3.0f, 24.0f, 7.18f);
        pathBuilder.lineTo(112.0f, 96.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 120.0f, 88.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.07f, 133.27f);
        pathBuilder.arcTo(262.48f, 262.48f, 0.0f, false, true, 160.0f, 121.94f);
        pathBuilder.lineTo(160.0f, 104.0f);
        pathBuilder.lineTo(128.0f, 104.0f);
        pathBuilder.verticalLineToRelative(29.24f);
        pathBuilder.close();
