...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Backspace", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getBackspace", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_backspace", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BackspaceKt {
    private static ImageVector _backspace;

    public static final ImageVector getBackspace(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(16.08f, 16.08f, 0.0f, false, false, -13.72f, 7.77f);
        pathBuilder.lineTo(9.14f, 123.88f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 8.24f);
        pathBuilder.lineToRelative(45.67f, 76.11f);
        pathBuilder.arcTo(16.08f, 16.08f, 0.0f, false, false, 68.53f, 216.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(61.67f, 204.12f);
        pathBuilder.lineTo(68.53f, 200.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(216.0f, 200.0f);
        pathBuilder.horizontalLineTo(68.53f);
        pathBuilder.lineToRelative(-43.2f, -72.0f);
        pathBuilder.lineToRelative(43.2f, -72.0f);
        pathBuilder.horizontalLineTo(216.0f);
        pathBuilder.close();
        pathBuilder.moveTo(106.34f, 146.34f);
        ...
        pathBuilder.lineTo(136.0f, 116.69f);
