...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PingPong", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPingPong", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pingPong", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PingpongKt {
    private static ImageVector _pingPong;

    public static final ImageVector getPingPong(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(59.0f, 177.83f);
        pathBuilder.arcToRelative(86.09f, 86.09f, 0.0f, false, true, -19.0f, -55.0f);
        pathBuilder.arcTo(84.27f, 84.27f, 0.0f, false, true, 122.8f, 40.0f);
        pathBuilder.arcToRelative(86.28f, 86.28f, 0.0f, false, true, 55.0f, 19.0f);
        pathBuilder.arcTo(85.08f, 85.08f, 0.0f, false, true, 196.58f, 80.1f);
        pathBuilder.lineTo(80.1f, 196.58f);
        pathBuilder.arcTo(85.08f, 85.08f, 0.0f, false, true, 59.0f, 177.83f);
        pathBuilder.close();
        pathBuilder.moveTo(197.35f, 224.0f);
        pathBuilder.lineToRelative(-32.63f, -45.69f);
        ...
        pathBuilder.lineTo(224.0f, 197.35f);
        pathBuilder.close();
