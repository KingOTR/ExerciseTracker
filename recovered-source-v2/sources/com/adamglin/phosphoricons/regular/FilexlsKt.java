...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileXls", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getFileXls", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileXls", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilexlsKt {
    private static ImageVector _fileXls;

    public static final ImageVector getFileXls(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 156.0f, 208.0f);
        pathBuilder.close();
        pathBuilder.moveTo(92.65f, 145.49f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.16f, 1.86f);
        pathBuilder.lineTo(68.0f, 166.24f);
        pathBuilder.lineTo(54.51f, 147.35f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -13.0f, 9.3f);
        pathBuilder.lineTo(58.17f, 180.0f);
        pathBuilder.lineTo(41.49f, 203.35f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 13.0f, 9.3f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 92.65f, 145.49f);
        pathBuilder.close();
        pathBuilder.moveTo(191.59f, 171.31f);
        pathBuilder.curveToRelative(-4.0f, -1.16f, -8.14f, -2.35f, -10.45f, -3.84f);
        pathBuilder.curveToRelative(-1.25f, -0.82f, -1.23f, -1.0f, -1.12f, -1.9f);
        pathBuilder.arcToRelative(4.54f, 4.54f, 0.0f, false, true, 2.0f, -3.67f);
        pathBuilder.curveToRelative(4.6f, -3.12f, 15.34f, -1.72f, 19.82f, -0.56f);
        ...
        pathBuilder.curveToRelative(-0.31f, 2.41f, -1.26f, 3.33f, -2.15f, 3.93f);
        pathBuilder.curveToRelative(-4.6f, 3.06f, -15.16f, 1.55f, -19.54f, 0.35f);
        ...
        pathBuilder.horizontalLineToRelative(28.68f);
