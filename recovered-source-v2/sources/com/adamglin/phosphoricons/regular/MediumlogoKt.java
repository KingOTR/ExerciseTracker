...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MediumLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMediumLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mediumLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MediumlogoKt {
    private static ImageVector _mediumLogo;

    public static final ImageVector getMediumLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(64.07f, 64.07f, 0.0f, false, false, 72.0f, 64.0f);
        pathBuilder.close();
        pathBuilder.moveTo(72.0f, 176.0f);
        pathBuilder.arcToRelative(48.0f, 48.0f, 0.0f, true, true, 48.0f, -48.0f);
        pathBuilder.arcTo(48.05f, 48.05f, 0.0f, false, true, 72.0f, 176.0f);
        pathBuilder.close();
        ...
        pathBuilder.curveToRelative(-5.64f, 0.0f, -16.0f, -18.22f, -16.0f, -48.0f);
        pathBuilder.reflectiveCurveToRelative(10.36f, -48.0f, 16.0f, -48.0f);
        pathBuilder.reflectiveCurveToRelative(16.0f, 18.22f, 16.0f, 48.0f);
        pathBuilder.reflectiveCurveTo(189.64f, 176.0f, 184.0f, 176.0f);
        pathBuilder.close();
