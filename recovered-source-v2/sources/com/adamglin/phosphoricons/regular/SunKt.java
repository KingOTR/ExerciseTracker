...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Sun", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSun", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sun", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SunKt {
    private static ImageVector _sun;

    public static final ImageVector getSun(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(64.07f, 64.07f, 0.0f, false, true, 192.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(176.0f, 128.0f);
        pathBuilder.arcToRelative(48.0f, 48.0f, 0.0f, true, false, -48.0f, 48.0f);
        pathBuilder.arcTo(48.05f, 48.05f, 0.0f, false, false, 176.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(58.34f, 69.66f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 69.66f, 58.34f);
        pathBuilder.lineToRelative(-16.0f, -16.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 42.34f, 53.66f);
        pathBuilder.close();
        pathBuilder.moveTo(58.34f, 186.34f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, -11.32f);
        pathBuilder.lineToRelative(-16.0f, 16.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 192.0f, 72.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(136.0f, 216.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 128.0f, 208.0f);
        pathBuilder.close();
