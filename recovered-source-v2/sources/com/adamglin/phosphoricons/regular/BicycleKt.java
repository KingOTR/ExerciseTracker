...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Bicycle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getBicycle", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bicycle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BicycleKt {
    private static ImageVector _bicycle;

    public static final ImageVector getBicycle(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(165.93f, 72.0f);
        ...
        pathBuilder.lineTo(99.26f, 88.0f);
        ...
        pathBuilder.lineTo(71.41f, 72.0f);
        pathBuilder.lineTo(85.12f, 95.51f);
        pathBuilder.lineTo(69.41f, 117.06f);
        pathBuilder.arcToRelative(48.13f, 48.13f, 0.0f, true, false, 12.92f, 9.44f);
        ...
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, true, true, -20.21f, -29.74f);
        pathBuilder.lineToRelative(-18.25f, 25.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 12.92f, 9.42f);
        pathBuilder.lineToRelative(18.25f, -25.0f);
        pathBuilder.arcTo(31.88f, 31.88f, 0.0f, false, true, 80.0f, 160.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 192.0f);
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, false, true, -22.51f, -54.72f);
        pathBuilder.lineTo(201.09f, 164.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, true, false, 214.91f, 156.0f);
        pathBuilder.lineTo(199.3f, 129.21f);
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, true, true, 208.0f, 192.0f);
        pathBuilder.close();
