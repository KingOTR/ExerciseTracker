...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Barn", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getBarn", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_barn", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BarnKt {
    private static ImageVector _barn;

    public static final ImageVector getBarn(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 108.17f);
        pathBuilder.lineTo(61.7f, 77.79f);
        pathBuilder.lineTo(128.0f, 32.0f);
        pathBuilder.lineToRelative(66.3f, 45.78f);
        pathBuilder.lineTo(216.0f, 108.17f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 150.17f);
        pathBuilder.lineTo(97.0f, 128.0f);
        pathBuilder.lineTo(159.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(176.0f, 135.55f);
        pathBuilder.verticalLineToRelative(48.91f);
        pathBuilder.lineTo(141.76f, 160.0f);
        pathBuilder.close();
        pathBuilder.moveTo(114.24f, 160.0f);
        pathBuilder.lineTo(80.0f, 184.46f);
        pathBuilder.lineTo(80.0f, 135.55f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 169.83f);
        pathBuilder.lineTo(159.0f, 192.0f);
        pathBuilder.lineTo(97.0f, 192.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 104.0f, 88.0f);
        pathBuilder.close();
