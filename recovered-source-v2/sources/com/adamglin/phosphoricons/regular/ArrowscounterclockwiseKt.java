...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsCounterClockwise", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getArrowsCounterClockwise", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsCounterClockwise", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowscounterclockwiseKt {
    private static ImageVector _arrowsCounterClockwise;

    public static final ImageVector getArrowsCounterClockwise(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(48.0f, 76.69f);
        pathBuilder.lineTo(62.63f, 62.06f);
        pathBuilder.arcTo(95.43f, 95.43f, 0.0f, false, true, 130.0f, 33.94f);
        ...
        pathBuilder.arcTo(79.56f, 79.56f, 0.0f, false, false, 73.94f, 73.37f);
        pathBuilder.lineTo(59.31f, 88.0f);
        ...
        pathBuilder.lineToRelative(-14.63f, 14.63f);
        pathBuilder.arcToRelative(79.56f, 79.56f, 0.0f, false, true, -56.13f, 23.43f);
        pathBuilder.horizontalLineToRelative(-0.45f);
        ...
        pathBuilder.lineTo(126.0f, 222.06f);
        pathBuilder.arcToRelative(95.43f, 95.43f, 0.0f, false, false, 67.36f, -28.12f);
        pathBuilder.lineTo(208.0f, 179.31f);
