...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BellZ", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getBellZ", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bellZ", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BellzKt {
    private static ImageVector _bellZ;

    public static final ImageVector getBellZ(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.65f, -12.44f);
        pathBuilder.lineTo(129.05f, 104.0f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 152.0f, 144.0f);
        pathBuilder.close();
        pathBuilder.moveTo(221.84f, 192.0f);
        pathBuilder.arcTo(15.8f, 15.8f, 0.0f, false, true, 208.0f, 200.0f);
        pathBuilder.lineTo(167.19f, 200.0f);
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, true, -78.38f, 0.0f);
        ...
        pathBuilder.curveToRelative(-7.73f, -13.27f, -16.0f, -43.95f, -16.0f, -80.0f);
        pathBuilder.arcToRelative(64.0f, 64.0f, 0.0f, true, false, -128.0f, 0.0f);
        pathBuilder.curveToRelative(0.0f, 36.06f, -8.28f, 66.74f, -16.0f, 80.0f);
        pathBuilder.close();
