...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CameraSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCameraSlash", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cameraSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CameraslashKt {
    private static ImageVector _cameraSlash;

    public static final ImageVector getCameraSlash(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(51.73f, 56.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(105.58f, 115.23f);
        pathBuilder.lineTo(142.58f, 155.92f);
        pathBuilder.arcTo(27.71f, 27.71f, 0.0f, false, true, 128.0f, 160.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, true, -22.42f, -44.77f);
        pathBuilder.close();
        pathBuilder.moveTo(48.0f, 200.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, -8.0f);
        pathBuilder.lineTo(40.0f, 80.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder.lineTo(66.28f, 72.0f);
        pathBuilder.lineToRelative(28.41f, 31.26f);
        pathBuilder.arcTo(44.0f, 44.0f, 0.0f, false, false, 128.0f, 176.0f);
        pathBuilder.arcToRelative(44.21f, 44.21f, 0.0f, false, false, 25.44f, -8.12f);
        pathBuilder.lineTo(182.64f, 200.0f);
        pathBuilder.close();
        pathBuilder.moveTo(232.0f, 80.0f);
        pathBuilder.lineTo(232.0f, 186.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder.lineTo(216.0f, 80.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, -8.0f);
        pathBuilder.lineTo(176.0f, 72.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.65f, -3.56f);
        pathBuilder.lineTo(155.71f, 48.0f);
        pathBuilder.lineTo(100.24f, 48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -12.91f, -9.42f);
