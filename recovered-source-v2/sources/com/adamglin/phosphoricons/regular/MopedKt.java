...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Moped", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMoped", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_moped", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MopedKt {
    private static ImageVector _moped;

    public static final ImageVector getMoped(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(42.67f, 130.27f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 48.0f, 122.73f);
        pathBuilder.lineTo(48.0f, 104.0f);
        pathBuilder.lineTo(98.46f, 104.0f);
        pathBuilder.lineToRelative(21.0f, 56.0f);
        pathBuilder.lineTo(16.81f, 160.0f);
        pathBuilder.arcTo(40.07f, 40.07f, 0.0f, false, true, 42.67f, 130.27f);
        pathBuilder.close();
