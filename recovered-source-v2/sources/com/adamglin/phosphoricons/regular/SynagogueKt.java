...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Synagogue", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSynagogue", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_synagogue", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SynagogueKt {
    private static ImageVector _synagogue;

    public static final ImageVector getSynagogue(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(208.0f, 57.38f);
        pathBuilder.lineTo(208.0f, 32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder.lineTo(192.0f, 57.38f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 176.0f, 80.0f);
        pathBuilder.verticalLineToRelative(42.21f);
        pathBuilder.lineTo(136.0f, 99.36f);
        pathBuilder.lineTo(136.0f, 72.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder.lineTo(120.0f, 99.36f);
        pathBuilder.lineTo(80.0f, 122.21f);
        pathBuilder.lineTo(80.0f, 80.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 64.0f, 57.38f);
        pathBuilder.lineTo(64.0f, 32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder.lineTo(48.0f, 57.38f);
        ...
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 208.0f, 57.38f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 56.0f, 72.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(80.0f, 140.64f);
        ...
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 128.0f, 152.0f);
        pathBuilder.close();
