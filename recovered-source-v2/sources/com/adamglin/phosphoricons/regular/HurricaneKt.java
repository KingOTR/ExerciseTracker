...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Hurricane", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getHurricane", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_hurricane", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HurricaneKt {
    private static ImageVector _hurricane;

    public static final ImageVector getHurricane(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(167.73f, 10.06f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(148.06f, 217.0f);
        pathBuilder.arcToRelative(184.14f, 184.14f, 0.0f, false, true, -40.68f, 19.37f);
        pathBuilder.lineToRelative(7.73f, -29.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -5.67f, -9.79f);
        pathBuilder.arcTo(72.06f, 72.06f, 0.0f, false, true, 56.0f, 128.0f);
        pathBuilder.curveToRelative(0.0f, -36.77f, 17.48f, -66.72f, 51.94f, -89.0f);
        pathBuilder.arcToRelative(184.14f, 184.14f, 0.0f, false, true, 40.68f, -19.37f);
        pathBuilder.lineToRelative(-7.73f, 29.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.67f, 9.79f);
        pathBuilder.arcTo(72.06f, 72.06f, 0.0f, false, true, 200.0f, 128.0f);
        pathBuilder.curveTo(200.0f, 164.77f, 182.52f, 194.72f, 148.06f, 217.0f);
        pathBuilder.close();
