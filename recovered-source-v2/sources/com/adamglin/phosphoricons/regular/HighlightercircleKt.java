...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HighlighterCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getHighlighterCircle", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_highlighterCircle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HighlightercircleKt {
    private static ImageVector _highlighterCircle;

    public static final ImageVector getHighlighterCircle(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(88.33f, 88.33f, 0.0f, false, true, -64.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(144.0f, 136.0f);
        pathBuilder.lineTo(112.0f, 136.0f);
        pathBuilder.lineTo(112.0f, 100.94f);
        pathBuilder.lineToRelative(32.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(190.22f, 190.22f);
        pathBuilder.arcTo(88.09f, 88.09f, 0.0f, false, true, 176.0f, 201.77f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 96.0f, 96.0f);
        pathBuilder.verticalLineToRelative(40.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -16.0f, 16.0f);
        pathBuilder.verticalLineToRelative(49.77f);
        pathBuilder.arcToRelative(88.0f, 88.0f, 0.0f, true, true, 110.22f, -11.55f);
        pathBuilder.close();
