...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PersonSimpleHike", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPersonSimpleHike", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_personSimpleHike", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PersonsimplehikeKt {
    private static ImageVector _personSimpleHike;

    public static final ImageVector getPersonSimpleHike(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(184.0f, 151.66f);
        pathBuilder.curveToRelative(-25.75f, -2.25f, -34.35f, -15.52f, -42.0f, -27.36f);
        pathBuilder.curveToRelative(-2.85f, -4.39f, -5.56f, -8.57f, -9.13f, -12.19f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -4.14f, -10.52f);
        pathBuilder.lineTo(122.19f, 96.5f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.0f, -3.92f);
        pathBuilder.arcToRelative(40.92f, 40.92f, 0.0f, false, true, 8.0f, 5.47f);
        pathBuilder.curveToRelative(6.37f, 5.52f, 10.51f, 11.91f, 14.16f, 17.55f);
        pathBuilder.curveToRelative(7.68f, 11.84f, 13.22f, 20.4f, 36.6f, 20.4f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 200.0f, 144.0f);
        pathBuilder.close();
        pathBuilder.moveTo(72.0f, 152.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 7.35f, -4.85f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(54.51f, 127.8f);
        pathBuilder.lineTo(72.2f, 86.5f);
        pathBuilder.lineToRelative(13.3f, 5.7f);
        pathBuilder.lineTo(67.8f, 133.49f);
        pathBuilder.close();
