...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Seal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSeal", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_seal", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealKt {
    private static ImageVector _seal;

    public static final ImageVector getSeal(RegularGroup regularGroup) {
        ...
        pathBuilder.curveTo(146.27f, 23.51f, 138.44f, 16.0f, 128.0f, 16.0f);
        ...
        pathBuilder.curveTo(109.73f, 232.49f, 117.56f, 240.0f, 128.0f, 240.0f);
        pathBuilder.reflectiveCurveToRelative(18.27f, -7.51f, 25.18f, -14.14f);
        pathBuilder.curveToRelative(3.94f, -3.77f, 8.0f, -7.67f, 11.57f, -9.14f);
        ...
        pathBuilder.reflectiveCurveToRelative(-9.14f, -4.92f, -14.11f, -9.69f);
        ...
        pathBuilder.reflectiveCurveToRelative(4.92f, -9.14f, 9.69f, -14.11f);
        ...
        pathBuilder.reflectiveCurveTo(219.08f, 137.14f, 214.31f, 142.11f);
        pathBuilder.close();
