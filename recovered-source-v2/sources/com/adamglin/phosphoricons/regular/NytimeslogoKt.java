...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NyTimesLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getNyTimesLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_nyTimesLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NytimeslogoKt {
    private static ImageVector _nyTimesLogo;

    public static final ImageVector getNyTimesLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(88.0f, 203.83f);
        pathBuilder.lineTo(88.0f, 142.4f);
        pathBuilder.lineTo(57.51f, 158.66f);
        pathBuilder.arcTo(72.15f, 72.15f, 0.0f, false, false, 88.0f, 203.83f);
        pathBuilder.close();
        pathBuilder.moveTo(120.0f, 125.33f);
        pathBuilder.lineTo(104.0f, 133.87f);
        pathBuilder.verticalLineToRelative(78.0f);
        pathBuilder.arcToRelative(71.0f, 71.0f, 0.0f, false, false, 16.0f, 3.67f);
        pathBuilder.close();
