...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PaintBrushBroad", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPaintBrushBroad", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_paintBrushBroad", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PaintbrushbroadKt {
    private static ImageVector _paintBrushBroad;

    public static final ImageVector getPaintBrushBroad(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, false, false, 32.0f, 64.0f);
        pathBuilder.verticalLineToRelative(72.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, false, 24.0f, 24.0f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.lineToRelative(-7.89f, 46.67f);
        pathBuilder.arcTo(8.42f, 8.42f, 0.0f, false, false, 96.0f, 208.0f);
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, false, false, 64.0f, 0.0f);
        pathBuilder.arcToRelative(8.42f, 8.42f, 0.0f, false, false, -0.11f, -1.33f);
        pathBuilder.lineTo(152.0f, 160.0f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, false, 24.0f, -24.0f);
        pathBuilder.verticalLineTo(32.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 216.0f, 24.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 72.0f, 40.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(0.0f, 0.2f);
        pathBuilder.lineTo(144.0f, 208.6f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -32.0f, 0.0f);
        pathBuilder.lineToRelative(7.8f, -46.14f);
        pathBuilder.lineToRelative(0.0f, -0.2f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 104.0f, 144.0f);
