...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"GitlabLogoSimple", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getGitlabLogoSimple", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_gitlabLogoSimple", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GitlablogosimpleKt {
    private static ImageVector _gitlabLogoSimple;

    public static final ImageVector getGitlabLogoSimple(RegularGroup regularGroup) {
        ...
        pathBuilder.horizontalLineTo(86.22f);
        ...
        pathBuilder.lineTo(128.0f, 215.09f);
        pathBuilder.lineTo(57.09f, 165.0f);
        pathBuilder.arcToRelative(41.1f, 41.1f, 0.0f, false, true, -15.75f, -43.84f);
        pathBuilder.lineTo(58.0f, 57.5f);
        pathBuilder.lineTo(73.13f, 98.76f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 80.64f, 104.0f);
        pathBuilder.horizontalLineToRelative(94.72f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 7.51f, -5.24f);
        pathBuilder.lineTo(198.0f, 57.5f);
        pathBuilder.lineToRelative(16.63f, 63.65f);
        pathBuilder.arcTo(41.1f, 41.1f, 0.0f, false, true, 198.91f, 165.0f);
        pathBuilder.close();
