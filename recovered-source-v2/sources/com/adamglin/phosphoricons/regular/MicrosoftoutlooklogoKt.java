...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MicrosoftOutlookLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMicrosoftOutlookLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_microsoftOutlookLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MicrosoftoutlooklogoKt {
    private static ImageVector _microsoftOutlookLogo;

    public static final ImageVector getMicrosoftOutlookLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, false, 120.0f, 128.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(165.66f, 164.0f);
        pathBuilder.lineTo(216.0f, 127.65f);
        pathBuilder.verticalLineToRelative(72.7f);
        pathBuilder.close();
        pathBuilder.moveTo(112.0f, 48.0f);
        pathBuilder.horizontalLineToRelative(80.0f);
        pathBuilder.verticalLineToRelative(77.24f);
        pathBuilder.lineToRelative(-40.0f, 28.89f);
        ...
        pathBuilder.verticalLineToRelative(77.9f);
        pathBuilder.curveToRelative(0.0f, 0.12f, 0.0f, 0.24f, 0.0f, 0.36f);
        ...
        pathBuilder.lineTo(199.26f, 208.0f);
