...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CableCar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCableCar", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cableCar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CablecarKt {
    private static ImageVector _cableCar;

    public static final ImageVector getCableCar(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(247.87f, 30.59f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -9.28f, -6.46f);
        pathBuilder.lineToRelative(-224.0f, 40.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 16.0f, 80.0f);
        pathBuilder.arcToRelative(8.6f, 8.6f, 0.0f, false, false, 1.42f, -0.12f);
        pathBuilder.lineTo(120.0f, 61.55f);
        ...
        pathBuilder.lineTo(136.0f, 58.7f);
        pathBuilder.lineTo(241.4f, 39.88f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 247.87f, 30.59f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 208.0f, 128.0f);
        pathBuilder.close();
