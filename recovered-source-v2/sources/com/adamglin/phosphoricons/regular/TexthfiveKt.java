...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TextHFive", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getTextHFive", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_textHFive", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TexthfiveKt {
    private static ImageVector _textHFive;

    public static final ImageVector getTextHFive(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(38.8f, 38.8f, 0.0f, false, false, -9.41f, 1.14f);
        pathBuilder.lineTo(206.78f, 120.0f);
        pathBuilder.lineTo(240.0f, 120.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.lineTo(200.0f, 104.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -7.89f, 6.68f);
        pathBuilder.lineToRelative(-8.0f, 48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 13.6f, 6.92f);
        pathBuilder.arcTo(19.73f, 19.73f, 0.0f, false, true, 212.0f, 160.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 0.0f, 40.0f);
        pathBuilder.arcToRelative(19.73f, 19.73f, 0.0f, false, true, -14.29f, -5.6f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -11.42f, 11.2f);
        pathBuilder.arcTo(35.54f, 35.54f, 0.0f, false, false, 212.0f, 216.0f);
