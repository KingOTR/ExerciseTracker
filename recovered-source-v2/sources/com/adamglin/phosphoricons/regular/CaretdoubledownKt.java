...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CaretDoubleDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCaretDoubleDown", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_caretDoubleDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CaretdoubledownKt {
    private static ImageVector _caretDoubleDown;

    public static final ImageVector getCaretDoubleDown(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(213.66f, 130.34f);
        ...
        pathBuilder.lineTo(128.0f, 204.69f);
        pathBuilder.lineToRelative(74.34f, -74.35f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 213.66f, 130.34f);
        pathBuilder.close();
        pathBuilder.moveTo(122.34f, 141.66f);
        ...
        pathBuilder.lineTo(128.0f, 124.69f);
        pathBuilder.lineTo(53.66f, 50.34f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 42.34f, 61.66f);
        pathBuilder.close();
