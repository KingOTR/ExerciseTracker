...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ShieldChevron", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getShieldChevron", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_shieldChevron", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ShieldchevronKt {
    private static ImageVector _shieldChevron;

    public static final ImageVector getShieldChevron(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(111.82f, 111.82f, 0.0f, false, true, -24.51f, -27.64f);
        pathBuilder.lineTo(128.0f, 129.77f);
        pathBuilder.lineToRelative(63.43f, 44.4f);
        pathBuilder.arcTo(111.56f, 111.56f, 0.0f, false, true, 167.4f, 201.42f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 112.0f);
        pathBuilder.quadToRelative(0.0f, 26.31f, -9.14f, 47.84f);
        pathBuilder.lineToRelative(-66.27f, -46.39f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -9.18f, 0.0f);
        pathBuilder.lineTo(57.13f, 159.84f);
        pathBuilder.curveTo(51.06f, 145.52f, 48.0f, 129.54f, 48.0f, 112.0f);
