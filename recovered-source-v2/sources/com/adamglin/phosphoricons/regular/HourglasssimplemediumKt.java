...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HourglassSimpleMedium", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getHourglassSimpleMedium", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_hourglassSimpleMedium", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HourglasssimplemediumKt {
    private static ImageVector _hourglassSimpleMedium;

    public static final ImageVector getHourglassSimpleMedium(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(97.79f, 88.0f);
        pathBuilder.horizontalLineToRelative(60.42f);
        pathBuilder.lineTo(128.0f, 116.92f);
        pathBuilder.close();
        pathBuilder.moveTo(200.0f, 48.0f);
        pathBuilder.lineTo(174.92f, 72.0f);
        pathBuilder.horizontalLineTo(81.08f);
        pathBuilder.lineTo(56.0f, 48.0f);
        pathBuilder.close();
        pathBuilder.moveTo(56.0f, 208.0f);
        pathBuilder.lineToRelative(64.0f, -61.26f);
        pathBuilder.verticalLineTo(168.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder.verticalLineTo(146.74f);
