...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CameraPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCameraPlus", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cameraPlus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CameraplusKt {
    private static ImageVector _cameraPlus;

    public static final ImageVector getCameraPlus(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(75.72f, 56.0f);
        pathBuilder.lineTo(87.0f, 39.12f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 100.28f, 32.0f);
        pathBuilder.horizontalLineToRelative(55.44f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 169.0f, 39.12f);
        ...
        pathBuilder.lineTo(155.72f, 48.0f);
        pathBuilder.lineTo(100.28f, 48.0f);
        pathBuilder.lineTo(86.66f, 68.44f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 80.0f, 72.0f);
