...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"AirTrafficControl", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getAirTrafficControl", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_airTrafficControl", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class AirtrafficcontrolKt {
    private static ImageVector _airTrafficControl;

    public static final ImageVector getAirTrafficControl(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(110.68f, 152.0f);
        pathBuilder.lineTo(97.58f, 80.0f);
        pathBuilder.horizontalLineToRelative(60.84f);
        pathBuilder.lineToRelative(-13.1f, 72.0f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 80.0f);
        pathBuilder.lineTo(81.32f, 80.0f);
        pathBuilder.lineToRelative(13.09f, 72.0f);
        pathBuilder.lineTo(66.18f, 152.0f);
        pathBuilder.close();
        pathBuilder.moveTo(189.82f, 152.0f);
        pathBuilder.lineTo(161.59f, 152.0f);
        pathBuilder.lineToRelative(13.09f, -72.0f);
