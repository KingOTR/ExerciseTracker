...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CubeTransparent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCubeTransparent", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cubeTransparent", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CubetransparentKt {
    private static ImageVector _cubeTransparent;

    public static final ImageVector getCubeTransparent(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 2.3f, 5.61f);
        pathBuilder.lineToRelative(56.0f, 56.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 96.0f, 224.0f);
        pathBuilder.lineTo(216.0f, 224.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.0f, -8.0f);
        pathBuilder.lineTo(224.0f, 96.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 221.66f, 90.34f);
        pathBuilder.close();
        pathBuilder.moveTo(168.0f, 59.31f);
        pathBuilder.lineTo(196.69f, 88.0f);
        pathBuilder.lineTo(168.0f, 88.0f);
        pathBuilder.close();
        pathBuilder.moveTo(88.0f, 196.69f);
        pathBuilder.lineTo(59.31f, 168.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(59.31f, 48.0f);
        ...
        pathBuilder.lineToRelative(40.0f, 40.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 196.69f);
        pathBuilder.lineTo(168.0f, 156.69f);
