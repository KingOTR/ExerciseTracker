...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TelegramLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getTelegramLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_telegramLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TelegramlogoKt {
    private static ImageVector _telegramLogo;

    public static final ImageVector getTelegramLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(167.74f, 62.19f);
        pathBuilder.lineTo(78.15f, 126.35f);
        pathBuilder.lineToRelative(-49.6f, -9.73f);
        pathBuilder.close();
        pathBuilder.moveTo(88.0f, 200.0f);
        pathBuilder.lineTo(88.0f, 152.52f);
        pathBuilder.lineToRelative(24.79f, 21.74f);
        pathBuilder.close();
