...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lightning", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getLightning", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_lightning", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LightningKt {
    private static ImageVector _lightning;

    public static final ImageVector getLightning(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(215.79f, 118.17f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -5.0f, -5.66f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 13.69f, 7.0f);
        pathBuilder.lineToRelative(112.0f, -120.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 215.79f, 118.17f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(84.62f, -90.66f);
        pathBuilder.lineTo(136.16f, 94.43f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.0f, 9.06f);
