...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NuclearPlant", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getNuclearPlant", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_nuclearPlant", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NuclearplantKt {
    private static ImageVector _nuclearPlant;

    public static final ImageVector getNuclearPlant(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(50.5f, 208.0f);
        pathBuilder.horizontalLineToRelative(115.0f);
        pathBuilder.curveTo(152.0f, 179.09f, 137.77f, 139.09f, 136.15f, 96.0f);
        pathBuilder.arcToRelative(7.46f, 7.46f, 0.0f, false, true, -1.0f, -0.06f);
        pathBuilder.lineTo(79.85f, 96.0f);
        pathBuilder.curveTo(78.24f, 139.06f, 64.06f, 179.07f, 50.5f, 208.0f);
        pathBuilder.close();
