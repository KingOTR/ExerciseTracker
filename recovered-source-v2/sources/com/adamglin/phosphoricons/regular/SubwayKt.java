...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Subway", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSubway", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_subway", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SubwayKt {
    private static ImageVector _subway;

    public static final ImageVector getSubway(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(56.06f, 56.06f, 0.0f, false, false, 48.0f, 96.0f);
        ...
        pathBuilder.arcTo(72.08f, 72.08f, 0.0f, false, true, 224.0f, 96.0f);
        pathBuilder.close();
        pathBuilder.moveTo(184.0f, 96.0f);
        pathBuilder.verticalLineToRelative(72.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, true, -19.29f, 23.53f);
        pathBuilder.lineToRelative(2.45f, 4.89f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.32f, 7.16f);
        pathBuilder.lineTo(147.06f, 192.0f);
        pathBuilder.lineTo(108.94f, 192.0f);
        pathBuilder.lineToRelative(-5.78f, 11.58f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.32f, -7.16f);
        pathBuilder.lineToRelative(2.45f, -4.89f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 72.0f, 168.0f);
        pathBuilder.lineTo(72.0f, 96.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 96.0f, 72.0f);
        pathBuilder.horizontalLineToRelative(64.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 184.0f, 96.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 96.0f, 176.0f);
        pathBuilder.close();
