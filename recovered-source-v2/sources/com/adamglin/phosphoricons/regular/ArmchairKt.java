...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Armchair", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getArmchair", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_armchair", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArmchairKt {
    private static ImageVector _armchair;

    public static final ImageVector getArmchair(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(216.0f, 88.8f);
        ...
        pathBuilder.verticalLineTo(88.8f);
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, false, 0.0f, 78.4f);
        pathBuilder.verticalLineTo(200.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, 16.0f);
        pathBuilder.horizontalLineTo(200.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder.verticalLineTo(167.2f);
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, false, 0.0f, -78.4f);
        pathBuilder.close();
        ...
        pathBuilder.verticalLineTo(88.8f);
        pathBuilder.arcTo(40.07f, 40.07f, 0.0f, false, false, 168.0f, 128.0f);
        pathBuilder.horizontalLineTo(88.0f);
        pathBuilder.arcTo(40.07f, 40.07f, 0.0f, false, false, 56.0f, 88.8f);
        pathBuilder.verticalLineTo(72.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 80.0f, 48.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.39f, 152.0f);
        ...
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, true, true, 72.0f, 128.0f);
        pathBuilder.verticalLineToRelative(40.0f);
        ...
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, true, true, 24.39f, 24.0f);
        pathBuilder.close();
