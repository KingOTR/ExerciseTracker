...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandPointing", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getHandPointing", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handPointing", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandpointingKt {
    private static ImageVector _handPointing;

    public static final ImageVector getHandPointing(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(27.86f, 27.86f, 0.0f, false, false, -13.35f, 3.39f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 144.0f, 74.7f);
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 35.73f, 146.0f);
        pathBuilder.lineToRelative(4.67f, 8.23f);
        pathBuilder.curveTo(74.81f, 214.89f, 89.05f, 240.0f, 136.0f, 240.0f);
        ...
        pathBuilder.curveToRelative(-37.63f, 0.0f, -47.84f, -18.0f, -81.68f, -77.68f);
        pathBuilder.lineToRelative(-4.69f, -8.27f);
        pathBuilder.lineToRelative(0.0f, -0.05f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 54.0f, 121.61f);
        pathBuilder.arcToRelative(11.88f, 11.88f, 0.0f, false, true, 6.0f, -1.6f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 10.41f, 6.0f);
