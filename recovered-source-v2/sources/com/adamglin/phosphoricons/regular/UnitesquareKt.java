...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UniteSquare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getUniteSquare", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_uniteSquare", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UnitesquareKt {
    private static ImageVector _uniteSquare;

    public static final ImageVector getUniteSquare(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(155.31f, 208.0f);
        pathBuilder.lineTo(48.0f, 100.69f);
        ...
        pathBuilder.lineTo(208.0f, 155.31f);
        pathBuilder.verticalLineToRelative(41.38f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 132.69f);
        pathBuilder.lineTo(179.31f, 104.0f);
        pathBuilder.lineTo(208.0f, 104.0f);
        pathBuilder.close();
        pathBuilder.moveTo(152.0f, 76.69f);
        pathBuilder.lineTo(123.31f, 48.0f);
        pathBuilder.lineTo(152.0f, 48.0f);
        pathBuilder.close();
        pathBuilder.moveTo(48.0f, 123.31f);
        pathBuilder.lineTo(76.69f, 152.0f);
        pathBuilder.lineTo(48.0f, 152.0f);
        pathBuilder.close();
        pathBuilder.moveTo(104.0f, 179.31f);
        pathBuilder.lineTo(132.69f, 208.0f);
