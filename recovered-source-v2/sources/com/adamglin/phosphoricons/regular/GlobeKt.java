...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Globe", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getGlobe", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_globe", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GlobeKt {
    private static ImageVector _globe;

    public static final ImageVector getGlobe(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(87.61f, 87.61f, 0.0f, false, true, 3.33f, -24.0f);
        pathBuilder.lineTo(81.84f, 104.0f);
        pathBuilder.arcToRelative(157.44f, 157.44f, 0.0f, false, false, 0.0f, 48.0f);
        pathBuilder.lineTo(43.33f, 152.0f);
        pathBuilder.arcTo(87.61f, 87.61f, 0.0f, false, true, 40.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(154.0f, 88.0f);
        pathBuilder.lineTo(102.0f, 88.0f);
        pathBuilder.arcToRelative(115.11f, 115.11f, 0.0f, false, true, 26.0f, -45.0f);
        pathBuilder.arcTo(115.27f, 115.27f, 0.0f, false, true, 154.0f, 88.0f);
        pathBuilder.close();
        pathBuilder.moveTo(206.33f, 88.0f);
        ...
        pathBuilder.arcTo(135.28f, 135.28f, 0.0f, false, false, 85.29f, 88.0f);
        pathBuilder.lineTo(49.63f, 88.0f);
        pathBuilder.arcTo(88.29f, 88.29f, 0.0f, false, true, 107.59f, 42.4f);
        pathBuilder.close();
        pathBuilder.moveTo(49.63f, 168.0f);
        pathBuilder.lineTo(85.29f, 168.0f);
        pathBuilder.arcToRelative(135.28f, 135.28f, 0.0f, false, false, 22.3f, 45.6f);
        pathBuilder.arcTo(88.29f, 88.29f, 0.0f, false, true, 49.63f, 168.0f);
        pathBuilder.close();
