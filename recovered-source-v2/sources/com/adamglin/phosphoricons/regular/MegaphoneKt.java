...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Megaphone", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMegaphone", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_megaphone", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MegaphoneKt {
    private static ImageVector _megaphone;

    public static final ImageVector getMegaphone(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(160.2f, 72.0f);
        ...
        pathBuilder.arcTo(48.07f, 48.07f, 0.0f, false, false, 248.0f, 120.0f);
        pathBuilder.close();
        pathBuilder.moveTo(48.0f, 199.93f);
        pathBuilder.lineTo(48.0f, 40.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.curveToRelative(42.81f, 35.91f, 86.63f, 45.0f, 104.0f, 47.24f);
        pathBuilder.verticalLineToRelative(65.48f);
        pathBuilder.curveTo(134.65f, 155.0f, 90.84f, 164.07f, 48.0f, 199.93f);
        pathBuilder.close();
        pathBuilder.moveTo(179.0f, 207.93f);
        pathBuilder.lineTo(179.0f, 208.04f);
        pathBuilder.lineTo(168.0f, 200.71f);
