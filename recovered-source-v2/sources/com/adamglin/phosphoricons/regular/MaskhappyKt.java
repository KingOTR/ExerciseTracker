...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MaskHappy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMaskHappy", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_maskHappy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MaskhappyKt {
    private static ImageVector _maskHappy;

    public static final ImageVector getMaskHappy(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 103.8f);
        pathBuilder.curveToRelative(0.0f, 32.64f, -8.66f, 63.23f, -24.37f, 86.13f);
        pathBuilder.curveTo(168.54f, 211.9f, 148.79f, 224.0f, 128.0f, 224.0f);
        pathBuilder.reflectiveCurveToRelative(-40.54f, -12.1f, -55.63f, -34.08f);
        pathBuilder.curveTo(56.66f, 167.0f, 48.0f, 136.43f, 48.0f, 103.79f);
        pathBuilder.lineTo(48.0f, 48.0f);
        pathBuilder.curveToRelative(15.11f, 5.87f, 45.58f, 15.71f, 80.0f, 15.71f);
        pathBuilder.reflectiveCurveTo(192.9f, 53.87f, 208.0f, 48.0f);
        pathBuilder.verticalLineToRelative(55.81f);
        pathBuilder.close();
        pathBuilder.moveTo(190.0f, 122.67f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, true, true, 178.0f, 133.33f);
        ...
        pathBuilder.reflectiveCurveTo(184.25f, 116.28f, 190.0f, 122.66f);
        pathBuilder.close();
        pathBuilder.moveTo(92.0f, 128.0f);
        pathBuilder.curveToRelative(-5.19f, 0.0f, -11.36f, 2.34f, -14.0f, 5.33f);
        ...
        pathBuilder.curveTo(103.36f, 130.34f, 97.19f, 128.0f, 92.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(168.45f, 173.19f);
        pathBuilder.arcToRelative(52.9f, 52.9f, 0.0f, false, true, -80.9f, 0.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, true, true, 99.72f, 162.8f);
