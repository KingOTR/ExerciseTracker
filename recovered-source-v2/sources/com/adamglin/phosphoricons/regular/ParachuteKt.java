...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Parachute", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getParachute", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_parachute", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ParachuteKt {
    private static ImageVector _parachute;

    public static final ImageVector getParachute(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(7.94f, 7.94f, 0.0f, false, false, 3.05f, 6.27f);
        pathBuilder.arcToRelative(0.93f, 0.93f, 0.0f, false, false, 0.15f, 0.13f);
        ...
        pathBuilder.arcToRelative(76.89f, 76.89f, 0.0f, false, true, 13.88f, 16.22f);
        pathBuilder.curveTo(149.49f, 62.0f, 158.45f, 81.87f, 159.82f, 112.0f);
        pathBuilder.lineTo(96.18f, 112.0f);
        pathBuilder.curveToRelative(1.37f, -30.13f, 10.33f, -50.0f, 17.94f, -61.74f);
        pathBuilder.arcTo(76.92f, 76.92f, 0.0f, false, true, 128.0f, 34.0f);
        pathBuilder.close();
