...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PhoneTransfer", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPhoneTransfer", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_phoneTransfer", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PhonetransferKt {
    private static ImageVector _phoneTransfer;

    public static final ImageVector getPhoneTransfer(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(223.87f, 183.08f);
        pathBuilder.arcTo(56.24f, 56.24f, 0.0f, false, true, 168.0f, 232.0f);
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 223.87f, 183.08f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -0.74f, 0.56f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -15.75f, 1.14f);
        pathBuilder.curveToRelative(-18.73f, -9.0f, -37.4f, -27.58f, -46.46f, -46.11f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 1.0f, -15.7f);
        pathBuilder.arcToRelative(7.0f, 7.0f, 0.0f, false, true, 0.57f, -0.77f);
