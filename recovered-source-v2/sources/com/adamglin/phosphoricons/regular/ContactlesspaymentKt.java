...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ContactlessPayment", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getContactlessPayment", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_contactlessPayment", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ContactlesspaymentKt {
    private static ImageVector _contactlessPayment;

    public static final ImageVector getContactlessPayment(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(97.07f, 100.26f);
        pathBuilder.arcToRelative(59.33f, 59.33f, 0.0f, false, true, 0.0f, 55.48f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(153.07f, 68.26f);
        pathBuilder.arcToRelative(126.67f, 126.67f, 0.0f, false, true, 0.0f, 119.54f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(125.07f, 84.26f);
        pathBuilder.arcToRelative(93.0f, 93.0f, 0.0f, false, true, 0.0f, 87.52f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -14.12f, -7.52f);
        pathBuilder.arcToRelative(77.0f, 77.0f, 0.0f, false, false, 0.0f, -72.48f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 14.12f, -7.52f);
        pathBuilder.close();
