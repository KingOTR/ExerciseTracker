...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Volleyball", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getVolleyball", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_volleyball", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class VolleyballKt {
    private static ImageVector _volleyball;

    public static final ImageVector getVolleyball(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(91.12f, 48.11f);
        pathBuilder.arcToRelative(87.57f, 87.57f, 0.0f, false, true, 24.22f, -7.2f);
        pathBuilder.arcToRelative(88.0f, 88.0f, 0.0f, false, true, 50.0f, 79.09f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(77.27f, 56.13f);
        ...
        pathBuilder.arcToRelative(87.5f, 87.5f, 0.0f, false, true, -36.88f, -8.11f);
        pathBuilder.lineToRelative(17.13f, -29.67f);
        pathBuilder.arcToRelative(104.23f, 104.23f, 0.0f, false, false, 85.53f, 8.17f);
        pathBuilder.arcTo(87.81f, 87.81f, 0.0f, false, true, 128.0f, 216.0f);
        pathBuilder.close();
