...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"EyedropperSample", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getEyedropperSample", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_eyedropperSample", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class EyedroppersampleKt {
    private static ImageVector _eyedropperSample;

    public static final ImageVector getEyedropperSample(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(142.8f, 62.2f);
        ...
        pathBuilder.lineToRelative(19.75f, -19.87f);
        ...
        pathBuilder.lineToRelative(-18.1f, 7.9f);
        pathBuilder.lineTo(57.0f, 189.41f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.25f, -5.75f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, true, 0.1f, -15.69f);
        pathBuilder.lineTo(122.0f, 167.97f);
        pathBuilder.close();
        pathBuilder.moveTo(138.0f, 152.0f);
        pathBuilder.lineTo(70.07f, 152.0f);
        pathBuilder.lineToRelative(44.0f, -44.0f);
        pathBuilder.lineToRelative(33.94f, 34.0f);
        pathBuilder.close();
        pathBuilder.moveTo(202.18f, 82.0f);
        pathBuilder.lineTo(176.81f, 107.52f);
        ...
        pathBuilder.lineToRelative(-9.0f, 9.0f);
        pathBuilder.lineTo(112.0f, 83.26f);
        pathBuilder.lineToRelative(9.0f, -9.0f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.66f, -2.36f);
        pathBuilder.lineToRelative(24.94f, -25.09f);
        pathBuilder.curveToRelative(7.81f, -7.82f, 20.5f, -8.18f, 28.29f, -0.81f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, 0.39f, 28.7f);
        pathBuilder.close();
