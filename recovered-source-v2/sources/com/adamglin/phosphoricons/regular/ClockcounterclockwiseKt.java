...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ClockCounterClockwise", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getClockCounterClockwise", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_clockCounterClockwise", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ClockcounterclockwiseKt {
    private static ImageVector _clockCounterClockwise;

    public static final ImageVector getClockCounterClockwise(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(95.44f, 95.44f, 0.0f, false, false, 60.08f, 60.15f);
        pathBuilder.curveTo(52.81f, 67.51f, 46.35f, 74.59f, 40.0f, 82.0f);
        ...
        pathBuilder.curveToRelative(7.15f, -8.42f, 14.27f, -16.35f, 22.39f, -24.57f);
        pathBuilder.arcToRelative(80.0f, 80.0f, 0.0f, true, true, 1.66f, 114.75f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -11.0f, 11.64f);
