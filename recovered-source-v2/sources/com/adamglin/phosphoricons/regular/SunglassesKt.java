...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Sunglasses", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSunglasses", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sunglasses", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SunglassesKt {
    private static ImageVector _sunglasses;

    public static final ImageVector getSunglasses(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(212.63f, 177.31f);
        pathBuilder.lineTo(179.31f, 144.0f);
        pathBuilder.lineTo(216.0f, 144.0f);
        pathBuilder.verticalLineToRelative(20.0f);
        pathBuilder.arcTo(27.8f, 27.8f, 0.0f, false, true, 212.63f, 177.31f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 164.0f);
        pathBuilder.lineTo(40.0f, 147.31f);
        pathBuilder.lineToRelative(41.31f, 41.32f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 40.0f, 164.0f);
        pathBuilder.close();
        pathBuilder.moveTo(96.0f, 164.0f);
        pathBuilder.arcToRelative(27.8f, 27.8f, 0.0f, false, true, -3.37f, 13.31f);
        pathBuilder.lineTo(59.31f, 144.0f);
        pathBuilder.lineTo(96.0f, 144.0f);
        pathBuilder.close();
        pathBuilder.moveTo(160.0f, 164.0f);
        pathBuilder.lineTo(160.0f, 147.31f);
        pathBuilder.lineToRelative(41.31f, 41.32f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 160.0f, 164.0f);
        pathBuilder.close();
