...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsClockwise", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getArrowsClockwise", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsClockwise", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsclockwiseKt {
    private static ImageVector _arrowsClockwise;

    public static final ImageVector getArrowsClockwise(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(182.06f, 73.37f);
        pathBuilder.arcToRelative(79.56f, 79.56f, 0.0f, false, false, -56.13f, -23.43f);
        ...
        pathBuilder.arcToRelative(96.0f, 96.0f, 0.0f, false, true, 135.0f, 0.79f);
        pathBuilder.lineTo(208.0f, 76.69f);
        pathBuilder.verticalLineTo(48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(186.41f, 183.29f);
        pathBuilder.arcToRelative(80.0f, 80.0f, 0.0f, false, true, -112.47f, -0.66f);
        ...
        pathBuilder.verticalLineTo(179.31f);
        pathBuilder.lineToRelative(14.63f, 14.63f);
        pathBuilder.arcTo(95.43f, 95.43f, 0.0f, false, false, 130.0f, 222.06f);
