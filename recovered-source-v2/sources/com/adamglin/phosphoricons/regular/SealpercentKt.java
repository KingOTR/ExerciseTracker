...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SealPercent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSealPercent", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sealPercent", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealpercentKt {
    private static ImageVector _sealPercent;

    public static final ImageVector getSealPercent(RegularGroup regularGroup) {
        ...
        pathBuilder.curveTo(23.51f, 109.73f, 16.0f, 117.56f, 16.0f, 128.0f);
        ...
        pathBuilder.curveToRelative(0.08f, -5.25f, 0.16f, -10.67f, 1.52f, -13.94f);
        pathBuilder.curveToRelative(1.47f, -3.56f, 5.37f, -7.63f, 9.14f, -11.57f);
        pathBuilder.curveTo(232.49f, 146.27f, 240.0f, 138.44f, 240.0f, 128.0f);
        ...
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, true, false, 24.0f, 24.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 160.0f, 136.0f);
        pathBuilder.close();
