...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Sailboat", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSailboat", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sailboat", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SailboatKt {
    private static ImageVector _sailboat;

    public static final ImageVector getSailboat(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(144.0f, 44.91f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(197.92f, 128.0f);
        pathBuilder.lineTo(144.0f, 128.0f);
        pathBuilder.lineTo(144.0f, 68.69f);
        pathBuilder.close();
        pathBuilder.moveTo(48.81f, 128.0f);
        pathBuilder.lineTo(128.0f, 30.53f);
        pathBuilder.lineTo(128.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(204.16f, 208.0f);
        pathBuilder.lineTo(51.84f, 208.0f);
        pathBuilder.lineToRelative(-19.2f, -24.0f);
        pathBuilder.lineTo(223.36f, 184.0f);
        pathBuilder.close();
