...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Checkerboard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCheckerboard", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_checkerboard", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CheckerboardKt {
    private static ImageVector _checkerboard;

    public static final ImageVector getCheckerboard(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(107.31f, 208.0f);
        pathBuilder.lineTo(48.0f, 148.69f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(120.0f, 172.69f);
        pathBuilder.lineTo(83.31f, 136.0f);
        pathBuilder.lineTo(120.0f, 136.0f);
        pathBuilder.close();
        pathBuilder.moveTo(48.0f, 171.31f);
        pathBuilder.lineTo(84.69f, 208.0f);
