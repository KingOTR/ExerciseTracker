...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserRectangle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getUserRectangle", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userRectangle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UserrectangleKt {
    private static ImageVector _userRectangle;

    public static final ImageVector getUserRectangle(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(72.57f, 200.0f);
        pathBuilder.arcToRelative(64.0f, 64.0f, 0.0f, false, true, 110.86f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(216.0f, 200.0f);
        pathBuilder.horizontalLineTo(201.33f);
        pathBuilder.arcToRelative(80.14f, 80.14f, 0.0f, false, false, -43.69f, -42.28f);
        pathBuilder.arcToRelative(48.0f, 48.0f, 0.0f, true, false, -59.28f, 0.0f);
        pathBuilder.arcTo(80.14f, 80.14f, 0.0f, false, false, 54.67f, 200.0f);
        pathBuilder.horizontalLineTo(40.0f);
        pathBuilder.verticalLineTo(56.0f);
        pathBuilder.horizontalLineTo(216.0f);
        pathBuilder.verticalLineTo(200.0f);
