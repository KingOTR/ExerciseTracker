...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Coin", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCoin", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_coin", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CoinKt {
    private static ImageVector _coin;

    public static final ImageVector getCoin(RegularGroup regularGroup) {
        ...
        pathBuilder.curveToRelative(62.64f, 0.0f, 96.0f, 23.23f, 96.0f, 40.0f);
        pathBuilder.reflectiveCurveToRelative(-33.36f, 40.0f, -96.0f, 40.0f);
        pathBuilder.reflectiveCurveToRelative(-96.0f, -23.23f, -96.0f, -40.0f);
        pathBuilder.reflectiveCurveTo(65.36f, 64.0f, 128.0f, 64.0f);
        pathBuilder.close();
        pathBuilder.moveTo(120.0f, 159.86f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(136.0f, 159.86f);
