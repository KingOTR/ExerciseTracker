...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SealQuestion", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSealQuestion", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sealQuestion", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealquestionKt {
    private static ImageVector _sealQuestion;

    public static final ImageVector getSealQuestion(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 140.0f, 180.0f);
        pathBuilder.close();
        pathBuilder.moveTo(168.0f, 108.0f);
        pathBuilder.curveToRelative(0.0f, 17.38f, -13.76f, 31.93f, -32.0f, 35.28f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder.verticalLineToRelative(-4.0f);
        pathBuilder.curveToRelative(0.0f, -19.85f, 17.94f, -36.0f, 40.0f, -36.0f);
        pathBuilder.reflectiveCurveTo(168.0f, 88.15f, 168.0f, 108.0f);
        pathBuilder.close();
