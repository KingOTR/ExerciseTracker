...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"LastfmLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getLastfmLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_lastfmLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LastfmlogoKt {
    private static ImageVector _lastfmLogo;

    public static final ImageVector getLastfmLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(56.22f, 56.22f, 0.0f, false, true, -50.75f, -32.32f);
        pathBuilder.lineToRelative(-30.14f, -64.6f);
        pathBuilder.arcTo(40.15f, 40.15f, 0.0f, false, false, 73.43f, 80.0f);
        pathBuilder.horizontalLineTo(64.0f);
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, false, -40.0f, 40.0f);
        pathBuilder.verticalLineToRelative(24.0f);
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, false, 40.0f, 40.0f);
        pathBuilder.horizontalLineToRelative(8.0f);
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, false, false, 29.34f, -19.2f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, true, true, 116.0f, 171.2f);
        pathBuilder.arcTo(48.0f, 48.0f, 0.0f, false, true, 72.0f, 200.0f);
        pathBuilder.horizontalLineTo(64.0f);
        pathBuilder.arcTo(56.06f, 56.06f, 0.0f, false, true, 8.0f, 144.0f);
        pathBuilder.verticalLineTo(120.0f);
        pathBuilder.arcTo(56.06f, 56.06f, 0.0f, false, true, 64.0f, 64.0f);
        pathBuilder.horizontalLineToRelative(9.43f);
        pathBuilder.arcToRelative(56.22f, 56.22f, 0.0f, false, true, 50.75f, 32.32f);
        pathBuilder.lineToRelative(30.14f, 64.6f);
        pathBuilder.arcTo(40.15f, 40.15f, 0.0f, false, false, 190.57f, 184.0f);
