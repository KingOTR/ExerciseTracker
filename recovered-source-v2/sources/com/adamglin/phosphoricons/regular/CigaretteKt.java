...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Cigarette", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCigarette", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cigarette", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CigaretteKt {
    private static ImageVector _cigarette;

    public static final ImageVector getCigarette(RegularGroup regularGroup) {
        ...
        pathBuilder.curveToRelative(-8.0f, 14.23f, -7.42f, 21.72f, -6.36f, 24.91f);
        pathBuilder.arcToRelative(7.79f, 7.79f, 0.0f, false, false, 2.64f, 3.86f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -6.5f, 14.62f);
        pathBuilder.arcToRelative(22.57f, 22.57f, 0.0f, false, true, -11.32f, -13.44f);
        pathBuilder.curveTo(190.07f, 87.73f, 192.62f, 75.0f, 201.0f, 60.08f);
        pathBuilder.close();
        pathBuilder.moveTo(161.0f, 60.08f);
        pathBuilder.curveToRelative(8.0f, -14.23f, 7.42f, -21.71f, 6.36f, -24.91f);
        pathBuilder.arcToRelative(7.79f, 7.79f, 0.0f, false, false, -2.64f, -3.86f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 6.5f, -14.62f);
        pathBuilder.arcToRelative(22.57f, 22.57f, 0.0f, false, true, 11.32f, 13.44f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -6.5f, 14.62f);
        pathBuilder.arcToRelative(22.57f, 22.57f, 0.0f, false, true, -11.32f, -13.44f);
        pathBuilder.curveTo(150.07f, 87.73f, 152.62f, 75.0f, 161.0f, 60.08f);
        pathBuilder.close();
