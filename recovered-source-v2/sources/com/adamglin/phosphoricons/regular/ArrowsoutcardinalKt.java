...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsOutCardinal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getArrowsOutCardinal", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsOutCardinal", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsoutcardinalKt {
    private static ImageVector _arrowsOutCardinal;

    public static final ImageVector getArrowsOutCardinal(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(90.34f, 61.66f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 90.34f, 61.66f);
        pathBuilder.close();
        pathBuilder.moveTo(154.34f, 194.34f);
        pathBuilder.lineTo(136.0f, 212.69f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(43.31f, 136.0f);
        pathBuilder.lineTo(96.0f, 136.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.lineTo(43.31f, 120.0f);
        pathBuilder.lineToRelative(18.35f, -18.34f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 50.34f, 90.34f);
        pathBuilder.lineToRelative(-32.0f, 32.0f);
