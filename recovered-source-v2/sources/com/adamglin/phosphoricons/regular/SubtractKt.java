...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Subtract", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSubtract", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_subtract", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SubtractKt {
    private static ImageVector _subtract;

    public static final ImageVector getSubtract(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(174.63f, 81.35f);
        pathBuilder.arcToRelative(80.0f, 80.0f, 0.0f, true, false, -93.28f, 93.28f);
        pathBuilder.arcToRelative(80.0f, 80.0f, 0.0f, true, false, 93.28f, -93.28f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(80.14f, 80.14f, 0.0f, false, false, 176.0f, 98.0f);
        pathBuilder.arcTo(63.81f, 63.81f, 0.0f, false, true, 224.0f, 160.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(64.07f, 64.07f, 0.0f, false, true, 32.0f, 96.0f);
        pathBuilder.close();
        pathBuilder.moveTo(98.0f, 176.0f);
        pathBuilder.arcToRelative(80.14f, 80.14f, 0.0f, false, false, 16.5f, -2.13f);
        pathBuilder.lineToRelative(50.0f, 50.0f);
        pathBuilder.curveToRelative(-1.49f, 0.11f, -3.0f, 0.18f, -4.51f, 0.18f);
        pathBuilder.arcTo(63.81f, 63.81f, 0.0f, false, true, 98.0f, 176.0f);
        pathBuilder.close();
