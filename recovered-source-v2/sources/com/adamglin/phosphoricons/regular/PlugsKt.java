...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Plugs", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPlugs", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_plugs", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PlugsKt {
    private static ImageVector _plugs;

    public static final ImageVector getPlugs(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(149.66f, 138.34f);
        ...
        pathBuilder.lineTo(69.66f, 106.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, 11.32f);
        pathBuilder.lineTo(64.69f, 124.0f);
        pathBuilder.lineTo(41.37f, 147.31f);
        ...
        pathBuilder.lineToRelative(18.35f, -18.34f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 149.66f, 138.34f);
        pathBuilder.close();
        pathBuilder.moveTo(97.37f, 203.34f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -22.62f, 0.0f);
        pathBuilder.lineTo(52.69f, 181.25f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 0.0f, -22.62f);
        pathBuilder.lineTo(76.0f, 135.31f);
        pathBuilder.lineTo(120.69f, 180.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(203.31f, 97.34f);
        pathBuilder.lineTo(180.0f, 120.69f);
        pathBuilder.lineTo(135.31f, 76.0f);
        pathBuilder.lineToRelative(23.32f, -23.31f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 22.62f, 0.0f);
        pathBuilder.lineToRelative(22.06f, 22.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 203.31f, 97.37f);
        pathBuilder.close();
