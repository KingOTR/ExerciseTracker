...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Bulldozer", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getBulldozer", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bulldozer", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BulldozerKt {
    private static ImageVector _bulldozer;

    public static final ImageVector getBulldozer(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(232.0f, 160.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder.horizontalLineToRelative(8.0f);
        ...
        pathBuilder.lineTo(199.2f, 168.0f);
        pathBuilder.arcToRelative(40.09f, 40.09f, 0.0f, false, false, -33.71f, -31.61f);
        pathBuilder.lineTo(129.44f, 49.85f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 114.67f, 40.0f);
        pathBuilder.lineTo(24.0f, 40.0f);
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 168.0f, 176.0f);
        pathBuilder.close();
