...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsSplit", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getArrowsSplit", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsSplit", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowssplitKt {
    private static ImageVector _arrowsSplit;

    public static final ImageVector getArrowsSplit(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(229.66f, 189.66f);
        ...
        pathBuilder.lineTo(184.0f, 196.69f);
        pathBuilder.verticalLineTo(139.31f);
        pathBuilder.lineToRelative(-56.0f, -56.0f);
        pathBuilder.lineToRelative(-56.0f, 56.0f);
        pathBuilder.verticalLineToRelative(57.38f);
        ...
        pathBuilder.lineTo(120.0f, 68.69f);
        pathBuilder.verticalLineTo(24.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder.verticalLineTo(68.69f);
        pathBuilder.lineToRelative(61.66f, 61.65f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 200.0f, 136.0f);
