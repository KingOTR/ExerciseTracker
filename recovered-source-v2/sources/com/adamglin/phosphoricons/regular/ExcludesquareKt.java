...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ExcludeSquare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getExcludeSquare", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_excludeSquare", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ExcludesquareKt {
    private static ImageVector _excludeSquare;

    public static final ImageVector getExcludeSquare(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(48.0f, 59.31f);
        pathBuilder.lineToRelative(40.0f, 40.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(152.0f, 84.69f);
        pathBuilder.lineTo(115.31f, 48.0f);
        pathBuilder.lineTo(152.0f, 48.0f);
        pathBuilder.close();
        pathBuilder.moveTo(48.0f, 115.31f);
        pathBuilder.lineTo(84.69f, 152.0f);
