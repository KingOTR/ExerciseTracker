...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MapTrifold", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMapTrifold", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mapTrifold", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MaptrifoldKt {
    private static ImageVector _mapTrifold;

    public static final ImageVector getMapTrifold(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(104.0f, 52.94f);
        pathBuilder.lineToRelative(48.0f, 24.0f);
        pathBuilder.lineTo(152.0f, 203.06f);
        pathBuilder.lineToRelative(-48.0f, -24.0f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 62.25f);
        pathBuilder.lineToRelative(48.0f, -12.0f);
        pathBuilder.verticalLineToRelative(127.5f);
        pathBuilder.lineToRelative(-48.0f, 12.0f);
        pathBuilder.close();
        pathBuilder.moveTo(216.0f, 193.75f);
        pathBuilder.lineTo(168.0f, 205.75f);
        pathBuilder.lineTo(168.0f, 78.25f);
        pathBuilder.lineToRelative(48.0f, -12.0f);
        pathBuilder.close();
