...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Atom", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getAtom", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_atom", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class AtomKt {
    private static ImageVector _atom;

    public static final ImageVector getAtom(RegularGroup regularGroup) {
        ...
        pathBuilder.curveToRelative(18.48f, 0.0f, 42.48f, -11.17f, 66.0f, -27.88f);
        ...
        pathBuilder.arcTo(300.33f, 300.33f, 0.0f, false, false, 141.27f, 70.0f);
        pathBuilder.curveTo(172.15f, 49.0f, 196.91f, 43.8f, 204.55f, 51.45f);
        pathBuilder.close();
        pathBuilder.moveTo(176.29f, 128.0f);
        pathBuilder.arcToRelative(289.14f, 289.14f, 0.0f, false, true, -22.76f, 25.53f);
        pathBuilder.arcTo(289.14f, 289.14f, 0.0f, false, true, 128.0f, 176.29f);
        pathBuilder.arcToRelative(289.14f, 289.14f, 0.0f, false, true, -25.53f, -22.76f);
        pathBuilder.arcTo(289.14f, 289.14f, 0.0f, false, true, 79.71f, 128.0f);
        pathBuilder.arcTo(298.62f, 298.62f, 0.0f, false, true, 128.0f, 79.71f);
        pathBuilder.arcToRelative(289.14f, 289.14f, 0.0f, false, true, 25.53f, 22.76f);
        pathBuilder.arcTo(289.14f, 289.14f, 0.0f, false, true, 176.29f, 128.0f);
        pathBuilder.close();
        ...
        pathBuilder.curveTo(83.85f, 207.0f, 59.09f, 212.2f, 51.45f, 204.55f);
        pathBuilder.close();
        pathBuilder.moveTo(204.55f, 204.55f);
