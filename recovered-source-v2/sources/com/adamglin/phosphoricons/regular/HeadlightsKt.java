...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Headlights", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getHeadlights", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_headlights", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HeadlightsKt {
    private static ImageVector _headlights;

    public static final ImageVector getHeadlights(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(144.0f, 64.0f);
        ...
        pathBuilder.arcTo(80.0f, 80.0f, 0.0f, false, true, 8.0f, 127.39f);
        pathBuilder.curveTo(8.33f, 83.62f, 44.62f, 48.0f, 88.9f, 48.0f);
        pathBuilder.lineTo(128.0f, 48.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 144.0f, 64.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 64.0f);
        pathBuilder.lineTo(88.9f, 64.0f);
        pathBuilder.curveTo(53.38f, 64.0f, 24.26f, 92.49f, 24.0f, 127.51f);
        pathBuilder.arcTo(64.0f, 64.0f, 0.0f, false, false, 88.0f, 192.0f);
