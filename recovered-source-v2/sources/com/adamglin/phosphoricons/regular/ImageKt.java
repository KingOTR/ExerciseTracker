...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Image", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getImage", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_image", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ImageKt {
    private static ImageVector _image;

    public static final ImageVector getImage(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(216.0f, 158.75f);
        pathBuilder.lineToRelative(-26.07f, -26.06f);
        ...
        pathBuilder.lineTo(40.0f, 149.37f);
        ...
        pathBuilder.lineTo(194.63f, 200.0f);
        pathBuilder.lineToRelative(-36.0f, -36.0f);
        pathBuilder.lineToRelative(20.0f, -20.0f);
        pathBuilder.lineTo(216.0f, 181.38f);
        pathBuilder.lineTo(216.0f, 200.0f);
        pathBuilder.close();
        pathBuilder.moveTo(144.0f, 100.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, 12.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 144.0f, 100.0f);
        pathBuilder.close();
