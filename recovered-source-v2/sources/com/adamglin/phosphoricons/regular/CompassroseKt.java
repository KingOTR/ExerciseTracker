...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CompassRose", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCompassRose", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_compassRose", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CompassroseKt {
    private static ImageVector _compassRose;

    public static final ImageVector getCompassRose(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -15.52f);
        pathBuilder.close();
        pathBuilder.moveTo(154.45f, 143.14f);
        pathBuilder.lineTo(139.31f, 128.0f);
        pathBuilder.lineToRelative(15.14f, -15.14f);
        pathBuilder.lineTo(215.0f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(101.55f, 143.14f);
        pathBuilder.lineTo(41.0f, 128.0f);
        pathBuilder.lineToRelative(60.57f, -15.14f);
        pathBuilder.lineTo(116.69f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(205.77f, 109.2f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(143.14f, 101.55f);
        pathBuilder.lineTo(128.0f, 116.69f);
        pathBuilder.lineToRelative(-15.14f, -15.14f);
        pathBuilder.lineTo(128.0f, 41.0f);
        pathBuilder.close();
        pathBuilder.moveTo(109.2f, 50.23f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(50.2f, 146.8f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(112.83f, 154.45f);
        pathBuilder.lineTo(128.0f, 139.31f);
        pathBuilder.lineToRelative(15.14f, 15.14f);
        pathBuilder.lineTo(128.0f, 215.0f);
        pathBuilder.close();
        pathBuilder.moveTo(146.77f, 205.77f);
        pathBuilder.lineTo(158.57f, 158.6f);
        pathBuilder.lineTo(205.74f, 146.8f);
