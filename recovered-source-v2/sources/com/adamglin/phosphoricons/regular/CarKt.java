...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Car", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCar", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_car", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CarKt {
    private static ImageVector _car;

    public static final ImageVector getCar(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(229.2f, 104.0f);
        pathBuilder.lineTo(201.42f, 41.5f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 186.8f, 32.0f);
        pathBuilder.lineTo(69.2f, 32.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -14.62f, 9.5f);
        pathBuilder.lineTo(26.8f, 104.0f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(69.2f, 48.0f);
        pathBuilder.lineTo(186.8f, 48.0f);
        pathBuilder.lineToRelative(24.89f, 56.0f);
        pathBuilder.lineTo(44.31f, 104.0f);
        pathBuilder.close();
