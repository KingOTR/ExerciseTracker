...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CodesandboxLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCodesandboxLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_codesandboxLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CodesandboxlogoKt {
    private static ImageVector _codesandboxLogo;

    public static final ImageVector getCodesandboxLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(83.84f, 145.0f);
        pathBuilder.lineTo(40.0f, 121.0f);
        pathBuilder.verticalLineToRelative(-32.0f);
        pathBuilder.lineToRelative(80.0f, 43.8f);
        pathBuilder.verticalLineToRelative(86.87f);
        pathBuilder.lineTo(88.0f, 202.09f);
        pathBuilder.lineTo(88.0f, 152.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 83.84f, 145.0f);
        pathBuilder.close();
        pathBuilder.moveTo(83.14f, 56.59f);
        pathBuilder.lineTo(124.14f, 79.04f);
        ...
        pathBuilder.lineTo(128.0f, 118.88f);
        pathBuilder.lineTo(48.66f, 75.44f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 32.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.lineToRelative(28.2f, 15.44f);
        pathBuilder.lineTo(128.0f, 62.89f);
        pathBuilder.lineTo(99.8f, 47.45f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 139.22f);
        pathBuilder.lineToRelative(32.0f, 17.52f);
        pathBuilder.verticalLineToRelative(36.59f);
        pathBuilder.lineTo(40.0f, 175.82f);
        pathBuilder.close();
        pathBuilder.moveTo(184.0f, 193.33f);
        pathBuilder.lineTo(184.0f, 156.74f);
        pathBuilder.lineToRelative(32.0f, -17.52f);
