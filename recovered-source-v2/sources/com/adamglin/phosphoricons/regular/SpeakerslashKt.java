...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SpeakerSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSpeakerSlash", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_speakerSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SpeakerslashKt {
    private static ImageVector _speakerSlash;

    public static final ImageVector getSpeakerSlash(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(73.55f, 80.0f);
        ...
        pathBuilder.lineToRelative(42.08f, 46.29f);
        ...
        pathBuilder.lineTo(88.0f, 95.89f);
        pathBuilder.lineToRelative(56.0f, 61.6f);
        pathBuilder.close();
        pathBuilder.moveTo(186.0f, 143.87f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, false, 0.0f, -31.72f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 12.0f, -10.57f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(105.84f, 67.87f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 1.4f, -11.23f);
        pathBuilder.lineToRelative(39.85f, -31.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 160.0f, 32.0f);
        pathBuilder.verticalLineToRelative(74.83f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder.lineTo(144.0f, 48.36f);
        pathBuilder.lineToRelative(-26.94f, 21.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 105.84f, 67.91f);
        pathBuilder.close();
