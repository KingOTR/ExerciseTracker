...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Highlighter", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getHighlighter", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_highlighter", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HighlighterKt {
    private static ImageVector _highlighter;

    public static final ImageVector getHighlighter(RegularGroup regularGroup) {
        ...
        pathBuilder.lineToRelative(21.19f, -21.18f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(93.84f, 206.85f);
        pathBuilder.lineToRelative(-55.0f, -18.35f);
        pathBuilder.lineTo(88.0f, 139.31f);
        pathBuilder.lineTo(124.69f, 176.0f);
        pathBuilder.close();
