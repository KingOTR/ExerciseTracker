...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SmileyAngry", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getSmileyAngry", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_smileyAngry", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SmileyangryKt {
    private static ImageVector _smileyAngry;

    public static final ImageVector getSmileyAngry(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(171.56f, 81.34f);
        pathBuilder.lineTo(128.0f, 110.39f);
        pathBuilder.lineToRelative(-43.56f, -29.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -8.88f, 13.32f);
        pathBuilder.lineToRelative(48.0f, 32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.88f, 0.0f);
        pathBuilder.lineToRelative(48.0f, -32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.88f, -13.32f);
        pathBuilder.close();
        pathBuilder.moveTo(156.43f, 177.34f);
        pathBuilder.curveTo(148.0f, 171.73f, 139.94f, 168.0f, 128.0f, 168.0f);
        pathBuilder.reflectiveCurveToRelative(-20.0f, 3.73f, -28.43f, 9.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.86f, 13.32f);
        pathBuilder.curveTo(114.93f, 186.34f, 120.0f, 184.0f, 128.0f, 184.0f);
        pathBuilder.reflectiveCurveToRelative(13.07f, 2.34f, 19.57f, 6.66f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 8.86f, -13.32f);
        pathBuilder.close();
