...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Asclepius", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getAsclepius", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_asclepius", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class AsclepiusKt {
    private static ImageVector _asclepius;

    public static final ImageVector getAsclepius(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(216.0f, 79.0f);
        ...
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 10.67f, -27.93f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 10.66f, -11.92f);
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, true, 144.0f, 216.0f);
        pathBuilder.horizontalLineToRelative(-8.0f);
        ...
        pathBuilder.arcToRelative(23.0f, 23.0f, 0.0f, false, false, -23.0f, -23.0f);
        pathBuilder.horizontalLineTo(160.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
        pathBuilder.horizontalLineToRelative(17.0f);
        pathBuilder.arcToRelative(39.0f, 39.0f, 0.0f, false, true, 39.0f, 39.0f);
        pathBuilder.close();
        pathBuilder.moveTo(56.0f, 96.0f);
        pathBuilder.horizontalLineTo(32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, -8.0f);
        pathBuilder.verticalLineTo(80.0f);
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, false, true, 64.0f, 40.0f);
        pathBuilder.horizontalLineTo(96.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, false, true, 56.0f, 96.0f);
        pathBuilder.close();
        pathBuilder.moveTo(80.0f, 56.0f);
        pathBuilder.horizontalLineTo(64.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 40.0f, 80.0f);
