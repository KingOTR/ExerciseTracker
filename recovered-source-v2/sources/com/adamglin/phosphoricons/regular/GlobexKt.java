...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"GlobeX", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getGlobeX", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_globeX", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GlobexKt {
    private static ImageVector _globeX;

    public static final ImageVector getGlobeX(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.0f, -14.23f);
        ...
        pathBuilder.lineTo(98.08f, 152.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(107.59f, 213.6f);
        pathBuilder.arcToRelative(88.29f, 88.29f, 0.0f, false, true, -58.0f, -45.6f);
        pathBuilder.lineTo(85.29f, 168.0f);
        pathBuilder.arcTo(135.28f, 135.28f, 0.0f, false, false, 107.59f, 213.6f);
        pathBuilder.close();
        pathBuilder.moveTo(81.84f, 152.0f);
        pathBuilder.lineTo(43.33f, 152.0f);
        pathBuilder.arcToRelative(88.15f, 88.15f, 0.0f, false, true, 0.0f, -48.0f);
