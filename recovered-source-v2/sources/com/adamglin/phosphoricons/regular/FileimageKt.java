...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileImage", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getFileImage", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileImage", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FileimageKt {
    private static ImageVector _fileImage;

    public static final ImageVector getFileImage(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(110.66f, 147.56f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -13.32f, 0.0f);
        pathBuilder.lineTo(76.49f, 178.85f);
        pathBuilder.lineToRelative(-9.76f, -15.18f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -13.46f, 0.0f);
        pathBuilder.lineToRelative(-36.0f, 56.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 24.0f, 232.0f);
        pathBuilder.lineTo(152.0f, 232.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 6.66f, -12.44f);
        pathBuilder.close();
        pathBuilder.moveTo(38.65f, 216.0f);
        pathBuilder.lineTo(60.0f, 182.79f);
        pathBuilder.lineToRelative(9.63f, 15.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 13.39f, 0.11f);
        pathBuilder.lineToRelative(21.0f, -31.47f);
        pathBuilder.lineTo(137.05f, 216.0f);
        pathBuilder.close();
        pathBuilder.moveTo(213.65f, 82.34f);
        pathBuilder.lineTo(157.65f, 26.34f);
