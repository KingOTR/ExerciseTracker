...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CaretCircleDoubleRight", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCaretCircleDoubleRight", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_caretCircleDoubleRight", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CaretcircledoublerightKt {
    private static ImageVector _caretCircleDoubleRight;

    public static final ImageVector getCaretCircleDoubleRight(RegularGroup regularGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(125.66f, 122.34f);
        ...
        pathBuilder.lineTo(82.34f, 101.66f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 93.66f, 90.34f);
        pathBuilder.close();
        pathBuilder.moveTo(181.66f, 122.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 11.32f);
        pathBuilder.lineToRelative(-32.0f, 32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f);
