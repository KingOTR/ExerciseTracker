...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Robot", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getRobot", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_robot", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RobotKt {
    private static ImageVector _robot;

    public static final ImageVector getRobot(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, false, 24.0f, 80.0f);
        ...
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, false, 200.0f, 48.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 56.0f, 64.0f);
        pathBuilder.lineTo(200.0f, 64.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 16.0f, 16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(164.0f, 136.0f);
        pathBuilder.lineTo(92.0f, 136.0f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 72.0f, 108.0f);
        pathBuilder.close();
        pathBuilder.moveTo(160.0f, 108.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, 12.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 160.0f, 108.0f);
        pathBuilder.close();
