...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Football", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getFootball", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_football", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FootballKt {
    private static ImageVector _football;

    public static final ImageVector getFootball(RegularGroup regularGroup) {
        ...
        pathBuilder.curveToRelative(-32.37f, -5.49f, -93.39f, -8.0f, -138.27f, 36.9f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(167.45f, 39.89f);
        ...
        pathBuilder.arcTo(188.59f, 188.59f, 0.0f, false, true, 216.0f, 92.78f);
        pathBuilder.lineTo(163.21f, 40.0f);
        pathBuilder.curveTo(164.61f, 39.92f, 166.0f, 39.9f, 167.45f, 39.9f);
        pathBuilder.close();
        pathBuilder.moveTo(56.56f, 213.3f);
        pathBuilder.arcTo(16.94f, 16.94f, 0.0f, false, true, 42.7f, 199.44f);
        pathBuilder.arcTo(188.59f, 188.59f, 0.0f, false, true, 40.0f, 163.22f);
        pathBuilder.lineTo(92.78f, 216.0f);
        pathBuilder.arcTo(187.79f, 187.79f, 0.0f, false, true, 56.56f, 213.3f);
        pathBuilder.close();
        pathBuilder.moveTo(180.86f, 180.86f);
        pathBuilder.curveToRelative(-11.61f, 11.6f, -33.27f, 27.73f, -67.37f, 33.27f);
        pathBuilder.lineTo(41.87f, 142.51f);
        pathBuilder.curveToRelative(5.54f, -34.1f, 21.67f, -55.76f, 33.27f, -67.37f);
        pathBuilder.reflectiveCurveTo(108.4f, 47.4f, 142.5f, 41.86f);
        pathBuilder.lineToRelative(71.63f, 71.63f);
        pathBuilder.curveTo(208.59f, 147.59f, 192.46f, 169.25f, 180.86f, 180.86f);
        pathBuilder.close();
        pathBuilder.moveTo(165.64f, 90.36f);
        ...
        pathBuilder.lineToRelative(14.34f, -14.34f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 165.64f, 90.36f);
        pathBuilder.close();
