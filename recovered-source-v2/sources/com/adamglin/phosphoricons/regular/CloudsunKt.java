...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CloudSun", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCloudSun", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cloudSun", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CloudsunKt {
    private static ImageVector _cloudSun;

    public static final ImageVector getCloudSun(RegularGroup regularGroup) {
        ...
        pathBuilder.curveToRelative(-0.58f, 0.0f, -1.16f, 0.0f, -1.74f, 0.0f);
        ...
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, true, 72.54f, -23.24f);
        pathBuilder.arcToRelative(76.26f, 76.26f, 0.0f, false, false, -35.62f, 40.0f);
        pathBuilder.arcToRelative(52.14f, 52.14f, 0.0f, false, false, -31.0f, 4.17f);
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, false, true, 56.0f, 104.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(60.06f, 60.06f, 0.0f, true, true, 164.0f, 208.0f);
        pathBuilder.close();
