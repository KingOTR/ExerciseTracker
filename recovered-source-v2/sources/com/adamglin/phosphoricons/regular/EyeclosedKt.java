...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"EyeClosed", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getEyeClosed", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_eyeClosed", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class EyeclosedKt {
    private static ImageVector _eyeClosed;

    public static final ImageVector getEyeClosed(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(228.0f, 175.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -10.92f, -3.0f);
        ...
        pathBuilder.arcToRelative(153.47f, 153.47f, 0.0f, false, true, -19.3f, -20.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, true, true, 38.22f, 99.0f);
        pathBuilder.curveToRelative(16.6f, 20.54f, 45.64f, 45.0f, 89.78f, 45.0f);
        pathBuilder.reflectiveCurveToRelative(73.18f, -24.49f, 89.78f, -45.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, true, true, 230.22f, 109.0f);
        pathBuilder.arcToRelative(153.47f, 153.47f, 0.0f, false, true, -19.3f, 20.0f);
        pathBuilder.lineToRelative(20.0f, 35.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 228.0f, 175.0f);
        pathBuilder.close();
