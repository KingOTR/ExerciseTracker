...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Pen", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPen", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pen", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PenKt {
    private static ImageVector _pen;

    public static final ImageVector getPen(RegularGroup regularGroup) {
        ...
        pathBuilder.lineToRelative(83.67f, -83.66f);
        pathBuilder.lineToRelative(3.48f, 13.9f);
        pathBuilder.lineToRelative(-36.8f, 36.79f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.31f, 11.32f);
        pathBuilder.lineToRelative(40.0f, -40.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 2.11f, -7.6f);
        pathBuilder.lineToRelative(-6.9f, -27.61f);
