...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CowboyHat", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getCowboyHat", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cowboyHat", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CowboyhatKt {
    private static ImageVector _cowboyHat;

    public static final ImageVector getCowboyHat(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(40.0f, 40.0f, 0.0f, false, false, 0.0f, -80.0f);
        pathBuilder.close();
        pathBuilder.moveTo(93.41f, 56.0f);
        pathBuilder.lineTo(117.88f, 76.4f);
        pathBuilder.lineToRelative(0.12f, 0.1f);
        pathBuilder.arcToRelative(15.92f, 15.92f, 0.0f, false, false, 20.0f, 0.0f);
        pathBuilder.lineToRelative(0.12f, -0.1f);
        pathBuilder.lineTo(162.59f, 56.0f);
        pathBuilder.lineToRelative(13.68f, 72.0f);
        pathBuilder.lineTo(79.73f, 128.0f);
        pathBuilder.close();
        pathBuilder.moveTo(40.0f, 184.0f);
        pathBuilder.arcToRelative(24.0f, 24.0f, 0.0f, false, true, -4.14f, -47.64f);
        pathBuilder.curveTo(51.28f, 159.83f, 67.73f, 174.65f, 82.4f, 184.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 184.0f);
        pathBuilder.curveToRelative(-0.33f, 0.0f, -25.49f, -0.4f, -53.86f, -26.6f);
        pathBuilder.lineTo(76.68f, 144.0f);
        ...
        pathBuilder.lineTo(173.6f, 184.0f);
        pathBuilder.curveToRelative(14.67f, -9.35f, 31.12f, -24.17f, 46.54f, -47.64f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 216.0f, 184.0f);
        pathBuilder.close();
