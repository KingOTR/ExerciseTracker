...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsInCardinal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getArrowsInCardinal", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsInCardinal", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsincardinalKt {
    private static ImageVector _arrowsInCardinal;

    public static final ImageVector getArrowsInCardinal(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(120.0f, 76.69f);
        pathBuilder.lineTo(120.0f, 24.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder.lineTo(136.0f, 76.69f);
        ...
        pathBuilder.lineTo(136.0f, 179.31f);
        pathBuilder.lineToRelative(18.34f, 18.35f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, -11.32f);
        pathBuilder.close();
        pathBuilder.moveTo(232.0f, 120.0f);
        pathBuilder.lineTo(179.31f, 120.0f);
        ...
        pathBuilder.lineToRelative(32.0f, 32.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, -11.32f);
        pathBuilder.lineTo(179.31f, 136.0f);
        pathBuilder.lineTo(232.0f, 136.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(101.66f, 122.34f);
        pathBuilder.lineTo(69.66f, 90.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, 11.32f);
        pathBuilder.lineTo(76.69f, 120.0f);
        pathBuilder.lineTo(24.0f, 120.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f);
        pathBuilder.lineTo(76.69f, 136.0f);
        pathBuilder.lineTo(58.34f, 154.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, 11.32f);
        pathBuilder.lineToRelative(32.0f, -32.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 101.66f, 122.34f);
        pathBuilder.close();
