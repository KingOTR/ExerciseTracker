...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BoxArrowDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getBoxArrowDown", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_boxArrowDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BoxarrowdownKt {
    private static ImageVector _boxArrowDown;

    public static final ImageVector getBoxArrowDown(RegularGroup regularGroup) {
        ...
        pathBuilder.moveTo(223.16f, 68.42f);
        ...
        pathBuilder.lineToRelative(-16.0f, 32.0f);
        pathBuilder.arcTo(8.08f, 8.08f, 0.0f, false, false, 32.0f, 72.0f);
        pathBuilder.lineTo(32.0f, 208.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, 16.0f);
        pathBuilder.lineTo(208.0f, 224.0f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder.lineTo(224.0f, 72.0f);
        pathBuilder.arcTo(8.08f, 8.08f, 0.0f, false, false, 223.16f, 68.42f);
        pathBuilder.close();
        pathBuilder.moveTo(60.94f, 48.0f);
        pathBuilder.lineTo(195.06f, 48.0f);
        pathBuilder.lineToRelative(8.0f, 16.0f);
        pathBuilder.lineTo(52.94f, 64.0f);
        pathBuilder.close();
