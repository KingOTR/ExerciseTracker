...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MicrosoftWordLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getMicrosoftWordLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_microsoftWordLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MicrosoftwordlogoKt {
    private static ImageVector _microsoftWordLogo;

    public static final ImageVector getMicrosoftWordLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.verticalLineToRelative(48.0f);
        pathBuilder.close();
        pathBuilder.moveTo(68.24f, 153.94f);
        pathBuilder.lineTo(56.24f, 105.94f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 15.52f, -3.88f);
        pathBuilder.lineToRelative(6.76f, 27.0f);
        pathBuilder.lineToRelative(6.32f, -12.66f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 14.32f, 0.0f);
        pathBuilder.lineToRelative(6.32f, 12.66f);
        pathBuilder.lineToRelative(6.76f, -27.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 15.52f, 3.88f);
        pathBuilder.lineToRelative(-12.0f, 48.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.89f, 6.0f);
        pathBuilder.arcToRelative(8.46f, 8.46f, 0.0f, false, true, -0.87f, 0.05f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.16f, -4.42f);
        pathBuilder.lineTo(92.0f, 137.89f);
        pathBuilder.lineToRelative(-8.84f, 17.69f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.92f, -1.64f);
        pathBuilder.close();
