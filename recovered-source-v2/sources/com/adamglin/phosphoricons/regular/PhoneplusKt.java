...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PhonePlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getPhonePlus", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_phonePlus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PhoneplusKt {
    private static ImageVector _phonePlus;

    public static final ImageVector getPhonePlus(RegularGroup regularGroup) {
        ...
        pathBuilder.lineToRelative(-47.1f, -21.11f);
        pathBuilder.lineToRelative(-0.12f, -0.06f);
        ...
        pathBuilder.arcTo(128.14f, 128.14f, 0.0f, false, true, 40.0f, 88.0f);
        pathBuilder.arcTo(40.2f, 40.2f, 0.0f, false, true, 74.87f, 48.0f);
        pathBuilder.arcToRelative(0.61f, 0.61f, 0.0f, false, false, 0.0f, 0.12f);
        pathBuilder.lineToRelative(21.0f, 47.0f);
        pathBuilder.lineTo(75.2f, 119.86f);
        ...
        pathBuilder.arcToRelative(6.92f, 6.92f, 0.0f, false, false, 0.74f, -0.57f);
        pathBuilder.lineTo(160.89f, 160.0f);
        pathBuilder.lineToRelative(47.0f, 21.06f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.reflectiveCurveToRelative(0.08f, 0.0f, 0.11f, 0.0f);
        pathBuilder.arcTo(40.21f, 40.21f, 0.0f, false, true, 168.0f, 216.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 136.0f, 80.0f);
        pathBuilder.close();
