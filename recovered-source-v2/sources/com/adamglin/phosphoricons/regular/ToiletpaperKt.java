...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ToiletPaper", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getToiletPaper", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_toiletPaper", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ToiletpaperKt {
    private static ImageVector _toiletPaper;

    public static final ImageVector getToiletPaper(RegularGroup regularGroup) {
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 76.0f, 120.0f);
        pathBuilder.close();
        ...
        pathBuilder.curveToRelative(0.0f, -42.43f, -16.86f, -72.0f, -32.0f, -72.0f);
        pathBuilder.reflectiveCurveTo(32.0f, 77.57f, 32.0f, 120.0f);
        pathBuilder.reflectiveCurveToRelative(16.86f, 72.0f, 32.0f, 72.0f);
        pathBuilder.reflectiveCurveTo(96.0f, 162.43f, 96.0f, 120.0f);
        pathBuilder.close();
