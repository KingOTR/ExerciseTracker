...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TwitchLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getTwitchLogo", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_twitchLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TwitchlogoKt {
    private static ImageVector _twitchLogo;

    public static final ImageVector getTwitchLogo(RegularGroup regularGroup) {
        ...
        pathBuilder.lineTo(122.9f, 208.0f);
        pathBuilder.horizontalLineToRelative(42.2f);
        pathBuilder.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 10.25f, -3.71f);
        pathBuilder.lineToRelative(42.89f, -35.75f);
        pathBuilder.arcTo(15.93f, 15.93f, 0.0f, false, false, 224.0f, 156.25f);
        pathBuilder.lineTo(224.0f, 48.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, false, 208.0f, 32.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.0f, 156.25f);
        pathBuilder.lineTo(165.1f, 192.0f);
        pathBuilder.lineTo(120.0f, 192.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -5.12f, 1.85f);
        pathBuilder.lineTo(80.0f, 222.92f);
