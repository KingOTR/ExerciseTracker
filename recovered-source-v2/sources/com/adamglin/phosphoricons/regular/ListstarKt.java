...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListStar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/RegularGroup;", "getListStar", "(Lcom/adamglin/phosphoricons/RegularGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listStar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListstarKt {
    private static ImageVector _listStar;

    public static final ImageVector getListStar(RegularGroup regularGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(237.09f, 143.78f);
        pathBuilder.lineTo(214.57f, 162.37f);
        pathBuilder.lineTo(221.43f, 190.08f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.82f, 8.81f);
        pathBuilder.lineTo(184.0f, 183.82f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 4.47f, 14.14f);
        pathBuilder.close();
        pathBuilder.moveTo(211.62f, 144.06f);
        pathBuilder.lineTo(196.73f, 142.91f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.73f, -4.8f);
        pathBuilder.lineToRelative(-6.0f, -13.92f);
        pathBuilder.lineToRelative(-6.0f, 13.92f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.73f, 4.8f);
        pathBuilder.lineToRelative(-14.89f, 1.15f);
        pathBuilder.lineToRelative(11.11f, 9.18f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 2.68f, 8.09f);
        pathBuilder.lineToRelative(-3.5f, 14.12f);
        pathBuilder.lineToRelative(13.27f, -7.81f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.12f, 0.0f);
        pathBuilder.lineToRelative(13.27f, 7.81f);
        pathBuilder.lineToRelative(-3.5f, -14.12f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 2.68f, -8.09f);
        pathBuilder.close();
