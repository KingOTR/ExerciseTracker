...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BookUser", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBookUser", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bookUser", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BookuserKt {
    private static ImageVector _bookUser;

    public static final ImageVector getBookUser(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(40.0f, 40.0f, 0.0f, false, false, 96.0f, 72.0f);
        ...
        pathBuilder2.arcTo(39.81f, 39.81f, 0.0f, false, false, 96.0f, 192.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(224.0f, 192.0f);
        pathBuilder2.lineTo(160.0f, 192.0f);
        pathBuilder2.arcToRelative(39.81f, 39.81f, 0.0f, false, false, -24.0f, 8.0f);
        pathBuilder2.lineTo(136.0f, 112.0f);
        pathBuilder2.arcToRelative(24.0f, 24.0f, 0.0f, false, true, 24.0f, -24.0f);
        pathBuilder2.horizontalLineToRelative(64.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(89.6f, 43.19f);
        pathBuilder2.arcToRelative(48.0f, 48.0f, 0.0f, false, true, 76.8f, 0.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -12.79f, 9.62f);
        pathBuilder2.arcToRelative(32.0f, 32.0f, 0.0f, false, false, -51.22f, 0.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, true, true, 89.6f, 43.19f);
        pathBuilder2.close();
