...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PlugCharging", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPlugCharging", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_plugCharging", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PlugchargingKt {
    private static ImageVector _plugCharging;

    public static final ImageVector getPlugCharging(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineTo(96.0f, 16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder2.lineTo(80.0f, 56.0f);
        pathBuilder2.lineTo(32.55f, 56.0f);
        pathBuilder2.curveTo(26.28f, 56.0f, 24.0f, 60.78f, 24.0f, 64.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(105.42f, 132.56f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -0.91f, -7.37f);
        pathBuilder2.lineToRelative(12.0f, -32.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 15.0f, 5.62f);
        pathBuilder2.lineToRelative(-8.0f, 21.19f);
        pathBuilder2.lineTo(144.0f, 120.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.49f, 10.81f);
        pathBuilder2.lineToRelative(-12.0f, 32.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -15.0f, -5.62f);
        pathBuilder2.lineToRelative(8.0f, -21.19f);
        pathBuilder2.lineTo(112.0f, 136.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 105.42f, 132.56f);
        pathBuilder2.close();
