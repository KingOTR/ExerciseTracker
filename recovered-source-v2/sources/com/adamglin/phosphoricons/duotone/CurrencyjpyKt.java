...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CurrencyJpy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCurrencyJpy", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_currencyJpy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CurrencyjpyKt {
    private static ImageVector _currencyJpy;

    public static final ImageVector getCurrencyJpy(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineToRelative(-72.0f, 88.0f);
        ...
        pathBuilder2.moveTo(206.19f, 53.07f);
        pathBuilder2.lineTo(144.88f, 128.0f);
        ...
        pathBuilder2.horizontalLineTo(80.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
        pathBuilder2.horizontalLineToRelative(31.12f);
        pathBuilder2.lineTo(49.81f, 53.07f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 62.19f, 42.93f);
        pathBuilder2.lineTo(128.0f, 123.37f);
        pathBuilder2.lineToRelative(65.81f, -80.44f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 12.38f, 10.14f);
        pathBuilder2.close();
