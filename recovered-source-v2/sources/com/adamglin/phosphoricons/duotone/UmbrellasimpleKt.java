...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UmbrellaSimple", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getUmbrellaSimple", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_umbrellaSimple", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UmbrellasimpleKt {
    private static ImageVector _umbrellaSimple;

    public static final ImageVector getUmbrellaSimple(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcToRelative(104.37f, 104.37f, 0.0f, false, true, 207.94f, 0.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 224.0f, 136.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcTo(96.43f, 96.43f, 0.0f, false, true, 193.4f, 65.52f);
        pathBuilder2.arcTo(95.32f, 95.32f, 0.0f, false, true, 224.0f, 128.0f);
        pathBuilder2.close();
