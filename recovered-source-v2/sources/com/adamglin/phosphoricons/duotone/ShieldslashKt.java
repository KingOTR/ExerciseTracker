...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ShieldSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getShieldSlash", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_shieldSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ShieldslashKt {
    private static ImageVector _shieldSlash;

    public static final ImageVector getShieldSlash(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 40.26f, 42.0f);
        ...
        pathBuilder2.curveToRelative(1.36f, -0.37f, 31.27f, -8.78f, 57.09f, -34.72f);
        pathBuilder2.lineToRelative(14.89f, 16.38f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 11.84f, -10.76f);
        pathBuilder2.close();
        pathBuilder2.moveTo(127.99f, 223.62f);
        pathBuilder2.arcToRelative(128.48f, 128.48f, 0.0f, false, true, -38.92f, -21.81f);
        pathBuilder2.curveTo(61.82f, 179.51f, 48.0f, 149.3f, 48.0f, 112.0f);
        pathBuilder2.lineToRelative(0.0f, -56.0f);
        pathBuilder2.horizontalLineToRelative(3.71f);
        pathBuilder2.lineTo(176.41f, 193.15f);
        pathBuilder2.arcTo(129.26f, 129.26f, 0.0f, false, true, 128.0f, 223.62f);
        pathBuilder2.close();
        pathBuilder2.moveTo(224.0f, 56.0f);
        pathBuilder2.verticalLineToRelative(56.0f);
        pathBuilder2.curveToRelative(0.0f, 20.58f, -3.89f, 39.61f, -11.56f, 56.59f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, true, true, 197.86f, 162.0f);
        pathBuilder2.curveToRelative(6.73f, -14.89f, 10.14f, -31.71f, 10.14f, -50.0f);
