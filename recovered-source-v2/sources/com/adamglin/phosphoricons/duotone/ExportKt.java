...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Export", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getExport", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_export", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ExportKt {
    private static ImageVector _export;

    public static final ImageVector getExport(DuotoneGroup duotoneGroup) {
        ...
        float f = (float) 24.0d;
        ImageVector.Builder builder = new ImageVector.Builder("Export", Dp.m6303constructorimpl(f), Dp.m6303constructorimpl(f), 256.0f, 256.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 56.0f, 96.0f);
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 216.0f, 112.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(93.66f, 69.66f);
        ...
        pathBuilder2.lineToRelative(-40.0f, 40.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 93.66f, 69.66f);
        pathBuilder2.close();
