...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Playlist", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPlaylist", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_playlist", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PlaylistKt {
    private static ImageVector _playlist;

    public static final ImageVector getPlaylist(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, true, 200.0f, 192.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(247.66f, 126.3f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -10.0f, 5.36f);
        pathBuilder2.lineTo(208.0f, 122.75f);
        pathBuilder2.lineTo(208.0f, 192.0f);
        pathBuilder2.arcToRelative(32.05f, 32.05f, 0.0f, true, true, -16.0f, -27.69f);
        pathBuilder2.lineTo(192.0f, 112.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 10.3f, -7.66f);
        pathBuilder2.lineToRelative(40.0f, 12.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 247.66f, 126.3f);
        pathBuilder2.close();
        pathBuilder2.moveTo(192.0f, 192.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, true, false, -16.0f, 16.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 192.0f, 192.0f);
        pathBuilder2.close();
