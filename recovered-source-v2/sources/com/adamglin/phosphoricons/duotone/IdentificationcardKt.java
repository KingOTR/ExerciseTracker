...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"IdentificationCard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getIdentificationCard", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_identificationCard", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class IdentificationcardKt {
    private static ImageVector _identificationCard;

    public static final ImageVector getIdentificationCard(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 200.0f, 112.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(192.0f, 136.0f);
        pathBuilder2.lineTo(152.0f, 136.0f);
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 232.0f, 56.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(135.74f, 166.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -15.5f, 4.0f);
        pathBuilder2.curveToRelative(-2.63f, -10.26f, -13.06f, -18.0f, -24.25f, -18.0f);
        pathBuilder2.reflectiveCurveToRelative(-21.61f, 7.74f, -24.25f, 18.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -15.5f, -4.0f);
        pathBuilder2.arcToRelative(39.84f, 39.84f, 0.0f, false, true, 17.19f, -23.34f);
        pathBuilder2.arcToRelative(32.0f, 32.0f, 0.0f, true, true, 45.12f, 0.0f);
        pathBuilder2.arcTo(39.76f, 39.76f, 0.0f, false, true, 135.75f, 166.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(96.0f, 136.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, true, false, -16.0f, -16.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 96.0f, 136.0f);
        pathBuilder2.close();
