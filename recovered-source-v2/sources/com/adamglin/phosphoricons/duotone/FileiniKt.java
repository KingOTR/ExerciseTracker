...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileIni", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFileIni", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileIni", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FileiniKt {
    private static ImageVector _fileIni;

    public static final ImageVector getFileIni(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineTo(86.51f, 147.35f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 72.0f, 152.0f);
        pathBuilder2.verticalLineToRelative(56.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.lineTo(88.0f, 177.0f);
        pathBuilder2.lineToRelative(25.49f, 35.69f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 120.0f, 216.0f);
        pathBuilder2.arcToRelative(7.91f, 7.91f, 0.0f, false, false, 2.44f, -0.38f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 128.0f, 208.0f);
        pathBuilder2.lineTo(128.0f, 152.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 120.0f, 144.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 160.0f, 144.0f);
        pathBuilder2.close();
