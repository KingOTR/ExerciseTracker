...
/* compiled from: At.kt */
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"At", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getAt", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_at", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class AtKt {
    private static ImageVector _at;

    public static final ImageVector getAt(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.curveToRelative(21.51f, 0.0f, 44.1f, -6.48f, 60.43f, -17.33f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.86f, -13.33f);
        pathBuilder2.curveTo(166.0f, 210.38f, 146.21f, 216.0f, 128.0f, 216.0f);
        pathBuilder2.arcToRelative(88.0f, 88.0f, 0.0f, true, true, 88.0f, -88.0f);
        pathBuilder2.curveToRelative(0.0f, 26.45f, -10.88f, 32.0f, -20.0f, 32.0f);
        pathBuilder2.reflectiveCurveToRelative(-20.0f, -5.55f, -20.0f, -32.0f);
        pathBuilder2.lineTo(176.0f, 88.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(4.26f);
        pathBuilder2.arcToRelative(48.0f, 48.0f, 0.0f, true, false, 5.93f, 65.1f);
        pathBuilder2.curveToRelative(6.0f, 12.0f, 16.35f, 18.64f, 30.07f, 18.64f);
        pathBuilder2.curveToRelative(22.54f, 0.0f, 36.0f, -17.94f, 36.0f, -48.0f);
