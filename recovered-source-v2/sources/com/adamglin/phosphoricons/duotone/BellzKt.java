...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BellZ", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBellZ", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bellZ", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BellzKt {
    private static ImageVector _bellZ;

    public static final ImageVector getBellZ(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.65f, -12.44f);
        pathBuilder2.lineTo(129.05f, 104.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 6.65f, 12.44f);
        pathBuilder2.lineTo(127.0f, 136.0f);
        pathBuilder2.horizontalLineToRelative(17.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 152.0f, 144.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(221.84f, 192.0f);
        pathBuilder2.arcTo(15.8f, 15.8f, 0.0f, false, true, 208.0f, 200.0f);
        pathBuilder2.lineTo(167.19f, 200.0f);
        pathBuilder2.arcToRelative(40.0f, 40.0f, 0.0f, false, true, -78.38f, 0.0f);
