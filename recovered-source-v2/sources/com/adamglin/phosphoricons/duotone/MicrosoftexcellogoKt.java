...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MicrosoftExcelLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getMicrosoftExcelLogo", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_microsoftExcelLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MicrosoftexcellogoKt {
    private static ImageVector _microsoftExcelLogo;

    public static final ImageVector getMicrosoftExcelLogo(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(144.0f, 216.0f);
        ...
        pathBuilder2.verticalLineToRelative(48.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(65.85f, 146.88f);
        pathBuilder2.lineTo(81.59f, 128.0f);
        pathBuilder2.lineTo(65.85f, 109.12f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 12.3f, -10.24f);
        pathBuilder2.lineTo(92.0f, 115.5f);
        pathBuilder2.lineToRelative(13.85f, -16.62f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 12.3f, 10.24f);
        pathBuilder2.lineTo(102.41f, 128.0f);
        pathBuilder2.lineToRelative(15.74f, 18.88f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -12.3f, 10.24f);
        pathBuilder2.lineTo(92.0f, 140.5f);
        pathBuilder2.lineTo(78.15f, 157.12f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -12.3f, -10.24f);
        pathBuilder2.close();
