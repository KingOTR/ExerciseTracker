...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserSquare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getUserSquare", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userSquare", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsersquareKt {
    private static ImageVector _userSquare;

    public static final ImageVector getUserSquare(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(57.78f, 216.0f);
        pathBuilder.arcTo(72.0f, 72.0f, 0.0f, false, true, 128.0f, 160.0f);
        ...
        pathBuilder.arcToRelative(72.0f, 72.0f, 0.0f, false, true, 70.22f, 56.0f);
        pathBuilder.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(68.67f, 208.0f);
        pathBuilder2.arcTo(64.45f, 64.45f, 0.0f, false, true, 87.8f, 182.2f);
        pathBuilder2.arcToRelative(64.0f, 64.0f, 0.0f, false, true, 80.4f, 0.0f);
        pathBuilder2.arcTo(64.45f, 64.45f, 0.0f, false, true, 187.33f, 208.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(208.0f, 208.0f);
        pathBuilder2.horizontalLineToRelative(-3.67f);
        pathBuilder2.arcToRelative(79.87f, 79.87f, 0.0f, false, false, -46.69f, -50.29f);
        pathBuilder2.arcToRelative(48.0f, 48.0f, 0.0f, true, false, -59.28f, 0.0f);
        pathBuilder2.arcTo(79.87f, 79.87f, 0.0f, false, false, 51.67f, 208.0f);
        pathBuilder2.horizontalLineTo(48.0f);
        pathBuilder2.verticalLineTo(48.0f);
        pathBuilder2.horizontalLineTo(208.0f);
        pathBuilder2.verticalLineTo(208.0f);
