...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Spinner", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getSpinner", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_spinner", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SpinnerKt {
    private static ImageVector _spinner;

    public static final ImageVector getSpinner(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(136.0f, 32.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(173.25f, 90.75f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.66f, -2.35f);
        pathBuilder2.lineToRelative(22.63f, -22.62f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, -11.32f);
        pathBuilder2.lineTo(167.6f, 77.09f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.65f, 13.66f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(178.91f, 167.6f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.31f, 11.31f);
        pathBuilder2.lineToRelative(22.62f, 22.63f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, -11.32f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(77.09f, 167.6f);
        pathBuilder2.lineTo(54.46f, 190.22f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, 11.32f);
        pathBuilder2.lineTo(88.4f, 178.91f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 77.09f, 167.6f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 72.0f, 128.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(65.78f, 54.46f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 54.46f, 65.78f);
        pathBuilder2.lineTo(77.09f, 88.4f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 88.4f, 77.09f);
        pathBuilder2.close();
