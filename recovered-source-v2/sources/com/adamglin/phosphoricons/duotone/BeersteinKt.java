...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BeerStein", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBeerStein", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_beerStein", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BeersteinKt {
    private static ImageVector _beerStein;

    public static final ImageVector getBeerStein(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(144.0f, 96.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 144.0f, 96.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.curveToRelative(0.0f, -30.88f, 28.71f, -56.0f, 64.0f, -56.0f);
        pathBuilder2.curveToRelative(16.77f, 0.0f, 32.91f, 5.8f, 44.82f, 16.0f);
        ...
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, true, 240.0f, 112.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(57.0f, 64.0f);
        pathBuilder2.lineTo(182.62f, 64.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, false, 160.0f, 48.0f);
        pathBuilder2.lineTo(145.74f, 48.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.53f, -2.22f);
        pathBuilder2.curveTo(131.06f, 37.0f, 117.87f, 32.0f, 104.0f, 32.0f);
        pathBuilder2.curveTo(80.82f, 32.0f, 61.43f, 45.76f, 57.0f, 64.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(184.0f, 208.0f);
        pathBuilder2.lineTo(184.0f, 192.17f);
