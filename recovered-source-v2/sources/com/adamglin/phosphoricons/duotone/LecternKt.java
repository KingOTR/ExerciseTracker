...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lectern", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getLectern", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_lectern", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LecternKt {
    private static ImageVector _lectern;

    public static final ImageVector getLectern(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 64.0f, 40.0f);
        pathBuilder.horizontalLineTo(192.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.16f, 4.42f);
        pathBuilder.lineToRelative(40.0f, 80.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 232.0f, 136.0f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(246.3f, 120.84f);
        pathBuilder2.lineToRelative(-40.0f, -80.0f);
        pathBuilder2.arcTo(15.92f, 15.92f, 0.0f, false, false, 192.0f, 32.0f);
        pathBuilder2.lineTo(64.0f, 32.0f);
        pathBuilder2.arcTo(15.92f, 15.92f, 0.0f, false, false, 49.7f, 40.84f);
        pathBuilder2.lineToRelative(-40.0f, 80.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 24.0f, 144.0f);
        ...
        pathBuilder2.horizontalLineToRelative(96.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 14.31f, -23.16f);
        pathBuilder2.close();
