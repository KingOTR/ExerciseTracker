...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CodeBlock", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCodeBlock", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_codeBlock", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CodeblockKt {
    private static ImageVector _codeBlock;

    public static final ImageVector getCodeBlock(DuotoneGroup duotoneGroup) {
        Intrinsics.checkNotNullParameter(duotoneGroup, "<this>");
        ImageVector imageVector = _codeBlock;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        float f = (float) 24.0d;
        ImageVector.Builder builder = new ImageVector.Builder("CodeBlock", Dp.m6303constructorimpl(f), Dp.m6303constructorimpl(f), 256.0f, 256.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 16.0f, 96.0f);
        pathBuilder.verticalLineTo(32.0f);
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 32.0f, 16.0f);
        ...
        pathBuilder2.lineToRelative(-32.0f, -32.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 98.34f, 37.66f);
        pathBuilder2.lineTo(124.69f, 64.0f);
        pathBuilder2.lineTo(98.34f, 90.34f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 98.34f, 101.66f);
        pathBuilder2.close();
        pathBuilder2.moveTo(200.0f, 40.0f);
        pathBuilder2.lineTo(176.0f, 40.0f);
