...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ImageSquare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getImageSquare", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_imageSquare", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ImagesquareKt {
    private static ImageVector _imageSquare;

    public static final ImageVector getImageSquare(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineTo(166.34f, 106.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 0.0f);
        pathBuilder.lineTo(216.0f, 144.69f);
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 96.0f, 112.0f);
        pathBuilder.close();
        ...
        pathBuilder2.verticalLineToRelative(77.38f);
        pathBuilder2.lineToRelative(-24.69f, -24.7f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -22.62f, 0.0f);
        pathBuilder2.lineTo(53.37f, 208.0f);
        pathBuilder2.lineTo(48.0f, 208.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(208.0f, 208.0f);
        pathBuilder2.lineTo(76.0f, 208.0f);
        ...
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, true, false, 72.0f, 96.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, false, 96.0f, 120.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(96.0f, 88.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -8.0f, 8.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 96.0f, 88.0f);
        pathBuilder2.close();
