...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileCode", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFileCode", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileCode", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilecodeKt {
    private static ImageVector _fileCode;

    public static final ImageVector getFileCode(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(181.66f, 146.34f);
        ...
        pathBuilder2.lineTo(164.69f, 152.0f);
        pathBuilder2.lineToRelative(-18.35f, -18.34f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, -11.32f);
        pathBuilder2.close();
        pathBuilder2.moveTo(109.66f, 122.34f);
        ...
        pathBuilder2.lineTo(91.31f, 152.0f);
        pathBuilder2.lineToRelative(18.35f, -18.34f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 109.66f, 122.34f);
        pathBuilder2.close();
