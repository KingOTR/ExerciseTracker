...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"QuestionMark", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getQuestionMark", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_questionMark", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class QuestionmarkKt {
    private static ImageVector _questionMark;

    public static final ImageVector getQuestionMark(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.curveToRelative(0.0f, 28.51f, -24.47f, 52.11f, -56.0f, 55.56f);
        ...
        pathBuilder2.curveToRelative(26.47f, 0.0f, 48.0f, -17.94f, 48.0f, -40.0f);
        pathBuilder2.reflectiveCurveToRelative(-21.53f, -40.0f, -48.0f, -40.0f);
        pathBuilder2.reflectiveCurveTo(80.0f, 73.94f, 80.0f, 96.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.curveToRelative(0.0f, -30.88f, 28.71f, -56.0f, 64.0f, -56.0f);
        pathBuilder2.reflectiveCurveTo(192.0f, 65.12f, 192.0f, 96.0f);
        pathBuilder2.close();
