...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserCirclePlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getUserCirclePlus", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userCirclePlus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsercircleplusKt {
    private static ImageVector _userCirclePlus;

    public static final ImageVector getUserCirclePlus(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(230.56f, 110.68f);
        pathBuilder2.arcToRelative(103.92f, 103.92f, 0.0f, true, true, -85.24f, -85.24f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -2.64f, 15.78f);
        pathBuilder2.arcTo(88.07f, 88.07f, 0.0f, false, false, 40.0f, 128.0f);
        ...
        pathBuilder2.arcToRelative(79.66f, 79.66f, 0.0f, false, true, 36.06f, 28.75f);
        pathBuilder2.arcTo(87.62f, 87.62f, 0.0f, false, false, 216.0f, 128.0f);
        pathBuilder2.arcToRelative(88.85f, 88.85f, 0.0f, false, false, -1.22f, -14.68f);
        ...
        pathBuilder2.arcToRelative(87.57f, 87.57f, 0.0f, false, false, 53.92f, -18.5f);
