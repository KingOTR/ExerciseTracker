...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MathOperations", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getMathOperations", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mathOperations", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MathoperationsKt {
    private static ImageVector _mathOperations;

    public static final ImageVector getMathOperations(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(104.0f, 176.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(154.34f, 101.66f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, 0.0f);
        pathBuilder2.lineTo(184.0f, 83.31f);
        pathBuilder2.lineToRelative(18.34f, 18.35f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, -11.32f);
        pathBuilder2.lineTo(195.31f, 72.0f);
        pathBuilder2.lineToRelative(18.35f, -18.34f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, -11.32f);
        pathBuilder2.lineTo(184.0f, 60.69f);
        pathBuilder2.lineTo(165.66f, 42.34f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, 11.32f);
        pathBuilder2.lineTo(172.69f, 72.0f);
        pathBuilder2.lineTo(154.34f, 90.34f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 154.34f, 101.66f);
        pathBuilder2.close();
