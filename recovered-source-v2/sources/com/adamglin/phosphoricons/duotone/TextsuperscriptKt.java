...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TextSuperscript", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getTextSuperscript", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_textSuperscript", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TextsuperscriptKt {
    private static ImageVector _textSuperscript;

    public static final ImageVector getTextSuperscript(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 56.0f, 48.0f);
        ...
        pathBuilder2.moveTo(248.0f, 144.0f);
        ...
        pathBuilder2.lineToRelative(43.17f, -57.55f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, true, false, -27.86f, -15.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -15.09f, -5.33f);
        pathBuilder2.arcToRelative(32.0f, 32.0f, 0.0f, true, true, 55.74f, 29.92f);
        pathBuilder2.lineTo(208.0f, 136.0f);
        pathBuilder2.horizontalLineToRelative(32.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 248.0f, 144.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(149.24f, 74.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.29f, 0.8f);
        pathBuilder2.lineTo(92.0f, 127.79f);
        pathBuilder2.lineToRelative(-45.95f, -53.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 34.0f, 85.24f);
        pathBuilder2.lineTo(81.41f, 140.0f);
        pathBuilder2.lineTo(34.0f, 194.76f);
        ...
        pathBuilder2.lineTo(102.59f, 140.0f);
        pathBuilder2.lineToRelative(47.46f, -54.76f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 149.24f, 74.0f);
        pathBuilder2.close();
