...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Perspective", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPerspective", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_perspective", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PerspectiveKt {
    private static ImageVector _perspective;

    public static final ImageVector getPerspective(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -9.43f, 7.87f);
        pathBuilder.lineToRelative(-160.0f, -29.09f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 40.0f, 178.91f);
        pathBuilder.verticalLineTo(77.09f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 6.57f, -7.87f);
        pathBuilder.lineToRelative(160.0f, -29.09f);
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -18.86f, -15.74f);
        pathBuilder2.lineToRelative(-160.0f, 29.09f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 32.0f, 77.09f);
        ...
        pathBuilder2.verticalLineToRelative(42.91f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 13.14f, 15.74f);
        pathBuilder2.lineToRelative(160.0f, 29.09f);
        pathBuilder2.arcTo(16.47f, 16.47f, 0.0f, false, false, 208.0f, 224.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder2.verticalLineTo(136.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(48.0f, 77.09f);
        ...
        pathBuilder2.lineTo(48.0f, 178.91f);
        pathBuilder2.verticalLineTo(136.0f);
