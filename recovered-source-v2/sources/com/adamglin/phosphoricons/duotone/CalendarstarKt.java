...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CalendarStar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCalendarStar", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendarStar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarstarKt {
    private static ImageVector _calendarStar;

    public static final ImageVector getCalendarStar(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.moveTo(149.6f, 143.41f);
        pathBuilder.lineTo(157.67f, 176.0f);
        pathBuilder.lineTo(128.0f, 158.54f);
        pathBuilder.lineTo(98.33f, 176.0f);
        pathBuilder.lineToRelative(8.07f, -32.59f);
        pathBuilder.lineTo(80.0f, 121.61f);
        pathBuilder.lineToRelative(34.65f, -2.67f);
        pathBuilder.lineTo(128.0f, 88.0f);
        pathBuilder.lineToRelative(13.35f, 30.94f);
        pathBuilder.lineTo(176.0f, 121.61f);
        pathBuilder.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(176.62f, 113.64f);
        pathBuilder2.lineTo(146.78f, 111.33f);
        pathBuilder2.lineTo(135.35f, 84.83f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -14.7f, 0.0f);
        pathBuilder2.lineToRelative(-11.43f, 26.5f);
        pathBuilder2.lineToRelative(-29.84f, 2.31f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -4.47f, 14.14f);
        pathBuilder2.lineToRelative(22.52f, 18.59f);
        pathBuilder2.lineToRelative(-6.86f, 27.71f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.82f, 8.81f);
        pathBuilder2.lineTo(128.0f, 167.82f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -4.47f, -14.14f);
        pathBuilder2.close();
        pathBuilder2.moveTo(144.51f, 137.24f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -2.68f, 8.09f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 6.73f, -4.8f);
