...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Cpu", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCpu", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cpu", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CpuKt {
    private static ImageVector _cpu;

    public static final ImageVector getCpu(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(152.0f, 96.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.0f, -8.0f);
        pathBuilder2.lineTo(160.0f, 104.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 152.0f, 96.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(160.0f, 40.0f);
        ...
        pathBuilder2.lineTo(112.0f, 40.0f);
        pathBuilder2.lineTo(112.0f, 24.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder2.lineTo(216.0f, 160.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.verticalLineToRelative(95.87f);
        pathBuilder2.reflectiveCurveToRelative(0.0f, 0.09f, 0.0f, 0.13f);
        pathBuilder2.reflectiveCurveToRelative(0.0f, 0.09f, 0.0f, 0.13f);
