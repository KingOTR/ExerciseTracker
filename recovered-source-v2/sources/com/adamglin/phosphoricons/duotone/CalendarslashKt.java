...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CalendarSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCalendarSlash", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendarSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarslashKt {
    private static ImageVector _calendarSlash;

    public static final ImageVector getCalendarSlash(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 48.0f, 32.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(73.55f, 80.0f);
        pathBuilder2.horizontalLineTo(48.0f);
        pathBuilder2.verticalLineTo(51.88f);
        pathBuilder2.close();
        pathBuilder2.moveTo(48.0f, 208.0f);
        pathBuilder2.verticalLineTo(96.0f);
        pathBuilder2.horizontalLineTo(88.1f);
        pathBuilder2.lineTo(189.92f, 208.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(224.0f, 48.0f);
        pathBuilder2.verticalLineTo(177.23f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -16.0f, 0.0f);
        pathBuilder2.verticalLineTo(96.0f);
        pathBuilder2.horizontalLineTo(134.88f);
        ...
        pathBuilder2.verticalLineTo(48.0f);
        pathBuilder2.horizontalLineTo(91.25f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
