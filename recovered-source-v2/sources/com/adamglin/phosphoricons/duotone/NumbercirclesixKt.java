...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NumberCircleSix", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getNumberCircleSix", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_numberCircleSix", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NumbercirclesixKt {
    private static ImageVector _numberCircleSix;

    public static final ImageVector getNumberCircleSix(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.curveToRelative(-0.61f, 0.0f, -1.22f, 0.0f, -1.82f, 0.0f);
        pathBuilder2.lineTo(142.87f, 84.1f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -13.74f, -8.2f);
        pathBuilder2.lineToRelative(-32.23f, 54.0f);
        pathBuilder2.arcTo(36.0f, 36.0f, 0.0f, true, false, 128.0f, 112.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 168.0f);
        pathBuilder2.arcToRelative(20.0f, 20.0f, 0.0f, true, true, 20.0f, -20.0f);
        pathBuilder2.arcTo(20.0f, 20.0f, 0.0f, false, true, 128.0f, 168.0f);
        pathBuilder2.close();
