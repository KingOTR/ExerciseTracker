...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Briefcase", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBriefcase", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_briefcase", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BriefcaseKt {
    private static ImageVector _briefcase;

    public static final ImageVector getBriefcase(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.moveTo(224.0f, 118.31f);
        pathBuilder.verticalLineTo(200.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, 8.0f);
        pathBuilder.horizontalLineTo(40.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, -8.0f);
        pathBuilder.verticalLineTo(118.31f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.arcTo(191.14f, 191.14f, 0.0f, false, false, 128.0f, 144.0f);
        pathBuilder.arcTo(191.08f, 191.08f, 0.0f, false, false, 224.0f, 118.31f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(104.0f, 112.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 104.0f, 112.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(232.0f, 72.0f);
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 40.0f, 56.0f);
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 232.0f, 72.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.verticalLineToRelative(41.62f);
        pathBuilder2.arcTo(184.07f, 184.07f, 0.0f, false, false, 128.0f, 136.0f);
        pathBuilder2.arcToRelative(184.0f, 184.0f, 0.0f, false, false, 88.0f, -22.39f);
        pathBuilder2.verticalLineTo(72.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(216.0f, 200.0f);
        pathBuilder2.verticalLineTo(131.63f);
        pathBuilder2.arcTo(200.25f, 200.25f, 0.0f, false, true, 128.0f, 152.0f);
        pathBuilder2.arcToRelative(200.19f, 200.19f, 0.0f, false, true, -88.0f, -20.36f);
        pathBuilder2.verticalLineTo(200.0f);
