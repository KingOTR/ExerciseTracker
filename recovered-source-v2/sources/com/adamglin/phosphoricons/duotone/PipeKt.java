...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Pipe", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPipe", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pipe", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PipeKt {
    private static ImageVector _pipe;

    public static final ImageVector getPipe(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.moveTo(168.0f, 48.0f);
        ...
        pathBuilder2.lineTo(205.83f, 40.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 192.0f, 32.0f);
        pathBuilder2.lineTo(176.0f, 32.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -13.83f, 8.0f);
        pathBuilder2.lineTo(144.0f, 40.0f);
        pathBuilder2.arcTo(104.11f, 104.11f, 0.0f, false, false, 40.0f, 144.0f);
        pathBuilder2.verticalLineToRelative(18.16f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 32.0f, 176.0f);
        pathBuilder2.verticalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 8.0f, 13.84f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.lineTo(120.0f, 205.84f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 128.0f, 192.0f);
        ...
        pathBuilder2.horizontalLineToRelative(18.17f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 176.0f, 128.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 13.83f, -8.0f);
        pathBuilder2.lineTo(232.0f, 120.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(112.0f, 176.0f);
        pathBuilder2.verticalLineToRelative(16.0f);
        ...
        pathBuilder2.lineTo(56.0f, 144.0f);
        pathBuilder2.arcToRelative(88.1f, 88.1f, 0.0f, false, true, 88.0f, -88.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.verticalLineToRelative(48.0f);
        pathBuilder2.lineTo(144.0f, 104.0f);
        pathBuilder2.arcTo(40.0f, 40.0f, 0.0f, false, false, 104.0f, 144.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(176.0f, 112.0f);
        pathBuilder2.lineTo(176.0f, 48.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.verticalLineToRelative(63.8f);
