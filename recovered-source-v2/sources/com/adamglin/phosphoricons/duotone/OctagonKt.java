...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Octagon", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getOctagon", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_octagon", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class OctagonKt {
    private static ImageVector _octagon;

    public static final ImageVector getOctagon(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(227.31f, 80.24f);
        pathBuilder2.lineTo(175.76f, 28.69f);
        pathBuilder2.arcTo(15.86f, 15.86f, 0.0f, false, false, 164.45f, 24.0f);
        pathBuilder2.horizontalLineTo(91.55f);
        pathBuilder2.arcToRelative(15.86f, 15.86f, 0.0f, false, false, -11.31f, 4.69f);
        pathBuilder2.lineTo(28.69f, 80.24f);
        pathBuilder2.arcTo(15.86f, 15.86f, 0.0f, false, false, 24.0f, 91.55f);
        ...
        pathBuilder2.arcTo(15.86f, 15.86f, 0.0f, false, false, 91.55f, 232.0f);
        pathBuilder2.horizontalLineToRelative(72.9f);
        pathBuilder2.arcToRelative(15.86f, 15.86f, 0.0f, false, false, 11.31f, -4.69f);
        pathBuilder2.lineToRelative(51.55f, -51.55f);
        pathBuilder2.arcTo(15.86f, 15.86f, 0.0f, false, false, 232.0f, 164.45f);
        pathBuilder2.verticalLineTo(91.55f);
        pathBuilder2.arcTo(15.86f, 15.86f, 0.0f, false, false, 227.31f, 80.24f);
        pathBuilder2.close();
        pathBuilder2.moveTo(216.0f, 164.45f);
        pathBuilder2.lineTo(164.45f, 216.0f);
        pathBuilder2.horizontalLineTo(91.55f);
        pathBuilder2.lineTo(40.0f, 164.45f);
        pathBuilder2.verticalLineTo(91.55f);
        pathBuilder2.lineTo(91.55f, 40.0f);
        pathBuilder2.horizontalLineToRelative(72.9f);
        pathBuilder2.lineTo(216.0f, 91.55f);
        pathBuilder2.close();
