...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Spiral", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getSpiral", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_spiral", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SpiralKt {
    private static ImageVector _spiral;

    public static final ImageVector getSpiral(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcToRelative(88.0f, 88.0f, 0.0f, false, true, -88.0f, -88.0f);
        pathBuilder.arcToRelative(96.0f, 96.0f, 0.0f, false, true, 96.0f, -96.0f);
        pathBuilder.arcTo(104.0f, 104.0f, 0.0f, false, true, 240.0f, 144.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcToRelative(96.11f, 96.11f, 0.0f, false, true, -96.0f, -96.0f);
        pathBuilder2.arcTo(104.11f, 104.11f, 0.0f, false, true, 136.0f, 32.0f);
        pathBuilder2.arcTo(112.12f, 112.12f, 0.0f, false, true, 248.0f, 144.0f);
        pathBuilder2.close();
