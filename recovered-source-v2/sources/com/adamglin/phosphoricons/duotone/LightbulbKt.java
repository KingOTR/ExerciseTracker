...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lightbulb", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getLightbulb", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_lightbulb", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LightbulbKt {
    private static ImageVector _lightbulb;

    public static final ImageVector getLightbulb(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(87.59f, 87.59f, 0.0f, false, true, 40.0f, 104.49f);
        pathBuilder2.curveTo(39.74f, 56.83f, 78.26f, 17.14f, 125.88f, 16.0f);
        ...
        pathBuilder2.arcToRelative(71.65f, 71.65f, 0.0f, false, false, 27.64f, 56.3f);
        pathBuilder2.arcTo(32.0f, 32.0f, 0.0f, false, true, 96.0f, 186.0f);
        pathBuilder2.verticalLineToRelative(6.0f);
        pathBuilder2.horizontalLineToRelative(64.0f);
        pathBuilder2.verticalLineToRelative(-6.0f);
        pathBuilder2.arcToRelative(32.15f, 32.15f, 0.0f, false, true, 12.47f, -25.35f);
        pathBuilder2.arcTo(71.65f, 71.65f, 0.0f, false, false, 200.0f, 104.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(183.89f, 94.66f);
        pathBuilder2.arcToRelative(57.6f, 57.6f, 0.0f, false, false, -46.56f, -46.55f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -2.66f, 15.78f);
        pathBuilder2.curveToRelative(16.57f, 2.79f, 30.63f, 16.85f, 33.44f, 33.45f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 176.0f, 104.0f);
        pathBuilder2.arcToRelative(9.0f, 9.0f, 0.0f, false, false, 1.35f, -0.11f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 183.89f, 94.66f);
        pathBuilder2.close();
