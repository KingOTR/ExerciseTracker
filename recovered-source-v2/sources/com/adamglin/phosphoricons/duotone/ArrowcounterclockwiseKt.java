...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowCounterClockwise", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getArrowCounterClockwise", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowCounterClockwise", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowcounterclockwiseKt {
    private static ImageVector _arrowCounterClockwise;

    public static final ImageVector getArrowCounterClockwise(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcToRelative(96.0f, 96.0f, 0.0f, false, true, -94.71f, 96.0f);
        pathBuilder2.horizontalLineTo(128.0f);
        pathBuilder2.arcTo(95.38f, 95.38f, 0.0f, false, true, 62.1f, 197.8f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.0f, -11.63f);
        pathBuilder2.arcTo(80.0f, 80.0f, 0.0f, true, false, 71.43f, 71.39f);
        pathBuilder2.arcToRelative(3.07f, 3.07f, 0.0f, false, true, -0.26f, 0.25f);
        pathBuilder2.lineTo(44.59f, 96.0f);
        ...
        pathBuilder2.verticalLineTo(85.8f);
        pathBuilder2.lineTo(60.25f, 60.0f);
        pathBuilder2.arcTo(96.0f, 96.0f, 0.0f, false, true, 224.0f, 128.0f);
        pathBuilder2.close();
