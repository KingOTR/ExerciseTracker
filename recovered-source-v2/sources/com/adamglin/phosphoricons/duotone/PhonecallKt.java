...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PhoneCall", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPhoneCall", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_phoneCall", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PhonecallKt {
    private static ImageVector _phoneCall;

    public static final ImageVector getPhoneCall(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(144.27f, 45.93f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 9.8f, -5.66f);
        pathBuilder2.arcToRelative(86.22f, 86.22f, 0.0f, false, true, 61.66f, 61.66f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.66f, 9.8f);
        pathBuilder2.arcTo(8.23f, 8.23f, 0.0f, false, true, 208.0f, 112.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.73f, -5.94f);
        pathBuilder2.arcToRelative(70.35f, 70.35f, 0.0f, false, false, -50.33f, -50.33f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 144.27f, 45.93f);
        pathBuilder2.close();
        pathBuilder2.moveTo(141.94f, 87.73f);
        pathBuilder2.curveToRelative(13.79f, 3.68f, 22.65f, 12.54f, 26.33f, 26.33f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 176.0f, 120.0f);
        pathBuilder2.arcToRelative(8.23f, 8.23f, 0.0f, false, false, 2.07f, -0.27f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.66f, -9.8f);
        pathBuilder2.curveToRelative(-5.12f, -19.16f, -18.5f, -32.54f, -37.66f, -37.66f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -4.13f, 15.46f);
        pathBuilder2.close();
        pathBuilder2.moveTo(223.88f, 183.08f);
        pathBuilder2.arcTo(56.26f, 56.26f, 0.0f, false, true, 168.0f, 232.0f);
        pathBuilder2.curveTo(88.6f, 232.0f, 24.0f, 167.4f, 24.0f, 88.0f);
        pathBuilder2.arcTo(56.26f, 56.26f, 0.0f, false, true, 72.92f, 32.12f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 16.62f, 9.52f);
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 15.17f, -1.4f);
        pathBuilder2.lineToRelative(0.13f, 0.06f);
        pathBuilder2.lineToRelative(47.11f, 21.11f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 223.88f, 183.08f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcToRelative(8.44f, 8.44f, 0.0f, false, true, -0.74f, 0.56f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -15.75f, 1.14f);
        pathBuilder2.curveToRelative(-18.73f, -9.05f, -37.4f, -27.58f, -46.46f, -46.11f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 1.0f, -15.7f);
        pathBuilder2.arcToRelative(6.13f, 6.13f, 0.0f, false, true, 0.57f, -0.77f);
