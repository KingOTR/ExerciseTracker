...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Download", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getDownload", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_download", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class DownloadKt {
    private static ImageVector _download;

    public static final ImageVector getDownload(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 240.0f, 136.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(122.34f, 133.66f);
        ...
        pathBuilder2.lineTo(136.0f, 108.69f);
        pathBuilder2.lineTo(136.0f, 24.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(84.69f);
        pathBuilder2.lineTo(85.66f, 74.34f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 74.34f, 85.66f);
        pathBuilder2.close();
        pathBuilder2.moveTo(200.0f, 168.0f);
        pathBuilder2.arcToRelative(12.0f, 12.0f, 0.0f, true, false, -12.0f, 12.0f);
        pathBuilder2.arcTo(12.0f, 12.0f, 0.0f, false, false, 200.0f, 168.0f);
        pathBuilder2.close();
