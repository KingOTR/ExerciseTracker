...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Stack", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getStack", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_stack", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class StackKt {
    private static ImageVector _stack;

    public static final ImageVector getStack(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(230.91f, 172.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 228.0f, 182.91f);
        pathBuilder2.lineToRelative(-96.0f, 56.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.06f, 0.0f);
        pathBuilder2.lineToRelative(-96.0f, -56.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 36.0f, 169.09f);
        pathBuilder2.lineToRelative(92.0f, 53.65f);
        pathBuilder2.lineToRelative(92.0f, -53.65f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 230.91f, 172.0f);
        pathBuilder2.close();
