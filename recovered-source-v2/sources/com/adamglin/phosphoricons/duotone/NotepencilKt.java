...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NotePencil", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getNotePencil", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_notePencil", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NotepencilKt {
    private static ImageVector _notePencil;

    public static final ImageVector getNotePencil(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(229.66f, 58.34f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 88.0f, 128.0f);
        ...
        pathBuilder2.lineToRelative(96.0f, -96.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 229.66f, 58.34f);
        pathBuilder2.close();
        pathBuilder2.moveTo(124.69f, 152.0f);
        pathBuilder2.horizontalLineTo(104.0f);
        pathBuilder2.verticalLineTo(131.31f);
        pathBuilder2.lineToRelative(64.0f, -64.0f);
        pathBuilder2.lineTo(188.69f, 88.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(200.0f, 76.69f);
        pathBuilder2.lineTo(179.31f, 56.0f);
        pathBuilder2.lineTo(192.0f, 43.31f);
