...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileMd", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFileMd", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileMd", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilemdKt {
    private static ImageVector _fileMd;

    public static final ImageVector getFileMd(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineTo(88.0f, 177.38f);
        pathBuilder2.lineTo(74.55f, 196.59f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -13.1f, 0.0f);
        pathBuilder2.lineTo(48.0f, 177.38f);
        pathBuilder2.lineTo(48.0f, 208.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.lineTo(32.0f, 152.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 14.55f, -4.59f);
        pathBuilder2.lineTo(68.0f, 178.05f);
        pathBuilder2.lineToRelative(21.45f, -30.64f);
