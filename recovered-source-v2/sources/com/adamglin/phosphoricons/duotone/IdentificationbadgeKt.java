...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"IdentificationBadge", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getIdentificationBadge", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_identificationBadge", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class IdentificationbadgeKt {
    private static ImageVector _identificationBadge;

    public static final ImageVector getIdentificationBadge(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 200.0f, 32.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 168.0f);
        pathBuilder.arcToRelative(32.0f, 32.0f, 0.0f, true, true, 32.0f, -32.0f);
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, true, 128.0f, 168.0f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(75.19f, 198.4f);
        ...
        pathBuilder2.arcTo(67.88f, 67.88f, 0.0f, false, false, 155.0f, 165.51f);
        pathBuilder2.arcToRelative(40.0f, 40.0f, 0.0f, true, false, -53.94f, 0.0f);
        pathBuilder2.arcTo(67.88f, 67.88f, 0.0f, false, false, 73.6f, 187.2f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 75.19f, 198.4f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 112.0f);
        pathBuilder2.arcToRelative(24.0f, 24.0f, 0.0f, true, true, -24.0f, 24.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, true, 128.0f, 112.0f);
        pathBuilder2.close();
