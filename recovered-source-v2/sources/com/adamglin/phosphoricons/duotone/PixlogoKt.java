...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PixLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPixLogo", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pixLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PixlogoKt {
    private static ImageVector _pixLogo;

    public static final ImageVector getPixLogo(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(235.34f, 116.72f);
        pathBuilder2.lineTo(139.28f, 20.66f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -22.56f, 0.0f);
        pathBuilder2.lineTo(20.66f, 116.72f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 0.0f, 22.56f);
        pathBuilder2.lineToRelative(96.06f, 96.06f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 22.56f, 0.0f);
        pathBuilder2.lineToRelative(96.06f, -96.06f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 235.34f, 116.72f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(128.0f, 116.68f);
        pathBuilder2.lineTo(101.66f, 90.34f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 96.0f, 88.0f);
        pathBuilder2.lineTo(72.0f, 88.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(56.0f, 104.0f);
        pathBuilder2.lineTo(92.68f, 104.0f);
        ...
        pathBuilder2.lineTo(163.32f, 152.0f);
        pathBuilder2.lineToRelative(-24.0f, -24.0f);
        pathBuilder2.lineToRelative(24.0f, -24.0f);
