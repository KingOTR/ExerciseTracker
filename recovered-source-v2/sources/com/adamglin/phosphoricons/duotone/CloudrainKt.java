...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CloudRain", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCloudRain", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cloudRain", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CloudrainKt {
    private static ImageVector _cloudRain;

    public static final ImageVector getCloudRain(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(158.66f, 196.44f);
        pathBuilder2.lineToRelative(-32.0f, 48.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -13.32f, -8.88f);
        pathBuilder2.lineToRelative(32.0f, -48.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 13.32f, 8.88f);
        pathBuilder2.close();
        pathBuilder2.moveTo(232.0f, 92.0f);
        pathBuilder2.arcToRelative(76.08f, 76.08f, 0.0f, false, true, -76.0f, 76.0f);
        pathBuilder2.lineTo(132.28f, 168.0f);
        pathBuilder2.lineToRelative(-29.62f, 44.44f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -13.32f, -8.88f);
        pathBuilder2.lineTo(113.05f, 168.0f);
