...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CalendarHeart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCalendarHeart", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendarHeart", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarheartKt {
    private static ImageVector _calendarHeart;

    public static final ImageVector getCalendarHeart(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.curveToRelative(0.0f, 32.0f, -48.0f, 56.0f, -48.0f, 56.0f);
        pathBuilder.reflectiveCurveToRelative(-48.0f, -24.0f, -48.0f, -56.0f);
        ...
        pathBuilder2.arcToRelative(31.91f, 31.91f, 0.0f, false, false, -24.0f, 10.86f);
        pathBuilder2.arcTo(32.0f, 32.0f, 0.0f, false, false, 72.0f, 120.0f);
        pathBuilder2.curveToRelative(0.0f, 36.52f, 50.28f, 62.08f, 52.42f, 63.16f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 7.16f, 0.0f);
        pathBuilder2.curveTo(133.72f, 182.08f, 184.0f, 156.52f, 184.0f, 120.0f);
        pathBuilder2.arcTo(32.0f, 32.0f, 0.0f, false, false, 152.0f, 88.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 166.93f);
        pathBuilder2.curveToRelative(-13.79f, -7.79f, -40.0f, -26.75f, -40.0f, -46.93f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 32.0f, 0.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, true, 32.0f, 0.0f);
        pathBuilder2.curveTo(168.0f, 140.19f, 141.79f, 159.15f, 128.0f, 166.93f);
        pathBuilder2.close();
