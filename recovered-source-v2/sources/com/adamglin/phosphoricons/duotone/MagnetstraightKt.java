...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MagnetStraight", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getMagnetStraight", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_magnetStraight", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MagnetstraightKt {
    private static ImageVector _magnetStraight;

    public static final ImageVector getMagnetStraight(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 104.0f, 56.0f);
        pathBuilder.close();
        ...
        pathBuilder2.verticalLineToRelative(88.0f);
        pathBuilder2.arcToRelative(88.0f, 88.0f, 0.0f, false, false, 88.0f, 88.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(128.55f, 216.0f);
        pathBuilder2.arcTo(72.0f, 72.0f, 0.0f, false, true, 56.0f, 144.0f);
        pathBuilder2.lineTo(56.0f, 104.0f);
        pathBuilder2.lineTo(96.0f, 104.0f);
        ...
        pathBuilder2.verticalLineToRelative(39.0f);
        pathBuilder2.curveTo(200.0f, 183.0f, 168.0f, 215.71f, 128.55f, 216.0f);
        pathBuilder2.close();
