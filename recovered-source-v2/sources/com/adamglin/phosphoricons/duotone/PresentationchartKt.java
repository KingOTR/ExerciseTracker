...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PresentationChart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPresentationChart", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_presentationChart", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PresentationchartKt {
    private static ImageVector _presentationChart;

    public static final ImageVector getPresentationChart(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineTo(79.36f, 192.0f);
        pathBuilder2.lineTo(57.75f, 219.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 12.5f, 10.0f);
        pathBuilder2.lineToRelative(29.59f, -37.0f);
        pathBuilder2.horizontalLineToRelative(56.32f);
        pathBuilder2.lineToRelative(29.59f, 37.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 12.5f, -10.0f);
        pathBuilder2.lineToRelative(-21.61f, -27.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(168.0f, 88.0f);
