...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SelectionInverse", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getSelectionInverse", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_selectionInverse", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SelectioninverseKt {
    private static ImageVector _selectionInverse;

    public static final ImageVector getSelectionInverse(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineTo(42.34f, 42.34f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 48.0f, 40.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 152.0f, 216.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(40.0f, 152.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 40.0f, 152.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(72.0f, 208.0f);
        ...
        pathBuilder2.lineTo(59.31f, 48.0f);
        pathBuilder2.lineTo(208.0f, 196.69f);
        pathBuilder2.close();
