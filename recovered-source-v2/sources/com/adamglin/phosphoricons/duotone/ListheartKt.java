...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListHeart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getListHeart", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listHeart", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListheartKt {
    private static ImageVector _listHeart;

    public static final ImageVector getListHeart(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.curveTo(186.28f, 206.08f, 136.0f, 180.52f, 136.0f, 144.0f);
        pathBuilder2.arcToRelative(32.0f, 32.0f, 0.0f, false, true, 56.0f, -21.14f);
        pathBuilder2.arcTo(32.0f, 32.0f, 0.0f, false, true, 248.0f, 144.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -32.0f, 0.0f);
        pathBuilder2.curveToRelative(0.0f, 20.18f, 26.21f, 39.14f, 40.0f, 46.93f);
        pathBuilder2.curveTo(205.79f, 183.15f, 232.0f, 164.19f, 232.0f, 144.0f);
        pathBuilder2.close();
