...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CameraPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCameraPlus", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cameraPlus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CameraplusKt {
    private static ImageVector _cameraPlus;

    public static final ImageVector getCameraPlus(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineTo(93.62f, 43.56f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 100.28f, 40.0f);
        ...
        pathBuilder2.moveTo(168.0f, 136.0f);
        ...
        pathBuilder2.verticalLineToRelative(24.0f);
        pathBuilder2.horizontalLineToRelative(24.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 168.0f, 136.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, true, 48.0f, 56.0f);
        pathBuilder2.lineTo(75.72f, 56.0f);
        pathBuilder2.lineTo(87.0f, 39.12f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 100.28f, 32.0f);
        pathBuilder2.horizontalLineToRelative(55.44f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 169.0f, 39.12f);
        ...
        pathBuilder2.lineTo(155.72f, 48.0f);
        pathBuilder2.lineTo(100.28f, 48.0f);
        pathBuilder2.lineTo(86.66f, 68.44f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 80.0f, 72.0f);
