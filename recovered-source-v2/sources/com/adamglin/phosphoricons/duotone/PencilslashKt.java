...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PencilSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPencilSlash", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pencilSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PencilslashKt {
    private static ImageVector _pencilSlash;

    public static final ImageVector getPencilSlash(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(116.92f, 127.74f);
        pathBuilder2.lineTo(68.0f, 176.69f);
        pathBuilder2.lineTo(51.31f, 160.0f);
        pathBuilder2.lineToRelative(49.75f, -49.74f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(79.32f, 188.0f);
        pathBuilder2.lineToRelative(48.41f, -48.41f);
        pathBuilder2.lineToRelative(15.89f, 17.48f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(145.0f, 99.69f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, true, false, 156.31f, 111.0f);
        pathBuilder2.lineToRelative(7.69f, -7.69f);
