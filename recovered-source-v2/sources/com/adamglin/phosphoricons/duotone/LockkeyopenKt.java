...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"LockKeyOpen", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getLockKeyOpen", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_lockKeyOpen", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LockkeyopenKt {
    private static ImageVector _lockKeyOpen;

    public static final ImageVector getLockKeyOpen(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 208.0f, 88.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 160.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, true, true, 20.0f, -20.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 128.0f, 160.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcToRelative(28.0f, 28.0f, 0.0f, false, false, -8.0f, 54.83f);
        pathBuilder2.lineTo(120.0f, 184.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.lineTo(136.0f, 166.83f);
        pathBuilder2.arcTo(28.0f, 28.0f, 0.0f, false, false, 128.0f, 112.0f);
        pathBuilder2.close();
