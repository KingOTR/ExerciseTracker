...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Calendar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCalendar", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarKt {
    private static ImageVector _calendar;

    public static final ImageVector getCalendar(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineTo(96.0f, 132.94f);
        pathBuilder2.lineToRelative(-4.42f, 2.22f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.16f, -14.32f);
        pathBuilder2.lineToRelative(16.0f, -8.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 112.0f, 120.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(171.16f, 150.45f);
        ...
        pathBuilder2.lineToRelative(28.78f, -38.37f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, true, false, 145.07f, 132.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -13.85f, -8.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, true, 176.0f, 136.0f);
        pathBuilder2.arcTo(23.76f, 23.76f, 0.0f, false, true, 171.16f, 150.45f);
        pathBuilder2.close();
