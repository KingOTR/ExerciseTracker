...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Subway", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getSubway", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_subway", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SubwayKt {
    private static ImageVector _subway;

    public static final ImageVector getSubway(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(64.0f, 64.0f, 0.0f, false, false, 40.0f, 96.0f);
        pathBuilder.lineTo(40.0f, 208.0f);
        pathBuilder.lineTo(216.0f, 208.0f);
        pathBuilder.lineTo(216.0f, 96.0f);
        pathBuilder.arcTo(64.0f, 64.0f, 0.0f, false, false, 152.0f, 32.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(16.0f, 16.0f, 0.0f, false, true, 96.0f, 80.0f);
        ...
        pathBuilder2.arcTo(56.06f, 56.06f, 0.0f, false, false, 48.0f, 96.0f);
        ...
        pathBuilder2.arcTo(72.08f, 72.08f, 0.0f, false, true, 224.0f, 96.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(184.0f, 96.0f);
        pathBuilder2.verticalLineToRelative(72.0f);
        pathBuilder2.arcToRelative(24.0f, 24.0f, 0.0f, false, true, -19.29f, 23.53f);
        pathBuilder2.lineToRelative(2.45f, 4.89f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.32f, 7.16f);
        pathBuilder2.lineTo(147.06f, 192.0f);
        pathBuilder2.lineTo(108.94f, 192.0f);
        pathBuilder2.lineToRelative(-5.78f, 11.58f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.32f, -7.16f);
        pathBuilder2.lineToRelative(2.45f, -4.89f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, true, 72.0f, 168.0f);
        pathBuilder2.lineTo(72.0f, 96.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, true, 96.0f, 72.0f);
        pathBuilder2.horizontalLineToRelative(64.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, true, 184.0f, 96.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(88.0f, 96.0f);
        pathBuilder2.verticalLineToRelative(48.0f);
        pathBuilder2.horizontalLineToRelative(80.0f);
        pathBuilder2.lineTo(168.0f, 96.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, -8.0f);
        pathBuilder2.lineTo(96.0f, 88.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 88.0f, 96.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(120.0f, 160.0f);
        pathBuilder2.verticalLineToRelative(16.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.lineTo(136.0f, 160.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(96.0f, 176.0f);
        pathBuilder2.horizontalLineToRelative(8.0f);
        pathBuilder2.lineTo(104.0f, 160.0f);
        pathBuilder2.lineTo(88.0f, 160.0f);
        pathBuilder2.verticalLineToRelative(8.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 96.0f, 176.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.verticalLineToRelative(16.0f);
        pathBuilder2.horizontalLineToRelative(8.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 168.0f, 168.0f);
        pathBuilder2.close();
