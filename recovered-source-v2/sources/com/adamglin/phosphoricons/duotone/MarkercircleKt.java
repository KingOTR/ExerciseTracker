...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MarkerCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getMarkerCircle", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_markerCircle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MarkercircleKt {
    private static ImageVector _markerCircle;

    public static final ImageVector getMarkerCircle(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineToRelative(12.0f, -57.63f);
        pathBuilder.curveToRelative(1.77f, -8.49f, 13.89f, -8.49f, 15.66f, 0.0f);
        pathBuilder.lineToRelative(12.0f, 57.63f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(88.0f, 206.37f);
        pathBuilder2.lineTo(88.0f, 176.0f);
        pathBuilder2.horizontalLineToRelative(80.0f);
        pathBuilder2.verticalLineToRelative(30.37f);
        pathBuilder2.arcTo(88.38f, 88.38f, 0.0f, false, true, 88.0f, 206.37f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(118.0f, 128.0f);
        pathBuilder2.lineTo(128.0f, 80.0f);
        pathBuilder2.horizontalLineToRelative(0.0f);
        pathBuilder2.lineToRelative(10.0f, 48.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -13.61f, -15.8f);
        pathBuilder2.lineTo(143.66f, 76.74f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -31.32f, 0.0f);
        pathBuilder2.lineTo(101.61f, 128.2f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 88.0f, 144.0f);
        pathBuilder2.verticalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -16.0f, 16.0f);
