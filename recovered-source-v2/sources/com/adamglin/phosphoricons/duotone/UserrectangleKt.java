...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserRectangle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getUserRectangle", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userRectangle", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UserrectangleKt {
    private static ImageVector _userRectangle;

    public static final ImageVector getUserRectangle(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.horizontalLineTo(195.9f);
        ...
        pathBuilder.arcToRelative(72.0f, 72.0f, 0.0f, false, false, -67.9f, 48.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(72.57f, 200.0f);
        pathBuilder2.arcToRelative(64.0f, 64.0f, 0.0f, false, true, 110.86f, 0.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(216.0f, 200.0f);
        pathBuilder2.horizontalLineTo(201.33f);
        pathBuilder2.arcToRelative(80.14f, 80.14f, 0.0f, false, false, -43.69f, -42.28f);
        pathBuilder2.arcToRelative(48.0f, 48.0f, 0.0f, true, false, -59.28f, 0.0f);
        pathBuilder2.arcTo(80.14f, 80.14f, 0.0f, false, false, 54.67f, 200.0f);
        pathBuilder2.horizontalLineTo(40.0f);
        pathBuilder2.verticalLineTo(56.0f);
        pathBuilder2.horizontalLineTo(216.0f);
        pathBuilder2.verticalLineTo(200.0f);
