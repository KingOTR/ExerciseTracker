...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SealQuestion", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getSealQuestion", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sealQuestion", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealquestionKt {
    private static ImageVector _sealQuestion;

    public static final ImageVector getSealQuestion(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.curveToRelative(-11.32f, -4.68f, -30.65f, 1.42f, -39.85f, -7.78f);
        ...
        pathBuilder.curveTo(51.36f, 83.0f, 45.26f, 63.66f, 54.46f, 54.46f);
        ...
        pathBuilder2.curveToRelative(-3.56f, -1.47f, -7.63f, -5.37f, -11.57f, -9.14f);
        pathBuilder2.curveTo(146.28f, 23.51f, 138.44f, 16.0f, 128.0f, 16.0f);
        ...
        pathBuilder2.curveToRelative(-1.47f, 3.56f, -5.37f, 7.63f, -9.14f, 11.57f);
        pathBuilder2.curveTo(23.51f, 109.72f, 16.0f, 117.56f, 16.0f, 128.0f);
        ...
        pathBuilder2.curveToRelative(5.25f, 0.08f, 10.67f, 0.16f, 13.94f, 1.52f);
        pathBuilder2.curveToRelative(3.56f, 1.47f, 7.63f, 5.37f, 11.57f, 9.14f);
        pathBuilder2.curveTo(109.72f, 232.49f, 117.56f, 240.0f, 128.0f, 240.0f);
        pathBuilder2.reflectiveCurveToRelative(18.27f, -7.51f, 25.18f, -14.14f);
        pathBuilder2.curveToRelative(3.94f, -3.77f, 8.0f, -7.67f, 11.57f, -9.14f);
        ...
        pathBuilder2.curveToRelative(0.08f, -5.25f, 0.16f, -10.67f, 1.52f, -13.94f);
        pathBuilder2.curveToRelative(1.47f, -3.56f, 5.37f, -7.63f, 9.14f, -11.57f);
        pathBuilder2.curveTo(232.49f, 146.28f, 240.0f, 138.44f, 240.0f, 128.0f);
        ...
        pathBuilder2.reflectiveCurveToRelative(-9.15f, -4.92f, -14.11f, -9.69f);
        ...
        pathBuilder2.reflectiveCurveToRelative(4.92f, -9.15f, 9.69f, -14.11f);
        ...
        pathBuilder2.reflectiveCurveTo(219.08f, 137.15f, 214.31f, 142.11f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(168.0f, 108.0f);
        pathBuilder2.curveToRelative(0.0f, 17.38f, -13.76f, 31.93f, -32.0f, 35.28f);
        ...
        pathBuilder2.curveToRelative(13.23f, 0.0f, 24.0f, -9.0f, 24.0f, -20.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(-4.0f);
        pathBuilder2.curveToRelative(0.0f, -19.85f, 17.94f, -36.0f, 40.0f, -36.0f);
        pathBuilder2.reflectiveCurveTo(168.0f, 88.15f, 168.0f, 108.0f);
        pathBuilder2.close();
