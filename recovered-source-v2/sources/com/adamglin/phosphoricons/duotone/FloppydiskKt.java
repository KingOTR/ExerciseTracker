...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FloppyDisk", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFloppyDisk", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_floppyDisk", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FloppydiskKt {
    private static ImageVector _floppyDisk;

    public static final ImageVector getFloppyDisk(DuotoneGroup duotoneGroup) {
        Intrinsics.checkNotNullParameter(duotoneGroup, "<this>");
        ImageVector imageVector = _floppyDisk;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        float f = (float) 24.0d;
        ImageVector.Builder builder = new ImageVector.Builder("FloppyDisk", Dp.m6303constructorimpl(f), Dp.m6303constructorimpl(f), 256.0f, 256.0f, 0L, 0, false, 224, null);
        SolidColor solidColor = new SolidColor(ColorKt.Color(4278190080L), null);
        int m4196getButtKaPHkGw = StrokeCap.INSTANCE.m4196getButtKaPHkGw();
        int m4207getMiterLxFBmk8 = StrokeJoin.INSTANCE.m4207getMiterLxFBmk8();
        int m4126getNonZeroRgk1Os = PathFillType.INSTANCE.m4126getNonZeroRgk1Os();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(216.0f, 83.31f);
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder.horizontalLineTo(172.69f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 5.65f, 2.34f);
        pathBuilder.lineToRelative(35.32f, 35.32f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 216.0f, 83.31f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(219.31f, 72.0f);
        pathBuilder2.lineTo(184.0f, 36.69f);
        pathBuilder2.arcTo(15.86f, 15.86f, 0.0f, false, false, 172.69f, 32.0f);
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder2.lineTo(224.0f, 83.31f);
        pathBuilder2.arcTo(15.86f, 15.86f, 0.0f, false, false, 219.31f, 72.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(172.69f, 48.0f);
        pathBuilder2.lineTo(208.0f, 83.31f);
        pathBuilder2.close();
