...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Vault", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getVault", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_vault", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class VaultKt {
    private static ImageVector _vault;

    public static final ImageVector getVault(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(40.0f, 40.0f, 0.0f, false, true, 152.0f, 168.0f);
        pathBuilder.close();
        ...
        pathBuilder2.lineTo(199.32f, 120.0f);
        pathBuilder2.arcToRelative(48.0f, 48.0f, 0.0f, true, false, 0.0f, 16.0f);
        pathBuilder2.lineTo(216.0f, 136.0f);
        pathBuilder2.verticalLineToRelative(56.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(165.84f, 120.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, true, false, 0.0f, 16.0f);
        pathBuilder2.lineTo(183.0f, 136.0f);
        pathBuilder2.arcToRelative(32.0f, 32.0f, 0.0f, true, true, 0.0f, -16.0f);
        pathBuilder2.close();
