...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SmileyXEyes", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getSmileyXEyes", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_smileyXEyes", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SmileyxeyesKt {
    private static ImageVector _smileyXEyes;

    public static final ImageVector getSmileyXEyes(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(189.66f, 122.34f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 11.32f);
        pathBuilder2.lineTo(168.0f, 123.31f);
        pathBuilder2.lineToRelative(-10.34f, 10.35f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f);
        pathBuilder2.lineTo(156.69f, 112.0f);
        pathBuilder2.lineToRelative(-10.35f, -10.34f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, -11.32f);
        pathBuilder2.lineTo(168.0f, 100.69f);
        pathBuilder2.lineToRelative(10.34f, -10.35f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 11.32f);
        pathBuilder2.lineTo(179.31f, 112.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(109.66f, 101.66f);
        pathBuilder2.lineTo(99.31f, 112.0f);
        pathBuilder2.lineToRelative(10.35f, 10.34f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 11.32f);
        pathBuilder2.lineTo(88.0f, 123.31f);
        pathBuilder2.lineTo(77.66f, 133.66f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f);
        pathBuilder2.lineTo(76.69f, 112.0f);
        pathBuilder2.lineTo(66.34f, 101.66f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 77.66f, 90.34f);
        pathBuilder2.lineTo(88.0f, 100.69f);
        pathBuilder2.lineTo(98.34f, 90.34f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 11.32f);
        pathBuilder2.close();
        pathBuilder2.moveTo(140.0f, 180.0f);
        pathBuilder2.arcToRelative(12.0f, 12.0f, 0.0f, true, true, -12.0f, -12.0f);
        pathBuilder2.arcTo(12.0f, 12.0f, 0.0f, false, true, 140.0f, 180.0f);
        pathBuilder2.close();
