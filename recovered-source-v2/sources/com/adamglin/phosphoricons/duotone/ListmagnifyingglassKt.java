...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListMagnifyingGlass", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getListMagnifyingGlass", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listMagnifyingGlass", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListmagnifyingglassKt {
    private static ImageVector _listMagnifyingGlass;

    public static final ImageVector getListMagnifyingGlass(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(32.0f, 32.0f, 0.0f, false, true, 216.0f, 144.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(237.66f, 197.66f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 0.0f);
        pathBuilder2.lineTo(206.0f, 177.36f);
        pathBuilder2.arcTo(40.0f, 40.0f, 0.0f, true, true, 217.36f, 166.0f);
        pathBuilder2.lineToRelative(20.3f, 20.3f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 237.66f, 197.66f);
        pathBuilder2.close();
        pathBuilder2.moveTo(184.0f, 168.0f);
        pathBuilder2.arcToRelative(24.0f, 24.0f, 0.0f, true, false, -24.0f, -24.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, false, 184.0f, 168.0f);
        pathBuilder2.close();
