...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TwitchLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getTwitchLogo", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_twitchLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TwitchlogoKt {
    private static ImageVector _twitchLogo;

    public static final ImageVector getTwitchLogo(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.verticalLineTo(156.25f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -2.88f, 6.15f);
        pathBuilder.lineToRelative(-42.89f, 35.75f);
        pathBuilder.arcTo(8.05f, 8.05f, 0.0f, false, true, 165.1f, 200.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 13.12f, 6.15f);
        pathBuilder2.lineTo(122.9f, 208.0f);
        pathBuilder2.horizontalLineToRelative(42.2f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 10.25f, -3.71f);
        pathBuilder2.lineToRelative(42.89f, -35.75f);
        pathBuilder2.arcTo(15.93f, 15.93f, 0.0f, false, false, 224.0f, 156.25f);
        pathBuilder2.lineTo(224.0f, 48.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 208.0f, 32.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(208.0f, 156.25f);
        pathBuilder2.lineTo(165.1f, 192.0f);
        pathBuilder2.lineTo(120.0f, 192.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -5.12f, 1.85f);
        pathBuilder2.lineTo(80.0f, 222.92f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(160.0f, 136.0f);
