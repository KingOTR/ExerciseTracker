...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CloudWarning", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCloudWarning", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cloudWarning", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CloudwarningKt {
    private static ImageVector _cloudWarning;

    public static final ImageVector getCloudWarning(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.moveTo(240.0f, 127.62f);
        pathBuilder.arcToRelative(80.0f, 80.0f, 0.0f, false, true, -80.0f, 80.0f);
        pathBuilder.horizontalLineTo(72.0f);
        pathBuilder.arcTo(56.0f, 56.0f, 0.0f, true, true, 85.92f, 97.36f);
        pathBuilder.lineToRelative(0.0f, 0.1f);
        pathBuilder.arcTo(80.0f, 80.0f, 0.0f, false, true, 240.0f, 127.62f);
        pathBuilder.close();
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(172.0f, 164.0f);
        pathBuilder2.arcToRelative(12.0f, 12.0f, 0.0f, true, true, -12.0f, -12.0f);
        pathBuilder2.arcTo(12.0f, 12.0f, 0.0f, false, true, 172.0f, 164.0f);
        pathBuilder2.close();
