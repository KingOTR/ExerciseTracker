...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CellSignalSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCellSignalSlash", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cellSignalSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CellsignalslashKt {
    private static ImageVector _cellSignalSlash;

    public static final ImageVector getCellSignalSlash(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, true, false, 42.07f, 45.38f);
        pathBuilder2.lineToRelative(58.07f, 63.86f);
        pathBuilder2.lineTo(20.69f, 188.68f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 32.0f, 216.0f);
        pathBuilder2.horizontalLineTo(192.0f);
        pathBuilder2.arcToRelative(16.13f, 16.13f, 0.0f, false, false, 4.56f, -0.68f);
        pathBuilder2.lineToRelative(5.52f, 6.06f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 11.84f, -10.76f);
        pathBuilder2.close();
        pathBuilder2.moveTo(32.0f, 200.0f);
        pathBuilder2.lineToRelative(78.9f, -78.89f);
        pathBuilder2.lineTo(182.64f, 200.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.18f, 92.51f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -11.31f);
        pathBuilder2.lineToRelative(52.51f, -52.5f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, true, 208.0f, 40.0f);
        pathBuilder2.verticalLineTo(159.63f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.verticalLineTo(40.0f);
        pathBuilder2.lineTo(139.5f, 92.51f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 128.18f, 92.51f);
        pathBuilder2.close();
