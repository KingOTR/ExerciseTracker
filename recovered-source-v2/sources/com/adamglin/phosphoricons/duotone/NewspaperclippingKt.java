...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NewspaperClipping", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getNewspaperClipping", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_newspaperClipping", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NewspaperclippingKt {
    private static ImageVector _newspaperClipping;

    public static final ImageVector getNewspaperClipping(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.58f, 7.15f);
        pathBuilder2.lineTo(64.0f, 208.94f);
        pathBuilder2.lineToRelative(28.42f, 14.21f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 7.16f, 0.0f);
        pathBuilder2.lineTo(128.0f, 208.94f);
        pathBuilder2.lineToRelative(28.42f, 14.21f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 7.16f, 0.0f);
        pathBuilder2.lineTo(192.0f, 208.94f);
        pathBuilder2.lineToRelative(28.42f, 14.21f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 232.0f, 216.0f);
        pathBuilder2.lineTo(232.0f, 56.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 216.0f, 40.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(216.0f, 203.06f);
        pathBuilder2.lineTo(195.58f, 192.84f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -7.16f, 0.0f);
        pathBuilder2.lineTo(160.0f, 207.06f);
        pathBuilder2.lineToRelative(-28.42f, -14.22f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -7.16f, 0.0f);
        pathBuilder2.lineTo(96.0f, 207.06f);
        pathBuilder2.lineTo(67.58f, 192.84f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -7.16f, 0.0f);
        pathBuilder2.lineTo(40.0f, 203.06f);
        pathBuilder2.lineTo(40.0f, 56.0f);
        pathBuilder2.lineTo(216.0f, 56.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(136.0f, 112.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(136.0f, 144.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder2.horizontalLineToRelative(48.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder2.lineTo(144.0f, 152.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 136.0f, 144.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(64.0f, 168.0f);
        pathBuilder2.horizontalLineToRelative(48.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 64.0f, 168.0f);
        pathBuilder2.close();
