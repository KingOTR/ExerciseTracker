...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TextHTwo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getTextHTwo", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_textHTwo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TexthtwoKt {
    private static ImageVector _textHTwo;

    public static final ImageVector getTextHTwo(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineToRelative(43.16f, -57.56f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, true, false, -25.54f, -19.27f);
        pathBuilder2.arcToRelative(16.28f, 16.28f, 0.0f, false, false, -2.32f, 4.3f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -15.08f, -5.34f);
        pathBuilder2.arcToRelative(32.0f, 32.0f, 0.0f, true, true, 55.73f, 29.93f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.verticalLineTo(124.0f);
        pathBuilder2.horizontalLineToRelative(88.0f);
        pathBuilder2.verticalLineToRelative(52.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.verticalLineTo(56.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 144.0f, 48.0f);
        pathBuilder2.close();
