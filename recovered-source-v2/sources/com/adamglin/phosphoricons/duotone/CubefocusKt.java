...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CubeFocus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCubeFocus", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cubeFocus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CubefocusKt {
    private static ImageVector _cubeFocus;

    public static final ImageVector getCubeFocus(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(72.0f, 200.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 224.0f, 160.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 32.0f, 96.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(188.0f, 167.0f);
        pathBuilder2.lineToRelative(-56.0f, 32.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.94f, 0.0f);
        pathBuilder2.lineTo(68.0f, 167.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 64.0f, 160.0f);
        pathBuilder2.lineTo(64.0f, 96.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 4.0f, -7.0f);
        pathBuilder2.lineToRelative(56.0f, -32.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.94f, 0.0f);
        pathBuilder2.lineToRelative(56.0f, 32.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 4.0f, 7.0f);
        pathBuilder2.verticalLineToRelative(64.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 188.0f, 167.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(88.12f, 96.0f);
        pathBuilder2.lineTo(128.0f, 118.79f);
        pathBuilder2.lineTo(167.88f, 96.0f);
        pathBuilder2.lineTo(128.0f, 73.21f);
        pathBuilder2.close();
        pathBuilder2.moveTo(80.0f, 155.36f);
        pathBuilder2.lineToRelative(40.0f, 22.85f);
        pathBuilder2.lineTo(120.0f, 132.64f);
        pathBuilder2.lineTo(80.0f, 109.79f);
        pathBuilder2.close();
        pathBuilder2.moveTo(176.0f, 155.36f);
        pathBuilder2.lineTo(176.0f, 109.79f);
        pathBuilder2.lineToRelative(-40.0f, 22.85f);
        pathBuilder2.verticalLineToRelative(45.57f);
        pathBuilder2.close();
