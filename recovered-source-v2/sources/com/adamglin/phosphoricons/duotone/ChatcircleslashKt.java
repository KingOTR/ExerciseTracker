...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ChatCircleSlash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getChatCircleSlash", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_chatCircleSlash", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ChatcircleslashKt {
    private static ImageVector _chatCircleSlash;

    public static final ImageVector getChatCircleSlash(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineTo(52.33f, 56.66f);
        pathBuilder2.arcTo(104.06f, 104.06f, 0.0f, false, false, 36.18f, 176.88f);
        ...
        pathBuilder2.arcToRelative(104.0f, 104.0f, 0.0f, false, false, 112.7f, -9.73f);
        pathBuilder2.lineToRelative(10.26f, 11.29f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -6.54f, -0.66f);
        ...
        pathBuilder2.arcTo(88.0f, 88.0f, 0.0f, false, true, 63.14f, 68.54f);
        pathBuilder2.lineTo(181.0f, 198.23f);
        pathBuilder2.arcTo(87.77f, 87.77f, 0.0f, false, true, 128.0f, 216.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(232.0f, 128.0f);
        pathBuilder2.arcToRelative(104.15f, 104.15f, 0.0f, false, true, -12.38f, 49.25f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.09f, -7.58f);
        pathBuilder2.arcTo(88.0f, 88.0f, 0.0f, false, false, 93.88f, 46.86f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.21f, -14.75f);
        pathBuilder2.arcTo(104.06f, 104.06f, 0.0f, false, true, 232.0f, 128.0f);
        pathBuilder2.close();
