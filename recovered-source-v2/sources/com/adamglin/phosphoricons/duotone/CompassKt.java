...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Compass", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCompass", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_compass", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CompassKt {
    private static ImageVector _compass;

    public static final ImageVector getCompass(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(172.42f, 72.84f);
        pathBuilder2.lineToRelative(-64.0f, 32.0f);
        pathBuilder2.arcToRelative(8.05f, 8.05f, 0.0f, false, false, -3.58f, 3.58f);
        pathBuilder2.lineToRelative(-32.0f, 64.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 80.0f, 184.0f);
        pathBuilder2.arcToRelative(8.1f, 8.1f, 0.0f, false, false, 3.58f, -0.84f);
        pathBuilder2.lineToRelative(64.0f, -32.0f);
        pathBuilder2.arcToRelative(8.05f, 8.05f, 0.0f, false, false, 3.58f, -3.58f);
        pathBuilder2.lineToRelative(32.0f, -64.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -10.74f, -10.74f);
        pathBuilder2.close();
        pathBuilder2.moveTo(138.0f, 138.0f);
        pathBuilder2.lineTo(97.89f, 158.11f);
        pathBuilder2.lineTo(118.0f, 118.0f);
        pathBuilder2.lineToRelative(40.15f, -20.07f);
        pathBuilder2.close();
