...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileVideo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFileVideo", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileVideo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilevideoKt {
    private static ImageVector _fileVideo;

    public static final ImageVector getFileVideo(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineToRelative(32.0f, 20.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(155.88f, 145.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.12f, 0.22f);
        pathBuilder2.lineToRelative(-19.95f, 12.46f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 112.0f, 144.0f);
        pathBuilder2.lineTo(48.0f, 144.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -16.0f, 16.0f);
        pathBuilder2.verticalLineToRelative(48.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, 16.0f);
        pathBuilder2.horizontalLineToRelative(64.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 15.81f, -13.68f);
        pathBuilder2.lineToRelative(19.95f, 12.46f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 160.0f, 216.0f);
        pathBuilder2.lineTo(160.0f, 152.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 155.88f, 145.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(112.0f, 208.0f);
        pathBuilder2.lineTo(48.0f, 208.0f);
        pathBuilder2.lineTo(48.0f, 160.0f);
        pathBuilder2.horizontalLineToRelative(64.0f);
        pathBuilder2.verticalLineToRelative(48.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(144.0f, 201.57f);
        pathBuilder2.lineTo(128.0f, 191.57f);
        pathBuilder2.lineTo(128.0f, 176.43f);
        pathBuilder2.lineToRelative(16.0f, -10.0f);
        pathBuilder2.close();
