...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Church", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getChurch", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_church", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ChurchKt {
    private static ImageVector _church;

    public static final ImageVector getChurch(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(32.0f, 216.0f);
        ...
        pathBuilder2.moveTo(228.12f, 145.14f);
        pathBuilder2.lineTo(192.0f, 123.47f);
        pathBuilder2.lineTo(192.0f, 104.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -4.0f, -7.0f);
        pathBuilder2.lineTo(136.0f, 67.36f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.lineTo(120.0f, 67.36f);
        pathBuilder2.lineTo(68.0f, 97.05f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -4.0f, 7.0f);
        pathBuilder2.verticalLineToRelative(19.47f);
        pathBuilder2.lineTo(27.88f, 145.14f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 24.0f, 152.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 228.12f, 145.14f);
        pathBuilder2.close();
        pathBuilder2.moveTo(40.0f, 156.53f);
        pathBuilder2.lineToRelative(24.0f, -14.4f);
        ...
        pathBuilder2.lineTo(80.0f, 108.64f);
        pathBuilder2.lineToRelative(48.0f, -27.43f);
        pathBuilder2.lineToRelative(48.0f, 27.43f);
        pathBuilder2.lineTo(176.0f, 208.0f);
        pathBuilder2.lineTo(152.0f, 208.0f);
        pathBuilder2.lineTo(152.0f, 168.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, false, 128.0f, 144.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(216.0f, 208.0f);
        pathBuilder2.lineTo(192.0f, 208.0f);
        pathBuilder2.lineTo(192.0f, 142.13f);
        pathBuilder2.lineToRelative(24.0f, 14.4f);
        pathBuilder2.close();
