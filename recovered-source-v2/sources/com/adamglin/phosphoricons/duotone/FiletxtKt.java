...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileTxt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFileTxt", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileTxt", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FiletxtKt {
    private static ImageVector _fileTxt;

    public static final ImageVector getFileTxt(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(154.51f, 156.65f);
        pathBuilder2.lineTo(137.83f, 180.0f);
        pathBuilder2.lineToRelative(16.68f, 23.35f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -13.0f, 9.3f);
        pathBuilder2.lineTo(128.0f, 193.76f);
        pathBuilder2.lineToRelative(-13.49f, 18.89f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -13.0f, -9.3f);
        pathBuilder2.lineTo(118.17f, 180.0f);
        pathBuilder2.lineToRelative(-16.68f, -23.35f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 13.0f, -9.3f);
        pathBuilder2.lineTo(128.0f, 166.24f);
        pathBuilder2.lineToRelative(13.49f, -18.89f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 13.0f, 9.3f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(84.0f, 144.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 92.0f, 152.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(220.0f, 152.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, 8.0f);
        pathBuilder2.lineTo(200.0f, 160.0f);
        pathBuilder2.verticalLineToRelative(48.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.lineTo(184.0f, 160.0f);
        pathBuilder2.lineTo(172.0f, 160.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f);
        pathBuilder2.horizontalLineToRelative(40.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 220.0f, 152.0f);
        pathBuilder2.close();
