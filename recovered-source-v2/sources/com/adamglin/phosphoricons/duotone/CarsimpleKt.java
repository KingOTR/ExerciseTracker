...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CarSimple", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCarSimple", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_carSimple", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CarsimpleKt {
    private static ImageVector _carSimple;

    public static final ImageVector getCarSimple(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineTo(61.89f, 44.75f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 69.2f, 40.0f);
        pathBuilder.horizontalLineTo(186.8f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.31f, 4.75f);
        pathBuilder.close();
        ...
        pathBuilder2.horizontalLineTo(186.8f);
        pathBuilder2.lineToRelative(24.89f, 56.0f);
        pathBuilder2.horizontalLineTo(44.31f);
        pathBuilder2.close();
