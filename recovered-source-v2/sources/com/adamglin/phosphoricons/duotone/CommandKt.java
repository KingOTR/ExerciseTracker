...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Command", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getCommand", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_command", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CommandKt {
    private static ImageVector _command;

    public static final ImageVector getCommand(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, true, 28.0f, -28.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 208.0f, 76.0f);
        pathBuilder.close();
        pathBuilder.moveTo(76.0f, 48.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 48.0f, 76.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, false, 28.0f, 28.0f);
        pathBuilder.horizontalLineToRelative(28.0f);
        pathBuilder.verticalLineTo(76.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 76.0f, 48.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 48.0f, 180.0f);
        pathBuilder.close();
        ...
        pathBuilder2.lineTo(160.0f, 144.0f);
        ...
        pathBuilder2.arcTo(20.0f, 20.0f, 0.0f, false, true, 56.0f, 76.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcToRelative(20.0f, 20.0f, 0.0f, false, true, -20.0f, -20.0f);
