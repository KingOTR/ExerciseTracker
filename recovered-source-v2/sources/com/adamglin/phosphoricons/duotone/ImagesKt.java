...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Images", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getImages", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_images", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ImagesKt {
    private static ImageVector _images;

    public static final ImageVector getImages(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.verticalLineToRelative(82.06f);
        pathBuilder.lineToRelative(-23.72f, -23.72f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.31f, 0.0f);
        pathBuilder.lineTo(163.31f, 140.0f);
        pathBuilder.lineTo(113.66f, 90.34f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, 0.0f);
        pathBuilder.lineTo(64.0f, 128.69f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(72.0f, 56.0f);
        pathBuilder2.lineTo(216.0f, 56.0f);
        pathBuilder2.verticalLineToRelative(62.75f);
        pathBuilder2.lineToRelative(-10.07f, -10.06f);
        ...
        pathBuilder2.lineTo(72.0f, 109.37f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(72.0f, 132.0f);
        pathBuilder2.lineToRelative(36.0f, -36.0f);
        pathBuilder2.lineToRelative(49.66f, 49.66f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.31f, 0.0f);
        pathBuilder2.lineTo(194.63f, 120.0f);
        pathBuilder2.lineTo(216.0f, 141.38f);
        pathBuilder2.lineTo(216.0f, 168.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(160.0f, 84.0f);
        pathBuilder2.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, 12.0f);
        pathBuilder2.arcTo(12.0f, 12.0f, 0.0f, false, true, 160.0f, 84.0f);
        pathBuilder2.close();
