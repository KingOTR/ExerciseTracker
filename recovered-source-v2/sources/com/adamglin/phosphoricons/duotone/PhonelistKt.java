...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PhoneList", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPhoneList", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_phoneList", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PhonelistKt {
    private static ImageVector _phoneList;

    public static final ImageVector getPhoneList(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(214.36f, 166.46f);
        pathBuilder2.lineToRelative(-47.1f, -21.11f);
        pathBuilder2.lineToRelative(-0.12f, -0.06f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -15.18f, 1.4f);
        pathBuilder2.arcToRelative(8.12f, 8.12f, 0.0f, false, false, -0.75f, 0.56f);
        pathBuilder2.lineTo(126.87f, 168.0f);
        ...
        pathBuilder2.lineTo(89.54f, 41.64f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -16.62f, -9.52f);
        pathBuilder2.arcTo(56.26f, 56.26f, 0.0f, false, false, 24.0f, 88.0f);
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 214.36f, 166.46f);
        pathBuilder2.close();
        pathBuilder2.moveTo(168.0f, 216.0f);
        pathBuilder2.arcTo(128.14f, 128.14f, 0.0f, false, true, 40.0f, 88.0f);
        pathBuilder2.arcTo(40.2f, 40.2f, 0.0f, false, true, 74.87f, 48.0f);
        pathBuilder2.arcToRelative(0.61f, 0.61f, 0.0f, false, false, 0.0f, 0.12f);
        pathBuilder2.lineToRelative(21.0f, 47.0f);
        pathBuilder2.lineTo(75.2f, 119.86f);
        ...
        pathBuilder2.arcToRelative(6.92f, 6.92f, 0.0f, false, false, 0.74f, -0.57f);
        pathBuilder2.lineTo(160.89f, 160.0f);
        pathBuilder2.lineToRelative(47.0f, 21.06f);
        pathBuilder2.horizontalLineToRelative(0.0f);
        pathBuilder2.reflectiveCurveToRelative(0.08f, 0.0f, 0.11f, 0.0f);
        pathBuilder2.arcTo(40.21f, 40.21f, 0.0f, false, true, 168.0f, 216.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(136.0f, 64.0f);
        ...
        pathBuilder2.lineTo(144.0f, 72.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 136.0f, 64.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(136.0f, 104.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder2.horizontalLineToRelative(64.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder2.lineTo(144.0f, 112.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 136.0f, 104.0f);
        pathBuilder2.close();
