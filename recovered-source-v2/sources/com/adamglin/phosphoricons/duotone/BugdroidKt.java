...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BugDroid", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBugDroid", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bugDroid", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BugdroidKt {
    private static ImageVector _bugDroid;

    public static final ImageVector getBugDroid(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(191.83f, 51.48f);
        pathBuilder2.lineToRelative(13.83f, -13.82f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, -11.32f);
        pathBuilder2.lineTo(179.79f, 40.9f);
        pathBuilder2.arcToRelative(87.81f, 87.81f, 0.0f, false, false, -103.58f, 0.0f);
        pathBuilder2.lineTo(61.66f, 26.34f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 50.34f, 37.66f);
        pathBuilder2.lineTo(64.17f, 51.48f);
        pathBuilder2.arcTo(87.72f, 87.72f, 0.0f, false, false, 40.0f, 112.0f);
        ...
        pathBuilder2.arcTo(87.72f, 87.72f, 0.0f, false, false, 191.83f, 51.48f);
        pathBuilder2.close();
        ...
        pathBuilder2.verticalLineToRelative(-8.0f);
        pathBuilder2.arcTo(72.08f, 72.08f, 0.0f, false, true, 128.0f, 40.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(88.0f, 92.0f);
        pathBuilder2.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, 12.0f);
        pathBuilder2.arcTo(12.0f, 12.0f, 0.0f, false, true, 88.0f, 92.0f);
        pathBuilder2.close();
