...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SealPercent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getSealPercent", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sealPercent", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealpercentKt {
    private static ImageVector _sealPercent;

    public static final ImageVector getSealPercent(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.curveToRelative(-4.68f, 11.32f, 1.42f, 30.65f, -7.78f, 39.85f);
        ...
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, false, 120.0f, 96.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcToRelative(24.0f, 24.0f, 0.0f, true, false, 24.0f, 24.0f);
        pathBuilder2.arcTo(24.0f, 24.0f, 0.0f, false, false, 160.0f, 136.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(160.0f, 168.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 8.0f, -8.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 160.0f, 168.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(173.66f, 93.66f);
        pathBuilder2.lineTo(93.66f, 173.66f);
