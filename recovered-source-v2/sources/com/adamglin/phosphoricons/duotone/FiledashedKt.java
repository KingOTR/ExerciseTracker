...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileDashed", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFileDashed", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileDashed", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FiledashedKt {
    private static ImageVector _fileDashed;

    public static final ImageVector getFileDashed(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(80.0f, 224.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 80.0f, 224.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(80.0f, 24.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 208.0f, 168.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(48.0f, 152.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.0f, -8.0f);
        pathBuilder2.lineTo(56.0f, 104.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(40.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 48.0f, 152.0f);
        pathBuilder2.close();
