...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TagChevron", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getTagChevron", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_tagChevron", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TagchevronKt {
    private static ImageVector _tagChevron;

    public static final ImageVector getTagChevron(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.lineTo(201.0f, 55.12f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 187.72f, 48.0f);
        pathBuilder2.horizontalLineTo(32.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -6.66f, 12.44f);
        pathBuilder2.lineTo(70.39f, 128.0f);
        pathBuilder2.lineToRelative(-45.0f, 67.56f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 32.0f, 208.0f);
        ...
        pathBuilder2.horizontalLineTo(47.0f);
        pathBuilder2.lineToRelative(39.71f, -59.56f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -8.88f);
        pathBuilder2.lineTo(47.0f, 64.0f);
        pathBuilder2.horizontalLineTo(187.72f);
        pathBuilder2.lineToRelative(42.67f, 64.0f);
        pathBuilder2.close();
