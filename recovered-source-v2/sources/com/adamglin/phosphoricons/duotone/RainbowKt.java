...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Rainbow", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getRainbow", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_rainbow", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RainbowKt {
    private static ImageVector _rainbow;

    public static final ImageVector getRainbow(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.verticalLineTo(168.0f);
        pathBuilder.arcToRelative(112.0f, 112.0f, 0.0f, false, true, 224.0f, 0.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcTo(88.1f, 88.1f, 0.0f, false, false, 128.0f, 80.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 48.0f);
        pathBuilder2.arcTo(120.13f, 120.13f, 0.0f, false, false, 8.0f, 168.0f);
        pathBuilder2.verticalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.lineTo(24.0f, 168.0f);
        pathBuilder2.arcToRelative(104.0f, 104.0f, 0.0f, false, true, 208.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.lineTo(248.0f, 168.0f);
        pathBuilder2.arcTo(120.13f, 120.13f, 0.0f, false, false, 128.0f, 48.0f);
        pathBuilder2.close();
