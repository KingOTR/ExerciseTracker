...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Funnel", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFunnel", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_funnel", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FunnelKt {
    private static ImageVector _funnel;

    public static final ImageVector getFunnel(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(230.6f, 49.53f);
        pathBuilder2.arcTo(15.81f, 15.81f, 0.0f, false, false, 216.0f, 40.0f);
        ...
        pathBuilder2.lineToRelative(67.74f, -72.32f);
        pathBuilder2.lineToRelative(0.08f, -0.09f);
        pathBuilder2.arcTo(15.8f, 15.8f, 0.0f, false, false, 230.6f, 49.53f);
        pathBuilder2.close();
        pathBuilder2.moveTo(40.0f, 56.0f);
        pathBuilder2.horizontalLineToRelative(0.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(146.18f, 130.58f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -2.16f, -5.47f);
