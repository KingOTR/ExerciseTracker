...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Mailbox", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getMailbox", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mailbox", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MailboxKt {
    private static ImageVector _mailbox;

    public static final ImageVector getMailbox(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(52.0f, 52.0f, 0.0f, false, false, 76.0f, 64.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 104.0f, 152.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(240.0f, 116.0f);
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, true, -16.0f, -16.0f);
        pathBuilder2.lineTo(16.0f, 116.0f);
        pathBuilder2.arcTo(60.07f, 60.07f, 0.0f, false, true, 76.0f, 56.0f);
        pathBuilder2.horizontalLineToRelative(76.0f);
        ...
        pathBuilder2.arcTo(60.07f, 60.07f, 0.0f, false, true, 240.0f, 116.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(120.0f, 176.0f);
        pathBuilder2.lineTo(120.0f, 116.0f);
        pathBuilder2.arcToRelative(44.0f, 44.0f, 0.0f, false, false, -88.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(60.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(224.0f, 116.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.lineTo(152.0f, 72.0f);
        pathBuilder2.lineTo(116.75f, 72.0f);
        pathBuilder2.arcTo(59.86f, 59.86f, 0.0f, false, true, 136.0f, 116.0f);
        pathBuilder2.verticalLineToRelative(60.0f);
