...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BellSimpleRinging", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBellSimpleRinging", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bellSimpleRinging", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BellsimpleringingKt {
    private static ImageVector _bellSimpleRinging;

    public static final ImageVector getBellSimpleRinging(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(227.39f, 60.32f);
        pathBuilder2.arcToRelative(111.36f, 111.36f, 0.0f, false, false, -39.12f, -43.08f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -8.54f, 13.53f);
        pathBuilder2.arcToRelative(94.13f, 94.13f, 0.0f, false, true, 33.46f, 36.91f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 14.2f, -7.36f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, false, -8.54f, -13.53f);
        pathBuilder2.arcTo(111.36f, 111.36f, 0.0f, false, false, 28.61f, 60.32f);
