...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MouseScroll", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getMouseScroll", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mouseScroll", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MousescrollKt {
    private static ImageVector _mouseScroll;

    public static final ImageVector getMouseScroll(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(56.0f, 56.0f, 0.0f, false, true, 200.0f, 80.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcToRelative(48.05f, 48.05f, 0.0f, false, true, 48.0f, 48.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(136.0f, 83.31f);
        pathBuilder2.verticalLineToRelative(89.38f);
        ...
        pathBuilder2.lineToRelative(-24.0f, -24.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, -11.32f);
        pathBuilder2.lineTo(120.0f, 172.69f);
        pathBuilder2.lineTo(120.0f, 83.31f);
        pathBuilder2.lineTo(109.66f, 93.66f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 98.34f, 82.34f);
        pathBuilder2.lineToRelative(24.0f, -24.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 0.0f);
        pathBuilder2.lineToRelative(24.0f, 24.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 11.32f);
