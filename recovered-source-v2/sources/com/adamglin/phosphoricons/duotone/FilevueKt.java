...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileVue", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFileVue", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileVue", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilevueKt {
    private static ImageVector _fileVue;

    public static final ImageVector getFileVue(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(87.54f, 154.69f);
        ...
        pathBuilder2.lineTo(60.0f, 184.21f);
        pathBuilder2.lineToRelative(12.47f, -34.9f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 15.07f, 5.38f);
        pathBuilder2.close();
        pathBuilder2.moveTo(208.0f, 160.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.lineTo(176.0f, 144.0f);
        ...
        pathBuilder2.lineTo(184.0f, 188.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.lineTo(184.0f, 172.0f);
        pathBuilder2.lineTo(184.0f, 160.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(144.0f, 144.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, 8.0f);
        pathBuilder2.verticalLineToRelative(38.0f);
        pathBuilder2.arcToRelative(10.0f, 10.0f, 0.0f, false, true, -20.0f, 0.0f);
        pathBuilder2.lineTo(116.0f, 152.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(38.0f);
        pathBuilder2.arcToRelative(26.0f, 26.0f, 0.0f, false, false, 52.0f, 0.0f);
        pathBuilder2.lineTo(152.0f, 152.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 144.0f, 144.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(188.69f, 80.0f);
