...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Jeep", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getJeep", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_jeep", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class JeepKt {
    private static ImageVector _jeep;

    public static final ImageVector getJeep(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.lineTo(42.65f, 46.32f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 50.47f, 40.0f);
        pathBuilder.horizontalLineTo(205.53f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.82f, 6.32f);
        pathBuilder.close();
        ...
        pathBuilder2.horizontalLineToRelative(-9.53f);
        pathBuilder2.lineToRelative(-9.29f, -43.35f);
        pathBuilder2.arcTo(16.08f, 16.08f, 0.0f, false, false, 205.53f, 32.0f);
        pathBuilder2.lineTo(50.47f, 32.0f);
        pathBuilder2.arcTo(16.08f, 16.08f, 0.0f, false, false, 34.82f, 44.65f);
        pathBuilder2.lineTo(25.53f, 88.0f);
        ...
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder2.lineTo(232.0f, 104.0f);
        pathBuilder2.horizontalLineToRelative(8.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(50.47f, 48.0f);
        pathBuilder2.lineTo(205.53f, 48.0f);
        pathBuilder2.lineToRelative(8.57f, 40.0f);
        pathBuilder2.lineTo(41.9f, 88.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.verticalLineToRelative(24.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(216.0f, 160.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(56.0f, 132.0f);
        pathBuilder2.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, 12.0f);
        pathBuilder2.arcTo(12.0f, 12.0f, 0.0f, false, true, 56.0f, 132.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(176.0f, 132.0f);
        pathBuilder2.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, 12.0f);
        pathBuilder2.arcTo(12.0f, 12.0f, 0.0f, false, true, 176.0f, 132.0f);
        pathBuilder2.close();
