...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MicrosoftPowerpointLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getMicrosoftPowerpointLogo", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_microsoftPowerpointLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MicrosoftpowerpointlogoKt {
    private static ImageVector _microsoftPowerpointLogo;

    public static final ImageVector getMicrosoftPowerpointLogo(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(136.0f, 24.0f);
        pathBuilder2.arcTo(104.33f, 104.33f, 0.0f, false, false, 54.0f, 64.0f);
        ...
        pathBuilder2.lineTo(54.0f, 192.0f);
        pathBuilder2.arcTo(104.0f, 104.0f, 0.0f, true, false, 136.0f, 24.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(223.63f, 120.0f);
        pathBuilder2.lineTo(160.0f, 120.0f);
        pathBuilder2.lineTo(160.0f, 80.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -16.0f, -16.0f);
        pathBuilder2.lineTo(144.0f, 40.37f);
        pathBuilder2.arcTo(88.13f, 88.13f, 0.0f, false, true, 223.63f, 120.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 40.37f);
        pathBuilder2.lineTo(128.0f, 64.0f);
        pathBuilder2.lineTo(75.63f, 64.0f);
        pathBuilder2.arcTo(88.36f, 88.36f, 0.0f, false, true, 128.0f, 40.37f);
        pathBuilder2.close();
        pathBuilder2.moveTo(40.0f, 80.0f);
        pathBuilder2.lineTo(144.0f, 80.0f);
        pathBuilder2.verticalLineToRelative(47.9f);
        pathBuilder2.arcToRelative(0.51f, 0.51f, 0.0f, false, false, 0.0f, 0.2f);
        pathBuilder2.lineTo(144.0f, 176.0f);
        pathBuilder2.lineTo(40.0f, 176.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 192.0f);
        pathBuilder2.verticalLineToRelative(23.63f);
        pathBuilder2.arcTo(88.36f, 88.36f, 0.0f, false, true, 75.63f, 192.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(144.0f, 215.63f);
        pathBuilder2.lineTo(144.0f, 192.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f);
        pathBuilder2.lineTo(160.0f, 136.0f);
        pathBuilder2.horizontalLineToRelative(63.63f);
        pathBuilder2.arcTo(88.13f, 88.13f, 0.0f, false, true, 144.0f, 215.63f);
        pathBuilder2.close();
