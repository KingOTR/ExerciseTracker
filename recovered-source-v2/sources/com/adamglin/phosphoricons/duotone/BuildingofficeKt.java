...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BuildingOffice", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBuildingOffice", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_buildingOffice", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BuildingofficeKt {
    private static ImageVector _buildingOffice;

    public static final ImageVector getBuildingOffice(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.moveTo(176.0f, 40.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f);
        pathBuilder2.lineTo(248.0f, 224.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(168.0f, 208.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(72.0f, 80.0f);
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 72.0f, 80.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(120.0f, 80.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder2.horizontalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder2.lineTo(128.0f, 88.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 120.0f, 80.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(72.0f, 120.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder2.lineTo(96.0f, 112.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f);
        pathBuilder2.lineTo(80.0f, 128.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 72.0f, 120.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 120.0f, 120.0f);
        pathBuilder2.close();
