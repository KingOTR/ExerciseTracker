...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandArrowUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getHandArrowUp", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handArrowUp", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandarrowupKt {
    private static ImageVector _handArrowUp;

    public static final ImageVector getHandArrowUp(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcToRelative(7.35f, 7.35f, 0.0f, false, false, 1.2f, -0.4f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(154.34f, 61.66f);
        ...
        pathBuilder2.lineTo(200.0f, 43.31f);
        pathBuilder2.lineTo(200.0f, 104.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.lineTo(184.0f, 43.31f);
        pathBuilder2.lineTo(165.66f, 61.66f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 154.34f, 61.66f);
        pathBuilder2.close();
