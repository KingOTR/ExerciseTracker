...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Bank", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBank", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bank", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BankKt {
    private static ImageVector _bank;

    public static final ImageVector getBank(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 4.19f, -14.81f);
        pathBuilder2.lineToRelative(-104.0f, -64.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.38f, 0.0f);
        pathBuilder2.lineToRelative(-104.0f, 64.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 24.0f, 104.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 41.39f);
        pathBuilder2.lineTo(203.74f, 88.0f);
        pathBuilder2.lineTo(52.26f, 88.0f);
        pathBuilder2.close();
