...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Star", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getStar", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_star", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class StarKt {
    private static ImageVector _star;

    public static final ImageVector getStar(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.moveTo(229.06f, 108.79f);
        ...
        pathBuilder.lineTo(128.0f, 189.09f);
        ...
        pathBuilder.arcToRelative(8.36f, 8.36f, 0.0f, false, true, 15.48f, 0.0f);
        pathBuilder.lineToRelative(24.62f, 59.6f);
        pathBuilder.lineTo(224.27f, 94.0f);
        pathBuilder.arcTo(8.46f, 8.46f, 0.0f, false, true, 229.06f, 108.79f);
        pathBuilder.close();
        ...
        pathBuilder2.arcToRelative(16.38f, 16.38f, 0.0f, false, false, 24.5f, 17.82f);
        ...
        pathBuilder2.lineTo(175.14f, 144.73f);
        ...
        pathBuilder2.lineToRelative(-54.72f, -33.65f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.38f, 0.0f);
        pathBuilder2.lineTo(69.09f, 215.94f);
        pathBuilder2.curveToRelative(-0.15f, 0.09f, -0.19f, 0.12f, -0.38f, 0.0f);
        pathBuilder2.arcToRelative(0.37f, 0.37f, 0.0f, false, true, -0.17f, -0.48f);
        pathBuilder2.lineToRelative(14.88f, -62.8f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -2.56f, -7.91f);
        pathBuilder2.lineToRelative(-48.7f, -42.0f);
        pathBuilder2.curveToRelative(-0.12f, -0.1f, -0.23f, -0.19f, -0.13f, -0.5f);
        pathBuilder2.reflectiveCurveToRelative(0.18f, -0.27f, 0.33f, -0.29f);
        pathBuilder2.lineToRelative(63.92f, -5.16f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 103.0f, 91.86f);
        pathBuilder2.lineToRelative(24.62f, -59.61f);
        pathBuilder2.curveToRelative(0.08f, -0.17f, 0.11f, -0.25f, 0.35f, -0.25f);
        pathBuilder2.reflectiveCurveToRelative(0.27f, 0.08f, 0.35f, 0.25f);
        pathBuilder2.lineTo(153.0f, 91.86f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 6.75f, 4.92f);
        pathBuilder2.lineToRelative(63.92f, 5.16f);
        pathBuilder2.curveToRelative(0.15f, 0.0f, 0.24f, 0.0f, 0.33f, 0.29f);
