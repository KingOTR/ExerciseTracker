...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ThreeD", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getThreeD", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_threeD", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ThreedKt {
    private static ImageVector _threeD;

    public static final ImageVector getThreeD(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(96.0f, 148.0f);
        ...
        pathBuilder2.lineTo(88.63f, 88.0f);
        ...
        pathBuilder2.arcTo(36.0f, 36.0f, 0.0f, false, true, 76.0f, 184.0f);
        pathBuilder2.arcToRelative(35.71f, 35.71f, 0.0f, false, true, -25.71f, -10.81f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, true, true, 61.71f, 162.0f);
        pathBuilder2.arcTo(20.0f, 20.0f, 0.0f, false, false, 96.0f, 148.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(160.0f, 72.0f);
        pathBuilder2.arcToRelative(56.0f, 56.0f, 0.0f, false, true, 0.0f, 112.0f);
        pathBuilder2.lineTo(136.0f, 184.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, -8.0f);
        pathBuilder2.lineTo(128.0f, 80.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(160.0f, 88.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(32.0f, 56.0f);
