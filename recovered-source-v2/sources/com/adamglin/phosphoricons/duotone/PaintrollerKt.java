...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PaintRoller", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getPaintRoller", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_paintRoller", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PaintrollerKt {
    private static ImageVector _paintRoller;

    public static final ImageVector getPaintRoller(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 208.0f, 64.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 32.0f, 64.0f);
        ...
        pathBuilder2.verticalLineToRelative(50.0f);
        pathBuilder2.lineTo(131.6f, 182.65f);
        pathBuilder2.arcTo(16.07f, 16.07f, 0.0f, false, false, 120.0f, 198.0f);
        pathBuilder2.verticalLineToRelative(34.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.lineTo(136.0f, 198.0f);
        pathBuilder2.lineToRelative(100.4f, -28.68f);
        pathBuilder2.arcTo(16.07f, 16.07f, 0.0f, false, false, 248.0f, 154.0f);
        pathBuilder2.lineTo(248.0f, 104.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 232.0f, 88.0f);
        pathBuilder2.close();
