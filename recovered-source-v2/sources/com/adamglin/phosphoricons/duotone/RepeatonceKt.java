...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"RepeatOnce", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getRepeatOnce", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_repeatOnce", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RepeatonceKt {
    private static ImageVector _repeatOnce;

    public static final ImageVector getRepeatOnce(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(64.0f, 64.0f, 0.0f, false, true, 96.0f, 64.0f);
        pathBuilder.close();
        ...
        pathBuilder2.arcTo(72.08f, 72.08f, 0.0f, false, true, 96.0f, 56.0f);
        pathBuilder2.lineTo(204.69f, 56.0f);
        pathBuilder2.lineTo(194.34f, 45.66f);
        ...
        pathBuilder2.lineToRelative(-24.0f, 24.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f);
        pathBuilder2.lineTo(204.69f, 72.0f);
        ...
        pathBuilder2.lineTo(51.31f, 184.0f);
        ...
        pathBuilder2.lineToRelative(24.0f, 24.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.32f, -11.32f);
        pathBuilder2.lineTo(51.31f, 200.0f);
        ...
        pathBuilder2.lineToRelative(4.42f, -2.21f);
        pathBuilder2.lineTo(128.0f, 152.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 136.0f, 160.0f);
        pathBuilder2.close();
