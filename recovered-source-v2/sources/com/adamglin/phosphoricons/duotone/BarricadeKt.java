...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Barricade", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getBarricade", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_barricade", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BarricadeKt {
    private static ImageVector _barricade;

    public static final ImageVector getBarricade(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 16.0f, 80.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(224.0f, 128.69f);
        pathBuilder2.lineTo(175.31f, 80.0f);
        pathBuilder2.lineTo(224.0f, 80.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(80.69f, 80.0f);
        pathBuilder2.lineToRelative(72.0f, 72.0f);
        pathBuilder2.lineTo(103.31f, 152.0f);
        pathBuilder2.lineTo(32.0f, 80.69f);
        pathBuilder2.lineTo(32.0f, 80.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(32.0f, 103.31f);
        pathBuilder2.lineTo(80.69f, 152.0f);
        pathBuilder2.lineTo(32.0f, 152.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(224.0f, 152.0f);
        pathBuilder2.lineTo(175.31f, 152.0f);
        pathBuilder2.lineToRelative(-72.0f, -72.0f);
        pathBuilder2.horizontalLineToRelative(49.38f);
        pathBuilder2.lineTo(224.0f, 151.32f);
