...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Rug", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getRug", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_rug", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RugKt {
    private static ImageVector _rug;

    public static final ImageVector getRug(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(200.0f, 16.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f);
        pathBuilder2.lineTo(48.0f, 232.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        ...
        pathBuilder2.verticalLineToRelative(16.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.lineTo(208.0f, 24.0f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, false, 200.0f, 16.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(121.14f, 172.12f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 13.72f, 0.0f);
        ...
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 8.24f);
        pathBuilder2.close();
        pathBuilder2.moveTo(128.0f, 103.55f);
        pathBuilder2.lineTo(142.67f, 128.0f);
        pathBuilder2.lineTo(128.0f, 152.45f);
        pathBuilder2.lineTo(113.33f, 128.0f);
        pathBuilder2.close();
