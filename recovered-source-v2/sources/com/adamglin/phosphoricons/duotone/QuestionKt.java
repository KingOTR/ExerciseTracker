...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Question", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getQuestion", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_question", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class QuestionKt {
    private static ImageVector _question;

    public static final ImageVector getQuestion(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.curveToRelative(-22.06f, 0.0f, -40.0f, 16.15f, -40.0f, 36.0f);
        pathBuilder2.verticalLineToRelative(4.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(-4.0f);
        pathBuilder2.curveToRelative(0.0f, -11.0f, 10.77f, -20.0f, 24.0f, -20.0f);
        pathBuilder2.reflectiveCurveToRelative(24.0f, 9.0f, 24.0f, 20.0f);
        pathBuilder2.reflectiveCurveToRelative(-10.77f, 20.0f, -24.0f, 20.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, 8.0f);
        pathBuilder2.verticalLineToRelative(8.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f);
        pathBuilder2.verticalLineToRelative(-0.72f);
        pathBuilder2.curveToRelative(18.24f, -3.35f, 32.0f, -17.9f, 32.0f, -35.28f);
        pathBuilder2.curveTo(168.0f, 88.15f, 150.06f, 72.0f, 128.0f, 72.0f);
        pathBuilder2.close();
