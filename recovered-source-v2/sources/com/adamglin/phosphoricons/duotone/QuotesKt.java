...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Quotes", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getQuotes", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_quotes", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class QuotesKt {
    private static ImageVector _quotes;

    public static final ImageVector getQuotes(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 108.0f, 72.0f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(100.0f, 56.0f);
        ...
        pathBuilder2.lineTo(116.0f, 72.0f);
        pathBuilder2.arcTo(16.0f, 16.0f, 0.0f, false, false, 100.0f, 56.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(100.0f, 136.0f);
        pathBuilder2.lineTo(40.0f, 136.0f);
        pathBuilder2.lineTo(40.0f, 72.0f);
        pathBuilder2.horizontalLineToRelative(60.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(216.0f, 56.0f);
        pathBuilder2.lineTo(156.0f, 56.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, -16.0f, 16.0f);
        pathBuilder2.verticalLineToRelative(64.0f);
        pathBuilder2.arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, 16.0f);
        pathBuilder2.horizontalLineToRelative(60.0f);
        ...
        pathBuilder2.lineTo(156.0f, 136.0f);
        pathBuilder2.lineTo(156.0f, 72.0f);
        pathBuilder2.horizontalLineToRelative(60.0f);
        pathBuilder2.close();
