...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FilePy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getFilePy", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_filePy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilepyKt {
    private static ImageVector _filePy;

    public static final ImageVector getFilePy(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(154.78f, 156.24f);
        pathBuilder2.lineTo(136.0f, 186.24f);
        pathBuilder2.lineTo(136.0f, 208.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f);
        pathBuilder2.lineTo(120.0f, 186.29f);
        pathBuilder2.lineToRelative(-18.78f, -30.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 13.56f, -8.48f);
        pathBuilder2.lineTo(128.0f, 168.91f);
        pathBuilder2.lineToRelative(13.22f, -21.15f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 13.56f, 8.48f);
        pathBuilder2.close();
