...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsDownUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/DuotoneGroup;", "getArrowsDownUp", "(Lcom/adamglin/phosphoricons/DuotoneGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsDownUp", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsdownupKt {
    private static ImageVector _arrowsDownUp;

    public static final ImageVector getArrowsDownUp(DuotoneGroup duotoneGroup) {
        ...
        pathBuilder2.moveTo(117.66f, 170.34f);
        ...
        pathBuilder2.lineTo(72.0f, 188.69f);
        pathBuilder2.lineTo(72.0f, 48.0f);
        pathBuilder2.arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f);
        pathBuilder2.lineTo(88.0f, 188.69f);
        pathBuilder2.lineToRelative(18.34f, -18.35f);
        pathBuilder2.arcTo(8.0f, 8.0f, 0.0f, false, true, 117.66f, 170.34f);
        pathBuilder2.close();
        pathBuilder2.moveTo(213.66f, 74.34f);
        pathBuilder2.lineTo(181.66f, 42.34f);
        ...
        pathBuilder2.lineTo(168.0f, 67.31f);
