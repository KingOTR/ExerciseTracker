...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"DesktopTower", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getDesktopTower", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_desktopTower", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class DesktoptowerKt {
    private static ImageVector _desktopTower;

    public static final ImageVector getDesktopTower(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 212.0f, 72.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, -8.0f);
        pathBuilder.close();
        pathBuilder.moveTo(244.0f, 48.0f);
        pathBuilder.lineTo(244.0f, 208.0f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 244.0f, 48.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, -4.0f);
        pathBuilder.close();
        pathBuilder.moveTo(192.0f, 172.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 8.0f, 8.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 192.0f, 172.0f);
        pathBuilder.close();
