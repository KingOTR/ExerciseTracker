...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Pen", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getPen", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_pen", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PenKt {
    private static ImageVector _pen;

    public static final ImageVector getPen(ThinGroup thinGroup) {
        ...
        pathBuilder.lineToRelative(88.67f, -88.67f);
        pathBuilder.lineToRelative(5.73f, 23.0f);
        pathBuilder.lineToRelative(-38.39f, 38.4f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, 5.65f, 5.66f);
        pathBuilder.lineToRelative(40.0f, -40.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 1.06f, -3.8f);
        pathBuilder.lineToRelative(-7.46f, -29.8f);
        pathBuilder.lineToRelative(28.06f, -28.06f);
        ...
        pathBuilder.lineTo(86.35f, 212.0f);
