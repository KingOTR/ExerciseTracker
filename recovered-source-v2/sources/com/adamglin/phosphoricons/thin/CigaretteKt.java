...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Cigarette", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getCigarette", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cigarette", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CigaretteKt {
    private static ImageVector _cigarette;

    public static final ImageVector getCigarette(ThinGroup thinGroup) {
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.0f, -5.26f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(164.51f, 62.0f);
        pathBuilder.curveToRelative(8.22f, -14.61f, 8.21f, -23.23f, 6.75f, -27.9f);
        pathBuilder.arcToRelative(10.82f, 10.82f, 0.0f, false, false, -4.94f, -6.51f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.0f, -5.26f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.3f, -2.0f);
        ...
        pathBuilder.curveToRelative(-8.22f, 14.61f, -8.21f, 23.24f, -6.75f, 27.91f);
        pathBuilder.arcToRelative(10.74f, 10.74f, 0.0f, false, false, 4.94f, 6.5f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 168.0f, 108.0f);
        pathBuilder.arcToRelative(4.09f, 4.09f, 0.0f, false, true, -1.63f, -0.35f);
        pathBuilder.curveToRelative(-0.66f, -0.3f, -6.52f, -3.09f, -9.16f, -11.0f);
        pathBuilder.curveTo(154.23f, 87.59f, 156.69f, 76.0f, 164.51f, 62.0f);
        pathBuilder.close();
