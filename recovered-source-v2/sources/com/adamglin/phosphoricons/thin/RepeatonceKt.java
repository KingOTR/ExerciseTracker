...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"RepeatOnce", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getRepeatOnce", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_repeatOnce", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RepeatonceKt {
    private static ImageVector _repeatOnce;

    public static final ImageVector getRepeatOnce(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(68.07f, 68.07f, 0.0f, false, true, 96.0f, 60.0f);
        pathBuilder.lineTo(214.34f, 60.0f);
        pathBuilder.lineTo(197.17f, 42.83f);
        ...
        pathBuilder.lineToRelative(-24.0f, 24.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, -5.66f);
        pathBuilder.lineTo(214.34f, 68.0f);
        ...
        pathBuilder.lineTo(41.66f, 188.0f);
        ...
        pathBuilder.lineTo(41.66f, 196.0f);
        pathBuilder.lineTo(160.0f, 196.0f);
        pathBuilder.arcToRelative(68.07f, 68.07f, 0.0f, false, false, 68.0f, -68.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 224.0f, 124.0f);
        pathBuilder.close();
        pathBuilder.moveTo(136.0f, 156.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, -4.0f);
        ...
        pathBuilder.lineToRelative(10.21f, -5.1f);
        pathBuilder.lineTo(132.0f, 152.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 136.0f, 156.0f);
        pathBuilder.close();
