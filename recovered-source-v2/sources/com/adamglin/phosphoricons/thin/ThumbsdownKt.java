...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ThumbsDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getThumbsDown", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_thumbsDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ThumbsdownKt {
    private static ImageVector _thumbsDown;

    public static final ImageVector getThumbsDown(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(235.85f, 157.52f);
        pathBuilder.lineToRelative(-12.0f, -96.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 204.0f, 44.0f);
        ...
        pathBuilder.lineTo(77.53f, 156.0f);
        pathBuilder.lineToRelative(38.89f, 77.79f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 120.0f, 236.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(76.0f, 148.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(225.0f, 167.94f);
        ...
        pathBuilder.lineTo(84.0f, 151.06f);
        pathBuilder.lineTo(84.0f, 52.0f);
        pathBuilder.lineTo(204.0f, 52.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, 11.91f, 10.51f);
        pathBuilder.lineToRelative(12.0f, 96.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 225.0f, 167.94f);
        pathBuilder.close();
