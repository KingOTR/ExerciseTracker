...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TrayArrowDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getTrayArrowDown", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_trayArrowDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TrayarrowdownKt {
    private static ImageVector _trayArrowDown;

    public static final ImageVector getTrayArrowDown(ThinGroup thinGroup) {
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.82f, -1.17f);
        pathBuilder.lineTo(85.17f, 159.51f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 76.69f, 156.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(93.17f, 122.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, -5.66f);
        pathBuilder.lineTo(124.0f, 142.34f);
