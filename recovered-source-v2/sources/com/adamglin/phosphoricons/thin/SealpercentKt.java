...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SealPercent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getSealPercent", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_sealPercent", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealpercentKt {
    private static ImageVector _sealPercent;

    public static final ImageVector getSealPercent(ThinGroup thinGroup) {
        ...
        pathBuilder.curveToRelative(-1.76f, 4.26f, -5.93f, 8.6f, -10.0f, 12.8f);
        pathBuilder.curveToRelative(-6.4f, 6.68f, -13.0f, 13.59f, -13.0f, 22.42f);
        ...
        pathBuilder.curveToRelative(-5.65f, 2.34f, -10.55f, 7.0f, -15.28f, 11.57f);
        ...
        pathBuilder.curveToRelative(-4.73f, -4.54f, -9.63f, -9.23f, -15.28f, -11.57f);
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 116.0f, 96.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, true, false, 20.0f, 20.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 160.0f, 140.0f);
        pathBuilder.close();
        pathBuilder.moveTo(160.0f, 172.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, -12.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 160.0f, 172.0f);
        pathBuilder.close();
        pathBuilder.moveTo(170.83f, 90.83f);
        pathBuilder.lineTo(90.83f, 170.83f);
