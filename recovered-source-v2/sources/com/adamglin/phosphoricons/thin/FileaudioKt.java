...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileAudio", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getFileAudio", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileAudio", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FileaudioKt {
    private static ImageVector _fileAudio;

    public static final ImageVector getFileAudio(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(97.53f, 132.3f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.36f, 0.87f);
        pathBuilder.lineTo(70.34f, 156.0f);
        pathBuilder.lineTo(48.0f, 156.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.0f, 4.0f);
        pathBuilder.verticalLineToRelative(40.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, 4.0f);
        pathBuilder.lineTo(70.34f, 204.0f);
        pathBuilder.lineToRelative(22.83f, 22.83f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 100.0f, 224.0f);
        pathBuilder.lineTo(100.0f, 136.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 97.53f, 132.3f);
        pathBuilder.close();
        pathBuilder.moveTo(92.0f, 214.3f);
        pathBuilder.lineTo(74.83f, 197.17f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 72.0f, 196.0f);
        ...
        pathBuilder.lineTo(92.0f, 145.66f);
        pathBuilder.close();
        pathBuilder.moveTo(148.0f, 180.0f);
        pathBuilder.arcToRelative(36.52f, 36.52f, 0.0f, false, true, -18.0f, 31.45f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, -6.9f);
        pathBuilder.arcToRelative(28.5f, 28.5f, 0.0f, false, false, 0.0f, -49.1f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.0f, -6.9f);
        pathBuilder.arcTo(36.52f, 36.52f, 0.0f, false, true, 148.0f, 180.0f);
        pathBuilder.close();
        pathBuilder.moveTo(210.83f, 85.17f);
        pathBuilder.lineTo(154.83f, 29.17f);
