...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Rainbow", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getRainbow", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_rainbow", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class RainbowKt {
    private static ImageVector _rainbow;

    public static final ImageVector getRainbow(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(84.09f, 84.09f, 0.0f, false, false, 128.0f, 84.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 52.0f);
        pathBuilder.arcTo(116.13f, 116.13f, 0.0f, false, false, 12.0f, 168.0f);
        pathBuilder.verticalLineToRelative(16.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 8.0f, 0.0f);
        pathBuilder.lineTo(20.0f, 168.0f);
        pathBuilder.arcToRelative(108.0f, 108.0f, 0.0f, false, true, 216.0f, 0.0f);
        pathBuilder.verticalLineToRelative(16.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 8.0f, 0.0f);
        pathBuilder.lineTo(244.0f, 168.0f);
        pathBuilder.arcTo(116.13f, 116.13f, 0.0f, false, false, 128.0f, 52.0f);
        pathBuilder.close();
