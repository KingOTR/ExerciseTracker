...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"WashingMachine", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getWashingMachine", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_washingMachine", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class WashingmachineKt {
    private static ImageVector _washingMachine;

    public static final ImageVector getWashingMachine(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(60.07f, 60.07f, 0.0f, false, false, 128.0f, 68.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 196.0f, 68.0f);
        pathBuilder.close();
        pathBuilder.moveTo(122.83f, 114.83f);
        pathBuilder.lineTo(106.83f, 130.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, -5.66f);
        pathBuilder.lineToRelative(16.0f, -16.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, 5.66f);
        pathBuilder.close();
        pathBuilder.moveTo(154.83f, 117.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, 5.66f);
        pathBuilder.lineToRelative(-32.0f, 32.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, -5.66f);
        pathBuilder.lineToRelative(32.0f, -32.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 154.83f, 117.17f);
        pathBuilder.close();
