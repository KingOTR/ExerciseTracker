...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ListMagnifyingGlass", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getListMagnifyingGlass", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_listMagnifyingGlass", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ListmagnifyingglassKt {
    private static ImageVector _listMagnifyingGlass;

    public static final ImageVector getListMagnifyingGlass(ThinGroup thinGroup) {
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, -8.0f);
        pathBuilder.close();
        pathBuilder.moveTo(234.83f, 194.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, 0.0f);
        pathBuilder.lineToRelative(-22.72f, -22.72f);
        pathBuilder.arcToRelative(36.06f, 36.06f, 0.0f, true, true, 5.66f, -5.66f);
        pathBuilder.lineToRelative(22.72f, 22.72f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 234.83f, 194.83f);
        pathBuilder.close();
        pathBuilder.moveTo(184.0f, 172.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, false, -28.0f, -28.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, false, 184.0f, 172.0f);
        pathBuilder.close();
