...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Clipboard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getClipboard", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_clipboard", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ClipboardKt {
    private static ImageVector _clipboard;

    public static final ImageVector getClipboard(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(161.92f, 36.0f);
        pathBuilder.arcToRelative(44.0f, 44.0f, 0.0f, false, false, -67.84f, 0.0f);
        ...
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, true, 128.0f, 28.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.0f, -4.0f);
        pathBuilder.lineTo(88.83f, 44.0f);
        pathBuilder.arcTo(43.71f, 43.71f, 0.0f, false, false, 84.0f, 64.0f);
        pathBuilder.verticalLineToRelative(8.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, 4.0f);
        pathBuilder.horizontalLineToRelative(80.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, -4.0f);
        pathBuilder.lineTo(172.0f, 64.0f);
        pathBuilder.arcToRelative(43.71f, 43.71f, 0.0f, false, false, -4.83f, -20.0f);
