...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MopedFront", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getMopedFront", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mopedFront", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MopedfrontKt {
    private static ImageVector _mopedFront;

    public static final ImageVector getMopedFront(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(163.77f, 44.0f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, false, false, -71.54f, 0.0f);
        pathBuilder.lineTo(48.0f, 44.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, 8.0f);
        pathBuilder.lineTo(92.23f, 52.0f);
        pathBuilder.arcToRelative(36.06f, 36.06f, 0.0f, false, false, 17.34f, 26.91f);
        pathBuilder.arcTo(60.11f, 60.11f, 0.0f, false, false, 68.0f, 136.0f);
        ...
        pathBuilder.arcToRelative(60.11f, 60.11f, 0.0f, false, false, -41.57f, -57.09f);
        pathBuilder.arcTo(36.06f, 36.06f, 0.0f, false, false, 163.77f, 52.0f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, -4.0f);
        pathBuilder.lineTo(76.0f, 136.0f);
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 128.0f, 76.0f);
        pathBuilder.close();
