...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Warehouse", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getWarehouse", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_warehouse", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class WarehouseKt {
    private static ImageVector _warehouse;

    public static final ImageVector getWarehouse(ThinGroup thinGroup) {
        ...
        pathBuilder.verticalLineTo(54.66f);
        pathBuilder.lineToRelative(12.84f, -2.75f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, -1.68f, -7.82f);
        pathBuilder.lineToRelative(-224.0f, 48.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 16.0f, 100.0f);
        pathBuilder.arcToRelative(4.07f, 4.07f, 0.0f, false, false, 0.84f, -0.09f);
        pathBuilder.lineTo(28.0f, 97.52f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, -8.0f);
        pathBuilder.close();
        pathBuilder.moveTo(36.0f, 95.81f);
        pathBuilder.lineTo(220.0f, 56.38f);
        pathBuilder.verticalLineTo(188.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(180.0f, 156.0f);
