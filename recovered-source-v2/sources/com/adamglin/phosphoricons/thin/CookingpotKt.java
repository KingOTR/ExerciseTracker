...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"CookingPot", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getCookingPot", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_cookingPot", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CookingpotKt {
    private static ImageVector _cookingPot;

    public static final ImageVector getCookingPot(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 128.0f, 52.0f);
        pathBuilder.close();
        pathBuilder.moveTo(160.0f, 52.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, -4.0f);
        pathBuilder.lineTo(164.0f, 16.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -8.0f, 0.0f);
        pathBuilder.lineTo(156.0f, 48.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 160.0f, 52.0f);
        pathBuilder.close();
        pathBuilder.moveTo(250.4f, 99.2f);
        pathBuilder.lineTo(220.0f, 122.0f);
        ...
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, true, -28.0f, -28.0f);
        pathBuilder.lineTo(36.0f, 122.0f);
        pathBuilder.lineTo(5.6f, 99.2f);
