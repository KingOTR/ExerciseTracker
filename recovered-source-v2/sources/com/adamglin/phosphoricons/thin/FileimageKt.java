...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileImage", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getFileImage", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileImage", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FileimageKt {
    private static ImageVector _fileImage;

    public static final ImageVector getFileImage(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(107.33f, 149.78f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -6.66f, 0.0f);
        pathBuilder.lineTo(76.42f, 186.15f);
        pathBuilder.lineTo(63.36f, 165.84f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -6.72f, 0.0f);
        pathBuilder.lineToRelative(-36.0f, 56.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 24.0f, 228.0f);
        pathBuilder.horizontalLineTo(152.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 3.33f, -6.22f);
        pathBuilder.close();
        pathBuilder.moveTo(31.33f, 220.0f);
        pathBuilder.lineTo(60.0f, 175.4f);
        pathBuilder.lineToRelative(13.0f, 20.22f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 3.33f, 1.83f);
        pathBuilder.arcToRelative(3.93f, 3.93f, 0.0f, false, false, 3.36f, -1.78f);
        pathBuilder.lineTo(104.0f, 159.21f);
        pathBuilder.lineTo(144.53f, 220.0f);
        pathBuilder.close();
