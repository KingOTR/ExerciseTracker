...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ApproximateEquals", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getApproximateEquals", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_approximateEquals", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ApproximateequalsKt {
    private static ImageVector _approximateEquals;

    public static final ImageVector getApproximateEquals(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(219.08f, 155.84f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -0.53f, 5.63f);
        pathBuilder.curveTo(203.56f, 173.9f, 188.9f, 180.0f, 173.93f, 180.0f);
        ...
        pathBuilder.curveToRelative(17.0f, -14.12f, 33.62f, -20.07f, 50.74f, -18.2f);
        pathBuilder.curveToRelative(15.0f, 1.65f, 28.6f, 9.0f, 41.72f, 16.15f);
        pathBuilder.curveToRelative(25.52f, 13.86f, 49.62f, 26.94f, 83.54f, -1.18f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 219.08f, 155.84f);
        pathBuilder.close();
        pathBuilder.moveTo(42.55f, 100.69f);
        pathBuilder.curveToRelative(33.92f, -28.12f, 58.0f, -15.0f, 83.54f, -1.18f);
        pathBuilder.curveToRelative(13.12f, 7.13f, 26.69f, 14.5f, 41.72f, 16.15f);
        pathBuilder.arcToRelative(57.32f, 57.32f, 0.0f, false, false, 6.12f, 0.33f);
        ...
        pathBuilder.curveTo(116.79f, 85.35f, 103.22f, 78.0f, 88.19f, 76.34f);
