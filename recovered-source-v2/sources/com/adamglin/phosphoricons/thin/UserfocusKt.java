...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserFocus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getUserFocus", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userFocus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UserfocusKt {
    private static ImageVector _userFocus;

    public static final ImageVector getUserFocus(ThinGroup thinGroup) {
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.2f, -1.6f);
        pathBuilder.arcToRelative(56.0f, 56.0f, 0.0f, false, false, -89.6f, 0.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, true, -6.4f, -4.8f);
        pathBuilder.arcToRelative(63.65f, 63.65f, 0.0f, false, true, 32.5f, -22.85f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, true, true, 37.4f, 0.0f);
        pathBuilder.arcToRelative(63.65f, 63.65f, 0.0f, false, true, 32.5f, 22.85f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 176.0f, 172.0f);
        pathBuilder.close();
