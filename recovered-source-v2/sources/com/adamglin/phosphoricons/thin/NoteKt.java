...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Note", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getNote", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_note", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NoteKt {
    private static ImageVector _note;

    public static final ImageVector getNote(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 92.0f, 96.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(220.0f, 156.69f);
        pathBuilder.arcToRelative(11.9f, 11.9f, 0.0f, false, true, -3.52f, 8.48f);
        pathBuilder.lineToRelative(-51.31f, 51.32f);
        pathBuilder.arcToRelative(11.93f, 11.93f, 0.0f, false, true, -8.48f, 3.51f);
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 48.0f, 212.0f);
        pathBuilder.close();
        pathBuilder.moveTo(206.35f, 164.0f);
        pathBuilder.lineTo(164.0f, 164.0f);
        pathBuilder.verticalLineToRelative(42.35f);
        pathBuilder.close();
