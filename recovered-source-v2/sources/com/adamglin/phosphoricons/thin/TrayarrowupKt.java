...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"TrayArrowUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getTrayArrowUp", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_trayArrowUp", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class TrayarrowupKt {
    private static ImageVector _trayArrowUp;

    public static final ImageVector getTrayArrowUp(ThinGroup thinGroup) {
        ...
        pathBuilder.lineToRelative(-19.32f, 19.32f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.82f, 1.17f);
        pathBuilder.horizontalLineTo(107.31f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.82f, -1.17f);
        pathBuilder.lineTo(85.17f, 159.52f);
        pathBuilder.arcTo(11.9f, 11.9f, 0.0f, false, false, 76.69f, 156.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(93.17f, 106.83f);
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 93.17f, 106.83f);
        pathBuilder.close();
