...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FilePng", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getFilePng", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_filePng", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilepngKt {
    private static ImageVector _filePng;

    public static final ImageVector getFilePng(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(60.0f, 148.0f);
        pathBuilder.lineTo(44.0f, 148.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(220.0f, 200.87f);
        ...
        pathBuilder.arcTo(17.45f, 17.45f, 0.0f, false, false, 200.0f, 156.0f);
        ...
        pathBuilder.lineTo(212.0f, 188.0f);
        ...
        pathBuilder.verticalLineToRelative(56.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.78f, 3.81f);
        pathBuilder.arcTo(3.93f, 3.93f, 0.0f, false, true, 148.0f, 212.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.25f, -1.67f);
        pathBuilder.lineTo(112.0f, 164.48f);
        pathBuilder.lineTo(112.0f, 208.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -8.0f, 0.0f);
        pathBuilder.lineTo(104.0f, 152.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 7.25f, -2.33f);
        pathBuilder.lineTo(144.0f, 195.52f);
        pathBuilder.lineTo(144.0f, 152.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 8.0f, 0.0f);
        pathBuilder.close();
