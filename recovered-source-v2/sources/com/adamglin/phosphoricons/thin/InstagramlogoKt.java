...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"InstagramLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getInstagramLogo", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_instagramLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class InstagramlogoKt {
    private static ImageVector _instagramLogo;

    public static final ImageVector getInstagramLogo(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(52.06f, 52.06f, 0.0f, false, false, 28.0f, 80.0f);
        ...
        pathBuilder.arcTo(52.06f, 52.06f, 0.0f, false, false, 176.0f, 28.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(44.05f, 44.05f, 0.0f, false, true, 80.0f, 36.0f);
        pathBuilder.horizontalLineToRelative(96.0f);
        pathBuilder.arcToRelative(44.05f, 44.05f, 0.0f, false, true, 44.0f, 44.0f);
        pathBuilder.close();
        pathBuilder.moveTo(188.0f, 76.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, -8.0f, -8.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 188.0f, 76.0f);
        pathBuilder.close();
