...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"NumberSquareThree", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getNumberSquareThree", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_numberSquareThree", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NumbersquarethreeKt {
    private static ImageVector _numberSquareThree;

    public static final ImageVector getNumberSquareThree(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, true, false, 124.0f, 124.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.28f, -6.29f);
        pathBuilder.lineTo(144.32f, 84.0f);
        pathBuilder.lineTo(104.0f, 84.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -8.0f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 3.28f, 6.29f);
        pathBuilder.lineTo(131.12f, 116.8f);
        pathBuilder.arcTo(32.06f, 32.06f, 0.0f, false, true, 156.0f, 148.0f);
        pathBuilder.close();
