...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Checkerboard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getCheckerboard", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_checkerboard", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CheckerboardKt {
    private static ImageVector _checkerboard;

    public static final ImageVector getCheckerboard(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(193.66f, 124.0f);
        pathBuilder.lineTo(132.0f, 62.34f);
        pathBuilder.lineTo(132.0f, 44.0f);
        pathBuilder.horizontalLineToRelative(18.34f);
        pathBuilder.lineTo(212.0f, 105.66f);
        pathBuilder.lineTo(212.0f, 124.0f);
        pathBuilder.close();
        pathBuilder.moveTo(132.0f, 73.66f);
        pathBuilder.lineTo(182.34f, 124.0f);
        pathBuilder.lineTo(132.0f, 124.0f);
        pathBuilder.close();
        pathBuilder.moveTo(212.0f, 48.0f);
        pathBuilder.lineTo(212.0f, 94.34f);
        pathBuilder.lineTo(161.66f, 44.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(105.66f, 212.0f);
        pathBuilder.lineTo(44.0f, 150.34f);
        pathBuilder.lineTo(44.0f, 132.0f);
        pathBuilder.lineTo(62.34f, 132.0f);
        pathBuilder.lineTo(124.0f, 193.66f);
        pathBuilder.lineTo(124.0f, 212.0f);
        pathBuilder.close();
        pathBuilder.moveTo(124.0f, 182.34f);
        pathBuilder.lineTo(73.66f, 132.0f);
        pathBuilder.lineTo(124.0f, 132.0f);
        pathBuilder.close();
        pathBuilder.moveTo(44.0f, 208.0f);
        pathBuilder.lineTo(44.0f, 161.66f);
        pathBuilder.lineTo(94.34f, 212.0f);
