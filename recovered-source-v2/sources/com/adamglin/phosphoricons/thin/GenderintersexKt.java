...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"GenderIntersex", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getGenderIntersex", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_genderIntersex", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GenderintersexKt {
    private static ImageVector _genderIntersex;

    public static final ImageVector getGenderIntersex(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(163.55f, 70.79f);
        pathBuilder.arcTo(60.0f, 60.0f, 0.0f, true, false, 116.0f, 171.85f);
        ...
        pathBuilder.verticalLineTo(171.85f);
        pathBuilder.arcTo(59.94f, 59.94f, 0.0f, false, false, 168.68f, 77.0f);
        pathBuilder.lineTo(204.0f, 41.66f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(120.0f, 164.0f);
        pathBuilder.arcToRelative(52.0f, 52.0f, 0.0f, true, true, 52.0f, -52.0f);
        pathBuilder.arcTo(52.06f, 52.06f, 0.0f, false, true, 120.0f, 164.0f);
        pathBuilder.close();
