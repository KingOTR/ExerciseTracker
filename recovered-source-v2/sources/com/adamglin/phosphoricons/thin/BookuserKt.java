...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BookUser", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getBookUser", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bookUser", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BookuserKt {
    private static ImageVector _bookUser;

    public static final ImageVector getBookUser(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 96.0f, 76.0f);
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 232.0f, 76.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, true, 28.0f, 28.0f);
        pathBuilder.verticalLineToRelative(97.4f);
        pathBuilder.arcTo(35.93f, 35.93f, 0.0f, false, false, 96.0f, 196.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(92.8f, 45.6f);
        pathBuilder.arcToRelative(44.0f, 44.0f, 0.0f, false, true, 70.4f, 0.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -6.4f, 4.8f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, false, false, -57.6f, 0.0f);
