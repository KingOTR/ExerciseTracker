...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HandTap", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getHandTap", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_handTap", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HandtapKt {
    private static ImageVector _handTap;

    public static final ImageVector getHandTap(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(196.0f, 124.0f);
        pathBuilder.arcToRelative(23.88f, 23.88f, 0.0f, false, false, -16.07f, 6.19f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 140.0f, 114.13f);
        ...
        pathBuilder.lineTo(80.74f, 151.94f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 39.22f, 176.0f);
        pathBuilder.lineToRelative(29.32f, 50.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 6.9f, -4.0f);
        pathBuilder.lineTo(46.13f, 172.0f);
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 100.0f, 184.0f);
        ...
        pathBuilder.curveToRelative(0.0f, 22.66f, -7.51f, 38.06f, -7.58f, 38.21f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 1.79f, 5.37f);
        pathBuilder.arcTo(4.05f, 4.05f, 0.0f, false, false, 208.0f, 228.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 3.58f, -2.21f);
        pathBuilder.curveToRelative(0.34f, -0.69f, 8.42f, -17.13f, 8.42f, -41.79f);
        pathBuilder.lineTo(220.0f, 148.0f);
        pathBuilder.arcTo(24.0f, 24.0f, 0.0f, false, false, 196.0f, 124.0f);
        pathBuilder.close();
