...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Globe", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getGlobe", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_globe", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class GlobeKt {
    private static ImageVector _globe;

    public static final ImageVector getGlobe(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(40.36f, 100.0f);
        pathBuilder.lineTo(86.59f, 100.0f);
        pathBuilder.arcToRelative(152.65f, 152.65f, 0.0f, false, false, 0.0f, 56.0f);
        pathBuilder.lineTo(40.36f, 156.0f);
        pathBuilder.arcToRelative(92.09f, 92.09f, 0.0f, false, true, 0.0f, -56.0f);
        pathBuilder.close();
        pathBuilder.moveTo(43.36f, 164.0f);
        pathBuilder.horizontalLineToRelative(45.0f);
        pathBuilder.arcToRelative(129.39f, 129.39f, 0.0f, false, false, 29.19f, 55.4f);
        pathBuilder.arcTo(92.25f, 92.25f, 0.0f, false, true, 43.34f, 164.0f);
        pathBuilder.close();
        pathBuilder.moveTo(138.48f, 219.4f);
        pathBuilder.arcTo(129.39f, 129.39f, 0.0f, false, false, 167.65f, 164.0f);
        pathBuilder.horizontalLineToRelative(45.0f);
        pathBuilder.arcTo(92.25f, 92.25f, 0.0f, false, true, 138.46f, 219.4f);
        pathBuilder.close();
