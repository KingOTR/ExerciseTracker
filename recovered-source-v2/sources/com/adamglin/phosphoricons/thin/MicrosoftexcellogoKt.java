...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MicrosoftExcelLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getMicrosoftExcelLogo", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_microsoftExcelLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MicrosoftexcellogoKt {
    private static ImageVector _microsoftExcelLogo;

    public static final ImageVector getMicrosoftExcelLogo(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 204.0f, 40.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 68.0f, 216.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(68.93f, 149.44f);
        pathBuilder.lineTo(86.79f, 128.0f);
        pathBuilder.lineTo(68.93f, 106.56f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 6.14f, -5.12f);
        pathBuilder.lineTo(92.0f, 121.75f);
        pathBuilder.lineToRelative(16.93f, -20.31f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, true, 6.14f, 5.12f);
        pathBuilder.lineTo(97.21f, 128.0f);
        pathBuilder.lineToRelative(17.86f, 21.44f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, true, -6.14f, 5.12f);
        pathBuilder.lineTo(92.0f, 134.25f);
        pathBuilder.lineTo(75.07f, 154.56f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 72.0f, 156.0f);
        pathBuilder.arcToRelative(3.94f, 3.94f, 0.0f, false, true, -2.56f, -0.93f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 68.93f, 149.44f);
        pathBuilder.close();
