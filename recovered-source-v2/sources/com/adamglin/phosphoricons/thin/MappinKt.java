...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MapPin", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getMapPin", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_mapPin", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MappinKt {
    private static ImageVector _mapPin;

    public static final ImageVector getMapPin(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 128.0f, 68.0f);
        pathBuilder.close();
        pathBuilder.moveTo(128.0f, 132.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, true, 28.0f, -28.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 128.0f, 132.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(250.0f, 250.0f, 0.0f, false, false, 171.0f, 197.62f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(165.1f, 192.23f);
        pathBuilder.arcTo(254.62f, 254.62f, 0.0f, false, true, 128.0f, 227.0f);
        pathBuilder.arcToRelative(254.62f, 254.62f, 0.0f, false, true, -37.1f, -34.81f);
        ...
        pathBuilder.curveTo(204.0f, 139.9f, 182.85f, 171.8f, 165.1f, 192.23f);
        pathBuilder.close();
