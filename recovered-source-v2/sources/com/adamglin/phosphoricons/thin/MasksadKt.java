...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MaskSad", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getMaskSad", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_maskSad", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MasksadKt {
    private static ImageVector _maskSad;

    public static final ImageVector getMaskSad(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(155.33f, 186.21f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.54f, 1.12f);
        pathBuilder.curveTo(142.8f, 182.69f, 137.0f, 180.0f, 128.0f, 180.0f);
        pathBuilder.reflectiveCurveToRelative(-14.8f, 2.69f, -21.79f, 7.33f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, true, -4.42f, -6.66f);
        pathBuilder.curveToRelative(7.82f, -5.21f, 15.28f, -8.67f, 26.21f, -8.67f);
        pathBuilder.reflectiveCurveToRelative(18.39f, 3.46f, 26.21f, 8.67f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 155.33f, 186.21f);
        pathBuilder.close();
        pathBuilder.moveTo(181.0f, 117.33f);
        pathBuilder.curveToRelative(-3.4f, 3.8f, -10.72f, 6.67f, -17.0f, 6.67f);
        pathBuilder.reflectiveCurveToRelative(-13.62f, -2.87f, -17.0f, -6.67f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -6.0f, 5.33f);
        pathBuilder.curveToRelative(4.92f, 5.5f, 14.37f, 9.34f, 23.0f, 9.34f);
        pathBuilder.reflectiveCurveToRelative(18.06f, -3.84f, 23.0f, -9.33f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(115.0f, 122.66f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, -6.0f, -5.34f);
        pathBuilder.curveToRelative(-3.4f, 3.8f, -10.72f, 6.67f, -17.0f, 6.67f);
        pathBuilder.reflectiveCurveToRelative(-13.62f, -2.87f, -17.0f, -6.67f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -6.0f, 5.33f);
        pathBuilder.curveToRelative(4.92f, 5.5f, 14.37f, 9.34f, 23.0f, 9.34f);
        pathBuilder.reflectiveCurveTo(110.06f, 128.16f, 115.0f, 122.67f);
        pathBuilder.close();
