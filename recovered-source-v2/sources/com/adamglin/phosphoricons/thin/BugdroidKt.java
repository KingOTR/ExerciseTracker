...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"BugDroid", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getBugDroid", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bugDroid", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BugdroidKt {
    private static ImageVector _bugDroid;

    public static final ImageVector getBugDroid(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(186.17f, 51.49f);
        pathBuilder.lineToRelative(16.66f, -16.66f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, -5.66f, -5.66f);
        pathBuilder.lineToRelative(-17.0f, 17.0f);
        pathBuilder.arcToRelative(83.72f, 83.72f, 0.0f, false, false, -104.26f, 0.0f);
        pathBuilder.lineToRelative(-17.0f, -17.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -5.66f, 5.66f);
        pathBuilder.lineTo(69.83f, 51.49f);
        pathBuilder.arcTo(83.75f, 83.75f, 0.0f, false, false, 44.0f, 112.0f);
        pathBuilder.verticalLineToRelative(40.0f);
        pathBuilder.arcToRelative(84.0f, 84.0f, 0.0f, false, false, 168.0f, 0.0f);
        pathBuilder.lineTo(212.0f, 112.0f);
        pathBuilder.arcTo(83.75f, 83.75f, 0.0f, false, false, 186.17f, 51.49f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(76.08f, 76.08f, 0.0f, false, true, 128.0f, 36.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, true, 8.0f, 8.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 92.0f, 92.0f);
        pathBuilder.close();
