...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"HeartBreak", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getHeartBreak", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_heartBreak", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class HeartbreakKt {
    private static ImageVector _heartBreak;

    public static final ImageVector getHeartBreak(ThinGroup thinGroup) {
        ...
        pathBuilder.arcToRelative(57.59f, 57.59f, 0.0f, false, false, -41.0f, 17.0f);
        pathBuilder.lineToRelative(-9.0f, 9.0f);
        pathBuilder.lineToRelative(-9.0f, -9.0f);
        pathBuilder.arcToRelative(58.0f, 58.0f, 0.0f, false, false, -99.0f, 41.0f);
        ...
        pathBuilder.arcToRelative(50.0f, 50.0f, 0.0f, false, true, 85.36f, -35.36f);
        pathBuilder.lineToRelative(9.0f, 9.0f);
        pathBuilder.lineTo(109.17f, 88.8f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, 5.66f);
        pathBuilder.lineToRelative(27.36f, 27.36f);
        pathBuilder.lineToRelative(-19.36f, 19.35f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.66f, 5.66f);
        pathBuilder.lineTo(145.0f, 124.64f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, -5.65f);
        pathBuilder.lineTo(117.66f, 91.63f);
        pathBuilder.lineToRelative(13.16f, -13.16f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.lineToRelative(11.8f, -11.81f);
        pathBuilder.arcTo(50.0f, 50.0f, 0.0f, false, true, 228.0f, 102.0f);
