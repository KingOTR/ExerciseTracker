...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"IdentificationBadge", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getIdentificationBadge", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_identificationBadge", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class IdentificationbadgeKt {
    private static ImageVector _identificationBadge;

    public static final ImageVector getIdentificationBadge(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(146.7f, 166.75f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, true, false, -37.4f, 0.0f);
        pathBuilder.arcTo(63.61f, 63.61f, 0.0f, false, false, 76.8f, 189.6f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 6.4f, 4.8f);
        pathBuilder.arcToRelative(56.0f, 56.0f, 0.0f, false, true, 89.6f, 0.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 6.4f, -4.8f);
        pathBuilder.arcTo(63.65f, 63.65f, 0.0f, false, false, 146.7f, 166.75f);
        pathBuilder.close();
        pathBuilder.moveTo(100.0f, 136.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, true, 28.0f, 28.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 100.0f, 136.0f);
        pathBuilder.close();
