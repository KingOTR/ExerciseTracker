...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ShuffleAngular", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getShuffleAngular", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_shuffleAngular", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ShuffleangularKt {
    private static ImageVector _shuffleAngular;

    public static final ImageVector getShuffleAngular(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(85.94f, 76.0f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 3.25f, 1.67f);
        pathBuilder.lineTo(170.06f, 180.0f);
        pathBuilder.horizontalLineToRelative(52.28f);
        ...
        pathBuilder.lineTo(170.06f, 76.0f);
        pathBuilder.horizontalLineToRelative(52.28f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -3.25f, 1.67f);
        pathBuilder.lineTo(144.41f, 98.15f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 145.34f, 103.73f);
        pathBuilder.close();
        pathBuilder.moveTo(110.66f, 152.27f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -5.58f, 0.93f);
        pathBuilder.lineTo(85.94f, 180.0f);
        pathBuilder.lineTo(32.0f, 180.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, 8.0f);
        pathBuilder.lineTo(88.0f, 188.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 3.25f, -1.67f);
        pathBuilder.lineToRelative(20.34f, -28.48f);
