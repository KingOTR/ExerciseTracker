...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"SmileyXEyes", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getSmileyXEyes", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_smileyXEyes", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SmileyxeyesKt {
    private static ImageVector _smileyXEyes;

    public static final ImageVector getSmileyXEyes(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(186.83f, 98.83f);
        pathBuilder.lineTo(173.66f, 112.0f);
        pathBuilder.lineToRelative(13.17f, 13.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, 5.66f);
        pathBuilder.lineTo(168.0f, 117.66f);
        pathBuilder.lineToRelative(-13.17f, 13.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, -5.66f);
        pathBuilder.lineTo(162.34f, 112.0f);
        pathBuilder.lineTo(149.17f, 98.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, -5.66f);
        pathBuilder.lineTo(168.0f, 106.34f);
        pathBuilder.lineToRelative(13.17f, -13.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, true, 5.66f, 5.66f);
        pathBuilder.close();
        pathBuilder.moveTo(106.83f, 98.83f);
        pathBuilder.lineTo(93.66f, 112.0f);
        pathBuilder.lineToRelative(13.17f, 13.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, 5.66f);
        pathBuilder.lineTo(88.0f, 117.66f);
        pathBuilder.lineTo(74.83f, 130.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, -5.66f);
        pathBuilder.lineTo(82.34f, 112.0f);
        pathBuilder.lineTo(69.17f, 98.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, -5.66f);
        pathBuilder.lineTo(88.0f, 106.34f);
        pathBuilder.lineToRelative(13.17f, -13.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, 5.66f);
        pathBuilder.close();
