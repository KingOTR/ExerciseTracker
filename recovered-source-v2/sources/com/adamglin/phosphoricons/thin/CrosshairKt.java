...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Crosshair", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getCrosshair", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_crosshair", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CrosshairKt {
    private static ImageVector _crosshair;

    public static final ImageVector getCrosshair(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(92.13f, 92.13f, 0.0f, false, false, 132.0f, 36.09f);
        pathBuilder.lineTo(132.0f, 24.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -8.0f, 0.0f);
        pathBuilder.lineTo(124.0f, 36.09f);
        pathBuilder.arcTo(92.13f, 92.13f, 0.0f, false, false, 36.09f, 124.0f);
        pathBuilder.lineTo(24.0f, 124.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, 8.0f);
        pathBuilder.lineTo(36.09f, 132.0f);
        pathBuilder.arcTo(92.13f, 92.13f, 0.0f, false, false, 124.0f, 219.91f);
        pathBuilder.lineTo(124.0f, 232.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 8.0f, 0.0f);
        pathBuilder.lineTo(132.0f, 219.91f);
        pathBuilder.arcTo(92.13f, 92.13f, 0.0f, false, false, 219.91f, 132.0f);
        pathBuilder.lineTo(232.0f, 132.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, -8.0f);
        pathBuilder.close();
        pathBuilder.moveTo(132.0f, 211.9f);
        ...
        pathBuilder.arcTo(84.11f, 84.11f, 0.0f, false, true, 124.0f, 44.1f);
        ...
        pathBuilder.arcTo(84.11f, 84.11f, 0.0f, false, true, 132.0f, 211.9f);
        pathBuilder.close();
