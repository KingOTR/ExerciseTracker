...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MessengerLogo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getMessengerLogo", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_messengerLogo", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class MessengerlogoKt {
    private static ImageVector _messengerLogo;

    public static final ImageVector getMessengerLogo(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(178.83f, 109.17f);
        ...
        pathBuilder.lineTo(112.0f, 117.66f);
        pathBuilder.lineTo(82.83f, 146.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, -5.66f);
        pathBuilder.lineToRelative(32.0f, -32.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, 0.0f);
        pathBuilder.lineTo(144.0f, 138.34f);
        pathBuilder.lineToRelative(29.17f, -29.17f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 178.83f, 109.17f);
        pathBuilder.close();
