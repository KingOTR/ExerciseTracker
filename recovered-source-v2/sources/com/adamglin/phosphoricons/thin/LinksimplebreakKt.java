...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"LinkSimpleBreak", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getLinkSimpleBreak", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_linkSimpleBreak", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class LinksimplebreakKt {
    private static ImageVector _linkSimpleBreak;

    public static final ImageVector getLinkSimpleBreak(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(212.79f, 116.77f);
        pathBuilder.lineToRelative(-30.07f, 30.06f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, true, -5.66f, -5.66f);
        pathBuilder.lineToRelative(30.07f, -30.06f);
        pathBuilder.arcToRelative(44.0f, 44.0f, 0.0f, false, false, -62.24f, -62.24f);
        pathBuilder.lineTo(114.82f, 78.93f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.65f, -5.66f);
        pathBuilder.lineToRelative(30.06f, -30.06f);
        pathBuilder.arcToRelative(52.0f, 52.0f, 0.0f, false, true, 73.56f, 73.56f);
        pathBuilder.close();
        pathBuilder.moveTo(141.17f, 177.06f);
        pathBuilder.lineTo(111.11f, 207.13f);
