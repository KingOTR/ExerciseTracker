...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowBendDoubleUpRight", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getArrowBendDoubleUpRight", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowBendDoubleUpRight", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowbenddoubleuprightKt {
    private static ImageVector _arrowBendDoubleUpRight;

    public static final ImageVector getArrowBendDoubleUpRight(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(218.34f, 104.0f);
        pathBuilder.lineTo(173.17f, 58.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, -5.66f);
        pathBuilder.lineToRelative(48.0f, 48.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 226.83f, 106.83f);
        pathBuilder.close();
        pathBuilder.moveTo(178.83f, 101.17f);
        pathBuilder.lineTo(130.83f, 53.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, -5.66f, 5.66f);
        pathBuilder.lineTo(166.34f, 100.0f);
        pathBuilder.lineTo(128.0f, 100.0f);
        pathBuilder.arcTo(100.11f, 100.11f, 0.0f, false, false, 28.0f, 200.0f);
        ...
        pathBuilder.lineToRelative(48.0f, -48.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 178.83f, 101.17f);
        pathBuilder.close();
