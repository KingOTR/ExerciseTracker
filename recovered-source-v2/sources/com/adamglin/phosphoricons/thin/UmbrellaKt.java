...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Umbrella", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getUmbrella", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_umbrella", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UmbrellaKt {
    private static ImageVector _umbrella;

    public static final ImageVector getUmbrella(ThinGroup thinGroup) {
        ...
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 12.0f, -13.0f);
        pathBuilder.close();
        pathBuilder.moveTo(32.0f, 132.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, -4.38f);
        pathBuilder.arcToRelative(100.2f, 100.2f, 0.0f, false, true, 89.73f, -91.09f);
        pathBuilder.curveTo(106.0f, 49.76f, 85.08f, 80.45f, 84.0f, 132.0f);
        pathBuilder.close();
        pathBuilder.moveTo(92.0f, 132.0f);
        pathBuilder.curveToRelative(1.21f, -56.0f, 27.6f, -86.37f, 35.94f, -94.57f);
        pathBuilder.curveTo(136.35f, 45.64f, 162.73f, 76.0f, 163.94f, 132.0f);
        pathBuilder.close();
        pathBuilder.moveTo(226.87f, 130.7f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.0f, 1.3f);
        pathBuilder.lineTo(172.0f, 132.0f);
        pathBuilder.curveToRelative(-1.0f, -51.55f, -22.0f, -82.24f, -33.7f, -95.47f);
        pathBuilder.arcTo(100.2f, 100.2f, 0.0f, false, true, 228.0f, 127.62f);
