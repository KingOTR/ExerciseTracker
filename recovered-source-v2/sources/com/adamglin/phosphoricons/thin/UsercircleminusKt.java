...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserCircleMinus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getUserCircleMinus", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userCircleMinus", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsercircleminusKt {
    private static ImageVector _userCircleMinus;

    public static final ImageVector getUserCircleMinus(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(222.31f, 94.67f);
        pathBuilder.arcTo(100.0f, 100.0f, 0.0f, true, true, 128.0f, 28.0f);
        pathBuilder.arcToRelative(100.69f, 100.69f, 0.0f, false, true, 16.66f, 1.38f);
        ...
        pathBuilder.arcToRelative(75.61f, 75.61f, 0.0f, false, true, 44.51f, 34.0f);
        pathBuilder.arcToRelative(92.0f, 92.0f, 0.0f, false, false, 21.6f, -95.54f);
