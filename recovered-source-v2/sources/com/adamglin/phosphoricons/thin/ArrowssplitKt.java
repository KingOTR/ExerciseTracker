...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsSplit", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getArrowsSplit", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsSplit", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowssplitKt {
    private static ImageVector _arrowsSplit;

    public static final ImageVector getArrowsSplit(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(226.83f, 186.83f);
        ...
        pathBuilder.lineTo(188.0f, 206.34f);
        pathBuilder.verticalLineTo(137.66f);
        pathBuilder.lineToRelative(-60.0f, -60.0f);
        pathBuilder.lineToRelative(-60.0f, 60.0f);
        pathBuilder.verticalLineToRelative(68.68f);
        ...
        pathBuilder.lineToRelative(-32.0f, -32.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.66f, -5.66f);
        pathBuilder.lineTo(60.0f, 206.34f);
        ...
        pathBuilder.verticalLineTo(70.34f);
        pathBuilder.lineToRelative(62.83f, 62.83f);
