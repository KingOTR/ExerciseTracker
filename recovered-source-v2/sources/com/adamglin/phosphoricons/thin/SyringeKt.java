...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Syringe", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getSyringe", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_syringe", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SyringeKt {
    private static ImageVector _syringe;

    public static final ImageVector getSyringe(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(74.0f, 131.66f);
        pathBuilder.lineToRelative(23.17f, 23.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, 5.66f, -5.66f);
        pathBuilder.lineTo(79.66f, 126.0f);
        pathBuilder.lineTo(98.0f, 107.66f);
        pathBuilder.lineToRelative(23.17f, 23.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.66f, -5.66f);
        pathBuilder.lineTo(103.66f, 102.0f);
        pathBuilder.lineTo(140.0f, 65.66f);
        pathBuilder.lineToRelative(25.17f, 25.17f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.lineTo(190.34f, 116.0f);
        pathBuilder.close();
