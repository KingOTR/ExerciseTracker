...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Calendar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getCalendar", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_calendar", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class CalendarKt {
    private static ImageVector _calendar;

    public static final ImageVector getCalendar(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(48.0f, 44.0f);
        ...
        pathBuilder.lineTo(100.0f, 126.47f);
        pathBuilder.lineToRelative(-10.21f, 5.11f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.58f, -7.16f);
        pathBuilder.lineToRelative(16.0f, -8.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 108.0f, 120.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(28.78f, -38.37f);
        pathBuilder.arcTo(11.88f, 11.88f, 0.0f, false, false, 164.0f, 136.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -22.4f, -6.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -6.92f, -4.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 172.0f, 136.0f);
        pathBuilder.arcTo(19.79f, 19.79f, 0.0f, false, true, 168.0f, 148.0f);
        pathBuilder.close();
