...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"AddressBookTabs", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getAddressBookTabs", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_addressBookTabs", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class AddressbooktabsKt {
    private static ImageVector _addressBookTabs;

    public static final ImageVector getAddressBookTabs(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(188.0f, 92.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(147.88f, 167.0f);
        pathBuilder.arcToRelative(36.24f, 36.24f, 0.0f, false, false, -20.44f, -23.67f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, false, -30.88f, 0.0f);
        pathBuilder.arcTo(36.28f, 36.28f, 0.0f, false, false, 76.13f, 167.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 79.0f, 171.87f);
        ...
        pathBuilder.curveTo(87.0f, 157.0f, 99.05f, 148.0f, 112.0f, 148.0f);
        pathBuilder.reflectiveCurveToRelative(25.05f, 9.0f, 28.12f, 21.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 7.76f, -2.0f);
        pathBuilder.close();
        pathBuilder.moveTo(92.0f, 120.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, true, true, 20.0f, 20.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, true, 92.0f, 120.0f);
        pathBuilder.close();
