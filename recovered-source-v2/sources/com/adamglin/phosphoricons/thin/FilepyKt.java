...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FilePy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getFilePy", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_filePy", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilepyKt {
    private static ImageVector _filePy;

    public static final ImageVector getFilePy(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(151.39f, 154.12f);
        pathBuilder.lineTo(132.0f, 185.12f);
        pathBuilder.lineTo(132.0f, 208.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -8.0f, 0.0f);
        pathBuilder.lineTo(124.0f, 185.15f);
        pathBuilder.lineToRelative(-19.39f, -31.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 6.78f, -4.24f);
        pathBuilder.lineTo(128.0f, 176.45f);
        pathBuilder.lineToRelative(16.61f, -26.57f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, true, 6.78f, 4.24f);
        pathBuilder.close();
