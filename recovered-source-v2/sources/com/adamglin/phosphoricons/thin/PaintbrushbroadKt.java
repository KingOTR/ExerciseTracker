...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PaintBrushBroad", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getPaintBrushBroad", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_paintBrushBroad", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PaintbrushbroadKt {
    private static ImageVector _paintBrushBroad;

    public static final ImageVector getPaintBrushBroad(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 36.0f, 64.0f);
        pathBuilder.verticalLineToRelative(72.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, 20.0f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.0f, 4.52f);
        pathBuilder.lineToRelative(-7.9f, 46.81f);
        pathBuilder.arcToRelative(3.79f, 3.79f, 0.0f, false, false, -0.06f, 0.67f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, false, false, 56.0f, 0.0f);
        pathBuilder.arcToRelative(3.79f, 3.79f, 0.0f, false, false, -0.06f, -0.67f);
        pathBuilder.lineTo(148.0f, 160.52f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.0f, -4.52f);
        pathBuilder.horizontalLineToRelative(48.0f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, -20.0f);
        pathBuilder.verticalLineTo(32.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 216.0f, 28.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 72.0f, 36.0f);
        pathBuilder.close();
        pathBuilder.moveTo(200.0f, 148.0f);
        pathBuilder.horizontalLineTo(152.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, -11.88f, 13.7f);
        pathBuilder.reflectiveCurveToRelative(0.0f, 0.06f, 0.0f, 0.1f);
        pathBuilder.lineTo(148.0f, 208.32f);
        pathBuilder.arcToRelative(20.0f, 20.0f, 0.0f, false, true, -40.0f, 0.0f);
        pathBuilder.lineToRelative(7.86f, -46.52f);
        pathBuilder.reflectiveCurveToRelative(0.0f, -0.07f, 0.0f, -0.1f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, false, 104.0f, 148.0f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 200.0f, 148.0f);
        pathBuilder.close();
