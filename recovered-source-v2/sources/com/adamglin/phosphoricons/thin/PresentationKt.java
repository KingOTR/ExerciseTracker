...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Presentation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getPresentation", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_presentation", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PresentationKt {
    private static ImageVector _presentation;

    public static final ImageVector getPresentation(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(87.68f, 188.0f);
        pathBuilder.lineToRelative(-26.8f, 33.5f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, 6.24f, 5.0f);
        pathBuilder.lineTo(97.92f, 188.0f);
        pathBuilder.horizontalLineToRelative(60.16f);
        pathBuilder.lineToRelative(30.8f, 38.5f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 6.24f, -5.0f);
        pathBuilder.lineTo(168.32f, 188.0f);
