...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Bookmark", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getBookmark", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_bookmark", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BookmarkKt {
    private static ImageVector _bookmark;

    public static final ImageVector getBookmark(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(188.0f, 168.78f);
        pathBuilder.lineToRelative(-57.89f, -36.17f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.24f, 0.0f);
        pathBuilder.lineTo(68.0f, 168.78f);
        pathBuilder.lineTo(68.0f, 48.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 72.0f, 44.0f);
        pathBuilder.close();
        pathBuilder.moveTo(130.11f, 180.61f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.24f, 0.0f);
        pathBuilder.lineTo(68.0f, 216.78f);
        pathBuilder.lineTo(68.0f, 178.22f);
        pathBuilder.lineToRelative(60.0f, -37.5f);
        pathBuilder.lineToRelative(60.0f, 37.5f);
        pathBuilder.verticalLineToRelative(38.56f);
        pathBuilder.close();
