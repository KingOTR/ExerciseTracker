...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"EscalatorDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getEscalatorDown", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_escalatorDown", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class EscalatordownKt {
    private static ImageVector _escalatorDown;

    public static final ImageVector getEscalatorDown(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(173.17f, 82.83f);
        ...
        pathBuilder.lineTo(204.0f, 94.34f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.94f, -1.29f);
        pathBuilder.lineTo(70.25f, 108.0f);
        pathBuilder.lineTo(32.0f, 108.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 20.0f, 96.0f);
        pathBuilder.lineTo(20.0f, 56.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 32.0f, 44.0f);
        pathBuilder.lineTo(88.0f, 44.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 2.94f, 1.29f);
        pathBuilder.lineTo(185.75f, 148.0f);
        pathBuilder.lineTo(224.0f, 148.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 236.0f, 160.0f);
        pathBuilder.close();
        pathBuilder.moveTo(228.0f, 160.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.0f, -4.0f);
        pathBuilder.lineTo(184.0f, 156.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.94f, -1.29f);
        pathBuilder.lineTo(86.25f, 52.0f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 2.94f, 1.29f);
        pathBuilder.lineTo(169.75f, 204.0f);
