...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PhoneTransfer", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getPhoneTransfer", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_phoneTransfer", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PhonetransferKt {
    private static ImageVector _phoneTransfer;

    public static final ImageVector getPhoneTransfer(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(181.17f, 42.83f);
        ...
        pathBuilder.lineToRelative(-32.0f, 32.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.66f, -5.66f);
        pathBuilder.lineTo(206.34f, 76.0f);
        pathBuilder.lineTo(144.0f, 76.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 140.0f, 72.0f);
        pathBuilder.close();
        pathBuilder.moveTo(219.91f, 182.58f);
        pathBuilder.arcTo(52.26f, 52.26f, 0.0f, false, true, 168.0f, 228.0f);
        pathBuilder.curveTo(90.8f, 228.0f, 28.0f, 165.2f, 28.0f, 88.0f);
        pathBuilder.arcTo(52.26f, 52.26f, 0.0f, false, true, 73.42f, 36.09f);
        ...
        pathBuilder.arcToRelative(3.47f, 3.47f, 0.0f, false, true, -0.29f, 0.38f);
        pathBuilder.lineTo(84.56f, 127.37f);
        pathBuilder.arcToRelative(3.9f, 3.9f, 0.0f, false, false, -0.18f, 3.69f);
        pathBuilder.curveToRelative(7.83f, 16.05f, 24.65f, 32.73f, 40.89f, 40.57f);
        pathBuilder.arcToRelative(3.9f, 3.9f, 0.0f, false, false, 3.7f, -0.21f);
        pathBuilder.lineTo(153.8f, 150.3f);
        pathBuilder.arcToRelative(3.27f, 3.27f, 0.0f, false, true, 0.37f, -0.28f);
        ...
        pathBuilder.arcTo(132.14f, 132.14f, 0.0f, false, false, 168.0f, 220.0f);
