...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"PersonSimpleBike", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getPersonSimpleBike", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_personSimpleBike", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class PersonsimplebikeKt {
    private static ImageVector _personSimpleBike;

    public static final ImageVector getPersonSimpleBike(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 200.0f, 140.0f);
        pathBuilder.close();
        pathBuilder.moveTo(200.0f, 204.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, true, 28.0f, -28.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 200.0f, 204.0f);
        pathBuilder.close();
        pathBuilder.moveTo(56.0f, 140.0f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, true, false, 36.0f, 36.0f);
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 56.0f, 140.0f);
        pathBuilder.close();
        pathBuilder.moveTo(56.0f, 204.0f);
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, true, 28.0f, -28.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 56.0f, 204.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(120.0f, 85.66f);
        pathBuilder.lineTo(93.66f, 112.0f);
        pathBuilder.lineToRelative(37.17f, 37.17f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 132.0f, 152.0f);
        pathBuilder.verticalLineToRelative(48.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -8.0f, 0.0f);
        pathBuilder.lineTo(124.0f, 153.66f);
        pathBuilder.lineTo(85.17f, 114.83f);
        ...
        pathBuilder.lineTo(192.0f, 108.0f);
