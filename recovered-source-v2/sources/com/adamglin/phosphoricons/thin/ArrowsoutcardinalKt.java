...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ArrowsOutCardinal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getArrowsOutCardinal", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_arrowsOutCardinal", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArrowsoutcardinalKt {
    private static ImageVector _arrowsOutCardinal;

    public static final ImageVector getArrowsOutCardinal(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(93.17f, 58.83f);
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 93.17f, 58.83f);
        pathBuilder.close();
        pathBuilder.moveTo(157.17f, 197.17f);
        pathBuilder.lineTo(132.0f, 222.34f);
        pathBuilder.lineTo(132.0f, 160.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -8.0f, 0.0f);
        pathBuilder.verticalLineToRelative(62.34f);
        pathBuilder.lineTo(98.83f, 197.17f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(33.66f, 132.0f);
        pathBuilder.lineTo(96.0f, 132.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, -8.0f);
        pathBuilder.lineTo(33.66f, 124.0f);
        pathBuilder.lineTo(58.83f, 98.83f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -5.66f, -5.66f);
        pathBuilder.lineToRelative(-32.0f, 32.0f);
