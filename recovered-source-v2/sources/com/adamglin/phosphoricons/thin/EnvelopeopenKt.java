...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"EnvelopeOpen", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getEnvelopeOpen", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_envelopeOpen", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class EnvelopeopenKt {
    private static ImageVector _envelopeOpen;

    public static final ImageVector getEnvelopeOpen(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(103.63f, 152.0f);
        pathBuilder.lineTo(36.0f, 199.76f);
        pathBuilder.verticalLineToRelative(-96.0f);
        pathBuilder.close();
        pathBuilder.moveTo(111.82f, 156.0f);
        pathBuilder.horizontalLineToRelative(32.36f);
        pathBuilder.lineToRelative(68.0f, 48.0f);
        pathBuilder.lineTo(43.86f, 204.0f);
        pathBuilder.close();
        pathBuilder.moveTo(152.37f, 152.0f);
        ...
        pathBuilder.lineTo(111.83f, 148.0f);
