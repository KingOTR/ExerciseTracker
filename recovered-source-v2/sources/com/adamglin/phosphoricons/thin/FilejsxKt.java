...
/* compiled from: Filejsx.kt */
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileJsx", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getFileJsx", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileJsx", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilejsxKt {
    private static ImageVector _fileJsx;

    public static final ImageVector getFileJsx(ThinGroup thinGroup) {
        Intrinsics.checkNotNullParameter(thinGroup, "<this>");
        ImageVector imageVector = _fileJsx;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        float f = (float) 24.0d;
        ImageVector.Builder builder = new ImageVector.Builder("FileJsx", Dp.m6303constructorimpl(f), Dp.m6303constructorimpl(f), 256.0f, 256.0f, 0L, 0, false, 224, null);
        SolidColor solidColor = new SolidColor(ColorKt.Color(4278190080L), null);
        int m4196getButtKaPHkGw = StrokeCap.INSTANCE.m4196getButtKaPHkGw();
        int m4207getMiterLxFBmk8 = StrokeJoin.INSTANCE.m4207getMiterLxFBmk8();
        int m4126getNonZeroRgk1Os = PathFillType.INSTANCE.m4126getNonZeroRgk1Os();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(143.84f, 195.8f);
        ...
        pathBuilder.arcTo(57.89f, 57.89f, 0.0f, false, true, 107.0f, 210.11f);
        ...
        pathBuilder.curveTo(132.26f, 178.0f, 145.64f, 181.84f, 143.84f, 195.8f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 72.0f, 148.0f);
        pathBuilder.close();
        pathBuilder.moveTo(210.32f, 148.75f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -5.58f, 0.92f);
        pathBuilder.lineTo(188.0f, 173.12f);
        pathBuilder.lineToRelative(-16.75f, -23.45f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -6.51f, 4.66f);
        pathBuilder.lineTo(183.08f, 180.0f);
        pathBuilder.lineToRelative(-18.34f, 25.67f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.93f, 5.58f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.58f, -0.92f);
        pathBuilder.lineTo(188.0f, 186.88f);
        pathBuilder.lineToRelative(16.74f, 23.45f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 208.0f, 212.0f);
        pathBuilder.arcToRelative(3.91f, 3.91f, 0.0f, false, false, 2.32f, -0.75f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.93f, -5.58f);
        pathBuilder.lineTo(192.92f, 180.0f);
        pathBuilder.lineToRelative(18.33f, -25.67f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 210.32f, 148.75f);
        pathBuilder.close();
