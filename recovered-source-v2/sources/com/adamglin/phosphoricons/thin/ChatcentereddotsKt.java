...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"ChatCenteredDots", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getChatCenteredDots", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_chatCenteredDots", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ChatcentereddotsKt {
    private static ImageVector _chatCenteredDots;

    public static final ImageVector getChatCenteredDots(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, true, 136.0f, 120.0f);
        pathBuilder.close();
        pathBuilder.moveTo(84.0f, 112.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 8.0f, 8.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 84.0f, 112.0f);
        pathBuilder.close();
        pathBuilder.moveTo(172.0f, 112.0f);
        pathBuilder.arcToRelative(8.0f, 8.0f, 0.0f, true, false, 8.0f, 8.0f);
        pathBuilder.arcTo(8.0f, 8.0f, 0.0f, false, false, 172.0f, 112.0f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(138.42f, 222.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, true, -20.84f, 0.0f);
        pathBuilder.lineTo(102.75f, 196.0f);
