...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"FileSql", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getFileSql", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_fileSql", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FilesqlKt {
    private static ImageVector _fileSql;

    public static final ImageVector getFileSql(ThinGroup thinGroup) {
        ...
        pathBuilder.lineTo(198.35f, 84.0f);
        ...
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, -4.0f);
        pathBuilder.lineTo(188.0f, 152.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, 8.0f, 0.0f);
        pathBuilder.verticalLineToRelative(52.0f);
        pathBuilder.horizontalLineToRelative(24.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 224.0f, 208.0f);
        pathBuilder.close();
        pathBuilder.moveTo(87.85f, 195.8f);
        pathBuilder.arcToRelative(17.0f, 17.0f, 0.0f, false, true, -7.43f, 12.41f);
        pathBuilder.curveTo(76.0f, 211.12f, 70.38f, 212.0f, 65.2f, 212.0f);
        pathBuilder.arcTo(57.89f, 57.89f, 0.0f, false, true, 51.0f, 210.11f);
        ...
        pathBuilder.arcToRelative(61.11f, 61.11f, 0.0f, false, true, 10.47f, 1.61f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.0f, 7.74f);
        pathBuilder.curveToRelative(-4.3f, -1.13f, -16.81f, -3.12f, -23.06f, 1.11f);
        pathBuilder.arcToRelative(8.53f, 8.53f, 0.0f, false, false, -3.75f, 6.49f);
        pathBuilder.curveToRelative(-0.66f, 5.17f, 3.89f, 7.0f, 14.42f, 10.08f);
        pathBuilder.curveTo(76.27f, 178.0f, 89.65f, 181.84f, 87.85f, 195.8f);
        pathBuilder.close();
        pathBuilder.moveTo(136.0f, 148.0f);
        pathBuilder.curveToRelative(-15.44f, 0.0f, -28.0f, 14.35f, -28.0f, 32.0f);
        pathBuilder.reflectiveCurveToRelative(12.56f, 32.0f, 28.0f, 32.0f);
        pathBuilder.arcToRelative(25.56f, 25.56f, 0.0f, false, false, 16.31f, -6.0f);
        pathBuilder.lineToRelative(4.86f, 4.85f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.65f, -5.66f);
        pathBuilder.lineToRelative(-5.06f, -5.06f);
        pathBuilder.arcTo(34.82f, 34.82f, 0.0f, false, false, 164.0f, 180.0f);
        pathBuilder.curveTo(164.0f, 162.35f, 151.44f, 148.0f, 136.0f, 148.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcToRelative(27.16f, 27.16f, 0.0f, false, true, -4.0f, 14.36f);
        pathBuilder.lineToRelative(-5.19f, -5.19f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, true, false, -5.65f, 5.66f);
        pathBuilder.lineToRelative(5.47f, 5.47f);
        pathBuilder.arcTo(17.5f, 17.5f, 0.0f, false, true, 136.0f, 204.0f);
        pathBuilder.close();
