...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Armchair", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getArmchair", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_armchair", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ArmchairKt {
    private static ImageVector _armchair;

    public static final ImageVector getArmchair(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(212.0f, 92.23f);
        ...
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 44.0f, 72.0f);
        pathBuilder.verticalLineTo(92.23f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, false, false, 0.0f, 71.55f);
        pathBuilder.verticalLineTo(200.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 12.0f, 12.0f);
        pathBuilder.horizontalLineTo(200.0f);
        pathBuilder.arcToRelative(12.0f, 12.0f, 0.0f, false, false, 12.0f, -12.0f);
        pathBuilder.verticalLineTo(163.78f);
        pathBuilder.arcToRelative(36.0f, 36.0f, 0.0f, false, false, 0.0f, -71.55f);
        pathBuilder.close();
        ...
        pathBuilder.verticalLineTo(92.23f);
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 172.0f, 128.0f);
        pathBuilder.verticalLineToRelative(4.0f);
        pathBuilder.horizontalLineTo(84.0f);
        pathBuilder.verticalLineToRelative(-4.0f);
        pathBuilder.arcTo(36.0f, 36.0f, 0.0f, false, false, 52.0f, 92.23f);
        pathBuilder.verticalLineTo(72.0f);
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, false, true, 80.0f, 44.0f);
        pathBuilder.close();
        pathBuilder.moveTo(208.3f, 156.0f);
        ...
        pathBuilder.arcTo(28.0f, 28.0f, 0.0f, true, true, 76.0f, 128.0f);
        pathBuilder.verticalLineToRelative(40.0f);
        ...
        pathBuilder.arcToRelative(28.0f, 28.0f, 0.0f, true, true, 28.3f, 28.0f);
        pathBuilder.close();
