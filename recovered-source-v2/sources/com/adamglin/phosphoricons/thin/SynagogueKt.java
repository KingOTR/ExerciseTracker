...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Synagogue", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getSynagogue", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_synagogue", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SynagogueKt {
    private static ImageVector _synagogue;

    public static final ImageVector getSynagogue(ThinGroup thinGroup) {
        ...
        pathBuilder.moveTo(204.0f, 60.4f);
        pathBuilder.lineTo(204.0f, 32.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -8.0f, 0.0f);
        pathBuilder.lineTo(196.0f, 60.4f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 180.0f, 80.0f);
        pathBuilder.verticalLineToRelative(49.11f);
        pathBuilder.lineToRelative(-48.0f, -27.43f);
        pathBuilder.lineTo(132.0f, 72.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -8.0f, 0.0f);
        pathBuilder.verticalLineToRelative(29.68f);
        pathBuilder.lineTo(76.0f, 129.11f);
        pathBuilder.lineTo(76.0f, 80.0f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 60.0f, 60.4f);
        pathBuilder.lineTo(60.0f, 32.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, -8.0f, 0.0f);
        pathBuilder.lineTo(52.0f, 60.4f);
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 36.0f, 80.0f);
        ...
        pathBuilder.arcTo(20.0f, 20.0f, 0.0f, false, false, 204.0f, 60.4f);
        pathBuilder.close();
        ...
        pathBuilder.lineTo(188.0f, 80.0f);
        ...
        pathBuilder.verticalLineToRelative(28.0f);
        pathBuilder.lineTo(44.0f, 108.0f);
        pathBuilder.lineTo(44.0f, 80.0f);
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 56.0f, 68.0f);
        pathBuilder.close();
        pathBuilder.moveTo(44.0f, 116.0f);
        ...
        pathBuilder.lineTo(76.0f, 138.32f);
