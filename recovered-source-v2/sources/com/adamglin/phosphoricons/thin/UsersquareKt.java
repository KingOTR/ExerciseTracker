...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"UserSquare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getUserSquare", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_userSquare", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UsersquareKt {
    private static ImageVector _userSquare;

    public static final ImageVector getUserSquare(ThinGroup thinGroup) {
        ...
        pathBuilder.close();
        pathBuilder.moveTo(63.0f, 212.0f);
        pathBuilder.arcToRelative(68.0f, 68.0f, 0.0f, false, true, 130.0f, 0.0f);
        pathBuilder.close();
        pathBuilder.moveTo(212.0f, 208.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, 4.0f);
        pathBuilder.horizontalLineToRelative(-6.66f);
        pathBuilder.arcToRelative(76.0f, 76.0f, 0.0f, false, false, -52.75f, -53.13f);
        pathBuilder.arcToRelative(44.0f, 44.0f, 0.0f, true, false, -41.18f, 0.0f);
        pathBuilder.arcTo(76.0f, 76.0f, 0.0f, false, false, 54.66f, 212.0f);
