...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Briefcase", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getBriefcase", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_briefcase", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class BriefcaseKt {
    private static ImageVector _briefcase;

    public static final ImageVector getBriefcase(ThinGroup thinGroup) {
        ...
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, true, 108.0f, 112.0f);
        pathBuilder.close();
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 40.0f, 60.0f);
        ...
        pathBuilder.arcTo(12.0f, 12.0f, 0.0f, false, true, 228.0f, 72.0f);
        pathBuilder.close();
        pathBuilder.moveTo(92.0f, 60.0f);
        ...
        pathBuilder.arcToRelative(188.0f, 188.0f, 0.0f, false, false, 92.0f, 24.0f);
        pathBuilder.arcToRelative(188.0f, 188.0f, 0.0f, false, false, 92.0f, -24.0f);
        pathBuilder.verticalLineTo(72.0f);
        ...
        pathBuilder.verticalLineTo(125.1f);
        pathBuilder.arcTo(196.06f, 196.06f, 0.0f, false, true, 128.0f, 148.0f);
        pathBuilder.arcToRelative(196.0f, 196.0f, 0.0f, false, true, -92.0f, -22.9f);
        pathBuilder.verticalLineTo(200.0f);
        pathBuilder.arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, 4.0f);
        pathBuilder.horizontalLineTo(216.0f);
        pathBuilder.arcTo(4.0f, 4.0f, 0.0f, false, false, 220.0f, 200.0f);
        pathBuilder.close();
