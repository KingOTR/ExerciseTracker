...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0000\u001a\u00020\u0001*\u00020\u00028F¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004\"\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Seal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lcom/adamglin/phosphoricons/ThinGroup;", "getSeal", "(Lcom/adamglin/phosphoricons/ThinGroup;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_seal", "phosphor_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SealKt {
    private static ImageVector _seal;

    public static final ImageVector getSeal(ThinGroup thinGroup) {
        ...
        pathBuilder.curveToRelative(-4.26f, -1.76f, -8.6f, -5.93f, -12.8f, -10.0f);
        pathBuilder.curveToRelative(-6.68f, -6.4f, -13.59f, -13.0f, -22.42f, -13.0f);
        ...
        pathBuilder.curveToRelative(6.55f, 6.54f, 16.75f, 6.69f, 25.74f, 6.83f);
        pathBuilder.curveToRelative(5.88f, 0.09f, 11.43f, 0.17f, 15.41f, 1.82f);
        pathBuilder.curveToRelative(4.26f, 1.76f, 8.6f, 5.93f, 12.8f, 10.0f);
        pathBuilder.curveToRelative(6.68f, 6.4f, 13.59f, 13.0f, 22.42f, 13.0f);
        pathBuilder.reflectiveCurveToRelative(15.74f, -6.62f, 22.42f, -13.0f);
        ...
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder.curveToRelative(-4.25f, -4.25f, -4.37f, -12.0f, -4.49f, -20.2f);
