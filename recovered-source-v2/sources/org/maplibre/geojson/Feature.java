...
public final class Feature implements GeoJson {
    ...
    public String toJson() {
        ...
        if (properties().size() == 0) {
            this = new Feature(TYPE, bbox(), id(), geometry(), null);
        }
    ...
    static final class GsonTypeAdapter extends TypeAdapter<Feature> {
        ...
        public Feature mo7884read(JsonReader jsonReader) throws IOException {
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    switch (nextName) {
                        case "properties":
                            ...
                            jsonObject = typeAdapter.mo7884read(jsonReader);
                            break;
                        case "id":
                            ...
                            str2 = typeAdapter2.mo7884read(jsonReader);
                            break;
                        case "bbox":
                            ...
                            boundingBox = typeAdapter3.mo7884read(jsonReader);
                            break;
                        case "type":
                            ...
                            str = typeAdapter4.mo7884read(jsonReader);
                            break;
                        case "geometry":
                            ...
                            geometry = typeAdapter5.mo7884read(jsonReader);
                            break;
                        default:
