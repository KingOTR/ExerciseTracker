...
public final class MultiLineString implements CoordinateContainer<List<List<Point>>> {
    ...
    public int hashCode() {
        ...
        return this.coordinates.hashCode() ^ ((hashCode ^ (boundingBox == null ? 0 : boundingBox.hashCode())) * 1000003);
    }
    ...
    static final class GsonTypeAdapter extends BaseGeometryTypeAdapter<MultiLineString, List<List<Point>>> {
        ...
        @Override // com.google.gson.TypeAdapter
        /* renamed from: read */
        public MultiLineString mo7884read(JsonReader jsonReader) throws IOException {
