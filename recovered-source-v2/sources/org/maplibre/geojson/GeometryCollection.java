...
public final class GeometryCollection implements Geometry {
    ...
    public int hashCode() {
        ...
        return this.geometries.hashCode() ^ ((hashCode ^ (boundingBox == null ? 0 : boundingBox.hashCode())) * 1000003);
    }
    ...
    static final class GsonTypeAdapter extends TypeAdapter<GeometryCollection> {
        ...
        public GeometryCollection mo7884read(JsonReader jsonReader) throws IOException {
            String str = null;
                ...
                if (jsonReader.peek() == JsonToken.NULL) {
                    ...
                    switch (nextName) {
                        case "bbox":
                            ...
                            boundingBox = typeAdapter.mo7884read(jsonReader);
                            break;
                        case "type":
                            ...
                            str = typeAdapter2.mo7884read(jsonReader);
                            break;
                        case "geometries":
                            TypeAdapter<List<Geometry>> typeAdapter3 = this.listGeometryAdapter;
                            if (typeAdapter3 == null) {
                            ...
                            list = typeAdapter3.mo7884read(jsonReader);
                            break;
                        default:
