...
public class AnimatorUtils {
    ...
    public static void animate(final View view, int i, int i2, final OnAnimationEndListener onAnimationEndListener) {
        ...
        loadAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.maplibre.android.utils.AnimatorUtils.1
    ...
    public static void rotate(final View view, float f) {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() { // from class: org.maplibre.android.utils.AnimatorUtils.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
                view.setLayerType(0, null);
    ...
    public static void alpha(final View view, float f, final OnAnimationEndListener onAnimationEndListener) {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() { // from class: org.maplibre.android.utils.AnimatorUtils.4
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
