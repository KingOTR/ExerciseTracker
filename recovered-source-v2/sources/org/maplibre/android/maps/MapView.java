...
public class MapView extends FrameLayout implements NativeMapView.ViewCallback {
    ...
    private void initializeDrawingSurface(MapLibreMapOptions mapLibreMapOptions) {
        MapRenderer create = MapRenderer.create(mapLibreMapOptions, getContext(), new Runnable() { // from class: org.maplibre.android.maps.MapView$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                MapView.this.m9815x6869dc55();
            }
        });
