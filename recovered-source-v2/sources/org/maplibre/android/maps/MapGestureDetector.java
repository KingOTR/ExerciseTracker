...
final class MapGestureDetector {
    ...
    private final class StandardGestureListener extends StandardGestureDetector.SimpleStandardOnGestureListener {
        ...
        public boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
            ...
            if (hypot < MapGestureDetector.this.uiSettings.getFlingThreshold()) {
                return false;
            }
            double tilt = MapGestureDetector.this.transform.getTilt();
            long flingAnimationBaseTime = (long) (((hypot / 7.0d) / ((tilt != 0.0d ? tilt / 10.0d : 0.0d) + 1.5d)) + MapGestureDetector.this.uiSettings.getFlingAnimationBaseTime());
