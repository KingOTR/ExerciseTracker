...
public class Style {
    ...
    public static Image toImage(Builder.ImageWrapper imageWrapper) {
        ...
        if (imageWrapper.getStretchX() != null && imageWrapper.getStretchY() != null) {
            ...
            return new Image(allocate.array(), density, imageWrapper.id, bitmap.getWidth(), bitmap.getHeight(), imageWrapper.sdf, fArr, fArr2, imageWrapper.getContent() == null ? null : imageWrapper.getContent().getContentArray());
        }
    ...
    public static String getPredefinedStyle(String str) {
        DefaultStyle predefinedStyle = MapLibre.getPredefinedStyle(str);
