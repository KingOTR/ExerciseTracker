...
public final class OfflineManager$invalidateAmbientCache$1 implements OfflineManager.FileSourceCallback {
    final /* synthetic */ OfflineManager.FileSourceCallback $callback;
    final /* synthetic */ OfflineManager this$0;

    OfflineManager$invalidateAmbientCache$1(OfflineManager offlineManager, OfflineManager.FileSourceCallback fileSourceCallback) {
    ...
    public void onSuccess() {
        ...
        handler.post(new Runnable() { // from class: org.maplibre.android.offline.OfflineManager$invalidateAmbientCache$1$$ExternalSyntheticLambda1
            ...
            public final void run() {
                OfflineManager$invalidateAmbientCache$1.onSuccess$lambda$0(OfflineManager.this, fileSourceCallback);
            }
        });
    }
    ...
    public void onError(final String message) {
        ...
        handler.post(new Runnable() { // from class: org.maplibre.android.offline.OfflineManager$invalidateAmbientCache$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                OfflineManager$invalidateAmbientCache$1.onError$lambda$1(OfflineManager.this, fileSourceCallback, message);
            }
        });
    }
