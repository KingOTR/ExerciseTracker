...
public final class GeoJsonSource extends Source {
    ...
    public GeoJsonSource(String str, String str2, GeoJsonOptions geoJsonOptions) {
        if (str2 == null || StringsKt.startsWith$default(str2, ProxyConfig.MATCH_HTTP, false, 2, (Object) null) || StringsKt.startsWith$default(str2, "asset", false, 2, (Object) null) || StringsKt.startsWith$default(str2, "file", false, 2, (Object) null)) {
            throw new IllegalArgumentException("Expected a raw json body".toString());
        }
        initialize(str, geoJsonOptions);
        setGeoJson(str2);
