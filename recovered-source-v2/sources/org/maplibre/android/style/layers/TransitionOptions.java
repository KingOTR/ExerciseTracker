...
public class TransitionOptions {
    ...
    public String toString() {
        return "TransitionOptions{duration=" + this.duration + ", delay=" + this.delay + ", enablePlacementTransitions=" + this.enablePlacementTransitions + AbstractJsonLexerKt.END_OBJ;
    }
}
