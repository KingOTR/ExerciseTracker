...
public class PropertyFactory {
    ...
    public static PropertyValue<String> lineGradient(int i) {
    ...
    public static PropertyValue<String> heatmapColor(int i) {
    ...
    public static PropertyValue<String> hillshadeShadowColor(int i) {
    ...
    public static PropertyValue<String> hillshadeHighlightColor(int i) {
    ...
    public static PropertyValue<String> hillshadeAccentColor(int i) {
    ...
    public static PropertyValue<Float[]> iconPadding(Float[] fArr) {
    ...
    public static PropertyValue<Object[]> textVariableAnchorOffset(Object[] objArr) {
        return new LayoutPropertyValue("text-variable-anchor-offset", objArr);
    }

    public static PropertyValue<Expression> textVariableAnchorOffset(Expression expression) {
        return new LayoutPropertyValue("text-variable-anchor-offset", expression);
    }
