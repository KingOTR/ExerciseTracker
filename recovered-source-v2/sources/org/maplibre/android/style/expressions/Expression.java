...
public class Expression {
    ...
    public static Expression all(Expression... expressionArr) {
        return new Expression(SVGParser.XML_STYLESHEET_ATTR_MEDIA_ALL, expressionArr);
    }
    ...
    public static Expression indexOf(Expression expression, Expression expression2) {
        return new Expression("index-of", expression, expression2);
    }

    public static Expression indexOf(Expression expression, Expression expression2, Expression expression3) {
        return new Expression("index-of", expression, expression2, expression3);
    }

    public static Expression slice(Expression expression, Expression expression2) {
        return new Expression("slice", expression, expression2);
    }

    public static Expression slice(Expression expression, Expression expression2, Expression expression3) {
        return new Expression("slice", expression, expression2, expression3);
    }
    ...
    public static Expression within(Polygon polygon) {
        HashMap hashMap = new HashMap();
        hashMap.put(SVGParser.XML_STYLESHEET_ATTR_TYPE, literal(polygon.type()));
    ...
    public static Expression product(Expression... expressionArr) {
        return new Expression(ProxyConfig.MATCH_ALL_SCHEMES, expressionArr);
    }
    ...
    public static Expression division(Expression expression, Expression expression2) {
        return new Expression(DomExceptionUtils.SEPARATOR, expression, expression2);
    }
    ...
    public static Expression format(FormatEntry... formatEntryArr) {
        ...
        for (FormatEntry formatEntry : formatEntryArr) {
            ...
            i += 2;
            expressionArr[i2] = new ExpressionMap(hashMap);
        }
    ...
    public static Expression toPadding(Expression expression) {
        return new Expression("to-padding", expression);
    }
    ...
    public static class ExpressionLiteral extends Expression implements ValueExpression {
        ...
        public boolean equals(Object obj) {
            ...
            return obj2 != null ? obj2.equals(expressionLiteral.literal) : expressionLiteral.literal == null;
        }
