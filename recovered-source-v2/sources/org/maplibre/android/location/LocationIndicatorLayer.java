...
class LocationIndicatorLayer extends Layer {
    ...
    public void setBearingTransition(TransitionOptions transitionOptions) {
        checkThread();
        nativeSetBearingTransition(transitionOptions.getDuration(), transitionOptions.getDelay());
    }
