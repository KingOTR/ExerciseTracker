...
public abstract class MapLibreAnimator<K> extends ValueAnimator implements ValueAnimator.AnimatorUpdateListener {
    ...
    public MapLibreAnimator(K[] kArr, AnimationsValueChangeListener<K> animationsValueChangeListener, int i) {
    ...
    public MapLibreAnimator(AnimationsValueChangeListener<K> animationsValueChangeListener, K k, K k2, double d, long j) {
        this.updateListener = animationsValueChangeListener;
        this.target = k;
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            MapLibreAnimator.this.postUpdates();
        }
    }
