...
public class LocationComponentOptions implements Parcelable {
    ...
    public static LocationComponentOptions createFromAttributes(Context context, int i) {
        ...
        padding.foregroundDrawable(obtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_foregroundDrawable, -1));
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_foregroundTintColor)) {
            padding.foregroundTintColor(Integer.valueOf(obtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_foregroundTintColor, -1)));
        }
        padding.backgroundDrawable(obtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_backgroundDrawable, -1));
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_backgroundTintColor)) {
            padding.backgroundTintColor(Integer.valueOf(obtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_backgroundTintColor, -1)));
        }
        padding.foregroundDrawableStale(obtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_foregroundDrawableStale, -1));
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_foregroundStaleTintColor)) {
            padding.foregroundStaleTintColor(Integer.valueOf(obtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_foregroundStaleTintColor, -1)));
        }
        padding.backgroundDrawableStale(obtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_backgroundDrawableStale, -1));
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_backgroundStaleTintColor)) {
            padding.backgroundStaleTintColor(Integer.valueOf(obtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_backgroundStaleTintColor, -1)));
        }
        padding.bearingDrawable(obtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_bearingDrawable, -1));
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_bearingTintColor)) {
            padding.bearingTintColor(Integer.valueOf(obtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_bearingTintColor, -1)));
        }
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_enableStaleState)) {
            padding.enableStaleState(obtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_enableStaleState, true));
        }
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_staleStateTimeout)) {
            padding.staleStateTimeout(obtainStyledAttributes.getInteger(R.styleable.maplibre_LocationComponent_maplibre_staleStateTimeout, 30000));
        }
        padding.gpsDrawable(obtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_gpsDrawable, -1));
        float dimension = obtainStyledAttributes.getDimension(R.styleable.maplibre_LocationComponent_maplibre_elevation, 0.0f);
        padding.accuracyColor(obtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_accuracyColor, -1));
        padding.accuracyAlpha(obtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_accuracyAlpha, 0.15f));
        padding.elevation(dimension);
        padding.trackingGesturesManagement(obtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_trackingGesturesManagement, false));
        padding.trackingInitialMoveThreshold(obtainStyledAttributes.getDimension(R.styleable.maplibre_LocationComponent_maplibre_trackingInitialMoveThreshold, context.getResources().getDimension(R.dimen.maplibre_locationComponentTrackingInitialMoveThreshold)));
        padding.trackingMultiFingerMoveThreshold(obtainStyledAttributes.getDimension(R.styleable.maplibre_LocationComponent_maplibre_trackingMultiFingerMoveThreshold, context.getResources().getDimension(R.dimen.maplibre_locationComponentTrackingMultiFingerMoveThreshold)));
        padding.padding(new int[]{obtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingLeft, 0), obtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingTop, 0), obtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingRight, 0), obtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingBottom, 0)});
        padding.layerAbove(obtainStyledAttributes.getString(R.styleable.maplibre_LocationComponent_maplibre_layer_above));
        padding.layerBelow(obtainStyledAttributes.getString(R.styleable.maplibre_LocationComponent_maplibre_layer_below));
        float f = obtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_minZoomIconScale, MIN_ZOOM_ICON_SCALE_DEFAULT);
        ...
        padding.trackingAnimationDurationMultiplier(obtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_trackingAnimationDurationMultiplier, TRACKING_ANIMATION_DURATION_MULTIPLIER_DEFAULT));
        padding.compassAnimationEnabled = Boolean.valueOf(obtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_compassAnimationEnabled, true));
        padding.accuracyAnimationEnabled = Boolean.valueOf(obtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_accuracyAnimationEnabled, true));
        padding.pulseEnabled = Boolean.valueOf(obtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleEnabled, false));
        padding.pulseFadeEnabled = Boolean.valueOf(obtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleFadeEnabled, true));
        if (obtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleColor)) {
            padding.pulseColor(obtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleColor, -1));
        }
        padding.pulseSingleDuration = obtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleDuration, 2300.0f);
        padding.pulseMaxRadius = obtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleRadius, 35.0f);
        padding.pulseAlpha = obtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleAlpha, 1.0f);
    ...
    public static Builder builder(Context context) {
        return createFromAttributes(context, R.style.maplibre_LocationComponent).toBuilder();
    }
    ...
    public static class Builder {
        ...
        public LocationComponentOptions build() {
            ...
            if (autoBuild.pulseEnabled() == null) {
                if (autoBuild.pulseFadeEnabled() == null) {
                    str = "";
                } else {
