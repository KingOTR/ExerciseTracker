...
import org.maplibre.android.gestures.SidewaysShoveGestureDetector;
    ...
    private void initDefaultThresholds() {
        for (BaseGesture baseGesture : this.detectors) {
            ...
            if (baseGesture instanceof ShoveGestureDetector) {
                ...
                shoveGestureDetector.setPixelDeltaThresholdResource(R.dimen.mapbox_defaultShovePixelThreshold);
            ...
            if (baseGesture instanceof SidewaysShoveGestureDetector) {
                ...
                sidewaysShoveGestureDetector.setPixelDeltaThresholdResource(R.dimen.mapbox_defaultShovePixelThreshold);
            ...
            if (baseGesture instanceof MultiFingerTapGestureDetector) {
                ...
                multiFingerTapGestureDetector.setMultiFingerTapMovementThresholdResource(R.dimen.mapbox_defaultMultiTapMovementThreshold);
