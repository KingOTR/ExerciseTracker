...
public final class PolygonOptions implements Parcelable {
    public static final Parcelable.Creator<PolygonOptions> CREATOR = new Parcelable.Creator<PolygonOptions>() { // from class: org.maplibre.android.annotations.PolygonOptions.1
    ...
    public boolean equals(Object obj) {
        ...
        if (Float.compare(polygonOptions.getAlpha(), getAlpha()) == 0 && getFillColor() == polygonOptions.getFillColor() && getStrokeColor() == polygonOptions.getStrokeColor() && getPoints().equals(polygonOptions.getPoints())) {
    ...
    public int hashCode() {
        return (((((((((getAlpha() != 0.0f ? Float.floatToIntBits(getAlpha()) : 0) + 31) * 31) + getFillColor()) * 31) + getStrokeColor()) * 31) + getPoints().hashCode()) * 31) + getHoles().hashCode();
    }
}
