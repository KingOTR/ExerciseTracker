...
public class BubbleLayout extends LinearLayout {
    ...
    public BubbleLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.arrowDirection = new ArrowDirection(obtainStyledAttributes.getInt(R.styleable.maplibre_BubbleLayout_maplibre_bl_arrowDirection, 0));
        this.arrowWidth = obtainStyledAttributes.getDimension(R.styleable.maplibre_BubbleLayout_maplibre_bl_arrowWidth, convertDpToPixel(8.0f, context));
        this.arrowHeight = obtainStyledAttributes.getDimension(R.styleable.maplibre_BubbleLayout_maplibre_bl_arrowHeight, convertDpToPixel(8.0f, context));
        this.arrowPosition = obtainStyledAttributes.getDimension(R.styleable.maplibre_BubbleLayout_maplibre_bl_arrowPosition, convertDpToPixel(12.0f, context));
        this.cornersRadius = obtainStyledAttributes.getDimension(R.styleable.maplibre_BubbleLayout_maplibre_bl_cornersRadius, 0.0f);
        this.bubbleColor = obtainStyledAttributes.getColor(R.styleable.maplibre_BubbleLayout_maplibre_bl_bubbleColor, -1);
        this.strokeWidth = obtainStyledAttributes.getDimension(R.styleable.maplibre_BubbleLayout_maplibre_bl_strokeWidth, -1.0f);
        this.strokeColor = obtainStyledAttributes.getColor(R.styleable.maplibre_BubbleLayout_maplibre_bl_strokeColor, -7829368);
