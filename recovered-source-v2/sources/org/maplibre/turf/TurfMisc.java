    ...
    public static Feature nearestPointOnLine(Point point, List<Point> list, String str) {
        ...
        while (i < list.size() - 1) {
            ...
            if (lineIntersects != null) {
                feature = Feature.fromGeometry(Point.fromLngLat(lineIntersects.horizontalIntersection().doubleValue(), lineIntersects.verticalIntersection().doubleValue()));
                feature.addNumberProperty("dist", Double.valueOf(TurfMeasurement.distance(point, (Point) feature.geometry(), str2)));
            } else {
                feature = null;
            }
            ...
            if (feature == null || ((Double) feature.getNumberProperty("dist")).doubleValue() >= ((Double) fromGeometry3.getNumberProperty("dist")).doubleValue()) {
                ...
                feature.addNumberProperty(INDEX_KEY, Integer.valueOf(i));
                feature2 = feature;
            }
            i = i2;
        }
