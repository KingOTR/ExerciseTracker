...
public class DefaultConfigurationProvider implements IConfigurationProvider {
    ...
    protected long gpsWaitTime = DeviceOrientationRequest.OUTPUT_PERIOD_DEFAULT;
    ...
    protected String userAgentHttpHeader = HttpHeaders.USER_AGENT;
    ...
    protected int animationSpeedShort = LogSeverity.ERROR_VALUE;
    ...
    private String computeNormalizedUserAgent(Context context) {
        ...
        try {
            return packageName + DomExceptionUtils.SEPARATOR + context.getPackageManager().getPackageInfo(packageName, 128).versionCode;
