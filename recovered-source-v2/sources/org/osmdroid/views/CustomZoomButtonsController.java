...
public class CustomZoomButtonsController {
    ...
    private int mFadeOutAnimationDurationInMillis = LogSeverity.ERROR_VALUE;
    ...
    public boolean isTouched(MotionEvent motionEvent) {
        ...
        boolean z = this.mListener != null && motionEvent.getAction() == 1;
        if (this.mDisplay.isTouched(motionEvent, true)) {
            if (z && this.mZoomInEnabled) {
