...
public class Projection implements IProjection {
    ...
    public RectL getMercatorViewPort(RectL rectL) {
        ...
        rectL2.left = getMercatorXFromPixel((int) f);
        rectL2.top = getMercatorYFromPixel((int) f3);
        rectL2.right = getMercatorXFromPixel((int) f2);
        rectL2.bottom = getMercatorYFromPixel((int) f4);
        return rectL2;
    }
    ...
    private void refresh() {
        ...
        IGeoPoint fromPixels = fromPixels(this.mScreenRectProjection.right, this.mScreenRectProjection.top, null, true);
        ...
        IGeoPoint fromPixels2 = fromPixels(this.mScreenRectProjection.left, this.mScreenRectProjection.bottom, null, true);
