            ...
            if (i4 <= 0 || metersToPixels * 2 <= i4) {
                ...
                if (paint3 != null) {
                    ...
                    if (this.mLabelOffsetLeft != null) {
                        canvas.drawText(this.mLabel, (-metersToPixels) + getOffsetX(r2.intValue()) + i, getOffsetY() + i2, this.mTextPaint);
                    }
                    ...
                    if (this.mLabelOffsetRight != null) {
                        canvas.drawText(this.mLabel, i + metersToPixels + getOffsetX(r2.intValue()), i2 + getOffsetY(), this.mTextPaint);
                    }
                }
            }
        }
