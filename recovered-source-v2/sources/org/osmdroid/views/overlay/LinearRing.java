...
public class LinearRing {
                ...
                while (d11 < width) {
                    ...
                    while (d12 < height) {
                        ...
                        if (d17 > Distance.getSquaredDistanceToProjection(d15, d16, pointL2.x, pointL2.y, pointL3.x, pointL3.y, projectionFactorToSegment)) {
                            ...
                            int i4 = (i - 1) * 2;
                            int i5 = i * 2;
                            return MapView.getTileSystem().getGeoFromMercator((long) (jArr[i4] + ((jArr[i5] - r4) * projectionFactorToSegment)), (long) (jArr[i4 + 1] + ((jArr[i5 + 1] - r6) * projectionFactorToSegment)), 1.15292150460684698E18d, null, false, false);
                        }
                        d12 += d14;
                        it2 = it3;
                        linearRing = this;
    ...
    float[] computeDowngradePointList(int i) {
        ...
        while (true) {
            ...
            long j3 = jArr[i3];
            i3 += 2;
            sideOptimizationPointAccepter.add(Math.round((j3 - this.mProjectedCenter.x) / d), Math.round((jArr[i4] - this.mProjectedCenter.y) / d));
        }
