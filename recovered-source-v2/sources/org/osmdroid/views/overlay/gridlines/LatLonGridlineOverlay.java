    ...
    public static FolderOverlay getLatLonGrid(Context context, MapView mapView) {
        ...
        if (zoomLevel >= 2) {
            ...
            while (true) {
                ...
                String str2 = df.format(d6) + (d6 > 0.0d ? "N" : ExifInterface.LATITUDE_SOUTH);
            ...
            while (d13 <= d12) {
                ...
                String str3 = df.format(d13) + (d13 > 0.0d ? ExifInterface.LONGITUDE_EAST : str);
            ...
            if (z) {
                ...
                while (d24 <= d23) {
                    ...
                    String str4 = df.format(d24) + (d24 > 0.0d ? ExifInterface.LONGITUDE_EAST : ExifInterface.LONGITUDE_WEST);
                ...
                while (d25 < 180.0d) {
                    ...
                    String str5 = df.format(d25) + (d25 > 0.0d ? ExifInterface.LONGITUDE_EAST : ExifInterface.LONGITUDE_WEST);
