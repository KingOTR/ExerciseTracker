...
public class GeoPoint implements IGeoPoint, MathConstants, GeoConstants, Parcelable, Serializable, Cloneable {
    ...
    public GeoPoint destinationPoint(double d, double d2) {
        ...
        return new GeoPoint(asin / 0.017453292519943295d, (longitude + Math.atan2((Math.sin(d4) * Math.sin(d3)) * Math.cos(latitude), Math.cos(d3) - (Math.sin(latitude) * Math.sin(asin)))) / 0.017453292519943295d);
    }
