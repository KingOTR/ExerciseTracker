    ...
    public Drawable downloadTile(long j, int i, String str, IFilesystemCache iFilesystemCache, OnlineTileSourceBase onlineTileSourceBase) throws CantContinueException {
        ...
        try {
            try {
                ...
                HttpURLConnection httpURLConnection8 = Configuration.getInstance().getHttpProxy() != null ? (HttpURLConnection) new URL(r22).openConnection(Configuration.getInstance().getHttpProxy()) : (HttpURLConnection) new URL(r22).openConnection();
                try {
                    ...
                    if (httpURLConnection8.getResponseCode() != 200) {
                        ...
                        if (headerField != null) {
                            if (headerField.startsWith(DomExceptionUtils.SEPARATOR)) {
                                URL url = new URL(r22);
                                int port = url.getPort();
                                boolean startsWith = str.toLowerCase().startsWith("https://");
                                if (port == -1) {
                                    port = str.toLowerCase().startsWith("http://") ? 80 : GrpcUtil.DEFAULT_PORT_SSL;
                                }
                                headerField = (startsWith ? r32 : ProxyConfig.MATCH_HTTP) + url.getHost() + ":" + port + headerField;
                            }
                            ...
                            Drawable downloadTile = downloadTile(j, r12 + 1, headerField, iFilesystemCache, onlineTileSourceBase);
                            StreamUtils.closeStream(null);
                            StreamUtils.closeStream(null);
                            StreamUtils.closeStream(null);
                            StreamUtils.closeStream(null);
                    ...
                    String headerField2 = httpURLConnection8.getHeaderField(HttpHeaders.CONTENT_TYPE);
                    if (Configuration.getInstance().isDebugMapTileDownloader()) {
                    ...
                    try {
                        ...
                        Counters.tileDownloadErrors++;
                        r12 = obj3;
                        r22 = byteArrayInputStream7;
                        r32 = byteArrayInputStream8;
                        ...
                        r12 = obj2;
                        r22 = byteArrayInputStream5;
                        r32 = byteArrayInputStream6;
                ...
                try {
                    ...
                    try {
                        long computeExpirationTime = onlineTileSourceBase.getTileSourcePolicy().computeExpirationTime(httpURLConnection8, System.currentTimeMillis());
                        ...
                        if (iFilesystemCache != 0) {
                            try {
                                ...
                                try {
                                    iFilesystemCache.saveFile(onlineTileSourceBase, j, byteArrayInputStream4, Long.valueOf(computeExpirationTime));
                                    ...
                                    fileNotFoundException = e;
                                    obj4 = inputStream;
                                    byteArrayInputStream9 = r2;
                                    byteArrayInputStream10 = r3;
                                    httpURLConnection5 = httpURLConnection8;
                                    Counters.tileDownloadErrors++;
                                    Log.w(IMapView.LOGTAG, "Tile not found: " + MapTileIndex.toString(j) + " : " + fileNotFoundException);
                                    r12 = obj4;
                                    ...
                                    obj3 = inputStream;
                                    byteArrayInputStream7 = r2;
                                    byteArrayInputStream8 = r3;
                                    httpURLConnection4 = httpURLConnection8;
                                    Log.w(IMapView.LOGTAG, "UnknownHostException downloading MapTile: " + MapTileIndex.toString(j) + " : " + unknownHostException);
                                    Counters.tileDownloadErrors++;
                                    r12 = obj3;
                                    ...
                                    iOException = e;
                                    obj2 = inputStream;
                                    byteArrayInputStream5 = r2;
                                    byteArrayInputStream6 = r3;
                                    httpURLConnection3 = httpURLConnection8;
                                    Counters.tileDownloadErrors++;
                                    Log.w(IMapView.LOGTAG, "IOException downloading MapTile: " + MapTileIndex.toString(j) + " : " + iOException);
                                    r12 = obj2;
