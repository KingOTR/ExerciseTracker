...
public class ThunderforestTileSource extends OnlineTileSourceBase {
    ...
    public String getTileURLString(long j) {
        return getBaseUrl().replace("{map}", urlMap[this.mMap]) + MapTileIndex.getZoom(j) + DomExceptionUtils.SEPARATOR + MapTileIndex.getX(j) + DomExceptionUtils.SEPARATOR + MapTileIndex.getY(j) + ".png?apikey=" + this.mMapId;
    }
