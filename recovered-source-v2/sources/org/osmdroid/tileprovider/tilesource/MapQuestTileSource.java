...
public class MapQuestTileSource extends OnlineTileSourceBase {
    ...
    public String getTileURLString(long j) {
        return getBaseUrl() + getMapBoxMapId() + DomExceptionUtils.SEPARATOR + MapTileIndex.getZoom(j) + DomExceptionUtils.SEPARATOR + MapTileIndex.getX(j) + DomExceptionUtils.SEPARATOR + MapTileIndex.getY(j) + ".png?access_token=" + getAccessToken();
    }
