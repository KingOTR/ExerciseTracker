...
public class MultiTouchController<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x013e A[Catch: Exception -> 0x015c, TryCatch #0 {Exception -> 0x015c, blocks: (B:3:0x0005, B:5:0x000a, B:6:0x001b, B:8:0x001f, B:13:0x0026, B:17:0x0038, B:21:0x0040, B:23:0x0049, B:25:0x0065, B:26:0x0086, B:28:0x0092, B:29:0x00b3, B:31:0x00bf, B:33:0x00e0, B:34:0x00d2, B:36:0x00a5, B:37:0x0078, B:39:0x0119, B:45:0x013e, B:46:0x0147, B:48:0x0143, B:50:0x012d, B:57:0x00ec, B:59:0x00f0, B:60:0x00f9, B:62:0x00ff, B:63:0x0108, B:65:0x010e, B:66:0x0117, B:67:0x0113, B:68:0x0104, B:69:0x00f5), top: B:2:0x0005 }] */
    /* JADX WARN: Removed duplicated region for block: B:48:0x0143 A[Catch: Exception -> 0x015c, TryCatch #0 {Exception -> 0x015c, blocks: (B:3:0x0005, B:5:0x000a, B:6:0x001b, B:8:0x001f, B:13:0x0026, B:17:0x0038, B:21:0x0040, B:23:0x0049, B:25:0x0065, B:26:0x0086, B:28:0x0092, B:29:0x00b3, B:31:0x00bf, B:33:0x00e0, B:34:0x00d2, B:36:0x00a5, B:37:0x0078, B:39:0x0119, B:45:0x013e, B:46:0x0147, B:48:0x0143, B:50:0x012d, B:57:0x00ec, B:59:0x00f0, B:60:0x00f9, B:62:0x00ff, B:63:0x0108, B:65:0x010e, B:66:0x0117, B:67:0x0113, B:68:0x0104, B:69:0x00f5), top: B:2:0x0005 }] */
            ...
            while (i <= historySize) {
                ...
                if (multiTouchSupported && intValue != 1) {
                    ...
                    for (int i2 = 0; i2 < min; i2++) {
                        ...
                        xVals[i2] = ((Float) (z2 ? m_getHistoricalX.invoke(motionEvent, Integer.valueOf(i2), Integer.valueOf(i)) : m_getX.invoke(motionEvent, Integer.valueOf(i2)))).floatValue();
                        yVals[i2] = ((Float) (z2 ? m_getHistoricalY.invoke(motionEvent, Integer.valueOf(i2), Integer.valueOf(i)) : m_getY.invoke(motionEvent, Integer.valueOf(i2)))).floatValue();
                        pressureVals[i2] = ((Float) (z2 ? m_getHistoricalPressure.invoke(motionEvent, Integer.valueOf(i2), Integer.valueOf(i)) : m_getPressure.invoke(motionEvent, Integer.valueOf(i2)))).floatValue();
                    }
                    float[] fArr = xVals;
                    float[] fArr2 = yVals;
                    ...
                    if (!z2 && (action == 1 || (((1 << ACTION_POINTER_INDEX_SHIFT) - 1) & action) == ACTION_POINTER_UP || action == 3)) {
                        ...
                        int i4 = historySize;
                        int i5 = i;
                        decodeTouchEvent(intValue, fArr, fArr2, fArr3, iArr, i3, z, !z2 ? motionEvent.getHistoricalEventTime(i) : motionEvent.getEventTime());
                        i = i5 + 1;
                        historySize = i4;
                    }
                    z = true;
                ...
                if (!z2) {
                    z = false;
                    int i422 = historySize;
                    int i522 = i;
                    decodeTouchEvent(intValue, fArr4, fArr22, fArr32, iArr2, i3, z, !z2 ? motionEvent.getHistoricalEventTime(i) : motionEvent.getEventTime());
                    i = i522 + 1;
                    historySize = i422;
                }
                z = true;
                int i4222 = historySize;
                int i5222 = i;
                decodeTouchEvent(intValue, fArr4, fArr22, fArr32, iArr2, i3, z, !z2 ? motionEvent.getHistoricalEventTime(i) : motionEvent.getEventTime());
                i = i5222 + 1;
                historySize = i4222;
