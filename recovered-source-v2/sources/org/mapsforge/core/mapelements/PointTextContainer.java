...
public abstract class PointTextContainer extends MapElementContainer {
    ...
    protected PointTextContainer(Point point, Display display, int i, String str, Paint paint, Paint paint2, SymbolContainer symbolContainer, Position position, int i2) {
