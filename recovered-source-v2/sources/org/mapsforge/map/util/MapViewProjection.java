...
public class MapViewProjection {
    ...
    public LatLong fromPixels(double d, double d2) {
        ...
        try {
            return new LatLong(MercatorProjection.pixelYToLatitude((MercatorProjection.latitudeToPixelY(latLong.latitude, mapSize) - (this.mapView.getHeight() >> 1)) + d2, mapSize), MercatorProjection.pixelXToLongitude((MercatorProjection.longitudeToPixelX(latLong.longitude, mapSize) - (this.mapView.getWidth() >> 1)) + d, mapSize));
