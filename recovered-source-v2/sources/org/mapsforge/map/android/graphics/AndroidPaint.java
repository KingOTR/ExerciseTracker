...
class AndroidPaint implements Paint {
    ...
    private static Paint.Align getAndroidAlign(Align align) {
        int i = AnonymousClass1.$SwitchMap$org$mapsforge$core$graphics$Align[align.ordinal()];
        if (i == 1) {
    ...
    private static Paint.Join getAndroidJoin(Join join) {
        int i = AnonymousClass1.$SwitchMap$org$mapsforge$core$graphics$Join[join.ordinal()];
        if (i == 1) {
    ...
    private static Paint.Style getAndroidStyle(Style style) {
        int i = AnonymousClass1.$SwitchMap$org$mapsforge$core$graphics$Style[style.ordinal()];
        if (i == 1) {
    ...
    private static int getFontStyle(FontStyle fontStyle) {
        int i = AnonymousClass1.$SwitchMap$org$mapsforge$core$graphics$FontStyle[fontStyle.ordinal()];
        int i2 = 1;
        if (i != 1) {
            i2 = 3;
            if (i != 2) {
    ...
    private static Typeface getTypeface(FontFamily fontFamily) {
        int i = AnonymousClass1.$SwitchMap$org$mapsforge$core$graphics$FontFamily[fontFamily.ordinal()];
        if (i == 1) {
    ...
    public void setDashPathEffect(float[] fArr) {
        this.paint.setPathEffect(fArr != null ? new DashPathEffect(fArr, 0.0f) : null);
    }
