...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m9694write$default(FileSystem fileSystem, Path file, boolean z, Function1 writerAction, int i, Object obj) throws IOException {
        ?? r4;
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
    ...
    public final <T> T m9695read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        ?? r5;
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m9696write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        ?? r5;
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
