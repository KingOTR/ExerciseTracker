...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m9682deprecated_getByte(long index) {
        ...
        if (segment != null) {
            if (size() - j2 < j2) {
                ...
                if (segment != null) {
                    ...
                    while (j < size2) {
                        byte[] bArr = segment.data;
                        int min = (int) Math.min(segment.limit, (segment.pos + size2) - j);
                ...
                if (segment != null) {
                    ...
                    while (j < size4) {
                        byte[] bArr2 = segment.data;
                        long j5 = size4;
                        int min2 = (int) Math.min(segment.limit, (segment.pos + size4) - j);
                        i = (int) ((segment.pos + j2) - j);
                        while (i < min2) {
