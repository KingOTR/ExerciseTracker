...
public final class C0094SegmentedByteString extends ByteString {
    ...
    public C0094SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0094SegmentedByteString c0094SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0094SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && resolveDefaultParameter == size()) {
            return c0094SegmentedByteString;
        }
