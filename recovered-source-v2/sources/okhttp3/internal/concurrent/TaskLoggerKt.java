...
public final class TaskLoggerKt {
    ...
    public static final String formatDuration(long j) {
        ...
        if (j <= -999500000) {
            ...
            str = j <= 0 ? ((j - LogSeverity.ERROR_VALUE) / 1000) + " µs" : j < 999500 ? ((j + LogSeverity.ERROR_VALUE) / 1000) + " µs" : j < 999500000 ? ((j + 500000) / DurationKt.NANOS_IN_MILLIS) + " ms" : ((j + 500000000) / Http2Connection.DEGRADED_PONG_TIMEOUT_NS) + " s ";
        }
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
