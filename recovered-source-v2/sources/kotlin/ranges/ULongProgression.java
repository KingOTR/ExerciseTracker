...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m9113getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m8079constructorimpl = ((int) ULong.m8079constructorimpl(j ^ ULong.m8079constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m8079constructorimpl2 = (m8079constructorimpl + ((int) ULong.m8079constructorimpl(j2 ^ ULong.m8079constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + m8079constructorimpl2;
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m8125toStringimpl(this.first)).append("..").append((Object) ULong.m8125toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m8125toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m8125toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m9139fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
