...
public final class UStringsKt {
    ...
    public static final String m9218toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m9220toStringolVBNx4(short s, int i) {
    ...
    public static final String m9219toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m9217toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m8000constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m7917boximpl(UByte.m7923constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m8000constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m8180boximpl(UShort.m8186constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m8000constructorimpl = UInt.m8000constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = Integer.divideUnsigned(-1, m8000constructorimpl);
                    if (Integer.compareUnsigned(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int m8000constructorimpl2 = UInt.m8000constructorimpl(i3 * m8000constructorimpl);
            int m8000constructorimpl3 = UInt.m8000constructorimpl(UInt.m8000constructorimpl(digitOf) + m8000constructorimpl2);
            if (Integer.compareUnsigned(m8000constructorimpl3, m8000constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = m8000constructorimpl3;
        }
        return UInt.m7994boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m8079constructorimpl = ULong.m8079constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = Long.divideUnsigned(-1L, m8079constructorimpl);
                    if (Long.compareUnsigned(j, j2) > 0) {
                    }
                }
                return null;
            }
            long m8079constructorimpl2 = ULong.m8079constructorimpl(j * m8079constructorimpl);
            long m8079constructorimpl3 = ULong.m8079constructorimpl(ULong.m8079constructorimpl(UInt.m8000constructorimpl(r13) & 4294967295L) + m8079constructorimpl2);
            if (Long.compareUnsigned(m8079constructorimpl3, m8079constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = m8079constructorimpl3;
        }
        return ULong.m8073boximpl(j);
    }
}
