...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo9222minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m9368minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo9221elapsedNowUwyO8pc() {
        return Duration.m9266minusLRDsOJo(this.mark.mo9221elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo9224plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m9267plusLRDsOJo(this.adjustment, duration), null);
    }
}
