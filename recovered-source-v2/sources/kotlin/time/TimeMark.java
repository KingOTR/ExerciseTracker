...
public interface TimeMark {
    ...
    TimeMark mo9222minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo9224plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m9369plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m9368minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo9224plusLRDsOJo(Duration.m9284unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m9264isNegativeimpl(timeMark.mo9221elapsedNowUwyO8pc());
        }
