...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m9371boximpl(m9365markNowz9LOYto());
    }
    ...
    public long m9365markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m9374constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m9364elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m9363differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m9362adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m9374constructorimpl(LongSaturatedMathKt.m9360saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
