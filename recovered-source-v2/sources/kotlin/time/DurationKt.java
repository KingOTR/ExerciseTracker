...
public final class DurationKt {
    ...
    private static final long m9358timesmvk6XK0(int i, long j) {
        return Duration.m9269timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m9357timeskIfJnKk(double d, long j) {
        return Duration.m9268timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m9334getZEROUwyO8pc = Duration.INSTANCE.m9334getZEROUwyO8pc();
        ...
        if (charAt4 == 'P') {
            ...
            while (i2 < length) {
                if (str.charAt(i2) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m9267plusLRDsOJo = Duration.m9267plusLRDsOJo(m9334getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m9334getZEROUwyO8pc = Duration.m9267plusLRDsOJo(m9267plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m9334getZEROUwyO8pc = Duration.m9267plusLRDsOJo(m9334getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, "Infinity".length()), true)) {
                m9334getZEROUwyO8pc = Duration.INSTANCE.m9332getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (i < length) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m9267plusLRDsOJo2 = Duration.m9267plusLRDsOJo(m9334getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m9334getZEROUwyO8pc = Duration.m9267plusLRDsOJo(m9267plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m9334getZEROUwyO8pc = Duration.m9267plusLRDsOJo(m9334getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m9284unaryMinusUwyO8pc(m9334getZEROUwyO8pc) : m9334getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m9231constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m9231constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m9231constructorimpl((j << 1) + i);
    }
