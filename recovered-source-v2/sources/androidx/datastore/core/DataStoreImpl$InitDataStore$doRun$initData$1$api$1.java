...
public final class DataStoreImpl$InitDataStore$doRun$initData$1$api$1<T> implements InitializerApi<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:42:0x0099 A[Catch: all -> 0x00e1, TRY_LEAVE, TryCatch #0 {all -> 0x00e1, blocks: (B:40:0x0095, B:42:0x0099, B:46:0x00d5, B:47:0x00e0), top: B:39:0x0095 }] */
    /* JADX WARN: Removed duplicated region for block: B:46:0x00d5 A[Catch: all -> 0x00e1, TRY_ENTER, TryCatch #0 {all -> 0x00e1, blocks: (B:40:0x0095, B:42:0x0099, B:46:0x00d5, B:47:0x00e0), top: B:39:0x0095 }] */
