...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    public DataStoreImpl(Storage<T> storage, List<? extends Function2<? super InitializerApi<T>, ? super Continuation<? super Unit>, ? extends Object>> initTasksList, CorruptionHandler<T> corruptionHandler, CoroutineScope scope) {
        ...
        this.scope = scope;
        this.updateCollection = FlowKt.shareIn(FlowKt.flow(new DataStoreImpl$updateCollection$1(this, null)), scope, SharingStartedKt.m9460WhileSubscribed5qebJ5I(SharingStarted.INSTANCE, Duration.INSTANCE.m9334getZEROUwyO8pc(), Duration.INSTANCE.m9334getZEROUwyO8pc()), 0);
    ...
    */
    public final Object handleUpdate(Message.Update<T> update, Continuation<? super Unit> continuation) {
            ...
            if ((dataStoreImpl$handleUpdate$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        ...
                        CompletableDeferredKt.completeWith(completableDeferred, m7905constructorimpl);
                        return Unit.INSTANCE;
                    }
                    if (currentState instanceof Data) {
                        ...
                        m7905constructorimpl = Result.m7905constructorimpl(obj);
                        completableDeferred = this;
                        CompletableDeferredKt.completeWith(completableDeferred, m7905constructorimpl);
                        return Unit.INSTANCE;
                    }
                    ...
                    if (z) {
                        if (currentState == update.getLastState()) {
                            ...
                            Intrinsics.checkNotNull(currentState, "null cannot be cast to non-null type androidx.datastore.core.ReadException<T of androidx.datastore.core.DataStoreImpl.handleUpdate$lambda$0>");
                ...
                CompletableDeferred<T> completableDeferred32 = ack;
                obj = transformAndWrite;
                this = completableDeferred32;
                m7905constructorimpl = Result.m7905constructorimpl(obj);
                completableDeferred = this;
                CompletableDeferredKt.completeWith(completableDeferred, m7905constructorimpl);
                return Unit.INSTANCE;
        ...
        CompletableDeferred<T> completableDeferred322 = ack;
        obj2 = transformAndWrite;
        this = completableDeferred322;
        m7905constructorimpl = Result.m7905constructorimpl(obj2);
        completableDeferred = this;
        CompletableDeferredKt.completeWith(completableDeferred, m7905constructorimpl);
        return Unit.INSTANCE;
    }
        ...
        try {
            if (continuation instanceof DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1) {
                ...
                if ((dataStoreImpl$readAndInitOrPropagateAndThrowFailure$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    initDataStore = this.readAndInit;
                    dataStoreImpl$readAndInitOrPropagateAndThrowFailure$1.L$0 = this;
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:58:0x00a3 A[Catch: CorruptionException -> 0x008c, TryCatch #2 {CorruptionException -> 0x008c, blocks: (B:35:0x0060, B:36:0x0101, B:39:0x006b, B:40:0x00e2, B:56:0x0088, B:58:0x00a3, B:59:0x00a9, B:66:0x0094, B:69:0x00d0), top: B:7:0x0024 }] */
