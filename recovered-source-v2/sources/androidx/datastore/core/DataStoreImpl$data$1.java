...
final class DataStoreImpl$data$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (FlowKt.onCompletion(FlowKt.onStart(flow, new AnonymousClass1(launch$default, null)), new AnonymousClass2(launch$default, null)).collect(new FlowCollector() { // from class: androidx.datastore.core.DataStoreImpl$data$1.3
