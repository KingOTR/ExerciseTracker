...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m9429getOrNullimpl = ChannelResult.m9429getOrNullimpl(((SimpleActor) this).messageQueue.mo9417tryReceivePtdJZtk());
                        if (m9429getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m9429getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo6673trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable m9428exceptionOrNullimpl = ChannelResult.m9428exceptionOrNullimpl(obj);
            if (m9428exceptionOrNullimpl != null) {
                throw m9428exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m9434isSuccessimpl(obj)) {
