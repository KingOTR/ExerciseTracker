...
public final class SizeFCompat {
    ...
    public SizeFCompat(float f, float f2) {
        this.mWidth = Preconditions.checkArgumentFinite(f, Property.ICON_TEXT_FIT_WIDTH);
        this.mHeight = Preconditions.checkArgumentFinite(f2, Property.ICON_TEXT_FIT_HEIGHT);
    }
