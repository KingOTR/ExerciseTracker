...
class FontRequestWorker {
    ...
    static TypefaceResult getFontSync(String str, Context context, List<FontRequest> list, int i) {
        ...
        try {
            ...
            Typeface createFromFontInfoWithFallback = fontFamilyResult.hasFallback() ? TypefaceCompat.createFromFontInfoWithFallback(context, null, fontFamilyResult.getFontsWithFallbacks(), i) : TypefaceCompat.createFromFontInfo(context, null, fontFamilyResult.getFonts(), i);
            if (createFromFontInfoWithFallback == null) {
                return new TypefaceResult(-3);
            }
            lruCache.put(str, createFromFontInfoWithFallback);
            return new TypefaceResult(createFromFontInfoWithFallback);
