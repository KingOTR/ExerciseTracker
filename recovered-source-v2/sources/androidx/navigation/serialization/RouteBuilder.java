...
public final class RouteBuilder<T> {
    ...
    private final void addQuery(String name, String value) {
        this.queryArgs += (this.queryArgs.length() == 0 ? "?" : "&") + name + Tag.KEY_VALUE_SEPARATOR + value;
    }
