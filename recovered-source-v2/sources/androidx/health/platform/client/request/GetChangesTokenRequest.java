...
public final class GetChangesTokenRequest extends ProtoParcelable<RequestProto.GetChangesTokenRequest> {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<GetChangesTokenRequest>() { // from class: androidx.health.platform.client.request.GetChangesTokenRequest$special$$inlined$newCreator$connect_client_release$1
            ...
            /* JADX WARN: Type inference failed for: r2v10, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.request.GetChangesTokenRequest] */
            ...
            public GetChangesTokenRequest createFromParcel(Parcel source) {
                ...
                if (readInt != 0) {
                    if (readInt == 1) {
                        return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], GetChangesTokenRequest>() { // from class: androidx.health.platform.client.request.GetChangesTokenRequest$special$$inlined$newCreator$connect_client_release$1.1
                            ...
                            public final GetChangesTokenRequest invoke(byte[] it) {
                ...
                RequestProto.GetChangesTokenRequest proto = RequestProto.GetChangesTokenRequest.parseFrom(createByteArray);
                Intrinsics.checkNotNullExpressionValue(proto, "proto");
                return new GetChangesTokenRequest(proto);
            }
