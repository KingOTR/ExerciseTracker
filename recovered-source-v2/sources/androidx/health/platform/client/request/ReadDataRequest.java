...
public final class ReadDataRequest extends ProtoParcelable<RequestProto.ReadDataRequest> {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<ReadDataRequest>() { // from class: androidx.health.platform.client.request.ReadDataRequest$special$$inlined$newCreator$connect_client_release$1
            ...
            /* JADX WARN: Type inference failed for: r2v10, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.request.ReadDataRequest] */
            @Override // android.os.Parcelable.Creator
            public ReadDataRequest createFromParcel(Parcel source) {
                ...
                if (readInt != 0) {
                    if (readInt == 1) {
                        return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], ReadDataRequest>() { // from class: androidx.health.platform.client.request.ReadDataRequest$special$$inlined$newCreator$connect_client_release$1.1
                            ...
                            public final ReadDataRequest invoke(byte[] it) {
                ...
                RequestProto.ReadDataRequest proto = RequestProto.ReadDataRequest.parseFrom(createByteArray);
                Intrinsics.checkNotNullExpressionValue(proto, "proto");
                return new ReadDataRequest(proto);
            }
