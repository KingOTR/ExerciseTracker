...
public final class GetChangesRequest extends ProtoParcelable<RequestProto.GetChangesRequest> {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<GetChangesRequest>() { // from class: androidx.health.platform.client.request.GetChangesRequest$special$$inlined$newCreator$connect_client_release$1
            ...
            /* JADX WARN: Type inference failed for: r2v10, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.request.GetChangesRequest] */
            @Override // android.os.Parcelable.Creator
            public GetChangesRequest createFromParcel(Parcel source) {
                ...
                if (readInt != 0) {
                    if (readInt == 1) {
                        return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], GetChangesRequest>() { // from class: androidx.health.platform.client.request.GetChangesRequest$special$$inlined$newCreator$connect_client_release$1.1
                            ...
                            public final GetChangesRequest invoke(byte[] it) {
                ...
                RequestProto.GetChangesRequest proto = RequestProto.GetChangesRequest.parseFrom(createByteArray);
                Intrinsics.checkNotNullExpressionValue(proto, "proto");
                return new GetChangesRequest(proto);
            }
