...
public final class UpsertExerciseRouteRequest extends ProtoParcelable<RequestProto.UpsertExerciseRouteRequest> {
    ...
    public RequestProto.UpsertExerciseRouteRequest getProto() {
        RequestProto.UpsertExerciseRouteRequest build = RequestProto.UpsertExerciseRouteRequest.newBuilder().setSessionUid(this.sessionUid).setExerciseRoute(this.route).build();
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<UpsertExerciseRouteRequest>() { // from class: androidx.health.platform.client.request.UpsertExerciseRouteRequest$special$$inlined$newCreator$connect_client_release$1
            ...
            /* JADX WARN: Type inference failed for: r2v12, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.request.UpsertExerciseRouteRequest] */
            ...
            public UpsertExerciseRouteRequest createFromParcel(Parcel source) {
                ...
                RequestProto.UpsertExerciseRouteRequest proto = RequestProto.UpsertExerciseRouteRequest.parseFrom(createByteArray);
                UpsertExerciseRouteRequest.Companion companion2 = UpsertExerciseRouteRequest.INSTANCE;
                Intrinsics.checkNotNullExpressionValue(proto, "proto");
                return companion2.fromProto$connect_client_release(proto);
            }
