...
public final class DataProto {
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (i) {
                ...
                case 2:
                    return new Builder(anonymousClass1);
                case 3:
                    return newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0005\u0001\u0000\u0001\u0005\u0005\u0000\u0000\u0000\u00015\u0000\u00023\u0000\u0003;\u0000\u0004;\u0000\u0005:\u0000", new Object[]{"value_", "valueCase_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    public static final class SeriesValue extends GeneratedMessageLite<SeriesValue, Builder> implements SeriesValueOrBuilder {
        ...
        public Value getValuesOrDefault(String str, Value value) {
            str.getClass();
            MapFieldLite<String, Value> internalGetValues = internalGetValues();
            return internalGetValues.containsKey(str) ? internalGetValues.get(str) : value;
        }
    ...
    public static final class DataPoint extends GeneratedMessageLite<DataPoint, Builder> implements DataPointOrBuilder {
        ...
        public SubTypeDataList getSubTypeDataListsOrDefault(String str, SubTypeDataList subTypeDataList) {
            str.getClass();
            MapFieldLite<String, SubTypeDataList> internalGetSubTypeDataLists = internalGetSubTypeDataLists();
            return internalGetSubTypeDataLists.containsKey(str) ? internalGetSubTypeDataLists.get(str) : subTypeDataList;
        }
        ...
        public SubTypeDataList getSubTypeDataListsOrThrow(String str) {
            str.getClass();
            MapFieldLite<String, SubTypeDataList> internalGetSubTypeDataLists = internalGetSubTypeDataLists();
            if (!internalGetSubTypeDataLists.containsKey(str)) {
                throw new IllegalArgumentException();
            }
            return internalGetSubTypeDataLists.get(str);
        }
    ...
    public static final class AggregateDataRow extends GeneratedMessageLite<AggregateDataRow, Builder> implements AggregateDataRowOrBuilder {
        ...
        public double getDoubleValuesOrDefault(String str, double d) {
            str.getClass();
            MapFieldLite<String, Double> internalGetDoubleValues = internalGetDoubleValues();
            return internalGetDoubleValues.containsKey(str) ? internalGetDoubleValues.get(str).doubleValue() : d;
        }
        ...
        public double getDoubleValuesOrThrow(String str) {
            str.getClass();
            MapFieldLite<String, Double> internalGetDoubleValues = internalGetDoubleValues();
            if (!internalGetDoubleValues.containsKey(str)) {
                throw new IllegalArgumentException();
            }
            return internalGetDoubleValues.get(str).doubleValue();
        }
        ...
        public long getLongValuesOrDefault(String str, long j) {
            str.getClass();
            MapFieldLite<String, Long> internalGetLongValues = internalGetLongValues();
            return internalGetLongValues.containsKey(str) ? internalGetLongValues.get(str).longValue() : j;
        }
        ...
        public long getLongValuesOrThrow(String str) {
            str.getClass();
            MapFieldLite<String, Long> internalGetLongValues = internalGetLongValues();
            if (!internalGetLongValues.containsKey(str)) {
                throw new IllegalArgumentException();
            }
            return internalGetLongValues.get(str).longValue();
        }
