...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    static {
        ...
        UNSIGNED_LEXICOGRAPHICAL_COMPARATOR = new Comparator<ByteString>() { // from class: androidx.health.platform.client.proto.ByteString.2
            ...
            /* JADX WARN: Type inference failed for: r3v1, types: [androidx.health.platform.client.proto.ByteString$ByteIterator] */
    ...
    private static final class NioByteString extends LeafByteString {
        ...
        public InputStream newInput() {
            return new InputStream() { // from class: androidx.health.platform.client.proto.ByteString.NioByteString.1
