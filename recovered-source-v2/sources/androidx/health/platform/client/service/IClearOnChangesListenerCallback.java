...
public interface IClearOnChangesListenerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IClearOnChangesListenerCallback {
        ...
        public static IClearOnChangesListenerCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IClearOnChangesListenerCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IClearOnChangesListenerCallback)) {
                return (IClearOnChangesListenerCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IClearOnChangesListenerCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IClearOnChangesListenerCallback.DESCRIPTOR);
