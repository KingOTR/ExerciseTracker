...
public interface ISetOnChangesListenerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISetOnChangesListenerCallback {
        ...
        public static ISetOnChangesListenerCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(ISetOnChangesListenerCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof ISetOnChangesListenerCallback)) {
                return (ISetOnChangesListenerCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements ISetOnChangesListenerCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(ISetOnChangesListenerCallback.DESCRIPTOR);
