...
public interface IRegisterForDataNotificationsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRegisterForDataNotificationsCallback {
        ...
        public static IRegisterForDataNotificationsCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IRegisterForDataNotificationsCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IRegisterForDataNotificationsCallback)) {
                return (IRegisterForDataNotificationsCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IRegisterForDataNotificationsCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IRegisterForDataNotificationsCallback.DESCRIPTOR);
