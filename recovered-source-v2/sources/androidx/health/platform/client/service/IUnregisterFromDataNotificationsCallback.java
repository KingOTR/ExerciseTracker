...
public interface IUnregisterFromDataNotificationsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUnregisterFromDataNotificationsCallback {
        ...
        public static IUnregisterFromDataNotificationsCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IUnregisterFromDataNotificationsCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IUnregisterFromDataNotificationsCallback)) {
                return (IUnregisterFromDataNotificationsCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IUnregisterFromDataNotificationsCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IUnregisterFromDataNotificationsCallback.DESCRIPTOR);
