...
public interface IUpsertExerciseRouteCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUpsertExerciseRouteCallback {
        ...
        public static IUpsertExerciseRouteCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IUpsertExerciseRouteCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IUpsertExerciseRouteCallback)) {
                return (IUpsertExerciseRouteCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IUpsertExerciseRouteCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IUpsertExerciseRouteCallback.DESCRIPTOR);
