...
public interface IGetPermissionTokenCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetPermissionTokenCallback {
        ...
        public static IGetPermissionTokenCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IGetPermissionTokenCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IGetPermissionTokenCallback)) {
                return (IGetPermissionTokenCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IGetPermissionTokenCallback {
            ...
            public void onSuccess(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IGetPermissionTokenCallback.DESCRIPTOR);
