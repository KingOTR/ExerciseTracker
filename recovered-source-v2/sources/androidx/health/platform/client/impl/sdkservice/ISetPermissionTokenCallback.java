...
public interface ISetPermissionTokenCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISetPermissionTokenCallback {
        ...
        public static ISetPermissionTokenCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(ISetPermissionTokenCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof ISetPermissionTokenCallback)) {
                return (ISetPermissionTokenCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements ISetPermissionTokenCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(ISetPermissionTokenCallback.DESCRIPTOR);
