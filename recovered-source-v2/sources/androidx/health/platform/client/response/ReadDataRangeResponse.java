...
public final class ReadDataRangeResponse extends ProtoParcelable<ResponseProto.ReadDataRangeResponse> {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<ReadDataRangeResponse>() { // from class: androidx.health.platform.client.response.ReadDataRangeResponse$special$$inlined$newCreator$connect_client_release$1
            ...
            /* JADX WARN: Type inference failed for: r2v10, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.response.ReadDataRangeResponse] */
