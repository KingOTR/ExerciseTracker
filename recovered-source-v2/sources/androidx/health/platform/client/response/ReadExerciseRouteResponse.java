...
public final class ReadExerciseRouteResponse extends ProtoParcelable<ResponseProto.ReadExerciseRouteResponse> {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<ReadExerciseRouteResponse>() { // from class: androidx.health.platform.client.response.ReadExerciseRouteResponse$special$$inlined$newCreator$connect_client_release$1
            ...
            /* JADX WARN: Type inference failed for: r2v10, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.response.ReadExerciseRouteResponse] */
            ...
            public ReadExerciseRouteResponse createFromParcel(Parcel source) {
                ...
                ResponseProto.ReadExerciseRouteResponse proto = ResponseProto.ReadExerciseRouteResponse.parseFrom(createByteArray);
                Intrinsics.checkNotNullExpressionValue(proto, "proto");
                return new ReadExerciseRouteResponse(proto);
            }
