...
public final class ReadRecordsRequest<T extends Record> {
    ...
    public int hashCode() {
        ...
        return ((hashCode + (str != null ? str.hashCode() : 0)) * 31) + Integer.hashCode(this.deduplicateStrategy);
    }
