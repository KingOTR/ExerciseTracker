...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\u0018\u0000 \u00032\u00020\u0001:\u0001\u0003B\u0007\b\u0000¢\u0006\u0002\u0010\u0002¨\u0006\u0004"}, d2 = {"Landroidx/health/connect/client/permission/HealthPermission;", "", "()V", "Companion", "connect-client_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class HealthPermission {
    ...
    public static final String PERMISSION_READ_HEALTH_DATA_HISTORY = "android.permission.health.READ_HEALTH_DATA_HISTORY";
    ...
    public static final String READ_MINDFULNESS_SESSION = "android.permission.health.READ_MINDFULNESS_SESSION";
    ...
    public static final String WRITE_MINDFULNESS_SESSION = "android.permission.health.WRITE_MINDFULNESS_SESSION";
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final /* synthetic */ <T extends Record> String getReadPermission() {
            Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
            return getReadPermission(Reflection.getOrCreateKotlinClass(Record.class));
        }
        ...
        @JvmStatic
        public final /* synthetic */ <T extends Record> String getWritePermission() {
            Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
            return getWritePermission(Reflection.getOrCreateKotlinClass(Record.class));
        }
    ...
    static {
        ...
        createListBuilder.add(PERMISSION_WRITE_EXERCISE_ROUTE);
        createListBuilder.add(PERMISSION_READ_HEALTH_DATA_IN_BACKGROUND);
        ALL_PERMISSIONS = CollectionsKt.build(createListBuilder);
    }
}
