...
final class SeriesAggregator<T extends SeriesRecord<?>> extends SingeResultAggregator<RecordInfo> {
    ...
    public Map<String, Double> getDoubleValues() {
        ...
        for (AggregateMetric<?> aggregateMetric : this.aggregateMetrics) {
            ...
            createMapBuilder.put(aggregateMetric.getMetricKey(), Double.valueOf(doubleValue));
        }
