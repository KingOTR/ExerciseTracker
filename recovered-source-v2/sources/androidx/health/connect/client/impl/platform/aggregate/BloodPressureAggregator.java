...
final class BloodPressureAggregator extends SingeResultAggregator<BloodPressureRecord> {
    ...
    public BloodPressureAggregator(Set<? extends AggregateMetric<?>> bloodPressureMetrics) {
        ...
        if (!set.containsAll(bloodPressureMetrics)) {
            ...
            Set<? extends AggregateMetric<?>> set2 = bloodPressureMetrics;
