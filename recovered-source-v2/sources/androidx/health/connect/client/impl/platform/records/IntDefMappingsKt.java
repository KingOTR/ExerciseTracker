...
public final class IntDefMappingsKt {
    ...
    static {
        Map<Integer, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(5, 5), TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4), TuplesKt.to(6, 6));
        SDK_TO_PLATFORM_CERVICAL_MUCUS_APPEARANCE = mapOf;
        PLATFORM_TO_SDK_CERVICAL_MUCUS_APPEARANCE = reversed(mapOf);
        Map<Integer, Integer> mapOf2 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4));
        SDK_TO_PLATFORM_BLOOD_PRESSURE_BODY_POSITION = mapOf2;
        PLATFORM_TO_SDK_BLOOD_PRESSURE_BODY_POSITION = reversed(mapOf2);
        Map<Integer, Integer> mapOf3 = MapsKt.mapOf(TuplesKt.to(0, 58), TuplesKt.to(2, 1), TuplesKt.to(4, 2), TuplesKt.to(5, 3), TuplesKt.to(8, 4), TuplesKt.to(9, 5), TuplesKt.to(10, 6), TuplesKt.to(11, 7), TuplesKt.to(13, 8), TuplesKt.to(14, 9), TuplesKt.to(16, 10), TuplesKt.to(25, 60), TuplesKt.to(26, 11), TuplesKt.to(27, 12), TuplesKt.to(28, 13), TuplesKt.to(29, 14), TuplesKt.to(31, 15), TuplesKt.to(32, 16), TuplesKt.to(33, 17), TuplesKt.to(34, 18), TuplesKt.to(35, 19), TuplesKt.to(36, 20), TuplesKt.to(37, 21), TuplesKt.to(38, 22), TuplesKt.to(39, 23), TuplesKt.to(44, 24), TuplesKt.to(46, 25), TuplesKt.to(47, 26), TuplesKt.to(48, 27), TuplesKt.to(50, 28), TuplesKt.to(51, 29), TuplesKt.to(52, 30), TuplesKt.to(53, 31), TuplesKt.to(54, 61), TuplesKt.to(55, 32), TuplesKt.to(56, 33), TuplesKt.to(57, 34), TuplesKt.to(58, 35), TuplesKt.to(59, 36), TuplesKt.to(60, 37), TuplesKt.to(61, 38), TuplesKt.to(62, 39), TuplesKt.to(63, 40), TuplesKt.to(64, 41), TuplesKt.to(65, 42), TuplesKt.to(66, 43), TuplesKt.to(68, 44), TuplesKt.to(69, 59), TuplesKt.to(70, 45), TuplesKt.to(71, 46), TuplesKt.to(72, 47), TuplesKt.to(73, 48), TuplesKt.to(74, 49), TuplesKt.to(75, 50), TuplesKt.to(76, 51), TuplesKt.to(78, 52), TuplesKt.to(79, 53), TuplesKt.to(80, 54), TuplesKt.to(81, 55), TuplesKt.to(82, 56), TuplesKt.to(83, 57));
        SDK_TO_PLATFORM_EXERCISE_SESSION_TYPE = mapOf3;
        PLATFORM_TO_SDK_EXERCISE_SESSION_TYPE = reversed(mapOf3);
        Map<Integer, Integer> mapOf4 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4));
        SDK_TO_PLATFORM_MEAL_TYPE = mapOf4;
        PLATFORM_TO_SDK_MEAL_TYPE = reversed(mapOf4);
        Map<Integer, Integer> mapOf5 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4), TuplesKt.to(5, 5));
        SDK_TO_PLATFORM_VO2_MAX_MEASUREMENT_METHOD = mapOf5;
        PLATFORM_TO_SDK_VO2_MAX_MEASUREMENT_METHOD = reversed(mapOf5);
        Map<Integer, Integer> mapOf6 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3));
        SDK_TO_PLATFORM_MENSTRUATION_FLOW_TYPE = mapOf6;
        PLATFORM_TO_SDK_MENSTRUATION_FLOW_TYPE = reversed(mapOf6);
        Map<Integer, Integer> mapOf7 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4), TuplesKt.to(5, 5), TuplesKt.to(6, 6), TuplesKt.to(7, 7), TuplesKt.to(8, 8), TuplesKt.to(9, 9), TuplesKt.to(10, 10));
        SDK_TO_PLATFORM_BODY_TEMPERATURE_MEASUREMENT_LOCATION = mapOf7;
        PLATFORM_TO_SDK_BODY_TEMPERATURE_MEASUREMENT_LOCATION = reversed(mapOf7);
        Map<Integer, Integer> mapOf8 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4));
        SDK_TO_PLATFORM_BLOOD_PRESSURE_MEASUREMENT_LOCATION = mapOf8;
        PLATFORM_TO_SDK_BLOOD_PRESSURE_MEASUREMENT_LOCATION = reversed(mapOf8);
        Map<Integer, Integer> mapOf9 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(0, 0));
        SDK_TO_PLATFORM_OVULATION_TEST_RESULT = mapOf9;
        PLATFORM_TO_SDK_OVULATION_TEST_RESULT = reversed(mapOf9);
        Map<Integer, Integer> mapOf10 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3));
        SDK_TO_PLATFORM_CERVICAL_MUCUS_SENSATION = mapOf10;
        PLATFORM_TO_SDK_CERVICAL_MUCUS_SENSATION = reversed(mapOf10);
        Map<Integer, Integer> mapOf11 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2));
        SDK_TO_PLATFORM_SEXUAL_ACTIVITY_PROTECTION_USED = mapOf11;
        PLATFORM_TO_SDK_SEXUAL_ACTIVITY_PROTECTION_USED = reversed(mapOf11);
        Map<Integer, Integer> mapOf12 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3));
        SDK_TO_PLATFORM_SKIN_TEMPERATURE_MEASUREMENT_LOCATION = mapOf12;
        PLATFORM_TO_SDK_SKIN_TEMPERATURE_MEASUREMENT_LOCATION = reversed(mapOf12);
        Map<Integer, Integer> mapOf13 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4), TuplesKt.to(5, 5), TuplesKt.to(6, 6));
        SDK_TO_PLATFORM_BLOOD_GLUCOSE_SPECIMEN_SOURCE = mapOf13;
        PLATFORM_TO_SDK_GLUCOSE_SPECIMEN_SOURCE = reversed(mapOf13);
        Map<Integer, Integer> mapOf14 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4));
        SDK_TO_PLATFORM_BLOOD_GLUCOSE_RELATION_TO_MEAL = mapOf14;
        PLATFORM_TO_SDK_BLOOD_GLUCOSE_RELATION_TO_MEAL = reversed(mapOf14);
        Map<Integer, Integer> mapOf15 = MapsKt.mapOf(TuplesKt.to(0, 0), TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4), TuplesKt.to(5, 5));
        SDK_TO_PLATFORM_EXERCISE_CATEGORY = mapOf15;
        PLATFORM_TO_SDK_EXERCISE_CATEGORY = reversed(mapOf15);
        Map<Integer, Integer> mapOf16 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3), TuplesKt.to(4, 4), TuplesKt.to(5, 5), TuplesKt.to(6, 6), TuplesKt.to(7, 7));
        SDK_TO_PLATFORM_SLEEP_STAGE_TYPE = mapOf16;
        PLATFORM_TO_SDK_SLEEP_STAGE_TYPE = reversed(mapOf16);
        Map<Integer, Integer> mapOf17 = MapsKt.mapOf(TuplesKt.to(1, 26), TuplesKt.to(2, 27), TuplesKt.to(3, 28), TuplesKt.to(4, 1), TuplesKt.to(5, 29), TuplesKt.to(6, 2), TuplesKt.to(7, 3), TuplesKt.to(8, 4), TuplesKt.to(9, 30), TuplesKt.to(10, 31), TuplesKt.to(11, 32), TuplesKt.to(12, 33), TuplesKt.to(13, 5), TuplesKt.to(14, 6), TuplesKt.to(15, 7), TuplesKt.to(16, 8), TuplesKt.to(17, 34), TuplesKt.to(18, 9), TuplesKt.to(19, 10), TuplesKt.to(20, 11), TuplesKt.to(21, 12), TuplesKt.to(22, 13), TuplesKt.to(23, 35), TuplesKt.to(24, 62), TuplesKt.to(25, 36), TuplesKt.to(26, 37), TuplesKt.to(27, 38), TuplesKt.to(28, 39), TuplesKt.to(29, 40), TuplesKt.to(30, 41), TuplesKt.to(31, 42), TuplesKt.to(32, 43), TuplesKt.to(33, 44), TuplesKt.to(34, 45), TuplesKt.to(35, 46), TuplesKt.to(36, 47), TuplesKt.to(37, 48), TuplesKt.to(38, 64), TuplesKt.to(39, 67), TuplesKt.to(40, 14), TuplesKt.to(41, 49), TuplesKt.to(42, 50), TuplesKt.to(43, 51), TuplesKt.to(44, 66), TuplesKt.to(45, 15), TuplesKt.to(46, 16), TuplesKt.to(47, 17), TuplesKt.to(48, 52), TuplesKt.to(49, 53), TuplesKt.to(50, 54), TuplesKt.to(51, 55), TuplesKt.to(52, 18), TuplesKt.to(53, 19), TuplesKt.to(54, 20), TuplesKt.to(55, 57), TuplesKt.to(56, 58), TuplesKt.to(57, 59), TuplesKt.to(58, 56), TuplesKt.to(59, 60), TuplesKt.to(60, 21), TuplesKt.to(61, 61), TuplesKt.to(62, 22), TuplesKt.to(63, 23), TuplesKt.to(64, 24), TuplesKt.to(65, 63), TuplesKt.to(66, 25), TuplesKt.to(67, 65));
        SDK_TO_PLATFORM_EXERCISE_SEGMENT_TYPE = mapOf17;
        PLATFORM_TO_SDK_EXERCISE_SEGMENT_TYPE = reversed(mapOf17);
        Map<Integer, Integer> mapOf18 = MapsKt.mapOf(TuplesKt.to(1, 1), TuplesKt.to(2, 2), TuplesKt.to(3, 3));
        SDK_TO_PLATFORM_RECORDING_METHOD = mapOf18;
        PLATFORM_TO_SDK_RECORDING_METHOD = reversed(mapOf18);
    }
