...
final class HealthConnectClientImpl$readRecord$1<T extends Record> extends ContinuationImpl {
    Object L$0;
    int label;
    ...
    HealthConnectClientImpl$readRecord$1(HealthConnectClientImpl healthConnectClientImpl, Continuation<? super HealthConnectClientImpl$readRecord$1> continuation) {
        super(continuation);
