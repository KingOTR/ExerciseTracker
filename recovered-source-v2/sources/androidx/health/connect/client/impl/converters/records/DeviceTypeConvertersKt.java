...
public final class DeviceTypeConvertersKt {
    ...
    static {
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(DeviceTypes.UNKNOWN, 0), TuplesKt.to(DeviceTypes.CHEST_STRAP, 7), TuplesKt.to(DeviceTypes.FITNESS_BAND, 6), TuplesKt.to(DeviceTypes.HEAD_MOUNTED, 5), TuplesKt.to(DeviceTypes.PHONE, 2), TuplesKt.to(DeviceTypes.RING, 4), TuplesKt.to(DeviceTypes.SCALE, 3), TuplesKt.to(DeviceTypes.SMART_DISPLAY, 8), TuplesKt.to("WATCH", 1));
        DEVICE_TYPE_STRING_TO_INT_MAP = mapOf;
