...
public final class AggregateRequestToProtoKt {
    public static final RequestProto.AggregateDataRequest toProto(AggregateRequest aggregateRequest) {
        ...
        RequestProto.AggregateDataRequest.Builder addAllDataOrigin = RequestProto.AggregateDataRequest.newBuilder().setTimeSpec(TimeRangeFilterConverterKt.toProto(aggregateRequest.getTimeRangeFilter())).addAllDataOrigin(toProtoList(aggregateRequest.getDataOriginFilter$connect_client_release()));
    ...
    public static final RequestProto.AggregateDataRequest toProto(AggregateGroupByDurationRequest aggregateGroupByDurationRequest) {
        ...
        RequestProto.AggregateDataRequest.Builder addAllDataOrigin = RequestProto.AggregateDataRequest.newBuilder().setTimeSpec(TimeRangeFilterConverterKt.toProto(aggregateGroupByDurationRequest.getTimeRangeFilter())).addAllDataOrigin(toProtoList(aggregateGroupByDurationRequest.getDataOriginFilter$connect_client_release()));
        ...
        RequestProto.AggregateDataRequest build = addAllDataOrigin.addAllMetricSpec(arrayList).setSliceDurationMillis(aggregateGroupByDurationRequest.getTimeRangeSlicer().toMillis()).build();
        Intrinsics.checkNotNullExpressionValue(build, "newBuilder()\n        .se…illis())\n        .build()");
        return build;
    }
    ...
    public static final RequestProto.AggregateDataRequest toProto(AggregateGroupByPeriodRequest aggregateGroupByPeriodRequest) {
        ...
        RequestProto.AggregateDataRequest.Builder addAllDataOrigin = RequestProto.AggregateDataRequest.newBuilder().setTimeSpec(TimeRangeFilterConverterKt.toProto(aggregateGroupByPeriodRequest.getTimeRangeFilter())).addAllDataOrigin(toProtoList(aggregateGroupByPeriodRequest.getDataOriginFilter$connect_client_release()));
        ...
        RequestProto.AggregateDataRequest build = addAllDataOrigin.addAllMetricSpec(arrayList).setSlicePeriod(aggregateGroupByPeriodRequest.getTimeRangeSlicer().toString()).build();
        Intrinsics.checkNotNullExpressionValue(build, "newBuilder()\n        .se…tring())\n        .build()");
        return build;
    }
