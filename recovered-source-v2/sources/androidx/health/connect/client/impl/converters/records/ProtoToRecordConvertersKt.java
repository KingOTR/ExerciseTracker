...
public final class ProtoToRecordConvertersKt {
    ...
    public static final Record toRecord(DataProto.DataPoint proto) {
        List<SkinTemperatureRecord.Delta> emptyList;
        List<ExerciseSegment> emptyList2;
        List<ExerciseLap> emptyList3;
        ExerciseRouteResult.NoData noData;
        List<SleepSessionRecord.Stage> emptyList4;
            ...
            switch (name.hashCode()) {
                case -2137162425:
                    if (name.equals("Height")) {
                        return new HeightRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), LengthKt.getMeters(ProtoToRecordUtilsKt.getDouble$default(proto, Property.ICON_TEXT_FIT_HEIGHT, 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -1931142571:
                    if (name.equals("BasalMetabolicRate")) {
                        return new BasalMetabolicRateRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), PowerKt.getKilocaloriesPerDay(ProtoToRecordUtilsKt.getDouble$default(proto, "bmr", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -1878699588:
                ...
                case -1728782805:
                    if (name.equals("Vo2Max")) {
                        ...
                        return new Vo2MaxRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), ProtoToRecordUtilsKt.getDouble$default(dataPoint, "vo2", 0.0d, 2, (Object) null), ProtoToRecordUtilsKt.mapEnum(dataPoint, "measurementMethod", Vo2MaxRecord.MEASUREMENT_METHOD_STRING_TO_INT_MAP, 0), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -1707725160:
                    if (name.equals("Weight")) {
                        return new WeightRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), MassKt.getKilograms(ProtoToRecordUtilsKt.getDouble$default(proto, "weight", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -1547814841:
                    if (name.equals("HeartRateVariabilityRmssd")) {
                        ...
                        double d = 1.0d;
                        if (ProtoToRecordUtilsKt.getDouble$default(dataPoint2, "heartRateVariability", 0.0d, 2, (Object) null) >= 1.0d) {
                            d = 200.0d;
                            if (ProtoToRecordUtilsKt.getDouble$default(dataPoint2, "heartRateVariability", 0.0d, 2, (Object) null) <= 200.0d) {
                                d = ProtoToRecordUtilsKt.getDouble$default(dataPoint2, "heartRateVariability", 0.0d, 2, (Object) null);
                            }
                        }
                        return new HeartRateVariabilityRmssdRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), d, ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -1249467044:
                    if (name.equals("LeanBodyMass")) {
                        return new LeanBodyMassRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), MassKt.getKilograms(ProtoToRecordUtilsKt.getDouble$default(proto, "mass", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -1170329975:
                ...
                case -1089246824:
                    if (name.equals("TotalCaloriesBurned")) {
                        return new TotalCaloriesBurnedRecord(ProtoToRecordUtilsKt.getStartTime(proto), ProtoToRecordUtilsKt.getStartZoneOffset(proto), ProtoToRecordUtilsKt.getEndTime(proto), ProtoToRecordUtilsKt.getEndZoneOffset(proto), EnergyKt.getKilocalories(ProtoToRecordUtilsKt.getDouble$default(proto, "energy", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -633416129:
                    if (name.equals("BloodPressure")) {
                        DataProto.DataPoint dataPoint3 = proto;
                        return new BloodPressureRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), PressureKt.getMillimetersOfMercury(ProtoToRecordUtilsKt.getDouble$default(dataPoint3, "systolic", 0.0d, 2, (Object) null)), PressureKt.getMillimetersOfMercury(ProtoToRecordUtilsKt.getDouble$default(dataPoint3, "diastolic", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.mapEnum(dataPoint3, "bodyPosition", BloodPressureRecord.BODY_POSITION_STRING_TO_INT_MAP, 0), ProtoToRecordUtilsKt.mapEnum(dataPoint3, "measurementLocation", BloodPressureRecord.MEASUREMENT_LOCATION_STRING_TO_INT_MAP, 0), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -562822786:
                ...
                case -561665783:
                    if (name.equals("BodyWaterMass")) {
                        return new BodyWaterMassRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), MassKt.getKilograms(ProtoToRecordUtilsKt.getDouble$default(proto, "mass", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -539421262:
                    if (name.equals("OxygenSaturation")) {
                        return new OxygenSaturationRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), PercentageKt.getPercent(ProtoToRecordUtilsKt.getDouble$default(proto, "percentage", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case -136898551:
                ...
                case 353103893:
                    if (name.equals("Distance")) {
                        return new DistanceRecord(ProtoToRecordUtilsKt.getStartTime(proto), ProtoToRecordUtilsKt.getStartZoneOffset(proto), ProtoToRecordUtilsKt.getEndTime(proto), ProtoToRecordUtilsKt.getEndZoneOffset(proto), LengthKt.getMeters(ProtoToRecordUtilsKt.getDouble$default(proto, "distance", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 557067342:
                ...
                case 578805655:
                    if (name.equals("SkinTemperature")) {
                        DataProto.Value value3 = proto.getValuesMap().get("baseline");
                        Temperature celsius = value3 != null ? TemperatureKt.getCelsius(value3.getDoubleVal()) : null;
                        int mapEnum = ProtoToRecordUtilsKt.mapEnum(proto, "measurementLocation", SkinTemperatureRecord.MEASUREMENT_LOCATION_STRING_TO_INT_MAP, 0);
                        ...
                        DataProto.DataPoint.SubTypeDataList subTypeDataList = proto.getSubTypeDataListsMap().get("deltas");
                        if (subTypeDataList == null || (emptyList = ProtoToRecordUtilsKt.toDeltasList(subTypeDataList)) == null) {
                            emptyList = CollectionsKt.emptyList();
                        }
                        return new SkinTemperatureRecord(startTime3, startZoneOffset3, endTime3, endZoneOffset3, emptyList, celsius, mapEnum, ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 761063032:
                ...
                case 1108584865:
                    if (name.equals("StepsCadenceSeries")) {
                        ...
                        for (DataProto.SeriesValue value4 : list3) {
                            Instant ofEpochMilli3 = Instant.ofEpochMilli(value4.getInstantTimeMillis());
                            Intrinsics.checkNotNullExpressionValue(ofEpochMilli3, "ofEpochMilli(value.instantTimeMillis)");
                            Intrinsics.checkNotNullExpressionValue(value4, "value");
                            arrayList3.add(new StepsCadenceRecord.Sample(ofEpochMilli3, ProtoToRecordUtilsKt.getDouble$default(value4, "rate", 0.0d, 2, (Object) null)));
                        }
                        return new StepsCadenceRecord(startTime4, startZoneOffset4, endTime4, endZoneOffset4, arrayList3, ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 1193457969:
                ...
                case 1468615931:
                    if (name.equals("ElevationGained")) {
                        return new ElevationGainedRecord(ProtoToRecordUtilsKt.getStartTime(proto), ProtoToRecordUtilsKt.getStartZoneOffset(proto), ProtoToRecordUtilsKt.getEndTime(proto), ProtoToRecordUtilsKt.getEndZoneOffset(proto), LengthKt.getMeters(ProtoToRecordUtilsKt.getDouble$default(proto, "elevation", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 1478142546:
                ...
                case 1498531293:
                    if (name.equals("CyclingPedalingCadenceSeries")) {
                        ...
                        for (DataProto.SeriesValue value5 : list4) {
                            Instant ofEpochMilli4 = Instant.ofEpochMilli(value5.getInstantTimeMillis());
                            ...
                            arrayList4.add(new CyclingPedalingCadenceRecord.Sample(ofEpochMilli4, ProtoToRecordUtilsKt.getDouble$default(value5, "rpm", 0.0d, 2, (Object) null)));
                        }
                        return new CyclingPedalingCadenceRecord(startTime5, startZoneOffset5, endTime5, endZoneOffset5, arrayList4, ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 1513758823:
                    if (name.equals("ActivitySession")) {
                        DataProto.DataPoint dataPoint7 = proto;
                        int mapEnum2 = ProtoToRecordUtilsKt.mapEnum(dataPoint7, TrackingService.EXTRA_ACTIVITY_TYPE, ExerciseSessionRecord.EXERCISE_TYPE_STRING_TO_INT_MAP, 0);
                        ...
                        DataProto.DataPoint.SubTypeDataList subTypeDataList2 = proto.getSubTypeDataListsMap().get("segments");
                        if (subTypeDataList2 == null || (emptyList2 = ProtoToRecordUtilsKt.toSegmentList(subTypeDataList2)) == null) {
                            emptyList2 = CollectionsKt.emptyList();
                        }
                        List<ExerciseSegment> list5 = emptyList2;
                        DataProto.DataPoint.SubTypeDataList subTypeDataList3 = proto.getSubTypeDataListsMap().get("laps");
                        if (subTypeDataList3 == null || (emptyList3 = ProtoToRecordUtilsKt.toLapList(subTypeDataList3)) == null) {
                            emptyList3 = CollectionsKt.emptyList();
                        }
                        List<ExerciseLap> list6 = emptyList3;
                        DataProto.DataPoint.SubTypeDataList subTypeDataList4 = proto.getSubTypeDataListsMap().get("route");
                        if (subTypeDataList4 != null) {
                            ...
                            DataProto.Value value6 = proto.getValuesMap().get("hasRoute");
                            noData = (value6 == null || !value6.getBooleanVal()) ? new ExerciseRouteResult.NoData() : new ExerciseRouteResult.ConsentRequired();
                        }
                        return new ExerciseSessionRecord(startTime6, startZoneOffset6, endTime6, endZoneOffset6, mapEnum2, string, string2, metadata, list5, list6, noData, (String) null, 2048, (DefaultConstructorMarker) null);
                    }
                    break;
                case 1584919122:
                    if (name.equals("BodyTemperature")) {
                        DataProto.DataPoint dataPoint8 = proto;
                        return new BodyTemperatureRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), TemperatureKt.getCelsius(ProtoToRecordUtilsKt.getDouble$default(dataPoint8, "temperature", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.mapEnum(dataPoint8, "measurementLocation", BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_STRING_TO_INT_MAP, 0), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 1719563767:
                    if (name.equals("BodyFat")) {
                        return new BodyFatRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), PercentageKt.getPercent(ProtoToRecordUtilsKt.getDouble$default(proto, "percentage", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 1738316664:
                    if (name.equals("Nutrition")) {
                        DataProto.Value value7 = proto.getValuesMap().get("biotin");
                        Mass grams = value7 != null ? MassKt.getGrams(value7.getDoubleVal()) : null;
                        DataProto.Value value8 = proto.getValuesMap().get("caffeine");
                        Mass grams2 = value8 != null ? MassKt.getGrams(value8.getDoubleVal()) : null;
                        DataProto.Value value9 = proto.getValuesMap().get("calcium");
                        Mass grams3 = value9 != null ? MassKt.getGrams(value9.getDoubleVal()) : null;
                        DataProto.Value value10 = proto.getValuesMap().get("calories");
                        Energy kilocalories = value10 != null ? EnergyKt.getKilocalories(value10.getDoubleVal()) : null;
                        DataProto.Value value11 = proto.getValuesMap().get("caloriesFromFat");
                        Energy kilocalories2 = value11 != null ? EnergyKt.getKilocalories(value11.getDoubleVal()) : null;
                        DataProto.Value value12 = proto.getValuesMap().get("chloride");
                        Mass grams4 = value12 != null ? MassKt.getGrams(value12.getDoubleVal()) : null;
                        DataProto.Value value13 = proto.getValuesMap().get("cholesterol");
                        Mass grams5 = value13 != null ? MassKt.getGrams(value13.getDoubleVal()) : null;
                        DataProto.Value value14 = proto.getValuesMap().get("chromium");
                        Mass grams6 = value14 != null ? MassKt.getGrams(value14.getDoubleVal()) : null;
                        DataProto.Value value15 = proto.getValuesMap().get("copper");
                        Mass grams7 = value15 != null ? MassKt.getGrams(value15.getDoubleVal()) : null;
                        DataProto.Value value16 = proto.getValuesMap().get("dietaryFiber");
                        Mass grams8 = value16 != null ? MassKt.getGrams(value16.getDoubleVal()) : null;
                        DataProto.Value value17 = proto.getValuesMap().get("folate");
                        Mass grams9 = value17 != null ? MassKt.getGrams(value17.getDoubleVal()) : null;
                        DataProto.Value value18 = proto.getValuesMap().get("folicAcid");
                        Mass grams10 = value18 != null ? MassKt.getGrams(value18.getDoubleVal()) : null;
                        DataProto.Value value19 = proto.getValuesMap().get("iodine");
                        Mass grams11 = value19 != null ? MassKt.getGrams(value19.getDoubleVal()) : null;
                        DataProto.Value value20 = proto.getValuesMap().get("iron");
                        Mass grams12 = value20 != null ? MassKt.getGrams(value20.getDoubleVal()) : null;
                        DataProto.Value value21 = proto.getValuesMap().get("magnesium");
                        Mass grams13 = value21 != null ? MassKt.getGrams(value21.getDoubleVal()) : null;
                        DataProto.Value value22 = proto.getValuesMap().get("manganese");
                        Mass grams14 = value22 != null ? MassKt.getGrams(value22.getDoubleVal()) : null;
                        DataProto.Value value23 = proto.getValuesMap().get("molybdenum");
                        Mass grams15 = value23 != null ? MassKt.getGrams(value23.getDoubleVal()) : null;
                        DataProto.Value value24 = proto.getValuesMap().get("monounsaturatedFat");
                        Mass grams16 = value24 != null ? MassKt.getGrams(value24.getDoubleVal()) : null;
                        DataProto.Value value25 = proto.getValuesMap().get("niacin");
                        Mass grams17 = value25 != null ? MassKt.getGrams(value25.getDoubleVal()) : null;
                        DataProto.Value value26 = proto.getValuesMap().get("pantothenicAcid");
                        Mass grams18 = value26 != null ? MassKt.getGrams(value26.getDoubleVal()) : null;
                        DataProto.Value value27 = proto.getValuesMap().get("phosphorus");
                        Mass grams19 = value27 != null ? MassKt.getGrams(value27.getDoubleVal()) : null;
                        DataProto.Value value28 = proto.getValuesMap().get("polyunsaturatedFat");
                        Mass grams20 = value28 != null ? MassKt.getGrams(value28.getDoubleVal()) : null;
                        DataProto.Value value29 = proto.getValuesMap().get("potassium");
                        Mass grams21 = value29 != null ? MassKt.getGrams(value29.getDoubleVal()) : null;
                        DataProto.Value value30 = proto.getValuesMap().get("protein");
                        Mass grams22 = value30 != null ? MassKt.getGrams(value30.getDoubleVal()) : null;
                        DataProto.Value value31 = proto.getValuesMap().get("riboflavin");
                        Mass grams23 = value31 != null ? MassKt.getGrams(value31.getDoubleVal()) : null;
                        DataProto.Value value32 = proto.getValuesMap().get("saturatedFat");
                        Mass grams24 = value32 != null ? MassKt.getGrams(value32.getDoubleVal()) : null;
                        DataProto.Value value33 = proto.getValuesMap().get("selenium");
                        Mass grams25 = value33 != null ? MassKt.getGrams(value33.getDoubleVal()) : null;
                        DataProto.Value value34 = proto.getValuesMap().get("sodium");
                        Mass grams26 = value34 != null ? MassKt.getGrams(value34.getDoubleVal()) : null;
                        DataProto.Value value35 = proto.getValuesMap().get("sugar");
                        Mass grams27 = value35 != null ? MassKt.getGrams(value35.getDoubleVal()) : null;
                        DataProto.Value value36 = proto.getValuesMap().get("thiamin");
                        Mass grams28 = value36 != null ? MassKt.getGrams(value36.getDoubleVal()) : null;
                        DataProto.Value value37 = proto.getValuesMap().get("totalCarbohydrate");
                        Mass grams29 = value37 != null ? MassKt.getGrams(value37.getDoubleVal()) : null;
                        DataProto.Value value38 = proto.getValuesMap().get("totalFat");
                        Mass grams30 = value38 != null ? MassKt.getGrams(value38.getDoubleVal()) : null;
                        DataProto.Value value39 = proto.getValuesMap().get("transFat");
                        Mass grams31 = value39 != null ? MassKt.getGrams(value39.getDoubleVal()) : null;
                        DataProto.Value value40 = proto.getValuesMap().get("unsaturatedFat");
                        Mass grams32 = value40 != null ? MassKt.getGrams(value40.getDoubleVal()) : null;
                        DataProto.Value value41 = proto.getValuesMap().get("vitaminA");
                        Mass grams33 = value41 != null ? MassKt.getGrams(value41.getDoubleVal()) : null;
                        DataProto.Value value42 = proto.getValuesMap().get("vitaminB12");
                        Mass grams34 = value42 != null ? MassKt.getGrams(value42.getDoubleVal()) : null;
                        DataProto.Value value43 = proto.getValuesMap().get("vitaminB6");
                        Mass grams35 = value43 != null ? MassKt.getGrams(value43.getDoubleVal()) : null;
                        DataProto.Value value44 = proto.getValuesMap().get("vitaminC");
                        Mass grams36 = value44 != null ? MassKt.getGrams(value44.getDoubleVal()) : null;
                        DataProto.Value value45 = proto.getValuesMap().get("vitaminD");
                        Mass grams37 = value45 != null ? MassKt.getGrams(value45.getDoubleVal()) : null;
                        DataProto.Value value46 = proto.getValuesMap().get("vitaminE");
                        Mass grams38 = value46 != null ? MassKt.getGrams(value46.getDoubleVal()) : null;
                        DataProto.Value value47 = proto.getValuesMap().get("vitaminK");
                        Mass grams39 = value47 != null ? MassKt.getGrams(value47.getDoubleVal()) : null;
                        DataProto.Value value48 = proto.getValuesMap().get("zinc");
                        Mass grams40 = value48 != null ? MassKt.getGrams(value48.getDoubleVal()) : null;
                        DataProto.DataPoint dataPoint9 = proto;
                        return new NutritionRecord(ProtoToRecordUtilsKt.getStartTime(proto), ProtoToRecordUtilsKt.getStartZoneOffset(proto), ProtoToRecordUtilsKt.getEndTime(proto), ProtoToRecordUtilsKt.getEndZoneOffset(proto), grams, grams2, grams3, kilocalories, kilocalories2, grams4, grams5, grams6, grams7, grams8, grams9, grams10, grams11, grams12, grams13, grams14, grams15, grams16, grams17, grams18, grams19, grams20, grams21, grams22, grams23, grams24, grams25, grams26, grams27, grams28, grams29, grams30, grams31, grams32, grams33, grams34, grams35, grams36, grams37, grams38, grams39, grams40, ProtoToRecordUtilsKt.getString(dataPoint9, HintConstants.AUTOFILL_HINT_NAME), ProtoToRecordUtilsKt.mapEnum(dataPoint9, "mealType", MealType.MEAL_TYPE_STRING_TO_INT_MAP, 0), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 2034898936:
                    if (name.equals("BoneMass")) {
                        return new BoneMassRecord(ProtoToRecordUtilsKt.getTime(proto), ProtoToRecordUtilsKt.getZoneOffset(proto), MassKt.getKilograms(ProtoToRecordUtilsKt.getDouble$default(proto, "mass", 0.0d, 2, (Object) null)), ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 2065313759:
                    if (name.equals("SleepSession")) {
                        ...
                        DataProto.DataPoint.SubTypeDataList subTypeDataList5 = proto.getSubTypeDataListsMap().get("stages");
                        if (subTypeDataList5 == null || (emptyList4 = ProtoToRecordUtilsKt.toStageList(subTypeDataList5)) == null) {
                            emptyList4 = CollectionsKt.emptyList();
                        }
                        return new SleepSessionRecord(startTime7, startZoneOffset7, endTime7, endZoneOffset7, string3, string4, emptyList4, ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
                case 2095285180:
                    if (name.equals("PowerSeries")) {
                        Instant startTime8 = ProtoToRecordUtilsKt.getStartTime(proto);
                        ZoneOffset startZoneOffset8 = ProtoToRecordUtilsKt.getStartZoneOffset(proto);
                        Instant endTime8 = ProtoToRecordUtilsKt.getEndTime(proto);
                        ZoneOffset endZoneOffset8 = ProtoToRecordUtilsKt.getEndZoneOffset(proto);
                        ...
                        for (DataProto.SeriesValue value49 : list7) {
                            Instant ofEpochMilli5 = Instant.ofEpochMilli(value49.getInstantTimeMillis());
                            Intrinsics.checkNotNullExpressionValue(ofEpochMilli5, "ofEpochMilli(value.instantTimeMillis)");
                            Intrinsics.checkNotNullExpressionValue(value49, "value");
                            arrayList5.add(new PowerRecord.Sample(ofEpochMilli5, PowerKt.getWatts(ProtoToRecordUtilsKt.getDouble$default(value49, "power", 0.0d, 2, (Object) null))));
                        }
                        return new PowerRecord(startTime8, startZoneOffset8, endTime8, endZoneOffset8, arrayList5, ProtoToRecordUtilsKt.getMetadata(proto));
                    }
                    break;
            }
        }
    ...
    public static final ExerciseRoute toExerciseRouteData(androidx.health.platform.client.exerciseroute.ExerciseRoute protoWrapper) {
        ...
        for (DataProto.SubTypeDataValue subTypeDataValue : list) {
            ...
            Intrinsics.checkNotNullExpressionValue(ofEpochMilli, "ofEpochMilli(value.startTimeMillis)");
