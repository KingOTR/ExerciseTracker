...
final class HealthConnectClientImpl$aggregateGroupByDuration$1 extends ContinuationImpl {
    int label;
    /* synthetic */ Object result;
    final /* synthetic */ HealthConnectClientImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HealthConnectClientImpl$aggregateGroupByDuration$1(HealthConnectClientImpl healthConnectClientImpl, Continuation<? super HealthConnectClientImpl$aggregateGroupByDuration$1> continuation) {
        super(continuation);
