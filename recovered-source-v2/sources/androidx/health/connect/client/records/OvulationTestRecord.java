...
public final class OvulationTestRecord implements InstantaneousRecord {
    ...
    static {
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(Result.INCONCLUSIVE, 0), TuplesKt.to(Result.POSITIVE, 1), TuplesKt.to(Result.HIGH, 2), TuplesKt.to(Result.NEGATIVE, 3));
