...
public final class BloodPressureRecord implements InstantaneousRecord {
    ...
    static {
        ...
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(MeasurementLocation.LEFT_UPPER_ARM, 3), TuplesKt.to(MeasurementLocation.LEFT_WRIST, 1), TuplesKt.to(MeasurementLocation.RIGHT_UPPER_ARM, 4), TuplesKt.to(MeasurementLocation.RIGHT_WRIST, 2));
        MEASUREMENT_LOCATION_STRING_TO_INT_MAP = mapOf;
        MEASUREMENT_LOCATION_INT_TO_STRING_MAP = UtilsKt.reverse(mapOf);
        Map<String, Integer> mapOf2 = MapsKt.mapOf(TuplesKt.to(BodyPosition.LYING_DOWN, 3), TuplesKt.to(BodyPosition.RECLINING, 4), TuplesKt.to(BodyPosition.SITTING_DOWN, 2), TuplesKt.to(BodyPosition.STANDING_UP, 1));
        BODY_POSITION_STRING_TO_INT_MAP = mapOf2;
        BODY_POSITION_INT_TO_STRING_MAP = UtilsKt.reverse(mapOf2);
        millimetersOfMercury = PressureKt.getMillimetersOfMercury(1.0E-322d);
