...
public final class DistanceRecord implements IntervalRecord {
    ...
    public int hashCode() {
        ...
        return ((((hashCode2 + (endZoneOffset != null ? endZoneOffset.hashCode() : 0)) * 31) + getMetadata().hashCode()) * 31) + Double.hashCode(this.distance.getMeters());
    }
    ...
    static {
        ...
        MAX_DISTANCE = meters;
        DISTANCE_TOTAL = AggregateMetric.INSTANCE.doubleMetric$connect_client_release("Distance", AggregateMetric.AggregationType.TOTAL, "distance", new DistanceRecord$Companion$DISTANCE_TOTAL$1(Length.INSTANCE));
    }
}
