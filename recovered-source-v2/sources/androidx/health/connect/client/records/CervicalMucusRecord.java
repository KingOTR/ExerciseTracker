...
public final class CervicalMucusRecord implements InstantaneousRecord {
    ...
    static {
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(Appearance.CLEAR, 5), TuplesKt.to(Appearance.CREAMY, 3), TuplesKt.to(Appearance.DRY, 1), TuplesKt.to(Appearance.STICKY, 2), TuplesKt.to(Appearance.WATERY, 4), TuplesKt.to(Appearance.UNUSUAL, 6));
        APPEARANCE_STRING_TO_INT_MAP = mapOf;
        APPEARANCE_INT_TO_STRING_MAP = UtilsKt.reverse(mapOf);
        Map<String, Integer> mapOf2 = MapsKt.mapOf(TuplesKt.to(Sensation.LIGHT, 1), TuplesKt.to(Sensation.MEDIUM, 2), TuplesKt.to(Sensation.HEAVY, 3));
