...
public final class HeightRecord implements InstantaneousRecord {
    ...
    static {
        ...
        MAX_HEIGHT = meters;
        HEIGHT_AVG = AggregateMetric.INSTANCE.doubleMetric$connect_client_release(HEIGHT_NAME, AggregateMetric.AggregationType.AVERAGE, "height", new HeightRecord$Companion$HEIGHT_AVG$1(Length.INSTANCE));
        HEIGHT_MIN = AggregateMetric.INSTANCE.doubleMetric$connect_client_release(HEIGHT_NAME, AggregateMetric.AggregationType.MINIMUM, "height", new HeightRecord$Companion$HEIGHT_MIN$1(Length.INSTANCE));
        HEIGHT_MAX = AggregateMetric.INSTANCE.doubleMetric$connect_client_release(HEIGHT_NAME, AggregateMetric.AggregationType.MAXIMUM, "height", new HeightRecord$Companion$HEIGHT_MAX$1(Length.INSTANCE));
    }
}
