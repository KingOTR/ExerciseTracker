...
public final class Metadata {
    ...
    */
    public /* synthetic */ Metadata(String str, DataOrigin dataOrigin, Instant EPOCH, String str2, long j, Device device, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, dataOrigin, EPOCH, (i2 & 8) != 0 ? null : str2, (i2 & 16) != 0 ? 0L : j, (i2 & 32) != 0 ? null : device, (i2 & 64) != 0 ? 0 : i);
        str = (i2 & 1) != 0 ? "" : str;
        dataOrigin = (i2 & 2) != 0 ? new DataOrigin("") : dataOrigin;
        if ((i2 & 4) != 0) {
            EPOCH = Instant.EPOCH;
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((hashCode + (str != null ? str.hashCode() : 0)) * 31) + Long.hashCode(this.clientRecordVersion)) * 31;
        Device device = this.device;
        return ((hashCode2 + (device != null ? device.hashCode() : 0)) * 31) + Integer.hashCode(this.recordingMethod);
    }
