...
public final class SexualActivityRecord implements InstantaneousRecord {
    ...
    public int hashCode() {
        int hashCode = ((this.protectionUsed * 31) + getTime().hashCode()) * 31;
    ...
    static {
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(Protection.PROTECTED, 1), TuplesKt.to(Protection.UNPROTECTED, 2));
        PROTECTION_USED_STRING_TO_INT_MAP = mapOf;
        PROTECTION_USED_INT_TO_STRING_MAP = UtilsKt.reverse(mapOf);
    }
