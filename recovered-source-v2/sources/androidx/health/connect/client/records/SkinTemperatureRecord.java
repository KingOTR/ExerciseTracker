...
public final class SkinTemperatureRecord implements IntervalRecord {
    ...
    public int hashCode() {
        ...
        return ((((((hashCode3 + (temperature != null ? temperature.hashCode() : 0)) * 31) + Integer.hashCode(this.measurementLocation)) * 31) + this.deltas.hashCode()) * 31) + getMetadata().hashCode();
    }
    ...
    static {
        ...
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(BodyTemperatureMeasurementLocation.FINGER, 1), TuplesKt.to(BodyTemperatureMeasurementLocation.TOE, 2), TuplesKt.to(BodyTemperatureMeasurementLocation.WRIST, 3));
