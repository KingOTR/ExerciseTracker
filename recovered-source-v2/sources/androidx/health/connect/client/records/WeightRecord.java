...
public final class WeightRecord implements InstantaneousRecord {
    ...
    public int hashCode() {
        int hashCode = ((this.weight.hashCode() * 31) + getTime().hashCode()) * 31;
