...
public final class MenstruationFlowRecord implements InstantaneousRecord {
    ...
    static {
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(CervicalMucusRecord.Sensation.LIGHT, 1), TuplesKt.to(CervicalMucusRecord.Sensation.MEDIUM, 2), TuplesKt.to(CervicalMucusRecord.Sensation.HEAVY, 3));
