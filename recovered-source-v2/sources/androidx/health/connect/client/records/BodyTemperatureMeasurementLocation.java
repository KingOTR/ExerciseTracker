...
public final class BodyTemperatureMeasurementLocation {
    ...
    static {
        Map<String, Integer> mapOf = MapsKt.mapOf(TuplesKt.to(ARMPIT, 1), TuplesKt.to(FINGER, 2), TuplesKt.to(FOREHEAD, 3), TuplesKt.to(MOUTH, 4), TuplesKt.to(RECTUM, 5), TuplesKt.to(TEMPORAL_ARTERY, 6), TuplesKt.to(TOE, 7), TuplesKt.to(EAR, 8), TuplesKt.to(WRIST, 9), TuplesKt.to(VAGINA, 10));
