...
public final class SavedStateHandleSaverKt {
    ...
    public static /* synthetic */ Object saveable$default(SavedStateHandle savedStateHandle, String str, Saver saver, Function0 function0, int i, Object obj) {
        ...
        return m6657saveable(savedStateHandle, str, saver, function0);
    }

    /* renamed from: saveable, reason: collision with other method in class */
    public static final <T> T m6657saveable(SavedStateHandle savedStateHandle, String key, final Saver<T, ? extends Object> saver, Function0<? extends T> init) {
        final T invoke;
        Object obj;
        ...
        if (bundle == null || (obj = bundle.get(Values.VECTOR_MAP_VECTORS_KEY)) == null || (invoke = saver.restore(obj)) == null) {
            invoke = init.invoke();
        }
    ...
    public static final Bundle saveable$lambda$1(Saver saver, Object value) {
        Intrinsics.checkNotNullParameter(saver, "$saver");
        Intrinsics.checkNotNullParameter(value, "$value");
        return BundleKt.bundleOf(TuplesKt.to(Values.VECTOR_MAP_VECTORS_KEY, saver.save(new SavedStateHandleSaverKt$saveable$1$1$1(SavedStateHandle.INSTANCE), value)));
    }
    ...
    public static final <T> MutableState<T> saveable(SavedStateHandle savedStateHandle, String key, Saver<T, ? extends Object> stateSaver, Function0<? extends MutableState<T>> init) {
        ...
        Intrinsics.checkNotNullParameter(init, "init");
        return (MutableState) m6657saveable(savedStateHandle, key, mutableStateSaver(stateSaver), (Function0) init);
    }
    ...
    public static final ReadOnlyProperty saveable$lambda$3(SavedStateHandle this_saveable, Saver saver, Function0 init, Object obj, KProperty property) {
        ...
        final Object m6657saveable = m6657saveable(this_saveable, (obj != null ? Reflection.getOrCreateKotlinClass(obj.getClass()).getQualifiedName() + '.' : "") + property.getName(), (Saver<Object, ? extends Object>) saver, (Function0<? extends Object>) init);
        return new ReadOnlyProperty() { // from class: androidx.lifecycle.viewmodel.compose.SavedStateHandleSaverKt$$ExternalSyntheticLambda3
            ...
            public final Object getValue(Object obj2, KProperty kProperty) {
                ...
                saveable$lambda$3$lambda$2 = SavedStateHandleSaverKt.saveable$lambda$3$lambda$2(m6657saveable, obj2, kProperty);
