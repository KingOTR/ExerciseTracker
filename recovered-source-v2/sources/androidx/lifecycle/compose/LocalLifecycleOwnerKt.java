...
public final class LocalLifecycleOwnerKt {
    ...
    static {
        ...
        try {
            ...
            m7905constructorimpl = Result.m7905constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m7905constructorimpl = Result.m7905constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal<LifecycleOwner> providableCompositionLocal2 = (ProvidableCompositionLocal) (Result.m7911isFailureimpl(m7905constructorimpl) ? null : m7905constructorimpl);
