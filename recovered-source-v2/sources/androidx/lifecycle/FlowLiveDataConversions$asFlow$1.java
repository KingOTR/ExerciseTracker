...
@DebugMetadata(c = "androidx.lifecycle.FlowLiveDataConversions$asFlow$1", f = "FlowLiveData.kt", i = {0, 1, 2}, l = {BuildConfig.VERSION_CODE, SdkConfig.SDK_VERSION, 113, 115}, m = "invokeSuspend", n = {"observer", "observer", "observer"}, s = {"L$0", "L$0", "L$0"})
            ...
            if (r1 == 0) {
                ...
                Observer observer3 = new Observer() { // from class: androidx.lifecycle.FlowLiveDataConversions$asFlow$1$$ExternalSyntheticLambda0
                    ...
                    public final void onChanged(Object obj2) {
                        ProducerScope.this.mo6673trySendJP2dKIU(obj2);
                    }
                };
                this.L$0 = observer3;
                this.label = 1;
