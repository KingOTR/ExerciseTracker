...
public class AnimatorInflaterCompat {
    ...
    */
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        int i = 0;
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(obtainAttributes, xmlPullParser, Values.VECTOR_MAP_VECTORS_KEY, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (z) {
            if (i == 0) {
                ofInt = Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser, Values.VECTOR_MAP_VECTORS_KEY, 0, 0.0f));
            } else {
                ofInt = (i == 1 || i == 3) ? Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, Values.VECTOR_MAP_VECTORS_KEY, 0, 0)) : null;
            }
        } else if (i == 0) {
