...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1419defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m1432defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1432defaultRippleColor5vOe2sY(Color.INSTANCE.m3869getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1432defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m1431defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1431defaultRippleAlphaDxMtmZc(Color.INSTANCE.m3869getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1431defaultRippleAlphaDxMtmZc;
    }
}
