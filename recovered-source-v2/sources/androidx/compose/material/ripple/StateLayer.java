...
final class StateLayer {
    ...
    public final void m1434drawStateLayermxwnekA(DrawScope drawScope, float f, long j) {
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m3842copywmQWz5c$default = Color.m3842copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m4380drawCircleVaOC9Bg$default(drawScope, m3842copywmQWz5c$default, f, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
