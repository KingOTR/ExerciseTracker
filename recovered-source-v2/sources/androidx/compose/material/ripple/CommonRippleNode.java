...
public final class CommonRippleNode extends RippleNode {
    ...
    public void mo1416addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(getBounded() ? Offset.m3591boximpl(interaction.getPressPosition()) : null, targetRadius, getBounded(), null);
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i7 < i6) {
                    if ((j2 & 255) < 128) {
                        ...
                        f2 = pressedAlpha;
                        i3 = i5;
                        ((RippleAnimation) objArr2[i8]).m1420draw4WTKRHQ(drawScope, Color.m3842copywmQWz5c$default(m1429getRippleColor0d7_KjU(), f3, 0.0f, 0.0f, 0.0f, 14, null));
                    } else {
                        f2 = pressedAlpha;
                        i = i7;
                        i2 = i6;
