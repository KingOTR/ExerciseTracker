...
public final class RippleAnimation {
    ...
    */
            ...
            if ((rippleAnimation$animate$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (i != 1) {
                        ...
                        this = (RippleAnimation) rippleAnimation$animate$1.L$0;
                        ResultKt.throwOnFailure(obj);
                        rippleAnimation$animate$1.L$0 = null;
                        rippleAnimation$animate$1.label = 3;
                        if (this.fadeOut(rippleAnimation$animate$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        return Unit.INSTANCE;
                    }
                ...
                this.setFinishedFadingIn(true);
                completableDeferred = this.finishSignalDeferred;
                rippleAnimation$animate$1.L$0 = this;
    ...
    public final void m1420draw4WTKRHQ(DrawScope drawScope, long j) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1422getRippleStartRadiusuvyYCjk(drawScope.mo4399getSizeNHjbRc()));
        }
        if (this.origin == null) {
            this.origin = Offset.m3591boximpl(drawScope.mo4398getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m3591boximpl(OffsetKt.Offset(Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()) / 2.0f, Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m3602getXimpl = Offset.m3602getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(m3602getXimpl, Offset.m3602getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m3603getYimpl = Offset.m3603getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(m3603getYimpl, Offset.m3603getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long m3842copywmQWz5c$default = Color.m3842copywmQWz5c$default(j, Color.m3845getAlphaimpl(j) * floatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m4380drawCircleVaOC9Bg$default(drawScope, m3842copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            return;
        }
        ...
        try {
            drawContext.getTransform().mo4323clipRectN_I0leg(0.0f, 0.0f, m3671getWidthimpl, m3668getHeightimpl, m3832getIntersectrtfAjoo);
            DrawScope.m4380drawCircleVaOC9Bg$default(drawScope, m3842copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        } finally {
