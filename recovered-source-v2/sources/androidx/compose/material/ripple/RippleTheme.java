...
public interface RippleTheme {
    ...
    long mo1419defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1432defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m3895luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m3880getWhite0d7_KjU();
        }
        ...
        public final RippleAlpha m1431defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (ColorKt.m3895luminance8_81llA(contentColor) > 0.5d) {
