...
public final class RippleKt {
    ...
    public static final DelegatableNode m1427createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m1433createPlatformRippleNodeTDGSqEk(interactionSource, z, f, colorProducer, function0);
    }
    ...
    public static final Indication m1428rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3833boximpl(j), composer, (i >> 6) & 14);
        ...
        if ((((i & SdkConfig.SDK_VERSION) ^ 48) <= 32 || !composer.changed(f)) && (i & 48) != 32) {
            z2 = false;
        }
        boolean z4 = z3 | z2;
