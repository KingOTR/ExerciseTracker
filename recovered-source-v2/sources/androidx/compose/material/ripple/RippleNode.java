...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo1416addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    private RippleNode(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        ...
        this.rippleSize = Size.INSTANCE.m3680getZeroNHjbRc();
    ...
    public final long m1429getRippleColor0d7_KjU() {
        return this.color.mo1743invoke0d7_KjU();
    }
    ...
    public void mo366onRemeasuredozmzZPI(long size) {
        ...
        this.rippleSize = IntSizeKt.m6485toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            mo376toPx0680j_4 = RippleAnimationKt.m1421getRippleEndRadiuscSwnlzA(requireDensity, this.bounded, this.rippleSize);
        } else {
            mo376toPx0680j_4 = requireDensity.mo376toPx0680j_4(this.radius);
        }
        this.targetRadius = mo376toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo1416addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m1434drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m1429getRippleColor0d7_KjU());
        }
