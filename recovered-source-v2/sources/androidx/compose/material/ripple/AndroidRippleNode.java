...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo1416addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        RippleHostView rippleHostView = getOrCreateRippleContainer().getRippleHostView(this);
        rippleHostView.m1424addRippleKOepWvA(interaction, getBounded(), size, MathKt.roundToInt(targetRadius), m1429getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0<Unit>() { // from class: androidx.compose.material.ripple.AndroidRippleNode$addRipple$1$1$1
            {
                super(0);
            }
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        RippleHostView rippleHostView = this.rippleHostView;
        if (rippleHostView != null) {
            rippleHostView.m1425setRippleProperties07v42R4(getRippleSize(), m1429getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
