...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1436setColorDxMtmZc(long color, float alpha) {
        long m1435calculateRippleColor5vOe2sY = m1435calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m3844equalsimpl0(color2.m3853unboximpl(), m1435calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m3833boximpl(m1435calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m3897toArgb8_81llA(m1435calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m1435calculateRippleColor5vOe2sY(long color, float alpha) {
        return Color.m3842copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
