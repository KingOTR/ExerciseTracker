...
public final class PlatformRipple extends Ripple {
    ...
    public RippleIndicationInstance mo1417rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new AndroidRippleIndicationInstance(z, f, state, state2, findNearestViewGroup, null);
