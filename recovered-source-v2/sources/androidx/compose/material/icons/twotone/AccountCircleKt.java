...
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AccountCircle", Dp.m6303constructorimpl(24.0f), Dp.m6303constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder3.close();
        ImageVector build = ImageVector.Builder.m4534addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, m4196getButtKaPHkGw3, m4206getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
