...
public final class VectorResources_androidKt {
    public static final ImageVector vectorResource(ImageVector.Companion companion, int i, Composer composer, int i2) {
        ...
        boolean changed = composer.changed(resources) | ((((i2 & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(i)) || (i2 & 48) == 32) | composer.changed(theme) | composer.changed(configuration);
