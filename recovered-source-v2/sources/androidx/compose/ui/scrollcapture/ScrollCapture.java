...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long m6459getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m6459getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTarget = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(boundsInRoot)), new Point(IntOffset.m6431getXimpl(m6459getTopLeftnOccac), IntOffset.m6432getYimpl(m6459getTopLeftnOccac)), composeScrollCaptureCallback);
