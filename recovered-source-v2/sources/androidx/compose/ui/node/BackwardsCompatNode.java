...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m5414constructorimpl(32) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet() & NodeKind.m5414constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m5414constructorimpl(4) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m5414constructorimpl(2) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m5414constructorimpl(128) & backwardsCompatNode.getKindSet()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$3
                        ...
                        public void onLayoutComplete() {
                            ...
                            if (layoutCoordinates == null) {
                                ...
                                backwardsCompatNode2.onPlaced(DelegatableNodeKt.m5301requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m5414constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if ((NodeKind.m5414constructorimpl(256) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof OnGloballyPositionedModifier)) {
        ...
        if ((NodeKind.m5414constructorimpl(16) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator());
        }
        if ((NodeKind.m5414constructorimpl(8) & backwardsCompatNode.getKindSet()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo3490getSizeNHjbRc() {
        return IntSizeKt.m6485toSizeozmzZPI(DelegatableNodeKt.m5301requireCoordinator64DMado(this, NodeKind.m5414constructorimpl(128)).mo5187getSizeYbymL2g());
    }
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        BackwardsCompatNode backwardsCompatNode = this;
        int m5414constructorimpl = NodeKind.m5414constructorimpl(32);
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo67measure3p2s80s(measureScope, measurable, j);
    }
    ...
    public void mo212onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo5074onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo366onRemeasuredozmzZPI(long size) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).m5233onRemeasuredozmzZPI(size);
        }
    }
