...
public final class LayoutNodeLayoutDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            ...
            outerCoordinator.mo5179measureBRTryo0(j);
        }
    };
    ...
    public final Constraints m5347getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m5355getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m5348getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        private long lastPosition = IntOffset.INSTANCE.m6441getZeronOccac();
        ...
        private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m6441getZeronOccac();
            ...
            this.placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinatorBlock$1
                ...
                public final void invoke2() {
                    ...
                    if (graphicsLayer != null) {
                        ...
                        placementScope2.m5258placeWithLayeraW9wM(outerCoordinator, j3, graphicsLayer, f3);
                        return;
                    }
                    if (function1 == null) {
                        ...
                        placementScope2.m5249place70tqf50(outerCoordinator2, j2, f2);
                        return;
                    }
                    ...
                    placementScope2.m5257placeWithLayeraW9wM(outerCoordinator3, j, f, function1);
                }
            };
        }
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m5355getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m6244boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo5179measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                lookaheadPassDelegate.mo5179measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m5356remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m5356remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m6249equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long mo5187getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5187getSizeYbymL2g();
            m5242setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m5346performMeasureBRTryo0(constraints);
            if (IntSize.m6471equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5187getSizeYbymL2g(), mo5187getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m5241setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public void mo5180placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5354placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }

        /* JADX INFO: Access modifiers changed from: protected */
        @Override // androidx.compose.ui.layout.Placeable
        /* renamed from: placeAt-f8xVGno */
        public void mo5240placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5354placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        private final void m5354placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            Placeable.PlacementScope placementScope;
            this.isPlacedByParent = true;
            if (!IntOffset.m6430equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate, IntOffset.m6431getXimpl(position), IntOffset.m6432getYimpl(position), 0.0f, 4, null);
            }
            ...
            m5353placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
        }

        /* renamed from: placeOuterCoordinator-MLgxB_4, reason: not valid java name */
        private final void m5353placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m5404placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
        ...
        public final void replace() {
            ...
            try {
                ...
                boolean isPlaced = getIsPlaced();
                m5353placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m5330remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadPassDelegate != null) {
                if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                    ...
                    mo5179measureBRTryo0(lookaheadConstraints.getValue());
                    return;
                } else {
                    if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InLayoutBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) {
                        ...
                        mo5179measureBRTryo0(lookaheadConstraints2.getValue());
                        return;
                    }
                    return;
                }
        ...
        public final void placeBasedOnLookahead() {
            LookaheadPassDelegate lookaheadPassDelegate = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate();
            if (lookaheadPassDelegate != null) {
                m5354placeSelfMLgxB_4(lookaheadPassDelegate.getLastPosition(), lookaheadPassDelegate.getLastZIndex(), lookaheadPassDelegate.getLastLayerBlock$ui_release(), lookaheadPassDelegate.getLastExplicitLayer());
            } else {
                InlineClassHelperKt.throwIllegalStateExceptionForNullCheck("invalid lookaheadDelegate");
                throw new KotlinNothingValueException();
            }
        ...
        */
        ...
        public final boolean m5352remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m6249equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m6244boximpl(constraints);
            m5242setMeasurementConstraintsBRTryo0(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m5345performLookaheadMeasureBRTryo0(constraints);
            m5241setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m6473getWidthimpl(IntSize) == lookaheadDelegate.getWidth() && IntSize.m6472getHeightimpl(IntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo5180placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5349placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo5240placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5349placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
        private final void m5349placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("place is called on a deactivated node");
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            this.onNodePlacedCalled = false;
            if (!IntOffset.m6430equalsimpl0(position, this.lastPosition)) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m5363placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
                onNodePlaced$ui_release();
            } else {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeSelf$2
                    ...
                    public final void invoke2() {
                        ...
                        Placeable.PlacementScope.m5243place70tqf50$default(placementScope, lookaheadDelegate3, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        LookaheadPassDelegate lookaheadPassDelegate = layoutNode2.getLayoutDelegate().getLookaheadPassDelegate();
                        Intrinsics.checkNotNull(lookaheadPassDelegate);
                        Constraints m5348getLastLookaheadConstraintsDWUhwKw = layoutNode2.getLayoutDelegate().m5348getLastLookaheadConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(m5348getLastLookaheadConstraintsDWUhwKw);
                        if (lookaheadPassDelegate.m5352remeasureBRTryo0(m5348getLastLookaheadConstraintsDWUhwKw.getValue())) {
        ...
        public final void replace() {
            ...
            try {
                ...
                this.onNodePlacedCalled = false;
                boolean isPlaced = getIsPlaced();
                m5349placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
                if (isPlaced && !this.onNodePlacedCalled && (parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release()) != null) {
                    LayoutNode.requestLookaheadRelayout$ui_release$default(parent$ui_release, false, 1, null);
                }
            } finally {
    ...
    public final void m5346performMeasureBRTryo0(long constraints) {
    ...
    public final void m5345performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo5179measureBRTryo0(constraints);
            }
        }, 2, null);
