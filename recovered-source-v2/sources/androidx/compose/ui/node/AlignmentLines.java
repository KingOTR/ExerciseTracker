...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5286calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            Offset = mo5286calculatePositionInParentR5De75A(initialCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            m3602getXimpl = Offset.m3603getYimpl(Offset);
        } else {
            m3602getXimpl = Offset.m3602getXimpl(Offset);
        }
        int round = Math.round(m3602getXimpl);
