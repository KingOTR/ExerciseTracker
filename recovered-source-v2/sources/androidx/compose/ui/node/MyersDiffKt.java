...
public final class MyersDiffKt {
    private static final IntStack calculateDiff(int i, int i2, DiffCallback diffCallback) {
        ...
        int i4 = (i3 * 2) + 1;
        int[] m5288constructorimpl = CenteredArray.m5288constructorimpl(new int[i4]);
        int[] m5288constructorimpl2 = CenteredArray.m5288constructorimpl(new int[i4]);
        int[] m5474constructorimpl = Snake.m5474constructorimpl(new int[5]);
        while (intStack2.isNotEmpty()) {
            int pop = intStack2.pop();
            int pop2 = intStack2.pop();
            int pop3 = intStack2.pop();
            int pop4 = intStack2.pop();
            int[] iArr = m5288constructorimpl;
            int[] iArr2 = m5288constructorimpl2;
            if (m5373midPointq5eDKzI(pop4, pop3, pop2, pop, diffCallback, m5288constructorimpl, m5288constructorimpl2, m5474constructorimpl)) {
                if (Snake.m5477getDiagonalSizeimpl(m5474constructorimpl) > 0) {
                    Snake.m5472addDiagonalToStackimpl(m5474constructorimpl, intStack);
                }
                intStack2.pushRange(pop4, Snake.m5482getStartXimpl(m5474constructorimpl), pop2, Snake.m5483getStartYimpl(m5474constructorimpl));
                intStack2.pushRange(Snake.m5478getEndXimpl(m5474constructorimpl), pop3, Snake.m5479getEndYimpl(m5474constructorimpl), pop);
            }
            m5288constructorimpl = iArr;
            m5288constructorimpl2 = iArr2;
        }
    ...
    private static final boolean m5373midPointq5eDKzI(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int[] iArr3) {
        int i5 = i2 - i;
        int i6 = i4 - i3;
        if (i5 >= 1 && i6 >= 1) {
            int i7 = ((i5 + i6) + 1) / 2;
            CenteredArray.m5294setimpl(iArr, 1, i);
            CenteredArray.m5294setimpl(iArr2, 1, i2);
            int i8 = 0;
            while (i8 < i7) {
                int i9 = i8;
                if (m5372forward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i8, iArr3) || m5371backward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i9, iArr3)) {
                    return true;
                }
                i8 = i9 + 1;
            }
    ...
    private static final boolean m5372forward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int m5291getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m5291getimpl(iArr, i10 + 1) > CenteredArray.m5291getimpl(iArr, i10 - 1))) {
                m5291getimpl = CenteredArray.m5291getimpl(iArr, i10 + 1);
                i6 = m5291getimpl;
            } else {
                m5291getimpl = CenteredArray.m5291getimpl(iArr, i10 - 1);
                i6 = m5291getimpl + 1;
            ...
            int i11 = (i3 + (i6 - i)) - i10;
            int i12 = (i5 == 0 || i6 != m5291getimpl) ? i11 : i11 - 1;
            while (i6 < i2 && i11 < i4) {
            ...
            CenteredArray.m5294setimpl(iArr, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 + 1 && i7 <= i5 - 1) {
                if (CenteredArray.m5291getimpl(iArr2, i7) <= i6) {
                    fillSnake(m5291getimpl, i12, i6, i11, false, iArr3);
                    return true;
                }
            }
        }
    ...
    private static final boolean m5371backward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int m5291getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        int i9 = -i5;
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m5291getimpl(iArr2, i10 + 1) < CenteredArray.m5291getimpl(iArr2, i10 - 1))) {
                m5291getimpl = CenteredArray.m5291getimpl(iArr2, i10 + 1);
                i6 = m5291getimpl;
            } else {
                m5291getimpl = CenteredArray.m5291getimpl(iArr2, i10 - 1);
                i6 = m5291getimpl - 1;
            ...
            CenteredArray.m5294setimpl(iArr2, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 && i7 <= i5) {
                if (CenteredArray.m5291getimpl(iArr, i7) >= i6) {
                    fillSnake(i6, i11, m5291getimpl, i12, true, iArr3);
                    return true;
                }
            }
        }
