...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo5179measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m5242setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo41measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), constraints));
    ...
    public Placeable mo5179measureBRTryo0(long constraints) {
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints = lookaheadDelegate.m5360getConstraintsmsEJaDk$ui_release();
        }
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo41measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), constraints));
        onMeasured();
        return this;
    }
    ...
    */
    public void mo5323hitTestChildYqVAtuI(NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        boolean z;
        boolean z2 = false;
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            if (m5408withinLayerBoundsk4lQ0M(pointerPosition)) {
                ...
                float f = m5396distanceInMinimumTouchTargettz77jQw(pointerPosition, m5399getMinimumTouchTargetSizeNHjbRc());
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode.isPlaced()) {
                        hitTestSource.mo5409childHitTestYqVAtuI(layoutNode, pointerPosition, hitTestResult, isTouchEvent, z);
    ...
    static {
        ...
        Paint.mo3722setColor8_81llA(Color.INSTANCE.m3877getRed0d7_KjU());
