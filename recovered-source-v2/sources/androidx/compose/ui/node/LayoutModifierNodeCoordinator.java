...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode) {
        ...
        if ((layoutModifierNode.getNode().getKindSet() & NodeKind.m5414constructorimpl(512)) != 0) {
    ...
    public final void setLayoutModifierNode$ui_release(LayoutModifierNode layoutModifierNode) {
        if (!Intrinsics.areEqual(layoutModifierNode, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet() & NodeKind.m5414constructorimpl(512)) != 0) {
                Intrinsics.checkNotNull(layoutModifierNode, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
    ...
    public final void m5326setLookaheadConstraints_Sx5XlM$ui_release(Constraints constraints) {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo5179measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m5242setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.m5326setLookaheadConstraints_Sx5XlM$ui_release(Constraints.m6244boximpl(constraints));
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo94measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    */
    public Placeable mo5179measureBRTryo0(long constraints) {
        final MeasureResult mo94measure3p2s80s;
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            boolean z = false;
            approachMeasureScopeImpl.setApproachMeasureRequired$ui_release(approachNode.mo107isMeasurementApproachInProgressozmzZPI(approachMeasureScopeImpl.mo5154getLookaheadSizeYbymL2g()) || !Constraints.m6248equalsimpl(constraints, getLookaheadConstraints()));
            ...
            mo94measure3p2s80s = approachNode.mo106approachMeasure3p2s80s(approachMeasureScopeImpl, getWrappedNonNull(), constraints);
            getWrappedNonNull().setForceMeasureWithLookaheadConstraints$ui_release(false);
            int width = mo94measure3p2s80s.getWidth();
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            if (width == lookaheadDelegate.getWidth()) {
                int height = mo94measure3p2s80s.getHeight();
            ...
            if (!approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long mo5187getSizeYbymL2g = getWrappedNonNull().mo5187getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                if (IntSize.m6470equalsimpl(mo5187getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m6465boximpl(lookaheadDelegate3.m5361getSizeYbymL2g$ui_release()) : null) && !z) {
                    mo94measure3p2s80s = new MeasureResult(this) { // from class: androidx.compose.ui.node.LayoutModifierNodeCoordinator$measure$1$1$1$1
        ...
        mo94measure3p2s80s = getLayoutModifierNode().mo94measure3p2s80s(this, getWrappedNonNull(), constraints);
        setMeasureResult$ui_release(mo94measure3p2s80s);
    ...
    protected void mo5240placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        super.mo5240placeAtf8xVGno(position, zIndex, layer);
        onAfterPlaceAt();
    }
    ...
    protected void mo5180placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo5180placeAtf8xVGno(position, zIndex, layerBlock);
        onAfterPlaceAt();
    }
    ...
    private final void onAfterPlaceAt() {
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            if (!approachNode.isPlacementApproachInProgress(placementScope, lookaheadDelegate.getLookaheadLayoutCoordinates()) && !approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long j = mo5187getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate2 = getLookaheadDelegate();
                if (IntSize.m6470equalsimpl(j, lookaheadDelegate2 != null ? IntSize.m6465boximpl(lookaheadDelegate2.m5361getSizeYbymL2g$ui_release()) : null)) {
                    long mo5187getSizeYbymL2g = getWrappedNonNull().mo5187getSizeYbymL2g();
                    LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                    if (IntSize.m6470equalsimpl(mo5187getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m6465boximpl(lookaheadDelegate3.m5361getSizeYbymL2g$ui_release()) : null)) {
                        z = true;
    ...
    static {
        ...
        Paint.mo3722setColor8_81llA(Color.INSTANCE.m3870getBlue0d7_KjU());
