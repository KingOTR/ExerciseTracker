...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode delegatableNode) {
        ...
        int m5414constructorimpl2 = NodeKind.m5414constructorimpl(2);
        Modifier.Node child = delegatableNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & m5414constructorimpl) == 0) {
            return null;
        }
        while (child != null && (child.getKindSet() & m5414constructorimpl2) == 0) {
