...
public final class NodeKindKt {
    ...
    public static final boolean m5422contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m5424or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m5414constructorimpl = NodeKind.m5414constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(256);
        }
        if (node instanceof ApproachLayoutModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            m5414constructorimpl |= NodeKind.m5414constructorimpl(131072);
        }
        int m5414constructorimpl2 = node instanceof TraversableNode ? NodeKind.m5414constructorimpl(262144) | m5414constructorimpl : m5414constructorimpl;
        mutableObjectIntMap.set(classKeyForObject, m5414constructorimpl2);
        return m5414constructorimpl2;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m5414constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m5301requireCoordinator64DMado(node, NodeKind.m5414constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m5414constructorimpl(128) & i) != 0 && (node instanceof LayoutAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m5414constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateOnPositioned$ui_release();
            }
            if ((NodeKind.m5414constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m5414constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m5414constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m5414constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode) && i2 != 2) {
                FocusTargetNodeKt.invalidateFocusTarget((FocusTargetNode) node);
            }
            if ((NodeKind.m5414constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m5414constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m5423getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m5414constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m5414constructorimpl | NodeKind.m5414constructorimpl(128) : m5414constructorimpl;
    }
}
