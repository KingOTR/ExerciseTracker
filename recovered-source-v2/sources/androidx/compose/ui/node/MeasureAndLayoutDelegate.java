...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m5369updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m6244boximpl(constraints);
    ...
    private final boolean m5366doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m5329lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            m5329lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m5333lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m5329lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m5329lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m5329lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m5329lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m5367doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m5330remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m5330remeasure_Sx5XlM$ui_release$default = layoutNode.m5334remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m5330remeasure_Sx5XlM$ui_release$default = LayoutNode.m5330remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m5330remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m5330remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m5368measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m5366doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6244boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m5367doRemeasuresdFAvZA(layoutNode, Constraints.m6244boximpl(constraints));
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        if (layoutNode.isPlaced() || layoutNode.isPlacedByParent() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (affectsLookahead) {
                r1 = layoutNode.getLookaheadMeasurePending$ui_release() ? m5366doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
                ...
                boolean m5367doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m5367doRemeasuresdFAvZA(layoutNode, constraints) : false;
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m5366doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m5367doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
