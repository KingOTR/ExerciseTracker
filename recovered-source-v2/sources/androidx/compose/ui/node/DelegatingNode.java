...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    protected final <T extends DelegatableNode> T delegate(T delegatableNode) {
        ...
        if (getIsAttached()) {
            if ((calculateNodeKindSetFromIncludingDelegates & NodeKind.m5414constructorimpl(2)) != 0 && (kindSet$ui_release & NodeKind.m5414constructorimpl(2)) == 0) {
    ...
    protected final void undelegate(DelegatableNode instance) {
        ...
        for (Modifier.Node node2 = this.delegate; node2 != null; node2 = node2.getChild()) {
            if (node2 == instance) {
                ...
                if (getIsAttached() && (kindSet$ui_release & NodeKind.m5414constructorimpl(2)) != 0 && (NodeKind.m5414constructorimpl(2) & calculateNodeKindSetFromIncludingDelegates) == 0) {
                    NodeChain nodes = DelegatableNodeKt.requireLayoutNode(this).getNodes();
                    getNode().updateCoordinator$ui_release(null);
                    nodes.syncCoordinators();
                    return;
    ...
    private final void validateDelegateKindSet(int delegateKindSet, Modifier.Node delegateNode) {
        int kindSet$ui_release = getKindSet();
        if ((delegateKindSet & NodeKind.m5414constructorimpl(2)) == 0 || (NodeKind.m5414constructorimpl(2) & kindSet$ui_release) == 0 || (this instanceof LayoutModifierNode)) {
            return;
        }
