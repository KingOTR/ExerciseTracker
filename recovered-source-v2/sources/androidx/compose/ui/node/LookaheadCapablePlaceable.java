...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode, MotionReferencePlacementDelegate {
    ...
    public final int get(AlignmentLine alignmentLine) {
        ...
        if (alignmentLine instanceof VerticalAlignmentLine) {
            m6432getYimpl = IntOffset.m6431getXimpl(getApparentToRealOffset());
        } else {
            m6432getYimpl = IntOffset.m6432getYimpl(getApparentToRealOffset());
        }
        return calculateAlignmentLine + m6432getYimpl;
    }
    ...
    */
    private final void addRulerReader(LayoutNode layoutNode, Ruler ruler) {
        ...
        if (mutableScatterMap4 == null) {
            i = 1;
            i2 = 0;
            mutableScatterMap4 = new MutableScatterMap<>(i2, i, defaultConstructorMarker);
