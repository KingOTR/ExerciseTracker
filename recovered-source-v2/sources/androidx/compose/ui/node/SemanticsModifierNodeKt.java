...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5301requireCoordinator64DMado(node, NodeKind.m5414constructorimpl(8)));
        }
        return DelegatableNodeKt.m5301requireCoordinator64DMado(node, NodeKind.m5414constructorimpl(8)).touchBoundsInRoot();
    }
}
