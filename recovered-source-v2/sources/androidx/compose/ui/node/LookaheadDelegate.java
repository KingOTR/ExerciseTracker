...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m5365setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m5361getSizeYbymL2g$ui_release() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: getConstraints-msEJaDk$ui_release, reason: not valid java name */
    public final long m5360getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m5241setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m5241setMeasuredSizeozmzZPI(IntSize.INSTANCE.m6478getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo5180placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo5180placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5359placeSelfgyyYBs(position);
    ...
    private final void m5359placeSelfgyyYBs(long position) {
        if (!IntOffset.m6430equalsimpl0(getPosition(), position)) {
            m5365setPositiongyyYBs(position);
    ...
    public final void m5363placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m5359placeSelfgyyYBs(IntOffset.m6435plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m5362performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m5364positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long m6441getZeronOccac = IntOffset.INSTANCE.m6441getZeronOccac();
        while (!Intrinsics.areEqual(this, ancestor)) {
            if (!this.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                m6441getZeronOccac = IntOffset.m6435plusqkQi6aY(m6441getZeronOccac, this.getPosition());
            }
            NodeCoordinator wrappedBy = this.coordinator.getWrappedBy();
