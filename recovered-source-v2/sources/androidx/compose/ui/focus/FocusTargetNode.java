...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public void onDetach() {
        ...
        if (i == 1 || i == 2) {
            DelegatableNodeKt.requireOwner(this).getFocusOwner().mo3531clearFocusI7lrPNg(true, true, false, FocusDirection.INSTANCE.m3522getExitdhqQ8s());
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int m5414constructorimpl = NodeKind.m5414constructorimpl(2048);
        int m5414constructorimpl2 = NodeKind.m5414constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = m5414constructorimpl | m5414constructorimpl2;
            ...
            if ((requireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & i) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & i) != 0) {
                        if (node2 != node && (node2.getKindSet() & m5414constructorimpl2) != 0) {
                            break loop0;
                        }
    ...
    public final void m3547fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (this.isProcessingCustomEnter) {
            return;
        }
        this.isProcessingCustomEnter = true;
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m3511boximpl(focusDirection));
    ...
    public final void m3548fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (this.isProcessingCustomExit) {
            return;
        }
        this.isProcessingCustomExit = true;
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m3511boximpl(focusDirection));
            if (invoke != FocusRequester.INSTANCE.getDefault()) {
                block.invoke(invoke);
            }
        } finally {
    ...
    /* compiled from: FocusTargetNode.kt */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bÀ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0002H\u0016J\u0013\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0096\u0002J\b\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0002H\u0016J\f\u0010\u000e\u001a\u00020\f*\u00020\u000fH\u0016¨\u0006\u0010"}, d2 = {"Landroidx/compose/ui/focus/FocusTargetNode$FocusTargetElement;", "Landroidx/compose/ui/node/ModifierNodeElement;", "Landroidx/compose/ui/focus/FocusTargetNode;", "()V", "create", "equals", "", Vo2MaxRecord.MeasurementMethod.OTHER, "", "hashCode", "", "update", "", "node", "inspectableProperties", "Landroidx/compose/ui/platform/InspectorInfo;", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
                ...
                for (Modifier.Node node2 = node; node2 != null; node2 = node2.getChild()) {
                    if ((node2.getKindSet() & m5414constructorimpl) != 0) {
                        ...
                        while (node3 != null) {
                            ...
                            } else if ((node3.getKindSet() & m5414constructorimpl) != 0 && (node3 instanceof DelegatingNode)) {
                                int i2 = 0;
