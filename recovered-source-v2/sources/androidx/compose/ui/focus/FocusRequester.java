...
public final class FocusRequester {
    ...
    */
    public final boolean findFocusTargetNode$ui_release(Function1<? super FocusTargetNode, Boolean> onFound) {
        boolean m3563findChildCorrespondingToFocusEnterOMvw8;
        Companion companion = INSTANCE;
        if (this == companion.getDefault()) {
            throw new IllegalStateException("\n    Please check whether the focusRequester is FocusRequester.Cancel or FocusRequester.Default\n    before invoking any functions on the focusRequester.\n".toString());
        }
                            ...
                            while (node != null) {
                                if (node instanceof FocusTargetNode) {
                                    ...
                                    if (focusTargetNode.fetchFocusProperties$ui_release().getCanFocus()) {
                                        m3563findChildCorrespondingToFocusEnterOMvw8 = onFound.invoke(focusTargetNode).booleanValue();
                                    } else {
                                        m3563findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m3563findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.INSTANCE.m3521getEnterdhqQ8s(), onFound);
                                    }
                                    if (m3563findChildCorrespondingToFocusEnterOMvw8) {
                                        z = true;
                                        break;
                                    }
                                } else if ((node.getKindSet() & m5414constructorimpl) != 0 && (node instanceof DelegatingNode)) {
