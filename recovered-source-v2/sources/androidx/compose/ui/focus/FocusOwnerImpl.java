...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    public boolean mo3535requestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
    ...
    public boolean mo3536takeFocusaToIllA(final int focusDirection, Rect previouslyFocusedRect) {
        Boolean mo3534focusSearchULY8qGw = mo3534focusSearchULY8qGw(focusDirection, previouslyFocusedRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$takeFocus$1
            ...
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                Boolean m3553requestFocusMxy_nc0 = FocusTransactionsKt.m3553requestFocusMxy_nc0(focusTargetNode, focusDirection);
    ...
    public void clearFocus(boolean force) {
        mo3531clearFocusI7lrPNg(force, true, true, FocusDirection.INSTANCE.m3522getExitdhqQ8s());
    }

    @Override // androidx.compose.ui.focus.FocusOwner
    /* renamed from: clearFocus-I7lrPNg */
    public boolean mo3531clearFocusI7lrPNg(boolean force, boolean refreshFocusEvents, boolean clearOwnerFocus, int focusDirection) {
        boolean clearFocus;
        FocusTransactionManager focusTransactionManager = getFocusTransactionManager();
        ...
        try {
            ...
            if (!force) {
                int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m3549performCustomClearFocusMxy_nc0(this.rootFocusNode, focusDirection).ordinal()];
                if (i == 1 || i == 2 || i == 3) {
                    clearFocus = false;
    ...
    public boolean mo3529moveFocus3ESFkO8(final int focusDirection) {
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = false;
        Boolean mo3534focusSearchULY8qGw = mo3534focusSearchULY8qGw(focusDirection, this.onFocusRectInterop.invoke(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$moveFocus$focusSearchSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                objectRef.element = FocusTransactionsKt.m3553requestFocusMxy_nc0(focusTargetNode, focusDirection);
                Boolean bool = objectRef.element;
                return Boolean.valueOf(bool != null ? bool.booleanValue() : false);
            }
        });
        if (mo3534focusSearchULY8qGw == null || objectRef.element == 0) {
            return false;
        }
        if (Intrinsics.areEqual((Object) mo3534focusSearchULY8qGw, (Object) true) && Intrinsics.areEqual((Object) objectRef.element, (Object) true)) {
            return true;
        }
        if (FocusOwnerImplKt.m3540is1dFocusSearch3ESFkO8(focusDirection)) {
            return mo3531clearFocusI7lrPNg(false, true, false, focusDirection) && mo3536takeFocusaToIllA(focusDirection, null);
        }
        return this.onMoveFocusInterop.invoke(FocusDirection.m3511boximpl(focusDirection)).booleanValue();
    }

    @Override // androidx.compose.ui.focus.FocusOwner
    /* renamed from: focusSearch-ULY8qGw */
    public Boolean mo3534focusSearchULY8qGw(int focusDirection, Rect focusedRect, final Function1<? super FocusTargetNode, Boolean> onFound) {
        final FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (findActiveFocusNode != null) {
            FocusRequester m3554customFocusSearchOMvw8 = FocusTraversalKt.m3554customFocusSearchOMvw8(findActiveFocusNode, focusDirection, this.onLayoutDirection.invoke());
            if (Intrinsics.areEqual(m3554customFocusSearchOMvw8, FocusRequester.INSTANCE.getCancel())) {
                return null;
            }
            if (!Intrinsics.areEqual(m3554customFocusSearchOMvw8, FocusRequester.INSTANCE.getDefault())) {
                return Boolean.valueOf(m3554customFocusSearchOMvw8.findFocusTargetNode$ui_release(onFound));
            }
        } else {
            findActiveFocusNode = null;
        }
        return FocusTraversalKt.m3555focusSearch0X8WOeE(this.rootFocusNode, focusDirection, this.onLayoutDirection.invoke(), focusedRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$focusSearch$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
    ...
    /* JADX WARN: Type inference failed for: r11v20, types: [androidx.compose.ui.Modifier$Node] */
    ...
    public boolean mo3533dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> onFocusedItem) {
        ...
        if (!m3539validateKeyEventZmokQxo(keyEvent)) {
            return false;
        }
        ...
        if (findActiveFocusNode == null || (node = lastLocalKeyInputNode(findActiveFocusNode)) == null) {
            if (findActiveFocusNode != null) {
                ...
                int m5414constructorimpl = NodeKind.m5414constructorimpl(8192);
                        ...
                        while (node2 != null) {
                            if ((node2.getKindSet() & m5414constructorimpl) != 0) {
                                ...
                                while (delegatingNode2 != 0) {
                                    ...
                                    if ((delegatingNode2.getKindSet() & m5414constructorimpl) != 0 && (delegatingNode2 instanceof DelegatingNode)) {
            ...
            int m5414constructorimpl2 = NodeKind.m5414constructorimpl(8192);
            ...
            loop14: while (true) {
                ...
                if ((requireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & m5414constructorimpl2) != 0) {
                    while (parent != null) {
                        if ((parent.getKindSet() & m5414constructorimpl2) != 0) {
                            ...
                            while (delegatingNode != 0) {
                                ...
                                if ((delegatingNode.getKindSet() & m5414constructorimpl2) != 0 && (delegatingNode instanceof DelegatingNode)) {
                                    Modifier.Node delegate2 = delegatingNode.getDelegate();
                                    int i2 = 0;
                                    delegatingNode = delegatingNode;
                                    while (delegate2 != null) {
                                        if ((delegate2.getKindSet() & m5414constructorimpl2) != 0) {
                                            i2++;
                                            if (i2 == 1) {
        ...
        if (node != null) {
            ...
            int m5414constructorimpl3 = NodeKind.m5414constructorimpl(8192);
            ...
            while (requireLayoutNode3 != null) {
                if ((requireLayoutNode3.getNodes().getHead().getAggregateChildKindSet() & m5414constructorimpl3) != 0) {
                    while (parent2 != null) {
                        if ((parent2.getKindSet() & m5414constructorimpl3) != 0) {
                            ...
                            while (node4 != null) {
                                if (node4 instanceof KeyInputModifierNode) {
                                    ...
                                    arrayList.add(node4);
                                } else if ((node4.getKindSet() & m5414constructorimpl3) != 0 && (node4 instanceof DelegatingNode)) {
                                    int i3 = 0;
                                    for (Modifier.Node delegate3 = ((DelegatingNode) node4).getDelegate(); delegate3 != null; delegate3 = delegate3.getChild()) {
                                        if ((delegate3.getKindSet() & m5414constructorimpl3) != 0) {
                                            i3++;
                                            if (i3 == 1) {
                                                node4 = delegate3;
                                            } else {
            ...
            if (arrayList != null) {
                ...
                if (size >= 0) {
                    while (true) {
                        int i4 = size - 1;
                        if (((KeyInputModifierNode) arrayList.get(size)).mo213onPreKeyEventZmokQxo(keyEvent)) {
                            return true;
                        }
                        if (i4 < 0) {
                            break;
            ...
            while (node5 != 0) {
                if (node5 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node5).mo213onPreKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node5.getKindSet() & m5414constructorimpl3) != 0 && (node5 instanceof DelegatingNode)) {
                    Modifier.Node delegate4 = node5.getDelegate();
                    int i5 = 0;
                    node5 = node5;
                    while (delegate4 != null) {
                        if ((delegate4.getKindSet() & m5414constructorimpl3) != 0) {
                            i5++;
                            if (i5 == 1) {
                                node5 = delegate4;
                            } else {
            ...
            while (node6 != 0) {
                if (node6 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node6).mo211onKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node6.getKindSet() & m5414constructorimpl3) != 0 && (node6 instanceof DelegatingNode)) {
                    Modifier.Node delegate5 = node6.getDelegate();
                    int i6 = 0;
                    node6 = node6;
                    while (delegate5 != null) {
                        if ((delegate5.getKindSet() & m5414constructorimpl3) != 0) {
                            i6++;
                            if (i6 == 1) {
                                node6 = delegate5;
                            } else {
            ...
            if (arrayList != null) {
                ...
                for (int i7 = 0; i7 < size2; i7++) {
                    if (((KeyInputModifierNode) arrayList.get(i7)).mo211onKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                }
    ...
    public boolean mo3532dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (findActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = findActiveFocusNode;
            int m5414constructorimpl = NodeKind.m5414constructorimpl(131072);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
                    ...
                    while (node != null) {
                        if ((node.getKindSet() & m5414constructorimpl) != 0) {
                            ...
                            while (delegatingNode != 0) {
                                ...
                                if ((delegatingNode.getKindSet() & m5414constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            ...
            int m5414constructorimpl2 = NodeKind.m5414constructorimpl(131072);
                        ...
                        if ((parent.getKindSet() & m5414constructorimpl2) != 0) {
                            ...
                            while (node2 != null) {
                                if (node2 instanceof SoftKeyboardInterceptionModifierNode) {
                                    ...
                                    arrayList.add(node2);
                                } else if ((node2.getKindSet() & m5414constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                                    int i2 = 0;
            ...
            if (arrayList != null && arrayList.size() - 1 >= 0) {
                while (true) {
                    int i3 = size - 1;
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(size)).mo4596onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                    if (i3 < 0) {
                        break;
            ...
            while (node3 != 0) {
                if (node3 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node3).mo4596onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node3.getKindSet() & m5414constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                    Modifier.Node delegate3 = node3.getDelegate();
                    int i4 = 0;
                    node3 = node3;
                    while (delegate3 != null) {
                        if ((delegate3.getKindSet() & m5414constructorimpl2) != 0) {
                            i4++;
                            if (i4 == 1) {
                                node3 = delegate3;
                            } else {
            ...
            while (node4 != 0) {
                if (node4 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node4).mo4595onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node4.getKindSet() & m5414constructorimpl2) != 0 && (node4 instanceof DelegatingNode)) {
                    Modifier.Node delegate4 = node4.getDelegate();
                    int i5 = 0;
                    node4 = node4;
                    while (delegate4 != null) {
                        if ((delegate4.getKindSet() & m5414constructorimpl2) != 0) {
                            i5++;
                            if (i5 == 1) {
                                node4 = delegate4;
                            } else {
            ...
            if (arrayList != null) {
                ...
                for (int i6 = 0; i6 < size2; i6++) {
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i6)).mo4595onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                }
            }
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent event) {
        ...
        if (findActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = findActiveFocusNode;
            int m5414constructorimpl = NodeKind.m5414constructorimpl(16384);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node node = focusTargetNode.getNode();
        ...
        if (rotaryInputModifierNode != null) {
            ...
            int m5414constructorimpl2 = NodeKind.m5414constructorimpl(16384);
    ...
    private final boolean m3539validateKeyEventZmokQxo(KeyEvent keyEvent) {
        long m4908getKeyZmokQxo = KeyEvent_androidKt.m4908getKeyZmokQxo(keyEvent);
        int m4909getTypeZmokQxo = KeyEvent_androidKt.m4909getTypeZmokQxo(keyEvent);
        if (KeyEventType.m4901equalsimpl0(m4909getTypeZmokQxo, KeyEventType.INSTANCE.m4905getKeyDownCS__XNY())) {
            MutableLongSet mutableLongSet = this.keysCurrentlyDown;
            if (mutableLongSet == null) {
                mutableLongSet = new MutableLongSet(3);
                this.keysCurrentlyDown = mutableLongSet;
            }
            mutableLongSet.plusAssign(m4908getKeyZmokQxo);
        } else if (KeyEventType.m4901equalsimpl0(m4909getTypeZmokQxo, KeyEventType.INSTANCE.m4906getKeyUpCS__XNY())) {
            MutableLongSet mutableLongSet2 = this.keysCurrentlyDown;
            if (mutableLongSet2 == null || !mutableLongSet2.contains(m4908getKeyZmokQxo)) {
                return false;
            }
            MutableLongSet mutableLongSet3 = this.keysCurrentlyDown;
            if (mutableLongSet3 != null) {
                mutableLongSet3.remove(m4908getKeyZmokQxo);
            }
        }
        return true;
    }
    ...
    private final /* synthetic */ <T extends DelegatableNode> void m3538traverseAncestorsIncludingSelfQFhIj7k(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1, Function0<Unit> function0, Function1<? super T, Unit> function12) {
        int i2;
        int size;
        NodeChain nodes;
    ...
    private final /* synthetic */ <T> T m3537nearestAncestorIncludingSelf64DMado(DelegatableNode delegatableNode, int i) {
        NodeChain nodes;
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int m5414constructorimpl = NodeKind.m5414constructorimpl(1024) | NodeKind.m5414constructorimpl(8192);
        if (!delegatableNode.getNode().getIsAttached()) {
        ...
        if ((node.getAggregateChildKindSet() & m5414constructorimpl) != 0) {
            for (Modifier.Node child = node.getChild(); child != null; child = child.getChild()) {
                if ((child.getKindSet() & m5414constructorimpl) != 0) {
                    if ((NodeKind.m5414constructorimpl(1024) & child.getKindSet()) != 0) {
                        return node2;
                    }
                    node2 = child;
                }
