...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode focusTargetNode) {
        Boolean m3553requestFocusMxy_nc0 = m3553requestFocusMxy_nc0(focusTargetNode, FocusDirection.INSTANCE.m3521getEnterdhqQ8s());
        if (m3553requestFocusMxy_nc0 != null) {
            return m3553requestFocusMxy_nc0.booleanValue();
        }
        return false;
    }

    /* renamed from: requestFocus-Mxy_nc0, reason: not valid java name */
    public static final Boolean m3553requestFocusMxy_nc0(final FocusTargetNode focusTargetNode, int i) {
        Boolean valueOf;
        ...
        try {
            ...
            int i2 = WhenMappings.$EnumSwitchMapping$0[m3552performCustomRequestFocusMxy_nc0(focusTargetNode, i).ordinal()];
            if (i2 == 1) {
    ...
    */
    ...
    private static final boolean requestFocusForChild(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2) {
        ...
        if (i2 != 2) {
            if (i2 == 3) {
                ...
                int m5414constructorimpl2 = NodeKind.m5414constructorimpl(1024);
                ...
                loop4: while (true) {
                    ...
                    if ((requireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & m5414constructorimpl2) != 0) {
                        while (parent2 != null) {
                            if ((parent2.getKindSet() & m5414constructorimpl2) != 0) {
                                ...
                                while (node3 != null) {
                                    ...
                                    if ((node3.getKindSet() & m5414constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                                        int i3 = 0;
    ...
    private static final boolean requestFocusForOwner(FocusTargetNode focusTargetNode) {
        return DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().mo3535requestFocusForOwner7o62pno(null, null);
    }
    ...
    public static final CustomDestinationResult m3552performCustomRequestFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        Modifier.Node node;
        NodeChain nodes;
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 == 1 || i2 == 2) {
        ...
        if (i2 == 3) {
            return m3549performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
        }
        if (i2 == 4) {
            FocusTargetNode focusTargetNode2 = focusTargetNode;
            int m5414constructorimpl = NodeKind.m5414constructorimpl(1024);
            ...
            if (i4 == 1) {
                return m3550performCustomEnterMxy_nc0(focusTargetNode3, i);
            }
            if (i4 == 2) {
                return CustomDestinationResult.Cancelled;
            }
            if (i4 == 3) {
                return m3552performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            }
            if (i4 != 4) {
                throw new NoWhenBranchMatchedException();
            }
            CustomDestinationResult m3552performCustomRequestFocusMxy_nc0 = m3552performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            CustomDestinationResult customDestinationResult = m3552performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? m3552performCustomRequestFocusMxy_nc0 : null;
            return customDestinationResult == null ? m3550performCustomEnterMxy_nc0(focusTargetNode3, i) : customDestinationResult;
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: performCustomClearFocus-Mxy_nc0, reason: not valid java name */
    public static final CustomDestinationResult m3549performCustomClearFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                return CustomDestinationResult.Cancelled;
            ...
            if (i2 == 3) {
                CustomDestinationResult m3549performCustomClearFocusMxy_nc0 = m3549performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
                if (m3549performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    m3549performCustomClearFocusMxy_nc0 = null;
                }
                return m3549performCustomClearFocusMxy_nc0 == null ? m3551performCustomExitMxy_nc0(focusTargetNode, i) : m3549performCustomClearFocusMxy_nc0;
            }
            if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    private static final CustomDestinationResult m3550performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m3511boximpl(i));
    ...
    private static final CustomDestinationResult m3551performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m3511boximpl(i));
                if (invoke != FocusRequester.INSTANCE.getDefault()) {
                    if (invoke == FocusRequester.INSTANCE.getCancel()) {
                        return CustomDestinationResult.Cancelled;
                    }
