...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m3567twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m3563findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 == 4) {
                ...
                return Boolean.valueOf(m3566searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
            }
        ...
        if (i3 == 1) {
            Boolean m3567twoDimensionalFocusSearchsMXa3k8 = m3567twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (!Intrinsics.areEqual((Object) m3567twoDimensionalFocusSearchsMXa3k8, (Object) false)) {
                return m3567twoDimensionalFocusSearchsMXa3k8;
            }
            if (rect == null) {
                rect = FocusTraversalKt.focusRect(activeNode(activeChild));
            }
            return Boolean.valueOf(m3564generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            if (rect == null) {
    ...
    private static final boolean m3564generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3566searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3510searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean m3566searchChildren4C6V_qg;
                m3566searchChildren4C6V_qg = TwoDimensionalFocusSearchKt.m3566searchChildren4C6V_qg(FocusTargetNode.this, rect, i, function1);
                Boolean valueOf = Boolean.valueOf(m3566searchChildren4C6V_qg);
    ...
    private static final FocusTargetNode m3562findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect translate;
        if (FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3523getLeftdhqQ8s())) {
            ...
            translate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3527getUpdhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m3565isBetterCandidateI7lrPNg(focusRect, translate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3523getLeftdhqQ8s())) {
            if (FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3526getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float left2;
        float width;
        if (FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3523getLeftdhqQ8s()) ? true : FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3526getRightdhqQ8s())) {
            f = 2;
            left = rect2.getTop() + (rect2.getHeight() / f);
            left2 = rect.getTop();
            width = rect.getHeight();
        } else {
            if (!(FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3527getUpdhqQ8s()) ? true : FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3520getDowndhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m3565isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m3561beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m3561beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    private static final boolean m3561beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3523getLeftdhqQ8s()) || FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3526getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m3563findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        Rect bottomRight;
        ...
        if (FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3521getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m3526getRightdhqQ8s();
        }
        if (FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3526getRightdhqQ8s()) ? true : FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3520getDowndhqQ8s())) {
            bottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            if (!(FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3523getLeftdhqQ8s()) ? true : FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3527getUpdhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            bottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        }
        FocusTargetNode m3562findBestCandidate4WY_MpI = m3562findBestCandidate4WY_MpI(mutableVector, bottomRight, i);
        if (m3562findBestCandidate4WY_MpI != null) {
            return function1.invoke(m3562findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m3566searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode m3562findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector.isNotEmpty() && (m3562findBestCandidate4WY_MpI = m3562findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (m3562findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(m3562findBestCandidate4WY_MpI).booleanValue();
            }
            if (m3564generateAndSearchChildren4C6V_qg(m3562findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(m3562findBestCandidate4WY_MpI);
        }
        return false;
    }
