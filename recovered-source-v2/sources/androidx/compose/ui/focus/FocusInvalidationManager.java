                        ...
                        if ((j3 & 255) < 128) {
                            ...
                            if (focusEventModifierNode.getNode().getIsAttached()) {
                                ...
                                while (mutableVector8.isNotEmpty()) {
                                    ...
                                    if ((node4.getAggregateChildKindSet() & m5414constructorimpl2) == 0) {
                                        DelegatableNodeKt.addLayoutNodeChildren(mutableVector8, node4);
                                    } else {
                                        while (node4 != null) {
                                            if ((node4.getKindSet() & m5414constructorimpl2) != 0) {
                                                ...
                                                while (node4 != null) {
                                                    if (node4 instanceof FocusTargetNode) {
                                                        ...
                                                        mutableVector = mutableVector8;
                                                        i2 = m5414constructorimpl2;
                                                        if (i18 == 1) {
                                                            m5414constructorimpl2 = i2;
                                    ...
                                    m5414constructorimpl2 = m5414constructorimpl2;
                                    mutableVector8 = mutableVector8;
                                }
                                if (z4) {
                                    if (z6) {
