...
public final class FocusInteropUtils_androidKt {
    public static final FocusDirection toFocusDirection(int i) {
        if (i == 1) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3525getPreviousdhqQ8s());
        }
        if (i == 2) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3524getNextdhqQ8s());
        }
        if (i == 17) {
    ...
    public static final Integer m3528toAndroidFocusDirection3ESFkO8(int i) {
        ...
        return FocusDirection.m3514equalsimpl0(i, FocusDirection.INSTANCE.m3525getPreviousdhqQ8s()) ? 1 : null;
    }
