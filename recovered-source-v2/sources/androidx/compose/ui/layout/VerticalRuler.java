...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3602getXimpl(targetCoordinates.mo5188localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(coordinate, IntSize.m6472getHeightimpl(sourceCoordinates.mo5187getSizeYbymL2g()) / 2.0f)));
    }
}
