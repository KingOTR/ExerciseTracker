...
public interface ApproachLayoutModifierNode extends LayoutModifierNode {
    ...
    boolean mo107isMeasurementApproachInProgressozmzZPI(long lookaheadSize);
    ...
    default MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    default int minApproachIntrinsicWidth(ApproachIntrinsicMeasureScope approachIntrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.ApproachMeasureBlock() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode$minApproachIntrinsicWidth$1
            ...
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo5155measure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
                return ApproachLayoutModifierNode.this.mo106approachMeasure3p2s80s(approachMeasureScope, measurable, j);
            }
