...
public interface ContentScale {
    ...
    long mo5170computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo5170computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5176computeFillMaxDimensioniLBOSCw;
                m5176computeFillMaxDimensioniLBOSCw = ContentScaleKt.m5176computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5176computeFillMaxDimensioniLBOSCw, m5176computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5170computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5177computeFillMinDimensioniLBOSCw;
                m5177computeFillMinDimensioniLBOSCw = ContentScaleKt.m5177computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5177computeFillMinDimensioniLBOSCw, m5177computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5170computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5175computeFillHeightiLBOSCw;
                m5175computeFillHeightiLBOSCw = ContentScaleKt.m5175computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5175computeFillHeightiLBOSCw, m5175computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5170computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5178computeFillWidthiLBOSCw;
                m5178computeFillWidthiLBOSCw = ContentScaleKt.m5178computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5178computeFillWidthiLBOSCw, m5178computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo5170computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5177computeFillMinDimensioniLBOSCw;
                if (Size.m3671getWidthimpl(srcSize) > Size.m3671getWidthimpl(dstSize) || Size.m3668getHeightimpl(srcSize) > Size.m3668getHeightimpl(dstSize)) {
                    m5177computeFillMinDimensioniLBOSCw = ContentScaleKt.m5177computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(m5177computeFillMinDimensioniLBOSCw, m5177computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo5170computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                m5178computeFillWidthiLBOSCw = ContentScaleKt.m5178computeFillWidthiLBOSCw(srcSize, dstSize);
                m5175computeFillHeightiLBOSCw = ContentScaleKt.m5175computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5178computeFillWidthiLBOSCw, m5175computeFillHeightiLBOSCw);
            }
        };
