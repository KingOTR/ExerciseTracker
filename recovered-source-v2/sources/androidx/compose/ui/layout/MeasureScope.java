...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5221roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo369roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m5222roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo370roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m5223toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo371toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5224toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo372toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5225toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo373toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m5226toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo374toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m5227toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo375toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m5228toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo376toPx0680j_4(f);
        }
        ...
        public static long m5229toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo377toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m5230toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo378toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5231toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo379toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5232toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo380toSpkPz2Gy4(i);
        }
