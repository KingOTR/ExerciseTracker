...
public final class LookaheadLayoutCoordinates implements LayoutCoordinates {
    ...
    public long mo5187getSizeYbymL2g() {
    ...
    private final long m5206getLookaheadOffsetF1C5BW0() {
        LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m3606minusMKHz9U(mo5188localPositionOfR5De75A(rootLookaheadDelegate.getCoordinates(), Offset.INSTANCE.m3618getZeroF1C5BW0()), getCoordinator().mo5188localPositionOfR5De75A(rootLookaheadDelegate.getCoordinator(), Offset.INSTANCE.m3618getZeroF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo5193screenToLocalMKHz9U(long relativeToScreen) {
        return Offset.m3607plusMKHz9U(getCoordinator().mo5193screenToLocalMKHz9U(relativeToScreen), m5206getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToScreen-MK-Hz9U */
    public long mo5191localToScreenMKHz9U(long relativeToLocal) {
        return getCoordinator().mo5191localToScreenMKHz9U(Offset.m3607plusMKHz9U(relativeToLocal, m5206getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: windowToLocal-MK-Hz9U */
    public long mo5196windowToLocalMKHz9U(long relativeToWindow) {
        return Offset.m3607plusMKHz9U(getCoordinator().mo5196windowToLocalMKHz9U(relativeToWindow), m5206getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo5192localToWindowMKHz9U(long relativeToLocal) {
        return getCoordinator().mo5192localToWindowMKHz9U(Offset.m3607plusMKHz9U(relativeToLocal, m5206getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToRoot-MK-Hz9U */
    public long mo5190localToRootMKHz9U(long relativeToLocal) {
        return getCoordinator().mo5190localToRootMKHz9U(Offset.m3607plusMKHz9U(relativeToLocal, m5206getLookaheadOffsetF1C5BW0()));
    }
    ...
    public long mo5189localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            ...
            if (lookaheadDelegate2 != null) {
                long m6434minusqkQi6aY = IntOffset.m6434minusqkQi6aY(IntOffset.m6435plusqkQi6aY(lookaheadDelegate.m5364positionIniSbpLlY$ui_release(lookaheadDelegate2, !includeMotionFrameOfReference), IntOffsetKt.m6447roundk4lQ0M(relativeToSource)), this.lookaheadDelegate.m5364positionIniSbpLlY$ui_release(lookaheadDelegate2, !includeMotionFrameOfReference));
                return OffsetKt.Offset(IntOffset.m6431getXimpl(m6434minusqkQi6aY), IntOffset.m6432getYimpl(m6434minusqkQi6aY));
            }
            LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate);
            long m6435plusqkQi6aY = IntOffset.m6435plusqkQi6aY(IntOffset.m6435plusqkQi6aY(lookaheadDelegate.m5364positionIniSbpLlY$ui_release(rootLookaheadDelegate, !includeMotionFrameOfReference), rootLookaheadDelegate.getPosition()), IntOffsetKt.m6447roundk4lQ0M(relativeToSource));
            LookaheadDelegate rootLookaheadDelegate2 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
            long m6434minusqkQi6aY2 = IntOffset.m6434minusqkQi6aY(m6435plusqkQi6aY, IntOffset.m6435plusqkQi6aY(this.lookaheadDelegate.m5364positionIniSbpLlY$ui_release(rootLookaheadDelegate2, !includeMotionFrameOfReference), rootLookaheadDelegate2.getPosition()));
            long Offset = OffsetKt.Offset(IntOffset.m6431getXimpl(m6434minusqkQi6aY2), IntOffset.m6432getYimpl(m6434minusqkQi6aY2));
            ...
            return wrappedBy.mo5189localPositionOfS_NoaFU(wrappedBy2, Offset, includeMotionFrameOfReference);
        }
        LookaheadDelegate rootLookaheadDelegate3 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m3607plusMKHz9U(mo5189localPositionOfS_NoaFU(rootLookaheadDelegate3.getLookaheadLayoutCoordinates(), relativeToSource, includeMotionFrameOfReference), rootLookaheadDelegate3.getCoordinator().getCoordinates().mo5189localPositionOfS_NoaFU(sourceCoordinates, Offset.INSTANCE.m3618getZeroF1C5BW0(), includeMotionFrameOfReference));
    }
    ...
    public void mo5194transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        getCoordinator().mo5194transformFromEL8BTi8(sourceCoordinates, matrix);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformToScreen-58bKbWc */
    public void mo5195transformToScreen58bKbWc(float[] matrix) {
        getCoordinator().mo5195transformToScreen58bKbWc(matrix);
    }
