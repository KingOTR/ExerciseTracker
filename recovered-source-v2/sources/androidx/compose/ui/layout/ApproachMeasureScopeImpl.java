...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public int mo369roundToPxR2X_6o(long j) {
        return this.coordinator.mo369roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo370roundToPx0680j_4(float f) {
        return this.coordinator.mo370roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo371toDpGaN1DYA(long j) {
        return this.coordinator.mo371toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo372toDpu2uoSUM(float f) {
        return this.coordinator.mo372toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo373toDpu2uoSUM(int i) {
        return this.coordinator.mo373toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo374toDpSizekrfVVM(long j) {
        return this.coordinator.mo374toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo375toPxR2X_6o(long j) {
        return this.coordinator.mo375toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo376toPx0680j_4(float f) {
        return this.coordinator.mo376toPx0680j_4(f);
    }
    ...
    public long mo377toSizeXkaWNTQ(long j) {
        return this.coordinator.mo377toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo378toSp0xMU5do(float f) {
        return this.coordinator.mo378toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo379toSpkPz2Gy4(float f) {
        return this.coordinator.mo379toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo380toSpkPz2Gy4(int i) {
        return this.coordinator.mo380toSpkPz2Gy4(i);
    }
