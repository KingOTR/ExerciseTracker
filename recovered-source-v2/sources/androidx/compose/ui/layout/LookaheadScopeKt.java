...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m3340initimpl(m3336constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m3343setimpl(m3336constructorimpl, lookaheadScopeImpl, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
            ...
            function3.invoke(lookaheadScopeImpl, startRestartGroup, Integer.valueOf((i2 << 3) & SdkConfig.SDK_VERSION));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    public static final long m5208localLookaheadPositionOfFgt4K4Q(LookaheadScope lookaheadScope, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        ...
        if (lookaheadCoordinates instanceof LookaheadLayoutCoordinates) {
            return lookaheadCoordinates.mo5189localPositionOfS_NoaFU(lookaheadCoordinates2, j, z);
        }
        if (lookaheadCoordinates2 instanceof LookaheadLayoutCoordinates) {
            return Offset.m3611unaryMinusF1C5BW0(lookaheadCoordinates2.mo5189localPositionOfS_NoaFU(lookaheadCoordinates, j, z));
        }
        return lookaheadCoordinates.mo5189localPositionOfS_NoaFU(lookaheadCoordinates, j, z);
    }
}
