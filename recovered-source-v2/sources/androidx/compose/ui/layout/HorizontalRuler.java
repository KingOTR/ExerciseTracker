...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3603getYimpl(targetCoordinates.mo5188localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(IntSize.m6473getWidthimpl(sourceCoordinates.mo5187getSizeYbymL2g()) / 2.0f, coordinate)));
    }
}
