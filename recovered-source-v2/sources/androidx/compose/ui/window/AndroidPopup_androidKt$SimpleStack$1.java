...
public final class AndroidPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (size == 1) {
            ...
            return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1.2
                {
                    super(1);
                }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            arrayList.add(list.get(i4).mo5179measureBRTryo0(j));
        }
