...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public void update(PainterNode node) {
        ...
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m3667equalsimpl0(node.getPainter().mo4520getIntrinsicSizeNHjbRc(), this.painter.mo4520getIntrinsicSizeNHjbRc()));
