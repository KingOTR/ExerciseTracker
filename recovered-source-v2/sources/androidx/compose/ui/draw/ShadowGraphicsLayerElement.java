...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public static /* synthetic */ ShadowGraphicsLayerElement m3498copygNMxBKI$default(ShadowGraphicsLayerElement shadowGraphicsLayerElement, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return shadowGraphicsLayerElement.m3502copygNMxBKI(f, shape2, z2, j3, j2);
    }
    ...
    public final ShadowGraphicsLayerElement m3502copygNMxBKI(float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6308equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m3844equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m3844equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m6309hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + Color.m3850hashCodeimpl(this.ambientColor)) * 31) + Color.m3850hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m6314toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m3851toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m3851toStringimpl(this.spotColor)) + ')';
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m3504getElevationD9Ej5fM() {
        return this.elevation;
    }
    ...
    public final long m3503getAmbientColor0d7_KjU() {
        return this.ambientColor;
    }

    /* renamed from: getSpotColor-0d7_KjU, reason: not valid java name */
    public final long m3505getSpotColor0d7_KjU() {
        return this.spotColor;
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement$createBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                graphicsLayerScope.setShadowElevation(graphicsLayerScope.mo376toPx0680j_4(ShadowGraphicsLayerElement.this.m3504getElevationD9Ej5fM()));
                ...
                graphicsLayerScope.mo4033setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.m3503getAmbientColor0d7_KjU());
                graphicsLayerScope.mo4035setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.m3505getSpotColor0d7_KjU());
            }
        };
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", Dp.m6301boximpl(this.elevation));
        inspectorInfo.getProperties().set("shape", this.shape);
        inspectorInfo.getProperties().set("clip", Boolean.valueOf(this.clip));
        inspectorInfo.getProperties().set("ambientColor", Color.m3833boximpl(this.ambientColor));
        inspectorInfo.getProperties().set("spotColor", Color.m3833boximpl(this.spotColor));
    }
}
