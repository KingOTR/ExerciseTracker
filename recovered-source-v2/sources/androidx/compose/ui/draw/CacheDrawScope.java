...
public final class CacheDrawScope implements Density {
    ...
    public final long m3492getSizeNHjbRc() {
        return this.cacheParams.mo3490getSizeNHjbRc();
    }
    ...
    public static /* synthetic */ void m3491recordTdoYBX4$default(CacheDrawScope cacheDrawScope, GraphicsLayer graphicsLayer, Density density, LayoutDirection layoutDirection, long j, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 4) != 0) {
            j = IntSizeKt.m6484toIntSizeuvyYCjk(cacheDrawScope.m3492getSizeNHjbRc());
        }
        cacheDrawScope.m3493recordTdoYBX4(graphicsLayer, density2, layoutDirection2, j, function1);
    }

    /* renamed from: record-TdoYBX4, reason: not valid java name */
    public final void m3493recordTdoYBX4(GraphicsLayer graphicsLayer, final Density density, final LayoutDirection layoutDirection, final long j, final Function1<? super ContentDrawScope, Unit> function1) {
        graphicsLayer.m4493recordmLhObY(density, layoutDirection, j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                long Size = SizeKt.Size(IntSize.m6473getWidthimpl(j2), IntSize.m6472getHeightimpl(j2));
