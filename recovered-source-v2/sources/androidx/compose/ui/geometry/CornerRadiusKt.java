...
public final class CornerRadiusKt {
    ...
    public static final long m3588lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3577getXimpl(j), CornerRadius.m3577getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m3578getYimpl(j), CornerRadius.m3578getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m3571constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
}
