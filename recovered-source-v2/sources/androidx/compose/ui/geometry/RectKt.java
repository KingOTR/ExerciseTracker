...
public final class RectKt {
    ...
    public static final Rect m3642Recttz77jQw(long j, long j2) {
        return new Rect(Offset.m3602getXimpl(j), Offset.m3603getYimpl(j), Offset.m3602getXimpl(j) + Size.m3671getWidthimpl(j2), Offset.m3603getYimpl(j) + Size.m3668getHeightimpl(j2));
    }

    /* renamed from: Rect-0a9Yr6o, reason: not valid java name */
    public static final Rect m3640Rect0a9Yr6o(long j, long j2) {
        return new Rect(Offset.m3602getXimpl(j), Offset.m3603getYimpl(j), Offset.m3602getXimpl(j2), Offset.m3603getYimpl(j2));
    }

    /* renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m3641Rect3MmeM6k(long j, float f) {
        return new Rect(Offset.m3602getXimpl(j) - f, Offset.m3603getYimpl(j) - f, Offset.m3602getXimpl(j) + f, Offset.m3603getYimpl(j) + f);
    }
