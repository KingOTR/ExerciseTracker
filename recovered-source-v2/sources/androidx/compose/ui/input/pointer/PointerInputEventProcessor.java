...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m5071processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m5072processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* renamed from: process-BIzXfog, reason: not valid java name */
    public final int m5072processBIzXfog(PointerInputEvent pointerEvent, PositionCalculator positionCalculator, boolean isInBounds) {
        boolean z;
        ...
        try {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (z || PointerEventKt.changedToDownIgnoreConsumed(valueAt2)) {
                    LayoutNode.m5327hitTestM_7yMNQ$ui_release$default(this.root, valueAt2.getPosition(), this.hitResult, PointerType.m5122equalsimpl0(valueAt2.getType(), PointerType.INSTANCE.m5129getTouchT8wyACA()), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m4978addHitPathQJqDSyo(valueAt2.getId(), this.hitResult, PointerEventKt.changedToDownIgnoreConsumed(valueAt2));
