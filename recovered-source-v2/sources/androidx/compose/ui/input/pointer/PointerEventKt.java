...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        return !Offset.m3599equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.INSTANCE.m3618getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        return !Offset.m3599equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.INSTANCE.m3618getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long m3606minusMKHz9U = Offset.m3606minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition());
        return (z || !pointerInputChange.isConsumed()) ? m3606minusMKHz9U : Offset.INSTANCE.m3618getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        if (Offset.m3599equalsimpl0(positionChange(pointerInputChange), Offset.INSTANCE.m3618getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m4994isOutOfBoundsO0kMr_c(PointerInputChange pointerInputChange, long j) {
        ...
        return m3602getXimpl < 0.0f || m3602getXimpl > ((float) IntSize.m6473getWidthimpl(j)) || m3603getYimpl < 0.0f || m3603getYimpl > ((float) IntSize.m6472getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m4995isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        if (!PointerType.m5122equalsimpl0(pointerInputChange.getType(), PointerType.INSTANCE.m5129getTouchT8wyACA())) {
            return m4994isOutOfBoundsO0kMr_c(pointerInputChange, j);
        }
        long position = pointerInputChange.getPosition();
        float m3602getXimpl = Offset.m3602getXimpl(position);
        float m3603getYimpl = Offset.m3603getYimpl(position);
        return m3602getXimpl < (-Size.m3671getWidthimpl(j2)) || m3602getXimpl > ((float) IntSize.m6473getWidthimpl(j)) + Size.m3671getWidthimpl(j2) || m3603getYimpl < (-Size.m3668getHeightimpl(j2)) || m3603getYimpl > ((float) IntSize.m6472getHeightimpl(j)) + Size.m3668getHeightimpl(j2);
    }
}
