...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m4977addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m4978addHitPathQJqDSyo(j, list, z);
    }

    /* renamed from: addHitPath-QJqDSyo, reason: not valid java name */
    public final void m4978addHitPathQJqDSyo(long pointerId, List<? extends Modifier.Node> pointerInputNodes, boolean prunePointerIdsAndChangesNotInNodesList) {
        Node node;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                ...
                if (node3 != null) {
                    node3.markIsIn();
                    node3.getPointerIds().m5143add0FcD4WY(pointerId);
            ...
            node4.getPointerIds().m5143add0FcD4WY(pointerId);
