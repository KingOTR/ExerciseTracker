...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Object obj, Object obj2, Object[] objArr, Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        this.boundsSize = IntSize.INSTANCE.m6478getZeroYbymL2g();
    }
    ...
    public long mo367getExtendedTouchPaddingNHjbRc() {
        long j = mo377toSizeXkaWNTQ(getViewConfiguration().mo5335getMinimumTouchTargetSizeMYxV2XQ());
        long boundsSize = getBoundsSize();
        return SizeKt.Size(Math.max(0.0f, Size.m3671getWidthimpl(j) - IntSize.m6473getWidthimpl(boundsSize)) / 2.0f, Math.max(0.0f, Size.m3668getHeightimpl(j) - IntSize.m6472getHeightimpl(boundsSize)) / 2.0f);
    }
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo4961getSizeYbymL2g() {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo4960getExtendedTouchPaddingNHjbRc() {
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m7905constructorimpl(event));
        }
                ...
                if ((suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        if (j <= 0 && (cancellableContinuation = this.pointerAwaiter) != null) {
                            Result.Companion companion = Result.INSTANCE;
                            cancellableContinuation.resumeWith(Result.m7905constructorimpl(ResultKt.createFailure(new PointerEventTimeoutCancellationException(j))));
                        }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.INSTANCE;
            createCoroutine.resumeWith(Result.m7905constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
