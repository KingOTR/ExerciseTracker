...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    */
    public void mo5074onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        boolean z;
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates$ui_release != null) {
                        long mo5190localToRootMKHz9U = layoutCoordinates$ui_release.mo5190localToRootMKHz9U(Offset.INSTANCE.m3618getZeroF1C5BW0());
                        final PointerInteropFilter pointerInteropFilter = this.this$0;
                        PointerInteropUtils_androidKt.m5109toCancelMotionEventScoped4ec7I(pointerEvent, mo5190localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                            {
                                super(1);
                            }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long mo5190localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo5190localToRootMKHz9U(Offset.INSTANCE.m3618getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m5110toMotionEventScoped4ec7I(pointerEvent, mo5190localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
