...
public final class VelocityTrackerKt {
    ...
    private static final void addPointerInputChangeLegacy(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.m5152setCurrentPointerPositionAccumulatork4lQ0M$ui_release(pointerInputChange.getPosition());
        ...
        while (i < size) {
            ...
            long m3606minusMKHz9U = Offset.m3606minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m5152setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3607plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), m3606minusMKHz9U));
            velocityTracker.m5148addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
            i++;
            previousPosition = position;
        }
        velocityTracker.m5152setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3607plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), Offset.m3606minusMKHz9U(pointerInputChange.getPosition(), previousPosition)));
        velocityTracker.m5148addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
    }
    ...
    private static final void addPointerInputChangeWithFix(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        ...
        if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            for (int i = 0; i < size; i++) {
                HistoricalChange historicalChange = historical.get(i);
                velocityTracker.m5148addPositionUv8p0NA(historicalChange.getUptimeMillis(), historicalChange.getOriginalEventPosition());
            }
            velocityTracker.m5148addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), pointerInputChange.getOriginalEventPosition());
        }
