...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m3618getZeroF1C5BW0();
    }
    ...
    public final void m5152setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m5148addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m3602getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m3603getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m5149calculateVelocity9UxMQ8M() {
        return m5150calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m5150calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m6540getXimpl(maximumVelocity) > 0.0f && Velocity.m6541getYimpl(maximumVelocity) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m6547toStringimpl(maximumVelocity)));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m6540getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m6541getYimpl(maximumVelocity)));
    }
