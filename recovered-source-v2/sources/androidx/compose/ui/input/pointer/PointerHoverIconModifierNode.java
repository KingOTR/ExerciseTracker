    ...
    public void mo212onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            if (PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5003getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5004getExit7fucELk())) {
                onExit();
            }
        }
    }
