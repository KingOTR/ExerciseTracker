...
public final class Node extends NodeParent {
    ...
    public boolean buildCache(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        boolean z;
        boolean z2;
        int m5004getExit7fucELk;
        boolean z3;
        int i;
        int i2;
        PointerInputChange m5045copyOHpmEuE;
        ...
        while (i5 < size) {
            ...
            if (this.pointerIds.contains(keyAt)) {
                ...
                if (Offset.m3605isValidimpl(previousPosition) && Offset.m3605isValidimpl(position)) {
                    ...
                    while (i6 < size2) {
                        ...
                        if (Offset.m3605isValidimpl(position2)) {
                            list = historical;
                            long uptimeMillis = historicalChange.getUptimeMillis();
                            i3 = size2;
                            LayoutCoordinates layoutCoordinates = this.coordinates;
                            Intrinsics.checkNotNull(layoutCoordinates);
                            arrayList.add(new HistoricalChange(uptimeMillis, layoutCoordinates.mo5188localPositionOfR5De75A(parentCoordinates, position2), historicalChange.getOriginalEventPosition(), null));
                        } else {
                            list = historical;
                            i3 = size2;
                        }
                    ...
                    long mo5188localPositionOfR5De75A = layoutCoordinates2.mo5188localPositionOfR5De75A(parentCoordinates, previousPosition);
                    LayoutCoordinates layoutCoordinates3 = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates3);
                    m5045copyOHpmEuE = valueAt.m5045copyOHpmEuE((r34 & 1) != 0 ? valueAt.id : 0L, (r34 & 2) != 0 ? valueAt.uptimeMillis : 0L, (r34 & 4) != 0 ? valueAt.position : layoutCoordinates3.mo5188localPositionOfR5De75A(parentCoordinates, position), (r34 & 8) != 0 ? valueAt.pressed : false, (r34 & 16) != 0 ? valueAt.previousUptimeMillis : 0L, (r34 & 32) != 0 ? valueAt.previousPosition : mo5188localPositionOfR5De75A, (r34 & 64) != 0 ? valueAt.previousPressed : false, (r34 & 128) != 0 ? valueAt.type : 0, arrayList, (r34 & 512) != 0 ? valueAt.scrollDelta : 0L);
                    longSparseArray.put(keyAt, m5045copyOHpmEuE);
                } else {
                    z3 = buildCache;
                    i = size;
                }
        ...
        for (int size3 = this.pointerIds.getSize() - 1; -1 < size3; size3--) {
            if (!changes.containsKey(this.pointerIds.m5145get_I2yYro(size3))) {
        ...
        while (true) {
            ...
            if (internalPointerEvent.m4979activeHoverEvent0FcD4WY(pointerInputChange2.getId())) {
        ...
        if (pointerInputChange3 != null) {
            if (!isInBounds) {
                ...
                if (!this.isIn && (pointerInputChange3.getPressed() || pointerInputChange3.getPreviousPressed())) {
                    ...
                    z2 = true;
                    this.isIn = !PointerEventKt.m4994isOutOfBoundsO0kMr_c(pointerInputChange3, r3.mo5187getSizeYbymL2g());
                    if (this.isIn == this.wasIn && (PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5005getMove7fucELk()) || PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5003getEnter7fucELk()) || PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5004getExit7fucELk()))) {
                        if (this.isIn) {
                            m5004getExit7fucELk = PointerEventType.INSTANCE.m5003getEnter7fucELk();
                        } else {
                            m5004getExit7fucELk = PointerEventType.INSTANCE.m5004getExit7fucELk();
                        }
                        pointerEvent.m4993setTypeEhbLWgg$ui_release(m5004getExit7fucELk);
                    } else if (!PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5003getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                        pointerEvent.m4993setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m5005getMove7fucELk());
                    } else if (PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5004getExit7fucELk()) && this.isIn && pointerInputChange3.getPressed()) {
                        pointerEvent.m4993setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m5005getMove7fucELk());
                    }
                }
            }
            ...
            if (!PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5003getEnter7fucELk())) {
            }
            if (PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5004getExit7fucELk())) {
                pointerEvent.m4993setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m5005getMove7fucELk());
            }
        } else {
            z = false;
        ...
        boolean z6 = (z5 || !PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5005getMove7fucELk()) || hasPositionChanged(this.pointerEvent, pointerEvent)) ? z2 : z;
    ...
    private final boolean hasPositionChanged(PointerEvent oldEvent, PointerEvent newEvent) {
        ...
        for (int i = 0; i < size; i++) {
            if (!Offset.m3599equalsimpl0(oldEvent.getChanges().get(i).getPosition(), newEvent.getChanges().get(i).getPosition())) {
                return true;
            }
        }
        return false;
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean m4979activeHoverEvent0FcD4WY = internalPointerEvent.m4979activeHoverEvent0FcD4WY(pointerInputChange.getId());
            boolean z = this.isIn;
            if ((!pressed && !m4979activeHoverEvent0FcD4WY) || (!pressed && !z)) {
                this.pointerIds.m5146remove0FcD4WY(pointerInputChange.getId());
            }
        }
        this.isIn = false;
        this.hasExited = PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5004getExit7fucELk());
    }
    ...
    public boolean dispatchMainEventPass(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (delegatingNode != 0) {
            if (delegatingNode instanceof PointerInputModifierNode) {
                ((PointerInputModifierNode) delegatingNode).mo212onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Initial, mo5187getSizeYbymL2g);
            } else if ((delegatingNode.getKindSet() & m5414constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
                Modifier.Node delegate = delegatingNode.getDelegate();
                int i = 0;
                delegatingNode = delegatingNode;
        ...
        if (this.modifierNode.getIsAttached()) {
            ...
            int m5414constructorimpl2 = NodeKind.m5414constructorimpl(16);
            MutableVector mutableVector2 = null;
            while (delegatingNode2 != 0) {
                if (delegatingNode2 instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) delegatingNode2).mo212onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Main, mo5187getSizeYbymL2g);
                } else if ((delegatingNode2.getKindSet() & m5414constructorimpl2) != 0 && (delegatingNode2 instanceof DelegatingNode)) {
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (!this.relevantChanges.isEmpty() && this.modifierNode.getIsAttached()) {
            ...
            while (delegatingNode != 0) {
                if (delegatingNode instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) delegatingNode).mo212onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Final, mo5187getSizeYbymL2g);
                } else if ((delegatingNode.getKindSet() & m5414constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
                    Modifier.Node delegate = delegatingNode.getDelegate();
                    int i2 = 0;
                    delegatingNode = delegatingNode;
