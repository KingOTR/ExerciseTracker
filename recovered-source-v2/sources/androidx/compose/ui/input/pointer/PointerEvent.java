...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m4983constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m5113constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m4989calculatePointerEventType7fucELk();
    }
    ...
    public final void m4993setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m4989calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    if (actionMasked != 2) {
                        ...
                        return PointerEventType.INSTANCE.m5006getPress7fucELk();
                    }
                    return PointerEventType.INSTANCE.m5005getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m5007getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m5006getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            if (internalPointerEvent != null) {
                z = true;
                if (internalPointerEvent.m4979activeHoverEvent0FcD4WY(pointerInputChange.getId())) {
