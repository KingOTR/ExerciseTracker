        ...
        try {
            if (i == 0) {
                ...
                if (!((Boolean) obj).booleanValue()) {
                    ...
                    this.L$1 = it;
                    this.label = 2;
                    if (flowCollector2.emit(Boxing.boxFloat(Settings.Global.getFloat(this.$applicationContext.getContentResolver(), "animator_duration_scale", 1.0f)), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    flowCollector = flowCollector2;
                    this.L$0 = flowCollector;
