...
public final class AndroidPlatformTextInputSession implements PlatformTextInputSessionScope, CoroutineScope {
    ...
    private final AtomicReference<SessionMutex.Session<T>> methodSessionMutex = SessionMutex.m3451constructorimpl();
    ...
    public final boolean isReadyForConnection() {
        InputMethodSession inputMethodSession = (InputMethodSession) SessionMutex.m3455getCurrentSessionimpl(this.methodSessionMutex);
        ...
        if (continuation instanceof AndroidPlatformTextInputSession$startInputMethod$1) {
            ...
            if ((androidPlatformTextInputSession$startInputMethod$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (SessionMutex.m3458withSessionCancellingPreviousimpl(atomicReference, function1, androidPlatformTextInputSession$startInputMethod$3, androidPlatformTextInputSession$startInputMethod$1) == coroutine_suspended) {
