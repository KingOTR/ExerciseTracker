...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m5571toLegacyClassNameV4PA4sw(int i) {
        if (Role.m5594equalsimpl0(i, Role.INSTANCE.m5598getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m5594equalsimpl0(i, Role.INSTANCE.m5599getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m5594equalsimpl0(i, Role.INSTANCE.m5602getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m5594equalsimpl0(i, Role.INSTANCE.m5601getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m5594equalsimpl0(i, Role.INSTANCE.m5600getDropdownListo7Vup1c())) {
