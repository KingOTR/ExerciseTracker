...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        super(context);
        this.lastDownPointerPosition = Offset.INSTANCE.m3617getUnspecifiedF1C5BW0();
        ...
        Modifier onKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m5507invokeZmokQxo(keyEvent.m4897unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m5507invokeZmokQxo(android.view.KeyEvent keyEvent) {
                Rect onFetchFocusRect;
                View findNextNonChildView;
                final FocusDirection mo5469getFocusDirectionP8AzH3I = AndroidComposeView.this.mo5469getFocusDirectionP8AzH3I(keyEvent);
                if (mo5469getFocusDirectionP8AzH3I != null && KeyEventType.m4901equalsimpl0(KeyEvent_androidKt.m4909getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4905getKeyDownCS__XNY())) {
                    onFetchFocusRect = AndroidComposeView.this.onFetchFocusRect();
                    Boolean mo3534focusSearchULY8qGw = AndroidComposeView.this.getFocusOwner().mo3534focusSearchULY8qGw(mo5469getFocusDirectionP8AzH3I.getValue(), onFetchFocusRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                        {
                            super(1);
                        }
                        ...
                        public final Boolean invoke(FocusTargetNode focusTargetNode) {
                            Boolean m3553requestFocusMxy_nc0 = FocusTransactionsKt.m3553requestFocusMxy_nc0(focusTargetNode, FocusDirection.this.getValue());
                            return Boolean.valueOf(m3553requestFocusMxy_nc0 != null ? m3553requestFocusMxy_nc0.booleanValue() : true);
                        }
                    });
                    if (mo3534focusSearchULY8qGw != null ? mo3534focusSearchULY8qGw.booleanValue() : true) {
                        return true;
                    }
                    if (!FocusOwnerImplKt.m3540is1dFocusSearch3ESFkO8(mo5469getFocusDirectionP8AzH3I.getValue())) {
                        return false;
                    }
                    Integer m3528toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3528toAndroidFocusDirection3ESFkO8(mo5469getFocusDirectionP8AzH3I.getValue());
                    if (m3528toAndroidFocusDirection3ESFkO8 == null) {
                        throw new IllegalStateException("Invalid focus direction".toString());
                    }
                    int intValue = m3528toAndroidFocusDirection3ESFkO8.intValue();
                    ...
                    if (androidRect != null) {
                        ...
                        if ((findNextNonChildView == null || !FocusInteropUtils_androidKt.requestInteropFocus(findNextNonChildView, Integer.valueOf(intValue), androidRect)) && AndroidComposeView.this.getFocusOwner().mo3531clearFocusI7lrPNg(false, true, false, mo5469getFocusDirectionP8AzH3I.getValue())) {
                            Boolean mo3534focusSearchULY8qGw2 = AndroidComposeView.this.getFocusOwner().mo3534focusSearchULY8qGw(mo5469getFocusDirectionP8AzH3I.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                                {
                                    super(1);
                                }
                            ...
                            return Boolean.valueOf(mo3534focusSearchULY8qGw2 != null ? mo3534focusSearchULY8qGw2.booleanValue() : true);
                        }
                        return true;
                    }
        ...
        this.tmpMatrix = Matrix.m4074constructorimpl$default(null, 1, null);
        this.viewToWindowMatrix = Matrix.m4074constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m4074constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m3616getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m3451constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m4591getTouchaOaMEAU() : InputMode.INSTANCE.m4590getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m5503invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m5503invokeiuPiT84(int i) {
                boolean requestFocusFromTouch;
                if (InputMode.m4586equalsimpl0(i, InputMode.INSTANCE.m4591getTouchaOaMEAU())) {
                    requestFocusFromTouch = AndroidComposeView.this.isInTouchMode();
                } else {
                    requestFocusFromTouch = InputMode.m4586equalsimpl0(i, InputMode.INSTANCE.m4590getKeyboardaOaMEAU()) ? AndroidComposeView.this.isInTouchMode() ? AndroidComposeView.this.requestFocusFromTouch() : true : false;
                }
    ...
    public void setCoroutineContext(CoroutineContext coroutineContext) {
        ...
        while (requireLayoutNode != null) {
            ...
            if ((child.getAggregateChildKindSet() & m5414constructorimpl) != 0) {
                while (child != null) {
    ...
    public final boolean m5498onMoveFocusInChildren3ESFkO8(int focusDirection) {
        View findNextFocusFromRect;
        if (FocusDirection.m3514equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3521getEnterdhqQ8s()) || FocusDirection.m3514equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3522getExitdhqQ8s())) {
            return false;
        }
    ...
    public static final void touchModeChangeListener$lambda$6(AndroidComposeView androidComposeView, boolean z) {
        androidComposeView._inputModeManager.m4594setInputModeiuPiT84(z ? InputMode.INSTANCE.m4591getTouchaOaMEAU() : InputMode.INSTANCE.m4590getKeyboardaOaMEAU());
    }
    ...
    */
        ...
        if (continuation instanceof AndroidComposeView$textInputSession$1) {
            ...
            if ((androidComposeView$textInputSession$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (SessionMutex.m3458withSessionCancellingPreviousimpl(atomicReference, function1, function2, androidComposeView$textInputSession$1) == coroutine_suspended) {
    ...
    public static final void sendHoverExitEvent$lambda$8(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m5501sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public View focusSearch(View focused, int direction) {
        if (focused != null) {
            ...
            if (Intrinsics.areEqual((Object) getFocusOwner().mo3534focusSearchULY8qGw(focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3520getDowndhqQ8s(), calculateBoundingRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$focusSearch$1
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode focusTargetNode) {
                    return true;
                }
    ...
    public boolean requestFocus(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3521getEnterdhqQ8s();
        Boolean mo3534focusSearchULY8qGw = getFocusOwner().mo3534focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$1
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                Boolean m3553requestFocusMxy_nc0 = FocusTransactionsKt.m3553requestFocusMxy_nc0(focusTargetNode, value);
                return Boolean.valueOf(m3553requestFocusMxy_nc0 != null ? m3553requestFocusMxy_nc0.booleanValue() : false);
            }
        });
        if (mo3534focusSearchULY8qGw != null) {
            return mo3534focusSearchULY8qGw.booleanValue();
        }
        return false;
    }
    ...
    public final boolean m5499onRequestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer m3528toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (m3528toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3528toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : m3528toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
    ...
    public boolean mo5471sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        return getFocusOwner().mo3532dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.m3530dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEvent(final android.view.KeyEvent event) {
        if (isFocused()) {
            this._windowInfo.m5580setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5113constructorimpl(event.getMetaState()));
            return FocusOwner.m3530dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m4892constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo3533dispatchKeyEventYhN2O0w(KeyEvent.m4892constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$dispatchKeyEvent$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        return (isFocused() && getFocusOwner().mo3532dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m4892constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m5502startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
    ...
    public void mo5470measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m5368measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long m5496convertMeasureSpecI7RO_PI = m5496convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int m8079constructorimpl = (int) ULong.m8079constructorimpl(m5496convertMeasureSpecI7RO_PI >>> 32);
            int m8079constructorimpl2 = (int) ULong.m8079constructorimpl(m5496convertMeasureSpecI7RO_PI & 4294967295L);
            long m5496convertMeasureSpecI7RO_PI2 = m5496convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long m6264fitPrioritizingHeightZbe2FdA = Constraints.INSTANCE.m6264fitPrioritizingHeightZbe2FdA(m8079constructorimpl, m8079constructorimpl2, (int) ULong.m8079constructorimpl(m5496convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m8079constructorimpl(4294967295L & m5496convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean z = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m6244boximpl(m6264fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    z = Constraints.m6249equalsimpl0(constraints.getValue(), m6264fitPrioritizingHeightZbe2FdA);
                }
                if (!z) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m5369updateRootConstraintsBRTryo0(m6264fitPrioritizingHeightZbe2FdA);
    ...
    private final int m5494component1VKZWuLQ(long j) {
        return (int) ULong.m8079constructorimpl(j >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m5495component2VKZWuLQ(long j) {
        return (int) ULong.m8079constructorimpl(j & 4294967295L);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m5500packZIaKswc(int a, int b) {
        return ULong.m8079constructorimpl(ULong.m8079constructorimpl(ULong.m8079constructorimpl(a) << 32) | ULong.m8079constructorimpl(b));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m5496convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m5500packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m5500packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m5500packZIaKswc(size, size);
        }
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        int m6431getXimpl = IntOffset.m6431getXimpl(j);
        int m6432getYimpl = IntOffset.m6432getYimpl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (m6431getXimpl != i || m6432getYimpl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (m6431getXimpl != Integer.MAX_VALUE && m6432getYimpl != Integer.MAX_VALUE) {
    ...
    public FocusDirection mo5469getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        long m4908getKeyZmokQxo = KeyEvent_androidKt.m4908getKeyZmokQxo(keyEvent);
        if (Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4836getTabEK5gGoQ())) {
            return FocusDirection.m3511boximpl(KeyEvent_androidKt.m4914isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m3525getPreviousdhqQ8s() : FocusDirection.INSTANCE.m3524getNextdhqQ8s());
        }
        if (Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4677getDirectionRightEK5gGoQ())) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3526getRightdhqQ8s());
        }
        if (Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4676getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3523getLeftdhqQ8s());
        }
        if (Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4678getDirectionUpEK5gGoQ()) ? true : Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4789getPageUpEK5gGoQ())) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3527getUpdhqQ8s());
        }
        if (Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4673getDirectionDownEK5gGoQ()) ? true : Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4788getPageDownEK5gGoQ())) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3520getDowndhqQ8s());
        }
        if (Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4672getDirectionCenterEK5gGoQ()) ? true : Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4686getEnterEK5gGoQ()) ? true : Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4778getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3521getEnterdhqQ8s());
        }
        if (Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4615getBackEK5gGoQ()) ? true : Key.m4600equalsimpl0(m4908getKeyZmokQxo, Key.INSTANCE.m4689getEscapeEK5gGoQ())) {
            return FocusDirection.m3511boximpl(FocusDirection.INSTANCE.m3522getExitdhqQ8s());
        }
        return null;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m4594setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m4591getTouchaOaMEAU() : InputMode.INSTANCE.m4590getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return motionEvent.isFromSource(4194304) ? handleRotaryEvent(motionEvent) : ProcessResult.m5139getDispatchedToAPointerInputModifierimpl(m5497handleMotionEvent8iAsVTc(motionEvent));
        }
        return super.dispatchGenericMotionEvent(motionEvent);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int m5497handleMotionEvent8iAsVTc = m5497handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m5138getAnyMovementConsumedimpl(m5497handleMotionEvent8iAsVTc)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m5139getDispatchedToAPointerInputModifierimpl(m5497handleMotionEvent8iAsVTc);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final int m5497handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        int i;
        int i2;
            ...
            try {
                ...
                if (motionEvent3 != null && hasChangedDevices(motionEvent, motionEvent3)) {
                    if (isDevicePressEvent(motionEvent3)) {
                        ...
                        return m5501sendMotionEvent8iAsVTc(motionEvent);
                    }
                }
                i = 10;
    ...
    private final int m5501sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m5580setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5113constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (convertToPointerInputEvent$ui_release != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m5067getPositionF1C5BW0();
            }
            int m5072processBIzXfog = this.pointerInputEventProcessor.m5072processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked != 0 && actionMasked != 5) || ProcessResult.m5139getDispatchedToAPointerInputModifierimpl(m5072processBIzXfog)) {
                return m5072processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i4 < pointerCount) {
            ...
            long mo5132localToScreenMKHz9U = mo5132localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m3602getXimpl(mo5132localToScreenMKHz9U);
            pointerCoords.y = Offset.m3603getYimpl(mo5132localToScreenMKHz9U);
            i4++;
        }
        ...
        this.pointerInputEventProcessor.m5072processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, true);
        obtain.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m5512canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m5512canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo5132localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long m4080mapMKHz9U = Matrix.m4080mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m3602getXimpl(m4080mapMKHz9U) + Offset.m3602getXimpl(this.windowPosition), Offset.m3603getYimpl(m4080mapMKHz9U) + Offset.m3603getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: localToScreen-58bKbWc */
    public void mo5131localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m4091timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m5517preTranslatecG2Xzmc(localTransform, Offset.m3602getXimpl(this.windowPosition), Offset.m3603getYimpl(this.windowPosition), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo5133screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        return Matrix.m4080mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m3602getXimpl(positionOnScreen) - Offset.m3602getXimpl(this.windowPosition), Offset.m3603getYimpl(positionOnScreen) - Offset.m3603getYimpl(this.windowPosition)));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long m4080mapMKHz9U = Matrix.m4080mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m3602getXimpl(m4080mapMKHz9U), motionEvent.getRawY() - Offset.m3603getYimpl(m4080mapMKHz9U));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo5518calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m5544invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }

    @Override // android.view.View
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession androidPlatformTextInputSession = (AndroidPlatformTextInputSession) SessionMutex.m3455getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo5467calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m4080mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo5468calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m4080mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        return ProcessResult.m5139getDispatchedToAPointerInputModifierimpl(m5497handleMotionEvent8iAsVTc(event));
    }
                        ...
                        if (!z) {
                            ...
                            for (int i = 1; i < pointerCount; i++) {
                                ...
                                if (!Float.isInfinite(x2) && !Float.isNaN(x2)) {
                                    ...
                                    if (!Float.isInfinite(y2) && !Float.isNaN(y2) && MotionEventVerifierApi29.INSTANCE.isValidMotionEvent(event, i)) {
                                        z = false;
                                        if (!z) {
                                            break;
                                        }
