...
public final class OutlineResolver {
    ...
    public OutlineResolver() {
        ...
        this.rectTopLeft = Offset.INSTANCE.m3618getZeroF1C5BW0();
        this.rectSize = Size.INSTANCE.m3680getZeroNHjbRc();
    }
    ...
    public final boolean m5570updateS_szKao(androidx.compose.ui.graphics.Outline outline, float alpha, boolean clipToOutline, float elevation, long size) {
    ...
    public final boolean m5569isInOutlinek4lQ0M(long position) {
        androidx.compose.ui.graphics.Outline outline;
        if (this.outlineNeeded && (outline = this.outline) != null) {
            return ShapeContainingUtilKt.isInOutline(outline, Offset.m3602getXimpl(position), Offset.m3603getYimpl(position), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (clipPath != null) {
            Canvas.m3814clipPathmtrdDE$default(canvas, clipPath, 0, 2, null);
            return;
        }
        ...
        if (f > 0.0f) {
            ...
            if (path == null || !m5568isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, f)) {
                RoundRect m3656RoundRectgG7oq9Y = RoundRectKt.m3656RoundRectgG7oq9Y(Offset.m3602getXimpl(this.rectTopLeft), Offset.m3603getYimpl(this.rectTopLeft), Offset.m3602getXimpl(this.rectTopLeft) + Size.m3671getWidthimpl(this.rectSize), Offset.m3603getYimpl(this.rectTopLeft) + Size.m3668getHeightimpl(this.rectSize), CornerRadiusKt.CornerRadius$default(this.roundedCornerRadius, 0.0f, 2, null));
                if (path == null) {
                    path = AndroidPath_androidKt.Path();
                } else {
                    path.reset();
                }
                Path.addRoundRect$default(path, m3656RoundRectgG7oq9Y, null, 2, null);
                this.tmpRoundRect = m3656RoundRectgG7oq9Y;
                this.tmpPath = path;
            }
            Canvas.m3814clipPathmtrdDE$default(canvas, path, 0, 2, null);
            return;
        }
        Canvas.m3815clipRectN_I0leg$default(canvas, Offset.m3602getXimpl(this.rectTopLeft), Offset.m3603getYimpl(this.rectTopLeft), Size.m3671getWidthimpl(this.rectSize) + Offset.m3602getXimpl(this.rectTopLeft), Size.m3668getHeightimpl(this.rectSize) + Offset.m3603getYimpl(this.rectTopLeft), 0, 16, null);
    }
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (outline != null && this.outlineNeeded && Size.m3671getWidthimpl(this.rectSize) > 0.0f && Size.m3668getHeightimpl(this.rectSize) > 0.0f) {
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float m3577getXimpl = CornerRadius.m3577getXimpl(roundRect.m3652getTopLeftCornerRadiuskKHJgLs());
        ...
        if (RoundRectKt.isSimple(roundRect)) {
            this.cachedOutline.setRoundRect(Math.round(roundRect.getLeft()), Math.round(roundRect.getTop()), Math.round(roundRect.getRight()), Math.round(roundRect.getBottom()), m3577getXimpl);
            this.roundedCornerRadius = m3577getXimpl;
            return;
        }
    ...
    private final boolean m5568isSameBounds4L21HEs(RoundRect roundRect, long j, long j2, float f) {
        return roundRect != null && RoundRectKt.isSimple(roundRect) && roundRect.getLeft() == Offset.m3602getXimpl(j) && roundRect.getTop() == Offset.m3603getYimpl(j) && roundRect.getRight() == Offset.m3602getXimpl(j) + Size.m3671getWidthimpl(j2) && roundRect.getBottom() == Offset.m3603getYimpl(j) + Size.m3668getHeightimpl(j2) && CornerRadius.m3577getXimpl(roundRect.m3652getTopLeftCornerRadiuskKHJgLs()) == f;
    }
}
