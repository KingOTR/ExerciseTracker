...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m4234getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 4096) != 0) {
            ...
            setPivotX(TransformOrigin.m4229getPivotFractionXimpl(transformOrigin) * getWidth());
            setPivotY(TransformOrigin.m4230getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        if (z2 != z4 || (z4 && m5570updateS_szKao)) {
            invalidate();
        }
        ...
        if ((mutatedFields & 64) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m3897toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m3897toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if ((mutatedFields & 32768) != 0) {
            ...
            if (CompositingStrategy.m3928equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3934getOffscreenNrFUSI())) {
                setLayerType(2, null);
            } else if (CompositingStrategy.m3928equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3933getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
    ...
    public boolean mo5462isInLayerk4lQ0M(long position) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m3602getXimpl && m3602getXimpl < ((float) getWidth()) && 0.0f <= m3603getYimpl && m3603getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
    ...
    public void mo5465resizeozmzZPI(long size) {
        ...
        if (m6473getWidthimpl == getWidth() && m6472getHeightimpl == getHeight()) {
            return;
        }
        setPivotX(TransformOrigin.m4229getPivotFractionXimpl(this.mTransformOrigin) * m6473getWidthimpl);
        setPivotY(TransformOrigin.m4230getPivotFractionYimpl(this.mTransformOrigin) * m6472getHeightimpl);
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m6473getWidthimpl, getTop() + m6472getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo5464movegyyYBs(long position) {
        ...
        if (m6431getXimpl != getLeft()) {
            offsetLeftAndRight(m6431getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m6432getYimpl = IntOffset.m6432getYimpl(position);
        if (m6432getYimpl != getTop()) {
            offsetTopAndBottom(m6432getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo5463mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] m5546calculateInverseMatrixbWbORWo = this.matrixCache.m5546calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m4080mapMKHz9U(this.matrixCache.m5547calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m4082mapimpl(this.matrixCache.m5547calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo5466transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4091timesAssign58bKbWc(matrix, this.matrixCache.m5547calculateMatrixGrdbGEg(this));
    }
