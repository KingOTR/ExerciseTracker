...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                ...
                if (decodeByte == 2) {
                    ...
                    mutableSpanStyle.m5558setFontSizeR2X_6o(m5528decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m5559setFontStylemLjRB2g(FontStyle.m5895boximpl(m5526decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (decodeByte != 8) {
                                if (decodeByte != 9) {
                                    if (decodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m5555setBackground8_81llA(m5525decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m5556setBaselineShift_isdbwI(BaselineShift.m6076boximpl(m5523decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m5561setLetterSpacingR2X_6o(m5528decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m5560setFontSynthesistDdu0R4(FontSynthesis.m5906boximpl(m5527decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m5557setColor8_81llA(m5525decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m5525decodeColor0d7_KjU() {
        return Color.m3839constructorimpl(m5524decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m5528decodeTextUnitXSAIIZE() {
        long m6530getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m6530getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6529getSpUIouoOA();
        } else if (decodeByte == 2) {
            m6530getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6528getEmUIouoOA();
        } else {
            m6530getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6530getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m6524equalsimpl0(m6530getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m6530getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m6507getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m6508TextUnitanM5pPY(decodeFloat(), m6530getUnspecifiedUIouoOA);
    }
    ...
    public final int m5526decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.INSTANCE.m5905getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.INSTANCE.m5904getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m5905getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m5527decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.INSTANCE.m5916getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.INSTANCE.m5915getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.INSTANCE.m5917getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.INSTANCE.m5918getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m5916getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m5523decodeBaselineShifty9eOQZs() {
        return BaselineShift.m6077constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m5525decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m5524decodeULongsVKNKU() {
        return ULong.m8079constructorimpl(this.parcel.readLong());
    }
