...
/* synthetic */ class AndroidComposeView$focusOwner$2 extends FunctionReferenceImpl implements Function2<FocusDirection, Rect, Boolean> {
    ...
    public final Boolean invoke(FocusDirection focusDirection, Rect rect) {
        boolean m5499onRequestFocusForOwner7o62pno;
        m5499onRequestFocusForOwner7o62pno = ((AndroidComposeView) this.receiver).m5499onRequestFocusForOwner7o62pno(focusDirection, rect);
        return Boolean.valueOf(m5499onRequestFocusForOwner7o62pno);
    }
}
