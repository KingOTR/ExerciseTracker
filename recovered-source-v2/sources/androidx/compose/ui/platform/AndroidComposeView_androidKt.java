...
public final class AndroidComposeView_androidKt {
    ...
    public static final void m5516preTransformJiSxe2E(float[] fArr, float[] fArr2) {
        float m5515dotp89u6pk = m5515dotp89u6pk(fArr2, 0, fArr, 0);
        float m5515dotp89u6pk2 = m5515dotp89u6pk(fArr2, 0, fArr, 1);
        float m5515dotp89u6pk3 = m5515dotp89u6pk(fArr2, 0, fArr, 2);
        float m5515dotp89u6pk4 = m5515dotp89u6pk(fArr2, 0, fArr, 3);
        float m5515dotp89u6pk5 = m5515dotp89u6pk(fArr2, 1, fArr, 0);
        float m5515dotp89u6pk6 = m5515dotp89u6pk(fArr2, 1, fArr, 1);
        float m5515dotp89u6pk7 = m5515dotp89u6pk(fArr2, 1, fArr, 2);
        float m5515dotp89u6pk8 = m5515dotp89u6pk(fArr2, 1, fArr, 3);
        float m5515dotp89u6pk9 = m5515dotp89u6pk(fArr2, 2, fArr, 0);
        float m5515dotp89u6pk10 = m5515dotp89u6pk(fArr2, 2, fArr, 1);
        float m5515dotp89u6pk11 = m5515dotp89u6pk(fArr2, 2, fArr, 2);
        float m5515dotp89u6pk12 = m5515dotp89u6pk(fArr2, 2, fArr, 3);
        float m5515dotp89u6pk13 = m5515dotp89u6pk(fArr2, 3, fArr, 0);
        float m5515dotp89u6pk14 = m5515dotp89u6pk(fArr2, 3, fArr, 1);
        float m5515dotp89u6pk15 = m5515dotp89u6pk(fArr2, 3, fArr, 2);
        float m5515dotp89u6pk16 = m5515dotp89u6pk(fArr2, 3, fArr, 3);
        fArr[0] = m5515dotp89u6pk;
        fArr[1] = m5515dotp89u6pk2;
        fArr[2] = m5515dotp89u6pk3;
        fArr[3] = m5515dotp89u6pk4;
        fArr[4] = m5515dotp89u6pk5;
        fArr[5] = m5515dotp89u6pk6;
        fArr[6] = m5515dotp89u6pk7;
        fArr[7] = m5515dotp89u6pk8;
        fArr[8] = m5515dotp89u6pk9;
        fArr[9] = m5515dotp89u6pk10;
        fArr[10] = m5515dotp89u6pk11;
        fArr[11] = m5515dotp89u6pk12;
        fArr[12] = m5515dotp89u6pk13;
        fArr[13] = m5515dotp89u6pk14;
        fArr[14] = m5515dotp89u6pk15;
        fArr[15] = m5515dotp89u6pk16;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: preTranslate-cG2Xzmc, reason: not valid java name */
    public static final void m5517preTranslatecG2Xzmc(float[] fArr, float f, float f2, float[] fArr2) {
        Matrix.m4083resetimpl(fArr2);
        Matrix.m4094translateimpl$default(fArr2, f, f2, 0.0f, 4, null);
        m5516preTransformJiSxe2E(fArr, fArr2);
    }
    ...
    private static final float m5515dotp89u6pk(float[] fArr, int i, float[] fArr2, int i2) {
        int i3 = i * 4;
