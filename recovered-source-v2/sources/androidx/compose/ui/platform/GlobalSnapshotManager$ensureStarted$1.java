...
@DebugMetadata(c = "androidx.compose.ui.platform.GlobalSnapshotManager$ensureStarted$1", f = "GlobalSnapshotManager.android.kt", i = {0}, l = {ExerciseSegment.EXERCISE_SEGMENT_TYPE_YOGA}, m = "invokeSuspend", n = {"$this$consume$iv$iv"}, s = {"L$0"})
