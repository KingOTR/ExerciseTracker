...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m3932getAutoNrFUSI();
    ...
    public void mo5530setCompositingStrategyaDBOjCE(int i) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m3928equalsimpl0(i, CompositingStrategy.INSTANCE.m3934getOffscreenNrFUSI())) {
            renderNode.setUseCompositingLayer(true, null);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3928equalsimpl0(i, CompositingStrategy.INSTANCE.m3933getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m3814clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
