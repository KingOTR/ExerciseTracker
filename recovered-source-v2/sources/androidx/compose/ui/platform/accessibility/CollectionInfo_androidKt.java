    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m3591boximpl(OffsetKt.Offset(Math.abs(Offset.m3602getXimpl(semanticsNode4.getBoundsInRoot().m3632getCenterF1C5BW0()) - Offset.m3602getXimpl(semanticsNode3.getBoundsInRoot().m3632getCenterF1C5BW0())), Math.abs(Offset.m3603getYimpl(semanticsNode4.getBoundsInRoot().m3632getCenterF1C5BW0()) - Offset.m3603getYimpl(semanticsNode3.getBoundsInRoot().m3632getCenterF1C5BW0())))));
        ...
        if (emptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m3591boximpl(Offset.m3607plusMKHz9U(((Offset) first).getPackedValue(), ((Offset) emptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m3603getYimpl(packedValue) < Offset.m3602getXimpl(packedValue);
    }
