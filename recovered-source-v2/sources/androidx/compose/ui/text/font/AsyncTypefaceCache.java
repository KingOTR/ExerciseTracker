...
public final class AsyncTypefaceCache {
    ...
    private final Object PermanentFailure = AsyncTypefaceResult.m5856constructorimpl(null);
    ...
    /* compiled from: FontListFontFamilyTypefaceAdapter.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\t\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0081@\u0018\u00002\u00020\u0001B\u0011\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0001¢\u0006\u0004\b\u0003\u0010\u0004J\u001a\u0010\u000b\u001a\u00020\u00062\b\u0010\f\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\r\u0010\u000eJ\u0010\u0010\u000f\u001a\u00020\u0010HÖ\u0001¢\u0006\u0004\b\u0011\u0010\u0012J\u0010\u0010\u0013\u001a\u00020\u0014HÖ\u0001¢\u0006\u0004\b\u0015\u0010\u0016R\u0011\u0010\u0005\u001a\u00020\u00068F¢\u0006\u0006\u001a\u0004\b\u0007\u0010\bR\u0013\u0010\u0002\u001a\u0004\u0018\u00010\u0001¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n\u0088\u0001\u0002¨\u0006\u0017"}, d2 = {"Landroidx/compose/ui/text/font/AsyncTypefaceCache$AsyncTypefaceResult;", "", "result", "constructor-impl", "(Ljava/lang/Object;)Ljava/lang/Object;", "isPermanentFailure", "", "isPermanentFailure-impl", "(Ljava/lang/Object;)Z", "getResult", "()Ljava/lang/Object;", "equals", Vo2MaxRecord.MeasurementMethod.OTHER, "equals-impl", "(Ljava/lang/Object;Ljava/lang/Object;)Z", "hashCode", "", "hashCode-impl", "(Ljava/lang/Object;)I", "toString", "", "toString-impl", "(Ljava/lang/Object;)Ljava/lang/String;", "ui-text_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @JvmInline
    public static final class AsyncTypefaceResult {
        private final Object result;

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ AsyncTypefaceResult m5855boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Object m5856constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5857equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m5862unboximpl());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5858equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5859hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static final boolean m5860isPermanentFailureimpl(Object obj) {
            return obj == null;
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5861toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m5857equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m5859hashCodeimpl(this.result);
        }

        public String toString() {
            return m5861toStringimpl(this.result);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ Object m5862unboximpl() {
            return this.result;
        }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (this.cacheLock) {
            try {
                if (result == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m5855boximpl(this.PermanentFailure));
                } else if (forever) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m5855boximpl(AsyncTypefaceResult.m5856constructorimpl(result)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m5855boximpl(AsyncTypefaceResult.m5856constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final AsyncTypefaceResult m5854get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
            ...
            if ((asyncTypefaceCache$runCached$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    synchronized (this.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            return asyncTypefaceResult.m5862unboximpl();
                        }
                        Unit unit = Unit.INSTANCE;
                        asyncTypefaceCache$runCached$1.L$0 = this;
                        asyncTypefaceCache$runCached$1.L$1 = key;
                        asyncTypefaceCache$runCached$1.Z$0 = z;
                        asyncTypefaceCache$runCached$1.label = 1;
                        invoke = function1.invoke(asyncTypefaceCache$runCached$1);
                    ...
                    Key key2 = (Key) asyncTypefaceCache$runCached$1.L$1;
                    AsyncTypefaceCache asyncTypefaceCache = (AsyncTypefaceCache) asyncTypefaceCache$runCached$1.L$0;
                    ResultKt.throwOnFailure(obj);
                    key = key2;
                ...
                synchronized (this.cacheLock) {
                    try {
                        if (invoke == null) {
                            ...
                            this.permanentCache.put(key, AsyncTypefaceResult.m5855boximpl(AsyncTypefaceResult.m5856constructorimpl(invoke)));
                        } else {
                            this.resultCache.put(key, AsyncTypefaceResult.m5855boximpl(AsyncTypefaceResult.m5856constructorimpl(invoke)));
                        }
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) {
        synchronized (this.cacheLock) {
            try {
                ...
                if (asyncTypefaceResult != null) {
                    Object m5862unboximpl = asyncTypefaceResult.m5862unboximpl();
                    InlineMarker.finallyStart(2);
                    InlineMarker.finallyEnd(2);
                    return m5862unboximpl;
                }
                Unit unit = Unit.INSTANCE;
