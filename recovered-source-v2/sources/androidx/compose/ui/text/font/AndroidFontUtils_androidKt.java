...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5852getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m5898equalsimpl0(i, FontStyle.INSTANCE.m5904getItalic_LCdwA()));
    }
}
