...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m5885equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m5889getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList3.add(TuplesKt.to(font2.getWeight(), FontStyle.m5895boximpl(font2.getStyle())));
        }
        ...
        for (int i4 = 0; i4 < size4; i4++) {
            ...
            int m5901unboximpl = ((FontStyle) pair.component2()).m5901unboximpl();
            firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5894matchFontRetOiIg(fonts, fontWeight, m5901unboximpl), new TypefaceRequest(fontFamily, fontWeight, m5901unboximpl, FontSynthesis.INSTANCE.m5915getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5894matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m5943getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
        List list = (List) firstImmediatelyAvailable.component1();
