...
public abstract class FontFamily {
    ...
    private static final GenericFontFamily SansSerif = new GenericFontFamily(MapLibreConstants.DEFAULT_FONT, "FontFamily.SansSerif");
    ...
    public interface Resolver {
        ...
        State<Object> mo5873resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis);

        /* renamed from: resolve-DPcqOEQ$default, reason: not valid java name */
        static /* synthetic */ State m5872resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            return resolver.mo5873resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        }
    }
