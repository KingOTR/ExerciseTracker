...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface mo6040getNativeTypefacePYhJU0U;
        FontFamily fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            mo6040getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5925createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m5943getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo6040getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5926createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m5943getFontStyle_LCdwA());
        } else {
            ...
            mo6040getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo6040getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m5943getFontStyle_LCdwA(), typefaceRequest.m5944getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo6040getNativeTypefacePYhJU0U, false, 2, null);
    }
}
