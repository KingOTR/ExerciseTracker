...
public final /* data */ class ParagraphInfo {
    ...
    public final long m5669toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m3602getXimpl(j), Offset.m3603getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        return rect.m3639translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }
    ...
    public final Path toGlobal(Path path) {
        path.mo3738translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m5667toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m5668toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m5668toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m5781equalsimpl0(j, TextRange.INSTANCE.m5793getZerod9O1mEE())) {
            return TextRange.INSTANCE.m5793getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m5788getStartimpl(j)), toGlobalIndex(TextRange.m5783getEndimpl(j)));
    }
}
