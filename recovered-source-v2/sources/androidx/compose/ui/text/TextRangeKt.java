...
public final class TextRangeKt {
    ...
    public static final String m5795substringFDrldGo(CharSequence charSequence, long j) {
        return charSequence.subSequence(TextRange.m5786getMinimpl(j), TextRange.m5785getMaximpl(j)).toString();
    }

    public static final long TextRange(int i, int i2) {
        return TextRange.m5777constructorimpl(packWithCheck(i, i2));
    }
    ...
    public static final long m5794coerceIn8ffj60Q(long j, int i, int i2) {
        int coerceIn = RangesKt.coerceIn(TextRange.m5788getStartimpl(j), i, i2);
        int coerceIn2 = RangesKt.coerceIn(TextRange.m5783getEndimpl(j), i, i2);
        return (coerceIn == TextRange.m5788getStartimpl(j) && coerceIn2 == TextRange.m5783getEndimpl(j)) ? j : TextRange(coerceIn, coerceIn2);
    }
