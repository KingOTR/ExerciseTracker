...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m6073toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m6072toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m6073toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m4202equalsimpl0(i, StrokeJoin.INSTANCE.m4207getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m4202equalsimpl0(i, StrokeJoin.INSTANCE.m4208getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m4202equalsimpl0(i, StrokeJoin.INSTANCE.m4206getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m6072toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m4192equalsimpl0(i, StrokeCap.INSTANCE.m4196getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m4192equalsimpl0(i, StrokeCap.INSTANCE.m4197getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m4192equalsimpl0(i, StrokeCap.INSTANCE.m4198getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
