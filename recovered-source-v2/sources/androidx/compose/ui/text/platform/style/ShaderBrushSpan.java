...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3659boximpl(Size.INSTANCE.m3679getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if (ShaderBrushSpan.this.m6074getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m3673isEmptyimpl(ShaderBrushSpan.this.m6074getSizeNHjbRc())) {
                return null;
            }
            return ShaderBrushSpan.this.getShaderBrush().mo3812createShaderuvyYCjk(ShaderBrushSpan.this.m6074getSizeNHjbRc());
        }
    });
    ...
    public final long m6074getSizeNHjbRc() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m6075setSizeuvyYCjk(long j) {
