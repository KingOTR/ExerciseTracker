    ...
    */
    public AndroidFontListTypeface(FontListFontFamily fontListFontFamily, Context context, List<Pair<FontWeight, FontStyle>> list, FontMatcher fontMatcher2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m5885equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m5890getBlockingPKNRLFQ())) {
                arrayList2.add(font);
            }
        }
        ...
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                arrayList4.add((Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m5894matchFontRetOiIg(arrayList3, pair.component1(), pair.component2().m5901unboximpl())));
            }
    ...
    public Typeface mo6040getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m5894matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        Object m5919synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m5919synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
        Intrinsics.checkNotNull(m5919synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
        return (Typeface) m5919synthesizeTypefaceFxwP2eA;
    }
}
