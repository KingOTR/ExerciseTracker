...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo6040getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m5898equalsimpl0(fontStyle, FontStyle.INSTANCE.m5904getItalic_LCdwA()));
    }
}
