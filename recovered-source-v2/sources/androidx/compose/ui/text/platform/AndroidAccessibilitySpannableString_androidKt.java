...
public final class AndroidAccessibilitySpannableString_androidKt {
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m6067setColorRPmYEkk(spannableString2, spanStyle.m5738getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m6068setFontSizeKmRG4DE(spannableString2, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m5852getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.m5901unboximpl() : FontStyle.INSTANCE.m5905getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m5872resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5915getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m6065setBackgroundRPmYEkk(spannableString2, spanStyle.getBackground(), i, i2);
    }
