...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface mo6040getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return m6041buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
    }

    /* renamed from: buildStyledTypeface-FO1MlWM, reason: not valid java name */
    private final Typeface m6041buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m5898equalsimpl0(fontStyle, FontStyle.INSTANCE.m5904getItalic_LCdwA()));
    }
}
