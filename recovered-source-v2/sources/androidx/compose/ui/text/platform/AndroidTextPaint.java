...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m6050getBrushSizeVsRJwc0$ui_text_release$annotations() {
    }
    ...
    public AndroidTextPaint(int i, float f) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m4401getDefaultBlendMode0nO6VwU();
    ...
    public final void m6056setBrushSizeiaC8Vc4$ui_text_release(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m3602getXimpl(this.shadow.getOffset()), Offset.m3603getYimpl(this.shadow.getOffset()), ColorKt.m3897toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m6057setColor8_81llA(long color) {
        if (color != 16) {
            setColor(ColorKt.m3897toArgb8_81llA(color));
            clearShader();
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m6051setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m6055setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code restructure failed: missing block: B:16:0x0032, code lost:
    
        if ((r0 == null ? false : androidx.compose.ui.geometry.Size.m3667equalsimpl0(r0.getPackedValue(), r4)) == false) goto L16;
     */
    /* renamed from: setBrush-12SF9DM, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m6055setBrush12SF9DM(final Brush brush, final long size, float alpha) {
        if (brush == null) {
            clearShader();
            return;
        }
        if (brush instanceof SolidColor) {
            m6057setColor8_81llA(TextDrawStyleKt.m6212modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            return;
        }
        if (brush instanceof ShaderBrush) {
            ...
            if (size != InlineClassHelperKt.UnspecifiedPackedFloats) {
                this.brush = brush;
                this.brushSize = Size.m3659boximpl(size);
                this.shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.AndroidTextPaint$setBrush$1
                    ...
                    public final Shader invoke() {
                        return ((ShaderBrush) Brush.this).mo3812createShaderuvyYCjk(size);
                    }
                });
            }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            getComposePaint().mo3726setStylek9PVt8s(PaintingStyle.INSTANCE.m4111getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            getComposePaint().setStrokeWidth(stroke.getWidth());
            getComposePaint().setStrokeMiterLimit(stroke.getMiter());
            getComposePaint().mo3725setStrokeJoinWw9F2mQ(stroke.getJoin());
            getComposePaint().mo3724setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void m6054setBlendModes9anfk8(int i) {
        if (BlendMode.m3754equalsimpl0(i, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo3721setBlendModes9anfk8(i);
