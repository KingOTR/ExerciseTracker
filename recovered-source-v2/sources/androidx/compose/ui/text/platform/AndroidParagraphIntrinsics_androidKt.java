...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m6047resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m6046resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m6046resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale locale;
        if (TextDirection.m6202equalsimpl0(i, TextDirection.INSTANCE.m6207getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (!TextDirection.m6202equalsimpl0(i, TextDirection.INSTANCE.m6208getContentOrRtls_7Xco())) {
            if (TextDirection.m6202equalsimpl0(i, TextDirection.INSTANCE.m6209getLtrs_7Xco())) {
                return 0;
            }
            if (TextDirection.m6202equalsimpl0(i, TextDirection.INSTANCE.m6210getRtls_7Xco())) {
                return 1;
            }
            if (TextDirection.m6202equalsimpl0(i, TextDirection.INSTANCE.m6206getContents_7Xco()) ? true : TextDirection.m6202equalsimpl0(i, TextDirection.INSTANCE.m6211getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        return !(((platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m5640boximpl(paragraphStyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m5643equalsimpl0(r1.getValue(), EmojiSupportMatch.INSTANCE.m5649getNone_3YsG6Y()));
    }
}
