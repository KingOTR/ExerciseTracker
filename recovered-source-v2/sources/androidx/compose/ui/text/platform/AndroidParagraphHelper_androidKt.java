...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String str, float f, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean z) {
        ...
        if (z && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch m5640boximpl = (platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m5640boximpl(paragraphStyle.getEmojiSupportMatch());
            str2 = EmojiCompat.get().process(str, 0, str.length(), Integer.MAX_VALUE, m5640boximpl == null ? 0 : EmojiSupportMatch.m5643equalsimpl0(m5640boximpl.getValue(), EmojiSupportMatch.INSTANCE.m5647getAll_3YsG6Y()));
            Intrinsics.checkNotNull(str2);
        } else {
            str2 = str;
        }
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(textStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m6514isUnspecifiedR2X_6o(textStyle.m5827getLineHeightXSAIIZE())) {
            return str2;
        }
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m6070setLineHeightr9BaKPg(spannableString, textStyle.m5827getLineHeightXSAIIZE(), f, density);
        } else {
            LineHeightStyle lineHeightStyle = textStyle.getLineHeightStyle();
            if (lineHeightStyle == null) {
                lineHeightStyle = LineHeightStyle.INSTANCE.getDefault();
            }
            SpannableExtensions_androidKt.m6069setLineHeightKmRG4DE(spannableString, textStyle.m5827getLineHeightXSAIIZE(), f, density, lineHeightStyle);
        }
