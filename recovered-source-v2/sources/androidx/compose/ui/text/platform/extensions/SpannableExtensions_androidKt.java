...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float m6496getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m6493equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m6493equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m6514isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m6514isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long m6495getTypeUIouoOA = TextUnit.m6495getTypeUIouoOA(textIndent.getFirstLine());
            float f2 = 0.0f;
            if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6529getSpUIouoOA())) {
                m6496getValueimpl = density.mo375toPxR2X_6o(textIndent.getFirstLine());
            } else {
                m6496getValueimpl = TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6528getEmUIouoOA()) ? TextUnit.m6496getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long m6495getTypeUIouoOA2 = TextUnit.m6495getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA2, TextUnitType.INSTANCE.m6529getSpUIouoOA())) {
                f2 = density.mo375toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA2, TextUnitType.INSTANCE.m6528getEmUIouoOA())) {
                f2 = TextUnit.m6496getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(m6496getValueimpl), (int) Math.ceil(f2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m6069setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float m6064resolveLineHeightInPxo2QH7mI = m6064resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m6064resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(m6064resolveLineHeightInPxo2QH7mI, 0, (spannable2.length() == 0 || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m6177isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m6178isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m6070setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float m6064resolveLineHeightInPxo2QH7mI = m6064resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m6064resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(m6064resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m6064resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float m6496getValueimpl;
        long m6495getTypeUIouoOA = TextUnit.m6495getTypeUIouoOA(j);
        if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6529getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo375toPxR2X_6o(j);
            }
            m6496getValueimpl = TextUnit.m6496getValueimpl(j) / TextUnit.m6496getValueimpl(density.mo379toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6528getEmUIouoOA())) {
                return Float.NaN;
            }
            m6496getValueimpl = TextUnit.m6496getValueimpl(j);
        }
        return m6496getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan m6063createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (m6063createLetterSpacingSpaneAf_CNQ = m6063createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, m6063createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m6066setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m6067setColorRPmYEkk(spannable, item.m5738getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m6068setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m6065setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m6063createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long m6495getTypeUIouoOA = TextUnit.m6495getTypeUIouoOA(j);
        if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6529getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo375toPxR2X_6o(j));
        }
        if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6528getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m6496getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m6524equalsimpl0(TextUnit.m6495getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6529getSpUIouoOA()) || TextUnitType.m6524equalsimpl0(TextUnit.m6495getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6528getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m3897toArgb8_81llA(shadow.getColor()), Offset.m3602getXimpl(shadow.getOffset()), Offset.m3603getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m6065setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m3897toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    public static final void m6068setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long m6495getTypeUIouoOA = TextUnit.m6495getTypeUIouoOA(j);
        if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6529getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo375toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m6524equalsimpl0(m6495getTypeUIouoOA, TextUnitType.INSTANCE.m6528getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m6496getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m6067setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m3897toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m6066setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m6082unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m6067setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m5821getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m5820getFontStyle4Lr2A7w(), textStyle.m5821getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m5895boximpl, FontSynthesis.m5906boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5915getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }
}
