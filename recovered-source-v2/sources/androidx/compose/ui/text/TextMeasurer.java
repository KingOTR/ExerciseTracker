...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m5764measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m5766measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.INSTANCE.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.INSTANCE.m6241getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.defaultLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.defaultDensity : density, (i3 & 512) != 0 ? textMeasurer.defaultFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY, reason: not valid java name */
    public final TextLayoutResult m5766measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m5759copyO0kMr_c(textLayoutInput, ConstraintsKt.m6270constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m5765measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        return m5764measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int m6258getMinWidthimpl = Constraints.m6258getMinWidthimpl(textLayoutInput.getConstraints());
            int m6256getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m6234equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m6242getEllipsisgIe3tQ8())) && Constraints.m6252getHasBoundedWidthimpl(textLayoutInput.getConstraints())) ? Constraints.m6256getMaxWidthimpl(textLayoutInput.getConstraints()) : Integer.MAX_VALUE;
            int maxLines = (textLayoutInput.getSoftWrap() || !TextOverflow.m6234equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m6242getEllipsisgIe3tQ8())) ? textLayoutInput.getMaxLines() : 1;
            if (m6258getMinWidthimpl != m6256getMaxWidthimpl) {
                m6256getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), m6258getMinWidthimpl, m6256getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, Constraints.INSTANCE.m6265fitPrioritizingWidthZbe2FdA(0, m6256getMaxWidthimpl, 0, Constraints.m6255getMaxHeightimpl(textLayoutInput.getConstraints())), maxLines, TextOverflow.m6234equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m6242getEllipsisgIe3tQ8()), null), ConstraintsKt.m6270constrain4WqzIAM(textLayoutInput.getConstraints(), IntSizeKt.IntSize((int) Math.ceil(r3.getWidth()), (int) Math.ceil(r3.getHeight()))), null);
        }
    }
}
