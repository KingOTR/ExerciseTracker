...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m6214copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m6215copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m6215copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m6493equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m6493equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m6497hashCodeimpl(this.firstLine) * 31) + TextUnit.m6497hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m6503toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m6503toStringimpl(this.restLine)) + ')';
    }
}
