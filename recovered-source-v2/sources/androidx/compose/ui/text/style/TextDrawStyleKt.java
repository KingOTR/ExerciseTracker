...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m6213from8_81llA(ColorKt.m3894lerpjxsXWHM(textForegroundStyle.mo6090getColor0d7_KjU(), textForegroundStyle2.mo6090getColor0d7_KjU(), f));
        }
        if (z && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m6212modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m3842copywmQWz5c$default(j, Color.m3845getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
