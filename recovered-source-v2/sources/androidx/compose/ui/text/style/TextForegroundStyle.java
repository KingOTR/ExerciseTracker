...
public interface TextForegroundStyle {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m6213from8_81llA(long color) {
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m6213from8_81llA(TextDrawStyleKt.m6212modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
