...
public final class Html_androidKt {
    ...
    private static final void addSpans(AnnotatedString.Builder builder, Spanned spanned, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        for (Object obj : spanned.getSpans(0, builder.getLength(), Object.class)) {
            ...
            addSpan(builder, obj, TextRange.m5788getStartimpl(TextRange), TextRange.m5783getEndimpl(TextRange), textLinkStyles, linkInteractionListener);
        }
    }
    ...
    private static final void addSpan(AnnotatedString.Builder builder, Object obj, int i, int i2, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        ...
        if (obj instanceof SubscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m6076boximpl(BaselineShift.INSTANCE.m6087getSubscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
        if (obj instanceof SuperscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m6076boximpl(BaselineShift.INSTANCE.m6088getSuperscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
    ...
    private static final ParagraphStyle toParagraphStyle(AlignmentSpan alignmentSpan) {
        int m6197getStarte0LSkKk;
        Layout.Alignment alignment = alignmentSpan.getAlignment();
        int i = alignment == null ? -1 : WhenMappings.$EnumSwitchMapping$0[alignment.ordinal()];
        if (i == 1) {
            m6197getStarte0LSkKk = TextAlign.INSTANCE.m6197getStarte0LSkKk();
        } else if (i == 2) {
            m6197getStarte0LSkKk = TextAlign.INSTANCE.m6192getCentere0LSkKk();
        } else if (i == 3) {
            m6197getStarte0LSkKk = TextAlign.INSTANCE.m6193getEnde0LSkKk();
        } else {
            m6197getStarte0LSkKk = TextAlign.INSTANCE.m6198getUnspecifiede0LSkKk();
        }
        return new ParagraphStyle(m6197getStarte0LSkKk, 0, 0L, (TextIndent) null, (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 510, (DefaultConstructorMarker) null);
    }
    ...
    private static final SpanStyle toSpanStyle(StyleSpan styleSpan) {
        ...
        if (style == 2) {
            return new SpanStyle(0L, 0L, (FontWeight) null, FontStyle.m5895boximpl(FontStyle.INSTANCE.m5904getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65527, (DefaultConstructorMarker) null);
        }
        if (style != 3) {
            return null;
        }
        return new SpanStyle(0L, 0L, FontWeight.INSTANCE.getBold(), FontStyle.m5895boximpl(FontStyle.INSTANCE.m5904getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65523, (DefaultConstructorMarker) null);
    }
