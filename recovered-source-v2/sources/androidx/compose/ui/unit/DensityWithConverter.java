...
final /* data */ class DensityWithConverter implements Density {
    ...
    public float mo371toDpGaN1DYA(long j) {
        ...
        return Dp.m6303constructorimpl(this.converter.convertSpToDp(TextUnit.m6496getValueimpl(j)));
    }
}
