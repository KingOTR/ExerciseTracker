...
public interface FontScaling {
    ...
    public static final class DefaultImpls {
        ...
        public static long m6415toSp0xMU5do(FontScaling fontScaling, float f) {
            return FontScaling.super.mo378toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m6414toDpGaN1DYA(FontScaling fontScaling, long j) {
            return FontScaling.super.mo371toDpGaN1DYA(j);
        }
    }

    /* renamed from: toSp-0xMU5do */
    default long mo378toSp0xMU5do(float f) {
    ...
    default float mo371toDpGaN1DYA(long j) {
        if (!TextUnitType.m6524equalsimpl0(TextUnit.m6495getTypeUIouoOA(j), TextUnitType.INSTANCE.m6529getSpUIouoOA())) {
            InlineClassHelperKt.throwIllegalStateException("Only Sp can convert to Px");
        }
        if (!FontScaleConverterFactory.INSTANCE.isNonLinearFontScalingActive(getFontScale())) {
            return Dp.m6303constructorimpl(TextUnit.m6496getValueimpl(j) * getFontScale());
        }
        FontScaleConverter forScale = FontScaleConverterFactory.INSTANCE.forScale(getFontScale());
        return forScale == null ? Dp.m6303constructorimpl(TextUnit.m6496getValueimpl(j) * getFontScale()) : Dp.m6303constructorimpl(forScale.convertSpToDp(TextUnit.m6496getValueimpl(j)));
    }
}
