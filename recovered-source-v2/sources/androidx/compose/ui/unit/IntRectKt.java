...
public final class IntRectKt {
    ...
    public static final IntRect m6463IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m6431getXimpl(j), IntOffset.m6432getYimpl(j), IntOffset.m6431getXimpl(j) + IntSize.m6473getWidthimpl(j2), IntOffset.m6432getYimpl(j) + IntSize.m6472getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m6462IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m6431getXimpl(j), IntOffset.m6432getYimpl(j), IntOffset.m6431getXimpl(j2), IntOffset.m6432getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m6464IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m6431getXimpl(j) - i, IntOffset.m6432getYimpl(j) - i, IntOffset.m6431getXimpl(j) + i, IntOffset.m6432getYimpl(j) + i);
    }
