...
public interface FontScalingLinear {
    ...
    public static final class DefaultImpls {
        ...
        public static long m6421toSp0xMU5do(FontScalingLinear fontScalingLinear, float f) {
            return FontScalingLinear.super.m6419toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m6420toDpGaN1DYA(FontScalingLinear fontScalingLinear, long j) {
            return FontScalingLinear.super.m6418toDpGaN1DYA(j);
        }
    }

    /* renamed from: toSp-0xMU5do, reason: not valid java name */
    default long m6419toSp0xMU5do(float f) {
        return TextUnitKt.getSp(f / getFontScale());
    }

    /* renamed from: toDp-GaN1DYA, reason: not valid java name */
    default float m6418toDpGaN1DYA(long j) {
