...
public final class AndroidContentCaptureManager implements ContentCaptureManager, DefaultLifecycleObserver, View.OnAttachStateChangeListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x006f A[Catch: all -> 0x00a4, TryCatch #0 {all -> 0x00a4, blocks: (B:11:0x005a, B:15:0x0067, B:17:0x006f, B:19:0x0078, B:20:0x007b, B:22:0x007f, B:23:0x0088, B:10:0x0054), top: B:9:0x0054 }] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:24:0x0099 -> B:11:0x005a). Please report as a decompilation issue!!! */
    /*
    ...
    */
    public final Object boundsUpdatesEventLoop$ui_release(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof AndroidContentCaptureManager$boundsUpdatesEventLoop$1) {
            ...
            if ((androidContentCaptureManager$boundsUpdatesEventLoop$1.label & Integer.MIN_VALUE) != 0) {
                ...
                androidContentCaptureManager = androidContentCaptureManager$boundsUpdatesEventLoop$1.label;
                if (androidContentCaptureManager != 0) {
                    ResultKt.throwOnFailure(obj2);
                    try {
                        channelIterator = this.boundsUpdateChannel.iterator();
                    } catch (Throwable th) {
                    ...
                    try {
                        if (androidContentCaptureManager == 1) {
                            ChannelIterator<Unit> channelIterator2 = (ChannelIterator) androidContentCaptureManager$boundsUpdatesEventLoop$1.L$1;
                            AndroidContentCaptureManager androidContentCaptureManager2 = (AndroidContentCaptureManager) androidContentCaptureManager$boundsUpdatesEventLoop$1.L$0;
                            ResultKt.throwOnFailure(obj2);
                            ...
                            if (androidContentCaptureManager != 2) {
                                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                            }
                            ChannelIterator<Unit> channelIterator3 = (ChannelIterator) androidContentCaptureManager$boundsUpdatesEventLoop$1.L$1;
                            AndroidContentCaptureManager androidContentCaptureManager3 = (AndroidContentCaptureManager) androidContentCaptureManager$boundsUpdatesEventLoop$1.L$0;
                            ResultKt.throwOnFailure(obj2);
                            channelIterator = channelIterator3;
                            this = androidContentCaptureManager3;
                        }
                    } catch (Throwable th2) {
                        th = th2;
                        androidContentCaptureManager.subtreeChangedLayoutNodes.clear();
                ...
                obj = channelIterator.hasNext(androidContentCaptureManager$boundsUpdatesEventLoop$1);
        ...
        Object obj22 = androidContentCaptureManager$boundsUpdatesEventLoop$1.result;
        coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        androidContentCaptureManager = androidContentCaptureManager$boundsUpdatesEventLoop$1.label;
        if (androidContentCaptureManager != 0) {
        }
    ...
    private final ViewStructureCompat toViewStructure(SemanticsNode semanticsNode) {
        ...
        String m5571toLegacyClassNameV4PA4sw;
        ContentCaptureSessionCompat contentCaptureSessionCompat = this.contentCaptureSession;
        ...
        if (role != null && (m5571toLegacyClassNameV4PA4sw = SemanticsUtils_androidKt.m5571toLegacyClassNameV4PA4sw(role.getValue())) != null) {
            newVirtualViewStructure.setClassName(m5571toLegacyClassNameV4PA4sw);
        }
        TextLayoutResult textLayoutResult = SemanticsUtils_androidKt.getTextLayoutResult(unmergedConfig);
        if (textLayoutResult != null) {
            TextLayoutInput layoutInput = textLayoutResult.getLayoutInput();
            newVirtualViewStructure.setTextStyle(TextUnit.m6496getValueimpl(layoutInput.getStyle().m5819getFontSizeXSAIIZE()) * layoutInput.getDensity().getDensity() * layoutInput.getDensity().getFontScale(), 0, 0, 0);
        }
            ...
            for (long j : virtualIds) {
                ...
                if (semanticsNodeWithAdjustedBounds != null && (semanticsNode = semanticsNodeWithAdjustedBounds.getSemanticsNode()) != null) {
                    ...
                    if (list != null && (fastJoinToString$default = ListUtilsKt.fastJoinToString$default(list, "\n", null, null, 0, null, null, 62, null)) != null) {
                        builder.setValue("android:text", TranslationRequestValue.forText(new AnnotatedString(fastJoinToString$default, null, null, 6, null)));
