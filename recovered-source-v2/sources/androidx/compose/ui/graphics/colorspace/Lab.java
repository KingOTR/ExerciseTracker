...
public final class Lab extends ColorSpace {
    ...
    public Lab(String str, int i) {
        super(str, ColorModel.INSTANCE.m4256getLabxdoWZVw(), i, null);
    }
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        ...
        return (Float.floatToRawIntBits(f3 * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[0]) << 32) | (4294967295L & Float.floatToRawIntBits(f4 * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[1]));
    }
    ...
    public long mo4260xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
        ...
        float cbrt3 = f3 > A ? (float) Math.cbrt(f3) : (f3 * B) + C;
        float f4 = (116.0f * cbrt2) - 16.0f;
        float f5 = (cbrt - cbrt2) * 500.0f;
        float f6 = (cbrt2 - cbrt3) * 200.0f;
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 100.0f) {
        ...
        return ColorKt.Color(f4, f5, f6 <= 128.0f ? f6 : 128.0f, a, colorSpace);
    }
