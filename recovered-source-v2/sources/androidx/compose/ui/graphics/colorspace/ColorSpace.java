...
public abstract class ColorSpace {
    ...
    public final int getComponentCount() {
        return ColorModel.m4251getComponentCountimpl(this.model);
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] fArr = new float[ColorModel.m4251getComponentCountimpl(this.model)];
        fArr[0] = x;
        fArr[1] = y;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m4253toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m4250equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m4252hashCodeimpl(this.model)) * 31) + this.id;
    }
}
