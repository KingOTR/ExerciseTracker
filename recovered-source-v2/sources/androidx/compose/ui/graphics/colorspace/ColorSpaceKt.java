...
public final class ColorSpaceKt {
    ...
    private static final Connector m4263createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.INSTANCE.identity$ui_graphics_release(colorSpace);
        }
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (ColorModel.m4250equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m4257getRgbxdoWZVw()) && ColorModel.m4250equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m4257getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m4262connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m4278getPerceptualuksYyKA();
        }
        return m4261connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m4261connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        int id = colorSpace.getId();
        int id2 = colorSpace2.getId();
        if ((id | id2) < 0) {
            return m4263createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        if (connector == null) {
            connector = m4263createConnectorYBCOT_4(colorSpace, colorSpace2, i);
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (!ColorModel.m4250equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m4257getRgbxdoWZVw())) {
            return colorSpace;
        }
        Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
