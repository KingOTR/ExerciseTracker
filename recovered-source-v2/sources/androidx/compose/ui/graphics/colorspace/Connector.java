...
public class Connector {
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m4250equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m4257getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m4250equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m4257getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, INSTANCE.m4267computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        */
        private RgbConnector(Rgb rgb, Rgb rgb2, int i) {
            ...
            this.mTransform = m4268computeTransformYBCOT_4(rgb, rgb2, i);
        }
        ...
        private final float[] m4268computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m4273equalsimpl0(intent, RenderIntent.INSTANCE.m4277getAbsoluteuksYyKA())) {
        ...
        public long mo4265transformToColorl2rxGTc$ui_graphics_release(long color) {
            float m3849getRedimpl = Color.m3849getRedimpl(color);
            float m3848getGreenimpl = Color.m3848getGreenimpl(color);
            float m3846getBlueimpl = Color.m3846getBlueimpl(color);
            float m3845getAlphaimpl = Color.m3845getAlphaimpl(color);
            float invoke = (float) this.mSource.getEotfFunc().invoke(m3849getRedimpl);
            float invoke2 = (float) this.mSource.getEotfFunc().invoke(m3848getGreenimpl);
            float invoke3 = (float) this.mSource.getEotfFunc().invoke(m3846getBlueimpl);
            float[] fArr = this.mTransform;
            return ColorKt.Color((float) this.mDestination.getOetfFunc().invoke((fArr[0] * invoke) + (fArr[3] * invoke2) + (fArr[6] * invoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[1] * invoke) + (fArr[4] * invoke2) + (fArr[7] * invoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[2] * invoke) + (fArr[5] * invoke2) + (fArr[8] * invoke3)), m3845getAlphaimpl, this.mDestination);
        }
    }

    /* compiled from: Connector.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0014\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J,\u0010\u0003\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tH\u0002ø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000bJ\u0015\u0010\f\u001a\u00020\r2\u0006\u0010\u0005\u001a\u00020\u0006H\u0000¢\u0006\u0002\b\u000e\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001¨\u0006\u000f"}, d2 = {"Landroidx/compose/ui/graphics/colorspace/Connector$Companion;", "", "()V", "computeTransform", "", Property.SYMBOL_Z_ORDER_SOURCE, "Landroidx/compose/ui/graphics/colorspace/ColorSpace;", "destination", "intent", "Landroidx/compose/ui/graphics/colorspace/RenderIntent;", "computeTransform-YBCOT_4", "(Landroidx/compose/ui/graphics/colorspace/ColorSpace;Landroidx/compose/ui/graphics/colorspace/ColorSpace;I)[F", "identity", "Landroidx/compose/ui/graphics/colorspace/Connector;", "identity$ui_graphics_release", "ui-graphics_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m4267computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m4273equalsimpl0(intent, RenderIntent.INSTANCE.m4277getAbsoluteuksYyKA())) {
                return null;
            }
            boolean m4250equalsimpl0 = ColorModel.m4250equalsimpl0(source.getModel(), ColorModel.INSTANCE.m4257getRgbxdoWZVw());
            boolean m4250equalsimpl02 = ColorModel.m4250equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4257getRgbxdoWZVw());
            if (m4250equalsimpl0 && m4250equalsimpl02) {
                return null;
            }
            if (!m4250equalsimpl0 && !m4250equalsimpl02) {
                return null;
            ...
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = m4250equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = m4250equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            final int m4279getRelativeuksYyKA = RenderIntent.INSTANCE.m4279getRelativeuksYyKA();
            return new Connector(source, m4279getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    return v;
                }
                ...
                {
                    super(source, source, m4279getRelativeuksYyKA, null);
                }
            };
        }
    }
    ...
    public long mo4265transformToColorl2rxGTc$ui_graphics_release(long color) {
        ...
        float m3846getBlueimpl = Color.m3846getBlueimpl(color);
        float m3845getAlphaimpl = Color.m3845getAlphaimpl(color);
        long xy$ui_graphics_release = this.transformSource.toXy$ui_graphics_release(m3849getRedimpl, m3848getGreenimpl, m3846getBlueimpl);
        ...
        float z$ui_graphics_release = this.transformSource.toZ$ui_graphics_release(m3849getRedimpl, m3848getGreenimpl, m3846getBlueimpl);
        float[] fArr = this.transform;
        if (fArr != null) {
        ...
        return this.transformDestination.mo4260xyzaToColorJlNiLsg$ui_graphics_release(f, intBitsToFloat2, z$ui_graphics_release, m3845getAlphaimpl, this.destination);
    }
}
