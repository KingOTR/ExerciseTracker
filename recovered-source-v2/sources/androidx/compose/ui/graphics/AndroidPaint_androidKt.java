...
public final class AndroidPaint_androidKt {
    ...
    public static final void m3727setNativeBlendModeGB0RdKg(android.graphics.Paint paint, int i) {
        WrapperVerificationHelperMethods.INSTANCE.m4246setBlendModeGB0RdKg(paint, i);
    }
    ...
    public static final void m3728setNativeColor4WTKRHQ(android.graphics.Paint paint, long j) {
        paint.setColor(ColorKt.m3897toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m3732setNativeStyle5YerkU(android.graphics.Paint paint, int i) {
        paint.setStyle(PaintingStyle.m4106equalsimpl0(i, PaintingStyle.INSTANCE.m4111getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.INSTANCE.m4111getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m4110getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m4198getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4196getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m3730setNativeStrokeCapCSYIeUk(android.graphics.Paint paint, int i) {
        Paint.Cap cap;
        if (StrokeCap.m4192equalsimpl0(i, StrokeCap.INSTANCE.m4198getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m4192equalsimpl0(i, StrokeCap.INSTANCE.m4197getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m4192equalsimpl0(i, StrokeCap.INSTANCE.m4196getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m4206getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m3731setNativeStrokeJoinkLtJ_vA(android.graphics.Paint paint, int i) {
        Paint.Join join;
        if (StrokeJoin.m4202equalsimpl0(i, StrokeJoin.INSTANCE.m4207getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m4202equalsimpl0(i, StrokeJoin.INSTANCE.m4206getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m4202equalsimpl0(i, StrokeJoin.INSTANCE.m4208getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m3945getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m3943getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m3729setNativeFilterQuality50PEsBU(android.graphics.Paint paint, int i) {
        paint.setFilterBitmap(!FilterQuality.m3938equalsimpl0(i, FilterQuality.INSTANCE.m3945getNonefv9h1I()));
    }
