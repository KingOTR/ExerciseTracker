...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m3785getSrcOver0nO6VwU();
    }
    ...
    public long mo3716getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo3722setColor8_81llA(long j) {
        AndroidPaint_androidKt.m3728setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo3721setBlendModes9anfk8(int i) {
        if (BlendMode.m3754equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m3727setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo3720getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo3726setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m3732setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo3718getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo3724setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m3730setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo3719getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo3725setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m3731setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo3717getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo3723setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m3729setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
