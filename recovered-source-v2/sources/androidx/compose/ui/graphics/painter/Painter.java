...
public abstract class Painter {
    ...
    public abstract long mo4520getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m4525drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m4526drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m4526drawx_KDEd0(DrawScope drawScope, long j, float f, ColorFilter colorFilter) {
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(drawScope.getLayoutDirection());
        float m3671getWidthimpl = Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()) - Size.m3671getWidthimpl(j);
        float m3668getHeightimpl = Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()) - Size.m3668getHeightimpl(j);
        drawScope.getDrawContext().getTransform().inset(0.0f, 0.0f, m3671getWidthimpl, m3668getHeightimpl);
        if (f > 0.0f) {
            try {
                if (Size.m3671getWidthimpl(j) > 0.0f && Size.m3668getHeightimpl(j) > 0.0f) {
                    if (this.useLayer) {
                        Rect m3642Recttz77jQw = RectKt.m3642Recttz77jQw(Offset.INSTANCE.m3618getZeroF1C5BW0(), SizeKt.Size(Size.m3671getWidthimpl(j), Size.m3668getHeightimpl(j)));
                        Canvas canvas = drawScope.getDrawContext().getCanvas();
                        try {
                            canvas.saveLayer(m3642Recttz77jQw, obtainPaint());
                            onDraw(drawScope);
                            canvas.restore();
                        } catch (Throwable th) {
                            canvas.restore();
