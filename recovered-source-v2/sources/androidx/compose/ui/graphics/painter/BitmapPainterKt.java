...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m4523BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.INSTANCE.m6441getZeronOccac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
        ...
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.INSTANCE.m3943getLowfv9h1I();
        }
        return m4522BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY, reason: not valid java name */
    public static final BitmapPainter m4522BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        BitmapPainter bitmapPainter = new BitmapPainter(imageBitmap, j, j2, null);
        bitmapPainter.m4521setFilterQualityvDHp3xo$ui_graphics_release(i);
