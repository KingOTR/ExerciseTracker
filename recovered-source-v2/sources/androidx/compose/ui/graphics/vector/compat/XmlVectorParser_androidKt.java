...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4568getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4196getButtKaPHkGw();
        }
        return m4567getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4567getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m4196getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m4198getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4197getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m4570getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4207getMiterLxFBmk8();
        }
        return m4569getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4569getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m4207getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m4206getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m4208getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) {
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m3879getUnspecified0d7_KjU = Color.INSTANCE.m3879getUnspecified0d7_KjU();
            } else {
                ...
                if (namedColorStateList != null) {
                    m3879getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                } else {
                    m3879getUnspecified0d7_KjU = Color.INSTANCE.m3879getUnspecified0d7_KjU();
                }
            }
        ...
        long j = m3879getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3783getSrcIn0nO6VwU();
        } else if (i == 3) {
            m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3785getSrcOver0nO6VwU();
        } else if (i == 5) {
            m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3783getSrcIn0nO6VwU();
        } else if (i == 9) {
            m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3782getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3774getModulate0nO6VwU();
                    break;
                case 15:
                    m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3779getScreen0nO6VwU();
                    break;
                case 16:
                    m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3777getPlus0nO6VwU();
                    break;
                default:
                    m3783getSrcIn0nO6VwU = BlendMode.INSTANCE.m3783getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m3783getSrcIn0nO6VwU;
        float m6303constructorimpl = Dp.m6303constructorimpl(dimension / resources.getDisplayMetrics().density);
        float m6303constructorimpl2 = Dp.m6303constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, m6303constructorimpl, m6303constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m4567getStrokeLineCapCSYIeUk = m4567getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m4196getButtKaPHkGw());
        int m4569getStrokeLineJoinkLtJ_vA = m4569getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m4206getBevelLxFBmk8());
        ...
        builder.m4535addPathoIyEayM(list, namedInt == 0 ? companion.m4126getNonZeroRgk1Os() : companion.m4125getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m4567getStrokeLineCapCSYIeUk, m4569getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
