...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent groupComponent) {
        ...
        this.viewportSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3659boximpl(Size.INSTANCE.m3680getZeroNHjbRc()), null, 2, null);
        this.previousDrawSize = Size.INSTANCE.m3679getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    drawContext.getTransform().mo4327scale0AR0LA0(f, f2, m3618getZeroF1C5BW0);
                    root.draw(drawScope);
                } finally {
    ...
    public final int m4544getCacheBitmapConfig_sVssgQ$ui_release() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo3710getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m4064getArgb8888_sVssgQ();
    }
    ...
    public final long m4545getViewportSizeNHjbRc$ui_release() {
        return ((Size) this.viewportSize.getValue()).getPackedValue();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4546setViewportSizeuvyYCjk$ui_release(long j) {
        this.viewportSize.setValue(Size.m3659boximpl(j));
    }
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        int i = m4064getArgb8888_sVssgQ;
        if (this.isDirty || !Size.m3667equalsimpl0(this.previousDrawSize, drawScope.mo4399getSizeNHjbRc()) || !ImageBitmapConfig.m4059equalsimpl0(i, m4544getCacheBitmapConfig_sVssgQ$ui_release())) {
            this.tintFilter = ImageBitmapConfig.m4059equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4063getAlpha8_sVssgQ()) ? ColorFilter.Companion.m3884tintxETnrds$default(ColorFilter.INSTANCE, this.root.getTintColor(), 0, 2, null) : null;
            this.rootScaleX = Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()) / Size.m3671getWidthimpl(m4545getViewportSizeNHjbRc$ui_release());
            this.rootScaleY = Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()) / Size.m3668getHeightimpl(m4545getViewportSizeNHjbRc$ui_release());
            this.cacheDrawScope.m4527drawCachedImageFqjB98A(i, IntSizeKt.IntSize((int) Math.ceil(Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc())), (int) Math.ceil(Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo4399getSizeNHjbRc();
        }
        if (colorFilter == null) {
    ...
    public String toString() {
        ...
        sb.append(Size.m3671getWidthimpl(m4545getViewportSizeNHjbRc$ui_release())).append("\n\tviewportHeight: ");
        sb.append(Size.m3668getHeightimpl(m4545getViewportSizeNHjbRc$ui_release())).append("\n");
