...
public final class PathComponent extends VNode {
    ...
    public final void m4541setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo3736setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m4542setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m4543setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int mo3734getFillTypeRgk1Os = this.renderPath.mo3734getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo3736setFillTypeoQ8Xj4U(mo3734getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m4388drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m4388drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
