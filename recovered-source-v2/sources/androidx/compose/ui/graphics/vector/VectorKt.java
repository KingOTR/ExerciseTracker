...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4196getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4207getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m3783getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m3878getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4126getNonZeroRgk1Os();
    ...
    public static final boolean m4551rgbEqualOWjLjI(long j, long j2) {
        return Color.m3849getRedimpl(j) == Color.m3849getRedimpl(j2) && Color.m3848getGreenimpl(j) == Color.m3848getGreenimpl(j2) && Color.m3846getBlueimpl(j) == Color.m3846getBlueimpl(j2);
    }

    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        if (colorFilter instanceof BlendModeColorFilter) {
            BlendModeColorFilter blendModeColorFilter = (BlendModeColorFilter) colorFilter;
            if (BlendMode.m3754equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3783getSrcIn0nO6VwU()) || BlendMode.m3754equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3785getSrcOver0nO6VwU())) {
                return true;
            }
