...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m6478getZeroYbymL2g();
    private int config = ImageBitmapConfig.INSTANCE.m4064getArgb8888_sVssgQ();
    ...
    public final void m4527drawCachedImageFqjB98A(int config, long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmap = this.mCachedImage;
        Canvas canvas = this.cachedCanvas;
        if (imageBitmap == null || canvas == null || IntSize.m6473getWidthimpl(size) > imageBitmap.getWidth() || IntSize.m6472getHeightimpl(size) > imageBitmap.getHeight() || !ImageBitmapConfig.m4059equalsimpl0(this.config, config)) {
            imageBitmap = ImageBitmapKt.m4069ImageBitmapx__hDU$default(IntSize.m6473getWidthimpl(size), IntSize.m6472getHeightimpl(size), config, false, null, 24, null);
        ...
        long m6485toSizeozmzZPI = IntSizeKt.m6485toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m4382drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.m4393drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m3869getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m3758getClear0nO6VwU(), 62, null);
    }
}
