...
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m4153createBlurEffect8A3gB4(RenderEffect inputRenderEffect, float radiusX, float radiusY, int edgeTreatment) {
        if (inputRenderEffect == null) {
            return android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, AndroidTileMode_androidKt.m3748toAndroidTileMode0vamqd0(edgeTreatment));
        }
        return android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, inputRenderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m3748toAndroidTileMode0vamqd0(edgeTreatment));
    }

    /* renamed from: createOffsetEffect-Uv8p0NA, reason: not valid java name */
    public final android.graphics.RenderEffect m4154createOffsetEffectUv8p0NA(RenderEffect inputRenderEffect, long offset) {
        if (inputRenderEffect == null) {
            return android.graphics.RenderEffect.createOffsetEffect(Offset.m3602getXimpl(offset), Offset.m3603getYimpl(offset));
        }
        return android.graphics.RenderEffect.createOffsetEffect(Offset.m3602getXimpl(offset), Offset.m3603getYimpl(offset), inputRenderEffect.asAndroidRenderEffect());
    }
}
