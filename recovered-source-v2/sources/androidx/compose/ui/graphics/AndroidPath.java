...
public final class AndroidPath implements Path {
    ...
    public int mo3734getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m4125getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m4126getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo3736setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4121equalsimpl0(i, PathFillType.INSTANCE.m4125getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = CornerRadius.m3577getXimpl(roundRect.m3652getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m3578getYimpl(roundRect.m3652getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m3577getXimpl(roundRect.m3653getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m3578getYimpl(roundRect.m3653getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m3577getXimpl(roundRect.m3651getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m3578getYimpl(roundRect.m3651getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m3577getXimpl(roundRect.m3650getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m3578getYimpl(roundRect.m3650getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo3733addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3602getXimpl(offset), Offset.m3603getYimpl(offset));
            return;
        }
    ...
    public void mo3738translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m3602getXimpl(offset), Offset.m3603getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo3737transform58bKbWc(float[] matrix) {
    ...
    public boolean mo3735opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4131equalsimpl0(operation, PathOperation.INSTANCE.m4135getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4131equalsimpl0(operation, PathOperation.INSTANCE.m4136getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4131equalsimpl0(operation, PathOperation.INSTANCE.m4137getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4131equalsimpl0(operation, PathOperation.INSTANCE.m4138getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
