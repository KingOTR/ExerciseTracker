...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m4117stampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
            return AndroidPathEffect_androidKt.m3739actualStampedPathEffect7aD1DOk(shape, advance, phase, style);
        }
    }
}
