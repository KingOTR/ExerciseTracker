...
public final class Shadow {
    ...
    public static /* synthetic */ void m4165getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m4166getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m3618getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.color, shadow.color) && Offset.m3599equalsimpl0(this.offset, shadow.offset) && this.blurRadius == shadow.blurRadius;
    }

    public int hashCode() {
        return (((Color.m3850hashCodeimpl(this.color) * 31) + Offset.m3604hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m3851toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m3610toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default, reason: not valid java name */
    public static /* synthetic */ Shadow m4164copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m4167copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m4167copyqcb84PM(long color, long offset, float blurRadius) {
