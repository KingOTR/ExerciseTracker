...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m6478getZeroYbymL2g();
        ...
        create.setClipToBounds(false);
        m4514applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4479getAutoke2Ky5w());
        this.compositingStrategy = CompositingStrategy.INSTANCE.m4479getAutoke2Ky5w();
        this.blendMode = BlendMode.INSTANCE.m3785getSrcOver0nO6VwU();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3617getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m3869getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m3869getBlack0d7_KjU();
    ...
    public void mo4509setCompositingStrategyWpw9cng(int i) {
        this.compositingStrategy = i;
        updateLayerProperties();
    }

    /* renamed from: applyCompositingStrategy-Wpw9cng, reason: not valid java name */
    private final void m4514applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m4475equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w())) {
            renderNode.setLayerType(2);
            renderNode.setLayerPaint(this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4475equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4480getModulateAlphake2Ky5w())) {
    ...
    public void mo4508setBlendModes9anfk8(int i) {
        if (BlendMode.m3754equalsimpl0(this.blendMode, i)) {
            return;
        }
        this.blendMode = i;
        obtainLayerPaint().setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m3695toPorterDuffModes9anfk8(i)));
        updateLayerProperties();
    }

    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m4475equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w()) && BlendMode.m3754equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m3785getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4514applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w());
        } else {
            m4514applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo4511setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
        if (OffsetKt.m3623isUnspecifiedk4lQ0M(j)) {
            this.shouldManuallySetCenterPivot = true;
            this.renderNode.setPivotX(IntSize.m6473getWidthimpl(this.size) / 2.0f);
            this.renderNode.setPivotY(IntSize.m6472getHeightimpl(this.size) / 2.0f);
        } else {
            this.shouldManuallySetCenterPivot = false;
            this.renderNode.setPivotX(Offset.m3602getXimpl(j));
            this.renderNode.setPivotY(Offset.m3603getYimpl(j));
        }
    }
    ...
    public void mo4507setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m3897toArgb8_81llA(j));
    }
    ...
    public void mo4513setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m3897toArgb8_81llA(j));
    }
    ...
    public void mo4512setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setLeftTopRightBottom(x, y, IntSize.m6473getWidthimpl(size) + x, IntSize.m6472getHeightimpl(size) + y);
        if (IntSize.m6471equalsimpl0(this.size, size)) {
            return;
        }
        if (this.shouldManuallySetCenterPivot) {
            this.renderNode.setPivotX(IntSize.m6473getWidthimpl(size) / 2.0f);
            this.renderNode.setPivotY(IntSize.m6472getHeightimpl(size) / 2.0f);
        }
        this.size = size;
    }
    ...
    public void mo4510setOutlineO0kMr_c(Outline outline, long outlineSize) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        Canvas start = this.renderNode.start(Math.max(IntSize.m6473getWidthimpl(this.size), IntSize.m6473getWidthimpl(this.outlineSize)), Math.max(IntSize.m6472getHeightimpl(this.size), IntSize.m6472getHeightimpl(this.outlineSize)));
        try {
            ...
            drawContext.mo4321setSizeuvyYCjk(m6485toSizeozmzZPI);
