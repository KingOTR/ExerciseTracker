...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3618getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m4516applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4516applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w());
        } else {
            m4516applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4475equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m3754equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m3785getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo4511setPivotOffsetk4lQ0M(long j) {
        ...
        this.viewLayer.setPivotX(Offset.m3602getXimpl(j));
        this.viewLayer.setPivotY(Offset.m3603getYimpl(j));
    }
    ...
    public void mo4507setAmbientShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m3897toArgb8_81llA(j));
    }
    ...
    public void mo4513setSpotShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m3897toArgb8_81llA(j));
    }
    ...
    public void mo4512setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m6471equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m6473getWidthimpl(size) + x, IntSize.m6472getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m6473getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m6472getHeightimpl(size) / 2.0f);
            }
        } else {
            int i = this.x;
            if (i != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (picture != null) {
                Canvas beginRecording = picture.beginRecording(IntSize.m6473getWidthimpl(this.size), IntSize.m6472getHeightimpl(this.size));
                try {
