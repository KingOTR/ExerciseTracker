...
public final class GraphicsLayerKt {
    ...
    public static final void setOutline(GraphicsLayer graphicsLayer, Outline outline) {
        if (outline instanceof Outline.Rectangle) {
            ...
            graphicsLayer.m4498setRectOutlinetz77jQw(OffsetKt.Offset(rectangle.getRect().getLeft(), rectangle.getRect().getTop()), SizeKt.Size(rectangle.getRect().getWidth(), rectangle.getRect().getHeight()));
            return;
        }
        ...
        if (outline instanceof Outline.Rounded) {
            ...
            if (rounded.getRoundRectPath() != null) {
                ...
                graphicsLayer.m4499setRoundRectOutlineTNW_H78(OffsetKt.Offset(roundRect.getLeft(), roundRect.getTop()), SizeKt.Size(roundRect.getWidth(), roundRect.getHeight()), CornerRadius.m3577getXimpl(roundRect.m3650getBottomLeftCornerRadiuskKHJgLs()));
            }
        }
    }
