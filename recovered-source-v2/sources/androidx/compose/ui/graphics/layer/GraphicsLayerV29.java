...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m3680getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m4515applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m4479getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo4508setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m3694toAndroidBlendModes9anfk8(i));
    ...
    public void mo4507setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m3897toArgb8_81llA(j));
    }
    ...
    public void mo4513setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m3897toArgb8_81llA(j));
    }
    ...
    private final void m4515applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m4475equalsimpl0(i, CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4475equalsimpl0(i, CompositingStrategy.INSTANCE.m4480getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4515applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w());
        } else {
            m4515applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo4512setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setPosition(x, y, IntSize.m6473getWidthimpl(size) + x, IntSize.m6472getHeightimpl(size) + y);
        this.size = IntSizeKt.m6485toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo4321setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4475equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4481getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
