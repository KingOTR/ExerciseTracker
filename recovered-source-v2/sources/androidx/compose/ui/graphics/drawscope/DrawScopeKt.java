...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m4447rotateRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.mo4398getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4326rotateUv8p0NA(f, j);
            function1.invoke(drawScope);
        } finally {
            InlineMarker.finallyStart(1);
    ...
    public static /* synthetic */ void m4449rotateRadRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.mo4398getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4326rotateUv8p0NA(DegreesKt.degrees(f), j);
            function1.invoke(drawScope);
        } finally {
            InlineMarker.finallyStart(1);
            drawContext.getCanvas().restore();
    ...
    public static /* synthetic */ void m4451scaleFgt4K4Q$default(DrawScope drawScope, float f, float f2, long j, Function1 function1, int i, Object obj) {
        if ((i & 4) != 0) {
            j = drawScope.mo4398getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4327scale0AR0LA0(f, f2, j);
            function1.invoke(drawScope);
        } finally {
            InlineMarker.finallyStart(1);
            drawContext.getCanvas().restore();
    ...
    public static /* synthetic */ void m4453scaleRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.mo4398getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4327scale0AR0LA0(f, f, j);
            function1.invoke(drawScope);
        } finally {
            InlineMarker.finallyStart(1);
            drawContext.getCanvas().restore();
    ...
    public static /* synthetic */ void m4442clipRectrOu3jXo$default(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1 function1, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.INSTANCE.m3832getIntersectrtfAjoo();
        }
        int i3 = i;
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4323clipRectN_I0leg(f5, f6, f7, f8, i3);
            function1.invoke(drawScope);
        } finally {
            InlineMarker.finallyStart(1);
            drawContext.getCanvas().restore();
    ...
    public static /* synthetic */ void m4440clipPathKD09W0M$default(DrawScope drawScope, Path path, int i, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m3832getIntersectrtfAjoo();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4322clipPathmtrdDE(path, i);
            function1.invoke(drawScope);
        } finally {
            InlineMarker.finallyStart(1);
            drawContext.getCanvas().restore();
    ...
    public static final void m4444drawymL40Pk(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, GraphicsLayer graphicsLayer, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4445drawymL40Pk$default(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, GraphicsLayer graphicsLayer, Function1 function1, int i, Object obj) {
        if ((i & 16) != 0) {
            graphicsLayer = null;
        }
        Density density2 = drawScope.getDrawContext().getDensity();
    ...
    public static final void m4446rotateRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4448rotateRadRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4450scaleFgt4K4Q(DrawScope drawScope, float f, float f2, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4452scaleRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4441clipRectrOu3jXo(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4323clipRectN_I0leg(f, f2, f3, f4, i);
            function1.invoke(drawScope);
        } finally {
            InlineMarker.finallyStart(1);
            drawContext.getCanvas().restore();
    ...
    public static final void m4439clipPathKD09W0M(DrawScope drawScope, Path path, int i, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4320getSizeNHjbRc = drawContext.mo4320getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final /* synthetic */ void m4443drawGRGpd60(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, Function1<? super DrawScope, Unit> function1) {
        Density density2 = drawScope.getDrawContext().getDensity();
        LayoutDirection layoutDirection2 = drawScope.getDrawContext().getLayoutDirection();
        Canvas canvas2 = drawScope.getDrawContext().getCanvas();
        long mo4320getSizeNHjbRc = drawScope.getDrawContext().mo4320getSizeNHjbRc();
