...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo3812createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m3679getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo3790applyToPq9zytI(long size, Paint p, float alpha) {
        Shader shader = this.internalShader;
        if (shader == null || !Size.m3667equalsimpl0(this.createdSize, size)) {
            if (Size.m3673isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m3679getUnspecifiedNHjbRc();
            } else {
                shader = mo3812createShaderuvyYCjk(size);
                this.internalShader = shader;
                this.createdSize = size;
            }
        }
        if (!Color.m3844equalsimpl0(p.mo3716getColor0d7_KjU(), Color.INSTANCE.m3869getBlack0d7_KjU())) {
            p.mo3722setColor8_81llA(Color.INSTANCE.m3869getBlack0d7_KjU());
        }
