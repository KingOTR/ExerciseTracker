...
public final class AndroidMatrixConversions_androidKt {
    ...
    public static final void m3714setFromtUYjHk(float[] fArr, android.graphics.Matrix matrix) {
    ...
    public static final void m3713setFromEL8BTi8(android.graphics.Matrix matrix, float[] fArr) {
        float f = fArr[0];
        float f2 = fArr[1];
        float f3 = fArr[2];
        float f4 = fArr[3];
