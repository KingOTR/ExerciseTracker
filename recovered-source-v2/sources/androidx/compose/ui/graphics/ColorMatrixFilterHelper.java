...
final class ColorMatrixFilterHelper {
    ...
    public final float[] m3923getColorMatrix8unuwjk(android.graphics.ColorMatrixColorFilter colorFilter) {
        android.graphics.ColorMatrix colorMatrix = new android.graphics.ColorMatrix();
        colorFilter.getColorMatrix(colorMatrix);
        return ColorMatrix.m3899constructorimpl(colorMatrix.getArray());
    }
}
