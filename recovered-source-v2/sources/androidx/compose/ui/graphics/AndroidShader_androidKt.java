...
public final class AndroidShader_androidKt {
    ...
    public static final Shader m3744ActualLinearGradientShaderVjE6UOU(long j, long j2, List<Color> list, List<Float> list2, int i) {
        validateColorStops(list, list2);
        int countTransparentColors = countTransparentColors(list);
        return new android.graphics.LinearGradient(Offset.m3602getXimpl(j), Offset.m3603getYimpl(j), Offset.m3602getXimpl(j2), Offset.m3603getYimpl(j2), makeTransparentColors(list, countTransparentColors), makeTransparentStops(list2, list, countTransparentColors), AndroidTileMode_androidKt.m3748toAndroidTileMode0vamqd0(i));
    }

    /* renamed from: ActualRadialGradientShader-8uybcMk, reason: not valid java name */
    public static final Shader m3745ActualRadialGradientShader8uybcMk(long j, float f, List<Color> list, List<Float> list2, int i) {
        validateColorStops(list, list2);
        int countTransparentColors = countTransparentColors(list);
        return new android.graphics.RadialGradient(Offset.m3602getXimpl(j), Offset.m3603getYimpl(j), f, makeTransparentColors(list, countTransparentColors), makeTransparentStops(list2, list, countTransparentColors), AndroidTileMode_androidKt.m3748toAndroidTileMode0vamqd0(i));
    }

    /* renamed from: ActualSweepGradientShader-9KIMszo, reason: not valid java name */
    public static final Shader m3746ActualSweepGradientShader9KIMszo(long j, List<Color> list, List<Float> list2) {
        validateColorStops(list, list2);
        int countTransparentColors = countTransparentColors(list);
        return new android.graphics.SweepGradient(Offset.m3602getXimpl(j), Offset.m3603getYimpl(j), makeTransparentColors(list, countTransparentColors), makeTransparentStops(list2, list, countTransparentColors));
    }

    /* renamed from: ActualImageShader-F49vj9s, reason: not valid java name */
    public static final Shader m3743ActualImageShaderF49vj9s(ImageBitmap imageBitmap, int i, int i2) {
        return new BitmapShader(AndroidImageBitmap_androidKt.asAndroidBitmap(imageBitmap), AndroidTileMode_androidKt.m3748toAndroidTileMode0vamqd0(i), AndroidTileMode_androidKt.m3748toAndroidTileMode0vamqd0(i2));
    }
    ...
    public static final int[] makeTransparentColors(List<Color> list, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            iArr[i2] = ColorKt.m3897toArgb8_81llA(list.get(i2).m3853unboximpl());
        }
        return iArr;
    }
    ...
    public static final float[] makeTransparentStops(List<Float> list, List<Color> list2, int i) {
        ...
        for (int i3 = 1; i3 < lastIndex; i3++) {
            long m3853unboximpl = list2.get(i3).m3853unboximpl();
            float floatValue = list != null ? list.get(i3).floatValue() : i3 / CollectionsKt.getLastIndex(list2);
            int i4 = i2 + 1;
            fArr[i2] = floatValue;
            if (Color.m3845getAlphaimpl(m3853unboximpl) == 0.0f) {
                i2 += 2;
                fArr[i4] = floatValue;
            } else {
                i2 = i4;
