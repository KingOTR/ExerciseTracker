...
public interface Path {
    ...
    void mo3733addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo3735opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo3736setFillTypeoQ8Xj4U(int i);

    /* renamed from: transform-58bKbWc */
    default void mo3737transform58bKbWc(float[] matrix) {
    }

    /* renamed from: translate-k-4lQ0M */
    void mo3738translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4116transform58bKbWc(Path path, float[] fArr) {
            Path.super.mo3737transform58bKbWc(fArr);
        }
    ...
    static /* synthetic */ void m4113addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo3733addPathUv8p0NA(path2, j);
    }
    ...
    default Path plus(Path path) {
        ...
        Path.mo3735opN5in7k0(this, path, PathOperation.INSTANCE.m4138getUnionb3I0S0c());
        return Path;
    }

    default Path minus(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo3735opN5in7k0(this, path, PathOperation.INSTANCE.m4135getDifferenceb3I0S0c());
        return Path;
    }
    ...
    default Path and(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo3735opN5in7k0(this, path, PathOperation.INSTANCE.m4136getIntersectb3I0S0c());
        return Path;
    }

    default Path xor(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo3735opN5in7k0(this, path, PathOperation.INSTANCE.m4139getXorb3I0S0c());
        return Path;
    }
    ...
    public static final class Companion {
        ...
        public final Path m4114combinexh6zSI8(int operation, Path path1, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo3735opN5in7k0(path1, path2, operation)) {
                return Path;
            }
