...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m3476containsUv8p0NA(DragAndDropModifierNode dragAndDropModifierNode, long j) {
        ...
        long mo5187getSizeYbymL2g = coordinates.mo5187getSizeYbymL2g();
        int m6473getWidthimpl = IntSize.m6473getWidthimpl(mo5187getSizeYbymL2g);
        int m6472getHeightimpl = IntSize.m6472getHeightimpl(mo5187getSizeYbymL2g);
        long positionInRoot = LayoutCoordinatesKt.positionInRoot(coordinates);
        float m3602getXimpl = Offset.m3602getXimpl(positionInRoot);
        float m3603getYimpl = Offset.m3603getYimpl(positionInRoot);
        float f = m6473getWidthimpl + m3602getXimpl;
        float f2 = m6472getHeightimpl + m3603getYimpl;
        float m3602getXimpl2 = Offset.m3602getXimpl(j);
        if (m3602getXimpl > m3602getXimpl2 || m3602getXimpl2 > f) {
            return false;
        }
        float m3603getYimpl2 = Offset.m3603getYimpl(j);
        return m3603getYimpl <= m3603getYimpl2 && m3603getYimpl2 <= f2;
    }
