...
public final class ComposeDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
        ...
        outShadowSize.set(density.mo370roundToPx0680j_4(density.mo372toDpu2uoSUM(Size.m3671getWidthimpl(this.decorationSize))), density.mo370roundToPx0680j_4(density.mo372toDpu2uoSUM(Size.m3668getHeightimpl(this.decorationSize))));
    ...
    public void onDrawShadow(Canvas canvas) {
        ...
        drawParams2.m4319setSizeuvyYCjk(j);
        Canvas.save();
