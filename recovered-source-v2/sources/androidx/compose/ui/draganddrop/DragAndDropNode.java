...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode {
    ...
    public void mo3474drag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
        DelegatableNodeKt.requireOwner(this).getDragAndDropManager().mo3473drag12SF9DM(transferData, decorationSize, drawDragDecoration);
    }
    ...
    */
    public void onMoved(final DragAndDropEvent event) {
        ...
        boolean m3476containsUv8p0NA;
        DragAndDropModifierNode dragAndDropModifierNode2 = this.lastChildDragAndDropModifierNode;
        if (dragAndDropModifierNode2 != null) {
            m3476containsUv8p0NA = DragAndDropNodeKt.m3476containsUv8p0NA(dragAndDropModifierNode2, DragAndDrop_androidKt.getPositionInRoot(event));
            if (m3476containsUv8p0NA) {
            ...
            TraversableNodeKt.traverseDescendants(dragAndDropNode, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$onMoved$$inlined$firstDescendantOrNull$1
                ...
                public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode2) {
                    ...
                    if (DelegatableNodeKt.requireOwner(this).getDragAndDropManager().isInterestedNode(dragAndDropNode3)) {
                        m3476containsUv8p0NA2 = DragAndDropNodeKt.m3476containsUv8p0NA(dragAndDropNode3, DragAndDrop_androidKt.getPositionInRoot(event));
                        if (m3476containsUv8p0NA2) {
