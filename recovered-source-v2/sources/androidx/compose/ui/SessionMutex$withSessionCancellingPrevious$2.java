...
@DebugMetadata(c = "androidx.compose.ui.SessionMutex$withSessionCancellingPrevious$2", f = "SessionMutex.kt", i = {0, 1}, l = {ExerciseSegment.EXERCISE_SEGMENT_TYPE_YOGA, ExerciseSessionRecord.EXERCISE_TYPE_STAIR_CLIMBING_MACHINE}, m = "invokeSuspend", n = {"newSession", "newSession"}, s = {"L$0", "L$0"})
