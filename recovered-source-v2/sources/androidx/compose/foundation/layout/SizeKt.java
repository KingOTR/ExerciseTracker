...
public final class SizeKt {
    ...
    public static final Modifier m734width3ABfNKs(Modifier modifier, final float f) {
        return modifier.then(new SizeElement(f, 0.0f, f, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(Property.ICON_TEXT_FIT_WIDTH);
                inspectorInfo.setValue(Dp.m6301boximpl(f));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs, reason: not valid java name */
    public static final Modifier m715height3ABfNKs(Modifier modifier, final float f) {
        return modifier.then(new SizeElement(0.0f, f, 0.0f, f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$height-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(Property.ICON_TEXT_FIT_HEIGHT);
                inspectorInfo.setValue(Dp.m6301boximpl(f));
            }
    ...
    public static final Modifier m730size6HolHcs(Modifier modifier, long j) {
        return m731sizeVpY3zN4(modifier, DpSize.m6401getWidthD9Ej5fM(j), DpSize.m6399getHeightD9Ej5fM(j));
    }

    /* renamed from: widthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m736widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
            f2 = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        return m735widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m735widthInVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m6301boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m6301boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m717heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m716heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m716heightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m733sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        return m732sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m732sizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
        return modifier.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m6301boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m6301boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m6301boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m6301boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m726requiredWidth3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m718requiredHeight3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m722requiredSize6HolHcs(Modifier modifier, long j) {
        return m723requiredSizeVpY3zN4(modifier, DpSize.m6401getWidthD9Ej5fM(j), DpSize.m6399getHeightD9Ej5fM(j));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m728requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m727requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m727requiredWidthInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m720requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m719requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m719requiredHeightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m725requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m724requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m724requiredSizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
    ...
    public static /* synthetic */ Modifier m714defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m713defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m713defaultMinSizeVpY3zN4(Modifier modifier, float f, float f2) {
        return modifier.then(new UnspecifiedConstraintsElement(f, f2, null));
    }

    /* renamed from: size-3ABfNKs, reason: not valid java name */
    public static final Modifier m729size3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m731sizeVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set(Property.ICON_TEXT_FIT_WIDTH, Dp.m6301boximpl(f));
                inspectorInfo.getProperties().set(Property.ICON_TEXT_FIT_HEIGHT, Dp.m6301boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m721requiredSize3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m723requiredSizeVpY3zN4(Modifier modifier, final float f, final float f2) {
