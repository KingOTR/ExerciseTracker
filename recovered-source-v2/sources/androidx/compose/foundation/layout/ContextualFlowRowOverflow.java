...
public final class ContextualFlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final ContextualFlowRowOverflow m603expandOrCollapseIndicatorjt2gSs(final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int i, float f, Composer composer, int i2, int i3) {
            ...
            boolean z = true;
            int i4 = (i3 & 4) != 0 ? 1 : i;
            float m6303constructorimpl = (i3 & 8) != 0 ? Dp.m6303constructorimpl(0) : f;
            if (ComposerKt.isTraceInProgress()) {
            ...
            int mo370roundToPx0680j_4 = ((Density) consume).mo370roundToPx0680j_4(m6303constructorimpl);
            ComposerKt.sourceInformationMarkerStart(composer, 172958269, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
            boolean changed = ((((i2 & 896) ^ 384) > 256 && composer.changed(i4)) || (i2 & 384) == 256) | composer.changed(mo370roundToPx0680j_4) | ((((i2 & 14) ^ 6) > 4 && composer.changed(function3)) || (i2 & 6) == 4);
            if ((((i2 & SdkConfig.SDK_VERSION) ^ 48) <= 32 || !composer.changed(function32)) && (i2 & 48) != 32) {
                z = false;
            }
            boolean z2 = changed | z;
            Object rememberedValue = composer.rememberedValue();
            if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = new ContextualFlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, i4, mo370roundToPx0680j_4, new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(1);
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(897838875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1.1
                            ...
                            public final void invoke(Composer composer2, int i5) {
                                ...
                                if ((i5 & 3) != 2 || !composer2.getSkipping()) {
                                    ...
                                    function33.invoke(new ContextualFlowRowOverflowScopeImpl(FlowLayoutOverflowState.this), composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
