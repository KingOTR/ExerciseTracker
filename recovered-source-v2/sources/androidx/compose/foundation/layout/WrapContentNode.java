...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo94measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m6258getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m6256getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m6257getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m6255getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int coerceIn = RangesKt.coerceIn(mo5179measureBRTryo0.getWidth(), Constraints.m6258getMinWidthimpl(j), Constraints.m6256getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo5179measureBRTryo0.getHeight(), Constraints.m6257getMinHeightimpl(j), Constraints.m6255getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, coerceIn, coerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5243place70tqf50$default(placementScope, mo5179measureBRTryo0, WrapContentNode.this.getAlignmentCallback().invoke(IntSize.m6465boximpl(IntSizeKt.IntSize(coerceIn - mo5179measureBRTryo0.getWidth(), coerceIn2 - mo5179measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
