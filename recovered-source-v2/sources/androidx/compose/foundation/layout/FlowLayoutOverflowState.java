...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m612ellipsisSizeF35zmw$foundation_layout_release(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
    ...
    public final void m614setOverflowMeasurableshBUhpc$foundation_layout_release(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        long m653constructorimpl = OrientationIndependentConstraints.m653constructorimpl(constraints, isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        if (seeMoreMeasurable != null) {
            int mainAxisMin = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m6255getMaxHeightimpl(m653constructorimpl));
            this.seeMoreSize = IntIntPair.m24boximpl(IntIntPair.m27constructorimpl(mainAxisMin, FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, mainAxisMin)));
        ...
        if (collapseMeasurable != null) {
            int mainAxisMin2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m6255getMaxHeightimpl(m653constructorimpl));
            this.collapseSize = IntIntPair.m24boximpl(IntIntPair.m27constructorimpl(mainAxisMin2, FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, mainAxisMin2)));
    ...
    /* renamed from: setOverflowMeasurables--hBUhpc$foundation_layout_release, reason: not valid java name */
    public final void m613setOverflowMeasurableshBUhpc$foundation_layout_release(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        LayoutOrientation layoutOrientation = measurePolicy.isHorizontal() ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long m666toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m666toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m655copyyUG9Ft0$default(OrientationIndependentConstraints.m653constructorimpl(constraints, layoutOrientation), 0, 0, 0, 0, 10, null), layoutOrientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m610measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, m666toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$3$1
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    FlowLayoutOverflowState.this.seeMoreSize = IntIntPair.m24boximpl(IntIntPair.m27constructorimpl(i, i2));
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m610measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, m666toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$4$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    FlowLayoutOverflowState.this.collapseSize = IntIntPair.m24boximpl(IntIntPair.m27constructorimpl(i, i2));
    ...
    public final void m615setOverflowMeasurablesVKLhPVY$foundation_layout_release(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        this.getOverflowMeasurable = getOverflowMeasurable;
        m613setOverflowMeasurableshBUhpc$foundation_layout_release(measurePolicy, getOverflowMeasurable.invoke(true, 0), getOverflowMeasurable.invoke(false, 0), constraints);
    }
}
