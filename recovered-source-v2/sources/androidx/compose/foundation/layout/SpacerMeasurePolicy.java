...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6254getHasFixedWidthimpl(j) ? Constraints.m6256getMaxWidthimpl(j) : 0, Constraints.m6253getHasFixedHeightimpl(j) ? Constraints.m6255getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
