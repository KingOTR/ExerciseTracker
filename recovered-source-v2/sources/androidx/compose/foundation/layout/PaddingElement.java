...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public final void m675setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m676setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m674setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m673setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    private PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if (f >= 0.0f || Dp.m6308equalsimpl0(f, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM())) {
            float f5 = this.top;
            if (f5 >= 0.0f || Dp.m6308equalsimpl0(f5, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM())) {
                float f6 = this.end;
                if (f6 >= 0.0f || Dp.m6308equalsimpl0(f6, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM())) {
                    float f7 = this.bottom;
                    if (f7 >= 0.0f || Dp.m6308equalsimpl0(f7, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM())) {
                        return;
                    }
                }
            }
    ...
    public void update(PaddingNode node) {
        node.m695setStart0680j_4(this.start);
        node.m696setTop0680j_4(this.top);
        node.m694setEnd0680j_4(this.end);
        node.m693setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m6309hashCodeimpl(this.start) * 31) + Dp.m6309hashCodeimpl(this.top)) * 31) + Dp.m6309hashCodeimpl(this.end)) * 31) + Dp.m6309hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement paddingElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return paddingElement != null && Dp.m6308equalsimpl0(this.start, paddingElement.start) && Dp.m6308equalsimpl0(this.top, paddingElement.top) && Dp.m6308equalsimpl0(this.end, paddingElement.end) && Dp.m6308equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware;
    }
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m6303constructorimpl(0) : f, (i & 2) != 0 ? Dp.m6303constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m6303constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m6303constructorimpl(0) : f4, z, function1, null);
    }
}
