...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m6497hashCodeimpl(this.before)) * 31) + TextUnit.m6497hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m6493equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m6493equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m553setBeforeR2X_6o(this.before);
        node.m552setAfterR2X_6o(this.after);
    }
}
