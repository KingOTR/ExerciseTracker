...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if ((f < 0.0f && !Dp.m6308equalsimpl0(f, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM())) || (f2 < 0.0f && !Dp.m6308equalsimpl0(f2, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM()))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m547setBefore0680j_4(this.before);
        node.m546setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m6308equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m6308equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m6309hashCodeimpl(this.before)) * 31) + Dp.m6309hashCodeimpl(this.after);
    }
}
