...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m553setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m552setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        MeasureResult m533alignmentLineOffsetMeasuretjqqzMA;
        m533alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m533alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m6514isUnspecifiedR2X_6o(this.before) ? measureScope.mo371toDpGaN1DYA(this.before) : Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM(), !TextUnitKt.m6514isUnspecifiedR2X_6o(this.after) ? measureScope.mo371toDpGaN1DYA(this.after) : Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM(), measurable, j);
        return m533alignmentLineOffsetMeasuretjqqzMA;
    }
}
