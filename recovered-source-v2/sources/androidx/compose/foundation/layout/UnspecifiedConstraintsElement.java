...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m751setMinWidth0680j_4(this.minWidth);
        node.m750setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m6301boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m6301boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6308equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m6308equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m6309hashCodeimpl(this.minWidth) * 31) + Dp.m6309hashCodeimpl(this.minHeight);
    }
}
