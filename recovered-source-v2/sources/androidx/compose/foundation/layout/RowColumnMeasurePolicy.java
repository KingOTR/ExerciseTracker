...
public interface RowColumnMeasurePolicy {
    ...
    long mo599createConstraintsxF2OJ5Q(int mainAxisMin, int crossAxisMin, int mainAxisMax, int crossAxisMax, boolean isPrioritizing);
    ...
    static /* synthetic */ long m709createConstraintsxF2OJ5Q$default(RowColumnMeasurePolicy rowColumnMeasurePolicy, int i, int i2, int i3, int i4, boolean z, int i5, Object obj) {
        if (obj != null) {
        ...
        return rowColumnMeasurePolicy.mo599createConstraintsxF2OJ5Q(i, i2, i3, i4, z);
    }
}
