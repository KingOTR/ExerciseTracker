...
final class IntrinsicWidthNode extends IntrinsicSizeModifier {
    ...
    public long mo638calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.width == IntrinsicSize.Min) {
            maxIntrinsicWidth = measurable.minIntrinsicWidth(Constraints.m6255getMaxHeightimpl(j));
        } else {
            maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m6255getMaxHeightimpl(j));
        }
        if (maxIntrinsicWidth < 0) {
            maxIntrinsicWidth = 0;
        }
        return Constraints.INSTANCE.m6268fixedWidthOenEA2s(maxIntrinsicWidth);
    }
