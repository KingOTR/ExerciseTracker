...
final /* data */ class BoxMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(final MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        ...
        if (list.isEmpty()) {
            return MeasureScope.layout$default(measureScope, Constraints.m6258getMinWidthimpl(j), Constraints.m6257getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxMeasurePolicy$measure$1
        ...
        long m6247copyZbe2FdA$default = this.propagateMinConstraints ? j : Constraints.m6247copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
        if (list.size() == 1) {
            final Measurable measurable = list.get(0);
            matchesParentSize3 = BoxKt.getMatchesParentSize(measurable);
            if (!matchesParentSize3) {
                mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(m6247copyZbe2FdA$default);
                m6258getMinWidthimpl = Math.max(Constraints.m6258getMinWidthimpl(j), mo5179measureBRTryo0.getWidth());
                m6257getMinHeightimpl = Math.max(Constraints.m6257getMinHeightimpl(j), mo5179measureBRTryo0.getHeight());
            } else {
                m6258getMinWidthimpl = Constraints.m6258getMinWidthimpl(j);
                m6257getMinHeightimpl = Constraints.m6257getMinHeightimpl(j);
                mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(Constraints.INSTANCE.m6266fixedJhjzzOo(Constraints.m6258getMinWidthimpl(j), Constraints.m6257getMinHeightimpl(j)));
            }
            final int i = m6257getMinHeightimpl;
            final Placeable placeable = mo5179measureBRTryo0;
            final int i2 = m6258getMinWidthimpl;
            return MeasureScope.layout$default(measureScope, i2, i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxMeasurePolicy$measure$2
        ...
        intRef.element = Constraints.m6258getMinWidthimpl(j);
        final Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.element = Constraints.m6257getMinHeightimpl(j);
        int size = list.size();
        boolean z = false;
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (matchesParentSize2) {
                ...
                Placeable mo5179measureBRTryo02 = measurable2.mo5179measureBRTryo0(m6247copyZbe2FdA$default);
                placeableArr[i3] = mo5179measureBRTryo02;
                intRef.element = Math.max(intRef.element, mo5179measureBRTryo02.getWidth());
                intRef2.element = Math.max(intRef2.element, mo5179measureBRTryo02.getHeight());
            }
        }
        if (z) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                ...
                if (matchesParentSize) {
                    placeableArr[i4] = measurable3.mo5179measureBRTryo0(Constraints);
                }
            }
        }
