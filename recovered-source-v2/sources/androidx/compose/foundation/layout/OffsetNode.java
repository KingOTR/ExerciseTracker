...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m648setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m649setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo94measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (OffsetNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, mo5179measureBRTryo0, measureScope.mo370roundToPx0680j_4(OffsetNode.this.getX()), measureScope.mo370roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, mo5179measureBRTryo0, measureScope.mo370roundToPx0680j_4(OffsetNode.this.getX()), measureScope.mo370roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
