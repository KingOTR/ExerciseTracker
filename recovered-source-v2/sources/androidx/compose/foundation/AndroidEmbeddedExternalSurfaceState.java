...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope coroutineScope) {
        ...
        this.surfaceSize = IntSize.INSTANCE.m6478getZeroYbymL2g();
    ...
    public final void m225setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.m6471equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m6478getZeroYbymL2g())) {
            width = IntSize.m6473getWidthimpl(this.surfaceSize);
            height = IntSize.m6472getHeightimpl(this.surfaceSize);
