...
final class DrawGlowOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    private final boolean drawLeftGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m293drawWithRotationAndOffsetubNVwUQ(270.0f, OffsetKt.Offset(-Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()), drawScope.mo376toPx0680j_4(this.overscrollConfig.getDrawPadding().mo635calculateLeftPaddingu2uoSUM(drawScope.getLayoutDirection()))), edgeEffect, canvas);
    }

    private final boolean drawTopGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m293drawWithRotationAndOffsetubNVwUQ(0.0f, OffsetKt.Offset(0.0f, drawScope.mo376toPx0680j_4(this.overscrollConfig.getDrawPadding().getTop())), edgeEffect, canvas);
    }

    private final boolean drawRightGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m293drawWithRotationAndOffsetubNVwUQ(90.0f, OffsetKt.Offset(0.0f, (-MathKt.roundToInt(Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()))) + drawScope.mo376toPx0680j_4(this.overscrollConfig.getDrawPadding().mo636calculateRightPaddingu2uoSUM(drawScope.getLayoutDirection()))), edgeEffect, canvas);
    }

    private final boolean drawBottomGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m293drawWithRotationAndOffsetubNVwUQ(180.0f, OffsetKt.Offset(-Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()), (-Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc())) + drawScope.mo376toPx0680j_4(this.overscrollConfig.getDrawPadding().getBottom())), edgeEffect, canvas);
    }

    /* renamed from: drawWithRotationAndOffset-ubNVwUQ, reason: not valid java name */
    private final boolean m293drawWithRotationAndOffsetubNVwUQ(float rotationDegrees, long offset, EdgeEffect edgeEffect, Canvas canvas) {
        int save = canvas.save();
        canvas.rotate(rotationDegrees);
        canvas.translate(Offset.m3602getXimpl(offset), Offset.m3603getYimpl(offset));
