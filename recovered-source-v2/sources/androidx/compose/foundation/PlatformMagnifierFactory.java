...
public interface PlatformMagnifierFactory {
    ...
    PlatformMagnifier mo330createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom);
