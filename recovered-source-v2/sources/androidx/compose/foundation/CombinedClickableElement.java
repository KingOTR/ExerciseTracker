...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    public void update(CombinedClickableNodeImpl node) {
        node.mo288updatenSzSaCc(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int m5595hashCodeimpl = (((hashCode3 + (role != null ? Role.m5595hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int hashCode4 = (m5595hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
