...
public final class TextFieldStateKt {
    ...
    public static final TextFieldState m1115rememberTextFieldStateLepunE(final String str, final long j, Composer composer, int i, int i2) {
        ...
        boolean z = ((((i & 14) ^ 6) > 4 && composer.changed(str)) || (i & 6) == 4) | ((((i & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(j)) || (i & 48) == 32);
        ...
        TextFieldState textFieldState = (TextFieldState) RememberSaveableKt.m3429rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
