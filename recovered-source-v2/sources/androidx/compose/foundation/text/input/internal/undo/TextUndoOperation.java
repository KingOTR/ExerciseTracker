...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m5788getStartimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m5783getEndimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m5788getStartimpl(textUndoOperation.getPostSelection())), Integer.valueOf(TextRange.m5783getEndimpl(textUndoOperation.getPostSelection())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m5782getCollapsedimpl(this.postSelection)) {
            if (TextRange.m5782getCollapsedimpl(this.preSelection)) {
                if (TextRange.m5788getStartimpl(this.preSelection) > TextRange.m5788getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m5788getStartimpl(this.preSelection) == TextRange.m5788getStartimpl(this.postSelection) && TextRange.m5788getStartimpl(this.preSelection) == this.index) {
