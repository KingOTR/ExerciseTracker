...
public final class LegacyTextInputMethodRequest implements PlatformTextInputMethodRequest {
    ...
    private Function1<? super ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest$onImeActionPerformed$1
        ...
        public final void m1177invokeKlQnJC8(int i) {
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
            m1177invokeKlQnJC8(imeAction.getValue());
            return Unit.INSTANCE;
        }
    };
    private TextFieldValue state = new TextFieldValue("", TextRange.INSTANCE.m5793getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public RecordingInputConnection createInputConnection(EditorInfo outAttributes) {
        EditorInfo_androidKt.m1149updatepLxbY9I$default(outAttributes, this.state.getText(), this.state.getSelection(), this.imeOptions, null, 8, null);
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(textFieldValue, new InputEventCallback2() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest$createInputConnection$1
            ...
            public void mo1176onImeActionKlQnJC8(int imeAction) {
                Function1 function1;
                function1 = LegacyTextInputMethodRequest.this.onImeActionPerformed;
                function1.invoke(ImeAction.m5950boximpl(imeAction));
            }
    ...
    public final void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        boolean z = (TextRange.m5781equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (z) {
                ...
                int m5786getMinimpl = TextRange.m5786getMinimpl(newValue.getSelection());
                int m5785getMaximpl = TextRange.m5785getMaximpl(newValue.getSelection());
                TextRange composition = this.state.getComposition();
                int m5786getMinimpl2 = composition != null ? TextRange.m5786getMinimpl(composition.getPackedValue()) : -1;
                TextRange composition2 = this.state.getComposition();
                inputMethodManager.updateSelection(m5786getMinimpl, m5785getMaximpl, m5786getMinimpl2, composition2 != null ? TextRange.m5785getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m5781equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
