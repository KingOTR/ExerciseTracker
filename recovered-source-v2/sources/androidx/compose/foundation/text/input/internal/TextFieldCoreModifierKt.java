...
public final class TextFieldCoreModifierKt {
    ...
    public static final Rect getCursorRectInScroller(Density density, Rect rect, boolean z, int i) {
        float left;
        float left2;
        int mo370roundToPx0680j_4 = density.mo370roundToPx0680j_4(DefaultCursorThickness);
        if (z) {
        ...
        return Rect.copy$default(rect, f, 0.0f, left2 + mo370roundToPx0680j_4, 0.0f, 10, null);
    }
