...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1137onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m5782getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m999cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean mo1136onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        TextRange m5776boximpl;
        Integer m998consumeZmokQxo;
        boolean z = false;
        if (!KeyEventType.m4901equalsimpl0(KeyEvent_androidKt.m4909getTypeZmokQxo(event), KeyEventType.INSTANCE.m4905getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1082isTypedEventZmokQxo(event) && (m998consumeZmokQxo = this.deadKeyCombiner.m998consumeZmokQxo(event)) != null) {
            String sb = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), m998consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            boolean z2 = !TextFieldKeyEventHandler_androidKt.m1208isFromSoftKeyboardZmokQxo(event);
        ...
        KeyCommand mo1000mapZmokQxo = this.keyMapping.mo1000mapZmokQxo(event);
        if (mo1000mapZmokQxo != null && (!mo1000mapZmokQxo.getEditsText() || editable)) {
            TextFieldPreparedSelection textFieldPreparedSelection = new TextFieldPreparedSelection(textFieldState, textLayoutState.getLayoutResult(), TextFieldKeyEventHandler_androidKt.m1208isFromSoftKeyboardZmokQxo(event), getVisibleTextLayoutHeight(textLayoutState), this.preparedSelectionState);
            switch (WhenMappings.$EnumSwitchMapping$0[mo1000mapZmokQxo.ordinal()]) {
                case 1:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    if (TextRange.m5782getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        Integer valueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                        if (valueOf.intValue() == -1) {
                            valueOf = null;
                        }
                        m5776boximpl = valueOf != null ? TextRange.m5776boximpl(TextRangeKt.TextRange(valueOf.intValue(), TextRange.m5783getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                        if (m5776boximpl != null) {
                            TransformedTextFieldState.m1229replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", m5776boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                        TransformedTextFieldState.m1229replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 21:
                    if (TextRange.m5782getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        m5776boximpl = valueOf2 != null ? TextRange.m5776boximpl(TextRangeKt.TextRange(TextRange.m5788getStartimpl(textFieldPreparedSelection.getSelection()), valueOf2.intValue())) : null;
                        if (m5776boximpl != null) {
                            TransformedTextFieldState.m1229replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", m5776boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 22:
                    if (!TextRange.m5782getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1229replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m5783getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 23:
                    if (!TextRange.m5782getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1229replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5788getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 24:
                    if (!TextRange.m5782getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1229replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m5783getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 25:
                    if (!TextRange.m5782getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1229replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5788getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 26:
            ...
            if (!TextRange.m5781equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
                textFieldState.m1236selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
            }
        }
        return z;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, boolean isFromSoftKeyboard, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        state.m1236selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }
    ...
    private final float getVisibleTextLayoutHeight(TextLayoutState textLayoutState) {
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                ...
                if (rect != null) {
                    return Size.m3668getHeightimpl(rect.m3635getSizeNHjbRc());
                }
            }
        }
        return Float.NaN;
