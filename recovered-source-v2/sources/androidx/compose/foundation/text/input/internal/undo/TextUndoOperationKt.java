...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m5788getStartimpl(textUndoOperation.getPreSelection()), TextRange.m5783getEndimpl(textUndoOperation.getPreSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1145getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1144getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m5788getStartimpl(textUndoOperation.getPostSelection()), TextRange.m5783getEndimpl(textUndoOperation.getPostSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1145getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1144getCompositionMzsxiRA(), null, 8, null), true);
    }
}
