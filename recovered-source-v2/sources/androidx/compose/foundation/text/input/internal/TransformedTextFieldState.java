...
public final class TransformedTextFieldState {
    ...
    private static final long m1227mapFromTransformedxdX6G0(long j, OffsetMappingCalculator offsetMappingCalculator) {
        return Companion.m1240mapFromTransformedxdX6G0(j, offsetMappingCalculator);
    }

    @JvmStatic
    /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
    private static final long m1228mapToTransformedXGyztTk(long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity) {
        return Companion.m1241mapToTransformedXGyztTk(j, offsetMappingCalculator, selectionWedgeAffinity);
    }
    ...
    public final void placeCursorBeforeCharAt(int transformedOffset) {
        m1236selectCharsIn5zctL8(TextRangeKt.TextRange(transformedOffset));
    }

    /* renamed from: selectCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1236selectCharsIn5zctL8(long transformedRange) {
        m1237selectUntransformedCharsIn5zctL8(m1232mapFromTransformedGEjPoXI(transformedRange));
    }

    /* renamed from: selectUntransformedCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1237selectUntransformedCharsIn5zctL8(long untransformedRange) {
        ...
        textFieldState.getMainBuffer().setSelection(TextRange.m5788getStartimpl(untransformedRange), TextRange.m5783getEndimpl(untransformedRange));
    ...
    public final void m1230highlightCharsIn7RAjNK8(int type, long transformedRange) {
        long m1232mapFromTransformedGEjPoXI = m1232mapFromTransformedGEjPoXI(transformedRange);
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        TextFieldEditUndoBehavior textFieldEditUndoBehavior = TextFieldEditUndoBehavior.MergeIfPossible;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        textFieldState.getMainBuffer().m1146setHighlightK7f2yys(type, TextRange.m5788getStartimpl(m1232mapFromTransformedGEjPoXI), TextRange.m5783getEndimpl(m1232mapFromTransformedGEjPoXI));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void deleteSelectedText() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.delete(TextRange.m5786getMinimpl(mainBuffer.m1145getSelectiond9O1mEE()), TextRange.m5785getMaximpl(mainBuffer.m1145getSelectiond9O1mEE()));
        mainBuffer.setSelection(TextRange.m5786getMinimpl(mainBuffer.m1145getSelectiond9O1mEE()), TextRange.m5786getMinimpl(mainBuffer.m1145getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }

    /* renamed from: replaceText-M8tDOmk$default, reason: not valid java name */
    public static /* synthetic */ void m1229replaceTextM8tDOmk$default(TransformedTextFieldState transformedTextFieldState, CharSequence charSequence, long j, TextFieldEditUndoBehavior textFieldEditUndoBehavior, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        transformedTextFieldState.m1235replaceTextM8tDOmk(charSequence, j, textFieldEditUndoBehavior2, z);
    }

    /* renamed from: replaceText-M8tDOmk, reason: not valid java name */
    public final void m1235replaceTextM8tDOmk(CharSequence newText, long range, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        long m1232mapFromTransformedGEjPoXI = m1232mapFromTransformedGEjPoXI(range);
        mainBuffer.replace(TextRange.m5786getMinimpl(m1232mapFromTransformedGEjPoXI), TextRange.m5785getMaximpl(m1232mapFromTransformedGEjPoXI), newText);
        int m5786getMinimpl = TextRange.m5786getMinimpl(m1232mapFromTransformedGEjPoXI) + newText.length();
        mainBuffer.setSelection(m5786getMinimpl, m5786getMinimpl);
    ...
    public final void replaceSelectedText(CharSequence newText, boolean clearComposition, TextFieldEditUndoBehavior undoBehavior) {
        ...
        long m1145getSelectiond9O1mEE = mainBuffer.m1145getSelectiond9O1mEE();
        mainBuffer.replace(TextRange.m5786getMinimpl(m1145getSelectiond9O1mEE), TextRange.m5785getMaximpl(m1145getSelectiond9O1mEE), newText);
        int m5786getMinimpl = TextRange.m5786getMinimpl(m1145getSelectiond9O1mEE) + newText.length();
        mainBuffer.setSelection(m5786getMinimpl, m5786getMinimpl);
    ...
    public final void collapseSelectionToMax() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m5785getMaximpl(mainBuffer.m1145getSelectiond9O1mEE()), TextRange.m5785getMaximpl(mainBuffer.m1145getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void collapseSelectionToEnd() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m5783getEndimpl(mainBuffer.m1145getSelectiond9O1mEE()), TextRange.m5783getEndimpl(mainBuffer.m1145getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final long m1233mapToTransformedjx7JFs(int offset) {
        long TextRange;
        TransformedText value;
        ...
        if (offsetMapping != null) {
            TextRange = offsetMapping.m1183mapFromSourcejx7JFs(offset);
        } else {
            TextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMappingCalculator != null ? Companion.m1241mapToTransformedXGyztTk(TextRange, offsetMappingCalculator, getSelectionWedgeAffinity()) : TextRange;
    }

    /* renamed from: mapToTransformed-GEjPoXI, reason: not valid java name */
    public final long m1234mapToTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMappingCalculator = null;
        ...
        if (offsetMapping != null) {
            range = Companion.m1242mapToTransformedXGyztTk$default(Companion, range, offsetMapping, null, 4, null);
        }
        return offsetMappingCalculator != null ? Companion.m1241mapToTransformedXGyztTk(range, offsetMappingCalculator, getSelectionWedgeAffinity()) : range;
    }

    /* renamed from: mapFromTransformed--jx7JFs, reason: not valid java name */
    public final long m1231mapFromTransformedjx7JFs(int offset) {
        long TextRange;
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        ...
        if (offsetMappingCalculator != null) {
            TextRange = offsetMappingCalculator.m1182mapFromDestjx7JFs(offset);
        } else {
            TextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping != null ? Companion.m1240mapFromTransformedxdX6G0(TextRange, offsetMapping) : TextRange;
    }

    /* renamed from: mapFromTransformed-GEjPoXI, reason: not valid java name */
    public final long m1232mapFromTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMappingCalculator = null;
        ...
        if (offsetMappingCalculator != null) {
            range = Companion.m1240mapFromTransformedxdX6G0(range, offsetMappingCalculator);
        }
        return offsetMapping != null ? Companion.m1240mapFromTransformedxdX6G0(range, offsetMapping) : range;
    }
    ...
    */
    ...
    static final class Companion {
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, OutputTransformation outputTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            long m1241mapToTransformedXGyztTk = m1241mapToTransformedXGyztTk(untransformedValue.getSelection(), offsetMappingCalculator, wedgeAffinity);
            TextRange composition = untransformedValue.getComposition();
            if (composition != null) {
                textRange = TextRange.m5776boximpl(TransformedTextFieldState.Companion.m1241mapToTransformedXGyztTk(composition.getPackedValue(), offsetMappingCalculator, wedgeAffinity));
            }
            return new TransformedText(textFieldBuffer.m1107toTextFieldCharSequenceudt6zUU$foundation_release(m1241mapToTransformedXGyztTk, textRange), offsetMappingCalculator);
        }
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, CodepointTransformation codepointTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            return new TransformedText(new TextFieldCharSequence(visualText, m1241mapToTransformedXGyztTk, textRange, null, 8, null), offsetMappingCalculator);
        }

        /* renamed from: mapToTransformed-XGyztTk$default, reason: not valid java name */
        static /* synthetic */ long m1242mapToTransformedXGyztTk$default(Companion companion, long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity, int i, Object obj) {
            if ((i & 4) != 0) {
        ...
        @JvmStatic
        /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
        public final long m1241mapToTransformedXGyztTk(long range, OffsetMappingCalculator mapping, SelectionWedgeAffinity wedgeAffinity) {
            long TextRange;
            long m1183mapFromSourcejx7JFs = mapping.m1183mapFromSourcejx7JFs(TextRange.m5788getStartimpl(range));
            long m1183mapFromSourcejx7JFs2 = TextRange.m5782getCollapsedimpl(range) ? m1183mapFromSourcejx7JFs : mapping.m1183mapFromSourcejx7JFs(TextRange.m5783getEndimpl(range));
            int min = Math.min(TextRange.m5786getMinimpl(m1183mapFromSourcejx7JFs), TextRange.m5786getMinimpl(m1183mapFromSourcejx7JFs2));
            int max = Math.max(TextRange.m5785getMaximpl(m1183mapFromSourcejx7JFs), TextRange.m5785getMaximpl(m1183mapFromSourcejx7JFs2));
            if (TextRange.m5787getReversedimpl(range)) {
                TextRange = TextRangeKt.TextRange(max, min);
            } else {
                TextRange = TextRangeKt.TextRange(min, max);
            }
            if (!TextRange.m5782getCollapsedimpl(range) || TextRange.m5782getCollapsedimpl(TextRange)) {
                return TextRange;
            }
            ...
            if (i == 1) {
                return TextRangeKt.TextRange(TextRange.m5788getStartimpl(TextRange));
            }
            if (i == 2) {
                return TextRangeKt.TextRange(TextRange.m5783getEndimpl(TextRange));
            }
        ...
        @JvmStatic
        /* renamed from: mapFromTransformed-xdX6-G0, reason: not valid java name */
        public final long m1240mapFromTransformedxdX6G0(long range, OffsetMappingCalculator mapping) {
            long m1182mapFromDestjx7JFs = mapping.m1182mapFromDestjx7JFs(TextRange.m5788getStartimpl(range));
            long m1182mapFromDestjx7JFs2 = TextRange.m5782getCollapsedimpl(range) ? m1182mapFromDestjx7JFs : mapping.m1182mapFromDestjx7JFs(TextRange.m5783getEndimpl(range));
            int min = Math.min(TextRange.m5786getMinimpl(m1182mapFromDestjx7JFs), TextRange.m5786getMinimpl(m1182mapFromDestjx7JFs2));
            int max = Math.max(TextRange.m5785getMaximpl(m1182mapFromDestjx7JFs), TextRange.m5785getMaximpl(m1182mapFromDestjx7JFs2));
            if (TextRange.m5787getReversedimpl(range)) {
