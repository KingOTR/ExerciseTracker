...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int m5786getMinimpl = TextRange.m5786getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(m5786getMinimpl, TextRange.m5785getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, m5786getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int m5785getMaximpl = composition2 != null ? TextRange.m5785getMaximpl(composition2.getPackedValue()) : -1;
            if (m5786getMinimpl2 >= 0 && m5786getMinimpl2 < m5785getMaximpl) {
                builder.setComposingText(m5786getMinimpl2, textFieldValue.getText().subSequence(m5786getMinimpl2, m5785getMaximpl));
                addCharacterBounds(builder, m5786getMinimpl2, m5785getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder builder, int i, int i2, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        textLayoutResult.getMultiParagraph().m5653fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(originalToTransformed, originalToTransformed2), fArr, 0);
        while (i4 < i2) {
