...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int m5786getMinimpl = composition != null ? TextRange.m5786getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m5786getMinimpl(state.getSelection()), TextRange.m5785getMaximpl(state.getSelection()), m5786getMinimpl, composition2 != null ? TextRange.m5785getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5782getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m5786getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int m5966getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            m5966getDefaulteUduSuo = ImeAction.INSTANCE.m5966getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    m5966getDefaulteUduSuo = ImeAction.INSTANCE.m5968getGoeUduSuo();
                    break;
                case 3:
                    m5966getDefaulteUduSuo = ImeAction.INSTANCE.m5972getSearcheUduSuo();
                    break;
                case 4:
                    m5966getDefaulteUduSuo = ImeAction.INSTANCE.m5973getSendeUduSuo();
                    break;
                case 5:
                    m5966getDefaulteUduSuo = ImeAction.INSTANCE.m5969getNexteUduSuo();
                    break;
                case 6:
                    m5966getDefaulteUduSuo = ImeAction.INSTANCE.m5967getDoneeUduSuo();
                    break;
                case 7:
                    m5966getDefaulteUduSuo = ImeAction.INSTANCE.m5971getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo1176onImeActionKlQnJC8(m5966getDefaulteUduSuo);
        return true;
    }
