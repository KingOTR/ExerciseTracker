...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m5786getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m5785getMaximpl(textFieldCharSequence.getSelection());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat inputContentInfoCompat, Bundle bundle) {
        ...
        int m341getKeyboardkB6V9T0 = TransferableContent.Source.INSTANCE.m341getKeyboardkB6V9T0();
        ...
        return new TransferableContent(clipEntry, clipMetadata, m341getKeyboardkB6V9T0, new PlatformTransferableContent(linkUri, bundle), null);
    }
}
