...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString annotatedString, long j) {
        ...
        this.selectionStart = TextRange.m5788getStartimpl(j);
        this.selectionEnd = TextRange.m5783getEndimpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        checkRange(TextRange.m5788getStartimpl(j), TextRange.m5783getEndimpl(j));
    }
    ...
    public final TextRange m1144getCompositionMzsxiRA() {
        if (hasComposition()) {
            return TextRange.m5776boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE, reason: not valid java name */
    public final long m1145getSelectiond9O1mEE() {
    ...
    public final void delete(int start, int end) {
        ...
        PartialGapBuffer.replace$default(this.gapBuffer, TextRange.m5786getMinimpl(TextRange), TextRange.m5785getMaximpl(TextRange), "", 0, 0, 24, null);
        long m1147updateRangeAfterDeletepWDy79M = EditingBufferKt.m1147updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m5788getStartimpl(m1147updateRangeAfterDeletepWDy79M));
        setSelectionEnd(TextRange.m5783getEndimpl(m1147updateRangeAfterDeletepWDy79M));
        if (hasComposition()) {
            long m1147updateRangeAfterDeletepWDy79M2 = EditingBufferKt.m1147updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m5782getCollapsedimpl(m1147updateRangeAfterDeletepWDy79M2)) {
                commitComposition();
            } else {
                this.compositionStart = TextRange.m5786getMinimpl(m1147updateRangeAfterDeletepWDy79M2);
                this.compositionEnd = TextRange.m5785getMaximpl(m1147updateRangeAfterDeletepWDy79M2);
            }
        }
        this.highlight = null;
    }
    ...
    public final void m1146setHighlightK7f2yys(int type, int start, int end) {
        if (start >= end) {
            throw new IllegalArgumentException("Do not set reversed or empty range: " + start + " > " + end);
        }
        this.highlight = new Pair<>(TextHighlightType.m1116boximpl(type), TextRange.m5776boximpl(TextRangeKt.TextRange(RangesKt.coerceIn(start, 0, getLength()), RangesKt.coerceIn(end, 0, getLength()))));
    }
