...
public final class TextPreparedSelectionKt {
    ...
    public static final int calculateAdjacentCursorPosition(String str, int i, boolean z, TransformedTextFieldState transformedTextFieldState) {
        ...
        long m1231mapFromTransformedjx7JFs = transformedTextFieldState.m1231mapFromTransformedjx7JFs(findPrecedingBreak);
        ...
        if (i2 == 3) {
            return z ? TextRange.m5783getEndimpl(m1234mapToTransformedGEjPoXI) : TextRange.m5788getStartimpl(m1234mapToTransformedGEjPoXI);
        }
        if (i2 != 4) {
            throw new NoWhenBranchMatchedException();
        }
        if (z) {
            if (findPrecedingBreak == TextRange.m5788getStartimpl(m1234mapToTransformedGEjPoXI)) {
        ...
        if (findPrecedingBreak == TextRange.m5783getEndimpl(m1234mapToTransformedGEjPoXI)) {
            transformedTextFieldState.setSelectionWedgeAffinity(new SelectionWedgeAffinity(WedgeAffinity.End));
            return findPrecedingBreak;
        }
        transformedTextFieldState.setSelectionWedgeAffinity(new SelectionWedgeAffinity(WedgeAffinity.Start));
