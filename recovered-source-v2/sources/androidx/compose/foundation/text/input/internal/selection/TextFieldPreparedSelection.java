...
public final class TextFieldPreparedSelection {
    ...
    public final void m1258setSelection5zctL8(long j) {
        this.selection = j;
    }

    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        if (!TextRange.m5782getCollapsedimpl(getSelection())) {
            TransformedTextFieldState.m1229replaceTextM8tDOmk$default(this.state, "", getSelection(), null, !this.isFromSoftKeyboard, 4, null);
            return;
        }
        TextRange invoke = block.invoke();
        if (invoke != null) {
            TransformedTextFieldState.m1229replaceTextM8tDOmk$default(this.state, "", invoke.getPackedValue(), null, !this.isFromSoftKeyboard, 4, null);
        }
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        int m5783getEndimpl = TextRange.m5783getEndimpl(this.initialValue.getSelection());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return m5783getEndimpl;
        }
        Rect translate = this.textLayoutResult.getCursorRect(m5783getEndimpl).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(translate.getTop() - lineBottom) > Math.abs(translate.getBottom() - lineBottom)) {
            return this.textLayoutResult.m5760getOffsetForPositionk4lQ0M(translate.m3637getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m5760getOffsetForPositionk4lQ0M(translate.m3630getBottomLeftF1C5BW0());
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m5783getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m5783getEndimpl(this.selection));
    }
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.m5783getEndimpl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5783getEndimpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long m5762getWordBoundaryjx7JFs = textLayoutResult.m5762getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m5783getEndimpl(m5762getWordBoundaryjx7JFs) > i) {
                return TextRange.m5783getEndimpl(m5762getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long m5762getWordBoundaryjx7JFs = textLayoutResult.m5762getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m5788getStartimpl(m5762getWordBoundaryjx7JFs) < i) {
                return TextRange.m5788getStartimpl(m5762getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5786getMinimpl(textFieldPreparedSelection.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5785getMaximpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int m5783getEndimpl = TextRange.m5783getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(m5783getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(m5783getEndimpl) + i;
        if (lineForOffset < 0) {
            return 0;
        }
        ...
        return textLayoutResult.m5760getOffsetForPositionk4lQ0M(OffsetKt.Offset(cachedX, lineBottom));
    }
    ...
    public final TextFieldPreparedSelection deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            setCursor(TextRange.m5783getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseLeftOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m5782getCollapsedimpl(this.selection)) {
                or.invoke(this);
            } else if (isLtr()) {
                setCursor(TextRange.m5786getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m5785getMaximpl(this.selection));
            }
        }
        return this;
    }
    ...
    private final TextFieldPreparedSelection moveCursorPrev() {
        ...
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (calculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (m5783getEndimpl = TextRange.m5783getEndimpl(this.selection)), false, this.state)) != m5783getEndimpl) {
    ...
    private final TextFieldPreparedSelection moveCursorNext() {
        ...
        int calculateAdjacentCursorPosition;
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (calculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (m5783getEndimpl = TextRange.m5783getEndimpl(this.selection)), true, this.state)) != m5783getEndimpl) {
            setCursor(calculateAdjacentCursorPosition);
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection moveCursorPrevByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int findParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m5786getMinimpl(this.selection));
            if (findParagraphStart == TextRange.m5786getMinimpl(this.selection) && findParagraphStart != 0) {
    ...
    public final TextFieldPreparedSelection moveCursorNextByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int findParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m5785getMaximpl(this.selection));
            if (findParagraphEnd == TextRange.m5785getMaximpl(this.selection) && findParagraphEnd != this.text.length()) {
    ...
    public final TextFieldPreparedSelection selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m5788getStartimpl(this.initialValue.getSelection()), TextRange.m5783getEndimpl(this.selection));
        }
        return this;
    }
}
