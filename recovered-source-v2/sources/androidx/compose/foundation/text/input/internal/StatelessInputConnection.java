...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        String obj = TextRange.m5782getCollapsedimpl(getText().getSelection()) ? null : TextFieldCharSequenceKt.getSelectedText(getText()).toString();
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m5786getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1139onImeActionKlQnJC8(m5966getDefaulteUduSuo);
        return true;
    }
