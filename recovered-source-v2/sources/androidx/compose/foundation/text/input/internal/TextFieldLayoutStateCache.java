...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final TextLayoutResult m1210layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        ...
        if (!Intrinsics.areEqual(computeLayout, layoutResult)) {
            ...
            if (!current.getReadOnly()) {
                ...
                synchronized (SnapshotKt.getLock()) {
                    ...
                    cacheRecord3.m1213setCompositionOEnZFl4(visualText2.getComposition());
                    ...
                    cacheRecord3.m1214setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    private static final class CacheRecord extends StateRecord {
        ...
        public final void m1213setCompositionOEnZFl4(TextRange textRange) {
        ...
        public final void m1214setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a, TextFieldLayoutStateCache.MeasureInputs b) {
                ...
                } else if (a.getDensityValue() == b.getDensityValue() && a.getFontScale() == b.getFontScale() && a.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m6249equalsimpl0(a.getConstraints(), b.getConstraints())) {
                    return true;
                }
                return false;
            }
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m6261toStringimpl(this.constraints)) + ')';
        }
