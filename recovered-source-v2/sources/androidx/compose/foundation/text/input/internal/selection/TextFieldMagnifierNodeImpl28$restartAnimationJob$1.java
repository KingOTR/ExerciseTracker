        ...
        if (i == 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m3591boximpl(m1255invokeF1C5BW0());
                }

                /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m1255invokeF1C5BW0() {
                    boolean z;
                    TransformedTextFieldState transformedTextFieldState;
                    TextFieldSelectionState textFieldSelectionState;
                    TextLayoutState textLayoutState;
                    long m1251getMagnifierSizeYbymL2g;
                    ...
                    m1251getMagnifierSizeYbymL2g = TextFieldMagnifierNodeImpl28.this.m1251getMagnifierSizeYbymL2g();
                    return TextFieldMagnifierKt.m1248calculateSelectionMagnifierCenterAndroidhUlJWOE(transformedTextFieldState, textFieldSelectionState, textLayoutState, m1251getMagnifierSizeYbymL2g);
                }
            });
            ...
            if (snapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return m1256emit3MmeM6k(((Offset) obj2).getPackedValue(), continuation);
                }

                /* renamed from: emit-3MmeM6k, reason: not valid java name */
                public final Object m1256emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    Animatable animatable;
                    Animatable animatable2;
                    Animatable animatable3;
                    animatable = TextFieldMagnifierNodeImpl28.this.animatable;
                    if (OffsetKt.m3621isSpecifiedk4lQ0M(((Offset) animatable.getValue()).getPackedValue()) && OffsetKt.m3621isSpecifiedk4lQ0M(j)) {
                        animatable3 = TextFieldMagnifierNodeImpl28.this.animatable;
                        if (Offset.m3603getYimpl(((Offset) animatable3.getValue()).getPackedValue()) != Offset.m3603getYimpl(j)) {
                    ...
                    Object snapTo = animatable2.snapTo(Offset.m3591boximpl(j), continuation);
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            this.label = 1;
                            if (Animatable.animateTo$default(animatable, Offset.m3591boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
