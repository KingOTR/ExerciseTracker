...
public final class TextLayoutState {
    ...
    public TextLayoutState() {
        ...
        this.minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6301boximpl(Dp.m6303constructorimpl(0)), null, 2, null);
    ...
    public final float m1218getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m6317unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1222setMinHeightForSingleLineField0680j_4(float f) {
    ...
    public final TextLayoutResult m1221layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult m1210layoutWithNewMeasureInputshBUhpc = this.layoutCache.m1210layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
        ...
        return m1210layoutWithNewMeasureInputshBUhpc;
    }

    /* renamed from: getOffsetForPosition-3MmeM6k$default, reason: not valid java name */
    public static /* synthetic */ int m1216getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1219getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1219getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return -1;
        }
        if (coerceInVisibleBounds) {
            position = m1217coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(position);
        }
        return layoutResult.m5760getOffsetForPositionk4lQ0M(TextLayoutStateKt.m1224fromDecorationToTextLayoutUv8p0NA(this, position));
    }

    /* renamed from: isPositionOnText-k-4lQ0M, reason: not valid java name */
    public final boolean m1220isPositionOnTextk4lQ0M(long offset) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long m1224fromDecorationToTextLayoutUv8p0NA = TextLayoutStateKt.m1224fromDecorationToTextLayoutUv8p0NA(this, m1217coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(offset));
        int lineForVerticalPosition = layoutResult.getLineForVerticalPosition(Offset.m3603getYimpl(m1224fromDecorationToTextLayoutUv8p0NA));
        return Offset.m3602getXimpl(m1224fromDecorationToTextLayoutUv8p0NA) >= layoutResult.getLineLeft(lineForVerticalPosition) && Offset.m3602getXimpl(m1224fromDecorationToTextLayoutUv8p0NA) <= layoutResult.getLineRight(lineForVerticalPosition);
    }
    ...
    */
    public final long m1217coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long offset) {
        Rect zero;
        ...
        zero = Rect.INSTANCE.getZero();
        return TextLayoutStateKt.m1223coerceIn3MmeM6k(offset, zero);
    }
}
