...
public final class OffsetMappingCalculator {
    ...
    private int[] ops = OpArray.m1185constructorimpl(10);
    private int opsSize;
    ...
    public final void recordEditOperation(int sourceStart, int sourceEnd, int newLength) {
        ...
        if (max >= 2 || max != newLength) {
            ...
            if (i > OpArray.m1192getSizeimpl(this.ops)) {
                this.ops = OpArray.m1187copyOfpSmdads(this.ops, Math.max(i * 2, OpArray.m1192getSizeimpl(this.ops) * 2));
            }
            OpArray.m1194setimpl(this.ops, this.opsSize, min, max, newLength);
            this.opsSize = i;
        }
    }

    /* renamed from: mapFromSource--jx7JFs, reason: not valid java name */
    public final long m1183mapFromSourcejx7JFs(int offset) {
        return m1180mapfzxv0v0(offset, true);
    }

    /* renamed from: mapFromDest--jx7JFs, reason: not valid java name */
    public final long m1182mapFromDestjx7JFs(int offset) {
        return m1180mapfzxv0v0(offset, false);
    }

    /* renamed from: map-fzxv0v0, reason: not valid java name */
    private final long m1180mapfzxv0v0(int offset, boolean fromSource) {
        int i;
        int[] iArr = this.ops;
        int i2 = this.opsSize;
        if (i2 < 0) {
            ...
            while (i3 < i2) {
                ...
                int i7 = iArr[i5 + 1];
                int i8 = iArr[i5 + 2];
                long m1181mapStepC6uMEY = m1181mapStepC6uMEY(i4, i6, i7, i8, fromSource);
                long m1181mapStepC6uMEY2 = m1181mapStepC6uMEY(offset, i6, i7, i8, fromSource);
                i3++;
                i4 = Math.min(TextRange.m5788getStartimpl(m1181mapStepC6uMEY), TextRange.m5788getStartimpl(m1181mapStepC6uMEY2));
                offset = Math.max(TextRange.m5783getEndimpl(m1181mapStepC6uMEY), TextRange.m5783getEndimpl(m1181mapStepC6uMEY2));
            }
            i = offset;
            offset = i4;
        } else {
            ...
            while (-1 < i9) {
                ...
                int i13 = iArr[i11 + 1];
                int i14 = iArr[i11 + 2];
                long m1181mapStepC6uMEY3 = m1181mapStepC6uMEY(i10, i12, i13, i14, fromSource);
                long m1181mapStepC6uMEY4 = m1181mapStepC6uMEY(offset, i12, i13, i14, fromSource);
                i9--;
                i10 = Math.min(TextRange.m5788getStartimpl(m1181mapStepC6uMEY3), TextRange.m5788getStartimpl(m1181mapStepC6uMEY4));
                offset = Math.max(TextRange.m5783getEndimpl(m1181mapStepC6uMEY3), TextRange.m5783getEndimpl(m1181mapStepC6uMEY4));
            }
            i = offset;
            offset = i10;
        }
    ...
    private final long m1181mapStepC6uMEY(int offset, int opOffset, int untransformedLen, int transformedLen, boolean fromSource) {
