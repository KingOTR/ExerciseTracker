...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, final KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean z3, MutableInteractionSource mutableInteractionSource) {
        ...
        this.stylusHandwritingNode = (StylusHandwritingNode) delegate(new StylusHandwritingNode(new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$stylusHandwritingNode$1
            ...
            /* JADX WARN: Code restructure failed: missing block: B:8:0x0033, code lost:
                ...
                r2 = r2.this$0.getStylusHandwritingTrigger();
             */
            ...
            */
            public final Boolean invoke() {
                ...
                if (!KeyboardType.m6006equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6025getPasswordPjHm6EE()) && !KeyboardType.m6006equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6024getNumberPasswordPjHm6EE()) && stylusHandwritingTrigger != null) {
        ...
        textFieldDragAndDropNode = TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
            ...
            public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
                ...
                if (receiveContentConfiguration != null) {
                    TransferableContent onReceive = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m340getDragAndDropkB6V9T0(), null, 8, null));
            ...
            public final void m1205invokek4lQ0M(long j) {
                long m1226fromWindowToDecorationUv8p0NA = TextLayoutStateKt.m1226fromWindowToDecorationUv8p0NA(TextFieldDecoratorModifierNode.this.getTextLayoutState(), j);
                TextFieldDecoratorModifierNode.this.getTextFieldState().m1236selectCharsIn5zctL8(TextRangeKt.TextRange(TextLayoutState.m1216getOffsetForPosition3MmeM6k$default(TextFieldDecoratorModifierNode.this.getTextLayoutState(), m1226fromWindowToDecorationUv8p0NA, false, 2, null)));
                TextFieldDecoratorModifierNode.this.getTextFieldSelectionState().m1273updateHandleDraggingUv8p0NA(Handle.Cursor, m1226fromWindowToDecorationUv8p0NA);
            }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m5618setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$applySemantics$4
            ...
            public final Boolean invoke(int i, int i2, boolean z) {
                ...
                if (i == TextRange.m5788getStartimpl(selection2) && i2 == TextRange.m5783getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (z) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1237selectUntransformedCharsIn5zctL8(TextRange);
                } else {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1236selectCharsIn5zctL8(TextRange);
                }
                return true;
            }
        }, 1, null);
        final int m1015getImeActionOrDefaulteUduSuo$foundation_release = this.keyboardOptions.m1015getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m5613onImeAction9UiTYpY$default(semanticsPropertyReceiver, m1015getImeActionOrDefaulteUduSuo$foundation_release, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$applySemantics$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1204onImeActionPerformedKlQnJC8(m1015getImeActionOrDefaulteUduSuo$foundation_release);
                return true;
            }
        }, 2, null);
    ...
    public void mo212onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.stylusHandwritingNode.mo212onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputNode.mo212onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo213onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1137onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* renamed from: onKeyEvent-ZmokQxo */
    public boolean mo211onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1136onKeyEvent6ptp14s(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = TextFieldDecoratorModifierNode.this;
                textFieldDecoratorModifierNode.m1204onImeActionPerformedKlQnJC8(textFieldDecoratorModifierNode.getKeyboardOptions().m1015getImeActionOrDefaulteUduSuo$foundation_release());
            }
        });
    }
    ...
    public final void m1204onImeActionPerformedKlQnJC8(final int imeAction) {
        KeyboardActionHandler keyboardActionHandler;
        if (ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5970getNoneeUduSuo()) || ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5966getDefaulteUduSuo()) || (keyboardActionHandler = this.keyboardActionHandler) == null) {
            this.keyboardActionScope.mo1001defaultKeyboardActionKlQnJC8(imeAction);
            ...
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                public final void invoke2() {
                    ...
                    textFieldDecoratorModifierNode$keyboardActionScope$1.mo1001defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
