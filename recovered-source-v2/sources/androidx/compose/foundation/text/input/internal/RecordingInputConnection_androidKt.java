...
public final class RecordingInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m5786getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m5785getMaximpl(textFieldValue.getSelection());
