...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1108getOriginalRangejx7JFs(int changeIndex);

        /* renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1109getRangejx7JFs(int changeIndex);
    }
    ...
    public final long m1104getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m5782getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1106setSelection5zctL8(long j) {
        m1102requireValidRange5zctL8(j);
    ...
    */
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        int m5786getMinimpl = TextRange.m5786getMinimpl(getSelectionInChars());
        int m5785getMaximpl = TextRange.m5785getMaximpl(getSelectionInChars());
        if (m5785getMaximpl < min) {
            return;
        }
        if (m5786getMinimpl > min || max > m5785getMaximpl) {
            if (m5786getMinimpl > min && m5785getMaximpl < max) {
                min += newLength;
                m5786getMinimpl = min;
            } else if (m5786getMinimpl >= max) {
                i = newLength - (max - min);
                m5786getMinimpl += i;
                min = m5785getMaximpl + i;
            } else if (min < m5786getMinimpl) {
                m5786getMinimpl = min + newLength;
                i = newLength - (max - min);
                min = m5785getMaximpl + i;
            }
            this.selectionInChars = TextRangeKt.TextRange(m5786getMinimpl, min);
            return;
        }
        i = newLength - (max - min);
    }
    ...
    public final void revertAllChanges() {
        ...
        m1106setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1103toTextFieldCharSequenceudt6zUU$foundation_release$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldBuffer.m1107toTextFieldCharSequenceudt6zUU$foundation_release(j, textRange);
    }

    /* renamed from: toTextFieldCharSequence-udt6zUU$foundation_release, reason: not valid java name */
    public final TextFieldCharSequence m1107toTextFieldCharSequenceudt6zUU$foundation_release(long selection, TextRange composition) {
    ...
    private final void m1102requireValidRange5zctL8(long range) {
        long TextRange = TextRangeKt.TextRange(0, getLength());
        if (!TextRange.m5778contains5zctL8(TextRange, range)) {
            throw new IllegalArgumentException(("Expected " + ((Object) TextRange.m5791toStringimpl(range)) + " to be in " + ((Object) TextRange.m5791toStringimpl(TextRange))).toString());
        }
    }
}
