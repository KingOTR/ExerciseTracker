...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(str, TextRangeKt.m5794coerceIn8ffj60Q(j, 0, str.length()), (DefaultConstructorMarker) null);
    ...
    */
    ...
    public final long m1113getSelectiond9O1mEE() {
        return getValue$foundation_release().getSelection();
    }

    /* renamed from: getComposition-MzsxiRA, reason: not valid java name */
    public final TextRange m1112getCompositionMzsxiRA() {
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m5791toStringimpl(m1113getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean m5781equalsimpl0 = true ^ TextRange.m5781equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1145getSelectiond9O1mEE());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        m1114syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, z, m5781equalsimpl0);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super EditingBuffer, Unit> block) {
        getMainBuffer().getChangeTracker().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(getMainBuffer().toString(), getMainBuffer().m1145getSelectiond9O1mEE(), getMainBuffer().m1144getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m5781equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.m1145getSelectiond9O1mEE())) {
            if (Intrinsics.areEqual(value$foundation_release.getComposition(), this.mainBuffer.m1144getCompositionMzsxiRA()) && Intrinsics.areEqual(value$foundation_release.getHighlight(), this.mainBuffer.getHighlight())) {
                return;
            }
            updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1145getSelectiond9O1mEE(), this.mainBuffer.m1144getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null), restartImeIfContentChanges);
            return;
        }
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1145getSelectiond9O1mEE(), this.mainBuffer.m1144getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null);
        ...
        boolean m5781equalsimpl0 = TextRange.m5781equalsimpl0(textFieldBuffer2.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z2 = !m5781equalsimpl0;
        if (!contentEquals || !m5781equalsimpl0) {
            textFieldBuffer = textFieldBuffer2;
            m1114syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, z, z2);
        } else {
            textFieldBuffer = textFieldBuffer2;
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1103toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer2, 0L, textFieldCharSequence.getComposition(), 1, null), restartImeIfContentChanges);
        }
    ...
    public final void m1114syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        String editingBuffer = this.mainBuffer.toString();
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(editingBuffer, this.mainBuffer.m1145getSelectiond9O1mEE(), this.mainBuffer.m1144getCompositionMzsxiRA(), null, 8, null);
        boolean areEqual = Intrinsics.areEqual(newComposition, this.mainBuffer.m1144getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m5788getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m5783getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m5782getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m5786getMinimpl(newComposition.getPackedValue()), TextRange.m5785getMaximpl(newComposition.getPackedValue()));
        }
        ...
        updateValueAndNotifyListeners(textFieldCharSequence, new TextFieldCharSequence(editingBuffer, this.mainBuffer.m1145getSelectiond9O1mEE(), this.mainBuffer.m1144getCompositionMzsxiRA(), null, 8, null), true);
    }

    /* compiled from: TextFieldState.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\bÇ\u0002\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0004J\u0012\u0010\u0005\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0006\u001a\u00020\u0003H\u0016J\u0016\u0010\u0007\u001a\u0004\u0018\u00010\u0003*\u00020\b2\u0006\u0010\u0006\u001a\u00020\u0002H\u0016¨\u0006\t"}, d2 = {"Landroidx/compose/foundation/text/input/TextFieldState$Saver;", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text/input/TextFieldState;", "", "()V", "restore", Values.VECTOR_MAP_VECTORS_KEY, TrackingService.BATTERY_SAVE, "Landroidx/compose/runtime/saveable/SaverScope;", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m5788getStartimpl(textFieldState.m1113getSelectiond9O1mEE())), Integer.valueOf(TextRange.m5783getEndimpl(textFieldState.m1113getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
