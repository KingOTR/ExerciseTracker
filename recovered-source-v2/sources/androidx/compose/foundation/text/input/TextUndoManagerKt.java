...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long mo1108getOriginalRangejx7JFs = changeList.mo1108getOriginalRangejx7JFs(0);
            long mo1109getRangejx7JFs = changeList.mo1109getRangejx7JFs(0);
            if (TextRange.m5782getCollapsedimpl(mo1108getOriginalRangejx7JFs) && TextRange.m5782getCollapsedimpl(mo1109getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m5786getMinimpl(mo1108getOriginalRangejx7JFs), TextRangeKt.m5795substringFDrldGo(textFieldCharSequence, mo1108getOriginalRangejx7JFs), TextRangeKt.m5795substringFDrldGo(textFieldCharSequence2, mo1109getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
