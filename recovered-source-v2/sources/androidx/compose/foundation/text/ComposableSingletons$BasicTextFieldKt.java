...
public final class ComposableSingletons$BasicTextFieldKt {
    ...
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m990getLambda1$foundation_release() {
        return f0lambda1;
    }

    /* renamed from: getLambda-2$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m991getLambda2$foundation_release() {
        return f1lambda2;
    }

    /* renamed from: getLambda-3$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m992getLambda3$foundation_release() {
        return f2lambda3;
    }

    /* renamed from: getLambda-4$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m993getLambda4$foundation_release() {
        return f3lambda4;
    }
}
