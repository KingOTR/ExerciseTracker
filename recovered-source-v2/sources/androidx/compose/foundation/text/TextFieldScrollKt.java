...
public final class TextFieldScrollKt {
    ...
    public static final Modifier textFieldScroll(Modifier modifier, TextFieldScrollerPosition textFieldScrollerPosition, TextFieldValue textFieldValue, VisualTransformation visualTransformation, Function0<TextLayoutResultProxy> function0) {
        ...
        int m1085getOffsetToFollow5zctL8 = textFieldScrollerPosition.m1085getOffsetToFollow5zctL8(textFieldValue.getSelection());
        textFieldScrollerPosition.m1087setPreviousSelection5zctL8(textFieldValue.getSelection());
        ...
        if (i == 1) {
            verticalScrollLayoutModifier = new VerticalScrollLayoutModifier(textFieldScrollerPosition, m1085getOffsetToFollow5zctL8, filterWithValidation, function0);
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            verticalScrollLayoutModifier = new HorizontalScrollLayoutModifier(textFieldScrollerPosition, m1085getOffsetToFollow5zctL8, filterWithValidation, function0);
        }
    ...
    public static final Rect getCursorRectInScroller(Density density, int i, TransformedText transformedText, TextLayoutResult textLayoutResult, boolean z, int i2) {
        ...
        Rect rect = zero;
        int mo370roundToPx0680j_4 = density.mo370roundToPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (z) {
            left = (i2 - rect.getLeft()) - mo370roundToPx0680j_4;
        } else {
            left = rect.getLeft();
        }
        float f = left;
        if (z) {
            ...
            left2 = rect.getLeft() + mo370roundToPx0680j_4;
        }
