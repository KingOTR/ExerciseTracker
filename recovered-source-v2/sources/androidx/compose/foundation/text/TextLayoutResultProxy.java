...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1093getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1094getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1094getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m1092coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m5760getOffsetForPositionk4lQ0M(m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release(position));
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m3603getYimpl(m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1092coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }
    ...
    public final boolean m1095isPositionOnTextk4lQ0M(long offset) {
        long m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release = m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1092coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m3603getYimpl(m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release));
        return Offset.m3602getXimpl(m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m3602getXimpl(m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release) <= this.value.getLineRight(lineForVerticalPosition);
    }

    /* renamed from: translateDecorationToInnerCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1096translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
        ...
        if (layoutCoordinates2 != null) {
            ...
            if (layoutCoordinates2 != null && (layoutCoordinates = this.decorationBoxCoordinates) != null) {
                ...
                if (layoutCoordinates3 != null) {
                    return layoutCoordinates2.mo5188localPositionOfR5De75A(layoutCoordinates3, offset);
                }
            }
        }
        return offset;
    ...
    public final long m1097translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 != null) {
            if (!layoutCoordinates2.isAttached()) {
            ...
            if (layoutCoordinates2 != null && (layoutCoordinates = this.decorationBoxCoordinates) != null) {
                LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
                if (layoutCoordinates3 != null) {
                    return layoutCoordinates3.mo5188localPositionOfR5De75A(layoutCoordinates2, offset);
                }
            }
        }
        return offset;
    ...
    */
    private final long m1092coercedInVisibleBoundsOfInputTextMKHz9U(long j) {
        Rect zero;
        long m1099coerceIn3MmeM6k;
        ...
        zero = Rect.INSTANCE.getZero();
        m1099coerceIn3MmeM6k = TextLayoutResultProxyKt.m1099coerceIn3MmeM6k(j, zero);
        return m1099coerceIn3MmeM6k;
    }
}
