    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (invoke != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                Pair pair = rect != null ? new Pair(((Measurable) arrayList2.get(i2)).mo5179measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null)), IntOffset.m6422boximpl(IntOffsetKt.IntOffset(Math.round(rect.getLeft()), Math.round(rect.getTop())))) : null;
                if (pair != null) {
                    arrayList4.add(pair);
                }
            }
        ...
        return MeasureScope.layout$default(measureScope, Constraints.m6256getMaxWidthimpl(j), Constraints.m6255getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (list2 != null) {
                    ...
                    for (int i4 = 0; i4 < size4; i4++) {
                        ...
                        Placeable.PlacementScope.m5243place70tqf50$default(placementScope, pair2.component1(), pair2.component2().getPackedValue(), 0.0f, 2, null);
                    }
                }
                ...
                if (list3 != null) {
                    ...
                    for (int i5 = 0; i5 < size5; i5++) {
                        ...
                        Placeable.PlacementScope.m5243place70tqf50$default(placementScope, component1, component2 != null ? component2.invoke().getPackedValue() : IntOffset.INSTANCE.m6441getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
