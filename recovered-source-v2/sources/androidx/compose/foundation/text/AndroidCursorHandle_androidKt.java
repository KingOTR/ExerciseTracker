...
public final class AndroidCursorHandle_androidKt {
    ...
    */
    public static final void m970CursorHandleUSBMPiE(final OffsetProvider offsetProvider, final Modifier modifier, final long j, Composer composer, final int i, final int i2) {
        int i3;
        Composer startRestartGroup = composer.startRestartGroup(1776202187);
        ComposerKt.sourceInformation(startRestartGroup, "C(CursorHandle)P(2,1,0:c#ui.unit.DpSize)52@2192L241,63@2551L458,60@2438L571:AndroidCursorHandle.android.kt#423gt5");
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 6) == 0) {
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                if ((i2 & 4) != 0) {
                    j = DpSize.INSTANCE.m6410getUnspecifiedMYxV2XQ();
                    i3 &= -897;
                }
                ...
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -533359786, "CC(remember):AndroidCursorHandle.android.kt#9igjgp");
                int i4 = i3 & 14;
                ...
                if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$finalModifier$1$1
                        ...
                        public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                            semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, OffsetProvider.this.mo974provideF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
                        }
                    };
                    ...
                    public final void invoke(Composer composer2, int i5) {
                        ...
                        if ((i5 & 3) != 2 || !composer2.getSkipping()) {
                            ...
                            if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
                                ...
                                Modifier m725requiredSizeInqDBjuR0$default = SizeKt.m725requiredSizeInqDBjuR0$default(semantics$default, DpSize.m6401getWidthD9Ej5fM(j), DpSize.m6399getHeightD9Ej5fM(j), 0.0f, 0.0f, 12, null);
                                ...
                                Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer2, m725requiredSizeInqDBjuR0$default);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
                ...
                public final void invoke(Composer composer2, int i5) {
                    AndroidCursorHandle_androidKt.m970CursorHandleUSBMPiE(OffsetProvider.this, modifier, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m731sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                ...
                if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final float m3671getWidthimpl = Size.m3671getWidthimpl(cacheDrawScope.m3492getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap createHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, m3671getWidthimpl);
                            ...
                            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    try {
                                        ...
                                        transform.mo4326rotateUv8p0NA(45.0f, Offset.INSTANCE.m3618getZeroF1C5BW0());
    ...
    static {
        float m6303constructorimpl = Dp.m6303constructorimpl(25);
        CursorHandleHeight = m6303constructorimpl;
        CursorHandleWidth = Dp.m6303constructorimpl(Dp.m6303constructorimpl(m6303constructorimpl * 2.0f) / 2.4142137f);
    }
}
