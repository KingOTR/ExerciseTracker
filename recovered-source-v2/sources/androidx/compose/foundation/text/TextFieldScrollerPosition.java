...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m5793getZerod9O1mEE();
    ...
    public final void m1087setPreviousSelection5zctL8(long j) {
    ...
    public final int m1085getOffsetToFollow5zctL8(long selection) {
        return TextRange.m5788getStartimpl(selection) != TextRange.m5788getStartimpl(this.previousSelection) ? TextRange.m5788getStartimpl(selection) : TextRange.m5783getEndimpl(selection) != TextRange.m5783getEndimpl(this.previousSelection) ? TextRange.m5783getEndimpl(selection) : TextRange.m5786getMinimpl(selection);
    }
