...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0) {
        TextDragObserver textDragObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
            private long lastPosition = Offset.INSTANCE.m3618getZeroF1C5BW0();
            ...
            public void mo1063onStartk4lQ0M(long startPoint) {
                ...
                if (invoke != null) {
                    ...
                    selectionRegistrar2.mo1393notifySelectionUpdateStartubNVwUQ(invoke, startPoint, SelectionAdjustment.INSTANCE.getWord(), true);
            ...
            public void mo1062onDragk4lQ0M(long delta) {
                ...
                if (invoke != null) {
                    ...
                    if (invoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2)) {
                        ...
                        long m3607plusMKHz9U2 = Offset.m3607plusMKHz9U(this.lastPosition, m3607plusMKHz9U);
                        if (selectionRegistrar2.mo1392notifySelectionUpdatenjBpvok(invoke, m3607plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.INSTANCE.getWord(), true)) {
                            this.lastPosition = m3607plusMKHz9U2;
                            this.dragTotalDistance = Offset.INSTANCE.m3618getZeroF1C5BW0();
                        }
                    }
                }
        ...
        return SelectionGesturesKt.selectionGestureInput(Modifier.INSTANCE, new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo1276onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.mo1392notifySelectionUpdatenjBpvok(invoke, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
            ...
            public boolean mo1277onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.mo1392notifySelectionUpdatenjBpvok(invoke, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
                    return true;
                }
            ...
            public boolean mo1278onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                selectionRegistrar2.mo1393notifySelectionUpdateStartubNVwUQ(invoke, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2);
            }
            ...
            public boolean mo1275onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.mo1392notifySelectionUpdatenjBpvok(invoke, dragPosition, this.lastPosition, false, adjustment, false)) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
