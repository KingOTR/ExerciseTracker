...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m1324updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        ...
        if (TextOverflow.m6234equalsimpl0(this.overflow, overflow)) {
            return z;
        }
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m1312updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1312updateZNqEYIc(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
                ...
                */
                public final Boolean invoke(List<TextLayoutResult> list) {
                    ...
                    if (layoutCache2 != null) {
                        ...
                        m5833mergedA7vx0o = textStyle.m5833mergedA7vx0o((r58 & 1) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : colorProducer != null ? colorProducer.mo1743invoke0d7_KjU() : Color.INSTANCE.m3879getUnspecified0d7_KjU(), (r58 & 2) != 0 ? TextUnit.INSTANCE.m6507getUnspecifiedXSAIIZE() : 0L, (r58 & 4) != 0 ? null : null, (r58 & 8) != 0 ? null : null, (r58 & 16) != 0 ? null : null, (r58 & 32) != 0 ? null : null, (r58 & 64) != 0 ? null : null, (r58 & 128) != 0 ? TextUnit.INSTANCE.m6507getUnspecifiedXSAIIZE() : 0L, (r58 & 256) != 0 ? null : null, (r58 & 512) != 0 ? null : null, (r58 & 1024) != 0 ? null : null, (r58 & 2048) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : 0L, (r58 & 4096) != 0 ? null : null, (r58 & 8192) != 0 ? null : null, (r58 & 16384) != 0 ? null : null, (r58 & 32768) != 0 ? TextAlign.INSTANCE.m6198getUnspecifiede0LSkKk() : 0, (r58 & 65536) != 0 ? TextDirection.INSTANCE.m6211getUnspecifieds_7Xco() : 0, (r58 & 131072) != 0 ? TextUnit.INSTANCE.m6507getUnspecifiedXSAIIZE() : 0L, (r58 & 262144) != 0 ? null : null, (r58 & 524288) != 0 ? null : null, (r58 & 1048576) != 0 ? LineBreak.INSTANCE.m6125getUnspecifiedrAG3T2k() : 0, (r58 & 2097152) != 0 ? Hyphens.INSTANCE.m6104getUnspecifiedvmbZdU8() : 0, (r58 & 4194304) != 0 ? null : null, (r58 & 8388608) != 0 ? null : null);
                        textLayoutResult = TextLayoutResult.m5758copyO0kMr_c$default(layoutCache2, new TextLayoutInput(text, m5833mergedA7vx0o, layoutCache2.getLayoutInput().getPlaceholders(), layoutCache2.getLayoutInput().getMaxLines(), layoutCache2.getLayoutInput().getSoftWrap(), layoutCache2.getLayoutInput().getOverflow(), layoutCache2.getLayoutInput().getDensity(), layoutCache2.getLayoutInput().getLayoutDirection(), layoutCache2.getLayoutInput().getFontFamilyResolver(), layoutCache2.getLayoutInput().getConstraints(), (DefaultConstructorMarker) null), 0L, 2, null);
    ...
    public final MeasureResult m1323measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo94measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean m1311layoutWithConstraintsK40F9xA = layoutCache.m1311layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (m1311layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(Constraints.INSTANCE.m6265fitPrioritizingWidthZbe2FdA(IntSize.m6473getWidthimpl(textLayoutResult.getSize()), IntSize.m6473getWidthimpl(textLayoutResult.getSize()), IntSize.m6472getHeightimpl(textLayoutResult.getSize()), IntSize.m6472getHeightimpl(textLayoutResult.getSize())));
        int m6473getWidthimpl = IntSize.m6473getWidthimpl(textLayoutResult.getSize());
        int m6472getHeightimpl = IntSize.m6472getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(m6473getWidthimpl, m6472getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            boolean z = true;
            boolean z2 = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m6234equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6243getVisiblegIe3tQ8());
            if (z2) {
            ...
            try {
                ...
                if (brush != null) {
                    multiParagraph.m5659painthn5TExg(canvas, brush, (r17 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (r17 & 8) != 0 ? null : shadow2, (r17 & 16) != 0 ? null : textDecoration2, (r17 & 32) != 0 ? null : drawStyle2, (r17 & 64) != 0 ? DrawScope.INSTANCE.m4401getDefaultBlendMode0nO6VwU() : 0);
                } else {
                    ColorProducer colorProducer = this.overrideColor;
                    long mo1743invoke0d7_KjU = colorProducer != null ? colorProducer.mo1743invoke0d7_KjU() : Color.INSTANCE.m3879getUnspecified0d7_KjU();
                    if (mo1743invoke0d7_KjU == 16) {
                        if (this.style.m5818getColor0d7_KjU() != 16) {
                            mo1743invoke0d7_KjU = this.style.m5818getColor0d7_KjU();
                        } else {
                            mo1743invoke0d7_KjU = Color.INSTANCE.m3869getBlack0d7_KjU();
                        }
                    }
                    multiParagraph.m5657paintLG529CI(canvas, (r14 & 2) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : mo1743invoke0d7_KjU, (r14 & 4) != 0 ? null : shadow2, (r14 & 8) != 0 ? null : textDecoration2, (r14 & 16) == 0 ? drawStyle2 : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m4401getDefaultBlendMode0nO6VwU() : 0);
                }
                TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
