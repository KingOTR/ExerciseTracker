...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        this.maxLines = i2;
        this.minLines = i3;
        this.lastDensity = InlineDensity.INSTANCE.m1301getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.INSTANCE.m6266fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6241getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation_release(Density density) {
        ...
        long m1293constructorimpl = density != null ? InlineDensity.m1293constructorimpl(density) : InlineDensity.INSTANCE.m1301getUnspecifiedL26CHvs();
        if (density2 == null) {
            this.density = density;
            this.lastDensity = m1293constructorimpl;
        } else if (density == null || !InlineDensity.m1295equalsimpl0(this.lastDensity, m1293constructorimpl)) {
            this.density = density;
            this.lastDensity = m1293constructorimpl;
            markDirty();
        }
    ...
    public final void m1317setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m1316layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        boolean z = true;
        if (this.minLines > 1) {
            ...
            constraints = from.m1305coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (!m1314newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            if (!Constraints.m6249equalsimpl0(constraints, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m6270constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth())), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m6234equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6243getVisiblegIe3tQ8()) || (IntSize.m6473getWidthimpl(r3) >= paragraph.getWidth() && IntSize.m6472getHeightimpl(r3) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph m1313layoutTextK40F9xA = m1313layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m6270constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(m1313layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(m1313layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m6234equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6243getVisiblegIe3tQ8()) && (IntSize.m6473getWidthimpl(r9) < m1313layoutTextK40F9xA.getWidth() || IntSize.m6472getHeightimpl(r9) < m1313layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = m1313layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int ceilToIntPx = TextDelegateKt.ceilToIntPx(m1313layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m1318updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
    ...
    private final Paragraph m1313layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m5672Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m1302finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m1303finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m6234equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6242getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m1314newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return Constraints.m6256getMaxWidthimpl(constraints) != Constraints.m6256getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m6255getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long m6247copyZbe2FdA$default = Constraints.m6247copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, m6247copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), m6247copyZbe2FdA$default, this.maxLines, TextOverflow.m6234equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6242getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : AbstractJsonLexerKt.NULL) + ", lastDensity=" + ((Object) InlineDensity.m1299toStringimpl(this.lastDensity)) + ')';
    }
}
