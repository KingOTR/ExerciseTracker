...
public final class MinLinesConstrainer {
    ...
    public final long m1305coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        String str;
        Paragraph m5670ParagraphUdtVg6A;
        String str2;
        Paragraph m5670ParagraphUdtVg6A2;
        ...
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            ...
            m5670ParagraphUdtVg6A = ParagraphKt.m5670ParagraphUdtVg6A(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? false : false);
            f = m5670ParagraphUdtVg6A.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m5670ParagraphUdtVg6A2 = ParagraphKt.m5670ParagraphUdtVg6A(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? false : false);
            f2 = m5670ParagraphUdtVg6A2.getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (minLines != 1) {
            m6257getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(f + (f2 * (minLines - 1))), 0), Constraints.m6255getMaxHeightimpl(inConstraints));
        } else {
            m6257getMinHeightimpl = Constraints.m6257getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m6258getMinWidthimpl(inConstraints), Constraints.m6256getMaxWidthimpl(inConstraints), m6257getMinHeightimpl, Constraints.m6255getMaxHeightimpl(inConstraints));
    }
}
