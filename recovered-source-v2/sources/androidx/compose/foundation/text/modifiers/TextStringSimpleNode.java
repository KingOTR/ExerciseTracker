...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6241getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m1325updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        if (textChanged || layoutChanged) {
            getLayoutCache().m1318updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(String updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1318updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$applySemantics$1
                ...
                public final Boolean invoke(List<TextLayoutResult> list) {
                    ...
                    TextLayoutResult slowCreateTextLayoutResultOrNull = layoutCache.slowCreateTextLayoutResultOrNull(m5833mergedA7vx0o);
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean m1316layoutWithConstraintsK40F9xA = layoutCache.m1316layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (m1316layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(Constraints.INSTANCE.m6265fitPrioritizingWidthZbe2FdA(IntSize.m6473getWidthimpl(layoutSize), IntSize.m6473getWidthimpl(layoutSize), IntSize.m6472getHeightimpl(layoutSize), IntSize.m6472getHeightimpl(layoutSize)));
        int m6473getWidthimpl = IntSize.m6473getWidthimpl(layoutSize);
        int m6472getHeightimpl = IntSize.m6472getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(m6473getWidthimpl, m6472getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            if (didOverflow) {
                float m6473getWidthimpl = IntSize.m6473getWidthimpl(layoutCache.getLayoutSize());
                float m6472getHeightimpl = IntSize.m6472getHeightimpl(layoutCache.getLayoutSize());
                canvas.save();
                Canvas.m3815clipRectN_I0leg$default(canvas, 0.0f, 0.0f, m6473getWidthimpl, m6472getHeightimpl, 0, 16, null);
            }
            try {
                ...
                if (brush != null) {
                    Paragraph.m5663painthn5TExg$default(paragraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ...
                    Paragraph.m5661paintLG529CI$default(paragraph, canvas, mo1743invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
            } finally {
                if (didOverflow) {
                    canvas.restore();
