...
public final class KeyMapping_androidKt {
    private static final KeyMapping platformDefaultKeyMapping = new KeyMapping() { // from class: androidx.compose.foundation.text.KeyMapping_androidKt$platformDefaultKeyMapping$1
        ...
        public KeyCommand mo1000mapZmokQxo(KeyEvent event) {
            KeyCommand keyCommand = null;
            if (KeyEvent_androidKt.m4914isShiftPressedZmokQxo(event) && KeyEvent_androidKt.m4911isAltPressedZmokQxo(event)) {
            ...
            return keyCommand == null ? KeyMappingKt.getDefaultKeyMapping().mo1000mapZmokQxo(event) : keyCommand;
        }
    };
