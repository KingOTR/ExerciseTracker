...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6256getMaxWidthimpl(j), Constraints.m6255getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                measureWithTextRangeMeasureConstraints = BasicTextKt.measureWithTextRangeMeasureConstraints(list2, function0);
                if (measureWithTextRangeMeasureConstraints != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        Placeable.PlacementScope.m5243place70tqf50$default(placementScope, placeable, function02 != null ? ((IntOffset) function02.invoke()).getPackedValue() : IntOffset.INSTANCE.m6441getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
