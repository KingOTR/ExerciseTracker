...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m1077typedCommandZmokQxo(KeyEvent event) {
        Integer m998consumeZmokQxo;
        if (TextFieldKeyInput_androidKt.m1082isTypedEventZmokQxo(event) && (m998consumeZmokQxo = this.keyCombiner.m998consumeZmokQxo(event)) != null) {
            return new CommitTextCommand(StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), m998consumeZmokQxo.intValue()).toString(), 1);
        }
        return null;
    }

    /* renamed from: process-ZmokQxo, reason: not valid java name */
    public final boolean m1078processZmokQxo(KeyEvent event) {
        final KeyCommand mo1000mapZmokQxo;
        CommitTextCommand m1077typedCommandZmokQxo = m1077typedCommandZmokQxo(event);
        if (m1077typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(m1077typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m4901equalsimpl0(KeyEvent_androidKt.m4909getTypeZmokQxo(event), KeyEventType.INSTANCE.m4905getKeyDownCS__XNY()) || (mo1000mapZmokQxo = this.keyMapping.mo1000mapZmokQxo(event)) == null || (mo1000mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[KeyCommand.this.ordinal()]) {
                    ...
                    case 20:
                        List<EditCommand> deleteIfSelectedOr = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                return new DeleteSurroundingTextCommand(TextRange.m5783getEndimpl(textFieldPreparedSelection2.getSelection()) - textFieldPreparedSelection2.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> deleteIfSelectedOr2 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m5783getEndimpl(textFieldPreparedSelection2.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> deleteIfSelectedOr3 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (previousWordOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m5783getEndimpl(textFieldPreparedSelection2.getSelection()) - previousWordOffset.intValue(), 0);
                                } else {
                    ...
                    case 23:
                        List<EditCommand> deleteIfSelectedOr4 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m5783getEndimpl(textFieldPreparedSelection2.getSelection())) : null;
                            }
                        });
                        ...
                        List<EditCommand> deleteIfSelectedOr5 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (lineStartByOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m5783getEndimpl(textFieldPreparedSelection2.getSelection()) - lineStartByOffset.intValue(), 0);
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 25:
                        List<EditCommand> deleteIfSelectedOr6 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m5783getEndimpl(textFieldPreparedSelection2.getSelection())) : null;
                            }
                        });
                    ...
                    case 26:
                        if (!this.getSingleLine()) {
                            ...
                            i = this.imeAction;
                            onImeActionPerformed.invoke(ImeAction.m5950boximpl(i));
                            break;
                        }
                    case 27:
                        if (!this.getSingleLine()) {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m5781equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
