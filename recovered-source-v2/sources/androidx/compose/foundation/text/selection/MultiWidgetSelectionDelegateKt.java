...
public final class MultiWidgetSelectionDelegateKt {
    ...
    public static final void m1333appendSelectableInfoParwq6A(SelectionLayoutBuilder selectionLayoutBuilder, TextLayoutResult textLayoutResult, long j, long j2, long j3) {
        ...
        Rect rect = new Rect(0.0f, 0.0f, IntSize.m6473getWidthimpl(textLayoutResult.getSize()), IntSize.m6472getHeightimpl(textLayoutResult.getSize()));
        ...
        if (selectionLayoutBuilder.getIsStartHandle()) {
            ...
            appendSelectableInfo_Parwq6A$otherDirection = appendSelectableInfo_Parwq6A$otherDirection(m1335getXDirection3MmeM6k, m1336getYDirection3MmeM6k, selectionLayoutBuilder, j3, previousSelection != null ? previousSelection.getEnd() : null);
            direction3 = appendSelectableInfo_Parwq6A$otherDirection;
            direction4 = direction3;
            direction = m1335getXDirection3MmeM6k;
            direction2 = m1336getYDirection3MmeM6k;
        } else {
            Selection previousSelection2 = selectionLayoutBuilder.getPreviousSelection();
            appendSelectableInfo_Parwq6A$otherDirection = appendSelectableInfo_Parwq6A$otherDirection(m1335getXDirection3MmeM6k, m1336getYDirection3MmeM6k, selectionLayoutBuilder, j3, previousSelection2 != null ? previousSelection2.getStart() : null);
            direction = appendSelectableInfo_Parwq6A$otherDirection;
            direction2 = direction;
            direction3 = m1335getXDirection3MmeM6k;
            direction4 = m1336getYDirection3MmeM6k;
        }
        if (isSelected(SelectionLayoutKt.resolve2dDirection(m1335getXDirection3MmeM6k, m1336getYDirection3MmeM6k), appendSelectableInfo_Parwq6A$otherDirection)) {
            ...
            if (selectionLayoutBuilder.getIsStartHandle()) {
                ...
                previousAdjustedOffset = m1334getOffsetForPosition3MmeM6k;
                i = (previousSelection3 == null || (end = previousSelection3.getEnd()) == null) ? m1334getOffsetForPosition3MmeM6k : getPreviousAdjustedOffset(end, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j3, length);
            } else {
                int m1334getOffsetForPosition3MmeM6k2 = m1334getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection4 = selectionLayoutBuilder.getPreviousSelection();
                i = m1334getOffsetForPosition3MmeM6k2;
                previousAdjustedOffset = (previousSelection4 == null || (start = previousSelection4.getStart()) == null) ? m1334getOffsetForPosition3MmeM6k2 : getPreviousAdjustedOffset(start, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j3, length);
            }
            selectionLayoutBuilder.appendInfo(j3, previousAdjustedOffset, direction, direction2, i, direction3, direction4, OffsetKt.m3623isUnspecifiedk4lQ0M(j2) ? -1 : m1334getOffsetForPosition3MmeM6k(j2, textLayoutResult), textLayoutResult);
        }
    }
    ...
    private static final Direction m1335getXDirection3MmeM6k(long j, Rect rect) {
        return Offset.m3602getXimpl(j) < rect.getLeft() ? Direction.BEFORE : Offset.m3602getXimpl(j) > rect.getRight() ? Direction.AFTER : Direction.ON;
    }

    /* renamed from: getYDirection-3MmeM6k, reason: not valid java name */
    private static final Direction m1336getYDirection3MmeM6k(long j, Rect rect) {
        return Offset.m3603getYimpl(j) < rect.getTop() ? Direction.BEFORE : Offset.m3603getYimpl(j) > rect.getBottom() ? Direction.AFTER : Direction.ON;
    }
    ...
    private static final int m1334getOffsetForPosition3MmeM6k(long j, TextLayoutResult textLayoutResult) {
        if (Offset.m3603getYimpl(j) <= 0.0f) {
            return 0;
        }
        return Offset.m3603getYimpl(j) >= textLayoutResult.getMultiParagraph().getHeight() ? textLayoutResult.getLayoutInput().getText().length() : textLayoutResult.m5760getOffsetForPositionk4lQ0M(j);
    }
}
