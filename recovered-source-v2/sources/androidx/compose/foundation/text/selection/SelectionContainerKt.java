...
public final class SelectionContainerKt {
    ...
    public static final void DisableSelection(final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(SelectionRegistrarKt.getLocalSelectionRegistrar().provides(null), function2, startRestartGroup, ((i2 << 3) & SdkConfig.SDK_VERSION) | ProvidedValue.$stable);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void SelectionContainer(final Modifier modifier, final Selection selection, final Function1<? super Selection, Unit> function1, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 1171) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            final SelectionRegistrarImpl selectionRegistrarImpl = (SelectionRegistrarImpl) RememberSaveableKt.m3429rememberSaveable(new Object[0], (Saver) SelectionRegistrarImpl.INSTANCE.getSaver(), (String) null, (Function0) new Function0<SelectionRegistrarImpl>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$registrarImpl$1
                                                                ...
                                                                if (booleanValue) {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$1
                                                                        ...
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m3591boximpl(m1339invokeF1C5BW0());
                                                                        }

                                                                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                                                                        public final long m1339invokeF1C5BW0() {
                                                                            Offset m1375getStartHandlePosition_m7T9E = SelectionManager.this.m1375getStartHandlePosition_m7T9E();
                                                                            return m1375getStartHandlePosition_m7T9E != null ? m1375getStartHandlePosition_m7T9E.getPackedValue() : Offset.INSTANCE.m3617getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                } else {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$2
                                                                        ...
                                                                        @Override // kotlin.jvm.functions.Function0
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m3591boximpl(m1340invokeF1C5BW0());
                                                                        }

                                                                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                                                                        public final long m1340invokeF1C5BW0() {
                                                                            Offset m1374getEndHandlePosition_m7T9E = SelectionManager.this.m1374getEndHandlePosition_m7T9E();
                                                                            return m1374getEndHandlePosition_m7T9E != null ? m1374getEndHandlePosition_m7T9E.getPackedValue() : Offset.INSTANCE.m3617getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                }
