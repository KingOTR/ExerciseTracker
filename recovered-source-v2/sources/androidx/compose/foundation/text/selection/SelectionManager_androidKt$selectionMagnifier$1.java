        ...
        if (changedInstance || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
            rememberedValue2 = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$1$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m3591boximpl(m1386invokeF1C5BW0());
                }
                ...
                public final long m1386invokeF1C5BW0() {
                    ...
                    return SelectionManagerKt.m1382calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager2, invoke$lambda$1);
                }
            };
                ...
                public final Modifier invoke2(final Function0<Offset> function02) {
                    ...
                    Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                        ...
                        public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                            return Offset.m3591boximpl(m1387invoketuRUvjQ(density2));
                        }

                        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
                        public final long m1387invoketuRUvjQ(Density density2) {
                            return function02.invoke().getPackedValue();
                        }
                    };
                    final Density density2 = Density.this;
                    final MutableState<IntSize> mutableState2 = mutableState;
                    return Magnifier_androidKt.m309magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                            m1388invokeEaSLcWc(dpSize.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-EaSLcWc, reason: not valid java name */
                        public final void m1388invokeEaSLcWc(long j) {
                            MutableState<IntSize> mutableState3 = mutableState2;
                            Density density3 = Density.this;
                            SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo370roundToPx0680j_4(DpSize.m6401getWidthD9Ej5fM(j)), density3.mo370roundToPx0680j_4(DpSize.m6399getHeightD9Ej5fM(j))));
                        }
