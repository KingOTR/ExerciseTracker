...
public final class SelectionHandlesKt {
    ...
    public static final long m1346getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m3602getXimpl(j), Offset.m3603getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m6303constructorimpl(f);
