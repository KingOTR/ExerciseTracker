...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m3618getZeroF1C5BW0();
    ...
    public long mo348calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long mo974provideF1C5BW0 = this.positionProvider.mo974provideF1C5BW0();
        if (!OffsetKt.m3621isSpecifiedk4lQ0M(mo974provideF1C5BW0)) {
            mo974provideF1C5BW0 = this.prevPosition;
        }
        this.prevPosition = mo974provideF1C5BW0;
        return IntOffset.m6435plusqkQi6aY(IntOffset.m6435plusqkQi6aY(anchorBounds.m6459getTopLeftnOccac(), IntOffsetKt.m6447roundk4lQ0M(mo974provideF1C5BW0)), this.handleReferencePoint.mo3448alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m6478getZeroYbymL2g(), layoutDirection));
    }
}
