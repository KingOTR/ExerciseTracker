...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl$sort$1
                ...
                public final Integer invoke(Selectable selectable, Selectable selectable2) {
                    ...
                    if (layoutCoordinates != null) {
                        m3618getZeroF1C5BW0 = LayoutCoordinates.this.mo5188localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3618getZeroF1C5BW0());
                    } else {
                        m3618getZeroF1C5BW0 = Offset.INSTANCE.m3618getZeroF1C5BW0();
                    }
                    if (layoutCoordinates2 != null) {
                        m3618getZeroF1C5BW02 = LayoutCoordinates.this.mo5188localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m3618getZeroF1C5BW0());
                    } else {
                        m3618getZeroF1C5BW02 = Offset.INSTANCE.m3618getZeroF1C5BW0();
                    }
                    if (Offset.m3603getYimpl(m3618getZeroF1C5BW0) == Offset.m3603getYimpl(m3618getZeroF1C5BW02)) {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m3602getXimpl(m3618getZeroF1C5BW0)), Float.valueOf(Offset.m3602getXimpl(m3618getZeroF1C5BW02)));
                    } else {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m3603getYimpl(m3618getZeroF1C5BW0)), Float.valueOf(Offset.m3603getYimpl(m3618getZeroF1C5BW02)));
                    }
    ...
    public void mo1393notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m3591boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1392notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m3591boximpl(newPosition), Offset.m3591boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
