...
public final class TextSelectionDelegateKt {
    public static final long getSelectionHandleCoordinates(TextLayoutResult textLayoutResult, int i, boolean z, boolean z2) {
        ...
        return lineForOffset >= textLayoutResult.getLineCount() ? Offset.INSTANCE.m3617getUnspecifiedF1C5BW0() : OffsetKt.Offset(RangesKt.coerceIn(getHorizontalPosition(textLayoutResult, i, z, z2), 0.0f, IntSize.m6473getWidthimpl(textLayoutResult.getSize())), RangesKt.coerceIn(textLayoutResult.getLineBottom(lineForOffset), 0.0f, IntSize.m6472getHeightimpl(textLayoutResult.getSize())));
    }
