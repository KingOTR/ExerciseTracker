...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3591boximpl(Offset.INSTANCE.m3618getZeroF1C5BW0()), null, 2, null);

    /* renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3591boximpl(Offset.INSTANCE.m3618getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrarImpl) {
        ...
        selectionRegistrarImpl.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1378invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Rg1IO4c, reason: not valid java name */
            public final void m1378invokeRg1IO4c(boolean z, LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment) {
                long mo5187getSizeYbymL2g = layoutCoordinates.mo5187getSizeYbymL2g();
                Rect rect = new Rect(0.0f, 0.0f, IntSize.m6473getWidthimpl(mo5187getSizeYbymL2g), IntSize.m6472getHeightimpl(mo5187getSizeYbymL2g));
                if (!SelectionManagerKt.m1383containsInclusiveUv8p0NA(rect, j)) {
                    j = TextLayoutStateKt.m1223coerceIn3MmeM6k(j, rect);
                }
                long m1362convertToContainerCoordinatesR5De75A = SelectionManager.this.m1362convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                if (OffsetKt.m3621isSpecifiedk4lQ0M(m1362convertToContainerCoordinatesR5De75A)) {
                    SelectionManager.this.setInTouchMode(z);
                    SelectionManager.this.m1369startSelection9KIMszo(m1362convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
        ...
        selectionRegistrarImpl.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1379invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool2.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-pGV3PM0, reason: not valid java name */
            public final Boolean m1379invokepGV3PM0(boolean z, LayoutCoordinates layoutCoordinates, long j, long j2, boolean z2, SelectionAdjustment selectionAdjustment) {
                long m1362convertToContainerCoordinatesR5De75A = SelectionManager.this.m1362convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                long m1362convertToContainerCoordinatesR5De75A2 = SelectionManager.this.m1362convertToContainerCoordinatesR5De75A(layoutCoordinates, j2);
                SelectionManager.this.setInTouchMode(z);
                return Boolean.valueOf(SelectionManager.this.m1377updateSelectionqNKwrvQ$foundation_release(Offset.m3591boximpl(m1362convertToContainerCoordinatesR5De75A), m1362convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment));
            }
        });
        selectionRegistrarImpl.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m1364setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrarImpl.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                if (selection != null && (start = selection.getStart()) != null && j == start.getSelectableId()) {
                    SelectionManager.this.m1368setStartHandlePosition_kEHs6E(null);
                }
                ...
                if (selection2 != null && (end = selection2.getEnd()) != null && j == end.getSelectableId()) {
                    SelectionManager.this.m1367setEndHandlePosition_kEHs6E(null);
                }
                if (SelectionManager.this.selectionRegistrar.getSubselections().contains(j)) {
                    SelectionManager.this.updateSelectionToolbar();
                }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1380invokeZmokQxo(keyEvent.m4897unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1380invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z;
                if (SelectionManager_androidKt.m1385isCopyKeyEventZmokQxo(keyEvent)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset m3591boximpl = layoutCoordinates != null ? Offset.m3591boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, m3591boximpl)) {
            return;
        }
        this.previousPosition = m3591boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m1365setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m3591boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1372getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m1366setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m3591boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1373getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance.getValue()).getPackedValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1368setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1375getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1367setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1374getEndHandlePosition_m7T9E() {
    ...
    public final void m1364setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1371getCurrentDragPosition_m7T9E() {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x006c, code lost:
        ...
        if (androidx.compose.foundation.text.selection.SelectionManagerKt.m1383containsInclusiveUv8p0NA(r7, r8) == false) goto L36;
     */
    ...
    */
    public final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || (layoutCoordinates2 == null && layoutCoordinates3 == null)) {
            m1368setStartHandlePosition_kEHs6E(null);
            m1367setEndHandlePosition_kEHs6E(null);
            return;
        }
        Rect visibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        if (layoutCoordinates2 != null) {
            long mo1331getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1331getHandlePositiondBAh8RU(selection, true);
            if (!OffsetKt.m3623isUnspecifiedk4lQ0M(mo1331getHandlePositiondBAh8RU)) {
                offset = Offset.m3591boximpl(layoutCoordinates.mo5188localPositionOfR5De75A(layoutCoordinates2, mo1331getHandlePositiondBAh8RU));
                long packedValue = offset.getPackedValue();
                if (getDraggingHandle() != Handle.SelectionStart) {
                }
                m1368setStartHandlePosition_kEHs6E(offset);
                if (layoutCoordinates3 != null) {
                    long mo1331getHandlePositiondBAh8RU2 = anchorSelectable$foundation_release2.mo1331getHandlePositiondBAh8RU(selection, false);
                    if (!OffsetKt.m3623isUnspecifiedk4lQ0M(mo1331getHandlePositiondBAh8RU2)) {
                        Offset m3591boximpl = Offset.m3591boximpl(layoutCoordinates.mo5188localPositionOfR5De75A(layoutCoordinates3, mo1331getHandlePositiondBAh8RU2));
                        long packedValue2 = m3591boximpl.getPackedValue();
                        if (getDraggingHandle() == Handle.SelectionEnd || SelectionManagerKt.m1383containsInclusiveUv8p0NA(visibleBounds, packedValue2)) {
                            offset2 = m3591boximpl;
                        }
                    }
                }
                m1367setEndHandlePosition_kEHs6E(offset2);
            }
        }
        offset = null;
        m1368setStartHandlePosition_kEHs6E(offset);
    ...
    private final Rect getContentRect() {
        ...
        Rect m3639translatek4lQ0M = intersect.m3639translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates));
        return Rect.copy$default(m3639translatek4lQ0M, 0.0f, 0.0f, 0.0f, m3639translatek4lQ0M.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo1061onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset m1375getStartHandlePosition_m7T9E = isStartHandle ? this.m1375getStartHandlePosition_m7T9E() : this.m1374getEndHandlePosition_m7T9E();
                if (m1375getStartHandlePosition_m7T9E != null) {
                    m1375getStartHandlePosition_m7T9E.getPackedValue();
                    ...
                    long mo1331getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1331getHandlePositiondBAh8RU(selection, isStartHandle);
                    if (OffsetKt.m3623isUnspecifiedk4lQ0M(mo1331getHandlePositiondBAh8RU)) {
                        return;
                    }
                    long m1346getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1346getAdjustedCoordinatesk4lQ0M(mo1331getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m1364setCurrentDragPosition_kEHs6E(Offset.m3591boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo5188localPositionOfR5De75A(layoutCoordinates, m1346getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo1063onStartk4lQ0M(long startPoint) {
                ...
                long mo1331getHandlePositiondBAh8RU = selectable2.mo1331getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3623isUnspecifiedk4lQ0M(mo1331getHandlePositiondBAh8RU)) {
                    return;
                }
                long m1346getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1346getAdjustedCoordinatesk4lQ0M(mo1331getHandlePositiondBAh8RU);
                SelectionManager selectionManager = this;
                selectionManager.m1365setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo5188localPositionOfR5De75A(layoutCoordinates, m1346getAdjustedCoordinatesk4lQ0M));
                this.m1366setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3618getZeroF1C5BW0());
            }
            ...
            public void mo1062onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1366setDragTotalDistancek4lQ0M(Offset.m3607plusMKHz9U(selectionManager.m1373getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long m3607plusMKHz9U = Offset.m3607plusMKHz9U(this.m1372getDragBeginPositionF1C5BW0$foundation_release(), this.m1373getDragTotalDistanceF1C5BW0$foundation_release());
                if (this.m1377updateSelectionqNKwrvQ$foundation_release(Offset.m3591boximpl(m3607plusMKHz9U), this.m1372getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m1365setDragBeginPositionk4lQ0M(m3607plusMKHz9U);
                    this.m1366setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3618getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m1364setCurrentDragPosition_kEHs6E(null);
            }
    ...
    public final long m1362convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return Offset.INSTANCE.m3617getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation_release().mo5188localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m1369startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1376updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m3617getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-qNKwrvQ$foundation_release, reason: not valid java name */
    public final boolean m1377updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1376updateSelectionjyLRC_s$foundation_release(newPosition.getPackedValue(), previousPosition, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-jyLRC_s$foundation_release, reason: not valid java name */
    public final boolean m1376updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1364setCurrentDragPosition_kEHs6E(Offset.m3591boximpl(position));
        SelectionLayout m1363getSelectionLayoutWko1d7g = m1363getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (!m1363getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection adjust = adjustment.adjust(m1363getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(adjust, getSelection())) {
            selectionChanged(m1363getSelectionLayoutWko1d7g, adjust);
        }
        this.previousSelectionLayout = m1363getSelectionLayoutWko1d7g;
        return true;
    }

    /* renamed from: getSelectionLayout-Wko1d7g, reason: not valid java name */
    private final SelectionLayout m1363getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
        ...
        SelectionLayoutBuilder selectionLayoutBuilder = new SelectionLayoutBuilder(position, previousHandlePosition, requireContainerCoordinates$foundation_release, isStartHandle, OffsetKt.m3623isUnspecifiedk4lQ0M(previousHandlePosition) ? null : getSelection(), new Comparator() { // from class: androidx.compose.foundation.text.selection.SelectionManager$getSelectionLayout-Wko1d7g$$inlined$compareBy$1
            /* JADX WARN: Multi-variable type inference failed */
    ...
    public final void m1370contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m5782getCollapsedimpl(selection.m1337toTextRanged9O1mEE()) : true) {
            m1369startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
