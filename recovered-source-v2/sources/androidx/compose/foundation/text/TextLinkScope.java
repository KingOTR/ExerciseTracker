...
public final class TextLinkScope {
    ...
    public static final TextRangeLayoutMeasureResult textRange$lambda$3(TextLinkScope textLinkScope, int i, int i2, TextRangeLayoutMeasureScope textRangeLayoutMeasureScope) {
        ...
        if (textLayoutResult == null) {
            return textRangeLayoutMeasureScope.layout(0, 0, new Function0<IntOffset>() { // from class: androidx.compose.foundation.text.TextLinkScope$textRange$1$layoutResult$1
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke() {
                    return IntOffset.m6422boximpl(m1101invokenOccac());
                }

                /* renamed from: invoke-nOcc-ac, reason: not valid java name */
                public final long m1101invokenOccac() {
        ...
        return textRangeLayoutMeasureScope.layout(roundToIntRect.getWidth(), roundToIntRect.getHeight(), new Function0<IntOffset>() { // from class: androidx.compose.foundation.text.TextLinkScope$textRange$1$1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ IntOffset invoke() {
                return IntOffset.m6422boximpl(m1100invokenOccac());
            }

            /* renamed from: invoke-nOcc-ac, reason: not valid java name */
            public final long m1100invokenOccac() {
                return IntRect.this.m6459getTopLeftnOccac();
            }
        });
    }
    ...
    private final Path pathForRangeInRangeCoordinates(AnnotatedString.Range<LinkAnnotation> range) {
        ...
        pathForRange.mo3738translatek4lQ0M(Offset.m3611unaryMinusF1C5BW0(OffsetKt.Offset(textLayoutResult.getLineForOffset(range.getStart()) == textLayoutResult.getLineForOffset(range.getEnd()) ? Math.min(textLayoutResult.getBoundingBox(range.getEnd() - 1).getLeft(), boundingBox.getLeft()) : 0.0f, boundingBox.getTop())));
        return pathForRange;
    }
    ...
    public final void LinksComposables(Composer composer, final int i) {
        int i2;
        Modifier modifier;
        Modifier m273combinedClickableXVZzFYc;
        boolean isNullOrEmpty;
        Composer startRestartGroup = composer.startRestartGroup(1154651354);
        ComposerKt.sourceInformation(startRestartGroup, "C(LinksComposables)154@6764L7:TextLinkScope.kt#423gt5");
        int i3 = 2;
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            while (i4 < size) {
                ...
                if (range.getStart() != range.getEnd()) {
                    startRestartGroup.startReplaceGroup(1383677450);
                    ComposerKt.sourceInformation(startRestartGroup, "161@7083L39,173@7698L38,163@7140L640");
                    ...
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -371004613, "CC(remember):TextLinkScope.kt#9igjgp");
                    ...
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -370984934, "CC(remember):TextLinkScope.kt#9igjgp");
                    ...
                    m273combinedClickableXVZzFYc = ClickableKt.m273combinedClickableXVZzFYc(semantics$default, mutableInteractionSource, null, (r22 & 4) != 0, (r22 & 8) != 0 ? null : null, (r22 & 16) != 0 ? null : null, (r22 & 32) != 0 ? null : null, (r22 & 64) != 0 ? null : null, (r22 & 128) != 0 ? null : null, (Function0) rememberedValue2);
                    BoxKt.Box(m273combinedClickableXVZzFYc, startRestartGroup, 0);
                    isNullOrEmpty = TextLinkScopeKt.isNullOrEmpty(range.getItem().getStyles());
                    if (!isNullOrEmpty) {
                        startRestartGroup.startReplaceGroup(1384566902);
                        ComposerKt.sourceInformation(startRestartGroup, "178@7884L49,179@7988L110,179@7954L144,191@8539L1225,183@8120L1644");
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -370978971, "CC(remember):TextLinkScope.kt#9igjgp");
                        ...
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -370975582, "CC(remember):TextLinkScope.kt#9igjgp");
                        Object rememberedValue4 = startRestartGroup.rememberedValue();
                        if (rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue4 = (Function2) new TextLinkScope$LinksComposables$1$3$1(linkStateInteractionSourceObserver, mutableInteractionSource, null);
                        ...
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -370956835, "CC(remember):TextLinkScope.kt#9igjgp");
                        ...
                        startRestartGroup.startReplaceGroup(1386435086);
                        startRestartGroup.endReplaceGroup();
                    }
                    startRestartGroup.endReplaceGroup();
                } else {
                    startRestartGroup.startReplaceGroup(1386448974);
                    startRestartGroup.endReplaceGroup();
                }
                i4++;
                i3 = 2;
    ...
    public final void StyleAnnotation(final Object[] objArr, final Function1<? super TextAnnotatorScope, Unit> function1, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(StyleAnnotation)P(1)254@11281L117,254@11250L148:TextLinkScope.kt#423gt5");
        int i2 = (i & 48) == 0 ? (startRestartGroup.changedInstance(function1) ? 32 : 16) | i : i;
        if ((i & 384) == 0) {
            i2 |= startRestartGroup.changedInstance(this) ? 256 : 128;
        }
        startRestartGroup.startMovableGroup(-416686647, Integer.valueOf(objArr.length));
        ...
        if ((i2 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -416683411, "CC(remember):TextLinkScope.kt#9igjgp");
            boolean changedInstance = ((i2 & SdkConfig.SDK_VERSION) == 32) | startRestartGroup.changedInstance(this);
            Object rememberedValue = startRestartGroup.rememberedValue();
