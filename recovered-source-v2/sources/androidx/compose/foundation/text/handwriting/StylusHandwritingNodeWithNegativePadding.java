...
public final class StylusHandwritingNodeWithNegativePadding extends StylusHandwritingNode implements LayoutModifierNode {
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        final int i = measureScope.mo370roundToPx0680j_4(StylusHandwritingKt.getHandwritingBoundsVerticalOffset());
        final int i2 = measureScope.mo370roundToPx0680j_4(StylusHandwritingKt.getHandwritingBoundsHorizontalOffset());
        int i3 = i2 * 2;
        int i4 = i * 2;
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(ConstraintsKt.m6275offsetNN6EwU(j, i3, i4));
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth() - i3, mo5179measureBRTryo0.getHeight() - i4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.handwriting.StylusHandwritingNodeWithNegativePadding$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, Placeable.this, -i2, -i, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
