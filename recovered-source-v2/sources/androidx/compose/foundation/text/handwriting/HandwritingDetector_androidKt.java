...
public final class HandwritingDetector_androidKt {
    public static final Modifier handwritingDetector(Modifier modifier, Function0<Unit> function0) {
        return StylusHandwriting_androidKt.isStylusHandwritingSupported() ? PaddingKt.m685paddingVpY3zN4(modifier.then(new HandwritingDetectorElement(function0)), StylusHandwritingKt.getHandwritingBoundsHorizontalOffset(), StylusHandwritingKt.getHandwritingBoundsVerticalOffset()) : modifier;
    }
}
