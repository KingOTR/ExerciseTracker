...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo67measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m6255getMaxHeightimpl(j)) < Constraints.m6256getMaxWidthimpl(j) ? j : Constraints.m6247copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int min = Math.min(mo5179measureBRTryo0.getWidth(), Constraints.m6256getMaxWidthimpl(j));
        return MeasureScope.layout$default(measureScope, min, mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                cursorRectInScroller = TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo5179measureBRTryo0.getWidth());
                this.getScrollerPosition().update(Orientation.Horizontal, cursorRectInScroller, min, mo5179measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(placementScope, mo5179measureBRTryo0, Math.round(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
