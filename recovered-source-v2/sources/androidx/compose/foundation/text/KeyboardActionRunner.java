...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m1002runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> function1;
        Unit unit = null;
        if (ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5967getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5966getDefaulteUduSuo()) ? true : ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5970getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo1001defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo1001defaultKeyboardActionKlQnJC8(int imeAction) {
        if (ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5969getNexteUduSuo())) {
            getFocusManager().mo3529moveFocus3ESFkO8(FocusDirection.INSTANCE.m3524getNextdhqQ8s());
            return;
        }
        if (ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5971getPreviouseUduSuo())) {
            getFocusManager().mo3529moveFocus3ESFkO8(FocusDirection.INSTANCE.m3525getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5967getDoneeUduSuo())) {
            if (ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5968getGoeUduSuo()) ? true : ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5972getSearcheUduSuo()) ? true : ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5973getSendeUduSuo()) ? true : ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5966getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m5953equalsimpl0(imeAction, ImeAction.INSTANCE.m5970getNoneeUduSuo());
        } else {
