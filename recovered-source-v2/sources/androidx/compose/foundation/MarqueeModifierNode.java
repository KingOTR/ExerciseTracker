...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m310boximpl(i2), null, 2, null);
    ...
    public final int m324getAnimationModeZbEOnfQ() {
    ...
    public final void m325setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m310boximpl(i));
    }
    ...
    public final void m326updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m325setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m6308equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.m6273constrainWidthK40F9xA(j, mo5179measureBRTryo0.getWidth()));
        setContentWidth(mo5179measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float m3668getHeightimpl = Size.m3668getHeightimpl(contentDrawScope2.mo4399getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo4323clipRectN_I0leg(floatValue, 0.0f, containerWidth, m3668getHeightimpl, m3832getIntersectrtfAjoo);
            if (z) {
