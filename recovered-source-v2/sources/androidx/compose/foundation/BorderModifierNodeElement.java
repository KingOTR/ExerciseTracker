...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m259copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m261copy8Feqmps(f, brush, shape);
    }
    ...
    public final BorderModifierNodeElement m261copy8Feqmps(float width, Brush brush, Shape shape) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6308equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m6309hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m6314toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }

    /* renamed from: getWidth-D9Ej5fM, reason: not valid java name */
    public final float m262getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public void update(BorderModifierNode node) {
        node.m258setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(Property.ICON_TEXT_FIT_WIDTH, Dp.m6301boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m3833boximpl(((SolidColor) this.brush).getValue()));
            inspectorInfo.setValue(Color.m3833boximpl(((SolidColor) this.brush).getValue()));
        } else {
