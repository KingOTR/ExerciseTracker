...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo878invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m6249equalsimpl0(this.cachedConstraints, constraints) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m6244boximpl(constraints));
