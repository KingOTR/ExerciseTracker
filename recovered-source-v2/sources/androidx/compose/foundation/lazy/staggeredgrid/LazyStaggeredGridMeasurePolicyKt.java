        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyStaggeredGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m897invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridMeasureResult m897invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    float beforePadding;
                    float afterPadding;
                    float startPadding;
                    long IntOffset;
                    ObservableScopeInvalidator.m858attachToScopeimpl(LazyStaggeredGridState.this.m902getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                    CheckScrollableContainerConstraintsKt.m267checkScrollableContainerConstraintsK40F9xA(j, orientation);
                    LazyStaggeredGridSlots mo878invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider.mo878invoke0kLqBqw(lazyLayoutMeasureScope, j);
                    ...
                    int i2 = lazyLayoutMeasureScope.mo370roundToPx0680j_4(beforePadding);
                    ...
                    int i3 = lazyLayoutMeasureScope.mo370roundToPx0680j_4(afterPadding);
                    ...
                    int i4 = lazyLayoutMeasureScope.mo370roundToPx0680j_4(startPadding);
                    int m6255getMaxHeightimpl = ((z2 ? Constraints.m6255getMaxHeightimpl(j) : Constraints.m6256getMaxWidthimpl(j)) - i2) - i3;
                    if (z2) {
                    ...
                    int i5 = lazyLayoutMeasureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues3 = paddingValues;
                    boolean z3 = z2;
                    LazyStaggeredGridMeasureResult m895measureStaggeredGridXtK8cYQ = LazyStaggeredGridMeasureKt.m895measureStaggeredGridXtK8cYQ(lazyLayoutMeasureScope, LazyStaggeredGridState.this, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, LazyStaggeredGridState.this.getPinnedItems(), LazyStaggeredGridState.this.getBeyondBoundsInfo()), invoke, mo878invoke0kLqBqw, Constraints.m6247copyZbe2FdA$default(j, ConstraintsKt.m6273constrainWidthK40F9xA(j, i5), 0, ConstraintsKt.m6272constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(paddingValues3.getTop() + paddingValues3.getBottom()))), 0, 10, null), z3, z, j2, m6255getMaxHeightimpl, lazyLayoutMeasureScope.mo370roundToPx0680j_4(f), i2, i3, coroutineScope, graphicsContext);
                    LazyStaggeredGridState.applyMeasureResult$foundation_release$default(LazyStaggeredGridState.this, m895measureStaggeredGridXtK8cYQ, false, 2, null);
                    return m895measureStaggeredGridXtK8cYQ;
                }
            };
