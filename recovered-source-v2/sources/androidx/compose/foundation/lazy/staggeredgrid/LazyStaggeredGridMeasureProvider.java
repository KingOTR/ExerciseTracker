...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo892createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m898childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6268fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m6267fixedHeightOenEA2s(i);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m899getAndMeasurejy6DScQ(int index, long span) {
        ...
        long m898childConstraintsJhjzzOo = m898childConstraintsJhjzzOo(coerceAtMost, coerceAtMost2);
        return mo892createItempitSLOA(index, coerceAtMost, coerceAtMost2, key, contentType, this.measureScope.mo855measure0kLqBqw(index, m898childConstraintsJhjzzOo), m898childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc, reason: avoid collision after fix types in other method */
    public LazyStaggeredGridMeasuredItem mo798getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo892createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo855measure0kLqBqw(index, constraints), constraints);
    }
