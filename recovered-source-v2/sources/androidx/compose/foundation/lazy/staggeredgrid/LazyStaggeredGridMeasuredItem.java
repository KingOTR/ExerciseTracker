...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m6431getXimpl(getOffset()) : IntOffset.m6432getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (animation != null) {
                ...
                if ((m901getMainAxisgyyYBs(offset) <= height && m901getMainAxisgyyYBs(m6435plusqkQi6aY) <= height) || (m901getMainAxisgyyYBs(offset) >= i2 && m901getMainAxisgyyYBs(m6435plusqkQi6aY) >= i2)) {
            ...
            if (context.getReverseLayout()) {
                if (getIsVertical()) {
                    m6431getXimpl = IntOffset.m6431getXimpl(offset);
                } else {
                    m6431getXimpl = (this.mainAxisLayoutSize - IntOffset.m6431getXimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (!getIsVertical()) {
                    m6432getYimpl = IntOffset.m6432getYimpl(offset);
                } else {
                    m6432getYimpl = (this.mainAxisLayoutSize - IntOffset.m6432getYimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                offset = IntOffsetKt.IntOffset(m6431getXimpl, m6432getYimpl);
            }
            long m6435plusqkQi6aY2 = IntOffset.m6435plusqkQi6aY(offset, context.getContentOffset());
            if (animation != null) {
    ...
    private final int m901getMainAxisgyyYBs(long j) {
    ...
    private final long m900copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
