...
public final class LazyListState implements ScrollableState {
        ...
        this.prefetchScope = new LazyListPrefetchScope() { // from class: androidx.compose.foundation.lazy.LazyListState$prefetchScope$1
            ...
            public LazyLayoutPrefetchState.PrefetchHandle schedulePrefetch(int index) {
                ...
                try {
                    ...
                    return LazyListState.this.getPrefetchState().m856schedulePrefetch0kLqBqw(index, childConstraints);
                } catch (Throwable th) {
                    companion.restoreNonObservable(currentThreadSnapshot, makeCurrentNonObservable, readObserver);
                    throw th;
                }
    ...
    public final MutableState<Unit> m801getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
        ...
        if (continuation instanceof LazyListState$scroll$1) {
            ...
            if ((lazyListState$scroll$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    this = (LazyListState) lazyListState$scroll$1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
    ...
    public final MutableState<Unit> m802getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    private final void updateScrollDeltaForPostLookahead(float delta, Density density, CoroutineScope coroutineScope) {
        ...
        if (delta <= density.mo376toPx0680j_4(f)) {
            return;
        }
        Snapshot.Companion companion = Snapshot.INSTANCE;
        Snapshot currentThreadSnapshot = companion.getCurrentThreadSnapshot();
