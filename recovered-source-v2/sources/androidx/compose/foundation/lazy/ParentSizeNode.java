...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int m6258getMinWidthimpl = round != Integer.MAX_VALUE ? round : Constraints.m6258getMinWidthimpl(j);
        int m6257getMinHeightimpl = round2 != Integer.MAX_VALUE ? round2 : Constraints.m6257getMinHeightimpl(j);
        if (round == Integer.MAX_VALUE) {
            round = Constraints.m6256getMaxWidthimpl(j);
        }
        if (round2 == Integer.MAX_VALUE) {
            round2 = Constraints.m6255getMaxHeightimpl(j);
        }
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(ConstraintsKt.Constraints(m6258getMinWidthimpl, round, m6257getMinHeightimpl, round2));
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }
