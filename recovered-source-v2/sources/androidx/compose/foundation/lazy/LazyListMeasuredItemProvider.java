...
public abstract class LazyListMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo787createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m6256getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m6255getMaxHeightimpl(j), 5, null);
    }
    ...
    public LazyListMeasuredItem mo798getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m799getAndMeasure0kLqBqw(index, constraints);
    }

    /* renamed from: getAndMeasure-0kLqBqw$default, reason: not valid java name */
    public static /* synthetic */ LazyListMeasuredItem m797getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, long j, int i2, Object obj) {
        if (obj != null) {
        ...
        return lazyListMeasuredItemProvider.m799getAndMeasure0kLqBqw(i, j);
    }

    /* renamed from: getAndMeasure-0kLqBqw, reason: not valid java name */
    public final LazyListMeasuredItem m799getAndMeasure0kLqBqw(int index, long constraints) {
        return mo787createItemX9ElhV4(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo855measure0kLqBqw(index, constraints), constraints);
    }
