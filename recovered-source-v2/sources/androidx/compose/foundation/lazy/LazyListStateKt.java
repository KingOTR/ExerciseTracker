...
public final class LazyListStateKt {
    private static final float DeltaThresholdForScrollAnimation = Dp.m6303constructorimpl(1);
    ...
    public static final LazyListState rememberLazyListState(final int i, final int i2, Composer composer, int i3, int i4) {
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m3429rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final LazyListState rememberLazyListState(int i, int i2, LazyListPrefetchStrategy lazyListPrefetchStrategy, Composer composer, int i3, int i4) {
        ...
        boolean z = ((((i3 & 14) ^ 6) > 4 && composer.changed(i5)) || (i3 & 6) == 4) | ((((i3 & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(i6)) || (i3 & 48) == 32) | ((((i3 & 896) ^ 384) > 256 && composer.changedInstance(lazyListPrefetchStrategy2)) || (i3 & 384) == 256);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m3429rememberSaveable(objArr, (Saver) saver$foundation_release, (String) null, (Function0) rememberedValue2, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
