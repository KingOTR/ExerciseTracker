...
public final class LazyListMeasureKt {
    ...
    public static final LazyListMeasureResult m791measureLazyListx0Ok8Vo(int i, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, List<Integer> list, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyLayoutItemAnimator<LazyListMeasuredItem> lazyLayoutItemAnimator, int i8, List<Integer> list2, boolean z3, final boolean z4, LazyListLayoutInfo lazyListLayoutInfo, CoroutineScope coroutineScope, final MutableState<Unit> mutableState, GraphicsContext graphicsContext, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i <= 0) {
            ...
            lazyLayoutItemAnimator.onMeasured(0, m6258getMinWidthimpl, m6257getMinHeightimpl, new ArrayList(), lazyListMeasuredItemProvider.getKeyIndexMap(), lazyListMeasuredItemProvider, z, z4, 1, z3, 0, 0, coroutineScope, graphicsContext);
            if (!z4) {
                long m849getMinSizeToFitDisappearingItemsYbymL2g = lazyLayoutItemAnimator.m849getMinSizeToFitDisappearingItemsYbymL2g();
                if (!IntSize.m6471equalsimpl0(m849getMinSizeToFitDisappearingItemsYbymL2g, IntSize.INSTANCE.m6478getZeroYbymL2g())) {
                    m6258getMinWidthimpl = ConstraintsKt.m6273constrainWidthK40F9xA(j, IntSize.m6473getWidthimpl(m849getMinSizeToFitDisappearingItemsYbymL2g));
                    m6257getMinHeightimpl = ConstraintsKt.m6272constrainHeightK40F9xA(j, IntSize.m6472getHeightimpl(m849getMinSizeToFitDisappearingItemsYbymL2g));
                }
            }
            return new LazyListMeasureResult(null, 0, false, 0.0f, function3.invoke(Integer.valueOf(m6258getMinWidthimpl), Integer.valueOf(m6257getMinHeightimpl), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$3
        ...
        while (i26 < 0 && i22 > 0) {
            ...
            LazyListMeasuredItem m797getAndMeasure0kLqBqw$default = LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i28, 0L, 2, null);
            arrayDeque4.add(0, m797getAndMeasure0kLqBqw$default);
            i27 = Math.max(i27, m797getAndMeasure0kLqBqw$default.getCrossAxisSize());
            i26 += m797getAndMeasure0kLqBqw$default.getMainAxisSizeWithSpacings();
        ...
        while (i39 < i && (i38 < coerceAtLeast || i38 <= 0 || arrayDeque5.isEmpty())) {
            ...
            int i45 = i33;
            LazyListMeasuredItem m797getAndMeasure0kLqBqw$default2 = LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i39, 0L, 2, null);
            i38 += m797getAndMeasure0kLqBqw$default2.getMainAxisSizeWithSpacings();
            if (i38 <= i29) {
                i20 = i42;
                if (i20 != i - 1) {
                    i40 -= m797getAndMeasure0kLqBqw$default2.getMainAxisSizeWithSpacings();
                    i37 = i20 + 1;
                    z6 = true;
                    i41 = i43;
                    i39 = i20 + 1;
            ...
            int max = Math.max(i43, m797getAndMeasure0kLqBqw$default2.getCrossAxisSize());
            arrayDeque5.add(m797getAndMeasure0kLqBqw$default2);
            i41 = max;
            i39 = i20 + 1;
            coerceAtLeast = i44;
            i33 = i45;
        ...
        if (i38 < i2) {
            ...
            while (i51 < i3 && i50 > 0) {
                int i53 = i50 - 1;
                LazyListMeasuredItem m797getAndMeasure0kLqBqw$default3 = LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i53, 0L, 2, null);
                arrayDeque5.add(0, m797getAndMeasure0kLqBqw$default3);
                i52 = Math.max(i52, m797getAndMeasure0kLqBqw$default3.getCrossAxisSize());
                i51 += m797getAndMeasure0kLqBqw$default3.getMainAxisSizeWithSpacings();
                i47 = i47;
                i50 = i53;
            }
            int i54 = i51;
        ...
        int m6273constrainWidthK40F9xA = ConstraintsKt.m6273constrainWidthK40F9xA(j, i19);
        if (z) {
            i62 = i12;
        }
        int m6272constrainHeightK40F9xA = ConstraintsKt.m6272constrainHeightK40F9xA(j, i62);
        final List<LazyListMeasuredItem> calculateItemsOffsets = calculateItemsOffsets(arrayDeque6, createItemsBeforeList, createItemsAfterList, m6273constrainWidthK40F9xA, m6272constrainHeightK40F9xA, i12, i2, i61, z, vertical, horizontal, z2, density);
        lazyLayoutItemAnimator.onMeasured((int) f6, m6273constrainWidthK40F9xA, m6272constrainHeightK40F9xA, calculateItemsOffsets, lazyListMeasuredItemProvider.getKeyIndexMap(), lazyListMeasuredItemProvider, z, z4, 1, z3, i18, i12, coroutineScope, graphicsContext);
        if (z4) {
            ...
            f2 = f6;
            lazyListMeasuredItem2 = lazyListMeasuredItem5;
            long m849getMinSizeToFitDisappearingItemsYbymL2g2 = lazyLayoutItemAnimator.m849getMinSizeToFitDisappearingItemsYbymL2g();
            arrayDeque2 = arrayDeque;
            if (!IntSize.m6471equalsimpl0(m849getMinSizeToFitDisappearingItemsYbymL2g2, IntSize.INSTANCE.m6478getZeroYbymL2g())) {
                int i64 = z ? m6272constrainHeightK40F9xA : m6273constrainWidthK40F9xA;
                m6273constrainWidthK40F9xA = ConstraintsKt.m6273constrainWidthK40F9xA(j, Math.max(m6273constrainWidthK40F9xA, IntSize.m6473getWidthimpl(m849getMinSizeToFitDisappearingItemsYbymL2g2)));
                m6272constrainHeightK40F9xA = ConstraintsKt.m6272constrainHeightK40F9xA(j, Math.max(m6272constrainHeightK40F9xA, IntSize.m6472getHeightimpl(m849getMinSizeToFitDisappearingItemsYbymL2g2)));
                int i65 = z ? m6272constrainHeightK40F9xA : m6273constrainWidthK40F9xA;
                if (i65 != i64) {
        ...
        int i67 = m6273constrainWidthK40F9xA;
        int i68 = m6272constrainHeightK40F9xA;
        final LazyListMeasuredItem findOrComposeLazyListHeader = !list.isEmpty() ? LazyListHeadersKt.findOrComposeLazyListHeader(calculateItemsOffsets, lazyListMeasuredItemProvider, list, i3, i67, i68) : null;
        ...
        MeasureResult invoke = function3.invoke(Integer.valueOf(i67), Integer.valueOf(i68), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$8
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                ObservableScopeInvalidator.m858attachToScopeimpl(mutableState);
            }
        });
        if (z7) {
    ...
    private static final List<LazyListMeasuredItem> createItemsAfterList(List<LazyListMeasuredItem> list, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, int i2, List<Integer> list2, float f, boolean z, LazyListLayoutInfo lazyListLayoutInfo) {
        ...
        if (index2 <= min2) {
            ...
            while (true) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, index2, 0L, 2, null));
                if (index2 == min2) {
                    break;
                }
                index2++;
            ...
            if (lazyListItemInfo != null && (index = lazyListItemInfo.getIndex()) <= (min = Math.min(lazyListItemInfo2.getIndex(), i3))) {
                while (true) {
                    ...
                    if (lazyListMeasuredItem4 == null) {
                        ...
                        arrayList.add(LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, index, 0L, 2, null));
                    }
                    if (index == min) {
                        break;
                    }
            ...
            if (viewportEndOffset > 0.0f) {
                ...
                while (index3 < i && i5 < viewportEndOffset) {
                    ...
                    if (lazyListMeasuredItem != null) {
                        ...
                        arrayList.add(LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, index3, 0L, 2, null));
                        index3++;
        ...
        for (int i8 = 0; i8 < size5; i8++) {
            ...
            if (intValue > min2) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, intValue, 0L, 2, null));
            }
        }
    ...
    private static final List<LazyListMeasuredItem> createItemsBeforeList(int i, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i2, List<Integer> list) {
        ...
        if (max <= i3) {
            while (true) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i3, 0L, 2, null));
                if (i3 == max) {
                    break;
                }
                i3--;
