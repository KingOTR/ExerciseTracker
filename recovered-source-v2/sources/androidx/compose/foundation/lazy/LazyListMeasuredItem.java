...
public final class LazyListMeasuredItem implements LazyListItemInfo, LazyLayoutMeasuredItem {
        ...
        if (updateAnimations) {
            ...
            for (int i2 = 0; i2 < placeablesCount; i2++) {
                ...
                if (animation != null) {
                    ...
                    int m6431getXimpl = getIsVertical() ? IntOffset.m6431getXimpl(rawOffset) : Integer.valueOf(IntOffset.m6431getXimpl(rawOffset) + delta).intValue();
                    boolean isVertical = getIsVertical();
                    int m6432getYimpl = IntOffset.m6432getYimpl(rawOffset);
                    if (isVertical) {
                        m6432getYimpl += delta;
                    }
                    animation.m847setRawOffsetgyyYBs(IntOffsetKt.IntOffset(m6431getXimpl, m6432getYimpl));
                }
            }
        }
    }
    ...
    public final void place(Placeable.PlacementScope scope, boolean isLookingAhead) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long mo796getOffsetBjo55l4 = mo796getOffsetBjo55l4(i);
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), i);
            if (animation != null) {
                if (isLookingAhead) {
                    animation.m846setLookaheadOffsetgyyYBs(mo796getOffsetBjo55l4);
                } else {
                    if (!IntOffset.m6430equalsimpl0(animation.getLookaheadOffset(), LazyLayoutItemAnimation.INSTANCE.m848getNotInitializednOccac())) {
                        mo796getOffsetBjo55l4 = animation.getLookaheadOffset();
                    }
                    long m6435plusqkQi6aY = IntOffset.m6435plusqkQi6aY(mo796getOffsetBjo55l4, animation.m843getPlacementDeltanOccac());
                    if ((m794getMainAxisgyyYBs(mo796getOffsetBjo55l4) <= mainAxisSize && m794getMainAxisgyyYBs(m6435plusqkQi6aY) <= mainAxisSize) || (m794getMainAxisgyyYBs(mo796getOffsetBjo55l4) >= i2 && m794getMainAxisgyyYBs(m6435plusqkQi6aY) >= i2)) {
                        animation.cancelPlacementAnimation();
                    }
                    mo796getOffsetBjo55l4 = m6435plusqkQi6aY;
                }
            ...
            if (this.reverseLayout) {
                int m6431getXimpl = getIsVertical() ? IntOffset.m6431getXimpl(mo796getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m6431getXimpl(mo796getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (getIsVertical()) {
                    m6432getYimpl = (this.mainAxisLayoutSize - IntOffset.m6432getYimpl(mo796getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m6432getYimpl = IntOffset.m6432getYimpl(mo796getOffsetBjo55l4);
                }
                mo796getOffsetBjo55l4 = IntOffsetKt.IntOffset(m6431getXimpl, m6432getYimpl);
            }
            long m6435plusqkQi6aY2 = IntOffset.m6435plusqkQi6aY(mo796getOffsetBjo55l4, this.visualOffset);
    ...
    private final int m794getMainAxisgyyYBs(long j) {
    ...
    private final long m793copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
