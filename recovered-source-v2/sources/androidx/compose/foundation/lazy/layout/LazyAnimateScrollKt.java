...
public final class LazyAnimateScrollKt {
    ...
    private static final float TargetDistance = Dp.m6303constructorimpl(2500);
    private static final float BoundDistance = Dp.m6303constructorimpl(ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    private static final float MinimumDistance = Dp.m6303constructorimpl(50);
