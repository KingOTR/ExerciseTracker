...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m869schedulePrefetchVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    public final PrefetchRequest m868createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    private final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        public boolean execute(PrefetchRequestScope prefetchRequestScope) {
            ...
            if (!this.isMeasured && !Constraints.m6260isZeroimpl(this.constraints)) {
                ...
                try {
                    m870performMeasureBRTryo0(this.constraints);
        ...
        private final void m870performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                precomposedSlotHandle.mo5205premeasure0kLqBqw(i, constraints);
            }
        }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m6261toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
