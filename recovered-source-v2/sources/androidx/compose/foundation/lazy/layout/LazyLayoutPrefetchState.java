...
public final class LazyLayoutPrefetchState {
    ...
    public final PrefetchHandle schedulePrefetch(int index) {
        ...
        return m856schedulePrefetch0kLqBqw(index, j);
    }

    /* renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m856schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle m869schedulePrefetchVKLhPVY;
        PrefetchHandleProvider prefetchHandleProvider = this.prefetchHandleProvider;
        return (prefetchHandleProvider == null || (m869schedulePrefetchVKLhPVY = prefetchHandleProvider.m869schedulePrefetchVKLhPVY(index, constraints, this.prefetchMetrics)) == null) ? DummyHandle.INSTANCE : m869schedulePrefetchVKLhPVY;
    }
    ...
    private final class NestedPrefetchScopeImpl implements NestedPrefetchScope {
        ...
        public void schedulePrefetch(int index) {
            long j;
            j = LazyLayoutPrefetchStateKt.ZeroConstraints;
            mo857schedulePrefetch0kLqBqw(index, j);
        }

        @Override // androidx.compose.foundation.lazy.layout.NestedPrefetchScope
        /* renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
        public void mo857schedulePrefetch0kLqBqw(int index, long constraints) {
            PrefetchHandleProvider prefetchHandleProvider = LazyLayoutPrefetchState.this.getPrefetchHandleProvider();
            if (prefetchHandleProvider == null) {
                return;
            }
            this._requests.add(prefetchHandleProvider.m868createNestedPrefetchRequestVKLhPVY(index, constraints, LazyLayoutPrefetchState.this.prefetchMetrics));
        }
    }
}
