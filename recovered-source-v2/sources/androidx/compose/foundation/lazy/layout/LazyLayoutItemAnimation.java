...
public final class LazyLayoutItemAnimation {
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.INSTANCE.m6441getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m6422boximpl(IntOffset.INSTANCE.m6441getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, null, 12, null);
        ...
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m6422boximpl(IntOffset.INSTANCE.m6441getZeronOccac()), null, 2, null);
    ...
    public final void m847setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public final void m845setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m839setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m6422boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m843getPlacementDeltanOccac() {
    ...
    public final void m846setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso, reason: not valid java name */
    public final void m840animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long m6434minusqkQi6aY = IntOffset.m6434minusqkQi6aY(m843getPlacementDeltanOccac(), delta);
        m839setPlacementDeltagyyYBs(m6434minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = isMovingAway;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, m6434minusqkQi6aY, null), 3, null);
    }
    ...
    public final void release() {
        ...
        m839setPlacementDeltagyyYBs(IntOffset.INSTANCE.m6441getZeronOccac());
    ...
    public static final class Companion {
        ...
        public final long m848getNotInitializednOccac() {
