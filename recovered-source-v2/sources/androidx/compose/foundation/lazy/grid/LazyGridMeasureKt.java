...
public final class LazyGridMeasureKt {
    ...
    public static final LazyGridMeasureResult m825measureLazyGridOZKpZRA(int i, LazyGridMeasuredLineProvider lazyGridMeasuredLineProvider, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, int i8, List<Integer> list, CoroutineScope coroutineScope, final MutableState<Unit> mutableState, GraphicsContext graphicsContext, Function1<? super Integer, ? extends List<Pair<Integer, Constraints>>> function1, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i <= 0) {
            ...
            lazyLayoutItemAnimator.onMeasured(0, m6258getMinWidthimpl, m6257getMinHeightimpl, new ArrayList(), lazyGridMeasuredItemProvider.getKeyIndexMap(), lazyGridMeasuredItemProvider, z, false, i8, false, 0, 0, coroutineScope, graphicsContext);
            ...
            return new LazyGridMeasureResult(null, 0, false, 0.0f, function3.invoke(Integer.valueOf(m6258getMinWidthimpl), Integer.valueOf(m6257getMinHeightimpl), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$3
        ...
        while (i49 < size) {
            ...
            if (intValue < 0 || intValue >= index) {
                ...
                i21 = i35;
                i22 = i10;
                LazyGridMeasuredItem mo798getAndMeasurehBUhpc = lazyGridMeasuredItemProvider.mo798getAndMeasurehBUhpc(intValue, 0, spanOf, lazyGridMeasuredLineProvider.m829childConstraintsJhjzzOo$foundation_release(0, spanOf));
                ArrayList arrayList2 = list3 == null ? new ArrayList() : list3;
                arrayList2.add(mo798getAndMeasurehBUhpc);
                list3 = arrayList2;
            }
            i49++;
            i12 = i18;
        ...
        while (i56 < size2) {
            ...
            if (i51 + 1 > intValue2 || intValue2 >= i) {
                ...
                i16 = i56;
                LazyGridMeasuredItem mo798getAndMeasurehBUhpc2 = lazyGridMeasuredItemProvider.mo798getAndMeasurehBUhpc(intValue2, 0, spanOf2, lazyGridMeasuredLineProvider.m829childConstraintsJhjzzOo$foundation_release(0, spanOf2));
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                List list5 = arrayList;
                list5.add(mo798getAndMeasurehBUhpc2);
                arrayList = list5;
            }
            i56 = i16 + 1;
        }
        ...
        if (z) {
            ...
            m6273constrainWidthK40F9xA = ConstraintsKt.m6273constrainWidthK40F9xA(j, i9);
        }
        int i59 = m6273constrainWidthK40F9xA;
        if (z) {
            m6255getMaxHeightimpl = ConstraintsKt.m6272constrainHeightK40F9xA(j, i9);
        } else {
            m6255getMaxHeightimpl = Constraints.m6255getMaxHeightimpl(j);
        }
        int i60 = m6255getMaxHeightimpl;
        int i61 = i9;
        ...
        if (IntSize.m6471equalsimpl0(m849getMinSizeToFitDisappearingItemsYbymL2g2, IntSize.INSTANCE.m6478getZeroYbymL2g())) {
            ...
            int i62 = z ? i60 : i59;
            int m6273constrainWidthK40F9xA2 = ConstraintsKt.m6273constrainWidthK40F9xA(j, Math.max(i59, IntSize.m6473getWidthimpl(m849getMinSizeToFitDisappearingItemsYbymL2g2)));
            i14 = ConstraintsKt.m6272constrainHeightK40F9xA(j, Math.max(i60, IntSize.m6472getHeightimpl(m849getMinSizeToFitDisappearingItemsYbymL2g2)));
            int i63 = z ? i14 : m6273constrainWidthK40F9xA2;
            if (i63 != i62) {
            ...
            i15 = m6273constrainWidthK40F9xA2;
        }
        if (i51 == i - 1 && i61 <= i2) {
            z3 = false;
        }
    ...
    private static final List<LazyGridMeasuredItem> calculateExtraItems(List<Integer> list, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, LazyGridMeasuredLineProvider lazyGridMeasuredLineProvider, Function1<? super Integer, Boolean> function1) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (function1.invoke(Integer.valueOf(intValue)).booleanValue()) {
                ...
                arrayList.add(mo798getAndMeasurehBUhpc);
            }
        }
