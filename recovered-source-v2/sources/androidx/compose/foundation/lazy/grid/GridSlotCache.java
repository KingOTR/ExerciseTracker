...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo811invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m6244boximpl(constraints));
