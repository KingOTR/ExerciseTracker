...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m829childConstraintsJhjzzOo$foundation_release(int startSlot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6268fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.INSTANCE.m6267fixedHeightOenEA2s(coerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int m807getCurrentLineSpanimpl = GridItemSpan.m807getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i3).getPackedValue());
            LazyGridMeasuredItem m828getAndMeasurem8Kt_7k = this.measuredItemProvider.m828getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i3, m829childConstraintsJhjzzOo$foundation_release(i2, m807getCurrentLineSpanimpl), i2, m807getCurrentLineSpanimpl, i);
            i2 += m807getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i3] = m828getAndMeasurem8Kt_7k;
        }
