...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int currentSlotsPerLine) {
        ...
        for (int i = 0; i < currentSlotsPerLine; i++) {
            arrayList.add(GridItemSpan.m803boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    */
    public final LineConfiguration getLineConfiguration(int lineIndex) {
        ...
        while (i8 < this.slotsPerLine && i9 < getTotalSize()) {
            ...
            i9++;
            arrayList.add(GridItemSpan.m803boximpl(LazyGridSpanKt.GridItemSpan(firstItemKnownSpan)));
    ...
    public final int spanOf(int itemIndex, int maxSpan) {
        ...
        return GridItemSpan.m807getCurrentLineSpanimpl(interval.getValue().getSpan().invoke(lazyGridItemSpanScopeImpl, Integer.valueOf(itemIndex - interval.getStartIndex())).getPackedValue());
    }
