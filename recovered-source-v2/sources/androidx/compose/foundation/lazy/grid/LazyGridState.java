...
public final class LazyGridState implements ScrollableState {
            ...
            public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex) {
                ...
                try {
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        arrayList.add(lazyGridState.getPrefetchState().m856schedulePrefetch0kLqBqw(pair.getFirst().intValue(), pair.getSecond().getValue()));
                    }
    ...
    public final MutableState<Unit> m831getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m830getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
        ...
        if (continuation instanceof LazyGridState$scroll$1) {
            ...
            if ((lazyGridState$scroll$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    this = (LazyGridState) lazyGridState$scroll$1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
