...
public final class LazyListHeadersKt {
    public static final LazyListMeasuredItem findOrComposeLazyListHeader(List<LazyListMeasuredItem> list, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, List<Integer> list2, int i, int i2, int i3) {
        ...
        LazyListMeasuredItem m797getAndMeasure0kLqBqw$default = LazyListMeasuredItemProvider.m797getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i5, 0L, 2, null);
        m797getAndMeasure0kLqBqw$default.setNonScrollableItem(true);
        int max = i7 != Integer.MIN_VALUE ? Math.max(-i, i7) : -i;
        if (i8 != Integer.MIN_VALUE) {
            max = Math.min(max, i8 - m797getAndMeasure0kLqBqw$default.getSize());
        }
        m797getAndMeasure0kLqBqw$default.position(max, i2, i3);
        if (i9 != -1) {
            list.set(i9, m797getAndMeasure0kLqBqw$default);
        } else {
            list.add(0, m797getAndMeasure0kLqBqw$default);
        }
        return m797getAndMeasure0kLqBqw$default;
    }
}
