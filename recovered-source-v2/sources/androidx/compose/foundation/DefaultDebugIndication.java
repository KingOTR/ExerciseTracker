...
final class DefaultDebugIndication implements IndicationNodeFactory {
    ...
    static final class DefaultDebugIndicationInstance extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed) {
                DrawScope.m4393drawRectnJ9OG0$default(contentDrawScope, Color.m3842copywmQWz5c$default(Color.INSTANCE.m3869getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo4399getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered || this.isFocused) {
                DrawScope.m4393drawRectnJ9OG0$default(contentDrawScope, Color.m3842copywmQWz5c$default(Color.INSTANCE.m3869getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo4399getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
}
