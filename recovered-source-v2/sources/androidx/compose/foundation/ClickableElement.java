...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public void update(ClickableNode node) {
        node.m280updateQzZPfjk(this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.m5595hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
