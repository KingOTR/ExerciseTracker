...
final class DrawStretchOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        boolean z;
        this.overscrollEffect.m223updateSizeuvyYCjk$foundation_release(contentDrawScope.mo4399getSizeNHjbRc());
        if (Size.m3673isEmptyimpl(contentDrawScope.mo4399getSizeNHjbRc())) {
            contentDrawScope.drawContent();
            return;
        }
        this.overscrollEffect.getRedrawSignal$foundation_release().getValue();
        float f = contentDrawScope.mo376toPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        ...
        if (edgeEffectWrapper.isLeftAnimating()) {
            ...
            if (edgeEffectWrapper.isLeftStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateLeftEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect), 1 - Offset.m3603getYimpl(this.overscrollEffect.m222displacementF1C5BW0$foundation_release()));
            }
        } else {
            z = false;
        }
        ...
        if (edgeEffectWrapper.isTopAnimating()) {
            ...
            if (edgeEffectWrapper.isTopStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateTopEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect), Offset.m3602getXimpl(this.overscrollEffect.m222displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isRightAnimating()) {
            ...
            if (edgeEffectWrapper.isRightStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateRightEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect), Offset.m3603getYimpl(this.overscrollEffect.m222displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isBottomAnimating()) {
            ...
            if (edgeEffectWrapper.isBottomStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateBottomEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect), 1 - Offset.m3602getXimpl(this.overscrollEffect.m222displacementF1C5BW0$foundation_release()));
            }
            z = z2;
        }
        if (z) {
        ...
        long j = contentDrawScope.mo4399getSizeNHjbRc();
        ...
        long mo4320getSizeNHjbRc = contentDrawScope2.getDrawContext().mo4320getSizeNHjbRc();
