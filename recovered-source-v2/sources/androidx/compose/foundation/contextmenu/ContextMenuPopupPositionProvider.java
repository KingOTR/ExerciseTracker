...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo348calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m6431getXimpl(this.localPosition), IntSize.m6473getWidthimpl(popupContentSize), IntSize.m6473getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m6432getYimpl(this.localPosition), IntSize.m6472getHeightimpl(popupContentSize), IntSize.m6472getHeightimpl(windowSize), false, 8, null));
    }
}
