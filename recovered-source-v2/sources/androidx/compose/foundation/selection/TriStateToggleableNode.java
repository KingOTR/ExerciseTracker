...
final class TriStateToggleableNode extends ClickableNode {
    ...
    public final void m949updateQzZPfjk(ToggleableState state, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> onClick) {
        if (this.state != state) {
            this.state = state;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m280updateQzZPfjk(interactionSource, indicationNodeFactory, enabled, (String) null, role, onClick);
    }
