...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        CheckScrollableContainerConstraintsKt.m267checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m6256getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m6255getMaxHeightimpl(j), 5, null));
        int coerceAtMost = RangesKt.coerceAtMost(mo5179measureBRTryo0.getWidth(), Constraints.m6256getMaxWidthimpl(j));
        int coerceAtMost2 = RangesKt.coerceAtMost(mo5179measureBRTryo0.getHeight(), Constraints.m6255getMaxHeightimpl(j));
        final int height = mo5179measureBRTryo0.getHeight() - coerceAtMost2;
        int width = mo5179measureBRTryo0.getWidth() - coerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
