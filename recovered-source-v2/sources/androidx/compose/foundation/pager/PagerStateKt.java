...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m6303constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        boolean z = ((((i2 & 14) ^ 6) > 4 && composer.changed(i)) || (i2 & 6) == 4) | ((((i2 & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(f)) || (i2 & 48) == 32) | ((((i2 & 896) ^ 384) > 256 && composer.changed(function0)) || (i2 & 384) == 256);
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m3429rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int m6473getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m6473getWidthimpl(pagerLayoutInfo.mo923getViewportSizeYbymL2g()) : IntSize.m6472getHeightimpl(pagerLayoutInfo.mo923getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast(pageSpacing - (m6473getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(m6473getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, m6473getWidthimpl)), 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int m6473getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m6473getWidthimpl(pagerMeasureResult.mo923getViewportSizeYbymL2g()) : IntSize.m6472getHeightimpl(pagerMeasureResult.mo923getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(m6473getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, m6473getWidthimpl);
    }
