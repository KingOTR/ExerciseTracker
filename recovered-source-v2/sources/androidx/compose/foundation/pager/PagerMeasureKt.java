...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m926measurePagerbmk8ZPk(final LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, final PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, long j, final Orientation orientation, final Alignment.Vertical vertical, final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, List<Integer> list, SnapPosition snapPosition, final MutableState<Unit> mutableState, CoroutineScope coroutineScope, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), i8, i5, i4, orientation, -i3, i2 + i4, false, i9, null, null, 0.0f, 0, false, snapPosition, function3.invoke(Integer.valueOf(Constraints.m6258getMinWidthimpl(j)), Integer.valueOf(Constraints.m6257getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$4
        ...
        final long Constraints$default = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m6256getMaxWidthimpl(j) : i8, 0, orientation != Orientation.Vertical ? Constraints.m6255getMaxHeightimpl(j) : i8, 5, null);
        int i18 = i6;
        int i19 = i7;
        while (i18 > 0 && i19 > 0) {
            i18--;
        ...
        while (i23 < 0 && i18 > 0) {
            ...
            MeasuredPage m925getAndMeasureSGf7dI0 = m925getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i25, Constraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            arrayDeque2.add(i26, m925getAndMeasureSGf7dI0);
            i24 = Math.max(i24, m925getAndMeasureSGf7dI0.getCrossAxisSize());
            i23 += i27;
            i18 = i25;
            i22 = i22;
        ...
        while (i42 < i && (i43 < coerceAtLeast2 || i43 <= 0 || arrayDeque3.isEmpty())) {
            ...
            int i48 = i43;
            int i49 = i32;
            MeasuredPage m925getAndMeasureSGf7dI02 = m925getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i42, Constraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            int i50 = i - 1;
            i43 = (i45 == i50 ? i8 : i49) + i48;
            if (i43 > i30 || i45 == i50) {
                i24 = Math.max(i24, m925getAndMeasureSGf7dI02.getCrossAxisSize());
                arrayDeque3.add(m925getAndMeasureSGf7dI02);
                i39 = i46;
            } else {
                i40 -= i49;
                i39 = i45 + 1;
        ...
        if (i54 < i2) {
            ...
            while (i61 < i59 && i14 > 0) {
                i14--;
                int i62 = i60;
                MeasuredPage m925getAndMeasureSGf7dI03 = m925getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i14, Constraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                arrayDeque3.add(0, m925getAndMeasureSGf7dI03);
                i24 = Math.max(i24, m925getAndMeasureSGf7dI03.getCrossAxisSize());
                i61 += i62;
                i59 = i3;
                i60 = i62;
            }
        ...
        List<MeasuredPage> createPagesBeforeList = createPagesBeforeList(i14, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int i67) {
                MeasuredPage m925getAndMeasureSGf7dI04;
                LazyLayoutMeasureScope lazyLayoutMeasureScope2 = LazyLayoutMeasureScope.this;
                m925getAndMeasureSGf7dI04 = PagerMeasureKt.m925getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i67, Constraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
                return m925getAndMeasureSGf7dI04;
            }
        });
        ...
        List<MeasuredPage> createPagesAfterList = createPagesAfterList(((MeasuredPage) arrayDeque3.last()).getIndex(), i, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesAfter$1
            ...
            public final MeasuredPage invoke(int i70) {
                MeasuredPage m925getAndMeasureSGf7dI04;
                LazyLayoutMeasureScope lazyLayoutMeasureScope2 = LazyLayoutMeasureScope.this;
                m925getAndMeasureSGf7dI04 = PagerMeasureKt.m925getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i70, Constraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
                return m925getAndMeasureSGf7dI04;
            }
        });
        ...
        int m6273constrainWidthK40F9xA = ConstraintsKt.m6273constrainWidthK40F9xA(j3, i16);
        if (orientation == Orientation.Vertical) {
            i70 = i12;
        }
        int m6272constrainHeightK40F9xA = ConstraintsKt.m6272constrainHeightK40F9xA(j3, i70);
        final List<MeasuredPage> calculatePagesOffsets = calculatePagesOffsets(lazyLayoutMeasureScope, arrayDeque3, createPagesBeforeList, createPagesAfterList, m6273constrainWidthK40F9xA, m6272constrainHeightK40F9xA, i12, i2, i63, orientation, z, lazyLayoutMeasureScope, i5, i8);
        if (i72 != 0) {
        ...
        int i76 = i12;
        MeasuredPage calculateNewCurrentPage = calculateNewCurrentPage(orientation == Orientation.Vertical ? m6272constrainHeightK40F9xA : m6273constrainWidthK40F9xA, list2, i3, i4, i69, snapPosition, i);
        return new PagerMeasureResult(list2, i8, i5, i4, orientation, i29, i52, z, i9, measuredPage3, calculateNewCurrentPage, i69 == 0 ? 0.0f : RangesKt.coerceIn((snapPosition.position(i2, i8, i3, i4, calculateNewCurrentPage != null ? calculateNewCurrentPage.getIndex() : i66, i) - (calculateNewCurrentPage != null ? calculateNewCurrentPage.getOffset() : i66)) / i69, -0.5f, 0.5f), i15, (i53 < i || i76 > i2) ? 1 : i66, snapPosition, function3.invoke(Integer.valueOf(m6273constrainWidthK40F9xA), Integer.valueOf(m6272constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$14
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasuredPage m925getAndMeasureSGf7dI0(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z, int i2) {
        return new MeasuredPage(i, i2, lazyLayoutMeasureScope.mo855measure0kLqBqw(i, j), j2, pagerLazyLayoutItemProvider.getKey(i), orientation, horizontal, vertical, layoutDirection, z, null);
    }
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical m567spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m567spacedBy0680j_4(lazyLayoutMeasureScope.mo373toDpu2uoSUM(i6));
            if (orientation == Orientation.Vertical) {
                m567spacedBy0680j_4.arrange(density, i9, iArr, iArr2);
            } else {
                m567spacedBy0680j_4.arrange(density, i9, iArr, LayoutDirection.Ltr, iArr2);
            }
