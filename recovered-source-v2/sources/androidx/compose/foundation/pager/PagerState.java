...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f, PrefetchScheduler prefetchScheduler) {
        ...
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3591boximpl(Offset.INSTANCE.m3618getZeroF1C5BW0()), null, 2, null);
            ...
            this.placementScopeInvalidator = ObservableScopeInvalidator.m861constructorimpl$default(null, 1, null);
            this.measurementScopeInvalidator = ObservableScopeInvalidator.m861constructorimpl$default(null, 1, null);
    ...
    public final long m932getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m934setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m3591boximpl(j));
    }
    ...
    public final float performScroll(float delta) {
        ...
        if (value.tryToApplyScrollWithoutRemeasure(-i)) {
            ...
            ObservableScopeInvalidator.m865invalidateScopeimpl(this.placementScopeInvalidator);
    ...
    public final float getPositionThresholdFraction$foundation_release() {
        return Math.min(this.density.mo376toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    public final void m933setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final MutableState<Unit> m930getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final void snapToItem$foundation_release(int page, float offsetFraction, boolean forceRemeasure) {
        ...
        ObservableScopeInvalidator.m865invalidateScopeimpl(this.measurementScopeInvalidator);
    }

    /* renamed from: getMeasurementScopeInvalidator-zYiylxw$foundation_release, reason: not valid java name */
    public final MutableState<Unit> m929getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        if (getLayoutInfo().getOrientation() != Orientation.Vertical ? Math.signum(scrollDelta) != Math.signum(-Offset.m3602getXimpl(m932getUpDownDifferenceF1C5BW0$foundation_release())) : Math.signum(scrollDelta) != Math.signum(-Offset.m3603getYimpl(m932getUpDownDifferenceF1C5BW0$foundation_release()))) {
    ...
    private final boolean isNotGestureAction() {
        return ((int) Offset.m3602getXimpl(m932getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m3603getYimpl(m932getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
    ...
    private final void notifyPrefetch(float delta, PagerLayoutInfo info) {
        ...
        if (this.prefetchingEnabled && !info.getVisiblePagesInfo().isEmpty()) {
            ...
            if (index != this.indexToPrefetch) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m856schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
            if (z) {
