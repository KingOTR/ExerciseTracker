...
public final class PagerLayoutInfoKt {
    public static final int getMainAxisViewportSize(PagerLayoutInfo pagerLayoutInfo) {
        return pagerLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m6472getHeightimpl(pagerLayoutInfo.mo923getViewportSizeYbymL2g()) : IntSize.m6473getWidthimpl(pagerLayoutInfo.mo923getViewportSizeYbymL2g());
    }
}
