...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    public final void m302setSizeEaSLcWc(long j) {
        this.size = j;
    }
    ...
    public final void m300setCornerRadius0680j_4(float f) {
        this.cornerRadius = f;
    }
    ...
    public final void m301setElevation0680j_4(float f) {
        this.elevation = f;
    }
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m3617getUnspecifiedF1C5BW0();
    }
    ...
    private final long m296getAnchorPositionInRootF1C5BW0() {
    ...
    public final void m303update5F03MCQ(Function1<? super Density, Offset> sourceCenter, Function1<? super Density, Offset> magnifierCenter, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Function1<? super DpSize, Unit> onSizeChanged, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        if (this.magnifier != null && ((!Magnifier_androidKt.equalsIncludingNaN(zoom, f) && !platformMagnifierFactory.getCanUpdateZoom()) || !DpSize.m6398equalsimpl0(size, j) || !Dp.m6308equalsimpl0(cornerRadius, f2) || !Dp.m6308equalsimpl0(elevation, f3) || useTextDefault != z || clippingEnabled != z2 || !Intrinsics.areEqual(platformMagnifierFactory, platformMagnifierFactory2) || !Intrinsics.areEqual(requireView, view) || !Intrinsics.areEqual(requireDensity, density))) {
            recreateMagnifier();
        }
        updateMagnifier();
    }
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo330createnHHXs2Y(view2, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density2, this.zoom);
    ...
    */
    public final void updateMagnifier() {
        long m3617getUnspecifiedF1C5BW0;
        ...
        if (OffsetKt.m3621isSpecifiedk4lQ0M(packedValue) && OffsetKt.m3621isSpecifiedk4lQ0M(m296getAnchorPositionInRootF1C5BW0())) {
            this.sourceCenterInRoot = Offset.m3607plusMKHz9U(m296getAnchorPositionInRootF1C5BW0(), packedValue);
            Function1<? super Density, Offset> function1 = this.magnifierCenter;
            if (function1 != null) {
                Offset m3591boximpl = Offset.m3591boximpl(function1.invoke(density).getPackedValue());
                if (!OffsetKt.m3621isSpecifiedk4lQ0M(m3591boximpl.getPackedValue())) {
                    m3591boximpl = null;
                }
                if (m3591boximpl != null) {
                    m3617getUnspecifiedF1C5BW0 = Offset.m3607plusMKHz9U(m296getAnchorPositionInRootF1C5BW0(), m3591boximpl.getPackedValue());
                    long j = m3617getUnspecifiedF1C5BW0;
                    if (this.magnifier == null) {
                        recreateMagnifier();
                    }
                    platformMagnifier = this.magnifier;
                    if (platformMagnifier != null) {
                        platformMagnifier.mo329updateWko1d7g(this.sourceCenterInRoot, j, this.zoom);
                    }
                    updateSizeIfNecessary();
                    return;
                }
            }
            m3617getUnspecifiedF1C5BW0 = Offset.INSTANCE.m3617getUnspecifiedF1C5BW0();
            long j2 = m3617getUnspecifiedF1C5BW0;
            if (this.magnifier == null) {
            }
            platformMagnifier = this.magnifier;
            if (platformMagnifier != null) {
    ...
    private final void updateSizeIfNecessary() {
        Density density;
        PlatformMagnifier platformMagnifier = this.magnifier;
        if (platformMagnifier == null || (density = this.density) == null || IntSize.m6470equalsimpl(platformMagnifier.mo328getSizeYbymL2g(), this.previousSize)) {
            return;
        }
        Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
        if (function1 != null) {
            function1.invoke(DpSize.m6389boximpl(density.mo374toDpSizekrfVVM(IntSizeKt.m6485toSizeozmzZPI(platformMagnifier.mo328getSizeYbymL2g()))));
        }
        this.previousSize = IntSize.m6465boximpl(platformMagnifier.mo328getSizeYbymL2g());
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (channel != null) {
            ChannelResult.m9424boximpl(channel.mo6673trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode$applySemantics$1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m3591boximpl(m305invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0, reason: not valid java name */
            public final long m305invokeF1C5BW0() {
                long j;
