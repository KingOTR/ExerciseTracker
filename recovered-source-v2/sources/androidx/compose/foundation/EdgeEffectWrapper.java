...
final class EdgeEffectWrapper {
    ...
    private final EdgeEffect createEdgeEffect() {
        ...
        if (!IntSize.m6471equalsimpl0(this.size, IntSize.INSTANCE.m6478getZeroYbymL2g())) {
            create.setSize(IntSize.m6473getWidthimpl(this.size), IntSize.m6472getHeightimpl(this.size));
        }
        return create;
    }

    /* renamed from: setSize-ozmzZPI, reason: not valid java name */
    public final void m294setSizeozmzZPI(long size) {
        this.size = size;
        EdgeEffect edgeEffect = this.topEffect;
        if (edgeEffect != null) {
            edgeEffect.setSize(IntSize.m6473getWidthimpl(size), IntSize.m6472getHeightimpl(size));
        }
        EdgeEffect edgeEffect2 = this.bottomEffect;
        if (edgeEffect2 != null) {
            edgeEffect2.setSize(IntSize.m6473getWidthimpl(size), IntSize.m6472getHeightimpl(size));
        }
        EdgeEffect edgeEffect3 = this.leftEffect;
        if (edgeEffect3 != null) {
            edgeEffect3.setSize(IntSize.m6472getHeightimpl(size), IntSize.m6473getWidthimpl(size));
        }
        EdgeEffect edgeEffect4 = this.rightEffect;
        if (edgeEffect4 != null) {
            edgeEffect4.setSize(IntSize.m6472getHeightimpl(size), IntSize.m6473getWidthimpl(size));
        }
        EdgeEffect edgeEffect5 = this.topEffectNegation;
        if (edgeEffect5 != null) {
            edgeEffect5.setSize(IntSize.m6473getWidthimpl(size), IntSize.m6472getHeightimpl(size));
        }
        EdgeEffect edgeEffect6 = this.bottomEffectNegation;
        if (edgeEffect6 != null) {
            edgeEffect6.setSize(IntSize.m6473getWidthimpl(size), IntSize.m6472getHeightimpl(size));
        }
        EdgeEffect edgeEffect7 = this.leftEffectNegation;
        if (edgeEffect7 != null) {
            edgeEffect7.setSize(IntSize.m6472getHeightimpl(size), IntSize.m6473getWidthimpl(size));
        }
        EdgeEffect edgeEffect8 = this.rightEffectNegation;
        if (edgeEffect8 != null) {
            edgeEffect8.setSize(IntSize.m6472getHeightimpl(size), IntSize.m6473getWidthimpl(size));
        }
    }
}
