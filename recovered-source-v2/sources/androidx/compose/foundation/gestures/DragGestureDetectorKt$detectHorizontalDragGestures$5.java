        ...
        if (i == 0) {
            ...
            if (i != 1) {
                ...
                if (pointerInputChange != null) {
                    ...
                    this.L$1 = null;
                    this.label = 3;
                    obj = DragGestureDetectorKt.m426horizontalDragjO51t88(awaitPointerEventScope2, id, new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt$detectHorizontalDragGestures$5.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(1);
                        ...
                        public final void invoke2(PointerInputChange pointerInputChange2) {
                            function2.invoke(pointerInputChange2, Float.valueOf(Offset.m3602getXimpl(PointerEventKt.positionChange(pointerInputChange2))));
