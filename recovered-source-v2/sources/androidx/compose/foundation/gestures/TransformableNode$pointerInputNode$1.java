...
final class TransformableNode$pointerInputNode$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00141 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:18:0x0088 -> B:9:0x0036). Please report as a decompilation issue!!! */
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            /*
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (objectRef.element instanceof TransformEvent.TransformStarted) {
                        ...
                        this.L$2 = null;
                        this.label = 2;
                        if (transformableState.transform(MutatePriority.UserInput, new C00151(objectRef, this.this$0, null), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                    coroutineScope = coroutineScope2;
                    ...
                    if (i == 0) {
                        ...
                        if (!(this.$event.element instanceof TransformEvent.TransformStopped)) {
                            ...
                            if (transformDelta != null) {
                                transformScope.mo407transformByd4ec7I(transformDelta.getZoomChange(), transformDelta.getPanChange(), transformDelta.getRotationChange());
                            }
        ...
        static final class AnonymousClass2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                try {
                    ...
                    channel = this.this$0.channel;
                    channel.mo6673trySendJP2dKIU(TransformEvent.TransformStopped.INSTANCE);
                }
            }
        }
    }
