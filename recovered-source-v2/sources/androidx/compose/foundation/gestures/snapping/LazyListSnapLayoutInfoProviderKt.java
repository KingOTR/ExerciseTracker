...
public final class LazyListSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyListState lazyListState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyListSnapLayoutInfoProviderKt$SnapLayoutInfoProvider$1
            ...
            public float calculateSnapOffset(float velocity) {
                ...
                return SnapFlingBehaviorKt.m530calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem(LazyListState.this.getDensity$foundation_release(), velocity), f, f2);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyListLayoutInfo lazyListLayoutInfo) {
        return lazyListLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m6472getHeightimpl(lazyListLayoutInfo.mo789getViewportSizeYbymL2g()) : IntSize.m6473getWidthimpl(lazyListLayoutInfo.mo789getViewportSizeYbymL2g());
    }

    public static final int calculateFinalSnappingItem(Density density, float f) {
        if (Math.abs(f) < density.mo376toPx0680j_4(SnapFlingBehaviorKt.getMinFlingVelocityDp())) {
            return FinalSnappingItem.INSTANCE.m527getClosestItembbeMdSM();
        }
        return f > 0.0f ? FinalSnappingItem.INSTANCE.m528getNextItembbeMdSM() : FinalSnappingItem.INSTANCE.m529getPreviousItembbeMdSM();
    }
}
