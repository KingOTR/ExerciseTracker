...
public final class DraggableKt {
    ...
    public static final float m449toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m3603getYimpl(j) : Offset.m3602getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m450toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m6541getYimpl(j) : Velocity.m6540getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m451toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m6540getXimpl(j)) ? 0.0f : Velocity.m6540getXimpl(j), Float.isNaN(Velocity.m6541getYimpl(j)) ? 0.0f : Velocity.m6541getYimpl(j));
    }
}
