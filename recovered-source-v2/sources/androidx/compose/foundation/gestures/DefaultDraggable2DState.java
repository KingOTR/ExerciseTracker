...
final class DefaultDraggable2DState implements Draggable2DState {
    ...
    private final Drag2DScope drag2DScope = new Drag2DScope() { // from class: androidx.compose.foundation.gestures.DefaultDraggable2DState$drag2DScope$1
        ...
        public void mo406dragByk4lQ0M(long pixels) {
            DefaultDraggable2DState.this.getOnDelta().invoke(Offset.m3591boximpl(pixels));
        }
    };
    ...
    public void mo405dispatchRawDeltak4lQ0M(long delta) {
        this.onDelta.invoke(Offset.m3591boximpl(delta));
    }
}
