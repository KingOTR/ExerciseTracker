...
final class DefaultTransformableState implements TransformableState {
    ...
    private final TransformScope transformScope = new TransformScope() { // from class: androidx.compose.foundation.gestures.DefaultTransformableState$transformScope$1
        ...
        public void mo407transformByd4ec7I(float zoomChange, long panChange, float rotationChange) {
            DefaultTransformableState.this.getOnTransformation().invoke(Float.valueOf(zoomChange), Offset.m3591boximpl(panChange), Float.valueOf(rotationChange));
        }
    };
