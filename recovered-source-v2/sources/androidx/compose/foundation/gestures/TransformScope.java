...
public interface TransformScope {
    ...
    void mo407transformByd4ec7I(float zoomChange, long panChange, float rotationChange);
    ...
    static /* synthetic */ void m512transformByd4ec7I$default(TransformScope transformScope, float f, long j, float f2, int i, Object obj) {
        if (obj != null) {
        ...
        transformScope.mo407transformByd4ec7I(f, j, f2);
    }
}
