...
final class AnchoredDraggableNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        long m387reverseIfNeededAH228Gc;
        AnchoredDraggableState anchoredDraggableState;
        long m387reverseIfNeededAH228Gc2;
        float m389toFloatTH1AsA0;
        ...
        if (i == 0) {
            ...
            if (overscrollEffect != null) {
                ...
                m387reverseIfNeededAH228Gc = this.this$0.m387reverseIfNeededAH228Gc(this.$velocity);
                this.label = 2;
                if (overscrollEffect2.mo220applyToFlingBMRW4eQ(m387reverseIfNeededAH228Gc, new AnonymousClass1(this.this$0, null), this) == coroutine_suspended) {
                ...
                m387reverseIfNeededAH228Gc2 = anchoredDraggableNode3.m387reverseIfNeededAH228Gc(this.$velocity);
                m389toFloatTH1AsA0 = anchoredDraggableNode3.m389toFloatTH1AsA0(m387reverseIfNeededAH228Gc2);
                this.L$0 = anchoredDraggableNode2;
                this.label = 1;
                Object obj2 = anchoredDraggableState.settle(m389toFloatTH1AsA0, this);
                if (obj2 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                obj = obj2;
                anchoredDraggableNode = anchoredDraggableNode2;
                anchoredDraggableNode.m392toVelocityadjELrA(((Number) obj).floatValue());
            }
        } else if (i == 1) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<Velocity, Continuation<? super Velocity>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Velocity velocity, Continuation<? super Velocity> continuation) {
            return m396invokesFctU(velocity.getPackedValue(), continuation);
        }

        /* renamed from: invoke-sF-c-tU, reason: not valid java name */
        public final Object m396invokesFctU(long j, Continuation<? super Velocity> continuation) {
            return ((AnonymousClass1) create(Velocity.m6531boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                AnchoredDraggableNode anchoredDraggableNode2 = this.this$0;
                anchoredDraggableState = anchoredDraggableNode2.state;
                m389toFloatTH1AsA0 = this.this$0.m389toFloatTH1AsA0(j2);
                this.L$0 = anchoredDraggableNode2;
                this.J$0 = j2;
                this.label = 1;
                Object obj2 = anchoredDraggableState.settle(m389toFloatTH1AsA0, this);
            ...
            m392toVelocityadjELrA = anchoredDraggableNode.m392toVelocityadjELrA(((Number) obj).floatValue());
