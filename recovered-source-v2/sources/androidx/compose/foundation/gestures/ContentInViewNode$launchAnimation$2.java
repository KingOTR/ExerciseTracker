            ...
            if (i == 0) {
                ...
                Function1<Float, Unit> function1 = new Function1<Float, Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewNode.launchAnimation.2.1.1
                    ...
                    public final void invoke(float f) {
                        ...
                        float m501toFloatk4lQ0M = f2 * scrollingLogic.m501toFloatk4lQ0M(scrollingLogic.m499reverseIfNeededMKHz9U(nestedScrollScope.mo457scrollByOzD1aCk(scrollingLogic.m499reverseIfNeededMKHz9U(scrollingLogic.m502toOffsettuRUvjQ(f2 * f)), NestedScrollSource.INSTANCE.m4945getUserInputWNlRxjI())));
                        if (Math.abs(m501toFloatk4lQ0M) < Math.abs(f)) {
                            JobKt__JobKt.cancel$default(job, "Scroll animation cancelled because scroll was not consumed (" + m501toFloatk4lQ0M + " < " + f + ')', null, 2, null);
                        }
                    }
                };
                ...
                if (updatableAnimationState2.animateToZero(function1, new Function0<Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewNode.launchAnimation.2.1.2
                    ...
                    public final void invoke2() {
                        ...
                        while (true) {
                            ...
                            if (!(invoke == null ? true : ContentInViewNode.m402isMaxVisibleO0kMr_c$default(contentInViewNode3, invoke, 0L, 1, null))) {
                                break;
                            }
                            ...
                            continuation.resumeWith(Result.m7905constructorimpl(unit));
                        }
                        z = ContentInViewNode.this.trackingFocusedChild;
                        if (z) {
                            focusedChildBounds = ContentInViewNode.this.getFocusedChildBounds();
                            if (focusedChildBounds != null && ContentInViewNode.m402isMaxVisibleO0kMr_c$default(ContentInViewNode.this, focusedChildBounds, 0L, 1, null)) {
