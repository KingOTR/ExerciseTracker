...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo397calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset m3591boximpl = Offset.m3591boximpl(Offset.INSTANCE.m3618getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            m3591boximpl = Offset.m3591boximpl(Offset.m3607plusMKHz9U(m3591boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m3609timestuRUvjQ(m3591boximpl.getPackedValue(), -density.mo376toPx0680j_4(Dp.m6303constructorimpl(64)));
    }
}
