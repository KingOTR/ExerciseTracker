...
public final class ScrollableKt {
    ...
    private static final Function1<PointerInputChange, Boolean> CanDragCalculation = new Function1<PointerInputChange, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$CanDragCalculation$1
        ...
        public final Boolean invoke(PointerInputChange pointerInputChange) {
            return Boolean.valueOf(!PointerType.m5122equalsimpl0(pointerInputChange.getType(), PointerType.INSTANCE.m5127getMouseT8wyACA()));
        }
    };
    ...
    */
    public static final Object m484semanticsScrollByd4ec7I(ScrollingLogic scrollingLogic, long j, Continuation<? super Offset> continuation) {
        ...
        if (continuation instanceof ScrollableKt$semanticsScrollBy$1) {
            ...
            if ((scrollableKt$semanticsScrollBy$1.label & Integer.MIN_VALUE) != 0) {
                ...
                return Offset.m3591boximpl(scrollingLogic.m502toOffsettuRUvjQ(floatRef.element));
            }
        }
