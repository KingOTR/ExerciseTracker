    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            if (!DragGestureDetectorKt.m427isPointerUpDmW0f2w(pointerEvent2, this.$currentDown.element.getId())) {
                ...
                if (pointerInputChange2 != 0) {
                    ...
                    if (i == 0) {
                        ...
                        for (i3 = 0; i3 < size2; i3++) {
                            ...
                            if (pointerInputChange3.isConsumed() || PointerEventKt.m4995isOutOfBoundsjwHxaWs(pointerInputChange3, awaitPointerEventScope.mo4961getSizeYbymL2g(), awaitPointerEventScope.mo4960getExtendedTouchPaddingNHjbRc())) {
                                break;
                            }
                        }
                        this.L$0 = awaitPointerEventScope;
                        ...
                        if (!DragGestureDetectorKt.m427isPointerUpDmW0f2w(pointerEvent2, this.$currentDown.element.getId())) {
                            ...
                            while (true) {
                                ...
                                if (PointerId.m5032equalsimpl0(((PointerInputChange) t).getId(), objectRef2.element.getId())) {
                                    break;
                                }
                                i8++;
