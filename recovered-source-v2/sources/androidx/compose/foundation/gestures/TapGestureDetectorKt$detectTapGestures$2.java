...
@DebugMetadata(c = "androidx.compose.foundation.gestures.TapGestureDetectorKt$detectTapGestures$2", f = "TapGestureDetector.kt", i = {}, l = {Logger.NONE}, m = "invokeSuspend", n = {}, s = {})
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        if (function1 != null) {
                            function1.invoke(Offset.m3591boximpl(pointerInputChange.getPosition()));
                        }
                    ...
                    if (objectRef2.element != 0) {
                        if (this.$onDoubleTap == null) {
                            ...
                            if (function14 != null) {
                                function14.invoke(Offset.m3591boximpl(((PointerInputChange) objectRef2.element).getPosition()));
                            }
                        } else {
                            ...
                            if (pointerInputChange3 != null) {
                                ...
                                if (function15 != null) {
                                    function15.invoke(Offset.m3591boximpl(((PointerInputChange) objectRef3.element).getPosition()));
                                }
                            } else {
                ...
                case 5:
                    ...
                    try {
                        ...
                        function12 = this.$onTap;
                        if (function12 != null) {
                            function12.invoke(Offset.m3591boximpl(((PointerInputChange) objectRef4.element).getPosition()));
                        }
                        function13 = this.$onLongPress;
                        if (function13 != null) {
                            function13.invoke(Offset.m3591boximpl(pointerInputChange3.getPosition()));
                        }
                        this.L$0 = null;
                        this.L$1 = null;
                        this.L$2 = null;
        ...
        static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    Offset m3591boximpl = Offset.m3591boximpl(this.$down.getPosition());
                    this.label = 1;
                    if (function3.invoke(pressGestureScopeImpl, m3591boximpl, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        static final class AnonymousClass8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> function3 = this.$onPress;
                    PressGestureScopeImpl pressGestureScopeImpl = this.$pressScope;
                    Offset m3591boximpl = Offset.m3591boximpl(this.$secondDown.getPosition());
                    this.label = 1;
                    if (function3.invoke(pressGestureScopeImpl, m3591boximpl, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
        ...
        static final class AnonymousClass9 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (pointerInputChange == null) {
                    ...
                    function1.invoke(Offset.m3591boximpl(this.$upOrCancel.element.getPosition()));
                    return Unit.INSTANCE;
                }
                pointerInputChange.consume();
                BuildersKt__Builders_commonKt.launch$default(this.$$this$coroutineScope, null, null, new C00131(this.$pressScope, null), 3, null);
                this.$onDoubleTap.invoke(Offset.m3591boximpl(pointerInputChange.getPosition()));
                return Unit.INSTANCE;
            }
