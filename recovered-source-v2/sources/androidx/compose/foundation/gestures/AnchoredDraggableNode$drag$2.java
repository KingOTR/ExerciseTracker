        ...
        if (i == 0) {
            ...
            Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode$drag$2.1
                ...
                public final void invoke2(DragEvent.DragDelta dragDelta) {
                    ...
                    long m388reverseIfNeededMKHz9U;
                    AnchoredDraggableState anchoredDraggableState;
                    long m388reverseIfNeededMKHz9U2;
                    float m390toFloatk4lQ0M;
                    ...
                    if (overscrollEffect != null) {
                        ...
                        m388reverseIfNeededMKHz9U = anchoredDraggableNode.m388reverseIfNeededMKHz9U(dragDelta.getDelta());
                        int m4945getUserInputWNlRxjI = NestedScrollSource.INSTANCE.m4945getUserInputWNlRxjI();
                        ...
                        overscrollEffect2.mo221applyToScrollRhakbz0(m388reverseIfNeededMKHz9U, m4945getUserInputWNlRxjI, new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                                return Offset.m3591boximpl(m395invokeMKHz9U(offset.getPackedValue()));
                            }

                            /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                            public final long m395invokeMKHz9U(long j) {
                                AnchoredDraggableState anchoredDraggableState2;
                                float m390toFloatk4lQ0M2;
                                AnchoredDraggableState anchoredDraggableState3;
                                long m391toOffsettuRUvjQ;
                                anchoredDraggableState2 = ((AnchoredDraggableNode) anchoredDraggableNode2).state;
                                m390toFloatk4lQ0M2 = anchoredDraggableNode2.m390toFloatk4lQ0M(j);
                                float newOffsetForDelta$foundation_release = anchoredDraggableState2.newOffsetForDelta$foundation_release(m390toFloatk4lQ0M2);
                                ...
                                m391toOffsettuRUvjQ = anchoredDraggableNode3.m391toOffsettuRUvjQ(newOffsetForDelta$foundation_release - anchoredDraggableState3.requireOffset());
                                AnchoredDragScope.dragTo$default(anchoredDragScope2, newOffsetForDelta$foundation_release, 0.0f, 2, null);
                                return m391toOffsettuRUvjQ;
                            }
                        });
                        return;
                    }
                    ...
                    m388reverseIfNeededMKHz9U2 = anchoredDraggableNode3.m388reverseIfNeededMKHz9U(dragDelta.getDelta());
                    m390toFloatk4lQ0M = anchoredDraggableNode3.m390toFloatk4lQ0M(m388reverseIfNeededMKHz9U2);
                    AnchoredDragScope.dragTo$default(anchoredDragScope3, anchoredDraggableState.newOffsetForDelta$foundation_release(m390toFloatk4lQ0M), 0.0f, 2, null);
                }
            };
            this.label = 1;
