...
final class ScrollableNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo486onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.enabled) {
            return this.scrollingLogic.m498performRawScrollMKHz9U(available);
        }
    ...
    */
    public Object mo485onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
            ...
            if ((scrollableNestedScrollConnection$onPostFling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (this.enabled) {
                        ...
                        obj = scrollingLogic.m496doFlingAnimationQWom1Mo(j2, scrollableNestedScrollConnection$onPostFling$1);
                ...
                m6551getZero9UxMQ8M = Velocity.m6543minusAH228Gc(j2, ((Velocity) obj).getPackedValue());
                return Velocity.m6531boximpl(m6551getZero9UxMQ8M);
            }
        }
        ...
        m6551getZero9UxMQ8M = Velocity.m6543minusAH228Gc(j2, ((Velocity) obj2).getPackedValue());
        return Velocity.m6531boximpl(m6551getZero9UxMQ8M);
    }
}
