...
final class Draggable2DNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        Function3 function3;
        long m444reverseIfNeededAH228Gc;
        ...
        if (i == 0) {
            ...
            m444reverseIfNeededAH228Gc = this.this$0.m444reverseIfNeededAH228Gc(this.$velocity);
            Velocity m6531boximpl = Velocity.m6531boximpl(m444reverseIfNeededAH228Gc);
            this.label = 1;
            if (function3.invoke(coroutineScope, m6531boximpl, this) == coroutine_suspended) {
