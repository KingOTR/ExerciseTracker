...
final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            float m501toFloatk4lQ0M = this.$this_semanticsScrollBy.m501toFloatk4lQ0M(this.$offset);
            final Ref.FloatRef floatRef = this.$previousValue;
            final ScrollingLogic scrollingLogic = this.$this_semanticsScrollBy;
            this.label = 1;
            if (SuspendAnimationKt.animate$default(0.0f, m501toFloatk4lQ0M, 0.0f, null, new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(float f, float f2) {
                    float f3 = f - Ref.FloatRef.this.element;
                    ScrollingLogic scrollingLogic2 = scrollingLogic;
                    Ref.FloatRef.this.element += scrollingLogic2.reverseIfNeeded(scrollingLogic2.m501toFloatk4lQ0M(nestedScrollScope.mo457scrollByOzD1aCk(scrollingLogic2.m502toOffsettuRUvjQ(scrollingLogic2.reverseIfNeeded(f3)), NestedScrollSource.INSTANCE.m4945getUserInputWNlRxjI())));
                }
