...
final class ScrollableNode extends DragGestureNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode, SemanticsModifierNode {
    ...
    */
    ...
    public boolean mo211onKeyEventZmokQxo(KeyEvent event) {
        long Offset;
        if (!getEnabled() || ((!Key.m4600equalsimpl0(KeyEvent_androidKt.m4908getKeyZmokQxo(event), Key.INSTANCE.m4788getPageDownEK5gGoQ()) && !Key.m4600equalsimpl0(KeyEvent_androidKt.m4908getKeyZmokQxo(event), Key.INSTANCE.m4789getPageUpEK5gGoQ())) || !KeyEventType.m4901equalsimpl0(KeyEvent_androidKt.m4909getTypeZmokQxo(event), KeyEventType.INSTANCE.m4905getKeyDownCS__XNY()) || KeyEvent_androidKt.m4912isCtrlPressedZmokQxo(event))) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int m6472getHeightimpl = IntSize.m6472getHeightimpl(this.contentInViewNode.getViewportSize());
            Offset = OffsetKt.Offset(0.0f, Key.m4600equalsimpl0(KeyEvent_androidKt.m4908getKeyZmokQxo(event), Key.INSTANCE.m4789getPageUpEK5gGoQ()) ? m6472getHeightimpl : -m6472getHeightimpl);
        } else {
            int m6473getWidthimpl = IntSize.m6473getWidthimpl(this.contentInViewNode.getViewportSize());
            Offset = OffsetKt.Offset(Key.m4600equalsimpl0(KeyEvent_androidKt.m4908getKeyZmokQxo(event), Key.INSTANCE.m4789getPageUpEK5gGoQ()) ? m6473getWidthimpl : -m6473getWidthimpl, 0.0f);
        }
    ...
    public void mo212onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        while (true) {
            ...
            if (getCanDrag().invoke(changes.get(i)).booleanValue()) {
                super.mo212onPointerEventH0pRuoY(pointerEvent, pass, bounds);
                break;
            }
            i++;
        }
        if (pass == PointerEventPass.Main && PointerEventType.m4999equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5008getScroll7fucELk())) {
            m487processMouseWheelEventO0kMr_c(pointerEvent, bounds);
        }
    }
        ...
        this.scrollByAction = new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableNode$setScrollSemanticsActions$1
            ...
            static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    Object m484semanticsScrollByd4ec7I;
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        m484semanticsScrollByd4ec7I = ScrollableKt.m484semanticsScrollByd4ec7I(scrollingLogic, OffsetKt.Offset(this.$x, this.$y), this);
                        if (m484semanticsScrollByd4ec7I == coroutine_suspended) {
    ...
    private final void m487processMouseWheelEventO0kMr_c(PointerEvent event, long size) {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new ScrollableNode$processMouseWheelEvent$2$1(this, scrollConfig.mo397calculateMouseWheelScroll8xgXZGE(DelegatableNodeKt.requireDensity(this), event, size), null), 3, null);
