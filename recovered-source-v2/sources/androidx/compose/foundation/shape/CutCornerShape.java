...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo950createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m3671getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m3671getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m3671getWidthimpl(size), Size.m3668getHeightimpl(size) - f2);
        Path.lineTo(Size.m3671getWidthimpl(size) - f2, Size.m3668getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m3668getHeightimpl(size));
        Path.lineTo(0.0f, Size.m3668getHeightimpl(size) - bottomEnd);
        Path.close();
