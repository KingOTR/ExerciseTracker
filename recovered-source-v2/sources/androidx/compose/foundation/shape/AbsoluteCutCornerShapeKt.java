...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m951AbsoluteCutCornerShape0680j_4(float f) {
        return AbsoluteCutCornerShape(CornerSizeKt.m959CornerSize0680j_4(f));
    }
    ...
    public static final AbsoluteCutCornerShape m952AbsoluteCutCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m959CornerSize0680j_4(f), CornerSizeKt.m959CornerSize0680j_4(f2), CornerSizeKt.m959CornerSize0680j_4(f3), CornerSizeKt.m959CornerSize0680j_4(f4));
    }
    ...
    public static /* synthetic */ AbsoluteCutCornerShape m953AbsoluteCutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m952AbsoluteCutCornerShapea9UjIt4(f, f2, f3, f4);
    }
}
