...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        final int m2374calculateWidthyeHjK3Y;
        final int m2373calculateHeightmKXJcVc;
        List<? extends Measurable> list2 = list;
        final int i = measureScope.mo370roundToPx0680j_4(this.paddingValues.getTop());
        int i2 = measureScope.mo370roundToPx0680j_4(this.paddingValues.getBottom());
        ...
        final Placeable mo5179measureBRTryo0 = measurable8 != null ? measurable8.mo5179measureBRTryo0(m6247copyZbe2FdA$default) : null;
        ...
        int i8 = -widthOrZero4;
        long m6275offsetNN6EwU = ConstraintsKt.m6275offsetNN6EwU(m6247copyZbe2FdA$default, i8, -i2);
        int size5 = list.size();
        int i9 = 0;
        while (true) {
            if (i9 >= size5) {
        ...
        Placeable mo5179measureBRTryo05 = measurable12 != null ? measurable12.mo5179measureBRTryo0(m6275offsetNN6EwU) : null;
        int size6 = list.size();
        int i11 = 0;
        while (true) {
            if (i11 >= size6) {
        ...
        int minIntrinsicHeight = measurable13 != null ? measurable13.minIntrinsicHeight(Constraints.m6258getMinWidthimpl(j)) : 0;
        int heightOrZero = TextFieldImplKt.heightOrZero(mo5179measureBRTryo05) + i;
        long m6275offsetNN6EwU2 = ConstraintsKt.m6275offsetNN6EwU(Constraints.m6247copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null), i8, ((-heightOrZero) - i2) - minIntrinsicHeight);
        int size7 = list.size();
        int i13 = 0;
        while (i13 < size7) {
            int i14 = size7;
            Measurable measurable14 = list2.get(i13);
            int i15 = i13;
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable14), TextFieldImplKt.TextFieldId)) {
                final Placeable mo5179measureBRTryo06 = measurable14.mo5179measureBRTryo0(m6275offsetNN6EwU2);
                long m6247copyZbe2FdA$default2 = Constraints.m6247copyZbe2FdA$default(m6275offsetNN6EwU2, 0, 0, 0, 0, 14, null);
                int size8 = list.size();
                int i16 = 0;
                while (true) {
                    if (i16 >= size8) {
                ...
                Placeable mo5179measureBRTryo07 = measurable15 != null ? measurable15.mo5179measureBRTryo0(m6247copyZbe2FdA$default2) : null;
                int max5 = Math.max(max4, Math.max(TextFieldImplKt.heightOrZero(mo5179measureBRTryo06), TextFieldImplKt.heightOrZero(mo5179measureBRTryo07)) + heightOrZero + i2);
                m2374calculateWidthyeHjK3Y = TextFieldKt.m2374calculateWidthyeHjK3Y(TextFieldImplKt.widthOrZero(mo5179measureBRTryo0), TextFieldImplKt.widthOrZero(mo5179measureBRTryo02), TextFieldImplKt.widthOrZero(mo5179measureBRTryo03), TextFieldImplKt.widthOrZero(mo5179measureBRTryo04), mo5179measureBRTryo06.getWidth(), TextFieldImplKt.widthOrZero(mo5179measureBRTryo05), TextFieldImplKt.widthOrZero(mo5179measureBRTryo07), j);
                Placeable mo5179measureBRTryo08 = measurable13 != null ? measurable13.mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(ConstraintsKt.m6276offsetNN6EwU$default(m6247copyZbe2FdA$default, 0, -max5, 1, null), 0, m2374calculateWidthyeHjK3Y, 0, 0, 9, null)) : null;
                int heightOrZero2 = TextFieldImplKt.heightOrZero(mo5179measureBRTryo08);
                m2373calculateHeightmKXJcVc = TextFieldKt.m2373calculateHeightmKXJcVc(mo5179measureBRTryo06.getHeight(), TextFieldImplKt.heightOrZero(mo5179measureBRTryo05), TextFieldImplKt.heightOrZero(mo5179measureBRTryo0), TextFieldImplKt.heightOrZero(mo5179measureBRTryo02), TextFieldImplKt.heightOrZero(mo5179measureBRTryo03), TextFieldImplKt.heightOrZero(mo5179measureBRTryo04), TextFieldImplKt.heightOrZero(mo5179measureBRTryo07), TextFieldImplKt.heightOrZero(mo5179measureBRTryo08), this.animationProgress, j, measureScope.getDensity(), this.paddingValues);
                int i18 = m2373calculateHeightmKXJcVc - heightOrZero2;
                int size9 = list.size();
                for (int i19 = 0; i19 < size9; i19++) {
                    Measurable measurable16 = list.get(i19);
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable16), TextFieldImplKt.ContainerId)) {
                        final Placeable mo5179measureBRTryo09 = measurable16.mo5179measureBRTryo0(ConstraintsKt.Constraints(m2374calculateWidthyeHjK3Y != Integer.MAX_VALUE ? m2374calculateWidthyeHjK3Y : 0, m2374calculateWidthyeHjK3Y, i18 != Integer.MAX_VALUE ? i18 : 0, i18));
                        final Placeable placeable = mo5179measureBRTryo05;
                        final Placeable placeable2 = mo5179measureBRTryo07;
                        final Placeable placeable3 = mo5179measureBRTryo02;
                        final Placeable placeable4 = mo5179measureBRTryo04;
                        final Placeable placeable5 = mo5179measureBRTryo08;
                        return MeasureScope.layout$default(measureScope, m2374calculateWidthyeHjK3Y, m2373calculateHeightmKXJcVc, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TextFieldMeasurePolicy$measure$1
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                ...
                                if (placeable6 != null) {
                                    int i20 = m2374calculateWidthyeHjK3Y;
                                    int i21 = m2373calculateHeightmKXJcVc;
                                    Placeable placeable7 = mo5179measureBRTryo06;
                                    Placeable placeable8 = placeable2;
                                    Placeable placeable9 = mo5179measureBRTryo0;
                                    Placeable placeable10 = placeable3;
                                    Placeable placeable11 = mo5179measureBRTryo03;
                                    Placeable placeable12 = placeable4;
                                    Placeable placeable13 = mo5179measureBRTryo09;
                                ...
                                int i23 = m2374calculateWidthyeHjK3Y;
                                int i24 = m2373calculateHeightmKXJcVc;
                                Placeable placeable15 = mo5179measureBRTryo06;
                                Placeable placeable16 = placeable2;
                                Placeable placeable17 = mo5179measureBRTryo0;
                                Placeable placeable18 = placeable3;
                                Placeable placeable19 = mo5179measureBRTryo03;
                                Placeable placeable20 = placeable4;
                                Placeable placeable21 = mo5179measureBRTryo09;
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        int m2374calculateWidthyeHjK3Y;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable7), TextFieldImplKt.TextFieldId)) {
                ...
                m2374calculateWidthyeHjK3Y = TextFieldKt.m2374calculateWidthyeHjK3Y(intValue6, intValue3, intValue4, intValue5, intValue, intValue2, intrinsicMeasurable14 != null ? intrinsicMeasurer.invoke(intrinsicMeasurable14, Integer.valueOf(height)).intValue() : 0, TextFieldImplKt.getZeroConstraints());
                return m2374calculateWidthyeHjK3Y;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        int m2373calculateHeightmKXJcVc;
        int size = list.size();
        int i7 = 0;
        while (true) {
            if (i7 >= size) {
        ...
        for (int i12 = 0; i12 < size6; i12++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable13), TextFieldImplKt.TextFieldId)) {
                ...
                return m2373calculateHeightmKXJcVc;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
