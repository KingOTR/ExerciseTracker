...
final class AppBarKt$TwoRowsTopAppBar$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            AppBarKt.m1456TopAppBarLayoutkXwM9vE(SizeKt.m717heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, windowInsets)), 0.0f, f, 1, null), new ScrolledOffset() { // from class: androidx.compose.material3.AppBarKt$TwoRowsTopAppBar$6$$ExternalSyntheticLambda0
            ...
            Modifier m717heightInVpY3zN4$default = SizeKt.m717heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, WindowInsetsKt.m755onlybOOhFvg(windowInsets, WindowInsetsSides.INSTANCE.m777getHorizontalJoeWqyM()))), 0.0f, Dp.m6303constructorimpl(f3 - f), 1, null);
