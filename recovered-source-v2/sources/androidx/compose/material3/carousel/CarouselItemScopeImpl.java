        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new GenericShape(new Function3<Path, Size, LayoutDirection, Unit>() { // from class: androidx.compose.material3.carousel.CarouselItemScopeImpl$rememberMaskShape$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Path path, Size size, LayoutDirection layoutDirection) {
                    m2565invoke12SF9DM(path, size.getPackedValue(), layoutDirection);
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-12SF9DM, reason: not valid java name */
                public final void m2565invoke12SF9DM(Path path, long j, LayoutDirection layoutDirection) {
                    Rect intersect = CarouselItemScopeImpl.this.getItemInfo().getMaskRect().intersect(SizeKt.m3692toRectuvyYCjk(j));
                    OutlineKt.addOutline(path, shape.mo287createOutlinePq9zytI(intersect.m3635getSizeNHjbRc(), layoutDirection, density));
                    path.mo3738translatek4lQ0M(OffsetKt.Offset(intersect.getLeft(), intersect.getTop()));
                }
            });
