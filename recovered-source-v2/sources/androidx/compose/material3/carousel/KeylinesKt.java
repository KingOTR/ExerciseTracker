...
public final class KeylinesKt {
    public static /* synthetic */ KeylineList multiBrowseKeylineList$default(Density density, float f, float f2, float f3, int i, float f4, float f5, int i2, Object obj) {
        if ((i2 & 32) != 0) {
            f4 = density.mo376toPx0680j_4(CarouselDefaults.INSTANCE.m2564getMinSmallItemSizeD9Ej5fM$material3_release());
        }
        float f6 = f4;
        if ((i2 & 64) != 0) {
            f5 = density.mo376toPx0680j_4(CarouselDefaults.INSTANCE.m2563getMaxSmallItemSizeD9Ej5fM$material3_release());
        }
    ...
    public static final KeylineList multiBrowseKeylineList(Density density, float f, float f2, float f3, int i, float f4, float f5) {
        ...
        float mo376toPx0680j_4 = density.mo376toPx0680j_4(CarouselDefaults.INSTANCE.m2562getAnchorSizeD9Ej5fM$material3_release());
        ...
        return createLeftAlignedKeylineList(f, f3, mo376toPx0680j_4, mo376toPx0680j_4, findLowestCostArrangement);
    }
    ...
    public static final KeylineList createLeftAlignedKeylineList(float f, float f2, final float f3, final float f4, final Arrangement arrangement) {
        return KeylineListKt.m2570keylineListOfWNYm7Xg(f, f2, CarouselAlignment.INSTANCE.m2561getStartNUL3oTo(), new Function1<KeylineListScope, Unit>() { // from class: androidx.compose.material3.carousel.KeylinesKt$createLeftAlignedKeylineList$1
    ...
    public static final KeylineList uncontainedKeylineList(Density density, float f, float f2, float f3) {
        ...
        int i = f4 > 0.0f ? 1 : 0;
        float mo376toPx0680j_4 = density.mo376toPx0680j_4(CarouselDefaults.INSTANCE.m2562getAnchorSizeD9Ej5fM$material3_release());
        float calculateMediumChildSize = calculateMediumChildSize(mo376toPx0680j_4, min, f4);
        return createLeftAlignedKeylineList(f, f3, Math.max(Math.min(mo376toPx0680j_4, f2), calculateMediumChildSize * 0.5f), mo376toPx0680j_4, new Arrangement(0, 0.0f, 0, calculateMediumChildSize, i, min, max));
    }
