...
public final class CarouselDefaults {
    ...
    private static final float MinSmallItemSize = Dp.m6303constructorimpl(40);
    private static final float MaxSmallItemSize = Dp.m6303constructorimpl(56);
    private static final float AnchorSize = Dp.m6303constructorimpl(10);
    ...
    public final TargetedFlingBehavior multiBrowseFlingBehavior(CarouselState carouselState, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        }, rememberSplineBasedDecay, spring$default, 0.0f, composer, ((i << 3) & 8064) | (PagerDefaults.$stable << 15), 16);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
