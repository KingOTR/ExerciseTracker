...
public final class KeylineListKt {
    ...
    public static final KeylineList m2570keylineListOfWNYm7Xg(float f, float f2, int i, Function1<? super KeylineListScope, Unit> function1) {
        KeylineListScopeImpl keylineListScopeImpl = new KeylineListScopeImpl();
        function1.invoke(keylineListScopeImpl);
        return keylineListScopeImpl.m2571createWithAlignmentwaks0t8(f, f2, i);
    }
