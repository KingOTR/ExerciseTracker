...
public final class CarouselStateKt {
    public static final CarouselState rememberCarouselState(final int i, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        if ((((i2 & SdkConfig.SDK_VERSION) ^ 48) <= 32 || !composer.changed(function0)) && (i2 & 48) != 32) {
            z = false;
        }
        boolean z3 = z2 | z;
        ...
        CarouselState carouselState = (CarouselState) RememberSaveableKt.m3429rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 0, 4);
