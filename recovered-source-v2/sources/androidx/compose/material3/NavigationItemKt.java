...
public final class NavigationItemKt {
    ...
    public static final void m1994NavigationItemSHbi2eg(final boolean z, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final Shape shape, final float f, final float f2, final float f3, final float f4, final float f5, final float f6, final NavigationItemColors navigationItemColors, final Modifier modifier, final boolean z2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final int i, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i2, final int i3) {
        int i4;
        int i5;
        ...
        if ((i4 & 306783379) != 306783378 || (4793491 & i6) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            final ComposableLambda rememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(-44329638, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$styledIcon$1
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        long m1983iconColorWaAFU9c = NavigationItemColors.this.m1983iconColorWaAFU9c(z, z2);
                        Modifier.Companion clearAndSetSemantics = function22 != null ? SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$styledIcon$1.1
                        ...
                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3833boximpl(m1983iconColorWaAFU9c)), function24, composer2, ProvidedValue.$stable);
            ...
            ComposableLambda rememberComposableLambda2 = function22 == null ? null : ComposableLambdaKt.rememberComposableLambda(-254668050, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$styledLabel$1$1
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        ProvideContentColorTextStyleKt.m2586ProvideContentColorTextStyle3JVO9M(NavigationItemColors.this.m1984textColorWaAFU9c(z, z2), textStyle, function22, composer2, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            Modifier m713defaultMinSizeVpY3zN4 = SizeKt.m713defaultMinSizeVpY3zN4(SelectableKt.m935selectableO2vRcR0(modifier, z, mutableInteractionSource, null, z2, Role.m5591boximpl(Role.INSTANCE.m5604getTabo7Vup1c()), function0), NavigationItemMinWidth, NavigationItemMinHeight);
            ...
            if (rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                rememberedValue2 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$1$1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                        m2003invokeozmzZPI(intSize.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                    public final void m2003invokeozmzZPI(long j) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            Modifier onSizeChanged = OnRemeasuredModifierKt.onSizeChanged(m713defaultMinSizeVpY3zN4, (Function1) rememberedValue2);
            ...
            ComposerKt.sourceInformation(startRestartGroup, "*310@13207L7,318@13501L136");
            if (NavigationItemIconPosition.m1988equalsimpl0(i, NavigationItemIconPosition.INSTANCE.m1993getTopxw1Ddg())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = startRestartGroup.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                long Offset = OffsetKt.Offset((NavigationItem_SHbi2eg$lambda$2(mutableIntState) - r1.mo370roundToPx0680j_4(f)) / 2, ((Density) consume).mo376toPx0680j_4(IndicatorVerticalOffset));
                Unit unit = Unit.INSTANCE;
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1634380655, "CC(remember):NavigationItem.kt#9igjgp");
                boolean changed = startRestartGroup.changed(Offset) | ((i6 & 29360128) == 8388608);
            ...
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1634364732, "CC(remember):NavigationItem.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            int i8 = i7 << 3;
            m1995NavigationItemLayoutKmRXDg(interactionSource, selectedIndicatorColor, shape, composableLambda, i, rememberComposableLambda2, (Function0) rememberedValue4, f2, f3, f4, f5, f6, startRestartGroup, ((i7 >> 6) & 896) | ((i6 >> 6) & 57344) | (29360128 & i8) | (234881024 & i8) | (i8 & 1879048192), ((i7 >> 27) & 14) | ((i6 << 3) & SdkConfig.SDK_VERSION));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$3
                ...
                public final void invoke(Composer composer2, int i9) {
                    NavigationItemKt.m1994NavigationItemSHbi2eg(z, function0, function2, textStyle, shape, f, f2, f3, f4, f5, f6, navigationItemColors, modifier, z2, function22, function23, i, mutableInteractionSource, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final void m1995NavigationItemLayoutKmRXDg(final InteractionSource interactionSource, final long j, final Shape shape, final Function2<? super Composer, ? super Integer, Unit> function2, final int i, final Function2<? super Composer, ? super Integer, Unit> function22, final Function0<Float> function0, final float f, final float f2, final float f3, final float f4, final float f5, Composer composer, final int i2, final int i3) {
        int i4;
        int i5;
        int i6;
        Composer composer2;
        ...
        if ((i4 & 306783379) != 306783378 || (i5 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            if (function22 == null || NavigationItemIconPosition.m1988equalsimpl0(i, NavigationItemIconPosition.INSTANCE.m1993getTopxw1Ddg())) {
                i6 = i4;
            ...
            Composer m3336constructorimpl = Updater.m3336constructorimpl(composer2);
            Updater.m3343setimpl(m3336constructorimpl, obj, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m3343setimpl(m3336constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
            if (m3336constructorimpl.getInserting() || !Intrinsics.areEqual(m3336constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                m3336constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
            ...
            BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.INSTANCE, IndicatorRippleLayoutIdTag), shape), interactionSource, RippleKt.m2090rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7)), composer2, 0);
            Modifier layoutId = LayoutIdKt.layoutId(Modifier.INSTANCE, IndicatorLayoutIdTag);
            ComposerKt.sourceInformationMarkerStart(composer2, -776750382, "CC(remember):NavigationItem.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerEnd(composer2);
            BoxKt.Box(BackgroundKt.m238backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue), j, shape), composer2, 0);
            Modifier layoutId2 = LayoutIdKt.layoutId(Modifier.INSTANCE, IconLayoutIdTag);
            ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
            MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.INSTANCE.getTopStart(), false);
            ComposerKt.sourceInformationMarkerStart(composer2, -1323940314, "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh");
            ...
            ComposerKt.sourceInformationMarkerStart(composer2, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            ComposerKt.sourceInformationMarkerStart(composer2, 14502763, "C375@15803L6:NavigationItem.kt#uh7d8r");
            ...
            ComposerKt.sourceInformation(composer2, "377@15861L52");
            if (function22 != null) {
                Modifier layoutId3 = LayoutIdKt.layoutId(Modifier.INSTANCE, LabelLayoutIdTag);
                ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                ...
                ComposerKt.sourceInformationMarkerStart(composer2, 14602986, "C377@15904L7:NavigationItem.kt#uh7d8r");
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItemLayout$2
                ...
                public final void invoke(Composer composer3, int i7) {
                    NavigationItemKt.m1995NavigationItemLayoutKmRXDg(InteractionSource.this, j, shape, function2, i, function22, function0, f, f2, f3, f4, f5, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final MeasureResult m2000placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        int m6273constrainWidthK40F9xA = ConstraintsKt.m6273constrainWidthK40F9xA(j, placeable2.getWidth());
        int m6272constrainHeightK40F9xA = ConstraintsKt.m6272constrainHeightK40F9xA(j, placeable2.getHeight());
        final int width = (m6273constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int height = (m6272constrainHeightK40F9xA - placeable3.getHeight()) / 2;
        final int width2 = (m6273constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height2 = (m6272constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width3 = (m6273constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height3 = (m6272constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m6273constrainWidthK40F9xA, m6272constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasureResult m2002placeLabelAndTopIconqoqLrGI(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, float f, float f2, float f3) {
        int m6273constrainWidthK40F9xA = ConstraintsKt.m6273constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), placeable3.getWidth()));
        int m6272constrainHeightK40F9xA = ConstraintsKt.m6272constrainHeightK40F9xA(j, MathKt.roundToInt(placeable3.getHeight() + measureScope.mo376toPx0680j_4(f) + placeable.getHeight() + (measureScope.mo376toPx0680j_4(f3) * 2)));
        final int i = measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(f3 + f2));
        final int width = (m6273constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width2 = (m6273constrainWidthK40F9xA - placeable4.getWidth()) / 2;
        final int i2 = i - measureScope.mo370roundToPx0680j_4(f2);
        final int width3 = (m6273constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = i + placeable2.getHeight() + measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(f + f2));
        final int width4 = (m6273constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        return MeasureScope.layout$default(measureScope, m6273constrainWidthK40F9xA, m6272constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeLabelAndTopIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasureResult m2001placeLabelAndStartIconnru01g4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, float f) {
        int m6273constrainWidthK40F9xA = ConstraintsKt.m6273constrainWidthK40F9xA(j, placeable3.getWidth());
        int m6272constrainHeightK40F9xA = ConstraintsKt.m6272constrainHeightK40F9xA(j, placeable3.getHeight());
        final int width = (m6273constrainWidthK40F9xA - placeable4.getWidth()) / 2;
        final int height = (m6272constrainHeightK40F9xA - placeable4.getHeight()) / 2;
        final int height2 = (m6272constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        final int height3 = (m6272constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width2 = (m6273constrainWidthK40F9xA - ((placeable2.getWidth() + measureScope.mo370roundToPx0680j_4(f)) + placeable.getWidth())) / 2;
        final int width3 = placeable2.getWidth() + width2 + measureScope.mo370roundToPx0680j_4(f);
        final int width4 = (m6273constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int height4 = (m6272constrainHeightK40F9xA - placeable3.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m6273constrainWidthK40F9xA, m6272constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeLabelAndStartIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
