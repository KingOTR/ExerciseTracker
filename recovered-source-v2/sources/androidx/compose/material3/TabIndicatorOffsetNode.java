...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo94measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.initialWidth != null) {
            ...
            if (!Dp.m6308equalsimpl0(width, animatable.getTargetValue().m6317unboximpl())) {
            ...
            this.initialWidth = Dp.m6301boximpl(width);
        }
        ...
        if (this.initialOffset != null) {
            ...
            if (!Dp.m6308equalsimpl0(left, animatable2.getTargetValue().m6317unboximpl())) {
            ...
            this.initialOffset = Dp.m6301boximpl(left);
        }
        Animatable<Dp, AnimationVector1D> animatable3 = this.offsetAnimatable;
        if (animatable3 != null) {
            left = animatable3.getValue().m6317unboximpl();
        }
        Animatable<Dp, AnimationVector1D> animatable4 = this.widthAnimatable;
        if (animatable4 != null) {
            width = animatable4.getValue().m6317unboximpl();
        }
        final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(j, measureScope.mo370roundToPx0680j_4(width), measureScope.mo370roundToPx0680j_4(width), 0, 0, 12, null));
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, Placeable.this, measureScope.mo370roundToPx0680j_4(left), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
