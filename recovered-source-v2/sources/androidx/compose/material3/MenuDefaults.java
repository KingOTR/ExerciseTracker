...
public final class MenuDefaults {
    ...
    private static final float ShadowElevation = MenuTokens.INSTANCE.m3000getContainerElevationD9Ej5fM();
    ...
    static {
        ...
        DropdownMenuItemContentPadding = PaddingKt.m678PaddingValuesYgX7TsA(f, Dp.m6303constructorimpl(0));
    }

    /* renamed from: getTonalElevation-D9Ej5fM, reason: not valid java name */
    public final float m1911getTonalElevationD9Ej5fM() {
        return TonalElevation;
    }

    /* renamed from: getShadowElevation-D9Ej5fM, reason: not valid java name */
    public final float m1910getShadowElevationD9Ej5fM() {
    ...
    public final MenuItemColors m1912itemColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        if (ComposerKt.isTraceInProgress()) {
            j7 = m3879getUnspecified0d7_KjU6;
            ComposerKt.traceEventStart(-1278543580, i, -1, "androidx.compose.material3.MenuDefaults.itemColors (Menu.kt:229)");
        } else {
            j7 = m3879getUnspecified0d7_KjU6;
        }
        MenuItemColors m1914copytNS2XkQ = getDefaultMenuItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1914copytNS2XkQ(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4, m3879getUnspecified0d7_KjU5, j7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1914copytNS2XkQ;
    }
