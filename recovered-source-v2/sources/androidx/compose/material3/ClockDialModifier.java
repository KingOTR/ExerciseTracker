...
public final /* data */ class ClockDialModifier extends ModifierNodeElement<ClockDialNode> {
    ...
    public static /* synthetic */ ClockDialModifier m1563copye8ubxrI$default(ClockDialModifier clockDialModifier, AnalogTimePickerState analogTimePickerState, boolean z, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return clockDialModifier.m1564copye8ubxrI(analogTimePickerState, z, i);
    }

    /* renamed from: copy-e8ubxrI, reason: not valid java name */
    public final ClockDialModifier m1564copye8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.state, clockDialModifier.state) && this.autoSwitchToMinute == clockDialModifier.autoSwitchToMinute && TimePickerSelectionMode.m2430equalsimpl0(this.selection, clockDialModifier.selection);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.state.hashCode() * 31) + Boolean.hashCode(this.autoSwitchToMinute)) * 31) + TimePickerSelectionMode.m2431hashCodeimpl(this.selection);
    }
    ...
    public String toString() {
        return "ClockDialModifier(state=" + this.state + ", autoSwitchToMinute=" + this.autoSwitchToMinute + ", selection=" + ((Object) TimePickerSelectionMode.m2432toStringimpl(this.selection)) + ')';
    }
    ...
    public void update(ClockDialNode node) {
        node.m1565updateNodee8ubxrI(this.state, this.autoSwitchToMinute, this.selection);
    }
}
