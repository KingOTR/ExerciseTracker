...
public class FloatingActionButtonElevation {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        boolean changedInstance = composer.changedInstance(floatingActionButtonElevationAnimatable) | ((((i & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(this)) || (i & 48) == 32);
    ...
    public boolean equals(Object other) {
        ...
        if (Dp.m6308equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m6308equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m6308equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation)) {
            return Dp.m6308equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m6309hashCodeimpl(this.defaultElevation) * 31) + Dp.m6309hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6309hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6309hashCodeimpl(this.hoveredElevation);
    }
}
