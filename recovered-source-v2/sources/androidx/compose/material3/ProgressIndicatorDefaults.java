...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = ProgressIndicatorTokens.INSTANCE.m3151getTrackThicknessD9Ej5fM();
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m4197getRoundKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m4197getRoundKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m4197getRoundKaPHkGw();
    private static final float LinearTrackStopIndicatorSize = ProgressIndicatorTokens.INSTANCE.m3150getStopSizeD9Ej5fM();
    private static final float LinearIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3147getActiveTrackSpaceD9Ej5fM();
    private static final float CircularIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3147getActiveTrackSpaceD9Ej5fM();
    ...
    public static /* synthetic */ void m2036getCircularIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }
    ...
    public static /* synthetic */ void m2037getLinearIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }

    /* renamed from: getLinearTrackStopIndicatorSize-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m2038getLinearTrackStopIndicatorSizeD9Ej5fM$annotations() {
    }
    ...
    public final long getCircularTrackColor(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m3878getTransparent0d7_KjU;
    }
    ...
    public final void m2039drawStopIndicatorEgI2THU(DrawScope drawScope, float stopSize, long color, int strokeCap) {
        float min = Math.min(drawScope.mo376toPx0680j_4(stopSize), Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()));
        float m3668getHeightimpl = (Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()) - min) / 2;
        if (StrokeCap.m4192equalsimpl0(strokeCap, StrokeCap.INSTANCE.m4197getRoundKaPHkGw())) {
            float f = min / 2.0f;
            DrawScope.m4380drawCircleVaOC9Bg$default(drawScope, color, f, OffsetKt.Offset((Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()) - f) - m3668getHeightimpl, Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()) / 2.0f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        } else {
            DrawScope.m4393drawRectnJ9OG0$default(drawScope, color, OffsetKt.Offset((Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()) - min) - m3668getHeightimpl, (Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc()) - min) / 2.0f), SizeKt.Size(min, min), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
}
