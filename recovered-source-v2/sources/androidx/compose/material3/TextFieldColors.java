...
public final class TextFieldColors {
    ...
    public final long m2340leadingIconColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledLeadingIconColor;
        }
        if (isError) {
    ...
    public final long m2346trailingIconColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledTrailingIconColor;
        }
        if (isError) {
    ...
    public final long m2338indicatorColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledIndicatorColor;
        }
        if (isError) {
    ...
    public final long m2293containerColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledContainerColor;
        }
        if (isError) {
    ...
    public final long m2341placeholderColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledPlaceholderColor;
        }
        if (isError) {
    ...
    public final long m2339labelColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledLabelColor;
        }
        if (isError) {
    ...
    public final long m2345textColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (isError) {
    ...
    public final long m2344supportingTextColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledSupportingTextColor;
        }
        if (isError) {
    ...
    public final long m2342prefixColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledPrefixColor;
        }
        if (isError) {
    ...
    public final long m2343suffixColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledSuffixColor;
        }
        if (isError) {
    ...
    public final long m2295cursorColorvNxB06k$material3_release(boolean isError) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.focusedTextColor, textFieldColors.focusedTextColor) && Color.m3844equalsimpl0(this.unfocusedTextColor, textFieldColors.unfocusedTextColor) && Color.m3844equalsimpl0(this.disabledTextColor, textFieldColors.disabledTextColor) && Color.m3844equalsimpl0(this.errorTextColor, textFieldColors.errorTextColor) && Color.m3844equalsimpl0(this.focusedContainerColor, textFieldColors.focusedContainerColor) && Color.m3844equalsimpl0(this.unfocusedContainerColor, textFieldColors.unfocusedContainerColor) && Color.m3844equalsimpl0(this.disabledContainerColor, textFieldColors.disabledContainerColor) && Color.m3844equalsimpl0(this.errorContainerColor, textFieldColors.errorContainerColor) && Color.m3844equalsimpl0(this.cursorColor, textFieldColors.cursorColor) && Color.m3844equalsimpl0(this.errorCursorColor, textFieldColors.errorCursorColor) && Intrinsics.areEqual(this.textSelectionColors, textFieldColors.textSelectionColors) && Color.m3844equalsimpl0(this.focusedIndicatorColor, textFieldColors.focusedIndicatorColor) && Color.m3844equalsimpl0(this.unfocusedIndicatorColor, textFieldColors.unfocusedIndicatorColor) && Color.m3844equalsimpl0(this.disabledIndicatorColor, textFieldColors.disabledIndicatorColor) && Color.m3844equalsimpl0(this.errorIndicatorColor, textFieldColors.errorIndicatorColor) && Color.m3844equalsimpl0(this.focusedLeadingIconColor, textFieldColors.focusedLeadingIconColor) && Color.m3844equalsimpl0(this.unfocusedLeadingIconColor, textFieldColors.unfocusedLeadingIconColor) && Color.m3844equalsimpl0(this.disabledLeadingIconColor, textFieldColors.disabledLeadingIconColor) && Color.m3844equalsimpl0(this.errorLeadingIconColor, textFieldColors.errorLeadingIconColor) && Color.m3844equalsimpl0(this.focusedTrailingIconColor, textFieldColors.focusedTrailingIconColor) && Color.m3844equalsimpl0(this.unfocusedTrailingIconColor, textFieldColors.unfocusedTrailingIconColor) && Color.m3844equalsimpl0(this.disabledTrailingIconColor, textFieldColors.disabledTrailingIconColor) && Color.m3844equalsimpl0(this.errorTrailingIconColor, textFieldColors.errorTrailingIconColor) && Color.m3844equalsimpl0(this.focusedLabelColor, textFieldColors.focusedLabelColor) && Color.m3844equalsimpl0(this.unfocusedLabelColor, textFieldColors.unfocusedLabelColor) && Color.m3844equalsimpl0(this.disabledLabelColor, textFieldColors.disabledLabelColor) && Color.m3844equalsimpl0(this.errorLabelColor, textFieldColors.errorLabelColor) && Color.m3844equalsimpl0(this.focusedPlaceholderColor, textFieldColors.focusedPlaceholderColor) && Color.m3844equalsimpl0(this.unfocusedPlaceholderColor, textFieldColors.unfocusedPlaceholderColor) && Color.m3844equalsimpl0(this.disabledPlaceholderColor, textFieldColors.disabledPlaceholderColor) && Color.m3844equalsimpl0(this.errorPlaceholderColor, textFieldColors.errorPlaceholderColor) && Color.m3844equalsimpl0(this.focusedSupportingTextColor, textFieldColors.focusedSupportingTextColor) && Color.m3844equalsimpl0(this.unfocusedSupportingTextColor, textFieldColors.unfocusedSupportingTextColor) && Color.m3844equalsimpl0(this.disabledSupportingTextColor, textFieldColors.disabledSupportingTextColor) && Color.m3844equalsimpl0(this.errorSupportingTextColor, textFieldColors.errorSupportingTextColor) && Color.m3844equalsimpl0(this.focusedPrefixColor, textFieldColors.focusedPrefixColor) && Color.m3844equalsimpl0(this.unfocusedPrefixColor, textFieldColors.unfocusedPrefixColor) && Color.m3844equalsimpl0(this.disabledPrefixColor, textFieldColors.disabledPrefixColor) && Color.m3844equalsimpl0(this.errorPrefixColor, textFieldColors.errorPrefixColor) && Color.m3844equalsimpl0(this.focusedSuffixColor, textFieldColors.focusedSuffixColor) && Color.m3844equalsimpl0(this.unfocusedSuffixColor, textFieldColors.unfocusedSuffixColor) && Color.m3844equalsimpl0(this.disabledSuffixColor, textFieldColors.disabledSuffixColor) && Color.m3844equalsimpl0(this.errorSuffixColor, textFieldColors.errorSuffixColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m3850hashCodeimpl(this.focusedTextColor) * 31) + Color.m3850hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m3850hashCodeimpl(this.disabledTextColor)) * 31) + Color.m3850hashCodeimpl(this.errorTextColor)) * 31) + Color.m3850hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3850hashCodeimpl(this.errorContainerColor)) * 31) + Color.m3850hashCodeimpl(this.cursorColor)) * 31) + Color.m3850hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m3850hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m3850hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m3850hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m3850hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m3850hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3850hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m3850hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m3850hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m3850hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m3850hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m3850hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3850hashCodeimpl(this.errorLabelColor)) * 31) + Color.m3850hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m3850hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m3850hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m3850hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m3850hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m3850hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m3850hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m3850hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m3850hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m3850hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m3850hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m3850hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m3850hashCodeimpl(this.errorSuffixColor);
    }
}
