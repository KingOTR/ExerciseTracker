...
public final class TimePickerKt {
    ...
    private static final float OuterCircleSizeRadius = Dp.m6303constructorimpl(Endpoint.TARGET_FIELD_NUMBER);
    private static final float InnerCircleRadius = Dp.m6303constructorimpl(69);
    private static final float ClockDisplayBottomMargin = Dp.m6303constructorimpl(36);
    private static final float SupportLabelTop = Dp.m6303constructorimpl(7);
    private static final float MaxDistance = Dp.m6303constructorimpl(74);
    private static final float MinimumInteractiveSize = Dp.m6303constructorimpl(48);
    ...
    */
    public static final void m2403TimePickermT9BvqQ(final TimePickerState timePickerState, Modifier modifier, TimePickerColors timePickerColors, int i, Composer composer, final int i2, final int i3) {
        int i4;
        ...
        if ((i4 & 1171) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            if ((i2 & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                ...
                if ((i3 & 8) != 0) {
                    i = TimePickerDefaults.INSTANCE.m2401layoutTypesDNSZnc(startRestartGroup, 6);
                    i4 &= -7169;
                }
                ...
                if (TimePickerLayoutType.m2421equalsimpl0(i, TimePickerLayoutType.INSTANCE.m2426getVerticalQJTpgSE())) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePicker$1
                ...
                public final void invoke(Composer composer2, int i7) {
                    TimePickerKt.m2403TimePickermT9BvqQ(TimePickerState.this, modifier2, timePickerColors2, i6, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                }
            });
        }
    }
    ...
    */
    ...
    public static final TimePickerState rememberTimePickerState(int i, int i2, boolean z, Composer composer, int i3, int i4) {
        ...
        boolean z2 = ((((i3 & 14) ^ 6) > 4 && composer.changed(i5)) || (i3 & 6) == 4) | ((((i3 & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(i6)) || (i3 & 48) == 32) | ((((i3 & 896) ^ 384) > 256 && composer.changed(is24HourFormat)) || (i3 & 384) == 256);
        ...
        TimePickerStateImpl timePickerStateImpl = (TimePickerStateImpl) RememberSaveableKt.m3429rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final void m2412moveSelectord3b8Pxo(TimePickerState timePickerState, float f, float f2, float f3, long j) {
        if (TimePickerSelectionMode.m2430equalsimpl0(timePickerState.mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI()) && timePickerState.getIs24hour()) {
            timePickerState.setAfternoon(dist(f, f2, IntOffset.m6431getXimpl(j), IntOffset.m6432getYimpl(j)) < f3);
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object m2414onTaprOwcSBo(AnalogTimePickerState analogTimePickerState, float f, float f2, float f3, boolean z, long j, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof TimePickerKt$onTap$1) {
            ...
            if ((timePickerKt$onTap$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    float atan = atan(f2 - IntOffset.m6432getYimpl(j), f - IntOffset.m6431getXimpl(j));
                    if (TimePickerSelectionMode.m2430equalsimpl0(analogTimePickerState.mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI())) {
                        f4 = RadiansPerMinute;
                    ...
                    float f5 = rint * f4;
                    m2412moveSelectord3b8Pxo(analogTimePickerState3, f, f2, f3, j);
                    ...
                    if (i != 1) {
                        ...
                        if (z2) {
                            analogTimePickerState3.mo1442setSelection6_8s6DQ(TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI());
                        }
                        return Unit.INSTANCE;
                    }
                ...
                if (TimePickerSelectionMode.m2430equalsimpl0(analogTimePickerState3.mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI()) && z2) {
                    timePickerKt$onTap$1.L$0 = analogTimePickerState3;
                    timePickerKt$onTap$1.Z$0 = z2;
        ...
        if (TimePickerSelectionMode.m2430equalsimpl0(analogTimePickerState3.mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
            timePickerKt$onTap$1.L$0 = analogTimePickerState3;
            timePickerKt$onTap$1.Z$0 = z2;
            timePickerKt$onTap$1.label = 2;
            if (DelayKt.delay(100L, timePickerKt$onTap$1) != coroutine_suspended) {
    ...
    public static final long getSelectorPos(AnalogTimePickerState analogTimePickerState) {
        float f;
        float f2 = 2;
        float m6303constructorimpl = Dp.m6303constructorimpl(TimePickerTokens.INSTANCE.m3224getClockDialSelectorHandleContainerSizeD9Ej5fM() / f2);
        if (analogTimePickerState.getIs24hour() && analogTimePickerState.isAfternoon() && TimePickerSelectionMode.m2430equalsimpl0(analogTimePickerState.mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
            f = InnerCircleRadius;
        } else {
            f = OuterCircleSizeRadius;
        }
        float m6303constructorimpl2 = Dp.m6303constructorimpl(Dp.m6303constructorimpl(f - m6303constructorimpl) + m6303constructorimpl);
        return DpKt.m6324DpOffsetYgX7TsA(Dp.m6303constructorimpl(Dp.m6303constructorimpl(((float) Math.cos(analogTimePickerState.getCurrentAngle())) * m6303constructorimpl2) + Dp.m6303constructorimpl(TimePickerTokens.INSTANCE.m3222getClockDialContainerSizeD9Ej5fM() / f2)), Dp.m6303constructorimpl(Dp.m6303constructorimpl(m6303constructorimpl2 * ((float) Math.sin(analogTimePickerState.getCurrentAngle()))) + Dp.m6303constructorimpl(TimePickerTokens.INSTANCE.m3222getClockDialContainerSizeD9Ej5fM() / f2)));
    }
    ...
    public static final void VerticalTimePicker(final AnalogTimePickerState analogTimePickerState, Modifier modifier, TimePickerColors timePickerColors, final boolean z, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 1171) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                ...
                int i5 = i3 & 14;
                int i6 = i3 >> 3;
                int i7 = i5 | (i6 & SdkConfig.SDK_VERSION);
                VerticalClockDisplay(analogTimePickerState, timePickerColors, startRestartGroup, i7);
                SpacerKt.Spacer(SizeKt.m715height3ABfNKs(Modifier.INSTANCE, ClockDisplayBottomMargin), startRestartGroup, 6);
                ClockFace(analogTimePickerState, timePickerColors, z, startRestartGroup, (i6 & 896) | i7);
                SpacerKt.Spacer(SizeKt.m715height3ABfNKs(Modifier.INSTANCE, ClockFaceBottomMargin), startRestartGroup, 6);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    */
    public static final void HorizontalTimePicker(final AnalogTimePickerState analogTimePickerState, Modifier modifier, TimePickerColors timePickerColors, final boolean z, Composer composer, final int i, final int i2) {
        ...
        if (i5 != 0) {
            ...
            if ((i3 & 1171) == 1170 || !startRestartGroup.getSkipping()) {
                ...
                Modifier m688paddingqDBjuR0$default = PaddingKt.m688paddingqDBjuR0$default(companion, 0.0f, 0.0f, 0.0f, ClockFaceBottomMargin, 7, null);
                ...
                int i6 = i3 & 14;
                int i7 = i3 >> 3;
                int i8 = i6 | (i7 & SdkConfig.SDK_VERSION);
                HorizontalClockDisplay(analogTimePickerState, timePickerColors2, startRestartGroup, i8);
                SpacerKt.Spacer(SizeKt.m734width3ABfNKs(Modifier.INSTANCE, ClockDisplayBottomMargin), startRestartGroup, 6);
        ...
        Modifier m688paddingqDBjuR0$default2 = PaddingKt.m688paddingqDBjuR0$default(companion, 0.0f, 0.0f, 0.0f, ClockFaceBottomMargin, 7, null);
        ...
        int i62 = i3 & 14;
        int i72 = i3 >> 3;
        int i82 = i62 | (i72 & SdkConfig.SDK_VERSION);
    ...
    public static final void TimeInputImpl(final Modifier modifier, final TimePickerColors timePickerColors, final TimePickerState timePickerState, Composer composer, final int i) {
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m688paddingqDBjuR0$default = PaddingKt.m688paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, TimeInputBottomPadding, 7, null);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{TextKt.getLocalTextStyle().provides(m5814copyp1EtxEg), CompositionLocalsKt.getLocalLayoutDirection().provides(LayoutDirection.Ltr)}, ComposableLambdaKt.rememberComposableLambda(1306700887, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    if ((i5 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        if (changed || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue3 = (Function1) new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$1$1$1
                                ...
                                public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                                    return m2416invokeZmokQxo(keyEvent.m4897unboximpl());
                                }

                                /* renamed from: invoke-ZmokQxo, reason: not valid java name */
                                public final Boolean m2416invokeZmokQxo(android.view.KeyEvent keyEvent) {
                                    TextFieldValue TimeInputImpl$lambda$62;
                                    TextFieldValue TimeInputImpl$lambda$63;
                                    int m4910getUtf16CodePointZmokQxo = KeyEvent_androidKt.m4910getUtf16CodePointZmokQxo(keyEvent);
                                    if (48 <= m4910getUtf16CodePointZmokQxo && m4910getUtf16CodePointZmokQxo < 58) {
                                        TimeInputImpl$lambda$62 = TimePickerKt.TimeInputImpl$lambda$6(mutableState);
                                        if (TextRange.m5788getStartimpl(TimeInputImpl$lambda$62.getSelection()) == 2) {
                                            TimeInputImpl$lambda$63 = TimePickerKt.TimeInputImpl$lambda$6(mutableState);
                                            if (TimeInputImpl$lambda$63.getText().length() == 2) {
                                                TimePickerState.this.mo1442setSelection6_8s6DQ(TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI());
                                            }
                                        }
                                    }
                                    return false;
                        ...
                        if (changedInstance || rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue4 = (Function1) new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$1$2$1
                                ...
                                public final void invoke2(TextFieldValue textFieldValue) {
                                    TextFieldValue TimeInputImpl$lambda$62;
                                    int m2434getHouryecRtBI = TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI();
                                    ...
                                    TimePickerKt.m2415timeInputOnChangez7XvuPQ(m2434getHouryecRtBI, timePickerState3, textFieldValue, TimeInputImpl$lambda$62, i6, new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$1$2$1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(1);
                                        }
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        int m2434getHouryecRtBI = TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI();
                        KeyboardOptions keyboardOptions = new KeyboardOptions(0, (Boolean) null, KeyboardType.INSTANCE.m6023getNumberPjHm6EE(), ImeAction.INSTANCE.m5969getNexteUduSuo(), (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 115, (DefaultConstructorMarker) null);
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        TimePickerKt.m2404TimePickerTextField1vLObsk(onKeyEvent, TimeInputImpl$lambda$6, function1, timePickerState2, m2434getHouryecRtBI, keyboardOptions, new KeyboardActions(null, null, (Function1) rememberedValue5, null, null, null, 59, null), timePickerColors2, composer3, 24576, 0);
                        Modifier.Companion companion3 = Modifier.INSTANCE;
                        f = TimePickerKt.DisplaySeparatorWidth;
                        TimePickerKt.DisplaySeparator(SizeKt.m731sizeVpY3zN4(companion3, f, TimeInputTokens.INSTANCE.m3216getPeriodSelectorContainerHeightD9Ej5fM()), composer3, 6);
                        ...
                        if (changed2 || rememberedValue6 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue6 = (Function1) new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$1$4$1
                                ...
                                @Override // kotlin.jvm.functions.Function1
                                public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                                    return m2417invokeZmokQxo(keyEvent.m4897unboximpl());
                                }
                                ...
                                /*
                                    Code decompiled incorrectly, please refer to instructions dump.
                                */
                                public final Boolean m2417invokeZmokQxo(android.view.KeyEvent keyEvent) {
                                    boolean z3;
                                    TextFieldValue TimeInputImpl$lambda$92;
                                    if (KeyEvent_androidKt.m4910getUtf16CodePointZmokQxo(keyEvent) == 0) {
                                        TimeInputImpl$lambda$92 = TimePickerKt.TimeInputImpl$lambda$9(mutableState2);
                                        if (TextRange.m5788getStartimpl(TimeInputImpl$lambda$92.getSelection()) == 0) {
                                            z3 = true;
                                            if (z3) {
                                                TimePickerState.this.mo1442setSelection6_8s6DQ(TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI());
                                            }
                        ...
                        if (changedInstance3 || rememberedValue7 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue7 = (Function1) new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$1$5$1
                                ...
                                public final void invoke2(TextFieldValue textFieldValue) {
                                    TextFieldValue TimeInputImpl$lambda$92;
                                    int m2435getMinuteyecRtBI = TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI();
                                    TimePickerState timePickerState3 = TimePickerState.this;
                                    TimeInputImpl$lambda$92 = TimePickerKt.TimeInputImpl$lambda$9(mutableState2);
                                    final MutableState<TextFieldValue> mutableState3 = mutableState2;
                                    TimePickerKt.m2415timeInputOnChangez7XvuPQ(m2435getMinuteyecRtBI, timePickerState3, textFieldValue, TimeInputImpl$lambda$92, 59, new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$1$5$1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(1);
                                        }
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        int m2435getMinuteyecRtBI = TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI();
                        KeyboardOptions keyboardOptions2 = new KeyboardOptions(0, (Boolean) null, KeyboardType.INSTANCE.m6023getNumberPjHm6EE(), ImeAction.INSTANCE.m5967getDoneeUduSuo(), (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 115, (DefaultConstructorMarker) null);
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        TimePickerKt.m2404TimePickerTextField1vLObsk(onPreviewKeyEvent, TimeInputImpl$lambda$9, function12, timePickerState2, m2435getMinuteyecRtBI, keyboardOptions2, new KeyboardActions(null, null, (Function1) rememberedValue8, null, null, null, 59, null), timePickerColors2, composer3, 24576, 0);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        composer3.endNode();
                        ComposerKt.sourceInformationMarkerEnd(composer3);
            ...
            if (!timePickerState.getIs24hour()) {
                Modifier m688paddingqDBjuR0$default2 = PaddingKt.m688paddingqDBjuR0$default(Modifier.INSTANCE, PeriodToggleMargin, 0.0f, 0.0f, 0.0f, 14, null);
                ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.INSTANCE.getTopStart(), false);
                ComposerKt.sourceInformationMarkerStart(composer2, -1323940314, "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh");
                int currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composer2, 0);
                CompositionLocalMap currentCompositionLocalMap2 = composer2.getCurrentCompositionLocalMap();
                Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(composer2, m688paddingqDBjuR0$default2);
                Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                ComposerKt.sourceInformationMarkerStart(composer2, -692256719, "CC(ReusableComposeNode)P(1,2)376@14062L9:Composables.kt#9igjgp");
                if (!(composer2.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                ...
                VerticalPeriodToggle(SizeKt.m731sizeVpY3zN4(Modifier.INSTANCE, TimeInputTokens.INSTANCE.m3217getPeriodSelectorContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m3216getPeriodSelectorContainerHeightD9Ej5fM()), timePickerState, timePickerColors, composer2, 6 | ((i3 >> 3) & SdkConfig.SDK_VERSION) | ((i3 << 3) & 896));
    ...
    public static final void HorizontalClockDisplay(final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            if (!timePickerState.getIs24hour()) {
                Modifier m688paddingqDBjuR0$default = PaddingKt.m688paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, PeriodToggleMargin, 0.0f, 0.0f, 13, null);
                ...
                int i3 = i2 << 3;
                HorizontalPeriodToggle(SizeKt.m731sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m3228getPeriodSelectorHorizontalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m3227getPeriodSelectorHorizontalContainerHeightD9Ej5fM()), timePickerState, timePickerColors, startRestartGroup, (i3 & 896) | (i3 & SdkConfig.SDK_VERSION) | 6);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    public static final void VerticalClockDisplay(final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            if (!timePickerState.getIs24hour()) {
                Modifier m688paddingqDBjuR0$default = PaddingKt.m688paddingqDBjuR0$default(Modifier.INSTANCE, PeriodToggleMargin, 0.0f, 0.0f, 0.0f, 14, null);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.INSTANCE.getTopStart(), false);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1323940314, "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh");
                int currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(startRestartGroup, 0);
                ...
                int i3 = i2 << 3;
                VerticalPeriodToggle(SizeKt.m731sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m3231getPeriodSelectorVerticalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m3230getPeriodSelectorVerticalContainerHeightD9Ej5fM()), timePickerState, timePickerColors, startRestartGroup, (i3 & 896) | (i3 & SdkConfig.SDK_VERSION) | 6);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{TextKt.getLocalTextStyle().provides(TypographyKt.getValue(TimePickerTokens.INSTANCE.getTimeSelectorLabelTextFont(), startRestartGroup, 6)), CompositionLocalsKt.getLocalLayoutDirection().provides(LayoutDirection.Ltr)}, ComposableLambdaKt.rememberComposableLambda(-477913269, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockDisplayNumbers$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        TimePickerKt.m2405TimeSelectorSAnMeKU(SizeKt.m731sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m3234getTimeSelectorContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m3233getTimeSelectorContainerHeightD9Ej5fM()), TimePickerKt.getHourForDisplay(timePickerState2), timePickerState2, TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI(), timePickerColors2, composer2, 3078);
                        Modifier.Companion companion2 = Modifier.INSTANCE;
                        f = TimePickerKt.DisplaySeparatorWidth;
                        TimePickerKt.DisplaySeparator(SizeKt.m731sizeVpY3zN4(companion2, f, TimePickerTokens.INSTANCE.m3230getPeriodSelectorVerticalContainerHeightD9Ej5fM()), composer2, 6);
                        TimePickerKt.m2405TimeSelectorSAnMeKU(SizeKt.m731sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m3234getTimeSelectorContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m3233getTimeSelectorContainerHeightD9Ej5fM()), timePickerState2.getMinute(), timePickerState2, TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI(), timePickerColors2, composer2, 3078);
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        composer2.endNode();
                        ComposerKt.sourceInformationMarkerEnd(composer2);
    ...
    public static final void HorizontalPeriodToggle(final Modifier modifier, final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !startRestartGroup.getSkipping()) {
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        ...
                        for (int i3 = 0; i3 < size; i3++) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                                final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(j, 0, measureScope.mo370roundToPx0680j_4(TimePickerTokens.INSTANCE.m3229getPeriodSelectorOutlineWidthD9Ej5fM()), 0, 0, 12, null));
                                ...
                                for (int i5 = 0; i5 < size3; i5++) {
                                    arrayList3.add(((Measurable) arrayList2.get(i5)).mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(j, 0, Constraints.m6256getMaxWidthimpl(j) / 2, 0, 0, 12, null)));
                                }
                                final ArrayList arrayList4 = arrayList3;
                                return MeasureScope.layout$default(measureScope, Constraints.m6256getMaxWidthimpl(j), Constraints.m6255getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    ...
                                    public final void invoke2(Placeable.PlacementScope placementScope) {
                                        ...
                                        Placeable.PlacementScope.place$default(placementScope, mo5179measureBRTryo0, arrayList4.get(0).getWidth() - (mo5179measureBRTryo0.getWidth() / 2), 0, 0.0f, 4, null);
                                    }
                                }, 4, null);
                            }
                        }
            ...
            PeriodToggleImpl(modifier, timePickerState, timePickerColors, measurePolicy, ShapesKt.start(cornerBasedShape), ShapesKt.end(cornerBasedShape), startRestartGroup, (i2 & 14) | 3072 | (i2 & SdkConfig.SDK_VERSION) | (i2 & 896));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void VerticalPeriodToggle(final Modifier modifier, final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !startRestartGroup.getSkipping()) {
                ...
                rememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        ...
                        for (int i3 = 0; i3 < size; i3++) {
                            Measurable measurable = list.get(i3);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                                final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(j, 0, 0, 0, measureScope.mo370roundToPx0680j_4(TimePickerTokens.INSTANCE.m3229getPeriodSelectorOutlineWidthD9Ej5fM()), 3, null));
                                ArrayList arrayList = new ArrayList(list.size());
                                int size2 = list.size();
                                for (int i4 = 0; i4 < size2; i4++) {
                                    Measurable measurable2 = list.get(i4);
                                ...
                                int size3 = arrayList2.size();
                                for (int i5 = 0; i5 < size3; i5++) {
                                    arrayList3.add(((Measurable) arrayList2.get(i5)).mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(j, 0, 0, 0, Constraints.m6255getMaxHeightimpl(j) / 2, 3, null)));
                                }
                                final ArrayList arrayList4 = arrayList3;
                                return MeasureScope.layout$default(measureScope, Constraints.m6256getMaxWidthimpl(j), Constraints.m6255getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    {
                                        super(1);
                                    ...
                                    public final void invoke2(Placeable.PlacementScope placementScope) {
                                        ...
                                        Placeable.PlacementScope.place$default(placementScope, mo5179measureBRTryo0, 0, arrayList4.get(0).getHeight() - (mo5179measureBRTryo0.getHeight() / 2), 0.0f, 4, null);
                                    }
                                }, 4, null);
                            }
                        }
            ...
            Intrinsics.checkNotNull(value, "null cannot be cast to non-null type androidx.compose.foundation.shape.CornerBasedShape");
            CornerBasedShape cornerBasedShape = (CornerBasedShape) value;
            PeriodToggleImpl(modifier, timePickerState, timePickerColors, measurePolicy, ShapesKt.top(cornerBasedShape), ShapesKt.bottom(cornerBasedShape), startRestartGroup, (i2 & 14) | 3072 | (i2 & SdkConfig.SDK_VERSION) | (i2 & 896));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void PeriodToggleImpl(final Modifier modifier, final TimePickerState timePickerState, final TimePickerColors timePickerColors, final MeasurePolicy measurePolicy, final Shape shape, final Shape shape2, Composer composer, final int i) {
        ...
        if ((74899 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            BorderStroke m266BorderStrokecXLIe8U = BorderStrokeKt.m266BorderStrokecXLIe8U(TimePickerTokens.INSTANCE.m3229getPeriodSelectorOutlineWidthD9Ej5fM(), timePickerColors.getPeriodSelectorBorderColor());
            Shape value = ShapesKt.getValue(TimePickerTokens.INSTANCE.getPeriodSelectorContainerShape(), startRestartGroup, 6);
            Intrinsics.checkNotNull(value, "null cannot be cast to non-null type androidx.compose.foundation.shape.CornerBasedShape");
            CornerBasedShape cornerBasedShape = (CornerBasedShape) value;
            Strings.Companion companion = Strings.INSTANCE;
            final String m2658getString2EP1pXo = Strings_androidKt.m2658getString2EP1pXo(Strings.m2588constructorimpl(R.string.m3c_time_picker_period_toggle_description), startRestartGroup, 0);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            Modifier border = BorderKt.border(SelectableGroupKt.selectableGroup(SemanticsModifierKt.semantics$default(modifier, false, (Function1) rememberedValue, 1, null)), m266BorderStrokecXLIe8U, cornerBasedShape);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1323940314, "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh");
            int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(startRestartGroup, 0);
            CompositionLocalMap currentCompositionLocalMap = startRestartGroup.getCurrentCompositionLocalMap();
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            int i4 = (i2 << 3) & 7168;
            ToggleItem(z, shape, (Function0) rememberedValue2, timePickerColors, ComposableSingletons$TimePickerKt.INSTANCE.m1672getLambda1$material3_release(), startRestartGroup, ((i2 >> 9) & SdkConfig.SDK_VERSION) | 24576 | i4);
            SpacerKt.Spacer(BackgroundKt.m239backgroundbw27NRU$default(SizeKt.fillMaxSize$default(ZIndexModifierKt.zIndex(LayoutIdKt.layoutId(Modifier.INSTANCE, "Spacer"), 2.0f), 0.0f, 1, null), timePickerColors.getPeriodSelectorBorderColor(), null, 2, null), startRestartGroup, 0);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ToggleItem(isAfternoon, shape2, (Function0) rememberedValue3, timePickerColors, ComposableSingletons$TimePickerKt.INSTANCE.m1673getLambda2$material3_release(), startRestartGroup, ((i2 >> 12) & SdkConfig.SDK_VERSION) | 24576 | i4);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    public static final void ToggleItem(final boolean z, final Shape shape, final Function0<Unit> function0, final TimePickerColors timePickerColors, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 9363) != 9362 || !startRestartGroup.getSkipping()) {
            ...
            long m2397periodSelectorContentColorvNxB06k$material3_release = timePickerColors.m2397periodSelectorContentColorvNxB06k$material3_release(z);
            long m2396periodSelectorContainerColorvNxB06k$material3_release = timePickerColors.m2396periodSelectorContainerColorvNxB06k$material3_release(z);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ButtonKt.TextButton(function0, SemanticsModifierKt.semantics$default(fillMaxSize$default, false, (Function1) rememberedValue, 1, null), false, shape, ButtonDefaults.INSTANCE.m1502textButtonColorsro_MJ88(m2396periodSelectorContainerColorvNxB06k$material3_release, m2397periodSelectorContentColorvNxB06k$material3_release, 0L, 0L, startRestartGroup, 24576, 12), null, null, PaddingKt.m677PaddingValues0680j_4(Dp.m6303constructorimpl(0)), null, function3, startRestartGroup, ((i2 >> 6) & 14) | 12582912 | ((i2 << 6) & 7168) | ((i2 << 15) & 1879048192), 356);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void DisplaySeparator(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            m5814copyp1EtxEg = r16.m5814copyp1EtxEg((r48 & 1) != 0 ? r16.spanStyle.m5738getColor0d7_KjU() : 0L, (r48 & 2) != 0 ? r16.spanStyle.getFontSize() : 0L, (r48 & 4) != 0 ? r16.spanStyle.getFontWeight() : null, (r48 & 8) != 0 ? r16.spanStyle.getFontStyle() : null, (r48 & 16) != 0 ? r16.spanStyle.getFontSynthesis() : null, (r48 & 32) != 0 ? r16.spanStyle.getFontFamily() : null, (r48 & 64) != 0 ? r16.spanStyle.getFontFeatureSettings() : null, (r48 & 128) != 0 ? r16.spanStyle.getLetterSpacing() : 0L, (r48 & 256) != 0 ? r16.spanStyle.getBaselineShift() : null, (r48 & 512) != 0 ? r16.spanStyle.getTextGeometricTransform() : null, (r48 & 1024) != 0 ? r16.spanStyle.getLocaleList() : null, (r48 & 2048) != 0 ? r16.spanStyle.getBackground() : 0L, (r48 & 4096) != 0 ? r16.spanStyle.getTextDecoration() : null, (r48 & 8192) != 0 ? r16.spanStyle.getShadow() : null, (r48 & 16384) != 0 ? r16.spanStyle.getDrawStyle() : null, (r48 & 32768) != 0 ? r16.paragraphStyle.getTextAlign() : TextAlign.INSTANCE.m6192getCentere0LSkKk(), (r48 & 65536) != 0 ? r16.paragraphStyle.getTextDirection() : 0, (r48 & 131072) != 0 ? r16.paragraphStyle.getLineHeight() : 0L, (r48 & 262144) != 0 ? r16.paragraphStyle.getTextIndent() : null, (r48 & 524288) != 0 ? r16.platformStyle : null, (r48 & 1048576) != 0 ? r16.paragraphStyle.getLineHeightStyle() : new LineHeightStyle(LineHeightStyle.Alignment.INSTANCE.m6169getCenterPIaL0Z0(), LineHeightStyle.Trim.INSTANCE.m6181getBothEVpEnUU(), null), (r48 & 2097152) != 0 ? r16.paragraphStyle.getLineBreak() : 0, (r48 & 4194304) != 0 ? r16.paragraphStyle.getHyphens() : 0, (r48 & 8388608) != 0 ? ((TextStyle) consume).paragraphStyle.getTextMotion() : null);
            ...
            composer2 = startRestartGroup;
            TextKt.m2376Text4IGK_g(":", (Modifier) null, ColorSchemeKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSeparatorColor(), startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, m5814copyp1EtxEg, composer2, 6, 0, 65530);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer2);
    ...
    public static final void m2405TimeSelectorSAnMeKU(final Modifier modifier, final int i, final TimePickerState timePickerState, final int i2, final TimePickerColors timePickerColors, Composer composer, final int i3) {
        int i4;
        int m2588constructorimpl;
        Composer composer2;
        ...
        if ((i4 & 9363) != 9362 || !startRestartGroup.getSkipping()) {
            ...
            boolean m2430equalsimpl0 = TimePickerSelectionMode.m2430equalsimpl0(timePickerState.mo1441getSelectionyecRtBI(), i2);
            if (TimePickerSelectionMode.m2430equalsimpl0(i2, TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
                Strings.Companion companion = Strings.INSTANCE;
                m2588constructorimpl = Strings.m2588constructorimpl(R.string.m3c_time_picker_hour_selection);
            } else {
                Strings.Companion companion2 = Strings.INSTANCE;
                m2588constructorimpl = Strings.m2588constructorimpl(R.string.m3c_time_picker_minute_selection);
            }
            final String m2658getString2EP1pXo = Strings_androidKt.m2658getString2EP1pXo(m2588constructorimpl, startRestartGroup, 0);
            long m2398timeSelectorContainerColorvNxB06k$material3_release = timePickerColors.m2398timeSelectorContainerColorvNxB06k$material3_release(m2430equalsimpl0);
            final long m2399timeSelectorContentColorvNxB06k$material3_release = timePickerColors.m2399timeSelectorContentColorvNxB06k$material3_release(m2430equalsimpl0);
            ...
            if (z || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                rememberedValue2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$2$1
                    ...
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2() {
                        if (TimePickerSelectionMode.m2430equalsimpl0(i2, timePickerState.mo1441getSelectionyecRtBI())) {
                            return;
                        }
                        timePickerState.mo1442setSelection6_8s6DQ(i2);
                    }
                };
                startRestartGroup.updateRememberedValue(rememberedValue2);
            }
            ...
            SurfaceKt.m2227Surfaced85dljk(m2430equalsimpl0, (Function0<Unit>) rememberedValue2, semantics, false, value, m2398timeSelectorContainerColorvNxB06k$material3_release, 0L, 0.0f, 0.0f, (BorderStroke) null, (MutableInteractionSource) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.rememberComposableLambda(-1477282471, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$3
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    if ((i5 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        final String m2413numberContentDescriptiondSwYdS4 = TimePickerKt.m2413numberContentDescriptiondSwYdS4(i2, timePickerState.getIs24hour(), i, composer3, 0);
                        Alignment center = Alignment.INSTANCE.getCenter();
                        int i6 = i;
                        long j = m2399timeSelectorContentColorvNxB06k$material3_release;
                        ...
                        boolean changed2 = composer3.changed(m2413numberContentDescriptiondSwYdS4);
                        Object rememberedValue3 = composer3.rememberedValue();
                        if (changed2 || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue3 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$3$1$1$1
                                ...
                                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                    SemanticsPropertiesKt.setContentDescription(semanticsPropertyReceiver, m2413numberContentDescriptiondSwYdS4);
                                }
                            };
                            composer3.updateRememberedValue(rememberedValue3);
                        }
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        TextKt.m2376Text4IGK_g(CalendarLocale_jvmKt.toLocalString$default(i6, 2, 0, false, 6, null), SemanticsModifierKt.semantics$default(companion4, false, (Function1) rememberedValue3, 1, null), j, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131064);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        composer3.endNode();
                        ComposerKt.sourceInformationMarkerEnd(composer3);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$4
                ...
                public final void invoke(Composer composer3, int i5) {
                    TimePickerKt.m2405TimeSelectorSAnMeKU(Modifier.this, i, timePickerState, i2, timePickerColors, composer3, RecomposeScopeImplKt.updateChangedFlags(i3 | 1));
                }
            });
        }
    }
    ...
    public static final void ClockFace(final AnalogTimePickerState analogTimePickerState, final TimePickerColors timePickerColors, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            CrossfadeKt.Crossfade(analogTimePickerState.getClockFaceValues(), drawSelector(SizeKt.m729size3ABfNKs(BackgroundKt.m238backgroundbw27NRU(Modifier.INSTANCE, timePickerColors.getClockDialColor(), RoundedCornerShapeKt.getCircleShape()).then(new ClockDialModifier(analogTimePickerState, z, analogTimePickerState.mo1441getSelectionyecRtBI(), null)), TimePickerTokens.INSTANCE.m3222getClockDialContainerSizeD9Ej5fM()), analogTimePickerState, timePickerColors), AnimationSpecKt.tween$default(200, 0, null, 6, null), (String) null, ComposableLambdaKt.rememberComposableLambda(-1022006568, true, new Function3<IntList, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockFace$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(3);
                }
                ...
                public final void invoke(final IntList intList, Composer composer2, int i3) {
                    ...
                    Modifier semantics$default = SemanticsModifierKt.semantics$default(SizeKt.m729size3ABfNKs(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m3222getClockDialContainerSizeD9Ej5fM()), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockFace$1.1
                        @Override // kotlin.jvm.functions.Function1
                        public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                            invoke2(semanticsPropertyReceiver);
                            return Unit.INSTANCE;
                    ...
                    final boolean z2 = z;
                    TimePickerKt.m2402CircularLayoutuFdPcIQ(semantics$default, f, ComposableLambdaKt.rememberComposableLambda(-320307952, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockFace$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(Composer composer3, int i4) {
                            ...
                            if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                ...
                                ProvidedValue<Color> provides = ContentColorKt.getLocalContentColor().provides(Color.m3833boximpl(TimePickerColors.this.m2380clockDialContentColorvNxB06k$material3_release(false)));
                                    ...
                                    public final void invoke(Composer composer4, int i5) {
                                        ...
                                        if ((i5 & 3) != 2 || !composer4.getSkipping()) {
                                            ...
                                            for (final int i7 = 0; i7 < size; i7++) {
                                                if (!analogTimePickerState4.getIs24hour() || TimePickerSelectionMode.m2430equalsimpl0(analogTimePickerState4.mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI())) {
                                                    i6 = intList3.get(i7);
                                                } else {
                                            ...
                                            if (TimePickerSelectionMode.m2430equalsimpl0(analogTimePickerState3.mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI()) && analogTimePickerState3.getIs24hour()) {
                                                Modifier m238backgroundbw27NRU = BackgroundKt.m238backgroundbw27NRU(SizeKt.m729size3ABfNKs(LayoutIdKt.layoutId(Modifier.INSTANCE, LayoutId.InnerCircle), TimePickerTokens.INSTANCE.m3222getClockDialContainerSizeD9Ej5fM()), Color.INSTANCE.m3878getTransparent0d7_KjU(), RoundedCornerShapeKt.getCircleShape());
                                                f2 = TimePickerKt.InnerCircleRadius;
                                                final AnalogTimePickerState analogTimePickerState5 = analogTimePickerState3;
                                                final boolean z5 = z3;
                                                TimePickerKt.m2402CircularLayoutuFdPcIQ(m238backgroundbw27NRU, f2, ComposableLambdaKt.rememberComposableLambda(-205464413, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt.ClockFace.1.2.1.2
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    {
                                                        super(2);
                                                    }
    ...
    private static final Modifier drawSelector(Modifier modifier, final AnalogTimePickerState analogTimePickerState, final TimePickerColors timePickerColors) {
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$drawSelector$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                long Offset = OffsetKt.Offset(contentDrawScope.mo376toPx0680j_4(DpOffset.m6364getXD9Ej5fM(TimePickerKt.getSelectorPos(AnalogTimePickerState.this))), contentDrawScope.mo376toPx0680j_4(DpOffset.m6366getYD9Ej5fM(TimePickerKt.getSelectorPos(AnalogTimePickerState.this))));
                float f = 2;
                float f2 = contentDrawScope.mo376toPx0680j_4(TimePickerTokens.INSTANCE.m3224getClockDialSelectorHandleContainerSizeD9Ej5fM()) / f;
                long selectorColor = timePickerColors.getSelectorColor();
                ContentDrawScope contentDrawScope2 = contentDrawScope;
                DrawScope.m4380drawCircleVaOC9Bg$default(contentDrawScope2, Color.INSTANCE.m3869getBlack0d7_KjU(), f2, Offset, 0.0f, null, null, BlendMode.INSTANCE.m3758getClear0nO6VwU(), 56, null);
                contentDrawScope.drawContent();
                DrawScope.m4380drawCircleVaOC9Bg$default(contentDrawScope2, selectorColor, f2, Offset, 0.0f, null, null, BlendMode.INSTANCE.m3786getXor0nO6VwU(), 56, null);
                DrawScope.m4385drawLineNGM6Ib0$default(contentDrawScope2, selectorColor, androidx.compose.ui.geometry.SizeKt.m3681getCenteruvyYCjk(contentDrawScope.mo4399getSizeNHjbRc()), Offset.m3606minusMKHz9U(Offset, OffsetKt.Offset(((float) Math.cos(AnalogTimePickerState.this.getCurrentAngle())) * f2, ((float) Math.sin(AnalogTimePickerState.this.getCurrentAngle())) * f2)), contentDrawScope.mo376toPx0680j_4(TimePickerTokens.INSTANCE.m3225getClockDialSelectorTrackContainerWidthD9Ej5fM()), 0, null, 0.0f, null, BlendMode.INSTANCE.m3785getSrcOver0nO6VwU(), 240, null);
                DrawScope.m4380drawCircleVaOC9Bg$default(contentDrawScope2, selectorColor, contentDrawScope.mo376toPx0680j_4(TimePickerTokens.INSTANCE.m3223getClockDialSelectorCenterContainerSizeD9Ej5fM()) / f, androidx.compose.ui.geometry.SizeKt.m3681getCenteruvyYCjk(contentDrawScope.mo4399getSizeNHjbRc()), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
                DrawScope.m4380drawCircleVaOC9Bg$default(contentDrawScope2, timePickerColors.m2380clockDialContentColorvNxB06k$material3_release(true), f2, Offset, 0.0f, null, null, BlendMode.INSTANCE.m3768getDstOver0nO6VwU(), 56, null);
            }
        });
    }
    ...
    public static final void ClockText(final Modifier modifier, final AnalogTimePickerState analogTimePickerState, final int i, final boolean z, Composer composer, final int i2) {
        ...
        if ((i4 & 1171) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final float mo376toPx0680j_4 = ((Density) consume).mo376toPx0680j_4(MaxDistance);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 297230880, "CC(remember):TimePicker.kt#9igjgp");
            Object rememberedValue = startRestartGroup.rememberedValue();
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3591boximpl(Offset.INSTANCE.m3618getZeroF1C5BW0()), null, 2, null);
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            ...
            if (rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                rememberedValue2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m6422boximpl(IntOffset.INSTANCE.m6441getZeronOccac()), null, 2, null);
                startRestartGroup.updateRememberedValue(rememberedValue2);
            }
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final String m2413numberContentDescriptiondSwYdS4 = m2413numberContentDescriptiondSwYdS4(analogTimePickerState.mo1441getSelectionyecRtBI(), analogTimePickerState.getIs24hour(), i, startRestartGroup, i4 & 896);
            ...
            Alignment center = Alignment.INSTANCE.getCenter();
            Modifier m729size3ABfNKs = SizeKt.m729size3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier), MinimumInteractiveSize);
            ...
            if (rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                ...
                rememberedValue4 = (Function1) new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockText$1$1
                    ...
                    public final void invoke2(LayoutCoordinates layoutCoordinates) {
                        ...
                        TimePickerKt.ClockText$lambda$33(mutableState5, parentCoordinates != null ? IntSizeKt.m6479getCenterozmzZPI(parentCoordinates.mo5187getSizeYbymL2g()) : IntOffset.INSTANCE.m6441getZeronOccac());
                        TimePickerKt.ClockText$lambda$30(mutableState2, LayoutCoordinatesKt.boundsInParent(layoutCoordinates).m3632getCenterF1C5BW0());
                    }
                };
            ...
            Modifier focusable$default = FocusableKt.focusable$default(OnGloballyPositionedModifierKt.onGloballyPositioned(m729size3ABfNKs, (Function1) rememberedValue4), false, null, 3, null);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 297264943, "CC(remember):TimePicker.kt#9igjgp");
            boolean changedInstance = startRestartGroup.changedInstance(coroutineScope) | startRestartGroup.changedInstance(analogTimePickerState) | startRestartGroup.changed(mo376toPx0680j_4) | ((i4 & 7168) == 2048) | startRestartGroup.changed(z3);
            ...
            if (changedInstance || rememberedValue5 == Composer.INSTANCE.getEmpty()) {
                ...
                rememberedValue5 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockText$2$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                        ...
                        final AnalogTimePickerState analogTimePickerState2 = analogTimePickerState;
                        final float f = mo376toPx0680j_4;
                        final boolean z4 = z;
                        ...
                        SemanticsPropertiesKt.onClick$default(semanticsPropertyReceiver, null, new Function0<Boolean>() { // from class: androidx.compose.material3.TimePickerKt$ClockText$2$1.1
                            ...
                            static final class C00451 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                ...
                                public final Object invokeSuspend(Object obj) {
                                    ...
                                    if (i == 0) {
                                        ...
                                        float m3602getXimpl = Offset.m3602getXimpl(ClockText$lambda$29);
                                        ClockText$lambda$292 = TimePickerKt.ClockText$lambda$29(this.$center$delegate);
                                        float m3603getYimpl = Offset.m3603getYimpl(ClockText$lambda$292);
                                        ...
                                        this.label = 1;
                                        m2414onTaprOwcSBo = TimePickerKt.m2414onTaprOwcSBo(analogTimePickerState, m3602getXimpl, m3603getYimpl, f, z, ClockText$lambda$32, this);
                                        if (m2414onTaprOwcSBo == coroutine_suspended) {
                                            return coroutine_suspended;
                                        }
                                    } else {
                                        if (i != 1) {
                            ...
                            public final Boolean invoke() {
                                BuildersKt__Builders_commonKt.launch$default(CoroutineScope.this, null, null, new C00451(analogTimePickerState2, f, z4, mutableState7, mutableState8, null), 3, null);
                                return true;
                            }
                        }, 1, null);
            ...
            boolean changed = startRestartGroup.changed(m2413numberContentDescriptiondSwYdS4);
            ...
            composer2 = startRestartGroup;
            TextKt.m2376Text4IGK_g(str, clearAndSetSemantics, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, value, composer2, 0, 0, 65532);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer2);
    ...
    public static final void ClockText$lambda$33(MutableState<IntOffset> mutableState, long j) {
        mutableState.setValue(IntOffset.m6422boximpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: timeInputOnChange-z7XvuPQ, reason: not valid java name */
    public static final void m2415timeInputOnChangez7XvuPQ(int i, TimePickerState timePickerState, TextFieldValue textFieldValue, TextFieldValue textFieldValue2, int i2, Function1<? super TextFieldValue, Unit> function1) {
        int parseInt;
        ...
        if (textFieldValue.getText().length() == 0) {
            if (TimePickerSelectionMode.m2430equalsimpl0(i, TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
                timePickerState.setHour(0);
            } else {
                timePickerState.setMinute(0);
            }
            function1.invoke(TextFieldValue.m6031copy3r_uNRQ$default(textFieldValue, "", 0L, (TextRange) null, 6, (Object) null));
            return;
        }
        try {
            if (textFieldValue.getText().length() == 3 && TextRange.m5788getStartimpl(textFieldValue.getSelection()) == 1) {
            ...
            if (parseInt <= i2) {
                if (TimePickerSelectionMode.m2430equalsimpl0(i, TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
                    ...
                    if (parseInt > 1 && !timePickerState.getIs24hour()) {
                        timePickerState.mo1442setSelection6_8s6DQ(TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI());
                    }
                } else {
                    timePickerState.setMinute(parseInt);
                }
                if (textFieldValue.getText().length() > 2) {
                    textFieldValue = TextFieldValue.m6031copy3r_uNRQ$default(textFieldValue, String.valueOf(textFieldValue.getText().charAt(0)), 0L, (TextRange) null, 6, (Object) null);
                }
                function1.invoke(textFieldValue);
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:33:0x065f  */
    ...
    */
    public static final void m2404TimePickerTextField1vLObsk(final Modifier modifier, final TextFieldValue textFieldValue, final Function1<? super TextFieldValue, Unit> function1, final TimePickerState timePickerState, final int i, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, final TimePickerColors timePickerColors, Composer composer, final int i2, final int i3) {
        ...
        if (i10 != 0) {
            ...
            if ((4793491 & i6) == 4793490 || !startRestartGroup.getSkipping()) {
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                TextFieldColors m2026colors0hiis_0 = OutlinedTextFieldDefaults.INSTANCE.m2026colors0hiis_0(timePickerColors.m2399timeSelectorContentColorvNxB06k$material3_release(true), 0L, 0L, 0L, timePickerColors.m2398timeSelectorContainerColorvNxB06k$material3_release(true), timePickerColors.m2398timeSelectorContainerColorvNxB06k$material3_release(true), 0L, 0L, 0L, 0L, null, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, startRestartGroup, 0, 0, 0, 0, 3072, 2147483598, 4095);
                m2430equalsimpl0 = TimePickerSelectionMode.m2430equalsimpl0(i, timePickerState.mo1441getSelectionyecRtBI());
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -483455358, "CC(Column)P(2,3,1)85@4251L61,86@4317L133:Column.kt#2w3rfo");
                ...
                if (m2430equalsimpl0) {
                    Modifier m731sizeVpY3zN4 = SizeKt.m731sizeVpY3zN4(Modifier.INSTANCE, TimeInputTokens.INSTANCE.m3220getTimeFieldContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m3219getTimeFieldContainerHeightD9Ej5fM());
                    if (TimePickerSelectionMode.m2430equalsimpl0(i, TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
                    ...
                    textFieldColors = m2026colors0hiis_0;
                    mutableInteractionSource = mutableInteractionSource2;
                    i7 = i6;
                    m2405TimeSelectorSAnMeKU(m731sizeVpY3zN4, minute, timePickerState, i, timePickerColors, startRestartGroup, (i11 & 7168) | (i11 & 896) | 6 | ((i6 >> 9) & 57344));
                } else {
                    textFieldColors = m2026colors0hiis_0;
                    z = m2430equalsimpl0;
                    i7 = i6;
                ...
                startRestartGroup.endReplaceGroup();
                if (!TimePickerSelectionMode.m2430equalsimpl0(i, TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI())) {
                    Strings.Companion companion = Strings.INSTANCE;
                    m2588constructorimpl = Strings.m2588constructorimpl(R.string.m3c_time_picker_minute_text_field);
                } else {
                    Strings.Companion companion2 = Strings.INSTANCE;
                    m2588constructorimpl = Strings.m2588constructorimpl(R.string.m3c_time_picker_hour_text_field);
                }
                final String m2658getString2EP1pXo = Strings_androidKt.m2658getString2EP1pXo(m2588constructorimpl, startRestartGroup, 0);
                ...
                Modifier m731sizeVpY3zN42 = SizeKt.m731sizeVpY3zN4(FocusRequesterModifierKt.focusRequester(Modifier.INSTANCE, focusRequester), TimeInputTokens.INSTANCE.m3220getTimeFieldContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m3219getTimeFieldContainerHeightD9Ej5fM());
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                Modifier semantics$default = SemanticsModifierKt.semantics$default(m731sizeVpY3zN42, false, (Function1) rememberedValue3, i8, null);
                ProvidableCompositionLocal<TextStyle> localTextStyle = TextKt.getLocalTextStyle();
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = startRestartGroup.consume(localTextStyle);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ...
                pairArr[0] = TuplesKt.to(Float.valueOf(0.0f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
                pairArr[i8] = TuplesKt.to(Float.valueOf(0.1f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
                pairArr[2] = TuplesKt.to(Float.valueOf(0.1f), Color.m3833boximpl(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, 6).getPrimary()));
                pairArr[3] = TuplesKt.to(Float.valueOf(0.9f), Color.m3833boximpl(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, 6).getPrimary()));
                pairArr[4] = TuplesKt.to(Float.valueOf(0.9f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
                pairArr[5] = TuplesKt.to(Float.valueOf(1.0f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
                Brush m3801verticalGradient8A3gB4$default = Brush.Companion.m3801verticalGradient8A3gB4$default(companion3, pairArr, 0.0f, 0.0f, 0, 14, (Object) null);
                ...
                ComposableLambda rememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(825138052, i8, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$1$1$2
                    ...
                    public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer3, int i12) {
                        ...
                        if ((i13 & 19) != 18 || !composer3.getSkipping()) {
                            ...
                            PaddingValues m677PaddingValues0680j_4 = PaddingKt.m677PaddingValues0680j_4(Dp.m6303constructorimpl(0));
                            ...
                            outlinedTextFieldDefaults.DecorationBox(text, function2, true, true, none, mutableInteractionSource4, false, null, null, null, null, null, null, null, textFieldColors3, m677PaddingValues0680j_4, ComposableLambdaKt.rememberComposableLambda(-833003881, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$1$1$2.1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(2);
                                }
                                ...
                                public final void invoke(Composer composer4, int i14) {
                                    ...
                                    if ((i14 & 3) != 2 || !composer4.getSkipping()) {
                                        ...
                                        OutlinedTextFieldDefaults.INSTANCE.m2024Container4EFweAY(true, false, MutableInteractionSource.this, null, textFieldColors4, ShapesKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldContainerShape(), composer4, 6), 0.0f, 0.0f, composer4, 100663734, 200);
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventEnd();
                                            return;
                                        }
                            ...
                            }, composer3, 54), composer3, ((i13 << 3) & SdkConfig.SDK_VERSION) | 224640, 14352384, 16320);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                BasicTextFieldKt.BasicTextField(textFieldValue, function1, semantics$default, true, false, textStyle, keyboardOptions4, keyboardActions4, true, 0, 0, (VisualTransformation) null, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource3, m3801verticalGradient8A3gB4$default, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) rememberComposableLambda, startRestartGroup, (i12 & SdkConfig.SDK_VERSION) | (i12 & 14) | 100666368 | (i13 & 3670016) | (i13 & 29360128), 199680, 7696);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                Modifier clearAndSetSemantics = SemanticsModifierKt.clearAndSetSemantics(androidx.compose.foundation.layout.OffsetKt.m645offsetVpY3zN4$default(Modifier.INSTANCE, 0.0f, SupportLabelTop, i8, null), new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$1$2
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    }
                ...
                if (!TimePickerSelectionMode.m2430equalsimpl0(i, TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
                    ...
                    m2588constructorimpl2 = Strings.m2588constructorimpl(R.string.m3c_time_picker_hour);
                } else {
                    Strings.Companion companion5 = Strings.INSTANCE;
                    m2588constructorimpl2 = Strings.m2588constructorimpl(R.string.m3c_time_picker_minute);
                }
                composer2 = startRestartGroup;
                TextKt.m2376Text4IGK_g(Strings_androidKt.m2658getString2EP1pXo(m2588constructorimpl2, startRestartGroup, 0), clearAndSetSemantics, ColorSchemeKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextColor(), startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, TypographyKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextFont(), startRestartGroup, 6), composer2, 0, 0, 65528);
                ComposerKt.sourceInformationMarkerEnd(composer2);
                ComposerKt.sourceInformationMarkerEnd(composer2);
                composer2.endNode();
                ComposerKt.sourceInformationMarkerEnd(composer2);
                ComposerKt.sourceInformationMarkerEnd(composer2);
                ComposerKt.sourceInformationMarkerEnd(composer2);
                TimePickerSelectionMode m2427boximpl = TimePickerSelectionMode.m2427boximpl(timePickerState.mo1441getSelectionyecRtBI());
                ...
                if ((i9 & 7168) == 2048) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    EffectsKt.LaunchedEffect(m2427boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue4, composer2, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
            ...
            if (endRestartGroup == null) {
                endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$3
                    ...
                    public final void invoke(Composer composer3, int i14) {
                        TimePickerKt.m2404TimePickerTextField1vLObsk(Modifier.this, textFieldValue, function1, timePickerState, i, keyboardOptions3, keyboardActions3, timePickerColors, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                    }
                });
                return;
            }
        ...
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        TextFieldColors m2026colors0hiis_02 = OutlinedTextFieldDefaults.INSTANCE.m2026colors0hiis_0(timePickerColors.m2399timeSelectorContentColorvNxB06k$material3_release(true), 0L, 0L, 0L, timePickerColors.m2398timeSelectorContainerColorvNxB06k$material3_release(true), timePickerColors.m2398timeSelectorContainerColorvNxB06k$material3_release(true), 0L, 0L, 0L, 0L, null, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, startRestartGroup, 0, 0, 0, 0, 3072, 2147483598, 4095);
        m2430equalsimpl0 = TimePickerSelectionMode.m2430equalsimpl0(i, timePickerState.mo1441getSelectionyecRtBI());
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -483455358, "CC(Column)P(2,3,1)85@4251L61,86@4317L133:Column.kt#2w3rfo");
        ...
        final String m2658getString2EP1pXo2 = Strings_androidKt.m2658getString2EP1pXo(m2588constructorimpl, startRestartGroup, 0);
        ...
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1024044049, "C1803@69837L48,1807@70087L7,1814@70388L11,1815@70456L11,1819@70616L915,1797@69540L1991:TimePicker.kt#uh7d8r");
        Modifier m731sizeVpY3zN422 = SizeKt.m731sizeVpY3zN4(FocusRequesterModifierKt.focusRequester(Modifier.INSTANCE, focusRequester), TimeInputTokens.INSTANCE.m3220getTimeFieldContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m3219getTimeFieldContainerHeightD9Ej5fM());
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1002857443, "CC(remember):TimePicker.kt#9igjgp");
        ...
        startRestartGroup.updateRememberedValue(rememberedValue3);
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        Modifier semantics$default2 = SemanticsModifierKt.semantics$default(m731sizeVpY3zN422, false, (Function1) rememberedValue3, i8, null);
        ...
        pairArr2[0] = TuplesKt.to(Float.valueOf(0.0f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
        pairArr2[i8] = TuplesKt.to(Float.valueOf(0.1f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
        pairArr2[2] = TuplesKt.to(Float.valueOf(0.1f), Color.m3833boximpl(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, 6).getPrimary()));
        pairArr2[3] = TuplesKt.to(Float.valueOf(0.9f), Color.m3833boximpl(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, 6).getPrimary()));
        pairArr2[4] = TuplesKt.to(Float.valueOf(0.9f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
        pairArr2[5] = TuplesKt.to(Float.valueOf(1.0f), Color.m3833boximpl(Color.INSTANCE.m3878getTransparent0d7_KjU()));
        Brush m3801verticalGradient8A3gB4$default2 = Brush.Companion.m3801verticalGradient8A3gB4$default(companion32, pairArr2, 0.0f, 0.0f, 0, 14, (Object) null);
        ...
        ComposableLambda rememberComposableLambda2 = ComposableLambdaKt.rememberComposableLambda(825138052, i8, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$1$1$2
            ...
            public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer3, int i122) {
                ...
                if ((i132 & 19) != 18 || !composer3.getSkipping()) {
                    ...
                    }, composer3, 54), composer3, ((i132 << 3) & SdkConfig.SDK_VERSION) | 224640, 14352384, 16320);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                        return;
                    }
        ...
        BasicTextFieldKt.BasicTextField(textFieldValue, function1, semantics$default2, true, false, textStyle2, keyboardOptions4, keyboardActions4, true, 0, 0, (VisualTransformation) null, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource32, m3801verticalGradient8A3gB4$default2, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) rememberComposableLambda2, startRestartGroup, (i122 & SdkConfig.SDK_VERSION) | (i122 & 14) | 100666368 | (i132 & 3670016) | (i132 & 29360128), 199680, 7696);
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        startRestartGroup.endNode();
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        Modifier clearAndSetSemantics2 = SemanticsModifierKt.clearAndSetSemantics(androidx.compose.foundation.layout.OffsetKt.m645offsetVpY3zN4$default(Modifier.INSTANCE, 0.0f, SupportLabelTop, i8, null), new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$1$2
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
            }
        ...
        composer2 = startRestartGroup;
        TextKt.m2376Text4IGK_g(Strings_androidKt.m2658getString2EP1pXo(m2588constructorimpl2, startRestartGroup, 0), clearAndSetSemantics2, ColorSchemeKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextColor(), startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, TypographyKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextFont(), startRestartGroup, 6), composer2, 0, 0, 65528);
        ComposerKt.sourceInformationMarkerEnd(composer2);
        ComposerKt.sourceInformationMarkerEnd(composer2);
        composer2.endNode();
        ComposerKt.sourceInformationMarkerEnd(composer2);
        ComposerKt.sourceInformationMarkerEnd(composer2);
        ComposerKt.sourceInformationMarkerEnd(composer2);
        TimePickerSelectionMode m2427boximpl2 = TimePickerSelectionMode.m2427boximpl(timePickerState.mo1441getSelectionyecRtBI());
        ComposerKt.sourceInformationMarkerStart(composer2, 883095798, "CC(remember):TimePicker.kt#9igjgp");
        if ((i9 & 7168) == 2048) {
        }
        z2 = true;
        ...
        composer2.updateRememberedValue(rememberedValue4);
        ComposerKt.sourceInformationMarkerEnd(composer2);
        EffectsKt.LaunchedEffect(m2427boximpl2, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue4, composer2, 0);
        if (ComposerKt.isTraceInProgress()) {
        }
        keyboardOptions3 = keyboardOptions4;
        keyboardActions3 = keyboardActions4;
    ...
    public static final void m2402CircularLayoutuFdPcIQ(Modifier modifier, final float f, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, final long j) {
                        ...
                        final float f2 = measureScope.mo376toPx0680j_4(f);
                        ...
                        for (int i7 = 0; i7 < size2; i7++) {
                            arrayList3.add(((Measurable) arrayList2.get(i7)).mo5179measureBRTryo0(m6247copyZbe2FdA$default));
                        }
                        final ArrayList arrayList4 = arrayList3;
                        int size3 = list.size();
                        int i8 = 0;
                        ...
                        Placeable mo5179measureBRTryo0 = measurable5 != null ? measurable5.mo5179measureBRTryo0(m6247copyZbe2FdA$default) : null;
                        final Placeable mo5179measureBRTryo02 = measurable6 != null ? measurable6.mo5179measureBRTryo0(m6247copyZbe2FdA$default) : null;
                        final Placeable placeable = mo5179measureBRTryo0;
                        return MeasureScope.layout$default(measureScope, Constraints.m6258getMinWidthimpl(j), Constraints.m6257getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                ...
                                while (i9 < size6) {
                                    ...
                                    Placeable.PlacementScope.place$default(placementScope, placeable3, MathKt.roundToInt((Math.cos(d2) * d) + ((Constraints.m6256getMaxWidthimpl(j2) / 2) - (placeable3.getWidth() / 2))), MathKt.roundToInt((d * Math.sin(d2)) + ((Constraints.m6255getMaxHeightimpl(j2) / 2) - (placeable3.getHeight() / 2))), 0.0f, 4, null);
                                    i9++;
                                    list2 = list2;
                                    j2 = j2;
                                }
                                Placeable placeable4 = mo5179measureBRTryo02;
                                if (placeable4 != null) {
                                    Placeable.PlacementScope.place$default(placementScope, placeable4, (Constraints.m6258getMinWidthimpl(j) - mo5179measureBRTryo02.getWidth()) / 2, (Constraints.m6257getMinHeightimpl(j) - mo5179measureBRTryo02.getHeight()) / 2, 0.0f, 4, null);
                                }
                            }
                        }, 4, null);
                    }
            ...
            MeasurePolicy measurePolicy = (MeasurePolicy) rememberedValue;
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            int i5 = ((i3 >> 6) & 14) | ((i3 << 3) & SdkConfig.SDK_VERSION);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1323940314, "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh");
            int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(startRestartGroup, 0);
            CompositionLocalMap currentCompositionLocalMap = startRestartGroup.getCurrentCompositionLocalMap();
            Modifier materializeModifier = ComposedModifierKt.materializeModifier(startRestartGroup, modifier);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$2
                ...
                public final void invoke(Composer composer2, int i7) {
                    TimePickerKt.m2402CircularLayoutuFdPcIQ(Modifier.this, f, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public static final String m2413numberContentDescriptiondSwYdS4(int i, boolean z, int i2, Composer composer, int i3) {
        int m2588constructorimpl;
        ...
        if (TimePickerSelectionMode.m2430equalsimpl0(i, TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI())) {
            Strings.Companion companion = Strings.INSTANCE;
            m2588constructorimpl = Strings.m2588constructorimpl(R.string.m3c_time_picker_minute_suffix);
        } else if (z) {
            Strings.Companion companion2 = Strings.INSTANCE;
            m2588constructorimpl = Strings.m2588constructorimpl(R.string.m3c_time_picker_hour_24h_suffix);
        } else {
            Strings.Companion companion3 = Strings.INSTANCE;
            m2588constructorimpl = Strings.m2588constructorimpl(R.string.m3c_time_picker_hour_suffix);
        }
        String m2659getStringqBjtwXw = Strings_androidKt.m2659getStringqBjtwXw(m2588constructorimpl, new Object[]{Integer.valueOf(i2)}, composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2659getStringqBjtwXw;
    }
    ...
    private static final Modifier visible(Modifier modifier, final boolean z) {
        return modifier.then(new VisibleModifier(z, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.TimePickerKt$visible$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(Property.VISIBLE);
                inspectorInfo.getProperties().set(Property.VISIBLE, Boolean.valueOf(z));
            }
    ...
    static {
        float f = 24;
        ClockFaceBottomMargin = Dp.m6303constructorimpl(f);
        DisplaySeparatorWidth = Dp.m6303constructorimpl(f);
        TimeInputBottomPadding = Dp.m6303constructorimpl(f);
        ...
        PeriodToggleMargin = Dp.m6303constructorimpl(12);
    }
}
