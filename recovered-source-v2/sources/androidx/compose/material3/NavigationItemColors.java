...
public final class NavigationItemColors {
    ...
    public final NavigationItemColors m1975copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m1983iconColorWaAFU9c(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m1984textColorWaAFU9c(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.selectedIconColor, navigationItemColors.selectedIconColor) && Color.m3844equalsimpl0(this.unselectedIconColor, navigationItemColors.unselectedIconColor) && Color.m3844equalsimpl0(this.selectedTextColor, navigationItemColors.selectedTextColor) && Color.m3844equalsimpl0(this.unselectedTextColor, navigationItemColors.unselectedTextColor) && Color.m3844equalsimpl0(this.selectedIndicatorColor, navigationItemColors.selectedIndicatorColor) && Color.m3844equalsimpl0(this.disabledIconColor, navigationItemColors.disabledIconColor) && Color.m3844equalsimpl0(this.disabledTextColor, navigationItemColors.disabledTextColor);
    }
