...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors iconButtonColors(Composer composer, int i) {
        IconButtonColors m1814copyjRlVdoo;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m3853unboximpl = ((Color) consume).m3853unboximpl();
        IconButtonColors m1819defaultIconButtonColors4WTKRHQ$material3_release = m1819defaultIconButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m3853unboximpl);
        if (Color.m3844equalsimpl0(m1819defaultIconButtonColors4WTKRHQ$material3_release.getContentColor(), m3853unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m1819defaultIconButtonColors4WTKRHQ$material3_release;
        }
        m1814copyjRlVdoo = m1819defaultIconButtonColors4WTKRHQ$material3_release.m1814copyjRlVdoo((r18 & 1) != 0 ? m1819defaultIconButtonColors4WTKRHQ$material3_release.containerColor : 0L, (r18 & 2) != 0 ? m1819defaultIconButtonColors4WTKRHQ$material3_release.contentColor : m3853unboximpl, (r18 & 4) != 0 ? m1819defaultIconButtonColors4WTKRHQ$material3_release.disabledContainerColor : 0L, (r18 & 8) != 0 ? m1819defaultIconButtonColors4WTKRHQ$material3_release.disabledContentColor : Color.m3842copywmQWz5c$default(m3853unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1814copyjRlVdoo;
    }

    /* renamed from: iconButtonColors-ro_MJ88, reason: not valid java name */
    public final IconButtonColors m1827iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        ...
        long m3879getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j;
        if ((i2 & 2) != 0) {
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            j5 = ((Color) consume).m3853unboximpl();
        } else {
            j5 = j2;
        }
        long m3879getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j3;
        long m3842copywmQWz5c$default = (i2 & 8) != 0 ? Color.m3842copywmQWz5c$default(j5, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m1814copyjRlVdoo = m1819defaultIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m3853unboximpl()).m1814copyjRlVdoo(m3879getUnspecified0d7_KjU, j5, m3879getUnspecified0d7_KjU2, m3842copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors m1819defaultIconButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(Color.INSTANCE.m3878getTransparent0d7_KjU(), j, Color.INSTANCE.m3878getTransparent0d7_KjU(), Color.m3842copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors iconToggleButtonColors(Composer composer, int i) {
        IconToggleButtonColors m1837copytNS2XkQ;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m3853unboximpl = ((Color) consume).m3853unboximpl();
        IconToggleButtonColors m1820defaultIconToggleButtonColors4WTKRHQ$material3_release = m1820defaultIconToggleButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m3853unboximpl);
        if (Color.m3844equalsimpl0(m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.getContentColor(), m3853unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m1820defaultIconToggleButtonColors4WTKRHQ$material3_release;
        }
        m1837copytNS2XkQ = m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.m1837copytNS2XkQ((r26 & 1) != 0 ? m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.containerColor : 0L, (r26 & 2) != 0 ? m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.contentColor : m3853unboximpl, (r26 & 4) != 0 ? m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.disabledContainerColor : 0L, (r26 & 8) != 0 ? m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.disabledContentColor : Color.m3842copywmQWz5c$default(m3853unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), (r26 & 16) != 0 ? m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.checkedContainerColor : 0L, (r26 & 32) != 0 ? m1820defaultIconToggleButtonColors4WTKRHQ$material3_release.checkedContentColor : 0L);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1837copytNS2XkQ;
    }

    /* renamed from: iconToggleButtonColors-5tl4gsc, reason: not valid java name */
    public final IconToggleButtonColors m1828iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        long j8;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            j7 = ((Color) consume).m3853unboximpl();
        } else {
            j7 = j2;
        }
        long m3879getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j3;
        long m3842copywmQWz5c$default = (i2 & 8) != 0 ? Color.m3842copywmQWz5c$default(j7, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m3879getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j5;
        long m3879getUnspecified0d7_KjU4 = (i2 & 32) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
            j8 = m3879getUnspecified0d7_KjU4;
        ...
        Object consume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconToggleButtonColors m1837copytNS2XkQ = m1820defaultIconToggleButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m3853unboximpl()).m1837copytNS2XkQ(m3879getUnspecified0d7_KjU, j7, m3879getUnspecified0d7_KjU2, m3842copywmQWz5c$default, m3879getUnspecified0d7_KjU3, j8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors m1820defaultIconToggleButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.INSTANCE.m3878getTransparent0d7_KjU(), j, Color.INSTANCE.m3878getTransparent0d7_KjU(), Color.m3842copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.INSTANCE.m3878getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, IconButtonTokens.INSTANCE.getSelectedIconColor()), null);
    ...
    public final IconButtonColors m1823filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m3879getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j;
        long m1612contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1612contentColorForek8zF_U(m3879getUnspecified0d7_KjU, composer, i & 14) : j2;
        long m3879getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j3;
        long m3879getUnspecified0d7_KjU3 = (i2 & 8) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors m1814copyjRlVdoo = getDefaultFilledIconButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1814copyjRlVdoo(m3879getUnspecified0d7_KjU, m1612contentColorForek8zF_U, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledIconButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getContainerColor())), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m1824filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m3879getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j;
        long m3879getUnspecified0d7_KjU2 = (i2 & 2) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j2;
        long m3879getUnspecified0d7_KjU3 = (i2 & 4) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j3;
        long m3879getUnspecified0d7_KjU4 = (i2 & 8) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j4;
        long m3879getUnspecified0d7_KjU5 = (i2 & 16) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j5;
        long m1612contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1612contentColorForek8zF_U(m3879getUnspecified0d7_KjU5, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
            j7 = m1612contentColorForek8zF_U;
        ...
        IconToggleButtonColors m1837copytNS2XkQ = getDefaultFilledIconToggleButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1837copytNS2XkQ(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4, m3879getUnspecified0d7_KjU5, j7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledIconToggleButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getToggleUnselectedColor()), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedContainerColor())), null);
    ...
    public final IconButtonColors m1825filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        IconButtonColors m1814copyjRlVdoo = getDefaultFilledTonalIconButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1814copyjRlVdoo(m3879getUnspecified0d7_KjU, m1612contentColorForek8zF_U, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledTonalIconButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getContainerColor())), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m1826filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m3879getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j3;
        long m3879getUnspecified0d7_KjU3 = (i2 & 8) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j4;
        long m3879getUnspecified0d7_KjU4 = (i2 & 16) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j5;
        long m3879getUnspecified0d7_KjU5 = (i2 & 32) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
            j7 = m3879getUnspecified0d7_KjU5;
        ...
        IconToggleButtonColors m1837copytNS2XkQ = getDefaultFilledTonalIconToggleButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1837copytNS2XkQ(m3879getUnspecified0d7_KjU, m1612contentColorForek8zF_U, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4, j7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledTonalIconToggleButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedContainerColor())), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getToggleSelectedColor()), null);
    ...
    public final IconButtonColors outlinedIconButtonColors(Composer composer, int i) {
        ...
        Object consume = composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release = m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume).m3853unboximpl());
        ProvidableCompositionLocal<Color> localContentColor2 = ContentColorKt.getLocalContentColor();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        Object consume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m3853unboximpl = ((Color) consume2).m3853unboximpl();
        if (Color.m3844equalsimpl0(m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release.getContentColor(), m3853unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release;
        }
        m1814copyjRlVdoo = m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release.m1814copyjRlVdoo((r18 & 1) != 0 ? m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release.containerColor : 0L, (r18 & 2) != 0 ? m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release.contentColor : m3853unboximpl, (r18 & 4) != 0 ? m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release.disabledContainerColor : 0L, (r18 & 8) != 0 ? m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release.disabledContentColor : Color.m3842copywmQWz5c$default(m3853unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final IconButtonColors m1829outlinedIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        ...
        Object consume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m1814copyjRlVdoo = m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m3853unboximpl()).m1814copyjRlVdoo(m3879getUnspecified0d7_KjU, j5, m3879getUnspecified0d7_KjU2, m3842copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors m1821defaultOutlinedIconButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
    ...
    public final IconToggleButtonColors outlinedIconToggleButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m3853unboximpl = ((Color) consume).m3853unboximpl();
        IconToggleButtonColors m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release = m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m3853unboximpl);
        if (Color.m3844equalsimpl0(m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.getContentColor(), m3853unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release;
        }
        m1837copytNS2XkQ = m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.m1837copytNS2XkQ((r26 & 1) != 0 ? m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.containerColor : 0L, (r26 & 2) != 0 ? m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.contentColor : m3853unboximpl, (r26 & 4) != 0 ? m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.disabledContainerColor : 0L, (r26 & 8) != 0 ? m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.disabledContentColor : Color.m3842copywmQWz5c$default(m3853unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), (r26 & 16) != 0 ? m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.checkedContainerColor : 0L, (r26 & 32) != 0 ? m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.checkedContentColor : 0L);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final IconToggleButtonColors m1830outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m3842copywmQWz5c$default = (i2 & 8) != 0 ? Color.m3842copywmQWz5c$default(j7, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m3879getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j5;
        long m1612contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1612contentColorForek8zF_U(m3879getUnspecified0d7_KjU3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object consume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconToggleButtonColors m1837copytNS2XkQ = m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m3853unboximpl()).m1837copytNS2XkQ(m3879getUnspecified0d7_KjU, j7, m3879getUnspecified0d7_KjU2, m3842copywmQWz5c$default, m3879getUnspecified0d7_KjU3, m1612contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors m1822defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        IconToggleButtonColors defaultIconToggleButtonColorsCached = colorScheme.getDefaultIconToggleButtonColorsCached();
        if (defaultIconToggleButtonColorsCached != null) {
            return defaultIconToggleButtonColorsCached;
        }
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.INSTANCE.m3878getTransparent0d7_KjU(), j, Color.INSTANCE.m3878getTransparent0d7_KjU(), Color.m3842copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor())), null);
    ...
    public final BorderStroke outlinedIconToggleButtonBorder(boolean z, boolean z2, Composer composer, int i) {
        ...
        BorderStroke outlinedIconButtonBorder = outlinedIconButtonBorder(z, composer, (i & 14) | ((i >> 3) & SdkConfig.SDK_VERSION));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        if (z) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            m3842copywmQWz5c$default = ((Color) consume).m3853unboximpl();
            composer.endReplaceGroup();
        } else {
            ...
            Object consume2 = composer.consume(localContentColor2);
            ComposerKt.sourceInformationMarkerEnd(composer);
            m3842copywmQWz5c$default = Color.m3842copywmQWz5c$default(((Color) consume2).m3853unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceGroup();
        }
        ComposerKt.sourceInformationMarkerStart(composer, 176816691, "CC(remember):IconButton.kt#9igjgp");
        boolean changed = composer.changed(m3842copywmQWz5c$default);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = BorderStrokeKt.m266BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m3039getUnselectedOutlineWidthD9Ej5fM(), m3842copywmQWz5c$default);
