...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6301boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        boolean z2 = true;
        boolean z3 = (((i & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(interactionSource)) || (i & 48) == 32;
        ...
        if (rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            rememberedValue3 = new Animatable(Dp.m6301boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
            composer.updateRememberedValue(rememberedValue3);
        }
        Animatable animatable = (Animatable) rememberedValue3;
        ComposerKt.sourceInformationMarkerEnd(composer);
        Dp m6301boximpl = Dp.m6301boximpl(f2);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m6301boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue4, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6308equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m6308equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m6308equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m6308equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m6308equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m6309hashCodeimpl(this.defaultElevation) * 31) + Dp.m6309hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6309hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6309hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m6309hashCodeimpl(this.disabledElevation);
    }
}
