...
public final class TimePickerColors {
    ...
    public final long m2396periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContainerColor;
        }
        return this.periodSelectorUnselectedContainerColor;
    ...
    public final long m2397periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContentColor;
        }
        return this.periodSelectorUnselectedContentColor;
    ...
    public final long m2398timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContainerColor;
        }
        return this.timeSelectorUnselectedContainerColor;
    ...
    public final long m2399timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContentColor;
        }
        return this.timeSelectorUnselectedContentColor;
    ...
    public final long m2380clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.clockDialSelectedContentColor;
        }
        return this.clockDialUnselectedContentColor;
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m3844equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m3844equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m3844equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m3844equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m3844equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m3844equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m3844equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m3844equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m3844equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m3844equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m3844equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m3850hashCodeimpl(this.clockDialColor) * 31) + Color.m3850hashCodeimpl(this.selectorColor)) * 31) + Color.m3850hashCodeimpl(this.containerColor)) * 31) + Color.m3850hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m3850hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m3850hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m3850hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m3850hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
