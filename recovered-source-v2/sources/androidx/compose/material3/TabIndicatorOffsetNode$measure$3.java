...
final class TabIndicatorOffsetNode$measure$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Dp m6301boximpl = Dp.m6301boximpl(this.$indicatorOffset);
            animationSpec = TabRowKt.TabRowIndicatorSpec;
            this.label = 1;
            if (Animatable.animateTo$default(animatable, m6301boximpl, animationSpec, null, null, this, 12, null) == coroutine_suspended) {
