            ...
            if (!Dp.m6308equalsimpl0(this.$animatable.getTargetValue().m6317unboximpl(), this.$target)) {
                if (!this.$enabled) {
                    ...
                    if (Dp.m6308equalsimpl0(m6317unboximpl, f)) {
                        focus = new PressInteraction.Press(Offset.INSTANCE.m3618getZeroF1C5BW0(), null);
                    } else {
                    ...
                    this.label = 2;
                    if (ElevationKt.m2584animateElevationrAjV9yQ(this.$animatable, this.$target, focus, this.$interaction, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            }
