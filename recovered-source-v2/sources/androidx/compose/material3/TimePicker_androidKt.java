...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m2426getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2425getHorizontalQJTpgSE();
        } else {
            m2426getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2426getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2426getVerticalQJTpgSE;
    }
}
