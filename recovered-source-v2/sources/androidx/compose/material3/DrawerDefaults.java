...
public final class DrawerDefaults {
    ...
    private static final float ModalDrawerElevation = ElevationTokens.INSTANCE.m2856getLevel0D9Ej5fM();
    private static final float PermanentDrawerElevation = NavigationDrawerTokens.INSTANCE.m3011getStandardContainerElevationD9Ej5fM();
    private static final float DismissibleDrawerElevation = NavigationDrawerTokens.INSTANCE.m3011getStandardContainerElevationD9Ej5fM();
    private static final float MaximumDrawerWidth = NavigationDrawerTokens.INSTANCE.m3008getContainerWidthD9Ej5fM();
    ...
    public final float m1758getMaximumDrawerWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m755onlybOOhFvg = WindowInsetsKt.m755onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.m767plusgK_yJZ4(WindowInsetsSides.INSTANCE.m782getVerticalJoeWqyM(), WindowInsetsSides.INSTANCE.m780getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
