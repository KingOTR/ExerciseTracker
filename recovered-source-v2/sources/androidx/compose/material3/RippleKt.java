...
public final class RippleKt {
    ...
    private static final RippleNodeFactory DefaultBoundedRipple = new RippleNodeFactory(true, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM(), Color.INSTANCE.m3879getUnspecified0d7_KjU(), (DefaultConstructorMarker) null);
    private static final RippleNodeFactory DefaultUnboundedRipple = new RippleNodeFactory(false, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM(), Color.INSTANCE.m3879getUnspecified0d7_KjU(), (DefaultConstructorMarker) null);
    ...
    public static /* synthetic */ IndicationNodeFactory m2087rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m2086rippleH2RKhps(z, f, j);
    }

    /* renamed from: ripple-H2RKhps, reason: not valid java name */
    public static final IndicationNodeFactory m2086rippleH2RKhps(boolean z, float f, long j) {
        if (Dp.m6308equalsimpl0(f, Dp.INSTANCE.m6323getUnspecifiedD9Ej5fM()) && Color.m3844equalsimpl0(j, Color.INSTANCE.m3879getUnspecified0d7_KjU())) {
    ...
    public static /* synthetic */ IndicationNodeFactory m2089ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m2088ripplewH6b6FI(colorProducer, z, f);
    }

    /* renamed from: ripple-wH6b6FI, reason: not valid java name */
    public static final IndicationNodeFactory m2088ripplewH6b6FI(ColorProducer colorProducer, boolean z, float f) {
    ...
    public static final Indication m2090rippleOrFallbackImplementation9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        IndicationNodeFactory m2086rippleH2RKhps;
        ...
        if (((Boolean) consume).booleanValue()) {
            m2086rippleH2RKhps = androidx.compose.material.ripple.RippleKt.m1428rememberRipple9IZ8Weo(z2, f2, j2, composer, i & 1022, 0);
        } else {
            m2086rippleH2RKhps = m2086rippleH2RKhps(z2, f2, j2);
        }
