...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo760onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m3603getYimpl(available) > 0.0f) {
            return Offset.INSTANCE.m3618getZeroF1C5BW0();
        }
        float heightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3603getYimpl(available));
        if (heightOffset != this.this$0.getState().getHeightOffset()) {
            return Offset.m3596copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m3618getZeroF1C5BW0();
    }
    ...
    public long mo486onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        state.setContentOffset(state.getContentOffset() + Offset.m3603getYimpl(consumed));
        if (Offset.m3603getYimpl(available) < 0.0f || Offset.m3603getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3603getYimpl(consumed));
            return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - heightOffset);
        }
        if (Offset.m3603getYimpl(consumed) == 0.0f && Offset.m3603getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m3603getYimpl(available) > 0.0f) {
    ...
    */
    public Object mo485onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        if (continuation instanceof ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1) {
            ...
            if ((exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    obj = super.mo485onPostFlingRZ2iAVY(j, j2, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1);
                    ...
                    if (i != 1) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        return Velocity.m6531boximpl(Velocity.m6544plusAH228Gc(j3, ((Velocity) obj).getPackedValue()));
                    }
                    j2 = exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.J$0;
                    this = (ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1) exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
                long packedValue = ((Velocity) obj).getPackedValue();
                TopAppBarState state = this.this$0.getState();
                float m6541getYimpl = Velocity.m6541getYimpl(j2);
                ...
                obj = AppBarKt.settleAppBar(state, m6541getYimpl, flingAnimationSpec, snapAnimationSpec, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1);
                if (obj != coroutine_suspended) {
                    return coroutine_suspended;
                }
                j3 = packedValue;
        ...
        float m6541getYimpl2 = Velocity.m6541getYimpl(j2);
        ...
        exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.label = 2;
        obj = AppBarKt.settleAppBar(state2, m6541getYimpl2, flingAnimationSpec2, snapAnimationSpec2, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1);
        if (obj != coroutine_suspended) {
        }
    }
}
