...
public final class PullToRefreshModifierNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, NestedScrollConnection {
    ...
    public final void m2686setThreshold0680j_4(float f) {
        this.threshold = f;
    }
    ...
    public final int getThresholdPx() {
        return ((Density) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalDensity())).mo370roundToPx0680j_4(this.threshold);
    }
    ...
    public long mo760onPreScrollOzD1aCk(long available, int source) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m4933equalsimpl0(source, NestedScrollSource.INSTANCE.m4945getUserInputWNlRxjI()) && Offset.m3603getYimpl(available) < 0.0f) {
                return m2684consumeAvailableOffsetMKHz9U(available);
            }
    ...
    public long mo486onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m4933equalsimpl0(source, NestedScrollSource.INSTANCE.m4945getUserInputWNlRxjI())) {
                long m2684consumeAvailableOffsetMKHz9U = m2684consumeAvailableOffsetMKHz9U(available);
                ...
                return m2684consumeAvailableOffsetMKHz9U;
            }
            return Offset.INSTANCE.m3618getZeroF1C5BW0();
        }
        return Offset.INSTANCE.m3618getZeroF1C5BW0();
    ...
    */
    public Object mo759onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        if (continuation instanceof PullToRefreshModifierNode$onPreFling$1) {
            ...
            if ((pullToRefreshModifierNode$onPreFling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    float m6541getYimpl = Velocity.m6541getYimpl(j);
                    pullToRefreshModifierNode$onPreFling$1.F$0 = 0.0f;
                    pullToRefreshModifierNode$onPreFling$1.label = 1;
                    obj = onRelease(m6541getYimpl, pullToRefreshModifierNode$onPreFling$1);
                ...
                return Velocity.m6531boximpl(VelocityKt.Velocity(f, ((Number) obj).floatValue()));
            }
        }
        ...
        return Velocity.m6531boximpl(VelocityKt.Velocity(f, ((Number) obj2).floatValue()));
    }
    ...
    private final long m2684consumeAvailableOffsetMKHz9U(long available) {
        float distancePulled;
        if (this.isRefreshing) {
            distancePulled = 0.0f;
        } else {
            float coerceAtLeast = RangesKt.coerceAtLeast(getDistancePulled() + Offset.m3603getYimpl(available), 0.0f);
    ...
    */
    public final Object onRelease(float f, Continuation<? super Float> continuation) {
        ...
        if (continuation instanceof PullToRefreshModifierNode$onRelease$1) {
            ...
            if ((pullToRefreshModifierNode$onRelease$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    this = (PullToRefreshModifierNode) pullToRefreshModifierNode$onRelease$1.L$0;
                    ResultKt.throwOnFailure(obj);
                    this.onRefresh.invoke();
                } else {
                    if (i != 2) {
                ...
                if (this.getDistancePulled() != 0.0f || f < 0.0f) {
                    f = 0.0f;
                }
        ...
        if (this.getDistancePulled() != 0.0f) {
        }
        f = 0.0f;
        this.setDistancePulled(0.0f);
        return Boxing.boxFloat(f);
        ...
        if (continuation instanceof PullToRefreshModifierNode$animateToThreshold$1) {
            ...
            if ((pullToRefreshModifierNode$animateToThreshold$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    this = (PullToRefreshModifierNode) pullToRefreshModifierNode$animateToThreshold$1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
                this.setDistancePulled(this.getThresholdPx());
                this.setVerticalOffset(this.getThresholdPx());
        ...
        if (continuation instanceof PullToRefreshModifierNode$animateToHidden$1) {
            ...
            if ((pullToRefreshModifierNode$animateToHidden$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    this = (PullToRefreshModifierNode) pullToRefreshModifierNode$animateToHidden$1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
                this.setDistancePulled(0.0f);
