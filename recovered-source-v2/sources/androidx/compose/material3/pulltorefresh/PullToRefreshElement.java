...
public final /* data */ class PullToRefreshElement extends ModifierNodeElement<PullToRefreshModifierNode> {
    ...
    public static /* synthetic */ PullToRefreshElement m2670copyM2VBTUQ$default(PullToRefreshElement pullToRefreshElement, boolean z, Function0 function0, boolean z2, PullToRefreshState pullToRefreshState, float f, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return pullToRefreshElement.m2672copyM2VBTUQ(z, function02, z3, pullToRefreshState2, f);
    }
    ...
    public final PullToRefreshElement m2672copyM2VBTUQ(boolean isRefreshing, Function0<Unit> onRefresh, boolean enabled, PullToRefreshState state, float threshold) {
    ...
    public boolean equals(Object other) {
        ...
        return this.isRefreshing == pullToRefreshElement.isRefreshing && Intrinsics.areEqual(this.onRefresh, pullToRefreshElement.onRefresh) && this.enabled == pullToRefreshElement.enabled && Intrinsics.areEqual(this.state, pullToRefreshElement.state) && Dp.m6308equalsimpl0(this.threshold, pullToRefreshElement.threshold);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Boolean.hashCode(this.isRefreshing) * 31) + this.onRefresh.hashCode()) * 31) + Boolean.hashCode(this.enabled)) * 31) + this.state.hashCode()) * 31) + Dp.m6309hashCodeimpl(this.threshold);
    }

    public String toString() {
        return "PullToRefreshElement(isRefreshing=" + this.isRefreshing + ", onRefresh=" + this.onRefresh + ", enabled=" + this.enabled + ", state=" + this.state + ", threshold=" + ((Object) Dp.m6314toStringimpl(this.threshold)) + ')';
    }
    ...
    public final float m2673getThresholdD9Ej5fM() {
        return this.threshold;
    }
    ...
    public void update(PullToRefreshModifierNode node) {
        ...
        node.m2686setThreshold0680j_4(this.threshold);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("threshold", Dp.m6301boximpl(this.threshold));
    }
}
