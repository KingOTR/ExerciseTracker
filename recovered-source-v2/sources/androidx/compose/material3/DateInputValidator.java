...
public final class DateInputValidator {
    ...
    */
    public final String m1676validateXivgLIo(CalendarDate dateToValidate, int inputIdentifier, Locale locale) {
        ...
        if (InputIdentifier.m1853equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m1859getStartDateInputJ2x2o4M())) {
            long utcTimeMillis = dateToValidate.getUtcTimeMillis();
            Long l = this.currentEndDateMillis;
        }
        if (InputIdentifier.m1853equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m1857getEndDateInputJ2x2o4M())) {
