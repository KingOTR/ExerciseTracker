...
public final class AnalogTimePickerState implements TimePickerState {
    ...
    public int mo1441getSelectionyecRtBI() {
        return this.state.mo1441getSelectionyecRtBI();
    }
    ...
    public void mo1442setSelection6_8s6DQ(int i) {
        this.state.mo1442setSelection6_8s6DQ(i);
    }
    ...
    public final Object animateToCurrent(Continuation<? super Unit> continuation) {
        ...
        if (TimePickerSelectionMode.m2430equalsimpl0(mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI())) {
    ...
    private final boolean isUpdated() {
        if (TimePickerSelectionMode.m2430equalsimpl0(mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.hourAngle)) {
            return false;
        }
        return (TimePickerSelectionMode.m2430equalsimpl0(mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.minuteAngle)) ? false : true;
    }

    public final IntList getClockFaceValues() {
        IntList intList;
        IntList intList2;
        if (TimePickerSelectionMode.m2430equalsimpl0(mo1441getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI())) {
