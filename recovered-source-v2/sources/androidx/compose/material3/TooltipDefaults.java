...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m6325DpSizeYgX7TsA(Dp.m6303constructorimpl(16), Dp.m6303constructorimpl(8));
    ...
    public final long m2523getCaretSizeMYxV2XQ() {
        return caretSize;
    }
    ...
    public final RichTooltipColors m2526richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors m2080copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2080copyjRlVdoo(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2080copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m2524rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo348calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m6473getWidthimpl(popupContentSize)) / 2);
                    int top = (anchorBounds.getTop() - IntSize.m6472getHeightimpl(popupContentSize)) - mo370roundToPx0680j_4;
                    if (top < 0) {
                        top = anchorBounds.getBottom() + mo370roundToPx0680j_4;
                    }
    ...
    public final PopupPositionProvider m2525rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo348calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    ...
                    if (IntSize.m6473getWidthimpl(popupContentSize) + left > IntSize.m6473getWidthimpl(windowSize) && (left = anchorBounds.getRight() - IntSize.m6473getWidthimpl(popupContentSize)) < 0) {
                        left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m6473getWidthimpl(popupContentSize)) / 2);
                    }
                    int top = (anchorBounds.getTop() - IntSize.m6472getHeightimpl(popupContentSize)) - mo370roundToPx0680j_4;
                    if (top < 0) {
                        top = anchorBounds.getBottom() + mo370roundToPx0680j_4;
