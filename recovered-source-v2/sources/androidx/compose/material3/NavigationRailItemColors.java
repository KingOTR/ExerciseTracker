...
public final class NavigationRailItemColors {
    ...
    public final long m2010getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationRailItemColors m2005copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2014iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m2015textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m3844equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m3844equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m3844equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m3844equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m3844equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m3844equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m3850hashCodeimpl(this.selectedIconColor) * 31) + Color.m3850hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m3850hashCodeimpl(this.selectedTextColor)) * 31) + Color.m3850hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m3850hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m3850hashCodeimpl(this.disabledIconColor)) * 31) + Color.m3850hashCodeimpl(this.disabledTextColor);
    }
}
