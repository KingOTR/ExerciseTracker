...
public final class SelectableChipColors {
    ...
    public final long m2142containerColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2144labelColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2145leadingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2146trailingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m3844equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m3844equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m3844equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m3844equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m3844equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m3844equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m3844equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m3844equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m3844equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m3844equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m3844equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m3844equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m3850hashCodeimpl(this.containerColor) * 31) + Color.m3850hashCodeimpl(this.labelColor)) * 31) + Color.m3850hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3850hashCodeimpl(this.trailingIconColor)) * 31) + Color.m3850hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3850hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3850hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m3850hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m3850hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m3850hashCodeimpl(this.selectedTrailingIconColor);
    }
}
