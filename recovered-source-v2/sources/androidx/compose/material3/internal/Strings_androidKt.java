...
public final class Strings_androidKt {
    ...
    public static final String m2658getString2EP1pXo(int i, Composer composer, int i2) {
    ...
    public static final String m2659getStringqBjtwXw(int i, Object[] objArr, Composer composer, int i2) {
        ...
        String m2658getString2EP1pXo = m2658getString2EP1pXo(i, composer, i2 & 14);
        ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        ...
        String format = String.format(locale, m2658getString2EP1pXo, Arrays.copyOf(copyOf, copyOf.length));
