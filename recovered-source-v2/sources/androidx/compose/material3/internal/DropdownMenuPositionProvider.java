...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m2580copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m2582copyuVxBXkw(j2, density2, i3, function2);
    }
    ...
    public final DropdownMenuPositionProvider m2582copyuVxBXkw(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m6363equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((((DpOffset.m6368hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + Integer.hashCode(this.verticalMargin)) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m6371toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int mo370roundToPx0680j_4 = density.mo370roundToPx0680j_4(DpOffset.m6364getXD9Ej5fM(j));
        this.startToAnchorStart = MenuPosition.INSTANCE.startToAnchorStart(mo370roundToPx0680j_4);
        this.endToAnchorEnd = MenuPosition.INSTANCE.endToAnchorEnd(mo370roundToPx0680j_4);
        ...
        int mo370roundToPx0680j_42 = density.mo370roundToPx0680j_4(DpOffset.m6366getYD9Ej5fM(j));
        this.topToAnchorBottom = MenuPosition.INSTANCE.topToAnchorBottom(mo370roundToPx0680j_42);
        this.bottomToAnchorTop = MenuPosition.INSTANCE.bottomToAnchorTop(mo370roundToPx0680j_42);
        this.centerToAnchorTop = MenuPosition.INSTANCE.centerToAnchorTop(mo370roundToPx0680j_42);
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density density, int i, AnonymousClass2 anonymousClass2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, density, (i2 & 4) != 0 ? density.mo370roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i, (i2 & 8) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.internal.DropdownMenuPositionProvider.2
    ...
    public long mo348calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (IntOffset.m6431getXimpl(anchorBounds.m6454getCenternOccac()) < IntSize.m6473getWidthimpl(windowSize) / 2) {
        ...
        while (true) {
            ...
            i = ((MenuPosition.Horizontal) listOf.get(i3)).mo2574position95KtPRI(anchorBounds, windowSize, IntSize.m6473getWidthimpl(popupContentSize), layoutDirection);
            if (i3 == CollectionsKt.getLastIndex(listOf) || (i >= 0 && IntSize.m6473getWidthimpl(popupContentSize) + i <= IntSize.m6473getWidthimpl(windowSize))) {
                break;
            }
            i3++;
        }
        ...
        if (IntOffset.m6432getYimpl(anchorBounds.m6454getCenternOccac()) < IntSize.m6472getHeightimpl(windowSize) / 2) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            int mo2575positionJVtK1S4 = ((MenuPosition.Vertical) listOf2.get(i4)).mo2575positionJVtK1S4(anchorBounds, windowSize, IntSize.m6472getHeightimpl(popupContentSize));
            if (i4 == CollectionsKt.getLastIndex(listOf2) || (mo2575positionJVtK1S4 >= this.verticalMargin && IntSize.m6472getHeightimpl(popupContentSize) + mo2575positionJVtK1S4 <= IntSize.m6472getHeightimpl(windowSize) - this.verticalMargin)) {
                i2 = mo2575positionJVtK1S4;
                break;
            }
        }
        long IntOffset = IntOffsetKt.IntOffset(i, i2);
        this.onPositionCalculated.invoke(anchorBounds, IntRectKt.m6463IntRectVbeCjmY(IntOffset, popupContentSize));
        return IntOffset;
    }
}
