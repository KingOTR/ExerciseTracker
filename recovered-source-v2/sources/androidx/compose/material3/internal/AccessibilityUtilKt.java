...
public final class AccessibilityUtilKt {
    ...
    static {
        ...
        HorizontalSemanticsBoundsPadding = m6303constructorimpl;
        IncreaseHorizontalSemanticsBounds = PaddingKt.m686paddingVpY3zN4$default(SemanticsModifierKt.semantics(LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.internal.AccessibilityUtilKt$IncreaseHorizontalSemanticsBounds$1
            @Override // kotlin.jvm.functions.Function3
            public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                return m2573invoke3p2s80s(measureScope, measurable, constraints.getValue());
            }

            /* renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m2573invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                final int i = measureScope.mo370roundToPx0680j_4(AccessibilityUtilKt.getHorizontalSemanticsBoundsPadding());
                int i2 = i * 2;
                final Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(ConstraintsKt.m6275offsetNN6EwU(j, i2, 0));
                return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth() - i2, mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.internal.AccessibilityUtilKt$IncreaseHorizontalSemanticsBounds$1.1
        ...
        }), m6303constructorimpl, 0.0f, 2, null);
    }
}
