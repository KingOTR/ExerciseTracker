...
final class DraggableAnchorsNode<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo94measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!measureScope.isLookingAhead() || !this.didLookahead) {
            Pair<? extends DraggableAnchors<T>, ? extends T> invoke = this.anchors.invoke(IntSize.m6465boximpl(IntSizeKt.IntSize(mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight())), Constraints.m6244boximpl(j));
            this.state.updateAnchors(invoke.getFirst(), invoke.getSecond());
        }
        this.didLookahead = measureScope.isLookingAhead() || this.didLookahead;
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.internal.DraggableAnchorsNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                Placeable.PlacementScope.place$default(placementScope, mo5179measureBRTryo0, MathKt.roundToInt(f), MathKt.roundToInt(requireOffset), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
