...
public final class ExposedDropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public /* synthetic */ ExposedDropdownMenuPositionProvider(Density density, int i, State state, int i2, AnonymousClass2 anonymousClass2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(density, i, (i3 & 4) != 0 ? null : state, (i3 & 8) != 0 ? density.mo370roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i2, (i3 & 16) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuPositionProvider.2
    ...
    public long mo348calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        long IntSize = IntSizeKt.IntSize(IntSize.m6473getWidthimpl(windowSize), IntSize.m6472getHeightimpl(windowSize) + this.topWindowInsets);
        MenuPosition.Horizontal[] horizontalArr = new MenuPosition.Horizontal[3];
        int i2 = 0;
        horizontalArr[0] = this.startToAnchorStart;
        horizontalArr[1] = this.endToAnchorEnd;
        if (IntOffset.m6431getXimpl(anchorBounds.m6454getCenternOccac()) < IntSize.m6473getWidthimpl(IntSize) / 2) {
        ...
        while (true) {
            ...
            int i4 = i3;
            i = ((MenuPosition.Horizontal) listOf.get(i3)).mo2574position95KtPRI(anchorBounds, IntSize, IntSize.m6473getWidthimpl(popupContentSize), layoutDirection);
            if (i4 == CollectionsKt.getLastIndex(listOf) || (i >= 0 && IntSize.m6473getWidthimpl(popupContentSize) + i <= IntSize.m6473getWidthimpl(IntSize))) {
                break;
            }
            i3 = i4 + 1;
        }
        ...
        if (IntOffset.m6432getYimpl(anchorBounds.m6454getCenternOccac()) < IntSize.m6472getHeightimpl(IntSize) / 2) {
        ...
        for (int i5 = 0; i5 < size2; i5++) {
            int mo2575positionJVtK1S4 = ((MenuPosition.Vertical) listOf2.get(i5)).mo2575positionJVtK1S4(anchorBounds, IntSize, IntSize.m6472getHeightimpl(popupContentSize));
            if (i5 == CollectionsKt.getLastIndex(listOf2) || (mo2575positionJVtK1S4 >= 0 && IntSize.m6472getHeightimpl(popupContentSize) + mo2575positionJVtK1S4 <= IntSize.m6472getHeightimpl(IntSize))) {
