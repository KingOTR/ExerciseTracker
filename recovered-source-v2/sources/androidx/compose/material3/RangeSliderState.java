...
public final class RangeSliderState {
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long m2078scaleToUserValueowVgs5E = m2078scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), SliderRange);
        if (SliderRange.m2200equalsimpl0(m2078scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m2202getStartimpl(m2078scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m2201getEndInclusiveimpl(m2078scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m2197boximpl(m2078scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m2078scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        long m2190scaleziovWd0;
        m2190scaleziovWd0 = SliderKt.m2190scaleziovWd0(minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
        return m2190scaleziovWd0;
    }
