...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue4 == Composer.INSTANCE.getEmpty()) {
            rememberedValue4 = new Animatable(Dp.m6301boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m6301boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue5, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6308equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m6308equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m6308equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m6308equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m6308equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m6309hashCodeimpl(this.elevation) * 31) + Dp.m6309hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6309hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6309hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m6309hashCodeimpl(this.disabledElevation);
    }
}
