...
public final class CheckboxColors {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState toggleableState, Composer composer, int i) {
        ...
        State<Color> m117animateColorAsStateeuL9pac = SingleValueAnimationKt.m117animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean z, ToggleableState toggleableState, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m117animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-392031362);
            ComposerKt.sourceInformation(composer, "523@23032L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3833boximpl(j2), composer, 0);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.checkedCheckmarkColor, checkboxColors.checkedCheckmarkColor) && Color.m3844equalsimpl0(this.uncheckedCheckmarkColor, checkboxColors.uncheckedCheckmarkColor) && Color.m3844equalsimpl0(this.checkedBoxColor, checkboxColors.checkedBoxColor) && Color.m3844equalsimpl0(this.uncheckedBoxColor, checkboxColors.uncheckedBoxColor) && Color.m3844equalsimpl0(this.disabledCheckedBoxColor, checkboxColors.disabledCheckedBoxColor) && Color.m3844equalsimpl0(this.disabledUncheckedBoxColor, checkboxColors.disabledUncheckedBoxColor) && Color.m3844equalsimpl0(this.disabledIndeterminateBoxColor, checkboxColors.disabledIndeterminateBoxColor) && Color.m3844equalsimpl0(this.checkedBorderColor, checkboxColors.checkedBorderColor) && Color.m3844equalsimpl0(this.uncheckedBorderColor, checkboxColors.uncheckedBorderColor) && Color.m3844equalsimpl0(this.disabledBorderColor, checkboxColors.disabledBorderColor) && Color.m3844equalsimpl0(this.disabledUncheckedBorderColor, checkboxColors.disabledUncheckedBorderColor) && Color.m3844equalsimpl0(this.disabledIndeterminateBorderColor, checkboxColors.disabledIndeterminateBorderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m3850hashCodeimpl(this.checkedCheckmarkColor) * 31) + Color.m3850hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m3850hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m3850hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m3850hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m3850hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m3850hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m3850hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m3850hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m3850hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m3850hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m3850hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
