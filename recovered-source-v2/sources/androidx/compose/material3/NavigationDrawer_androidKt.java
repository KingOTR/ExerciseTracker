...
public final class NavigationDrawer_androidKt {
    private static final float PredictiveBackDrawerMaxScaleXDistanceGrow = Dp.m6303constructorimpl(12);
    private static final float PredictiveBackDrawerMaxScaleXDistanceShrink = Dp.m6303constructorimpl(24);
    private static final float PredictiveBackDrawerMaxScaleYDistance = Dp.m6303constructorimpl(48);

    public static final void DrawerPredictiveBackHandler(final DrawerState drawerState, Function3<? super DrawerPredictiveBackState, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        int i2;
        int i3;
        boolean z;
        int i4;
        ...
        if ((i5 & 19) != 18 || !startRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1444817207, i5, -1, "androidx.compose.material3.DrawerPredictiveBackHandler (NavigationDrawer.android.kt:44)");
            }
            ...
            floatRef.element = density.mo376toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceGrow);
            floatRef2.element = density.mo376toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceShrink);
            floatRef3.element = density.mo376toPx0680j_4(PredictiveBackDrawerMaxScaleYDistance);
            ...
            int i6 = i5 & 14;
            boolean changed = startRestartGroup.changed(z2) | startRestartGroup.changed(floatRef.element) | startRestartGroup.changed(floatRef2.element) | startRestartGroup.changed(floatRef3.element) | startRestartGroup.changedInstance(coroutineScope) | (i6 == 4);
            NavigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1 rememberedValue3 = startRestartGroup.rememberedValue();
            if (changed || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                i3 = i6;
                z = isOpen;
                i4 = 0;
                drawerPredictiveBackState = drawerPredictiveBackState3;
                rememberedValue3 = new NavigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1(drawerPredictiveBackState3, coroutineScope, drawerState, z2, floatRef, floatRef2, floatRef3, null);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            PredictiveBackHandlerKt.PredictiveBackHandler(z, (Function2) rememberedValue3, startRestartGroup, i4, i4);
            ...
            function32.invoke(drawerPredictiveBackState2, startRestartGroup, Integer.valueOf((i5 & SdkConfig.SDK_VERSION) | 6));
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationDrawer_androidKt$DrawerPredictiveBackHandler$4
                ...
                public final void invoke(Composer composer2, int i8) {
                    NavigationDrawer_androidKt.DrawerPredictiveBackHandler(DrawerState.this, function32, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
