...
final class TabRowDefaults$tabIndicatorOffset$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        State<Dp> m131animateDpAsStateAjpBEmI = AnimateAsStateKt.m131animateDpAsStateAjpBEmI(width, animationSpec, null, null, composer, 0, 12);
        float left = this.$currentTabPosition.getLeft();
        animationSpec2 = TabRowKt.TabRowIndicatorSpec;
        final State<Dp> m131animateDpAsStateAjpBEmI2 = AnimateAsStateKt.m131animateDpAsStateAjpBEmI(left, animationSpec2, null, null, composer, 0, 12);
        ...
        boolean changed = composer.changed(m131animateDpAsStateAjpBEmI2);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material3.TabRowDefaults$tabIndicatorOffset$2$1$1
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
                    return IntOffset.m6422boximpl(m2273invokeBjo55l4(density));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m2273invokeBjo55l4(Density density) {
                    float invoke$lambda$1;
                    invoke$lambda$1 = TabRowDefaults$tabIndicatorOffset$2.invoke$lambda$1(m131animateDpAsStateAjpBEmI2);
                    return IntOffsetKt.IntOffset(density.mo370roundToPx0680j_4(invoke$lambda$1), 0);
                }
            };
            composer.updateRememberedValue(rememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        Modifier m734width3ABfNKs = SizeKt.m734width3ABfNKs(OffsetKt.offset(wrapContentSize$default, (Function1) rememberedValue), invoke$lambda$0(m131animateDpAsStateAjpBEmI));
        if (ComposerKt.isTraceInProgress()) {
