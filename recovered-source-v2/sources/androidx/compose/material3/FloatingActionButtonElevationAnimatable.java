...
final class FloatingActionButtonElevationAnimatable {
    ...
    private FloatingActionButtonElevationAnimatable(float f, float f2, float f3, float f4) {
        ...
        this.animatable = new Animatable<>(Dp.m6301boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }

    /* renamed from: calculateTarget-u2uoSUM, reason: not valid java name */
    private final float m1804calculateTargetu2uoSUM(Interaction interaction) {
    ...
    public final Object m1805updateElevationlDy3nrA(float f, float f2, float f3, float f4, Continuation<? super Unit> continuation) {
        this.defaultElevation = f;
        this.pressedElevation = f2;
        this.hoveredElevation = f3;
        this.focusedElevation = f4;
            ...
            if (continuation instanceof FloatingActionButtonElevationAnimatable$snapElevation$1) {
                ...
                if ((floatingActionButtonElevationAnimatable$snapElevation$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        float m1804calculateTargetu2uoSUM = m1804calculateTargetu2uoSUM(this.targetInteraction);
                        if (!Dp.m6308equalsimpl0(this.animatable.getTargetValue().m6317unboximpl(), m1804calculateTargetu2uoSUM)) {
                            Animatable<Dp, AnimationVector1D> animatable = this.animatable;
                            Dp m6301boximpl = Dp.m6301boximpl(m1804calculateTargetu2uoSUM);
                            ...
                            if (animatable.snapTo(m6301boximpl, floatingActionButtonElevationAnimatable$snapElevation$1) == coroutine_suspended) {
        ...
        try {
            if (continuation instanceof FloatingActionButtonElevationAnimatable$animateElevation$1) {
                ...
                if ((floatingActionButtonElevationAnimatable$animateElevation$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ResultKt.throwOnFailure(obj);
                        float m1804calculateTargetu2uoSUM = m1804calculateTargetu2uoSUM(interaction);
                        this.targetInteraction = interaction;
                        boolean m6308equalsimpl0 = Dp.m6308equalsimpl0(this.animatable.getTargetValue().m6317unboximpl(), m1804calculateTargetu2uoSUM);
                        this = this;
                        if (!m6308equalsimpl0) {
                            Animatable<Dp, AnimationVector1D> animatable = this.animatable;
                            ...
                            this = this;
                            if (ElevationKt.m2584animateElevationrAjV9yQ(animatable, m1804calculateTargetu2uoSUM, interaction2, interaction, floatingActionButtonElevationAnimatable$animateElevation$1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        }
                    } else {
