...
final class CardElevation$animateElevation$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!Dp.m6308equalsimpl0(this.$animatable.getTargetValue().m6317unboximpl(), this.$target)) {
                if (!this.$enabled) {
                    this.label = 1;
                    if (this.$animatable.snapTo(Dp.m6301boximpl(this.$target), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    float m6317unboximpl = this.$animatable.getTargetValue().m6317unboximpl();
                    f = this.this$0.pressedElevation;
                    DragInteraction.Start start = null;
                    if (Dp.m6308equalsimpl0(m6317unboximpl, f)) {
                        start = new PressInteraction.Press(Offset.INSTANCE.m3618getZeroF1C5BW0(), null);
                    } else {
                        f2 = this.this$0.hoveredElevation;
                        if (Dp.m6308equalsimpl0(m6317unboximpl, f2)) {
                            start = new HoverInteraction.Enter();
                        } else {
                            f3 = this.this$0.focusedElevation;
                            if (Dp.m6308equalsimpl0(m6317unboximpl, f3)) {
                                start = new FocusInteraction.Focus();
                            } else {
                                f4 = this.this$0.draggedElevation;
                                if (Dp.m6308equalsimpl0(m6317unboximpl, f4)) {
                    ...
                    this.label = 2;
                    if (ElevationKt.m2584animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            }
