...
public final class ScaffoldKt {
    private static final float FabSpacing = Dp.m6303constructorimpl(16);
    ...
    */
    public static final void m2091ScaffoldTvnljyQ(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, int i, long j, long j2, WindowInsets windowInsets, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i2, final int i3) {
        int i4;
        ...
        Function2<? super Composer, ? super Integer, Unit> m1656getLambda1$material3_release;
        Function2<? super Composer, ? super Integer, Unit> m1657getLambda2$material3_release;
        Function2<? super Composer, ? super Integer, Unit> m1658getLambda3$material3_release;
        Function2<? super Composer, ? super Integer, Unit> m1659getLambda4$material3_release;
        int m1788getEndERTFSPs;
        int i10;
        long j4;
        ...
        if (i14 != 0) {
            ...
            if (i5 == 0) {
                ...
                if (i6 != 0) {
                    ...
                    if (i7 == 0) {
                        ...
                        if ((i3 & 512) != 0) {
                            ...
                            if ((i4 & 306783379) == 306783378 || !startRestartGroup.getSkipping()) {
                                ...
                                if ((i2 & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                                    ...
                                    m1656getLambda1$material3_release = i14 == 0 ? ComposableSingletons$ScaffoldKt.INSTANCE.m1656getLambda1$material3_release() : function25;
                                    m1657getLambda2$material3_release = i5 == 0 ? ComposableSingletons$ScaffoldKt.INSTANCE.m1657getLambda2$material3_release() : function26;
                                    m1658getLambda3$material3_release = i6 == 0 ? ComposableSingletons$ScaffoldKt.INSTANCE.m1658getLambda3$material3_release() : function23;
                                    m1659getLambda4$material3_release = i9 == 0 ? ComposableSingletons$ScaffoldKt.INSTANCE.m1659getLambda4$material3_release() : function27;
                                    m1788getEndERTFSPs = i8 == 0 ? FabPosition.INSTANCE.m1788getEndERTFSPs() : i;
                                    if ((i3 & 64) == 0) {
                                        i10 = i4 & (-3670017);
                                    ...
                                    if ((i3 & 128) != 0) {
                                        j3 = ColorSchemeKt.m1612contentColorForek8zF_U(j4, startRestartGroup, (i10 >> 18) & 14);
                                        i10 &= -29360129;
                                    }
                                    if ((i3 & 256) != 0) {
                                        ...
                                        if (i11 > 67108864 || !startRestartGroup.changed(contentWindowInsets)) {
                                            ...
                                            if ((i10 & 100663296) != 67108864) {
                                                ...
                                                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                                final int i15 = m1788getEndERTFSPs;
                                                final Function2<? super Composer, ? super Integer, Unit> function211 = m1656getLambda1$material3_release;
                                                final Function2<? super Composer, ? super Integer, Unit> function212 = m1658getLambda3$material3_release;
                                                final Function2<? super Composer, ? super Integer, Unit> function213 = m1659getLambda4$material3_release;
                                                final Function2<? super Composer, ? super Integer, Unit> function214 = m1657getLambda2$material3_release;
                                                int i16 = i10 >> 12;
                                                SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    ...
                                                    public final void invoke(Composer composer2, int i17) {
                                                        ...
                                                        if ((i17 & 3) != 2 || !composer2.getSkipping()) {
                                                            ...
                                                            ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i15, function211, function3, function212, function213, mutableWindowInsets, function214, composer2, 0);
                                                            if (ComposerKt.isTraceInProgress()) {
                                                ...
                                                j6 = j4;
                                                function28 = m1657getLambda2$material3_release;
                                                function29 = m1658getLambda3$material3_release;
                                                function210 = m1659getLambda4$material3_release;
                                                windowInsets2 = contentWindowInsets;
                                                j7 = j5;
                                                function25 = m1656getLambda1$material3_release;
                                                modifier2 = companion;
                                            }
                                        } else {
                                            j5 = j3;
                                        ...
                                        startRestartGroup.updateRememberedValue(rememberedValue2);
                                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                        final int i152 = m1788getEndERTFSPs;
                                        final Function2<? super Composer, ? super Integer, Unit> function2112 = m1656getLambda1$material3_release;
                                        final Function2<? super Composer, ? super Integer, Unit> function2122 = m1658getLambda3$material3_release;
                                        final Function2<? super Composer, ? super Integer, Unit> function2132 = m1659getLambda4$material3_release;
                                        final Function2<? super Composer, ? super Integer, Unit> function2142 = m1657getLambda2$material3_release;
                                        int i162 = i10 >> 12;
                                        SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            /* JADX WARN: Multi-variable type inference failed */
                                            ...
                                            public final void invoke(Composer composer2, int i17) {
                                                ...
                                                if ((i17 & 3) != 2 || !composer2.getSkipping()) {
                                                    ...
                                                    ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i152, function2112, function3, function2122, function2132, mutableWindowInsets2, function2142, composer2, 0);
                                                    if (ComposerKt.isTraceInProgress()) {
                                                        ComposerKt.traceEventEnd();
                                                        return;
                                                    }
                                    ...
                                    companion = modifier;
                                    i10 = i4;
                                    m1656getLambda1$material3_release = function25;
                                    m1657getLambda2$material3_release = function26;
                                    m1659getLambda4$material3_release = function27;
                                    m1658getLambda3$material3_release = function23;
                                    m1788getEndERTFSPs = i;
                                    j4 = j;
                                }
                                ...
                                startRestartGroup.updateRememberedValue(rememberedValue2);
                                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                final int i1522 = m1788getEndERTFSPs;
                                final Function2<? super Composer, ? super Integer, Unit> function21122 = m1656getLambda1$material3_release;
                                final Function2<? super Composer, ? super Integer, Unit> function21222 = m1658getLambda3$material3_release;
                                final Function2<? super Composer, ? super Integer, Unit> function21322 = m1659getLambda4$material3_release;
                                final Function2<? super Composer, ? super Integer, Unit> function21422 = m1657getLambda2$material3_release;
                                int i1622 = i10 >> 12;
                                SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    ...
                                    public final void invoke(Composer composer2, int i17) {
                                        ...
                                        if ((i17 & 3) != 2 || !composer2.getSkipping()) {
                                            ...
                                            ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i1522, function21122, function3, function21222, function21322, mutableWindowInsets22, function21422, composer2, 0);
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                            ...
                            if (endRestartGroup == null) {
                                ...
                                final int i17 = m1788getEndERTFSPs;
                                final long j8 = j6;
                                final long j9 = j7;
                                ...
                                endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$3
                                    ...
                                    public final void invoke(Composer composer2, int i18) {
                                        ScaffoldKt.m2091ScaffoldTvnljyQ(Modifier.this, function215, function28, function29, function210, i17, j8, j9, windowInsets3, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                                    }
                                });
                                return;
                            }
                        ...
                        startRestartGroup.updateRememberedValue(rememberedValue2);
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        final int i15222 = m1788getEndERTFSPs;
                        final Function2<? super Composer, ? super Integer, Unit> function211222 = m1656getLambda1$material3_release;
                        final Function2<? super Composer, ? super Integer, Unit> function212222 = m1658getLambda3$material3_release;
                        final Function2<? super Composer, ? super Integer, Unit> function213222 = m1659getLambda4$material3_release;
                        final Function2<? super Composer, ? super Integer, Unit> function214222 = m1657getLambda2$material3_release;
                        int i16222 = i10 >> 12;
                        SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            ...
                            public final void invoke(Composer composer2, int i172) {
                                ...
                                if ((i172 & 3) != 2 || !composer2.getSkipping()) {
                                    ...
                                    ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i15222, function211222, function3, function212222, function213222, mutableWindowInsets222, function214222, composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                    ...
                    startRestartGroup.updateRememberedValue(rememberedValue2);
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    final int i152222 = m1788getEndERTFSPs;
                    final Function2<? super Composer, ? super Integer, Unit> function2112222 = m1656getLambda1$material3_release;
                    final Function2<? super Composer, ? super Integer, Unit> function2122222 = m1658getLambda3$material3_release;
                    final Function2<? super Composer, ? super Integer, Unit> function2132222 = m1659getLambda4$material3_release;
                    final Function2<? super Composer, ? super Integer, Unit> function2142222 = m1657getLambda2$material3_release;
                    int i162222 = i10 >> 12;
                    SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        ...
                        public final void invoke(Composer composer2, int i172) {
                            ...
                            if ((i172 & 3) != 2 || !composer2.getSkipping()) {
                                ...
                                ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i152222, function2112222, function3, function2122222, function2132222, mutableWindowInsets2222, function2142222, composer2, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
                ...
                startRestartGroup.updateRememberedValue(rememberedValue2);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                final int i1522222 = m1788getEndERTFSPs;
                final Function2<? super Composer, ? super Integer, Unit> function21122222 = m1656getLambda1$material3_release;
                final Function2<? super Composer, ? super Integer, Unit> function21222222 = m1658getLambda3$material3_release;
                final Function2<? super Composer, ? super Integer, Unit> function21322222 = m1659getLambda4$material3_release;
                final Function2<? super Composer, ? super Integer, Unit> function21422222 = m1657getLambda2$material3_release;
                int i1622222 = i10 >> 12;
                SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    ...
                    public final void invoke(Composer composer2, int i172) {
                        ...
                        if ((i172 & 3) != 2 || !composer2.getSkipping()) {
                            ...
                            ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i1522222, function21122222, function3, function21222222, function21322222, mutableWindowInsets22222, function21422222, composer2, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            startRestartGroup.updateRememberedValue(rememberedValue2);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final int i15222222 = m1788getEndERTFSPs;
            final Function2<? super Composer, ? super Integer, Unit> function211222222 = m1656getLambda1$material3_release;
            final Function2<? super Composer, ? super Integer, Unit> function212222222 = m1658getLambda3$material3_release;
            final Function2<? super Composer, ? super Integer, Unit> function213222222 = m1659getLambda4$material3_release;
            final Function2<? super Composer, ? super Integer, Unit> function214222222 = m1657getLambda2$material3_release;
            ...
            SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
                ...
                public final void invoke(Composer composer2, int i172) {
                    ...
                    if ((i172 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i15222222, function211222222, function3, function212222222, function213222222, mutableWindowInsets222222, function214222222, composer2, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        startRestartGroup.updateRememberedValue(rememberedValue2);
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        final int i152222222 = m1788getEndERTFSPs;
        final Function2<? super Composer, ? super Integer, Unit> function2112222222 = m1656getLambda1$material3_release;
        final Function2<? super Composer, ? super Integer, Unit> function2122222222 = m1658getLambda3$material3_release;
        final Function2<? super Composer, ? super Integer, Unit> function2132222222 = m1659getLambda4$material3_release;
        final Function2<? super Composer, ? super Integer, Unit> function2142222222 = m1657getLambda2$material3_release;
        ...
        SurfaceKt.m2226SurfaceT9BRK9s(WindowInsetsPaddingKt.onConsumedWindowInsetsChanged(companion, (Function1) rememberedValue2), null, j4, j5, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1979205334, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$Scaffold$2
            ...
            public final void invoke(Composer composer2, int i172) {
                ...
                if ((i172 & 3) != 2 || !composer2.getSkipping()) {
                    ...
                    ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i152222222, function2112222222, function3, function2122222222, function2132222222, mutableWindowInsets2222222, function2142222222, composer2, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                        return;
                    }
    ...
    public static final void m2092ScaffoldLayoutFMILGgc(final int i, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final WindowInsets windowInsets, final Function2<? super Composer, ? super Integer, Unit> function24, Composer composer, final int i2) {
        ...
        if ((i3 & 599187) != 599186 || !startRestartGroup.getSkipping()) {
            ...
            boolean z = ((i3 & SdkConfig.SDK_VERSION) == 32) | ((i3 & 7168) == 2048) | ((458752 & i3) == 131072) | ((57344 & i3) == 16384) | ((i3 & 14) == 4) | ((3670016 & i3) == 1048576) | ((i3 & 896) == 256);
            ...
            if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                obj = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m2094invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                    }

                    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                    public final MeasureResult m2094invoke0kLqBqw(final SubcomposeMeasureScope subcomposeMeasureScope, long j) {
                        Object obj2;
                        Object obj3;
                        Object obj4;
                        ...
                        final int m6255getMaxHeightimpl = Constraints.m6255getMaxHeightimpl(j);
                        ...
                        for (int i9 = 0; i9 < size; i9++) {
                            arrayList.add(subcompose.get(i9).mo5179measureBRTryo0(m6247copyZbe2FdA$default));
                        }
                        ...
                        for (int size2 = subcompose2.size(); i11 < size2; size2 = size2) {
                            ...
                            arrayList3.add(subcompose2.get(i11).mo5179measureBRTryo0(ConstraintsKt.m6275offsetNN6EwU(m6247copyZbe2FdA$default, (-windowInsets2.getLeft(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection())) - windowInsets2.getRight(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection()), -windowInsets2.getBottom(subcomposeMeasureScope2))));
                            i11++;
                            height3 = height3;
                        ...
                        while (i17 < size3) {
                            ...
                            int i19 = -windowInsets3.getBottom(subcomposeMeasureScope3);
                            WindowInsets windowInsets4 = windowInsets3;
                            Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(ConstraintsKt.m6275offsetNN6EwU(m6247copyZbe2FdA$default, right, i19));
                            if (mo5179measureBRTryo0.getHeight() == 0 || mo5179measureBRTryo0.getWidth() == 0) {
                                mo5179measureBRTryo0 = null;
                            }
                            if (mo5179measureBRTryo0 != null) {
                                arrayList5.add(mo5179measureBRTryo0);
                            }
                            i17++;
                        ...
                        if (arrayList6.isEmpty()) {
                            ...
                            if (arrayList6.isEmpty()) {
                                ...
                                if (1 <= lastIndex4) {
                                    ...
                                    int i21 = 1;
                                    while (true) {
                                        Object obj14 = arrayList6.get(i21);
                            ...
                            if (arrayList6.isEmpty()) {
                                ...
                                if (1 <= lastIndex5) {
                                    ...
                                    int i23 = 1;
                                    while (true) {
                                        Object obj16 = arrayList6.get(i23);
                                        Object obj17 = obj15;
                            ...
                            int i24 = i;
                            if (FabPosition.m1783equalsimpl0(i24, FabPosition.INSTANCE.m1790getStartERTFSPs())) {
                                if (subcomposeMeasureScope.getLayoutDirection() == LayoutDirection.Ltr) {
                                    f6 = ScaffoldKt.FabSpacing;
                                    i7 = subcomposeMeasureScope.mo370roundToPx0680j_4(f6);
                                    fabPlacement = new FabPlacement(i7, width6, height9);
                                } else {
                                    f5 = ScaffoldKt.FabSpacing;
                                    i8 = subcomposeMeasureScope.mo370roundToPx0680j_4(f5);
                                    i7 = (m6256getMaxWidthimpl - i8) - width6;
                                    fabPlacement = new FabPlacement(i7, width6, height9);
                                }
                            } else {
                                if (FabPosition.m1783equalsimpl0(i24, FabPosition.INSTANCE.m1788getEndERTFSPs()) ? true : FabPosition.m1783equalsimpl0(i24, FabPosition.INSTANCE.m1789getEndOverlayERTFSPs())) {
                                    if (subcomposeMeasureScope.getLayoutDirection() == LayoutDirection.Ltr) {
                                        f4 = ScaffoldKt.FabSpacing;
                                        i8 = subcomposeMeasureScope.mo370roundToPx0680j_4(f4);
                                        i7 = (m6256getMaxWidthimpl - i8) - width6;
                                    } else {
                                        f3 = ScaffoldKt.FabSpacing;
                                        i7 = subcomposeMeasureScope.mo370roundToPx0680j_4(f3);
                                    }
                                } else {
                                    i7 = (m6256getMaxWidthimpl - width6) / 2;
                                }
                                fabPlacement = new FabPlacement(i7, width6, height9);
                            }
                        }
                        ...
                        for (int i25 = 0; i25 < size4; i25++) {
                            arrayList7.add(subcompose4.get(i25).mo5179measureBRTryo0(m6247copyZbe2FdA$default));
                        }
                        ...
                        if (arrayList8.isEmpty()) {
                            ...
                            if (1 <= lastIndex6) {
                                int i26 = 1;
                                while (true) {
                                    Object obj18 = arrayList8.get(i26);
                        ...
                        if (fabPlacement != null) {
                            ...
                            if (valueOf == null || FabPosition.m1783equalsimpl0(i27, FabPosition.INSTANCE.m1789getEndOverlayERTFSPs())) {
                                int height12 = fabPlacement.getHeight();
                                f = ScaffoldKt.FabSpacing;
                                i6 = height12 + subcomposeMeasureScope.mo370roundToPx0680j_4(f);
                                bottom = windowInsets5.getBottom(subcomposeMeasureScope);
                            } else {
                                i6 = valueOf.intValue() + fabPlacement.getHeight();
                                f2 = ScaffoldKt.FabSpacing;
                                bottom = subcomposeMeasureScope.mo370roundToPx0680j_4(f2);
                            }
                            ...
                            public final void invoke(Composer composer2, int i28) {
                                ...
                                if ((i28 & 3) != 2 || !composer2.getSkipping()) {
                                    ...
                                    if (arrayList2.isEmpty()) {
                                        ...
                                        f7 = subcomposeMeasureScope.mo373toDpu2uoSUM(i12);
                                    }
                                    if (arrayList8.isEmpty() || (num3 = num2) == null) {
                                        bottom2 = asPaddingValues.getBottom();
                                    } else {
                                        bottom2 = subcomposeMeasureScope.mo373toDpu2uoSUM(num3.intValue());
                                    }
                                    function32.invoke(PaddingKt.m680PaddingValuesa9UjIt4(PaddingKt.calculateStartPadding(asPaddingValues, subcomposeMeasureScope.getLayoutDirection()), f7, PaddingKt.calculateEndPadding(asPaddingValues, subcomposeMeasureScope.getLayoutDirection()), bottom2), composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                        ...
                        for (int i28 = 0; i28 < size5; i28++) {
                            arrayList9.add(subcompose5.get(i28).mo5179measureBRTryo0(m6247copyZbe2FdA$default));
                        }
                        ...
                        return MeasureScope.layout$default(subcomposeMeasureScope, m6256getMaxWidthimpl, m6255getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$2
                ...
                public final void invoke(Composer composer2, int i5) {
                    ScaffoldKt.m2092ScaffoldLayoutFMILGgc(i, function2, function3, function22, function23, windowInsets, function24, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
