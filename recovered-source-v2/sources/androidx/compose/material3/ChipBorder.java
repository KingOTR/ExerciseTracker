...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m266BorderStrokecXLIe8U(this.borderWidth, z ? this.borderColor : this.disabledBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.borderColor, chipBorder.borderColor) && Color.m3844equalsimpl0(this.disabledBorderColor, chipBorder.disabledBorderColor) && Dp.m6308equalsimpl0(this.borderWidth, chipBorder.borderWidth);
    }

    public int hashCode() {
        return (((Color.m3850hashCodeimpl(this.borderColor) * 31) + Color.m3850hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m6309hashCodeimpl(this.borderWidth);
    }
}
