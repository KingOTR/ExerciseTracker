...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        final int m2035calculateWidthDHJA7U0;
        final int m2034calculateHeightmKXJcVc;
        List<? extends Measurable> list2 = list;
        int i = measureScope.mo370roundToPx0680j_4(this.paddingValues.getBottom());
        ...
        Placeable mo5179measureBRTryo0 = measurable8 != null ? measurable8.mo5179measureBRTryo0(m6247copyZbe2FdA$default) : null;
        int widthOrZero = TextFieldImplKt.widthOrZero(mo5179measureBRTryo0);
        int max = Math.max(0, TextFieldImplKt.heightOrZero(mo5179measureBRTryo0));
        int size2 = list.size();
        int i3 = 0;
        while (true) {
            if (i3 >= size2) {
        ...
        Placeable mo5179measureBRTryo02 = measurable9 != null ? measurable9.mo5179measureBRTryo0(ConstraintsKt.m6276offsetNN6EwU$default(m6247copyZbe2FdA$default, -widthOrZero, 0, 2, null)) : null;
        int widthOrZero2 = widthOrZero + TextFieldImplKt.widthOrZero(mo5179measureBRTryo02);
        int max2 = Math.max(max, TextFieldImplKt.heightOrZero(mo5179measureBRTryo02));
        int size3 = list.size();
        int i4 = 0;
        while (true) {
            if (i4 >= size3) {
        ...
        final Placeable mo5179measureBRTryo03 = measurable10 != null ? measurable10.mo5179measureBRTryo0(ConstraintsKt.m6276offsetNN6EwU$default(m6247copyZbe2FdA$default, -widthOrZero2, 0, 2, null)) : null;
        int widthOrZero3 = widthOrZero2 + TextFieldImplKt.widthOrZero(mo5179measureBRTryo03);
        int max3 = Math.max(max2, TextFieldImplKt.heightOrZero(mo5179measureBRTryo03));
        int size4 = list.size();
        int i5 = 0;
        while (true) {
            if (i5 >= size4) {
        ...
        Placeable mo5179measureBRTryo04 = measurable11 != null ? measurable11.mo5179measureBRTryo0(ConstraintsKt.m6276offsetNN6EwU$default(m6247copyZbe2FdA$default, -widthOrZero3, 0, 2, null)) : null;
        int widthOrZero4 = widthOrZero3 + TextFieldImplKt.widthOrZero(mo5179measureBRTryo04);
        int max4 = Math.max(max3, TextFieldImplKt.heightOrZero(mo5179measureBRTryo04));
        int i6 = measureScope.mo370roundToPx0680j_4(this.paddingValues.mo635calculateLeftPaddingu2uoSUM(measureScope.getLayoutDirection())) + measureScope.mo370roundToPx0680j_4(this.paddingValues.mo636calculateRightPaddingu2uoSUM(measureScope.getLayoutDirection()));
        int i7 = -widthOrZero4;
        int i8 = -i;
        final Placeable placeable = mo5179measureBRTryo02;
        long m6275offsetNN6EwU = ConstraintsKt.m6275offsetNN6EwU(m6247copyZbe2FdA$default, MathHelpersKt.lerp(i7 - i6, -i6, this.animationProgress), i8);
        int size5 = list.size();
        int i9 = 0;
        while (true) {
            if (i9 >= size5) {
        ...
        Placeable mo5179measureBRTryo05 = measurable13 != null ? measurable13.mo5179measureBRTryo0(m6275offsetNN6EwU) : null;
        this.onLabelMeasured.invoke(Size.m3659boximpl(mo5179measureBRTryo05 != null ? SizeKt.Size(mo5179measureBRTryo05.getWidth(), mo5179measureBRTryo05.getHeight()) : Size.INSTANCE.m3680getZeroNHjbRc()));
        int size6 = list.size();
        int i11 = 0;
        while (true) {
            if (i11 >= size6) {
        ...
        int minIntrinsicHeight = measurable14 != null ? measurable14.minIntrinsicHeight(Constraints.m6258getMinWidthimpl(j)) : 0;
        int max5 = Math.max(TextFieldImplKt.heightOrZero(mo5179measureBRTryo05) / 2, measureScope.mo370roundToPx0680j_4(this.paddingValues.getTop()));
        long m6247copyZbe2FdA$default2 = Constraints.m6247copyZbe2FdA$default(ConstraintsKt.m6275offsetNN6EwU(j, i7, (i8 - max5) - minIntrinsicHeight), 0, 0, 0, 0, 11, null);
        int size7 = list.size();
        int i13 = 0;
        while (i13 < size7) {
            int i14 = size7;
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable15), TextFieldImplKt.TextFieldId)) {
                final Placeable mo5179measureBRTryo06 = measurable15.mo5179measureBRTryo0(m6247copyZbe2FdA$default2);
                long m6247copyZbe2FdA$default3 = Constraints.m6247copyZbe2FdA$default(m6247copyZbe2FdA$default2, 0, 0, 0, 0, 14, null);
                int size8 = list.size();
                int i16 = 0;
                while (true) {
                    if (i16 >= size8) {
                ...
                Placeable mo5179measureBRTryo07 = measurable16 != null ? measurable16.mo5179measureBRTryo0(m6247copyZbe2FdA$default3) : null;
                int max6 = Math.max(max4, Math.max(TextFieldImplKt.heightOrZero(mo5179measureBRTryo06), TextFieldImplKt.heightOrZero(mo5179measureBRTryo07)) + max5 + i);
                m2035calculateWidthDHJA7U0 = OutlinedTextFieldKt.m2035calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(mo5179measureBRTryo0), TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(mo5179measureBRTryo03), TextFieldImplKt.widthOrZero(mo5179measureBRTryo04), mo5179measureBRTryo06.getWidth(), TextFieldImplKt.widthOrZero(mo5179measureBRTryo05), TextFieldImplKt.widthOrZero(mo5179measureBRTryo07), this.animationProgress, j, measureScope.getDensity(), this.paddingValues);
                Placeable mo5179measureBRTryo08 = measurable14 != null ? measurable14.mo5179measureBRTryo0(Constraints.m6247copyZbe2FdA$default(ConstraintsKt.m6276offsetNN6EwU$default(m6247copyZbe2FdA$default, 0, -max6, 1, null), 0, m2035calculateWidthDHJA7U0, 0, 0, 9, null)) : null;
                int heightOrZero = TextFieldImplKt.heightOrZero(mo5179measureBRTryo08);
                m2034calculateHeightmKXJcVc = OutlinedTextFieldKt.m2034calculateHeightmKXJcVc(TextFieldImplKt.heightOrZero(mo5179measureBRTryo0), TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(mo5179measureBRTryo03), TextFieldImplKt.heightOrZero(mo5179measureBRTryo04), mo5179measureBRTryo06.getHeight(), TextFieldImplKt.heightOrZero(mo5179measureBRTryo05), TextFieldImplKt.heightOrZero(mo5179measureBRTryo07), TextFieldImplKt.heightOrZero(mo5179measureBRTryo08), this.animationProgress, j, measureScope.getDensity(), this.paddingValues);
                int i18 = m2034calculateHeightmKXJcVc - heightOrZero;
                int size9 = list.size();
                int i19 = 0;
                while (i19 < size9) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable17), TextFieldImplKt.ContainerId)) {
                        final Placeable mo5179measureBRTryo09 = measurable17.mo5179measureBRTryo0(ConstraintsKt.Constraints(m2035calculateWidthDHJA7U0 != Integer.MAX_VALUE ? m2035calculateWidthDHJA7U0 : 0, m2035calculateWidthDHJA7U0, i18 != Integer.MAX_VALUE ? i18 : 0, i18));
                        final Placeable placeable2 = mo5179measureBRTryo0;
                        final Placeable placeable3 = mo5179measureBRTryo04;
                        final Placeable placeable4 = mo5179measureBRTryo05;
                        final Placeable placeable5 = mo5179measureBRTryo07;
                        final Placeable placeable6 = mo5179measureBRTryo08;
                        return MeasureScope.layout$default(measureScope, m2035calculateWidthDHJA7U0, m2034calculateHeightmKXJcVc, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$1
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                ...
                                int i21 = m2034calculateHeightmKXJcVc;
                                int i22 = m2035calculateWidthDHJA7U0;
                                Placeable placeable7 = placeable2;
                                Placeable placeable8 = placeable;
                                Placeable placeable9 = mo5179measureBRTryo03;
                                Placeable placeable10 = placeable3;
                                Placeable placeable11 = mo5179measureBRTryo06;
                                Placeable placeable12 = placeable4;
                                Placeable placeable13 = placeable5;
                                Placeable placeable14 = mo5179measureBRTryo09;
                                ...
                                OutlinedTextFieldKt.place(placementScope, i21, i22, placeable7, placeable8, placeable9, placeable10, placeable11, placeable12, placeable13, placeable14, placeable15, f, z, density, layoutDirection, paddingValues);
                            }
                        }, 4, null);
                    }
                    i19++;
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        int m2035calculateWidthDHJA7U0;
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable7), TextFieldImplKt.TextFieldId)) {
                ...
                m2035calculateWidthDHJA7U0 = OutlinedTextFieldKt.m2035calculateWidthDHJA7U0(intValue4, intValue3, intValue5, intValue6, intValue, intValue2, intrinsicMeasurable14 != null ? function2.invoke(intrinsicMeasurable14, Integer.valueOf(i)).intValue() : 0, this.animationProgress, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m2035calculateWidthDHJA7U0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        int m2034calculateHeightmKXJcVc;
        int size = list.size();
        int i7 = 0;
        while (true) {
            if (i7 >= size) {
        ...
        for (int i12 = 0; i12 < size6; i12++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable13), TextFieldImplKt.TextFieldId)) {
                ...
                m2034calculateHeightmKXJcVc = OutlinedTextFieldKt.m2034calculateHeightmKXJcVc(i3, i4, i5, i6, intValue3, intValue, intValue4, intrinsicMeasurable16 != null ? function2.invoke(intrinsicMeasurable16, Integer.valueOf(i)).intValue() : 0, this.animationProgress, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m2034calculateHeightmKXJcVc;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
