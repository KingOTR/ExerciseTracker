...
public final class ExpressiveNavigationBarItemDefaults {
    ...
    public final NavigationItemColors getDefaultExpressiveNavigationBarItemColors$material3_release(ColorScheme colorScheme) {
        ...
        long m3842copywmQWz5c$default = Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, colorSchemeKeyTokens6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
        colorSchemeKeyTokens7 = ExpressiveNavigationBarKt.InactiveLabelTextColor;
        NavigationItemColors navigationItemColors = new NavigationItemColors(fromToken, fromToken2, fromToken3, fromToken4, fromToken5, m3842copywmQWz5c$default, Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, colorSchemeKeyTokens7), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
