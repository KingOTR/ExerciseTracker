...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState analogTimePickerState, boolean z, int i) {
        ...
        this.selection = i;
        this.center = IntOffset.INSTANCE.m6441getZeronOccac();
    ...
    public final float getMaxDist() {
        ...
        return requireDensity.mo376toPx0680j_4(f);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo366onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m6479getCenterozmzZPI(size);
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* renamed from: onPointerEvent-H0pRuoY */
    public void mo212onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo212onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo212onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public final void m1565updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (TimePickerSelectionMode.m2430equalsimpl0(this.selection, selection)) {
            return;
        }
