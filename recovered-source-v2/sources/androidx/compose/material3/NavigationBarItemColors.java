...
public final class NavigationBarItemColors {
    ...
    public final long m1948getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationBarItemColors m1943copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m1952iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m1953textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m3844equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m3844equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m3844equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m3844equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m3844equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m3844equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
