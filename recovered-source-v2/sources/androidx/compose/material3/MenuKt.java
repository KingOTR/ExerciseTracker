...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m6303constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m6303constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m6303constructorimpl(SdkConfig.SDK_VERSION);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m6303constructorimpl(280);

    /* renamed from: DropdownMenuContent-Qj0Zi0g, reason: not valid java name */
    public static final void m1924DropdownMenuContentQj0Zi0g(final Modifier modifier, final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, final Shape shape, final long j, final float f, final float f2, final BorderStroke borderStroke, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        int i2;
        int i3;
        ...
        if ((i2 & 306783379) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            boolean changed = startRestartGroup.changed(booleanValue5) | startRestartGroup.changed(createTransitionAnimation) | ((i2 & SdkConfig.SDK_VERSION) == 32 || ((i2 & 64) != 0 && startRestartGroup.changedInstance(mutableTransitionState))) | startRestartGroup.changed(createTransitionAnimation2) | ((i2 & 896) == 256);
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                rememberedValue = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        ...
                        graphicsLayerScope.mo4036setTransformOrigin__ExYCQ(mutableState.getValue().getPackedValue());
                    }
                };
            ...
            int i4 = i3 >> 9;
            int i5 = i3 >> 6;
            SurfaceKt.m2226SurfaceT9BRK9s(GraphicsLayerModifierKt.graphicsLayer(companion, (Function1) rememberedValue), shape, j, 0L, f, f2, borderStroke, ComposableLambdaKt.rememberComposableLambda(1573559053, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer composer2, int i6) {
                    ...
                    if ((i6 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier verticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m686paddingVpY3zN4$default(Modifier.this, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), scrollState, false, null, false, 14, null);
            ...
            }, startRestartGroup, 54), startRestartGroup, (i4 & 896) | (i4 & SdkConfig.SDK_VERSION) | 12582912 | (57344 & i5) | (458752 & i5) | (i5 & 3670016), 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$3
                ...
                public final void invoke(Composer composer2, int i6) {
                    MenuKt.m1924DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState, scrollState, shape, j, f, f2, borderStroke, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getLabelLarge(), ComposableLambdaKt.rememberComposableLambda(1065051884, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function22 != null) {
                            ProvidedValue<Color> provides = ContentColorKt.getLocalContentColor().provides(Color.m3833boximpl(menuItemColors.m1921leadingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides, ComposableLambdaKt.rememberComposableLambda(2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m714defaultMinSizeVpY3zN4$default = SizeKt.m714defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m2989getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(composer3, m714defaultMinSizeVpY3zN4$default);
                        ...
                        composer2.endReplaceGroup();
                        ProvidedValue<Color> provides2 = ContentColorKt.getLocalContentColor().provides(Color.m3833boximpl(menuItemColors.m1922textColorvNxB06k$material3_release(z)));
                        ...
                        CompositionLocalKt.CompositionLocalProvider(provides2, ComposableLambdaKt.rememberComposableLambda(-1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer composer3, int i4) {
                                ...
                                if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (function25 != null) {
                                        m6303constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m6303constructorimpl = Dp.m6303constructorimpl(0);
                                    }
                                    float f = m6303constructorimpl;
                                    if (function26 != null) {
                                        m6303constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m6303constructorimpl2 = Dp.m6303constructorimpl(0);
                                    }
                                    Modifier m688paddingqDBjuR0$default = PaddingKt.m688paddingqDBjuR0$default(weight$default, f, 0.0f, m6303constructorimpl2, 0.0f, 10, null);
                                    ...
                                    int currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composer3, 0);
                                    CompositionLocalMap currentCompositionLocalMap2 = composer3.getCurrentCompositionLocalMap();
                                    Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(composer3, m688paddingqDBjuR0$default);
                                    Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                                    ComposerKt.sourceInformationMarkerStart(composer3, -692256719, "CC(ReusableComposeNode)P(1,2)376@14062L9:Composables.kt#9igjgp");
                                    if (!(composer3.getApplier() instanceof Applier)) {
                                        ComposablesKt.invalidApplier();
                        ...
                        if (function23 != null) {
                            ProvidedValue<Color> provides3 = ContentColorKt.getLocalContentColor().provides(Color.m3833boximpl(menuItemColors.m1923trailingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides3, ComposableLambdaKt.rememberComposableLambda(580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m714defaultMinSizeVpY3zN4$default = SizeKt.m714defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m2997getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
    ...
    */
    ...
    static {
        float f = 48;
        MenuVerticalMargin = Dp.m6303constructorimpl(f);
        MenuListItemContainerHeight = Dp.m6303constructorimpl(f);
    }
}
