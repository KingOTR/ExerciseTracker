...
public final class SearchBarColors {
    ...
    */
    private SearchBarColors(long j, long j2) {
        ...
        textFieldColors = SearchBar_androidKt.UnspecifiedTextFieldColors;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m3844equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual(this.inputFieldColors, searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m3850hashCodeimpl(this.containerColor) * 31) + Color.m3850hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
