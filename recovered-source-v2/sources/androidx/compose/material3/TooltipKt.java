...
public final class TooltipKt {
    ...
    private static final float TooltipMinWidth = Dp.m6303constructorimpl(40);
    private static final float PlainTooltipMaxWidth = Dp.m6303constructorimpl(200);
    ...
    */
    ...
    public static final TooltipState rememberTooltipState(boolean z, boolean z2, MutatorMutex mutatorMutex, Composer composer, int i, int i2) {
        ...
        boolean z3 = ((((i & SdkConfig.SDK_VERSION) ^ 48) > 32 && composer.changed(z2)) || (i & 48) == 32) | ((((i & 896) ^ 384) > 256 && composer.changed(mutatorMutex)) || (i & 384) == 256);
    ...
    public static final Modifier textVerticalPadding(Modifier modifier, boolean z, boolean z2) {
        if (!z && !z2) {
            return PaddingKt.m686paddingVpY3zN4$default(modifier, 0.0f, PlainTooltipVerticalPadding, 1, null);
        }
        return PaddingKt.m688paddingqDBjuR0$default(AlignmentLineKt.m539paddingFromBaselineVpY3zN4$default(modifier, HeightFromSubheadToTextFirstLine, 0.0f, 2, null), 0.0f, 0.0f, 0.0f, TextBottomPadding, 7, null);
    }
    ...
    public static final Modifier animateTooltip(Modifier modifier, final Transition<Boolean> transition) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.TooltipKt$animateTooltip$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                composer.endReplaceGroup();
                return m4004graphicsLayerAp8cVGQ$default;
            }
    ...
    static {
        float f = 4;
        SpacingBetweenTooltipAndAnchor = Dp.m6303constructorimpl(f);
        float f2 = 24;
        TooltipMinHeight = Dp.m6303constructorimpl(f2);
        float m6303constructorimpl = Dp.m6303constructorimpl(f);
        PlainTooltipVerticalPadding = m6303constructorimpl;
        float f3 = 8;
        float m6303constructorimpl2 = Dp.m6303constructorimpl(f3);
        PlainTooltipHorizontalPadding = m6303constructorimpl2;
        PlainTooltipContentPadding = PaddingKt.m678PaddingValuesYgX7TsA(m6303constructorimpl2, m6303constructorimpl);
        RichTooltipMaxWidth = Dp.m6303constructorimpl(320);
        float f4 = 16;
        RichTooltipHorizontalPadding = Dp.m6303constructorimpl(f4);
        HeightToSubheadFirstLine = Dp.m6303constructorimpl(28);
        HeightFromSubheadToTextFirstLine = Dp.m6303constructorimpl(f2);
        TextBottomPadding = Dp.m6303constructorimpl(f4);
        ActionLabelMinHeight = Dp.m6303constructorimpl(36);
        ActionLabelBottomPadding = Dp.m6303constructorimpl(f3);
    }
}
