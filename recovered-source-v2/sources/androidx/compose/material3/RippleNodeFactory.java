...
final class RippleNodeFactory implements IndicationNodeFactory {
    ...
    private RippleNodeFactory(boolean z, float f, ColorProducer colorProducer) {
        this(z, f, colorProducer, Color.INSTANCE.m3879getUnspecified0d7_KjU());
    }
    ...
    public DelegatableNode create(InteractionSource interactionSource) {
        ...
        if (colorProducer == null) {
            colorProducer = new ColorProducer() { // from class: androidx.compose.material3.RippleNodeFactory$create$colorProducer$1
                ...
                public final long mo1743invoke0d7_KjU() {
                    long j;
    ...
    public boolean equals(Object other) {
        ...
        if (this.bounded == rippleNodeFactory.bounded && Dp.m6308equalsimpl0(this.radius, rippleNodeFactory.radius) && Intrinsics.areEqual(this.colorProducer, rippleNodeFactory.colorProducer)) {
            return Color.m3844equalsimpl0(this.color, rippleNodeFactory.color);
        }
        return false;
    }
    ...
    @Override // androidx.compose.foundation.IndicationNodeFactory
    public int hashCode() {
        int hashCode = ((Boolean.hashCode(this.bounded) * 31) + Dp.m6309hashCodeimpl(this.radius)) * 31;
        ColorProducer colorProducer = this.colorProducer;
        return ((hashCode + (colorProducer != null ? colorProducer.hashCode() : 0)) * 31) + Color.m3850hashCodeimpl(this.color);
    }
}
