...
public final class OutlinedTextFieldTokens {
    ...
    private static final float FocusOutlineWidth = Dp.m6303constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 1.0d;
        DisabledOutlineWidth = Dp.m6303constructorimpl(f);
        HoverOutlineWidth = Dp.m6303constructorimpl(f);
        float f2 = (float) 24.0d;
        LeadingIconSize = Dp.m6303constructorimpl(f2);
        OutlineWidth = Dp.m6303constructorimpl(f);
    ...
    public final float m3043getContainerHeightD9Ej5fM() {
    ...
    public final float m3044getDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m3045getFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m3046getHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m3048getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
