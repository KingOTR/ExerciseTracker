...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m6303constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m6303constructorimpl((float) 6.0d);
    ...
    public final float m2697getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m2698getSizeD9Ej5fM() {
        return Size;
    }
}
