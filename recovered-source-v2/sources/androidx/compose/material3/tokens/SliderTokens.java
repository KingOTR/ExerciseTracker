...
public final class SliderTokens {
    ...
    private static final float ValueIndicatorActiveBottomSpace = Dp.m6303constructorimpl((float) 12.0d);
    ...
    static {
        float f = (float) 44.0d;
        ActiveHandleHeight = Dp.m6303constructorimpl(f);
        float f2 = (float) 6.0d;
        ActiveHandleLeadingSpace = Dp.m6303constructorimpl(f2);
        ActiveHandlePadding = Dp.m6303constructorimpl(f2);
        ActiveHandleTrailingSpace = Dp.m6303constructorimpl(f2);
        float f3 = (float) 4.0d;
        ActiveHandleWidth = Dp.m6303constructorimpl(f3);
        float f4 = (float) 16.0d;
        ActiveTrackHeight = Dp.m6303constructorimpl(f4);
        DisabledHandleWidth = Dp.m6303constructorimpl(f3);
        float f5 = (float) 2.0d;
        FocusHandleWidth = Dp.m6303constructorimpl(f5);
        HandleHeight = Dp.m6303constructorimpl(f);
        HandleWidth = Dp.m6303constructorimpl(f3);
        HoverHandleWidth = Dp.m6303constructorimpl(f3);
        InactiveTrackHeight = Dp.m6303constructorimpl(f4);
        PressedHandleWidth = Dp.m6303constructorimpl(f5);
        StopIndicatorSize = Dp.m6303constructorimpl(f3);
        StopIndicatorTrailingSpace = Dp.m6303constructorimpl(f2);
    }
    ...
    public final float m3172getActiveHandleTrailingSpaceD9Ej5fM() {
        return ActiveHandleTrailingSpace;
    }

    /* renamed from: getActiveHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m3173getActiveHandleWidthD9Ej5fM() {
    ...
    public final float m3174getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m3175getDisabledHandleWidthD9Ej5fM() {
    ...
    public final float m3176getFocusHandleWidthD9Ej5fM() {
    ...
    public final float m3177getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m3178getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m3179getHoverHandleWidthD9Ej5fM() {
    ...
    public final float m3180getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m3181getPressedHandleWidthD9Ej5fM() {
