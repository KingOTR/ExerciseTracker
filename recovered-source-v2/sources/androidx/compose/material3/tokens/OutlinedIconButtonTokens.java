...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6303constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6303constructorimpl((float) 24.0d);
    ...
    public final float m3037getContainerSizeD9Ej5fM() {
    ...
    public final float m3038getSizeD9Ej5fM() {
        return Size;
    }
