...
public final class ProgressIndicatorTokens {
    ...
    private static final float Size = Dp.m6303constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveThickness = Dp.m6303constructorimpl(f);
        ActiveTrackSpace = Dp.m6303constructorimpl(f);
        StopShape = Dp.m6303constructorimpl(f);
        StopSize = Dp.m6303constructorimpl(f);
        TrackThickness = Dp.m6303constructorimpl(f);
    }
    ...
    public final float m3146getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* renamed from: getActiveTrackSpace-D9Ej5fM, reason: not valid java name */
    public final float m3147getActiveTrackSpaceD9Ej5fM() {
    ...
    public final float m3149getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* renamed from: getStopSize-D9Ej5fM, reason: not valid java name */
    public final float m3150getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3151getTrackThicknessD9Ej5fM() {
        return TrackThickness;
    }

    /* renamed from: getSize-D9Ej5fM, reason: not valid java name */
    public final float m3148getSizeD9Ej5fM() {
        return Size;
    }
}
