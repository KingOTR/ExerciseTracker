...
public final class ChipColors {
    ...
    public final ChipColors m1538copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
    ...
    public final long m1537containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1547labelColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1548leadingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1549trailingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m3844equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m3844equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m3844equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m3844equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m3844equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m3844equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m3844equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m3850hashCodeimpl(this.containerColor) * 31) + Color.m3850hashCodeimpl(this.labelColor)) * 31) + Color.m3850hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m3850hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3850hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
