...
final class SliderKt$rangeSliderPressDragModifier$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00431 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00431(RangeSliderState rangeSliderState, RangeSliderLogic rangeSliderLogic, CoroutineScope coroutineScope, Continuation<? super C00431> continuation) {
                super(2, continuation);
                this.$state = rangeSliderState;
                this.$rangeSliderLogic = rangeSliderLogic;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00431 c00431 = new C00431(this.$state, this.$rangeSliderLogic, this.$$this$coroutineScope, continuation);
                c00431.L$0 = obj;
                return c00431;
            }
            ...
            */
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (i != 1) {
                        ...
                        if (pair != null) {
                            ...
                            float m2579pointerSlopE8SPZFQ = DragGestureDetectorCopyKt.m2579pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), pointerInputChange.getType());
                            if (Math.abs(rangeSliderState.getRawOffsetEnd$material3_release() - floatRef.element) < m2579pointerSlopE8SPZFQ && Math.abs(rangeSliderState.getRawOffsetStart$material3_release() - floatRef.element) < m2579pointerSlopE8SPZFQ) {
                                float floatValue = ((Number) pair.getSecond()).floatValue();
                                if (!rangeSliderState.isRtl$material3_release() ? floatValue < 0.0f : floatValue >= 0.0f) {
                                    z = true;
                                }
                                booleanRef.element = z;
                                floatRef.element += Offset.m3602getXimpl(PointerEventKt.positionChange((PointerInputChange) pair.getFirst()));
                            }
                        }
                        ...
                        try {
                            ...
                            this.L$4 = null;
                            this.label = 3;
                            obj = DragGestureDetectorKt.m426horizontalDragjO51t88(awaitPointerEventScope, id, new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.material3.SliderKt$rangeSliderPressDragModifier$1$1$1$finishInteraction$success$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public final void invoke2(PointerInputChange pointerInputChange2) {
                                    float m3602getXimpl = Offset.m3602getXimpl(PointerEventKt.positionChange(pointerInputChange2));
                                    ...
                                    if (RangeSliderState.this.isRtl$material3_release()) {
                                        m3602getXimpl = -m3602getXimpl;
                                    }
                                    rangeSliderState3.onDrag$material3_release(z2, m3602getXimpl);
                                }
                            }, this);
                ...
                floatRef2.element = this.$state.isRtl$material3_release() ? this.$state.getTotalWidth$material3_release() - Offset.m3602getXimpl(pointerInputChange.getPosition()) : Offset.m3602getXimpl(pointerInputChange.getPosition());
                ...
                this.label = 2;
                m2187awaitSlop8vUncbI = SliderKt.m2187awaitSlop8vUncbI(awaitPointerEventScope, pointerInputChange.getId(), pointerInputChange.getType(), this);
                if (m2187awaitSlop8vUncbI == coroutine_suspended) {
                    return coroutine_suspended;
                }
                start = start3;
                obj = m2187awaitSlop8vUncbI;
                floatRef = floatRef2;
                ...
                this.L$4 = null;
                this.label = 3;
                obj = DragGestureDetectorKt.m426horizontalDragjO51t88(awaitPointerEventScope, id2, new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.material3.SliderKt$rangeSliderPressDragModifier$1$1$1$finishInteraction$success$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (ForEachGestureKt.awaitEachGesture(this.$$this$pointerInput, new C00431(this.$state, this.$rangeSliderLogic, coroutineScope, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
