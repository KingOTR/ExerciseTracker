...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = Dp.m6303constructorimpl(0);
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m755onlybOOhFvg = WindowInsetsKt.m755onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.m767plusgK_yJZ4(WindowInsetsSides.INSTANCE.m777getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m775getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        ...
        ContentPadding = PaddingKt.m681PaddingValuesa9UjIt4$default(f, bottomAppBarVerticalPadding, f2, 0.0f, 8, null);
    }
}
