                                            ...
                                            CompositionLocalKt.CompositionLocalProvider(TextSelectionColorsKt.getLocalTextSelectionColors().provides(textFieldColors2.getTextSelectionColors()), ComposableLambdaKt.rememberComposableLambda(1859145987, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$1
                                                ...
                                                public final void invoke(Composer composer2, int i41) {
                                                    ...
                                                    if ((i41 & 3) != 2 || !composer2.getSkipping()) {
                                                        ...
                                                        Modifier m713defaultMinSizeVpY3zN4 = SizeKt.m713defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(modifier7, z19, Strings_androidKt.m2658getString2EP1pXo(Strings.m2588constructorimpl(androidx.compose.ui.R.string.default_error_message), composer2, 0)), TextFieldDefaults.INSTANCE.m2363getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m2362getMinHeightD9Ej5fM());
                                                        ...
                                                        BasicTextFieldKt.BasicTextField(str2, function12, m713defaultMinSizeVpY3zN4, z20, z21, textStyle4, keyboardOptions6, keyboardActions6, z22, i42, i43, visualTransformation5, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource6, solidColor2, ComposableLambdaKt.rememberComposableLambda(-288211827, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$1.1
                                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                            /* JADX WARN: Multi-variable type inference failed */
                                                            {
                                                                super(3);
                                                            ...
                                                            public final void invoke(Function2<? super Composer, ? super Integer, Unit> function245, Composer composer3, int i44) {
                                                                ...
                                                                if ((i45 & 19) != 18 || !composer3.getSkipping()) {
                                                                    ...
                                                                    TextFieldDefaults.INSTANCE.DecorationBox(str3, function245, z23, z24, visualTransformation6, mutableInteractionSource7, z25, function238, function239, function240, function241, function242, function243, function244, shape6, textFieldColors5, null, null, composer3, (i45 << 3) & SdkConfig.SDK_VERSION, 100663296, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE);
                                                                    if (ComposerKt.isTraceInProgress()) {
    ...
    */
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider(TextSelectionColorsKt.getLocalTextSelectionColors().provides(textFieldColors2.getTextSelectionColors()), ComposableLambdaKt.rememberComposableLambda(-1163788208, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$3
                                                ...
                                                public final void invoke(Composer composer2, int i41) {
                                                    ...
                                                    if ((i41 & 3) != 2 || !composer2.getSkipping()) {
                                                        ...
                                                        final Shape shape6 = shape5;
                                                        final TextFieldColors textFieldColors5 = textFieldColors4;
                                                        BasicTextFieldKt.BasicTextField(textFieldValue2, function12, m713defaultMinSizeVpY3zN4, z20, z21, textStyle4, keyboardOptions6, keyboardActions6, z22, i42, i43, visualTransformation5, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource6, solidColor2, ComposableLambdaKt.rememberComposableLambda(1751957978, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$3.1
                                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                            /* JADX WARN: Multi-variable type inference failed */
                                                            {
                                                                super(3);
    ...
    public static final void TextFieldLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final Function2<? super Composer, ? super Integer, Unit> function26, final boolean z, final float f, final Function2<? super Composer, ? super Integer, Unit> function27, final Function2<? super Composer, ? super Integer, Unit> function28, final PaddingValues paddingValues, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 306783379) != 306783378 || (i4 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m3343setimpl(m3336constructorimpl, textFieldMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            if (function22 != null) {
                Modifier m688paddingqDBjuR0$default3 = PaddingKt.m688paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m717heightInVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.LabelId), DpKt.m6346lerpMdfbLM(TextFieldImplKt.getMinTextLineHeight(), TextFieldImplKt.getMinFocusedLabelLineHeight(), f), 0.0f, 2, null), null, false, 3, null), calculateStartPadding, 0.0f, calculateEndPadding, 0.0f, 10, null);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                ...
                Modifier materializeModifier6 = ComposedModifierKt.materializeModifier(startRestartGroup, m688paddingqDBjuR0$default3);
            ...
            startRestartGroup.endReplaceGroup();
            Modifier wrapContentHeight$default = SizeKt.wrapContentHeight$default(SizeKt.m717heightInVpY3zN4$default(Modifier.INSTANCE, TextFieldImplKt.getMinTextLineHeight(), 0.0f, 2, null), null, false, 3, null);
            if (function25 != null) {
                calculateStartPadding = Dp.m6303constructorimpl(0);
            }
            Modifier m688paddingqDBjuR0$default4 = PaddingKt.m688paddingqDBjuR0$default(wrapContentHeight$default, calculateStartPadding, 0.0f, function26 == null ? f2 : Dp.m6303constructorimpl(0), 0.0f, 10, null);
            startRestartGroup.startReplaceGroup(1341611627);
            ComposerKt.sourceInformation(startRestartGroup, "548@26778L63");
            if (function3 != null) {
                function3.invoke(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.PlaceholderId).then(m688paddingqDBjuR0$default4), startRestartGroup, Integer.valueOf((i3 >> 6) & SdkConfig.SDK_VERSION));
            }
            startRestartGroup.endReplaceGroup();
            Modifier then3 = LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.TextFieldId).then(m688paddingqDBjuR0$default4);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
    ...
    public static final int m2374calculateWidthyeHjK3Y(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        int i8 = i3 + i4;
        return Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, i6)) + i2, Constraints.m6258getMinWidthimpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-mKXJcVc, reason: not valid java name */
    public static final int m2373calculateHeightmKXJcVc(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f, long j, float f2, PaddingValues paddingValues) {
        boolean z = i2 > 0;
        float m6303constructorimpl = Dp.m6303constructorimpl(paddingValues.getTop() + paddingValues.getBottom()) * f2;
        if (z) {
            m6303constructorimpl = MathHelpersKt.lerp(Dp.m6303constructorimpl(TextFieldImplKt.getTextFieldPadding() * 2) * f2, m6303constructorimpl, f);
        }
        return Math.max(Constraints.m6257getMinHeightimpl(j), Math.max(i3, Math.max(i4, MathKt.roundToInt(m6303constructorimpl + MathHelpersKt.lerp(0, i2, f) + ComparisonsKt.maxOf(i, i7, i5, i6, MathHelpersKt.lerp(i2, 0, f))))) + i8);
    }
    ...
    public static final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, boolean z, float f, PaddingValues paddingValues) {
        Placeable.PlacementScope.m5243place70tqf50$default(placementScope, placeable7, IntOffset.INSTANCE.m6441getZeronOccac(), 0.0f, 2, null);
    ...
    public static final Modifier drawIndicatorLine(Modifier modifier, final State<BorderStroke> state) {
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TextFieldKt$drawIndicatorLine$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                ...
                float f = contentDrawScope.mo376toPx0680j_4(state.getValue().getWidth());
                float m3668getHeightimpl = Size.m3668getHeightimpl(contentDrawScope.mo4399getSizeNHjbRc()) - (f / 2);
                DrawScope.m4384drawLine1RTmtNc$default(contentDrawScope, state.getValue().getBrush(), OffsetKt.Offset(0.0f, m3668getHeightimpl), OffsetKt.Offset(Size.m3671getWidthimpl(contentDrawScope.mo4399getSizeNHjbRc()), m3668getHeightimpl), f, 0, null, 0.0f, null, 0, 496, null);
            }
        });
    }
