...
final class AppBarKt$SingleRowTopAppBar$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            Modifier m717heightInVpY3zN4$default = SizeKt.m717heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, this.$windowInsets)), 0.0f, this.$expandedHeight, 1, null);
            ...
            AppBarKt.m1456TopAppBarLayoutkXwM9vE(m717heightInVpY3zN4$default, scrolledOffset, this.$colors.getNavigationIconContentColor(), this.$colors.getTitleContentColor(), this.$colors.getActionIconContentColor(), this.$title, this.$titleTextStyle, 1.0f, Arrangement.INSTANCE.getCenter(), this.$centeredTitle ? Arrangement.INSTANCE.getCenter() : Arrangement.INSTANCE.getStart(), 0, false, this.$navigationIcon, this.$actionsRow, composer, 113246208, 3126);
            if (ComposerKt.isTraceInProgress()) {
