        ...
        if (i == 0) {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            if (z) {
                                ...
                                analogTimePickerState2.mo1442setSelection6_8s6DQ(TimePickerSelectionMode.INSTANCE.m2435getMinuteyecRtBI());
                            }
            ...
            if (DragGestureDetectorKt.detectDragGestures$default(pointerInputScope, null, function0, null, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputDragNode$1.2
                ...
                public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                    m1566invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                    return Unit.INSTANCE;
                }
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            clockDialNode.offsetX = f + Offset.m3602getXimpl(this.$dragAmount);
                            ClockDialNode clockDialNode2 = this.this$0;
                            f2 = clockDialNode2.offsetY;
                            clockDialNode2.offsetY = f2 + Offset.m3603getYimpl(this.$dragAmount);
                            analogTimePickerState = this.this$0.state;
                            f3 = this.this$0.offsetY;
                            j = this.this$0.center;
                            float m6432getYimpl = f3 - IntOffset.m6432getYimpl(j);
                            f4 = this.this$0.offsetX;
                            j2 = this.this$0.center;
                            atan = TimePickerKt.atan(m6432getYimpl, f4 - IntOffset.m6431getXimpl(j2));
                            this.label = 1;
                ...
                public final void m1566invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                    AnalogTimePickerState analogTimePickerState;
                    float f;
                    float f2;
                    float maxDist;
                    ...
                    TimePickerKt.m2412moveSelectord3b8Pxo(analogTimePickerState, f, f2, maxDist, j2);
                }
