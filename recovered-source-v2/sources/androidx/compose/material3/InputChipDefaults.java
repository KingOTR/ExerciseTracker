...
public final class InputChipDefaults {
    ...
    private static final float Height = InputChipTokens.INSTANCE.m2977getContainerHeightD9Ej5fM();
    private static final float IconSize = InputChipTokens.INSTANCE.m2979getLeadingIconSizeD9Ej5fM();
    private static final float AvatarSize = InputChipTokens.INSTANCE.m2975getAvatarSizeD9Ej5fM();

    private InputChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m1845getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1846getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getAvatarSize-D9Ej5fM, reason: not valid java name */
    public final float m1844getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final SelectableChipColors m1848inputChipColorskwJvTHA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
        long j14;
        ...
        long m3879getUnspecified0d7_KjU13 = (i3 & 4096) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j13;
        if (ComposerKt.isTraceInProgress()) {
            j14 = m3879getUnspecified0d7_KjU6;
            ComposerKt.traceEventStart(1312840646, i, i2, "androidx.compose.material3.InputChipDefaults.inputChipColors (Chip.kt:1605)");
        } else {
            j14 = m3879getUnspecified0d7_KjU6;
        }
        SelectableChipColors m2143copydaRQuJA = getDefaultInputChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2143copydaRQuJA(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4, m3879getUnspecified0d7_KjU5, j14, m3879getUnspecified0d7_KjU7, m3879getUnspecified0d7_KjU8, m3879getUnspecified0d7_KjU9, m3879getUnspecified0d7_KjU10, m3879getUnspecified0d7_KjU11, m3879getUnspecified0d7_KjU12, m3879getUnspecified0d7_KjU13);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final SelectableChipElevation m1849inputChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2976getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? InputChipTokens.INSTANCE.m2976getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m2976getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m2976getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m2976getContainerElevationD9Ej5fM : f4;
        float m2978getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m2978getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m2976getContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1745270109, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipElevation (Chip.kt:1672)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m2976getContainerElevationD9Ej5fM, f7, f8, f9, m2978getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke m1847inputChipBorder_7El2pE(boolean z, boolean z2, long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m3842copywmQWz5c$default = (i2 & 16) != 0 ? Color.m3842copywmQWz5c$default(ColorSchemeKt.getValue(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m3878getTransparent0d7_KjU2 = (i2 & 32) != 0 ? Color.INSTANCE.m3878getTransparent0d7_KjU() : j4;
        float m2982getUnselectedOutlineWidthD9Ej5fM = (i2 & 64) != 0 ? InputChipTokens.INSTANCE.m2982getUnselectedOutlineWidthD9Ej5fM() : f;
        float m2980getSelectedOutlineWidthD9Ej5fM = (i2 & 128) != 0 ? InputChipTokens.INSTANCE.m2980getSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (z2) {
            m2982getUnselectedOutlineWidthD9Ej5fM = m2980getSelectedOutlineWidthD9Ej5fM;
        }
        BorderStroke m266BorderStrokecXLIe8U = BorderStrokeKt.m266BorderStrokecXLIe8U(m2982getUnselectedOutlineWidthD9Ej5fM, value);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
