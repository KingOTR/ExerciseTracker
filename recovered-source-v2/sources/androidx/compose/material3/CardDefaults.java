...
public final class CardDefaults {
    ...
    public final CardElevation m1512cardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2930getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledCardTokens.INSTANCE.m2930getContainerElevationD9Ej5fM() : f;
        float m2936getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledCardTokens.INSTANCE.m2936getPressedContainerElevationD9Ej5fM() : f2;
        float m2933getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledCardTokens.INSTANCE.m2933getFocusContainerElevationD9Ej5fM() : f3;
        float m2934getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledCardTokens.INSTANCE.m2934getHoverContainerElevationD9Ej5fM() : f4;
        float m2932getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledCardTokens.INSTANCE.m2932getDraggedContainerElevationD9Ej5fM() : f5;
        float m2931getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilledCardTokens.INSTANCE.m2931getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-574898487, i, -1, "androidx.compose.material3.CardDefaults.cardElevation (Card.kt:405)");
        }
        CardElevation cardElevation = new CardElevation(m2930getContainerElevationD9Ej5fM, m2936getPressedContainerElevationD9Ej5fM, m2933getFocusContainerElevationD9Ej5fM, m2934getHoverContainerElevationD9Ej5fM, m2932getDraggedContainerElevationD9Ej5fM, m2931getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final CardElevation m1514elevatedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2849getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedCardTokens.INSTANCE.m2849getContainerElevationD9Ej5fM() : f;
        float m2855getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedCardTokens.INSTANCE.m2855getPressedContainerElevationD9Ej5fM() : f2;
        float m2852getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedCardTokens.INSTANCE.m2852getFocusContainerElevationD9Ej5fM() : f3;
        float m2853getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedCardTokens.INSTANCE.m2853getHoverContainerElevationD9Ej5fM() : f4;
        float m2851getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedCardTokens.INSTANCE.m2851getDraggedContainerElevationD9Ej5fM() : f5;
        float m2850getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? ElevatedCardTokens.INSTANCE.m2850getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1154241939, i, -1, "androidx.compose.material3.CardDefaults.elevatedCardElevation (Card.kt:434)");
        }
        CardElevation cardElevation = new CardElevation(m2849getContainerElevationD9Ej5fM, m2855getPressedContainerElevationD9Ej5fM, m2852getFocusContainerElevationD9Ej5fM, m2853getHoverContainerElevationD9Ej5fM, m2851getDraggedContainerElevationD9Ej5fM, m2850getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final CardElevation m1516outlinedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m3029getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? OutlinedCardTokens.INSTANCE.m3029getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m3029getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m3029getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m3029getContainerElevationD9Ej5fM : f4;
        float m3031getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? OutlinedCardTokens.INSTANCE.m3031getDraggedContainerElevationD9Ej5fM() : f5;
        float m3030getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? OutlinedCardTokens.INSTANCE.m3030getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-97678773, i, -1, "androidx.compose.material3.CardDefaults.outlinedCardElevation (Card.kt:463)");
        }
        CardElevation cardElevation = new CardElevation(m3029getContainerElevationD9Ej5fM, f7, f8, f9, m3031getDraggedContainerElevationD9Ej5fM, m3030getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final CardColors m1511cardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m3842copywmQWz5c$default = (i2 & 8) != 0 ? Color.m3842copywmQWz5c$default(m1612contentColorForek8zF_U, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1589582123, i, -1, "androidx.compose.material3.CardDefaults.cardColors (Card.kt:494)");
        }
        CardColors m1506copyjRlVdoo = getDefaultCardColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1506copyjRlVdoo(m3879getUnspecified0d7_KjU, m1612contentColorForek8zF_U, m3879getUnspecified0d7_KjU2, m3842copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1506copyjRlVdoo;
    }
    ...
    public final CardColors getDefaultCardColors$material3_release(ColorScheme colorScheme) {
        ...
        CardColors cardColors = new CardColors(ColorSchemeKt.fromToken(colorScheme, FilledCardTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledCardTokens.INSTANCE.getContainerColor())), ColorKt.m3888compositeOverOWjLjI(Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledCardTokens.INSTANCE.getDisabledContainerColor()), FilledCardTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledCardTokens.INSTANCE.getContainerColor())), Color.m3842copywmQWz5c$default(ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledCardTokens.INSTANCE.getContainerColor())), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final CardColors m1513elevatedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        CardColors m1506copyjRlVdoo = getDefaultElevatedCardColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1506copyjRlVdoo(m3879getUnspecified0d7_KjU, m1612contentColorForek8zF_U, m3879getUnspecified0d7_KjU2, m3842copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final CardColors getDefaultElevatedCardColors$material3_release(ColorScheme colorScheme) {
        ...
        CardColors cardColors = new CardColors(ColorSchemeKt.fromToken(colorScheme, ElevatedCardTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, ElevatedCardTokens.INSTANCE.getContainerColor())), ColorKt.m3888compositeOverOWjLjI(Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedCardTokens.INSTANCE.getDisabledContainerColor()), ElevatedCardTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, ElevatedCardTokens.INSTANCE.getDisabledContainerColor())), Color.m3842copywmQWz5c$default(ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, ElevatedCardTokens.INSTANCE.getContainerColor())), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final CardColors m1515outlinedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1612contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1612contentColorForek8zF_U(m3879getUnspecified0d7_KjU, composer, i & 14) : j2;
        long m3879getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j3;
        long m3842copywmQWz5c$default = (i2 & 8) != 0 ? Color.m3842copywmQWz5c$default(ColorSchemeKt.m1612contentColorForek8zF_U(m3879getUnspecified0d7_KjU, composer, i & 14), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1112362409, i, -1, "androidx.compose.material3.CardDefaults.outlinedCardColors (Card.kt:589)");
        }
        CardColors m1506copyjRlVdoo = getDefaultOutlinedCardColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1506copyjRlVdoo(m3879getUnspecified0d7_KjU, m1612contentColorForek8zF_U, m3879getUnspecified0d7_KjU2, m3842copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final CardColors getDefaultOutlinedCardColors$material3_release(ColorScheme colorScheme) {
        ...
        CardColors cardColors = new CardColors(ColorSchemeKt.fromToken(colorScheme, OutlinedCardTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, OutlinedCardTokens.INSTANCE.getContainerColor())), ColorSchemeKt.fromToken(colorScheme, OutlinedCardTokens.INSTANCE.getContainerColor()), Color.m3842copywmQWz5c$default(ColorSchemeKt.m1611contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, OutlinedCardTokens.INSTANCE.getContainerColor())), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final BorderStroke outlinedCardBorder(boolean z, Composer composer, int i, int i2) {
        ...
        if (z) {
            ...
            m3888compositeOverOWjLjI = ColorSchemeKt.getValue(OutlinedCardTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-134330379);
            ComposerKt.sourceInformation(composer, "622@28214L5,624@28366L5");
            m3888compositeOverOWjLjI = ColorKt.m3888compositeOverOWjLjI(Color.m3842copywmQWz5c$default(ColorSchemeKt.getValue(OutlinedCardTokens.INSTANCE.getDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.getValue(ElevatedCardTokens.INSTANCE.getContainerColor(), composer, 6));
            composer.endReplaceGroup();
        }
        ComposerKt.sourceInformationMarkerStart(composer, -974156849, "CC(remember):Card.kt#9igjgp");
        boolean changed = composer.changed(m3888compositeOverOWjLjI);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = BorderStrokeKt.m266BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m3035getOutlineWidthD9Ej5fM(), m3888compositeOverOWjLjI);
