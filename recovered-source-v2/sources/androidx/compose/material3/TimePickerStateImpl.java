...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int i, int i2, boolean z) {
        ...
        this.is24hour = z;
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m2427boximpl(TimePickerSelectionMode.INSTANCE.m2434getHouryecRtBI()), null, 2, null);
    ...
    public int mo1441getSelectionyecRtBI() {
        return ((TimePickerSelectionMode) this.selection.getValue()).m2433unboximpl();
    }

    @Override // androidx.compose.material3.TimePickerState
    /* renamed from: setSelection-6_8s6DQ */
    public void mo1442setSelection6_8s6DQ(int i) {
        this.selection.setValue(TimePickerSelectionMode.m2427boximpl(i));
    }
