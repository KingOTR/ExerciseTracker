...
public final class DividerKt {
    ...
    */
    public static final void m1755HorizontalDivider9IZ8Weo(Modifier modifier, final float f, final long j, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 147) == 146 && startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    f = DividerDefaults.INSTANCE.m1753getThicknessD9Ej5fM();
                }
                if ((i2 & 4) != 0) {
                ...
                boolean z = true;
                Modifier m715height3ABfNKs = SizeKt.m715height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), f);
                ...
                if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.DividerKt$HorizontalDivider$1$1
                        ...
                        public final void invoke2(DrawScope drawScope) {
                            float f2 = 2;
                            DrawScope.m4385drawLineNGM6Ib0$default(drawScope, j, OffsetKt.Offset(0.0f, drawScope.mo376toPx0680j_4(f) / f2), OffsetKt.Offset(Size.m3671getWidthimpl(drawScope.mo4399getSizeNHjbRc()), drawScope.mo376toPx0680j_4(f) / f2), drawScope.mo376toPx0680j_4(f), 0, null, 0.0f, null, 0, 496, null);
                        }
                    };
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$HorizontalDivider$2
                ...
                public final void invoke(Composer composer2, int i6) {
                    DividerKt.m1755HorizontalDivider9IZ8Weo(Modifier.this, f2, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1756VerticalDivider9IZ8Weo(Modifier modifier, final float f, final long j, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 147) == 146 && startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                ...
                boolean z = true;
                Modifier m734width3ABfNKs = SizeKt.m734width3ABfNKs(SizeKt.fillMaxHeight$default(modifier, 0.0f, 1, null), f);
                ...
                if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.DividerKt$VerticalDivider$1$1
                        ...
                        public final void invoke2(DrawScope drawScope) {
                            float f2 = 2;
                            DrawScope.m4385drawLineNGM6Ib0$default(drawScope, j, OffsetKt.Offset(drawScope.mo376toPx0680j_4(f) / f2, 0.0f), OffsetKt.Offset(drawScope.mo376toPx0680j_4(f) / f2, Size.m3668getHeightimpl(drawScope.mo4399getSizeNHjbRc())), drawScope.mo376toPx0680j_4(f), 0, null, 0.0f, null, 0, 496, null);
                        }
                    };
                    startRestartGroup.updateRememberedValue(rememberedValue);
                }
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                CanvasKt.Canvas(m734width3ABfNKs, (Function1) rememberedValue, startRestartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            } else {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$VerticalDivider$2
                ...
                public final void invoke(Composer composer2, int i6) {
                    DividerKt.m1756VerticalDivider9IZ8Weo(Modifier.this, f2, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1754Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        int i3;
        float f2;
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                ...
                if (Dp.m6308equalsimpl0(f, Dp.INSTANCE.m6321getHairlineD9Ej5fM())) {
                    ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                    Object consume = startRestartGroup.consume(localDensity);
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    f2 = Dp.m6303constructorimpl(1.0f / ((Density) consume).getDensity());
                } else {
                    f2 = f;
                }
                startRestartGroup.endReplaceGroup();
                BoxKt.Box(BackgroundKt.m239backgroundbw27NRU$default(SizeKt.m715height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), f2), j, null, 2, null), startRestartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
                ...
                public final void invoke(Composer composer2, int i6) {
                    DividerKt.m1754Divider9IZ8Weo(Modifier.this, f3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
