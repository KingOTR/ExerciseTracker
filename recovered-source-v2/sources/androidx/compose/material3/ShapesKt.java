...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), null, null, CornerSizeKt.m959CornerSize0680j_4(Dp.m6303constructorimpl(f)), 6, null);
    }
}
