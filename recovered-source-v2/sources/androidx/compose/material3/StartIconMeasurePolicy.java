...
final class StartIconMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureResult m2001placeLabelAndStartIconnru01g4;
        ...
        float f = 2;
        long m6275offsetNN6EwU = ConstraintsKt.m6275offsetNN6EwU(m6247copyZbe2FdA$default, -measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorVerticalPadding * f)));
        int size = list.size();
        for (int i = 0; i < size; i++) {
            Measurable measurable = list.get(i);
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(m6275offsetNN6EwU);
                int size2 = list.size();
                for (int i2 = 0; i2 < size2; i2++) {
                    Measurable measurable2 = list.get(i2);
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "label")) {
                        Placeable mo5179measureBRTryo02 = measurable2.mo5179measureBRTryo0(ConstraintsKt.m6276offsetNN6EwU$default(m6275offsetNN6EwU, -(mo5179measureBRTryo0.getWidth() + measureScope.mo370roundToPx0680j_4(this.startIconToLabelHorizontalPadding)), 0, 2, null));
                        int width = mo5179measureBRTryo0.getWidth() + mo5179measureBRTryo02.getWidth() + measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.startIconToLabelHorizontalPadding + Dp.m6303constructorimpl(this.indicatorHorizontalPadding * f)));
                        int max = Math.max(mo5179measureBRTryo0.getHeight(), mo5179measureBRTryo02.getHeight()) + measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorVerticalPadding * f));
                        int roundToInt = MathKt.roundToInt(width * floatValue);
                        int size3 = list.size();
                        for (int i3 = 0; i3 < size3; i3++) {
                            Measurable measurable3 = list.get(i3);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                Placeable mo5179measureBRTryo03 = measurable3.mo5179measureBRTryo0(ConstraintsKt.m6271constrainN9IONVI(m6247copyZbe2FdA$default, Constraints.INSTANCE.m6266fixedJhjzzOo(width, max)));
                                int size4 = list.size();
                                for (int i4 = 0; i4 < size4; i4++) {
                                    Measurable measurable4 = list.get(i4);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "indicator")) {
                                        m2001placeLabelAndStartIconnru01g4 = NavigationItemKt.m2001placeLabelAndStartIconnru01g4(measureScope, mo5179measureBRTryo02, mo5179measureBRTryo0, mo5179measureBRTryo03, measurable4.mo5179measureBRTryo0(ConstraintsKt.m6271constrainN9IONVI(m6247copyZbe2FdA$default, Constraints.INSTANCE.m6266fixedJhjzzOo(roundToInt, max))), j, this.startIconToLabelHorizontalPadding);
                                        return m2001placeLabelAndStartIconnru01g4;
                                    }
                                }
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return maxIntrinsicWidth + intrinsicMeasurable2.maxIntrinsicWidth(i) + intrinsicMeasureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(Dp.m6303constructorimpl(this.indicatorHorizontalPadding * 2) + this.startIconToLabelHorizontalPadding));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    IntrinsicMeasurable intrinsicMeasurable2 = list.get(i3);
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return Math.max(maxIntrinsicHeight, intrinsicMeasurable2.maxIntrinsicHeight(i)) + intrinsicMeasureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorVerticalPadding * 2));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
