...
public final class ButtonDefaults {
    ...
    public final float m1500getMinWidthD9Ej5fM() {
        return MinWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM, reason: not valid java name */
    public final float m1499getMinHeightD9Ej5fM() {
        return MinHeight;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1497getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getIconSpacing-D9Ej5fM, reason: not valid java name */
    public final float m1498getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }
    ...
    public final ButtonColors m1491buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1486copyjRlVdoo = getDefaultButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1486copyjRlVdoo(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1486copyjRlVdoo;
    }
    ...
    public final ButtonColors m1493elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1486copyjRlVdoo = getDefaultElevatedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1486copyjRlVdoo(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultElevatedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getLabelTextColor()), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledContainerColor()), ElevatedButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledLabelTextColor()), ElevatedButtonTokens.INSTANCE.getDisabledLabelTextOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1495filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1486copyjRlVdoo = getDefaultFilledTonalButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1486copyjRlVdoo(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultFilledTonalButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getLabelTextColor()), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor()), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1501outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1486copyjRlVdoo = getDefaultOutlinedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1486copyjRlVdoo(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultOutlinedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m3878getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m3878getTransparent0d7_KjU(), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1502textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1486copyjRlVdoo = getDefaultTextButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1486copyjRlVdoo(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU2, m3879getUnspecified0d7_KjU3, m3879getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultTextButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m3878getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m3878getTransparent0d7_KjU(), Color.m3842copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
        colorScheme.setDefaultTextButtonColorsCached$material3_release(buttonColors);
        return buttonColors;
    }

    /* renamed from: buttonElevation-R_JCAzs, reason: not valid java name */
    public final ButtonElevation m1492buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m2923getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledButtonTokens.INSTANCE.m2923getContainerElevationD9Ej5fM() : f;
        float m2929getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledButtonTokens.INSTANCE.m2929getPressedContainerElevationD9Ej5fM() : f2;
        float m2926getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledButtonTokens.INSTANCE.m2926getFocusContainerElevationD9Ej5fM() : f3;
        float m2927getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledButtonTokens.INSTANCE.m2927getHoverContainerElevationD9Ej5fM() : f4;
        float m2925getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledButtonTokens.INSTANCE.m2925getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1827791191, i, -1, "androidx.compose.material3.ButtonDefaults.buttonElevation (Button.kt:802)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(m2923getContainerElevationD9Ej5fM, m2929getPressedContainerElevationD9Ej5fM, m2926getFocusContainerElevationD9Ej5fM, m2927getHoverContainerElevationD9Ej5fM, m2925getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonElevation m1494elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m2842getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedButtonTokens.INSTANCE.m2842getContainerElevationD9Ej5fM() : f;
        float m2848getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedButtonTokens.INSTANCE.m2848getPressedContainerElevationD9Ej5fM() : f2;
        float m2845getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedButtonTokens.INSTANCE.m2845getFocusContainerElevationD9Ej5fM() : f3;
        float m2846getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedButtonTokens.INSTANCE.m2846getHoverContainerElevationD9Ej5fM() : f4;
        float m2844getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m2844getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m2842getContainerElevationD9Ej5fM, m2848getPressedContainerElevationD9Ej5fM, m2845getFocusContainerElevationD9Ej5fM, m2846getHoverContainerElevationD9Ej5fM, m2844getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonElevation m1496filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m2946getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledTonalButtonTokens.INSTANCE.m2946getContainerElevationD9Ej5fM() : f;
        float m2952getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledTonalButtonTokens.INSTANCE.m2952getPressedContainerElevationD9Ej5fM() : f2;
        float m2949getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledTonalButtonTokens.INSTANCE.m2949getFocusContainerElevationD9Ej5fM() : f3;
        float m2950getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledTonalButtonTokens.INSTANCE.m2950getHoverContainerElevationD9Ej5fM() : f4;
        float m6303constructorimpl = (i2 & 16) != 0 ? Dp.m6303constructorimpl(0) : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m2946getContainerElevationD9Ej5fM, m2952getPressedContainerElevationD9Ej5fM, m2949getFocusContainerElevationD9Ej5fM, m2950getHoverContainerElevationD9Ej5fM, m6303constructorimpl, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke m266BorderStrokecXLIe8U = BorderStrokeKt.m266BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m3028getOutlineWidthD9Ej5fM(), ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke outlinedButtonBorder(boolean z, Composer composer, int i, int i2) {
        ...
        float m3028getOutlineWidthD9Ej5fM = OutlinedButtonTokens.INSTANCE.m3028getOutlineWidthD9Ej5fM();
        if (z) {
            composer.startReplaceGroup(-855870548);
            ComposerKt.sourceInformation(composer, "893@41926L5");
            m3842copywmQWz5c$default = ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-855783004);
            ComposerKt.sourceInformation(composer, "895@42011L5");
            m3842copywmQWz5c$default = Color.m3842copywmQWz5c$default(ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceGroup();
        }
        BorderStroke m266BorderStrokecXLIe8U = BorderStrokeKt.m266BorderStrokecXLIe8U(m3028getOutlineWidthD9Ej5fM, m3842copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        float m6303constructorimpl = Dp.m6303constructorimpl(24);
        ButtonHorizontalPadding = m6303constructorimpl;
        float f = 8;
        float m6303constructorimpl2 = Dp.m6303constructorimpl(f);
        ButtonVerticalPadding = m6303constructorimpl2;
        PaddingValues m680PaddingValuesa9UjIt4 = PaddingKt.m680PaddingValuesa9UjIt4(m6303constructorimpl, m6303constructorimpl2, m6303constructorimpl, m6303constructorimpl2);
        ContentPadding = m680PaddingValuesa9UjIt4;
        float f2 = 16;
        float m6303constructorimpl3 = Dp.m6303constructorimpl(f2);
        ButtonWithIconHorizontalStartPadding = m6303constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m680PaddingValuesa9UjIt4(m6303constructorimpl3, m6303constructorimpl2, m6303constructorimpl, m6303constructorimpl2);
        float m6303constructorimpl4 = Dp.m6303constructorimpl(12);
        TextButtonHorizontalPadding = m6303constructorimpl4;
        TextButtonContentPadding = PaddingKt.m680PaddingValuesa9UjIt4(m6303constructorimpl4, m680PaddingValuesa9UjIt4.getTop(), m6303constructorimpl4, m680PaddingValuesa9UjIt4.getBottom());
        float m6303constructorimpl5 = Dp.m6303constructorimpl(f2);
        TextButtonWithIconHorizontalEndPadding = m6303constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m680PaddingValuesa9UjIt4(m6303constructorimpl4, m680PaddingValuesa9UjIt4.getTop(), m6303constructorimpl5, m680PaddingValuesa9UjIt4.getBottom());
        MinWidth = Dp.m6303constructorimpl(58);
        MinHeight = Dp.m6303constructorimpl(40);
        IconSize = FilledButtonTokens.INSTANCE.m2928getIconSizeD9Ej5fM();
        IconSpacing = Dp.m6303constructorimpl(f);
    }
}
