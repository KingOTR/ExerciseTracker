...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        ...
        if (z3) {
            ...
            m117animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m3833boximpl(j2), composer, 0);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-828241443);
            ComposerKt.sourceInformation(composer, "917@44710L88");
            m117animateColorAsStateeuL9pac = SingleValueAnimationKt.m117animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (z) {
            m3878getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            m3878getTransparent0d7_KjU = Color.INSTANCE.m3878getTransparent0d7_KjU();
        }
        long j = m3878getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceGroup(-217363149);
            ComposerKt.sourceInformation(composer, "941@45516L88");
            rememberUpdatedState = SingleValueAnimationKt.m117animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-217247953);
            ComposerKt.sourceInformation(composer, "943@45634L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3833boximpl(j), composer, 0);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        State<Color> m117animateColorAsStateeuL9pac = SingleValueAnimationKt.m117animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            m3878getTransparent0d7_KjU = z2 ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor;
        } else {
            m3878getTransparent0d7_KjU = Color.INSTANCE.m3878getTransparent0d7_KjU();
        }
        State<Color> m117animateColorAsStateeuL9pac = SingleValueAnimationKt.m117animateColorAsStateeuL9pac(m3878getTransparent0d7_KjU, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m3844equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m3844equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m3844equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m3844equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m3844equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m3844equalsimpl0(this.disabledYearContentColor, datePickerColors.disabledYearContentColor) && Color.m3844equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m3844equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m3844equalsimpl0(this.disabledSelectedYearContentColor, datePickerColors.disabledSelectedYearContentColor) && Color.m3844equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m3844equalsimpl0(this.disabledSelectedYearContainerColor, datePickerColors.disabledSelectedYearContainerColor) && Color.m3844equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m3844equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m3844equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m3844equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m3844equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m3844equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m3844equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m3844equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m3844equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m3844equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m3850hashCodeimpl(this.containerColor) * 31) + Color.m3850hashCodeimpl(this.titleContentColor)) * 31) + Color.m3850hashCodeimpl(this.headlineContentColor)) * 31) + Color.m3850hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m3850hashCodeimpl(this.subheadContentColor)) * 31) + Color.m3850hashCodeimpl(this.yearContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledYearContentColor)) * 31) + Color.m3850hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m3850hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledSelectedYearContentColor)) * 31) + Color.m3850hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledSelectedYearContainerColor)) * 31) + Color.m3850hashCodeimpl(this.dayContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m3850hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m3850hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m3850hashCodeimpl(this.todayContentColor)) * 31) + Color.m3850hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m3850hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m3850hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
