...
public final class SegmentedButtonColors {
    ...
    public final long m2117borderColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeBorderColor;
        }
        if (enabled && !active) {
    ...
    public final long m2119contentColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
        if (enabled && checked) {
            return this.activeContentColor;
        }
        if (enabled && !checked) {
    ...
    public final long m2118containerColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeContainerColor;
        }
        if (enabled && !active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.activeBorderColor, segmentedButtonColors.activeBorderColor) && Color.m3844equalsimpl0(this.activeContentColor, segmentedButtonColors.activeContentColor) && Color.m3844equalsimpl0(this.activeContainerColor, segmentedButtonColors.activeContainerColor) && Color.m3844equalsimpl0(this.inactiveBorderColor, segmentedButtonColors.inactiveBorderColor) && Color.m3844equalsimpl0(this.inactiveContentColor, segmentedButtonColors.inactiveContentColor) && Color.m3844equalsimpl0(this.inactiveContainerColor, segmentedButtonColors.inactiveContainerColor) && Color.m3844equalsimpl0(this.disabledActiveBorderColor, segmentedButtonColors.disabledActiveBorderColor) && Color.m3844equalsimpl0(this.disabledActiveContentColor, segmentedButtonColors.disabledActiveContentColor) && Color.m3844equalsimpl0(this.disabledActiveContainerColor, segmentedButtonColors.disabledActiveContainerColor) && Color.m3844equalsimpl0(this.disabledInactiveBorderColor, segmentedButtonColors.disabledInactiveBorderColor) && Color.m3844equalsimpl0(this.disabledInactiveContentColor, segmentedButtonColors.disabledInactiveContentColor) && Color.m3844equalsimpl0(this.disabledInactiveContainerColor, segmentedButtonColors.disabledInactiveContainerColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m3850hashCodeimpl(this.activeBorderColor) * 31) + Color.m3850hashCodeimpl(this.activeContentColor)) * 31) + Color.m3850hashCodeimpl(this.activeContainerColor)) * 31) + Color.m3850hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m3850hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m3850hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m3850hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m3850hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledInactiveContainerColor);
    }
}
