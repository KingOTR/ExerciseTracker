...
public final class SliderColors {
    ...
    public final SliderColors m2156copyK518z4(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor) {
    ...
    public final long m2167thumbColorvNxB06k$material3_release(boolean enabled) {
        return enabled ? this.thumbColor : this.disabledThumbColor;
    }

    /* renamed from: trackColor-WaAFU9c$material3_release, reason: not valid java name */
    public final long m2169trackColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public final long m2168tickColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m3844equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m3844equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m3844equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m3844equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m3844equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m3844equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m3844equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m3844equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m3844equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m3850hashCodeimpl(this.thumbColor) * 31) + Color.m3850hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3850hashCodeimpl(this.activeTickColor)) * 31) + Color.m3850hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3850hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3850hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3850hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3850hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3850hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3850hashCodeimpl(this.disabledInactiveTickColor);
    }
}
