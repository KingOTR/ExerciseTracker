...
final class TopIconOrIconOnlyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureResult m2000placeIconX9ElhV4;
        MeasureResult m2002placeLabelAndTopIconqoqLrGI;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                float f = 2;
                Placeable mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(ConstraintsKt.m6275offsetNN6EwU(m6247copyZbe2FdA$default, -measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorVerticalPadding * f))));
                int width = mo5179measureBRTryo0.getWidth() + measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorHorizontalPadding * f));
                int height = mo5179measureBRTryo0.getHeight() + measureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(this.indicatorVerticalPadding * f));
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                        Placeable mo5179measureBRTryo02 = measurable2.mo5179measureBRTryo0(ConstraintsKt.m6271constrainN9IONVI(m6247copyZbe2FdA$default, Constraints.INSTANCE.m6266fixedJhjzzOo(width, height)));
                        int size3 = list.size();
                        for (int i3 = 0; i3 < size3; i3++) {
                            Measurable measurable3 = list.get(i3);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicator")) {
                                Placeable mo5179measureBRTryo03 = measurable3.mo5179measureBRTryo0(ConstraintsKt.m6271constrainN9IONVI(m6247copyZbe2FdA$default, Constraints.INSTANCE.m6266fixedJhjzzOo(roundToInt, height)));
                                if (!this.hasLabel) {
                                    m2000placeIconX9ElhV4 = NavigationItemKt.m2000placeIconX9ElhV4(measureScope, mo5179measureBRTryo0, mo5179measureBRTryo02, mo5179measureBRTryo03, j);
                                    return m2000placeIconX9ElhV4;
                                }
                                int size4 = list.size();
                                for (int i4 = 0; i4 < size4; i4++) {
                                    Measurable measurable4 = list.get(i4);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "label")) {
                                        m2002placeLabelAndTopIconqoqLrGI = NavigationItemKt.m2002placeLabelAndTopIconqoqLrGI(measureScope, measurable4.mo5179measureBRTryo0(ConstraintsKt.m6276offsetNN6EwU$default(m6247copyZbe2FdA$default, 0, -(mo5179measureBRTryo03.getHeight() + measureScope.mo370roundToPx0680j_4(this.indicatorToLabelVerticalPadding)), 1, null)), mo5179measureBRTryo0, mo5179measureBRTryo02, mo5179measureBRTryo03, j, this.indicatorToLabelVerticalPadding, this.indicatorVerticalPadding, this.topIconItemVerticalPadding);
                                        return m2002placeLabelAndTopIconqoqLrGI;
                                    }
                                }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "icon")) {
                ...
                float f = 2;
                return maxIntrinsicHeight + maxIntrinsicHeight2 + intrinsicMeasureScope.mo370roundToPx0680j_4(Dp.m6303constructorimpl(Dp.m6303constructorimpl(Dp.m6303constructorimpl(this.topIconItemVerticalPadding * f) + Dp.m6303constructorimpl(this.indicatorVerticalPadding * f)) + this.indicatorToLabelVerticalPadding));
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
