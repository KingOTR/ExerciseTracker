...
public final class TimePickerDefaults {
    ...
    public final TimePickerColors m2400colorsu3YEpmA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, Composer composer, int i, int i2, int i3) {
        long j15;
        ...
        long m3879getUnspecified0d7_KjU14 = (i3 & 8192) != 0 ? Color.INSTANCE.m3879getUnspecified0d7_KjU() : j14;
        if (ComposerKt.isTraceInProgress()) {
            j15 = m3879getUnspecified0d7_KjU3;
            ComposerKt.traceEventStart(-646352288, i, i2, "androidx.compose.material3.TimePickerDefaults.colors (TimePicker.kt:317)");
        } else {
            j15 = m3879getUnspecified0d7_KjU3;
        }
        TimePickerColors m2381copydVHXu7A = getDefaultTimePickerColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2381copydVHXu7A(m3879getUnspecified0d7_KjU, m3879getUnspecified0d7_KjU4, m3879getUnspecified0d7_KjU5, m3879getUnspecified0d7_KjU6, m3879getUnspecified0d7_KjU2, j15, m3879getUnspecified0d7_KjU7, m3879getUnspecified0d7_KjU8, m3879getUnspecified0d7_KjU9, m3879getUnspecified0d7_KjU10, m3879getUnspecified0d7_KjU11, m3879getUnspecified0d7_KjU12, m3879getUnspecified0d7_KjU13, m3879getUnspecified0d7_KjU14);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2381copydVHXu7A;
    }
    ...
    public final int m2401layoutTypesDNSZnc(Composer composer, int i) {
