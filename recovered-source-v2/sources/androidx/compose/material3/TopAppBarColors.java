...
public final class TopAppBarColors {
    ...
    public final TopAppBarColors m2533copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
    ...
    public final long m2532containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m3894lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m3844equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m3844equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m3844equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m3844equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m3850hashCodeimpl(this.containerColor) * 31) + Color.m3850hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m3850hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m3850hashCodeimpl(this.titleContentColor)) * 31) + Color.m3850hashCodeimpl(this.actionIconContentColor);
    }
}
