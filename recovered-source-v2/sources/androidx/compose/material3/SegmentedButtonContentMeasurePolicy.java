...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo632measure3p2s80s(final MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        Object obj;
        Object obj2;
        Object obj3;
        float f;
        ...
        for (int i3 = 0; i3 < size; i3++) {
            arrayList.add(list2.get(i3).mo5179measureBRTryo0(j));
        }
        ...
        for (int i5 = 0; i5 < size2; i5++) {
            arrayList3.add(list3.get(i5).mo5179measureBRTryo0(j));
        }
        ...
        int max = Math.max(measureScope.mo370roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2137getIconSizeD9Ej5fM()), width3);
        f = SegmentedButtonKt.IconSpacing;
        int i7 = max + measureScope.mo370roundToPx0680j_4(f) + (valueOf != null ? valueOf.intValue() : 0);
        if (width3 == 0) {
            int i8 = measureScope.mo370roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2137getIconSizeD9Ej5fM());
            f2 = SegmentedButtonKt.IconSpacing;
            i = (-(i8 + measureScope.mo370roundToPx0680j_4(f2))) / 2;
        }
        ...
        return MeasureScope.layout$default(measureScope, i7, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SegmentedButtonContentMeasurePolicy$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                for (int i11 = 0; i11 < size3; i11++) {
                    Placeable placeable4 = list4.get(i11);
                    Placeable.PlacementScope.place$default(placementScope, placeable4, 0, (i10 - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
                int i12 = measureScope.mo370roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2137getIconSizeD9Ej5fM());
                MeasureScope measureScope2 = measureScope;
                f3 = SegmentedButtonKt.IconSpacing;
                int i13 = i12 + measureScope2.mo370roundToPx0680j_4(f3);
                Animatable<Integer, AnimationVector1D> animatable2 = this.getAnimatable();
                int intValue = i13 + (animatable2 != null ? animatable2.getValue().intValue() : i);
                List<Placeable> list5 = arrayList4;
                int i14 = i9;
                int size4 = list5.size();
                for (int i15 = 0; i15 < size4; i15++) {
                    Placeable placeable5 = list5.get(i15);
                    Placeable.PlacementScope.place$default(placementScope, placeable5, intValue, (i14 - placeable5.getHeight()) / 2, 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
