...
public final class IconToggleButtonColors {
    ...
    public final IconToggleButtonColors m1837copytNS2XkQ(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor) {
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3833boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3844equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m3844equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m3844equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m3844equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m3844equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m3844equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m3850hashCodeimpl(this.containerColor) * 31) + Color.m3850hashCodeimpl(this.contentColor)) * 31) + Color.m3850hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3850hashCodeimpl(this.disabledContentColor)) * 31) + Color.m3850hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m3850hashCodeimpl(this.checkedContentColor);
    }
}
