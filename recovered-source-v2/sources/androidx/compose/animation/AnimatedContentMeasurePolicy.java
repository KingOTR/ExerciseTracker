    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                ...
                placeableArr[i3] = mo5179measureBRTryo0;
                m6478getZeroYbymL2g = IntSize;
            }
            i3++;
        }
        int size3 = list.size();
        for (int i4 = 0; i4 < size3; i4++) {
            ...
            if (placeableArr[i4] == null) {
                placeableArr[i4] = measurable2.mo5179measureBRTryo0(j);
            }
        }
        if (measureScope.isLookingAhead()) {
            width = IntSize.m6473getWidthimpl(m6478getZeroYbymL2g);
        } else {
            if (size == 0) {
                placeable2 = null;
            } else {
            ...
            if (placeable2 == null) {
                ...
                if (measureScope.isLookingAhead()) {
                    ...
                    i2 = IntSize.m6472getHeightimpl(m6478getZeroYbymL2g);
                }
                final int i5 = i2;
                if (!measureScope.isLookingAhead()) {
                    this.rootScope.m66setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(i, i5));
                }
                return MeasureScope.layout$default(measureScope, i, i5, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
                    ...
                    public final void invoke2(Placeable.PlacementScope placementScope) {
                        ...
                        for (Placeable placeable5 : placeableArr2) {
                            if (placeable5 != null) {
                                long mo3448alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo3448alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i6, i7), LayoutDirection.Ltr);
                                Placeable.PlacementScope.place$default(placementScope, placeable5, IntOffset.m6431getXimpl(mo3448alignKFBX0sM), IntOffset.m6432getYimpl(mo3448alignKFBX0sM), 0.0f, 4, null);
                            }
                        }
                    }
                }, 4, null);
        ...
        return MeasureScope.layout$default(measureScope, i, i52, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
