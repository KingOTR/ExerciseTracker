...
public final class SharedBoundsNode extends Modifier.Node implements ApproachLayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final long Size = SizeKt.Size(mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight());
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (coordinates != null) {
                    ...
                    long mo5188localPositionOfR5De75A = rootLookaheadCoords.mo5188localPositionOfR5De75A(coordinates, Offset.INSTANCE.m3618getZeroF1C5BW0());
                    ...
                    if (sharedElement2.getCurrentBounds() == null) {
                        ...
                        sharedElement3.setCurrentBounds(RectKt.m3642Recttz77jQw(mo5188localPositionOfR5De75A, j2));
                    }
                    offset = Offset.m3591boximpl(mo5188localPositionOfR5De75A);
                } else {
                    offset = null;
                }
                ...
                if (offset != null) {
                    ...
                    sharedElement.m108onLookaheadResultv_w8tDc(sharedBoundsNode2.getState(), j3, packedValue);
                }
            }
        }, 4, null);
    }
    ...
    private final MeasureResult place(MeasureScope measureScope, final Placeable placeable) {
        long mo111calculateSizeJyjRU_E = this.state.getPlaceHolderSize().mo111calculateSizeJyjRU_E(requireLookaheadLayoutCoordinates().mo5187getSizeYbymL2g(), IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()));
        return MeasureScope.layout$default(measureScope, IntSize.m6473getWidthimpl(mo111calculateSizeJyjRU_E), IntSize.m6472getHeightimpl(mo111calculateSizeJyjRU_E), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$place$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (sharedElement.getFoundMatch()) {
                    ...
                    if (coordinates2 != null) {
                        ...
                        offset = Offset.m3591boximpl(rootCoords.mo5188localPositionOfR5De75A(coordinates2, Offset.INSTANCE.m3618getZeroF1C5BW0()));
                    } else {
                        offset = null;
                    }
                    if (value != null) {
                        ...
                        m3637getTopLeftF1C5BW0 = value.m3637getTopLeftF1C5BW0();
                    } else {
                        ...
                        m3637getTopLeftF1C5BW0 = currentBounds2.m3637getTopLeftF1C5BW0();
                    }
                    long m3606minusMKHz9U = offset != null ? Offset.m3606minusMKHz9U(m3637getTopLeftF1C5BW0, offset.getPackedValue()) : Offset.INSTANCE.m3618getZeroF1C5BW0();
                    Placeable.PlacementScope.place$default(placementScope, placeable, Math.round(Offset.m3602getXimpl(m3606minusMKHz9U)), Math.round(Offset.m3603getYimpl(m3606minusMKHz9U)), 0.0f, 4, null);
                    return;
                }
    ...
    public boolean mo107isMeasurementApproachInProgressozmzZPI(long lookaheadSize) {
        return getSharedElement().getFoundMatch() && this.state.getSharedElement().getScope().isTransitionActive();
    }

    @Override // androidx.compose.ui.layout.ApproachLayoutModifierNode
    /* renamed from: approachMeasure-3p2s80s, reason: not valid java name */
    public MeasureResult mo106approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
        if (getSharedElement().getFoundMatch()) {
            ...
            if (value != null) {
                long m6481roundToIntSizeuvyYCjk = IntSizeKt.m6481roundToIntSizeuvyYCjk(value.m3635getSizeNHjbRc());
                int m6473getWidthimpl = IntSize.m6473getWidthimpl(m6481roundToIntSizeuvyYCjk);
                int m6472getHeightimpl = IntSize.m6472getHeightimpl(m6481roundToIntSizeuvyYCjk);
                if (m6473getWidthimpl == Integer.MAX_VALUE || m6472getHeightimpl == Integer.MAX_VALUE) {
                ...
                j = Constraints.INSTANCE.m6266fixedJhjzzOo(RangesKt.coerceAtLeast(m6473getWidthimpl, 0), RangesKt.coerceAtLeast(m6472getHeightimpl, 0));
            }
        }
        return place(approachMeasureScope, measurable.mo5179measureBRTryo0(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateCurrentBounds(LayoutCoordinates layoutCoordinates) {
        getSharedElement().setCurrentBounds(RectKt.m3642Recttz77jQw(getRootCoords().mo5188localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3618getZeroF1C5BW0()), SizeKt.Size(IntSize.m6473getWidthimpl(layoutCoordinates.mo5187getSizeYbymL2g()), IntSize.m6472getHeightimpl(layoutCoordinates.mo5187getSizeYbymL2g()))));
    }
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m4397recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$draw$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
