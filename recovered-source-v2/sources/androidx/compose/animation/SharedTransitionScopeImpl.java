...
public final class SharedTransitionScopeImpl implements SharedTransitionScope, LookaheadScope {
    ...
    public long mo112localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        return this.$$delegate_0.mo112localLookaheadPositionOfauaQtc(layoutCoordinates, layoutCoordinates2, j, z);
    }
    ...
    private static final class ShapeBasedClip implements SharedTransitionScope.OverlayClip {
        ...
        public Path getClipPath(SharedTransitionScope.SharedContentState state, Rect bounds, LayoutDirection layoutDirection, Density density) {
            this.path.reset();
            OutlineKt.addOutline(this.path, this.clipShape.mo287createOutlinePq9zytI(bounds.m3635getSizeNHjbRc(), layoutDirection, density));
            this.path.mo3738translatek4lQ0M(bounds.m3637getTopLeftF1C5BW0());
            return this.path;
        }
    }
}
