...
public final /* data */ class Scale {
    ...
    public static /* synthetic */ Scale m102copybnNdC4k$default(Scale scale, float f, long j, FiniteAnimationSpec finiteAnimationSpec, int i, Object obj) {
        if ((i & 1) != 0) {
            f = scale.scale;
        }
        if ((i & 2) != 0) {
        ...
        return scale.m104copybnNdC4k(f, j, finiteAnimationSpec);
    }
    ...
    public final Scale m104copybnNdC4k(float scale, long transformOrigin, FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m4228equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }

    public int hashCode() {
        return (((Float.hashCode(this.scale) * 31) + TransformOrigin.m4231hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m4232toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
