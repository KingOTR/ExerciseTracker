...
public final /* data */ class VectorizedKeyframeSpecElementInfo<V extends AnimationVector> {
    ...
    public static /* synthetic */ VectorizedKeyframeSpecElementInfo m206copy2NF0KzA$default(VectorizedKeyframeSpecElementInfo vectorizedKeyframeSpecElementInfo, AnimationVector animationVector, Easing easing, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return vectorizedKeyframeSpecElementInfo.m208copy2NF0KzA(animationVector, easing, i);
    }
    ...
    public final VectorizedKeyframeSpecElementInfo<V> m208copy2NF0KzA(V vectorValue, Easing easing, int arcMode) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.vectorValue, vectorizedKeyframeSpecElementInfo.vectorValue) && Intrinsics.areEqual(this.easing, vectorizedKeyframeSpecElementInfo.easing) && ArcMode.m149equalsimpl0(this.arcMode, vectorizedKeyframeSpecElementInfo.arcMode);
    }

    public int hashCode() {
        return (((this.vectorValue.hashCode() * 31) + this.easing.hashCode()) * 31) + ArcMode.m150hashCodeimpl(this.arcMode);
    }

    public String toString() {
        return "VectorizedKeyframeSpecElementInfo(vectorValue=" + this.vectorValue + ", easing=" + this.easing + ", arcMode=" + ((Object) ArcMode.m151toStringimpl(this.arcMode)) + ')';
    }
    ...
    public final int m209getArcMode9TMq4() {
        return this.arcMode;
    }
}
