...
public final class DeferredTargetAnimation<T, V extends AnimationVector> {
    ...
    public final T updateTarget(T target, CoroutineScope coroutineScope, FiniteAnimationSpec<T> animationSpec) {
        ...
        Animatable<T, V> animatable = this.animatable;
        if (animatable == null) {
            animatable = new Animatable<>(target, this.vectorConverter, null, null, 12, null);
            this.animatable = animatable;
        }
        Animatable<T, V> animatable2 = animatable;
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new DeferredTargetAnimation$updateTarget$1(animatable2, this, target, animationSpec, null), 3, null);
