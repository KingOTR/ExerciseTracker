...
public final class VectorizedKeyframesSpec<V extends AnimationVector> implements VectorizedDurationBasedAnimationSpec<V> {
    ...
    */
    public VectorizedKeyframesSpec(Map<Integer, ? extends Pair<? extends V, ? extends Easing>> map, int i, int i2) {
        this(r4, r0, i, i2, EasingKt.getLinearEasing(), ArcMode.INSTANCE.m155getArcLinear9TMq4(), null);
        ...
        for (Map.Entry<Integer, ? extends Pair<? extends V, ? extends Easing>> entry : map.entrySet()) {
            ...
            mutableIntObjectMap.set(intValue, new VectorizedKeyframeSpecElementInfo(value.getFirst(), value.getSecond(), ArcMode.INSTANCE.m155getArcLinear9TMq4(), null));
        }
    }
    ...
    private final void init(V initialValue, V targetValue, V initialVelocity) {
        ...
        if (this.valueVector == null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                int m209getArcMode9TMq4 = vectorizedKeyframeSpecElementInfo != null ? vectorizedKeyframeSpecElementInfo.m209getArcMode9TMq4() : this.initialArcMode;
                if (!ArcMode.m149equalsimpl0(m209getArcMode9TMq4, ArcMode.INSTANCE.m155getArcLinear9TMq4())) {
                    z = true;
                }
                iArr[i2] = m209getArcMode9TMq4;
            }
            this.modes = iArr;
        }
        if (z) {
