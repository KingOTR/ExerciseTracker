    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (((Boolean) hasNext).booleanValue()) {
                Object next = it.next();
                Object m9429getOrNullimpl = ChannelResult.m9429getOrNullimpl(this.$channel.mo9417tryReceivePtdJZtk());
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(m9429getOrNullimpl == null ? next : m9429getOrNullimpl, this.$animatable, this.$animSpec$delegate, this.$listener$delegate, null), 3, null);
                this.L$0 = coroutineScope;
                this.L$1 = it;
                this.label = 1;
                hasNext = it.hasNext(this);
