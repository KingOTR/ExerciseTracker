...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public final AnimData m123copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m6471equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m6474hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m6476toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo94measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        Placeable mo5179measureBRTryo0;
        long m6270constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m118setLookaheadConstraintsBRTryo0(j);
            mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(j);
        } else {
            mo5179measureBRTryo0 = measurable.mo5179measureBRTryo0(m119targetConstraintsZezNO4M(j));
        }
        ...
        if (measureScope.isLookingAhead()) {
            ...
            m6270constrain4WqzIAM = IntSize;
        } else {
            m6270constrain4WqzIAM = ConstraintsKt.m6270constrain4WqzIAM(j, m120animateTomzRDjE0(AnimationModifierKt.m71isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : IntSize));
        }
        final int m6473getWidthimpl = IntSize.m6473getWidthimpl(m6270constrain4WqzIAM);
        final int m6472getHeightimpl = IntSize.m6472getHeightimpl(m6270constrain4WqzIAM);
        return MeasureScope.layout$default(measureScope, m6473getWidthimpl, m6472getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5243place70tqf50$default(placementScope, placeable, SizeAnimationModifierNode.this.getAlignment().mo3448alignKFBX0sM(IntSize, IntSizeKt.IntSize(m6473getWidthimpl, m6472getHeightimpl), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m120animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m6471equalsimpl0(targetSize, animData.getAnim().getValue().getPackedValue()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m6471equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue()) || z) {
                animData.m125setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
            ...
            animData = new AnimData(new Animatable(IntSize.m6465boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m6465boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
