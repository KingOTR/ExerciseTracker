...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset m3591boximpl = currentBounds != null ? Offset.m3591boximpl(currentBounds.m3637getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(m3591boximpl);
            long packedValue = m3591boximpl.getPackedValue();
            float m3602getXimpl = Offset.m3602getXimpl(packedValue);
            float m3603getYimpl = Offset.m3603getYimpl(packedValue);
    ...
    public final long m110getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m6485toSizeozmzZPI(invoke.mo5187getSizeYbymL2g());
    }
    ...
    public final long m109calculateLookaheadOffsetF1C5BW0() {
        LayoutCoordinates invoke = this.lookaheadCoords.invoke();
        if (invoke == null) {
            throw new IllegalArgumentException("Error: lookahead coordinates is null.".toString());
        }
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5188localPositionOfR5De75A(invoke, Offset.INSTANCE.m3618getZeroF1C5BW0());
    }
