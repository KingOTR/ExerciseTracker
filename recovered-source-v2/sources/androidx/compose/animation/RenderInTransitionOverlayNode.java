...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    private final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) {
            if (RenderInTransitionOverlayNode.this.getRenderInOverlay().invoke().booleanValue()) {
                ...
                long mo5188localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo5188localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode2), Offset.INSTANCE.m3618getZeroF1C5BW0());
                float m3602getXimpl = Offset.m3602getXimpl(mo5188localPositionOfR5De75A);
                float m3603getYimpl = Offset.m3603getYimpl(mo5188localPositionOfR5De75A);
                ...
                if (invoke != null) {
                    ...
                    try {
                        drawContext.getTransform().mo4322clipPathmtrdDE(invoke, m3832getIntersectrtfAjoo);
                        drawScope.getDrawContext().getTransform().translate(m3602getXimpl, m3603getYimpl);
                        try {
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m4397recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode$draw$1
            {
                super(1);
            }
