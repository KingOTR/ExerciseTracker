...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6465boximpl(IntSize.INSTANCE.m6478getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo44slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m63isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                int m6473getWidthimpl = IntSize.m6473getWidthimpl(m62getCurrentSizeYbymL2g);
                ...
                m61calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m61calculateOffsetemnUabE(IntSize, m62getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m6473getWidthimpl - IntOffset.m6431getXimpl(m61calculateOffsetemnUabE)));
            }
        }) : m64isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                ...
                long IntSize = IntSizeKt.IntSize(i, i);
                m62getCurrentSizeYbymL2g = this.m62getCurrentSizeYbymL2g();
                m61calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m61calculateOffsetemnUabE(IntSize, m62getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m6431getXimpl(m61calculateOffsetemnUabE)) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m58getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m62getCurrentSizeYbymL2g = this.m62getCurrentSizeYbymL2g();
                int m6472getHeightimpl = IntSize.m6472getHeightimpl(m62getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(i, i);
                m62getCurrentSizeYbymL2g2 = this.m62getCurrentSizeYbymL2g();
                m61calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m61calculateOffsetemnUabE(IntSize, m62getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m6472getHeightimpl - IntOffset.m6432getYimpl(m61calculateOffsetemnUabE)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m53getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                ...
                m62getCurrentSizeYbymL2g = this.m62getCurrentSizeYbymL2g();
                m61calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m61calculateOffsetemnUabE(IntSize, m62getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m6432getYimpl(m61calculateOffsetemnUabE)) - i));
            }
    ...
    public final long m61calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3448alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }
    ...
    public ExitTransition mo45slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m63isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6478getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m61calculateOffsetemnUabE = this.this$0.m61calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m6431getXimpl(m61calculateOffsetemnUabE)) - i));
            }
        }) : m64isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m61calculateOffsetemnUabE = this.this$0.m61calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m6431getXimpl(m61calculateOffsetemnUabE)) + IntSize.m6473getWidthimpl(packedValue)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m58getUpDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m61calculateOffsetemnUabE = this.this$0.m61calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m6432getYimpl(m61calculateOffsetemnUabE)) + IntSize.m6472getHeightimpl(packedValue)));
            }
    ...
    public final void m66setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m6465boximpl(j));
    }
    ...
    public final long m62getCurrentSizeYbymL2g() {
        ...
        return state != null ? state.getValue().getPackedValue() : m65getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    public final Modifier createSizeAnimationModifier$animation_release(ContentTransform contentTransform, Composer composer, int i) {
        ...
        if (createSizeAnimationModifier$lambda$2(mutableState)) {
            ...
            Transition.DeferredAnimation createDeferredAnimation = androidx.compose.animation.core.TransitionKt.createDeferredAnimation(this.transition, VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), null, composer, 0, 2);
        ...
        public MeasureResult mo67measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    ...
                    long packedValue2 = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6478getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long packedValue3 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m6478getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo126createAnimationSpecTemP2vQ = value.mo126createAnimationSpecTemP2vQ(packedValue2, packedValue3)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo126createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m6465boximpl(m68invokeYEO4UFw(obj));
                }
                ...
                public final long m68invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6478getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(animate);
            if (measureScope.isLookingAhead()) {
                packedValue = IntSizeKt.IntSize(mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight());
            } else {
                packedValue = animate.getValue().getPackedValue();
            }
            int m6473getWidthimpl = IntSize.m6473getWidthimpl(packedValue);
            int m6472getHeightimpl = IntSize.m6472getHeightimpl(packedValue);
            final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl3 = AnimatedContentTransitionScopeImpl.this;
            return MeasureScope.layout$default(measureScope, m6473getWidthimpl, m6472getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m5243place70tqf50$default(placementScope, mo5179measureBRTryo0, animatedContentTransitionScopeImpl3.getContentAlignment().mo3448alignKFBX0sM(IntSizeKt.IntSize(mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight()), packedValue, LayoutDirection.Ltr), 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
