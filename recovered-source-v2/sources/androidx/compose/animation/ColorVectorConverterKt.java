        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m73invoke8_81llA(color.m3853unboximpl());
                }

                /* renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m73invoke8_81llA(long j) {
                    long m3840convertvNxB06k = Color.m3840convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m3845getAlphaimpl(m3840convertvNxB06k), Color.m3849getRedimpl(m3840convertvNxB06k), Color.m3848getGreenimpl(m3840convertvNxB06k), Color.m3846getBlueimpl(m3840convertvNxB06k));
                }
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m3833boximpl(m74invokevNxB06k(animationVector4D));
                }

                /* renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m74invokevNxB06k(AnimationVector4D animationVector4D) {
                    ...
                    return Color.m3840convertvNxB06k(ColorKt.Color(v2, v3, f2, f3 <= 1.0f ? f3 : 1.0f, ColorSpaces.INSTANCE.getOklab()), ColorSpace.this);
                }
            });
        }
    };
