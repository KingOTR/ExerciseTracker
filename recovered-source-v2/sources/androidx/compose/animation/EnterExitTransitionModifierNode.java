...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m93setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m95sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i == 2) {
            ChangeSize changeSize = this.enter.getData().getChangeSize();
            return (changeSize == null || (size = changeSize.getSize()) == null) ? fullSize : size.invoke(IntSize.m6465boximpl(fullSize)).getPackedValue();
        }
        if (i != 3) {
            throw new NoWhenBranchMatchedException();
        }
        ChangeSize changeSize2 = this.exit.getData().getChangeSize();
        return (changeSize2 == null || (size2 = changeSize2.getSize()) == null) ? fullSize : size2.invoke(IntSize.m6465boximpl(fullSize)).getPackedValue();
    }
    ...
    public final long m97targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m6441getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m6441getZeronOccac();
            }
            ...
            if (changeSize != null) {
                long packedValue = changeSize.getSize().invoke(IntSize.m6465boximpl(fullSize)).getPackedValue();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long mo3448alignKFBX0sM = alignment.mo3448alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m6434minusqkQi6aY(mo3448alignKFBX0sM, alignment2.mo3448alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m6441getZeronOccac();
        }
        return IntOffset.INSTANCE.m6441getZeronOccac();
    ...
    public MeasureResult mo94measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long IntSize = IntSizeKt.IntSize(mo5179measureBRTryo0.getWidth(), mo5179measureBRTryo0.getHeight());
            this.lookaheadSize = IntSize;
            m93setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, IntSize.m6473getWidthimpl(IntSize), IntSize.m6472getHeightimpl(IntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable mo5179measureBRTryo02 = measurable.mo5179measureBRTryo0(j);
            long IntSize2 = IntSizeKt.IntSize(mo5179measureBRTryo02.getWidth(), mo5179measureBRTryo02.getHeight());
            final long j2 = AnimationModifierKt.m71isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : IntSize2;
            ...
            State<IntSize> animate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m6465boximpl(m98invokeYEO4UFw(enterExitState));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m98invokeYEO4UFw(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m95sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (animate3 != null) {
                IntSize2 = animate3.getValue().getPackedValue();
            }
            long m6270constrain4WqzIAM = ConstraintsKt.m6270constrain4WqzIAM(j, IntSize2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            final long m6441getZeronOccac = (deferredAnimation2 == null || (animate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    SpringSpec springSpec;
                    springSpec = EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m6422boximpl(m99invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m99invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m97targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m6441getZeronOccac() : animate2.getValue().getPackedValue();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long m6441getZeronOccac2 = (deferredAnimation3 == null || (animate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m6422boximpl(m100invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m100invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m96slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m6441getZeronOccac() : animate.getValue().getPackedValue();
            Alignment alignment2 = this.currentAlignment;
            final long m6435plusqkQi6aY = IntOffset.m6435plusqkQi6aY(alignment2 != null ? alignment2.mo3448alignKFBX0sM(j2, m6270constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m6441getZeronOccac(), m6441getZeronOccac2);
            return MeasureScope.layout$default(measureScope, IntSize.m6473getWidthimpl(m6270constrain4WqzIAM), IntSize.m6472getHeightimpl(m6270constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(Placeable.this, IntOffset.m6431getXimpl(m6441getZeronOccac) + IntOffset.m6431getXimpl(m6435plusqkQi6aY), IntOffset.m6432getYimpl(m6441getZeronOccac) + IntOffset.m6432getYimpl(m6435plusqkQi6aY), 0.0f, init);
                }
            }, 4, null);
        }
        final Placeable mo5179measureBRTryo03 = measurable.mo5179measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, mo5179measureBRTryo03.getWidth(), mo5179measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            {
                super(1);
            }
    ...
    public final long m96slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long m6441getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6441getZeronOccac() : slideOffset2.invoke(IntSize.m6465boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long m6441getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6441getZeronOccac() : slideOffset.invoke(IntSize.m6465boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m6441getZeronOccac();
        }
        if (i == 2) {
            return m6441getZeronOccac;
        }
        if (i == 3) {
            return m6441getZeronOccac2;
        }
        throw new NoWhenBranchMatchedException();
    }
}
