...
public abstract class Operation {
    ...
    public String mo3348intParamNamew8GmfQM(int parameter) {
        return "IntParameter(" + parameter + ')';
    }

    /* renamed from: objectParamName-31yXWZQ, reason: not valid java name */
    public String mo3349objectParamName31yXWZQ(int parameter) {
    ...
    /* compiled from: Operation.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0087@\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u000b\u0010\fJ\u0010\u0010\r\u001a\u00020\u0003HÖ\u0001¢\u0006\u0004\b\u000e\u0010\u0005J\u0010\u0010\u000f\u001a\u00020\u0010HÖ\u0001¢\u0006\u0004\b\u0011\u0010\u0012R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u0088\u0001\u0002¨\u0006\u0013"}, d2 = {"Landroidx/compose/runtime/changelist/Operation$IntParameter;", "", "offset", "", "constructor-impl", "(I)I", "getOffset", "()I", "equals", "", Vo2MaxRecord.MeasurementMethod.OTHER, "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", "toString", "", "toString-impl", "(I)Ljava/lang/String;", "runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @JvmInline
    public static final class IntParameter {
        private final int offset;

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ IntParameter m3375boximpl(int i) {
            return new IntParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m3376constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3377equalsimpl(int i, Object obj) {
            return (obj instanceof IntParameter) && i == ((IntParameter) obj).m3381unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3378equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3379hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3380toStringimpl(int i) {
            return "IntParameter(offset=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m3377equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3379hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3380toStringimpl(this.offset);
        }
    ...
    /* compiled from: Operation.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0087@\u0018\u0000*\u0004\b\u0000\u0010\u00012\u00020\u0002B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u001a\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\u0002HÖ\u0003¢\u0006\u0004\b\f\u0010\rJ\u0010\u0010\u000e\u001a\u00020\u0004HÖ\u0001¢\u0006\u0004\b\u000f\u0010\u0006J\u0010\u0010\u0010\u001a\u00020\u0011HÖ\u0001¢\u0006\u0004\b\u0012\u0010\u0013R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b\u0088\u0001\u0003¨\u0006\u0014"}, d2 = {"Landroidx/compose/runtime/changelist/Operation$ObjectParameter;", ExifInterface.GPS_DIRECTION_TRUE, "", "offset", "", "constructor-impl", "(I)I", "getOffset", "()I", "equals", "", Vo2MaxRecord.MeasurementMethod.OTHER, "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", "toString", "", "toString-impl", "(I)Ljava/lang/String;", "runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @JvmInline
    public static final class ObjectParameter<T> {
        private final int offset;

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ ObjectParameter m3386boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m3387constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3388equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m3392unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3389equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3390hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3391toStringimpl(int i) {
            return "ObjectParameter(offset=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m3388equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3390hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3391toStringimpl(this.offset);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ int m3392unboximpl() {
            return this.offset;
        }
    ...
    public static final class Ups extends Operation {
        ...
        public final int m3411getCountjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3348intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(0)) ? "count" : super.mo3348intParamNamew8GmfQM(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int mo3412getIntw8GmfQM = operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0));
            for (int i = 0; i < mo3412getIntw8GmfQM; i++) {
                applier.up();
            }
        }
    }
    ...
    public static final class Downs extends Operation {
        ...
        */
        ...
        public final int m3363getNodesHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object obj : (Object[]) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0))) {
                applier.down(obj);
            }
        }
        ...
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "nodes" : super.mo3349objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class AdvanceSlotsBy extends Operation {
        ...
        public final int m3350getDistancejn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3348intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(0)) ? "distance" : super.mo3348intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.advanceBy(operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0)));
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        */
        ...
        public final int m3401getEffectHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "effect" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        */
        ...
        public final int m3398getValueHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? Values.VECTOR_MAP_VECTORS_KEY : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.remembering((RememberObserver) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0)));
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        public final int m3351getAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3352getValueHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "anchor" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? Values.VECTOR_MAP_VECTORS_KEY : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Anchor anchor = (Anchor) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
            Object mo3413getObject31yXWZQ = operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            if (mo3413getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) mo3413getObject31yXWZQ).getWrapped());
            }
            slotWriter.appendSlot(anchor, mo3413getObject31yXWZQ);
        }
    }
    ...
    public static final class TrimParentValues extends Operation {
        ...
        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3402getCountjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            for (int max = Math.max(slotsStartIndex$runtime_release, slotsEndIndex$runtime_release - mo3412getIntw8GmfQM); max < slotsEndIndex$runtime_release; max++) {
            ...
            slotWriter.trimTailSlots(mo3412getIntw8GmfQM);
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        */
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3410getValueHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m3409getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3348intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(0)) ? "groupSlotIndex" : super.mo3348intParamNamew8GmfQM(parameter);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object mo3413getObject31yXWZQ = operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
            int mo3412getIntw8GmfQM = operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0));
            if (mo3413getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) mo3413getObject31yXWZQ).getWrapped());
            }
            Object obj = slotWriter.set(mo3412getIntw8GmfQM, mo3413getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting(((RememberObserverHolder) obj).getWrapped(), slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(slotWriter.getCurrentGroup(), mo3412getIntw8GmfQM), -1, -1);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
            }
        }
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3405getValueHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3403getAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m3404getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? Values.VECTOR_MAP_VECTORS_KEY : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "anchor" : super.mo3349objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            int i2;
            Object mo3413getObject31yXWZQ = operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            int mo3412getIntw8GmfQM = operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0));
            if (mo3413getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) mo3413getObject31yXWZQ).getWrapped());
            }
            int anchorIndex = slotWriter.anchorIndex(anchor);
            Object obj = slotWriter.set(anchorIndex, mo3412getIntw8GmfQM, mo3413getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                int slotsSize = slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(anchorIndex, mo3412getIntw8GmfQM);
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        */
        ...
        public final int m3406getDataHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "data" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.updateAux(operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        */
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3366getAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "anchor" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0)));
        }
    }
    ...
    public static final class MoveCurrentGroup extends Operation {
        ...
        public final int m3382getOffsetjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3348intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(0)) ? "offset" : super.mo3348intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.moveGroup(operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m3364getActionHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3365getCompositionHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "anchor" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "composition" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function1) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0))).invoke((Composition) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1)));
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3408getValueHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m3407getBlockHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? Values.VECTOR_MAP_VECTORS_KEY : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "block" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function2) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1))).invoke(applier.getCurrent(), operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0)));
        }
    }
    ...
    public static final class RemoveNode extends Operation {
        ...
        */
        ...
        public final int m3400getRemoveIndexjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3399getCountjn0FJLE() {
            return IntParameter.m3376constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3348intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(0)) ? "removeIndex" : IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(1)) ? "count" : super.mo3348intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.remove(operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0)), operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(1)));
        }
    }

    /* compiled from: Operation.kt */
    @Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÇ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001a\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0004H\u0016ø\u0001\u0000¢\u0006\u0004\b\u000e\u0010\u000fJ(\u0010\u0010\u001a\u00020\u0011*\u00020\u00122\n\u0010\u0013\u001a\u0006\u0012\u0002\b\u00030\u00142\u0006\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u0018H\u0016R\u0018\u0010\u0003\u001a\u00020\u00048Æ\u0002ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006R\u0018\u0010\u0007\u001a\u00020\u00048Æ\u0002ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\u001a\u0004\b\b\u0010\u0006R\u0018\u0010\t\u001a\u00020\u00048Æ\u0002ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\u001a\u0004\b\n\u0010\u0006\u0082\u0002\u000b\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u0019"}, d2 = {"Landroidx/compose/runtime/changelist/Operation$MoveNode;", "Landroidx/compose/runtime/changelist/Operation;", "()V", "Count", "Landroidx/compose/runtime/changelist/Operation$IntParameter;", "getCount-jn0FJLE", "()I", HttpHeaders.FROM, "getFrom-jn0FJLE", "To", "getTo-jn0FJLE", "intParamName", "", "parameter", "intParamName-w8GmfQM", "(I)Ljava/lang/String;", "execute", "", "Landroidx/compose/runtime/changelist/OperationArgContainer;", "applier", "Landroidx/compose/runtime/Applier;", "slots", "Landroidx/compose/runtime/SlotWriter;", "rememberManager", "Landroidx/compose/runtime/RememberManager;", "runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class MoveNode extends Operation {
        ...
        public final int m3384getFromjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }

        /* renamed from: getTo-jn0FJLE, reason: not valid java name */
        public final int m3385getTojn0FJLE() {
            return IntParameter.m3376constructorimpl(1);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3383getCountjn0FJLE() {
            return IntParameter.m3376constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3348intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(0)) ? "from" : IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(1)) ? "to" : IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(2)) ? "count" : super.mo3348intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.move(operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0)), operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(1)), operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(2)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3370getAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3371getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "anchor" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "from" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3372getAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3374getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }

        /* renamed from: getFixups-HpuvwBQ, reason: not valid java name */
        public final int m3373getFixupsHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "anchor" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "from" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(2)) ? "fixups" : super.mo3349objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m3367getFactoryHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3369getInsertIndexjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3368getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3348intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3378equalsimpl0(parameter, IntParameter.m3376constructorimpl(0)) ? "insertIndex" : super.mo3348intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "factory" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "groupAnchor" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object invoke = ((Function0) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            int mo3412getIntw8GmfQM = operationArgContainer.mo3412getIntw8GmfQM(IntParameter.m3376constructorimpl(0));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            slotWriter.updateNode(anchor, invoke);
            applier.insertTopDown(mo3412getIntw8GmfQM, invoke);
            applier.down(invoke);
        }
    }
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        */
        ...
        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3394getInsertIndexjn0FJLE() {
            return IntParameter.m3376constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3393getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "groupAnchor" : super.mo3349objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            applier.up();
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            applier.insertBottomUp(mo3412getIntw8GmfQM, slotWriter.node(anchor));
        }
    }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m3362getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3361getAnchorHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "effectiveNodeIndexOut" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "anchor" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int positionToInsert;
            IntRef intRef = (IntRef) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        public final int m3355getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m3356getNodesHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "effectiveNodeIndex" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "nodes" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int element = ((IntRef) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            int size = list.size();
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m3359getResolvedStateHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3358getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }

        /* renamed from: getFrom-HpuvwBQ, reason: not valid java name */
        public final int m3357getFromHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(2);
        }

        /* renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m3360getToHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(3);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "resolvedState" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "resolvedCompositionContext" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(2)) ? "from" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(3)) ? "to" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            MovableContentState movableContentState = (MovableContentState) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3395getCompositionHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3396getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m3397getReferenceHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(2);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "composition" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "parentCompositionContext" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(2)) ? "reference" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            OperationKt.releaseMovableGroupAtCurrent((ControlledComposition) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0)), (CompositionContext) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1)), (MovableContentStateReference) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(2)), slotWriter);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m3353getChangesHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(0);
        }

        /* renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m3354getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3387constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3349objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(0)) ? "changes" : ObjectParameter.m3389equalsimpl0(parameter, ObjectParameter.m3387constructorimpl(1)) ? "effectiveNodeIndex" : super.mo3349objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo3413getObject31yXWZQ(ObjectParameter.m3387constructorimpl(0));
            if (element > 0) {
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int i, int i2, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                arrayList.add(IntParameter.m3375boximpl(IntParameter.m3376constructorimpl(i3)));
            }
            this.intParams = arrayList;
            ArrayList arrayList2 = new ArrayList(i2);
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList2.add(ObjectParameter.m3386boximpl(ObjectParameter.m3387constructorimpl(i4)));
            }
