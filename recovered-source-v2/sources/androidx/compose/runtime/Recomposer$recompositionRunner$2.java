                            ...
                            if (set instanceof ScatterSetWrapper) {
                                            ...
                                            for (int i4 = 0; i4 < i3; i4++) {
                                                if ((255 & j) < 128) {
                                                    ...
                                                    if (obj4 instanceof StateObjectImpl) {
                                                        ...
                                                        if (!((StateObjectImpl) obj4).m3446isReadInh_f27i8$runtime_release(ReaderKind.m3434constructorimpl(1))) {
                                                        }
                                                    }
                                ...
                                for (Object obj5 : set) {
                                    if (obj5 instanceof StateObjectImpl) {
                                        ...
                                        if (!((StateObjectImpl) obj5).m3446isReadInh_f27i8$runtime_release(ReaderKind.m3434constructorimpl(1))) {
                                        }
                                    }
