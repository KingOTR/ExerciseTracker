...
public final class ComposerKt {
    ...
    private static final Object invocation = new OpaqueKey(DatabaseFileArchive.COLUMN_PROVIDER);
    private static final Object provider = new OpaqueKey(DatabaseFileArchive.COLUMN_PROVIDER);
    ...
    public static final <K, V> MutableScatterMap<K, Object> multiMap(int i) {
        return MutableScatterMultiMap.m3317constructorimpl(new MutableScatterMap(i));
    }
