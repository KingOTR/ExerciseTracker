...
public final class ComposerImpl implements Composer {
    ...
    public void startReplaceableGroup(int key) {
        m3303startBaiHCIY(key, null, GroupKind.INSTANCE.m3313getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m3303startBaiHCIY(-127, null, GroupKind.INSTANCE.m3313getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m3303startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m3313getGroupULZAiWs(), null);
    }
    ...
    public void startNode() {
        m3303startBaiHCIY(125, null, GroupKind.INSTANCE.m3314getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m3303startBaiHCIY(125, null, GroupKind.INSTANCE.m3315getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m3303startBaiHCIY(key, null, GroupKind.INSTANCE.m3313getGroupULZAiWs(), dataKey);
    }
    ...
    public void startProvider(ProvidedValue<?> value) {
        ...
        m3303startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3313getGroupULZAiWs(), currentCompositionLocalScope);
    }
    ...
    public void startProviders(ProvidedValue<?>[] values) {
        ...
        m3303startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3313getGroupULZAiWs(), updateProviderMapGroup);
    }
    ...
    */
    private final void m3303startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        int hashCode;
        int rotateLeft;
        ...
        if (obj == null) {
            if (data != null && key == 207 && !Intrinsics.areEqual(data, Composer.INSTANCE.getEmpty())) {
                ...
                boolean z = kind == GroupKind.INSTANCE.m3313getGroupULZAiWs();
                ...
                boolean z2 = kind == GroupKind.INSTANCE.m3314getNodeULZAiWs() && this.reusing;
                if (this.pending == null) {
        ...
        if (kind == GroupKind.INSTANCE.m3313getGroupULZAiWs()) {
        }
    ...
    */
    public final void invokeMovableContentLambda(final MovableContent<Object> content, PersistentCompositionLocalMap locals, final Object parameter, boolean force) {
        ...
        try {
            ...
            m3303startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3313getGroupULZAiWs(), locals);
            this.providerCache = null;
