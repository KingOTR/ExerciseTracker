...
public final class TransparentObserverMutableSnapshot extends MutableSnapshot {
    ...
    */
    ...
    public void mo3432recordModified$runtime_release(StateObject state) {
        getCurrentSnapshot().mo3432recordModified$runtime_release(state);
    }
    ...
    public Void mo3430nestedActivated$runtime_release(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
    ...
    public Void mo3431nestedDeactivated$runtime_release(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
}
