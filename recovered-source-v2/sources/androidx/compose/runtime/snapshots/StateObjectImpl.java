...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m3447recordReadInh_f27i8$runtime_release(int reader) {
        int m3434constructorimpl;
        do {
            m3434constructorimpl = ReaderKind.m3434constructorimpl(this.readerKind.get());
            if ((m3434constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(m3434constructorimpl, ReaderKind.m3434constructorimpl(m3434constructorimpl | reader)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime_release, reason: not valid java name */
    public final boolean m3446isReadInh_f27i8$runtime_release(int reader) {
        return (ReaderKind.m3434constructorimpl(this.readerKind.get()) & reader) != 0;
    }
}
