...
public class MutableSnapshot extends Snapshot {
    ...
    */
    public SnapshotApplyResult apply() {
        ...
        synchronized (SnapshotKt.getLock()) {
            ...
            if (modified$runtime_release2 != null && modified$runtime_release2.get_size() != 0) {
                ...
                i2 = SnapshotKt.nextSnapshotId;
                snapshotIdSet = SnapshotKt.openSnapshots;
                SnapshotApplyResult innerApplyLocked$runtime_release = innerApplyLocked$runtime_release(i2, map, snapshotIdSet.clear(globalSnapshot.getId()));
                ...
                if (modified$runtime_release != null) {
                    ...
                    if (!wrapIntoSet.isEmpty()) {
                        ...
                        for (int i3 = 0; i3 < size2; i3++) {
                            ((Function2) emptyList.get(i3)).invoke(wrapIntoSet, this);
                        }
                    }
                }
                if (modified$runtime_release2 != null && modified$runtime_release2.isNotEmpty()) {
                    ...
                    size = emptyList.size();
                    for (i = 0; i < size; i++) {
                        ((Function2) emptyList.get(i)).invoke(wrapIntoSet2, this);
                    }
                }
                synchronized (SnapshotKt.getLock()) {
    ...
    public void dispose() {
        ...
        super.dispose();
        mo3431nestedDeactivated$runtime_release(this);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0074, code lost:
        ...
        r4 = androidx.compose.runtime.snapshots.SnapshotKt.readable(r14, getId(), r2);
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final SnapshotApplyResult innerApplyLocked$runtime_release(int snapshotId, Map<StateRecord, ? extends StateRecord> optimisticMerges, SnapshotIdSet invalidSnapshots) {
                                ...
                                if (readable2.getSnapshotId() != 1 && !Intrinsics.areEqual(readable, readable2)) {
                                    ...
                                    if (!Intrinsics.areEqual(mergeRecords, readable3)) {
                                        if (Intrinsics.areEqual(mergeRecords, readable)) {
                                            ...
                                            arrayList2.add(TuplesKt.to(stateObject, readable.create()));
                                            if (arrayList == null) {
                                            ...
                                            arrayList2.add(!Intrinsics.areEqual(mergeRecords, readable2) ? TuplesKt.to(stateObject, mergeRecords) : TuplesKt.to(stateObject, readable2.create()));
                                        }
                                    }
                                }
                            }
        ...
        if (arrayList != null) {
            ...
            for (int i7 = 0; i7 < size2; i7++) {
                mutableScatterSet.remove(arrayList.get(i7));
            }
            List<? extends StateObject> list = this.merged;
            if (list != null) {
