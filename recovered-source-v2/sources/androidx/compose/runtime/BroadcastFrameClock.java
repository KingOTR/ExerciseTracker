    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                m7905constructorimpl = Result.m7905constructorimpl(this.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
    ...
    public final void fail(Throwable cause) {
        synchronized (this.lock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Result.Companion companion = Result.INSTANCE;
                continuation.resumeWith(Result.m7905constructorimpl(ResultKt.createFailure(cause)));
            }
            this.awaiters.clear();
            this.hasAwaitersUnlocked.set(0);
            Unit unit = Unit.INSTANCE;
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th == null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m7905constructorimpl(ResultKt.createFailure(th)));
            }
        }
