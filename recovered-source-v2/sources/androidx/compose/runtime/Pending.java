...
final class Pending {
    ...
    public Pending(List<KeyInfo> list, int i) {
        ...
        this.keyMap = LazyKt.lazy(new Function0<MutableScatterMultiMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.Pending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ MutableScatterMultiMap<Object, KeyInfo> invoke() {
                return MutableScatterMultiMap.m3316boximpl(m3326invokeSAeQiB4());
            }

            /* renamed from: invoke-SAeQiB4, reason: not valid java name */
            public final MutableScatterMap<K, Object> m3326invokeSAeQiB4() {
                MutableScatterMap<K, Object> multiMap;
                Object joinedKey;
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    ...
                    MutableScatterMultiMap.m3322putimpl(multiMap, joinedKey, keyInfo2);
                }
                return multiMap;
            }
        });
    ...
    public final MutableScatterMap<K, Object> m3325getKeyMapSAeQiB4() {
        return ((MutableScatterMultiMap) this.keyMap.getValue()).getMap();
    }

    public final KeyInfo getNext(int key, Object dataKey) {
        return (KeyInfo) MutableScatterMultiMap.m3321popimpl(m3325getKeyMapSAeQiB4(), dataKey != null ? new JoinedKey(Integer.valueOf(key), dataKey) : Integer.valueOf(key));
    }
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((j2 & 255) < 128) {
                            ...
                            if (from <= nodeIndex && nodeIndex < from + count) {
                                groupInfo.setNodeIndex(to + (nodeIndex - from));
