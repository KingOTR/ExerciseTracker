    ...
    private final void groupAsString(StringBuilder sb, int i) {
        ...
        if (dataIndex > slotIndex) {
            ...
            for (int i2 = slotIndex; i2 < dataIndex; i2++) {
                ...
                summarize = SlotTableKt.summarize(String.valueOf(this.slots[dataIndexToDataAddress(i2)]), 10);
                sb.append(String.valueOf(summarize));
            }
