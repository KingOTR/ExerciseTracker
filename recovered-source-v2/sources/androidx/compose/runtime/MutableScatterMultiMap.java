...
final class MutableScatterMultiMap<K, V> {
    ...
    public static final /* synthetic */ MutableScatterMultiMap m3316boximpl(MutableScatterMap mutableScatterMap) {
        return new MutableScatterMultiMap(mutableScatterMap);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <K, V> MutableScatterMap<K, Object> m3317constructorimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return mutableScatterMap;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3318equalsimpl(MutableScatterMap<K, Object> mutableScatterMap, Object obj) {
    ...
    public static final boolean m3319equalsimpl0(MutableScatterMap<K, Object> mutableScatterMap, MutableScatterMap<K, Object> mutableScatterMap2) {
        return Intrinsics.areEqual(mutableScatterMap, mutableScatterMap2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3320hashCodeimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return mutableScatterMap.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3323toStringimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return "MutableScatterMultiMap(map=" + mutableScatterMap + ')';
    }

    public boolean equals(Object obj) {
        return m3318equalsimpl(this.map, obj);
    }

    public int hashCode() {
        return m3320hashCodeimpl(this.map);
    }

    public String toString() {
        return m3323toStringimpl(this.map);
    }
    ...
    public static final V m3321popimpl(MutableScatterMap<K, Object> mutableScatterMap, K k) {
    ...
    public static final void m3322putimpl(MutableScatterMap<K, Object> mutableScatterMap, K k, V v) {
