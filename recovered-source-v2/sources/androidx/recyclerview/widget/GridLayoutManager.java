    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i19 = 0; i19 < i14; i19++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i16) {
                ...
                if (this.mOrientation == 1) {
                    i11 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i21, layoutParams.width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i16 - i20, Ints.MAX_POWER_OF_TWO);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i16 - i21, Ints.MAX_POWER_OF_TWO);
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i20, layoutParams.height, false);
                    i11 = makeMeasureSpec;
                }
