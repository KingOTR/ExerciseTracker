        ...
        if (continuation instanceof PagingDataPresenter$presentNewList$1) {
            ...
            if ((pagingDataPresenter$presentNewList$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i3 != 0) {
                    ...
                    PagingDataEvent.Refresh refresh = new PagingDataEvent.Refresh(pageStore, pageStore2);
                    ...
                    PagingDataPresenter<T> pagingDataPresenter = (PagingDataPresenter) pagingDataPresenter$presentNewList$1.L$0;
                    ResultKt.throwOnFailure(obj);
                ...
                if (pageStore.getSize() == 0 && (hintReceiver2 = this.hintReceiver) != null) {
