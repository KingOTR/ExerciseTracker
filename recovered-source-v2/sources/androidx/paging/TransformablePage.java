...
public final /* data */ class TransformablePage<T> {
    ...
    public TransformablePage(int[] originalPageOffsets, List<? extends T> data, int i, List<Integer> list) {
        ...
        throw new IllegalArgumentException(sb.append(list.size()).append(") is provided, it must be same length as data (size = ").append(data.size()).append(')').toString().toString());
    }
