...
final /* synthetic */ class PagingDataTransforms__PagingDataTransforms_jvmKt {
    ...
    public static final <R, T extends R> PagingData<R> insertSeparators(PagingData<T> pagingData, TerminalSeparatorType terminalSeparatorType, Executor executor, Function2<? super T, ? super T, ? extends R> generator) {
        ...
        Intrinsics.checkNotNullParameter(executor, "executor");
        Intrinsics.checkNotNullParameter(generator, "generator");
        return PagingDataTransforms__PagingDataTransformsKt.insertSeparators(pagingData, terminalSeparatorType, new PagingDataTransforms__PagingDataTransforms_jvmKt$insertSeparators$1(executor, generator, null));
    }
                    ...
                    if (continuation instanceof AnonymousClass1) {
                        ...
                        if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                            ...
                            if (i != 0) {
                                ...
                                CoroutineDispatcher from = ExecutorsKt.from(this.$executor$inlined);
                                PagingDataTransforms__PagingDataTransforms_jvmKt$map$1$1 pagingDataTransforms__PagingDataTransforms_jvmKt$map$1$1 = new PagingDataTransforms__PagingDataTransforms_jvmKt$map$1$1((PageEvent) obj, this.$transform$inlined, null);
                                anonymousClass1.L$0 = flowCollector2;
                                anonymousClass1.label = 1;
                                Object withContext = BuildersKt.withContext(from, pagingDataTransforms__PagingDataTransforms_jvmKt$map$1$1, anonymousClass1);
                    ...
                    if (continuation instanceof AnonymousClass1) {
                        ...
                        if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                            ...
                            if (i != 0) {
                                ...
                                FlowCollector flowCollector2 = this.$this_unsafeFlow;
                                CoroutineDispatcher from = ExecutorsKt.from(this.$executor$inlined);
                                PagingDataTransforms__PagingDataTransforms_jvmKt$flatMap$1$1 pagingDataTransforms__PagingDataTransforms_jvmKt$flatMap$1$1 = new PagingDataTransforms__PagingDataTransforms_jvmKt$flatMap$1$1((PageEvent) obj, this.$transform$inlined, null);
                                anonymousClass1.L$0 = flowCollector2;
                                anonymousClass1.label = 1;
                                Object withContext = BuildersKt.withContext(from, pagingDataTransforms__PagingDataTransforms_jvmKt$flatMap$1$1, anonymousClass1);
                                if (withContext == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                obj2 = withContext;
                    ...
                    if (continuation instanceof AnonymousClass1) {
                        ...
                        if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                            ...
                            if (i != 0) {
                                ...
                                FlowCollector flowCollector2 = this.$this_unsafeFlow;
                                CoroutineDispatcher from = ExecutorsKt.from(this.$executor$inlined);
                                PagingDataTransforms__PagingDataTransforms_jvmKt$filter$1$1 pagingDataTransforms__PagingDataTransforms_jvmKt$filter$1$1 = new PagingDataTransforms__PagingDataTransforms_jvmKt$filter$1$1((PageEvent) obj, this.$predicate$inlined, null);
                                anonymousClass1.L$0 = flowCollector2;
                                anonymousClass1.label = 1;
                                Object withContext = BuildersKt.withContext(from, pagingDataTransforms__PagingDataTransforms_jvmKt$filter$1$1, anonymousClass1);
                                if (withContext == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                obj2 = withContext;
