...
@DebugMetadata(c = "androidx.paging.SimpleChannelFlowKt$simpleChannelFlow$1", f = "SimpleChannelFlow.kt", i = {}, l = {ExerciseSegment.EXERCISE_SEGMENT_TYPE_SINGLE_ARM_TRICEPS_EXTENSION}, m = "invokeSuspend", n = {}, s = {})
...
final class SimpleChannelFlowKt$simpleChannelFlow$1<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "androidx.paging.SimpleChannelFlowKt$simpleChannelFlow$1$1", f = "SimpleChannelFlow.kt", i = {0, 1}, l = {ExerciseSegment.EXERCISE_SEGMENT_TYPE_YOGA, ExerciseSessionRecord.EXERCISE_TYPE_STAIR_CLIMBING}, m = "invokeSuspend", n = {"producer", "producer"}, s = {"L$0", "L$0"})
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:15:0x0084 -> B:6:0x001a). Please report as a decompilation issue!!! */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (!((Boolean) obj).booleanValue()) {
                    ...
                    this.label = 2;
                    if (this.$$this$flow.emit(next, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    it = channelIterator;
                    launch$default = job;
