...
final class CachedPageEventFlow$downstreamFlow$1$2$emit$1 extends ContinuationImpl {
    ...
    CachedPageEventFlow$downstreamFlow$1$2$emit$1(CachedPageEventFlow$downstreamFlow$1.AnonymousClass2<? super T> anonymousClass2, Continuation<? super CachedPageEventFlow$downstreamFlow$1$2$emit$1> continuation) {
        super(continuation);
