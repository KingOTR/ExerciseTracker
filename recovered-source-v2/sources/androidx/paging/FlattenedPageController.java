            ...
            if (continuation instanceof FlattenedPageController$record$1) {
                ...
                if ((flattenedPageController$record$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        Mutex mutex2 = (Mutex) flattenedPageController$record$1.L$2;
                        indexedValue = (IndexedValue) flattenedPageController$record$1.L$1;
                        FlattenedPageController<T> flattenedPageController = (FlattenedPageController) flattenedPageController$record$1.L$0;
                        ResultKt.throwOnFailure(obj);
                        mutex = mutex2;
    ...
    */
    public final Object getStateAsEvents(Continuation<? super List<? extends IndexedValue<? extends PageEvent<T>>>> continuation) {
        ...
        try {
            if (continuation instanceof FlattenedPageController$getStateAsEvents$1) {
                ...
                if ((flattenedPageController$getStateAsEvents$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        Mutex mutex2 = (Mutex) flattenedPageController$getStateAsEvents$1.L$1;
                        FlattenedPageController<T> flattenedPageController = (FlattenedPageController) flattenedPageController$getStateAsEvents$1.L$0;
                        ResultKt.throwOnFailure(obj);
                        mutex = mutex2;
                        this = flattenedPageController;
                    }
                    List<PageEvent<T>> asEvents = this.list.getAsEvents();
                    int size = (this.maxEventIndex - asEvents.size()) + 1;
            ...
            List<PageEvent<T>> asEvents2 = this.list.getAsEvents();
            int size2 = (this.maxEventIndex - asEvents2.size()) + 1;
