...
public final class PagingData<T> {
    ...
    public static final class Companion {
        ...
        public final <T> PagingData<T> empty() {
            return new PagingData<>(FlowKt.flowOf(new PageEvent.StaticList(CollectionsKt.emptyList(), null, null)), getNOOP_UI_RECEIVER$paging_common_release(), getNOOP_HINT_RECEIVER$paging_common_release(), new Function0<PageEvent.Insert<T>>() { // from class: androidx.paging.PagingData$Companion$empty$1
                ...
                public final PageEvent.Insert<T> invoke() {
                    return PageEvent.Insert.INSTANCE.Refresh(CollectionsKt.listOf(new TransformablePage(0, CollectionsKt.emptyList())), 0, 0, LoadStates.INSTANCE.getIDLE(), null);
                }
            });
        }
        ...
        @JvmStatic
        public final <T> PagingData<T> empty(final LoadStates sourceLoadStates, final LoadStates mediatorLoadStates) {
            Intrinsics.checkNotNullParameter(sourceLoadStates, "sourceLoadStates");
            return new PagingData<>(FlowKt.flowOf(new PageEvent.StaticList(CollectionsKt.emptyList(), sourceLoadStates, mediatorLoadStates)), getNOOP_UI_RECEIVER$paging_common_release(), getNOOP_HINT_RECEIVER$paging_common_release(), new Function0<PageEvent.Insert<T>>() { // from class: androidx.paging.PagingData$Companion$empty$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final PageEvent.Insert<T> invoke() {
                    return PageEvent.Insert.INSTANCE.Refresh(CollectionsKt.listOf(new TransformablePage(0, CollectionsKt.emptyList())), 0, 0, LoadStates.this, mediatorLoadStates);
                }
            });
        }
        ...
        @JvmStatic
        public final <T> PagingData<T> from(final List<? extends T> data, final LoadStates sourceLoadStates, final LoadStates mediatorLoadStates) {
            Intrinsics.checkNotNullParameter(data, "data");
            Intrinsics.checkNotNullParameter(sourceLoadStates, "sourceLoadStates");
            return new PagingData<>(FlowKt.flowOf(new PageEvent.StaticList(data, sourceLoadStates, mediatorLoadStates)), getNOOP_UI_RECEIVER$paging_common_release(), getNOOP_HINT_RECEIVER$paging_common_release(), new Function0<PageEvent.Insert<T>>() { // from class: androidx.paging.PagingData$Companion$from$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final PageEvent.Insert<T> invoke() {
                    return PageEvent.Insert.INSTANCE.Refresh(CollectionsKt.listOf(new TransformablePage(0, data)), 0, 0, sourceLoadStates, mediatorLoadStates);
                }
            });
        }
    }
