...
public abstract class ItemKeyedDataSource<Key, Value> extends DataSource<Key, Value> {
    ...
    /* compiled from: ItemKeyedDataSource.jvm.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\b\u0016\u0018\u0000*\b\b\u0002\u0010\u0001*\u00020\u00022\u00020\u0002B\u0015\u0012\u0006\u0010\u0003\u001a\u00028\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0012\u0010\u0003\u001a\u00028\u00028\u0006X\u0087\u0004¢\u0006\u0004\n\u0002\u0010\u0007R\u0010\u0010\u0004\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Landroidx/paging/ItemKeyedDataSource$LoadParams;", "Key", "", DatabaseFileArchive.COLUMN_KEY, "requestedLoadSize", "", "(Ljava/lang/Object;I)V", "Ljava/lang/Object;", "paging-common_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public final ItemKeyedDataSource$asCallback$1<Key, Value> asCallback(final CancellableContinuation<? super DataSource.BaseResult<Value>> cancellableContinuation) {
        return new LoadCallback<Value>() { // from class: androidx.paging.ItemKeyedDataSource$asCallback$1
            ...
            public void onResult(List<? extends Value> data) {
                ...
                cancellableContinuation2.resumeWith(Result.m7905constructorimpl(new DataSource.BaseResult(data, this.getPrevKey$paging_common_release(data), this.getNextKey$paging_common_release(data), 0, 0, 24, null)));
            }
        };
    }
    ...
    public final Object loadInitial$paging_common_release(LoadInitialParams<Key> loadInitialParams, Continuation<? super DataSource.BaseResult<Value>> continuation) {
        ...
        loadInitial(loadInitialParams, new LoadInitialCallback<Value>() { // from class: androidx.paging.ItemKeyedDataSource$loadInitial$2$1
            ...
            public void onResult(List<? extends Value> data, int position, int totalCount) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m7905constructorimpl(new DataSource.BaseResult(data, this.getPrevKey$paging_common_release(data), this.getNextKey$paging_common_release(data), position, (totalCount - data.size()) - position)));
            }
            ...
            public void onResult(List<? extends Value> data) {
                ...
                CancellableContinuation<DataSource.BaseResult<Value>> cancellableContinuation = cancellableContinuationImpl2;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m7905constructorimpl(new DataSource.BaseResult(data, this.getPrevKey$paging_common_release(data), this.getNextKey$paging_common_release(data), 0, 0, 24, null)));
            }
        });
