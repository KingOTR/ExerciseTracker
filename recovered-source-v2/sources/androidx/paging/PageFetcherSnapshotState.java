...
public final class PageFetcherSnapshotState<Key, Value> {
    ...
    public final PageEvent<Value> toPageEvent$paging_common_release(PagingSource.LoadResult.Page<Key, Value> page, LoadType loadType) {
        ...
        if (i3 == 1) {
            return PageEvent.Insert.INSTANCE.Refresh(listOf, getPlaceholdersBefore$paging_common_release(), getPlaceholdersAfter$paging_common_release(), this.sourceLoadStates.snapshot(), null);
        }
        if (i3 == 2) {
            return PageEvent.Insert.INSTANCE.Prepend(listOf, getPlaceholdersBefore$paging_common_release(), this.sourceLoadStates.snapshot(), null);
        }
        if (i3 == 3) {
            return PageEvent.Insert.INSTANCE.Append(listOf, getPlaceholdersAfter$paging_common_release(), this.sourceLoadStates.snapshot(), null);
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public final void drop(PageEvent.Drop<Value> event) {
        ...
        if (i != 2) {
            if (i == 3) {
                ...
                this.appendGenerationIdCh.mo6673trySendJP2dKIU(Integer.valueOf(i3));
                return;
            }
        ...
        this.prependGenerationIdCh.mo6673trySendJP2dKIU(Integer.valueOf(i5));
    }
                ...
                if (continuation instanceof PageFetcherSnapshotState$Holder$withLock$1) {
                    ...
                    if ((pageFetcherSnapshotState$Holder$withLock$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            Mutex mutex2 = (Mutex) pageFetcherSnapshotState$Holder$withLock$1.L$2;
                            function1 = (Function1) pageFetcherSnapshotState$Holder$withLock$1.L$1;
                            Holder<Key, Value> holder = (Holder) pageFetcherSnapshotState$Holder$withLock$1.L$0;
                            ResultKt.throwOnFailure(obj);
                            mutex = mutex2;
                            this = holder;
                        }
