        ...
        if (i == 0) {
            ...
            final ?? r1 = new ConstraintListener<T>() { // from class: androidx.work.impl.constraints.controllers.BaseConstraintController$track$1$listener$1
                ...
                public void onConstraintChanged(T newValue) {
                    producerScope.getChannel().mo6673trySendJP2dKIU(baseConstraintController.isConstrained(newValue) ? new ConstraintsState.ConstraintsNotMet(baseConstraintController.getReason()) : ConstraintsState.ConstraintsMet.INSTANCE);
                }
            };
