    ...
    protected SupportSQLiteOpenHelper createOpenHelper(final DatabaseConfiguration config) {
        return config.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(config.context).name(config.name).callback(new RoomOpenHelper(config, new RoomOpenHelper.Delegate(23) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(final SupportSQLiteDatabase db) {
                ...
                TableInfo read = TableInfo.read(db, "Dependency");
                ...
                TableInfo read2 = TableInfo.read(db, "WorkSpec");
                ...
                TableInfo read3 = TableInfo.read(db, "WorkTag");
                ...
                TableInfo read4 = TableInfo.read(db, "SystemIdInfo");
                if (!tableInfo4.equals(read4)) {
                    return new RoomOpenHelper.ValidationResult(false, "SystemIdInfo(androidx.work.impl.model.SystemIdInfo).\n Expected:\n" + tableInfo4 + "\n Found:\n" + read4);
                }
                HashMap hashMap5 = new HashMap(2);
                hashMap5.put(HintConstants.AUTOFILL_HINT_NAME, new TableInfo.Column(HintConstants.AUTOFILL_HINT_NAME, "TEXT", true, 1, null, 1));
                ...
                TableInfo read5 = TableInfo.read(db, "WorkName");
                ...
                TableInfo read6 = TableInfo.read(db, "WorkProgress");
                if (!tableInfo6.equals(read6)) {
                    return new RoomOpenHelper.ValidationResult(false, "WorkProgress(androidx.work.impl.model.WorkProgress).\n Expected:\n" + tableInfo6 + "\n Found:\n" + read6);
                }
                HashMap hashMap7 = new HashMap(2);
                hashMap7.put(DatabaseFileArchive.COLUMN_KEY, new TableInfo.Column(DatabaseFileArchive.COLUMN_KEY, "TEXT", true, 1, null, 1));
                ...
                TableInfo read7 = TableInfo.read(db, "Preference");
