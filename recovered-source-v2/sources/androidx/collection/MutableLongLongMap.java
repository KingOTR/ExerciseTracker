...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final long put(long key, long value, long r7) {
        int findInsertIndex = findInsertIndex(key);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
