...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final long put(int key, long value, long r6) {
        int findInsertIndex = findInsertIndex(key);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
                ...
                if (j == 254) {
                    ...
                    if (((findFirstAvailableSlot - i9) & i3) / 8 == ((i4 - i9) & i3) / 8) {
                        ...
                        if (((j2 >> i11) & 255) == 128) {
                            ...
                            iArr[i14] = iArr[i5];
                            jArr2[i5] = jArr2[findFirstAvailableSlot];
                            jArr2[findFirstAvailableSlot] = jArr2[i14];
                            jArr2[i14] = jArr2[i5];
                            i2 = i14 - 1;
                        }
                        c = 0;
