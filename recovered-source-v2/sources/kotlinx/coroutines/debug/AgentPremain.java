...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m7905constructorimpl = Result.m7905constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m7905constructorimpl = Result.m7905constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m7911isFailureimpl(m7905constructorimpl) ? null : m7905constructorimpl);
