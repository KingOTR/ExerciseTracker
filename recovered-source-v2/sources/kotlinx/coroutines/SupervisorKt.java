...
public final class SupervisorKt {
    ...
    public static /* synthetic */ Job m9406SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m9405SupervisorJob(job);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    /* renamed from: SupervisorJob, reason: collision with other method in class */
    public static final /* synthetic */ Job m9405SupervisorJob(Job job) {
        return SupervisorJob(job);
    }
