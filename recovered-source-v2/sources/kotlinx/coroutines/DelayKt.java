...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo9476scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m9398delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m9399toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9399toDelayMillisLRDsOJo(long j) {
        boolean m9265isPositiveimpl = Duration.m9265isPositiveimpl(j);
        if (m9265isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m9249getInWholeMillisecondsimpl(Duration.m9267plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m9265isPositiveimpl) {
