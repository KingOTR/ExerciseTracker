...
public interface SendChannel<E> {
    ...
    Object mo6673trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo6673trySendJP2dKIU = sendChannel.mo6673trySendJP2dKIU(e);
            if (ChannelResult.m9434isSuccessimpl(mo6673trySendJP2dKIU)) {
                return true;
            }
            Throwable m9428exceptionOrNullimpl = ChannelResult.m9428exceptionOrNullimpl(mo6673trySendJP2dKIU);
