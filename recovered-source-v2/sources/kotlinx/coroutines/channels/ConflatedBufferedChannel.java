...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m9443trySendImplMj0NB7M = conflatedBufferedChannel.m9443trySendImplMj0NB7M(e, true);
        if (m9443trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m9428exceptionOrNullimpl(m9443trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m9443trySendImplMj0NB7M = conflatedBufferedChannel.m9443trySendImplMj0NB7M(e, true);
        if (!(m9443trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo6673trySendJP2dKIU(E element) {
        return m9443trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m9443trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m9442trySendDropLatestMj0NB7M(element, isSendOp) : m9418trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m9442trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo6673trySendJP2dKIU = super.mo6673trySendJP2dKIU(element);
        if (ChannelResult.m9434isSuccessimpl(mo6673trySendJP2dKIU) || ChannelResult.m9432isClosedimpl(mo6673trySendJP2dKIU)) {
            return mo6673trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo6673trySendJP2dKIU = mo6673trySendJP2dKIU(element);
        if (!(mo6673trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo6673trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m9428exceptionOrNullimpl(mo6673trySendJP2dKIU);
