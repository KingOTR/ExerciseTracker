...
public interface ReceiveChannel<E> {
    ...
    Object mo9416receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo9417tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo9417tryReceivePtdJZtk = receiveChannel.mo9417tryReceivePtdJZtk();
            if (ChannelResult.m9434isSuccessimpl(mo9417tryReceivePtdJZtk)) {
                return (E) ChannelResult.m9430getOrThrowimpl(mo9417tryReceivePtdJZtk);
            }
            Throwable m9428exceptionOrNullimpl = ChannelResult.m9428exceptionOrNullimpl(mo9417tryReceivePtdJZtk);
            if (m9428exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m9428exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo9416receiveCatchingJP2dKIU = receiveChannel.mo9416receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    ...
                    return ChannelResult.m9429getOrNullimpl(mo9416receiveCatchingJP2dKIU);
                }
            }
