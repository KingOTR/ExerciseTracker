            ...
            public final void onComplete(Task<T> task2) {
                ...
                if (exception2 == null) {
                    ...
                    if (isCanceled) {
                        ...
                        cancellableContinuation.resumeWith(Result.m7905constructorimpl(task2.getResult()));
                        return;
                    }
                }
                Continuation continuation2 = cancellableContinuationImpl2;
                Result.Companion companion2 = Result.INSTANCE;
                continuation2.resumeWith(Result.m7905constructorimpl(ResultKt.createFailure(exception2)));
            }
        });
        if (cancellationTokenSource != null) {
