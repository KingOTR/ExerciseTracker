...
@DebugMetadata(c = "kotlinx.coroutines.sync.SemaphoreKt", f = "Semaphore.kt", i = {0, 0}, l = {ExerciseSessionRecord.EXERCISE_TYPE_WEIGHTLIFTING}, m = "withPermit", n = {"$this$withPermit", "action"}, s = {"L$0", "L$1"})
