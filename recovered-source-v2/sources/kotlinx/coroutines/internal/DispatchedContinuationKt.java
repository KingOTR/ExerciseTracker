...
public final class DispatchedContinuationKt {
    ...
    public static final <T> void resumeCancellableWith(Continuation<? super T> continuation, Object obj) {
        ...
        if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
            ...
            dispatchedContinuation.dispatcher.mo9475dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
            return;
        }
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                dispatchedContinuation.resumeWith(Result.m7905constructorimpl(ResultKt.createFailure(cancellationException)));
            } else {
