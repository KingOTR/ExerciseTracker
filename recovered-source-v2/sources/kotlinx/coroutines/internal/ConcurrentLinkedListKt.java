    ...
    public static final <S extends Segment<S>> Object findSegmentInternal(S s, long j, Function2<? super Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s.id >= j && !s.isRemoved()) {
                return SegmentOrClosed.m9478constructorimpl(s);
            }
            Object nextOrClosed = s.getNextOrClosed();
            if (nextOrClosed == CLOSED) {
                return SegmentOrClosed.m9478constructorimpl(CLOSED);
            }
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m9483isClosedimpl(findSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, obj, segment, m9481getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m9483isClosedimpl(findSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceArray, i, segment, m9481getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m9481getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
