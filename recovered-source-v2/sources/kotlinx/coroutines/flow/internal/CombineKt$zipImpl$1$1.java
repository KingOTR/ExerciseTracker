...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            static final class C00901 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final /* synthetic */ CompletableJob $collectJob;
                final /* synthetic */ ReceiveChannel<Object> $second;
                final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00901(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, CompletableJob completableJob, Continuation<? super C00901> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00901(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, this.$collectJob, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Unit unit, Continuation<? super Unit> continuation) {
                    return ((C00901) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                */
                public final Object invokeSuspend(Object obj) {
                    Object mo9416receiveCatchingJP2dKIU;
                    ?? r1;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    int i = this.label;
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        mo9416receiveCatchingJP2dKIU = this.$second.mo9416receiveCatchingJP2dKIU(this);
                        if (mo9416receiveCatchingJP2dKIU == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo9416receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    }
                    CompletableJob completableJob = this.$collectJob;
                    if (mo9416receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable m9428exceptionOrNullimpl = ChannelResult.m9428exceptionOrNullimpl(mo9416receiveCatchingJP2dKIU);
                        if (m9428exceptionOrNullimpl == null) {
                            throw new AbortFlowException(completableJob);
                        }
                        throw m9428exceptionOrNullimpl;
                    }
                    Object obj2 = this.$this_unsafeFlow;
                    Function3 function3 = this.$transform;
                    Object obj3 = this.$value;
                    if (mo9416receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        mo9416receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = obj2;
                    this.label = 2;
                    obj = function3.invoke(obj3, mo9416receiveCatchingJP2dKIU, this);
                    r1 = obj2;
                ...
                if (continuation instanceof CombineKt$zipImpl$1$1$2$1$emit$1) {
                    ...
                    if ((combineKt$zipImpl$1$1$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            C00901 c00901 = new C00901(this.$second, this.$this_unsafeFlow, this.$transform, t1, this.$collectJob, null);
                            combineKt$zipImpl$1$1$2$1$emit$1.label = 1;
                            if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c00901, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        } else {
                            if (i != 1) {
