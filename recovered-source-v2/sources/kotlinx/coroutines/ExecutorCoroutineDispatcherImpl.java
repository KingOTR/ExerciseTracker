...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo9475dispatch(CoroutineContext context, Runnable block) {
        Runnable runnable;
        try {
            ...
            Dispatchers.getIO().mo9475dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo9476scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        Executor executor = getExecutor();
        ...
        if (scheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo9476scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
