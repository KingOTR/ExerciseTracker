...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m9537JsonPrimitive7apg3OU(byte b) {
        return m9538JsonPrimitiveVKZWuLQ(ULong.m8079constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m9540JsonPrimitivexj2QHRw(short s) {
        return m9538JsonPrimitiveVKZWuLQ(ULong.m8079constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m9539JsonPrimitiveWZ4Q5Ns(int i) {
        return m9538JsonPrimitiveVKZWuLQ(ULong.m8079constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m9538JsonPrimitiveVKZWuLQ(long j) {
