...
public final class ComposerForUnsignedNumbers extends Composer {
    ...
    public void print(int v) {
        ...
        String unsignedString = Integer.toUnsignedString(UInt.m8000constructorimpl(v));
        if (z) {
    ...
    public void print(long v) {
        boolean z = this.forceQuoting;
        String unsignedString = Long.toUnsignedString(ULong.m8079constructorimpl(v));
        if (z) {
            printQuoted(unsignedString);
        } else {
            print(unsignedString);
    ...
    public void print(byte v) {
        boolean z = this.forceQuoting;
        String m7967toStringimpl = UByte.m7967toStringimpl(UByte.m7923constructorimpl(v));
        if (z) {
            printQuoted(m7967toStringimpl);
        } else {
            print(m7967toStringimpl);
        }
    }
    ...
    public void print(short v) {
        boolean z = this.forceQuoting;
        String m8230toStringimpl = UShort.m8230toStringimpl(UShort.m8186constructorimpl(v));
        if (z) {
            printQuoted(m8230toStringimpl);
        } else {
            print(m8230toStringimpl);
        }
    }
}
