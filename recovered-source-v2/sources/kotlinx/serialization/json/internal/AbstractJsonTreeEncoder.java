    ...
    private final AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1 inlineUnsignedNumberEncoder(final String tag) {
        return new AbstractEncoder() { // from class: kotlinx.serialization.json.internal.AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1
            ...
            public void encodeInt(int value) {
                putUnquotedString(Integer.toUnsignedString(UInt.m8000constructorimpl(value)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeLong(long value) {
                putUnquotedString(Long.toUnsignedString(ULong.m8079constructorimpl(value)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeByte(byte value) {
                putUnquotedString(UByte.m7967toStringimpl(UByte.m7923constructorimpl(value)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeShort(short value) {
                putUnquotedString(UShort.m8230toStringimpl(UShort.m8186constructorimpl(value)));
            }
        };
    }
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        if (str != null) {
            if (jsonTreeListEncoder instanceof JsonTreeMapEncoder) {
                ...
                jsonTreeMapEncoder2.putElement(DatabaseFileArchive.COLUMN_KEY, JsonElementKt.JsonPrimitive(str));
                String str2 = this.polymorphicSerialName;
                if (str2 == null) {
                    str2 = descriptor.getSerialName();
                }
                jsonTreeMapEncoder2.putElement(Values.VECTOR_MAP_VECTORS_KEY, JsonElementKt.JsonPrimitive(str2));
            } else {
