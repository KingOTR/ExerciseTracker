...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m9501computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m7905constructorimpl = Result.m7905constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m7905constructorimpl = Result.m7905constructorimpl(ResultKt.createFailure(th));
            }
            obj = Result.m7904boximpl(m7905constructorimpl);
