...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo9496getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            ...
            Object putIfAbsent2 = concurrentHashMap2.putIfAbsent(arrayList2, m7904boximpl);
            obj = putIfAbsent2 == null ? m7904boximpl : putIfAbsent2;
        }
